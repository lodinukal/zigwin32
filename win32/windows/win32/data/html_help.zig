...
pub const HHN_FIRST = @as(u32, 4294966436);
pub const HHN_LAST = @as(u32, 4294966417);
pub const HHN_NAVCOMPLETE = @as(u32, 4294966436);
pub const HHN_TRACK = @as(u32, 4294966435);
pub const HHN_WINDOW_CREATE = @as(u32, 4294966434);
...
// Section: Types (23)
//--------------------------------------------------------------------------------
pub const HTML_HELP_COMMAND = enum(i32) {
    DISPLAY_TOPIC = 0,
    // HELP_FINDER = 0, this enum value conflicts with DISPLAY_TOPIC
    DISPLAY_TOC = 1,
    DISPLAY_INDEX = 2,
    DISPLAY_SEARCH = 3,
    SET_WIN_TYPE = 4,
    ...
    ENUM_CATEGORY_IT = 22,
    RESET_IT_FILTER = 23,
    SET_INCLUSIVE_FILTER = 24,
    SET_EXCLUSIVE_FILTER = 25,
    INITIALIZE = 28,
    UNINITIALIZE = 29,
    SET_QUERYSERVICE = 30,
    PRETRANSLATEMESSAGE = 253,
    SET_GLOBAL_PROPERTY = 252,
    SAFE_DISPLAY_TOPIC = 32,
    // MAX_TABS = 19, this enum value conflicts with ALINK_LOOKUP
    // MAX_TABS_CUSTOM = 9, this enum value conflicts with SYNC
    FTS_DEFAULT_PROXIMITY = -1,
};
pub const HH_DISPLAY_TOPIC = HTML_HELP_COMMAND.DISPLAY_TOPIC;
pub const HH_HELP_FINDER = HTML_HELP_COMMAND.DISPLAY_TOPIC;
pub const HH_DISPLAY_TOC = HTML_HELP_COMMAND.DISPLAY_TOC;
pub const HH_DISPLAY_INDEX = HTML_HELP_COMMAND.DISPLAY_INDEX;
pub const HH_DISPLAY_SEARCH = HTML_HELP_COMMAND.DISPLAY_SEARCH;
pub const HH_SET_WIN_TYPE = HTML_HELP_COMMAND.SET_WIN_TYPE;
pub const HH_GET_WIN_TYPE = HTML_HELP_COMMAND.GET_WIN_TYPE;
pub const HH_GET_WIN_HANDLE = HTML_HELP_COMMAND.GET_WIN_HANDLE;
pub const HH_ENUM_INFO_TYPE = HTML_HELP_COMMAND.ENUM_INFO_TYPE;
pub const HH_SET_INFO_TYPE = HTML_HELP_COMMAND.SET_INFO_TYPE;
pub const HH_SYNC = HTML_HELP_COMMAND.SYNC;
pub const HH_RESERVED1 = HTML_HELP_COMMAND.RESERVED1;
pub const HH_RESERVED2 = HTML_HELP_COMMAND.RESERVED2;
pub const HH_RESERVED3 = HTML_HELP_COMMAND.RESERVED3;
pub const HH_KEYWORD_LOOKUP = HTML_HELP_COMMAND.KEYWORD_LOOKUP;
pub const HH_DISPLAY_TEXT_POPUP = HTML_HELP_COMMAND.DISPLAY_TEXT_POPUP;
pub const HH_HELP_CONTEXT = HTML_HELP_COMMAND.HELP_CONTEXT;
pub const HH_TP_HELP_CONTEXTMENU = HTML_HELP_COMMAND.TP_HELP_CONTEXTMENU;
pub const HH_TP_HELP_WM_HELP = HTML_HELP_COMMAND.TP_HELP_WM_HELP;
pub const HH_CLOSE_ALL = HTML_HELP_COMMAND.CLOSE_ALL;
pub const HH_ALINK_LOOKUP = HTML_HELP_COMMAND.ALINK_LOOKUP;
pub const HH_GET_LAST_ERROR = HTML_HELP_COMMAND.GET_LAST_ERROR;
pub const HH_ENUM_CATEGORY = HTML_HELP_COMMAND.ENUM_CATEGORY;
pub const HH_ENUM_CATEGORY_IT = HTML_HELP_COMMAND.ENUM_CATEGORY_IT;
pub const HH_RESET_IT_FILTER = HTML_HELP_COMMAND.RESET_IT_FILTER;
pub const HH_SET_INCLUSIVE_FILTER = HTML_HELP_COMMAND.SET_INCLUSIVE_FILTER;
pub const HH_SET_EXCLUSIVE_FILTER = HTML_HELP_COMMAND.SET_EXCLUSIVE_FILTER;
pub const HH_INITIALIZE = HTML_HELP_COMMAND.INITIALIZE;
pub const HH_UNINITIALIZE = HTML_HELP_COMMAND.UNINITIALIZE;
pub const HH_SET_QUERYSERVICE = HTML_HELP_COMMAND.SET_QUERYSERVICE;
pub const HH_PRETRANSLATEMESSAGE = HTML_HELP_COMMAND.PRETRANSLATEMESSAGE;
pub const HH_SET_GLOBAL_PROPERTY = HTML_HELP_COMMAND.SET_GLOBAL_PROPERTY;
pub const HH_SAFE_DISPLAY_TOPIC = HTML_HELP_COMMAND.SAFE_DISPLAY_TOPIC;
pub const HH_MAX_TABS = HTML_HELP_COMMAND.ALINK_LOOKUP;
pub const HH_MAX_TABS_CUSTOM = HTML_HELP_COMMAND.SYNC;
pub const HH_FTS_DEFAULT_PROXIMITY = HTML_HELP_COMMAND.FTS_DEFAULT_PROXIMITY;
...
pub const HH_ENUM_IT = extern struct {
    cbStruct: i32,
    iType: i32,
    pszCatName: ?[*:0]align(1) const u8,
    pszITName: ?[*:0]align(1) const u8,
    pszITDescription: ?[*:0]align(1) const u8,
};

pub const HH_ENUM_CAT = extern struct {
    cbStruct: i32,
    pszCatName: ?[*:0]align(1) const u8,
    pszCatDescription: ?[*:0]align(1) const u8,
};

pub const HH_SET_INFOTYPE = extern struct {
    cbStruct: i32,
    pszCatName: ?[*:0]align(1) const u8,
    pszInfoTypeName: ?[*:0]align(1) const u8,
};
...
pub const IITPropList = extern struct {
    pub const VTable = extern struct {
        ...
        Set: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                PropID: u32,
                lpszwString: ?[*:0]align(1) const u16,
                dwOperation: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IITPropList_Set(self: *const T, PropID: u32, lpszwString: ?[*:0]align(1) const u16, dwOperation: u32) callconv(.Inline) HRESULT {
...
pub const IITDatabase = extern struct {
    pub const VTable = extern struct {
        ...
        Open: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                lpszMoniker: ?[*:0]align(1) const u16,
                dwFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IITDatabase,
        ...
        GetObjectPersistence: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IITDatabase,
                lpwszObject: ?[*:0]align(1) const u16,
                dwObjInstance: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IITDatabase_Open(self: *const T, lpszHost: ?[*:0]align(1) const u16, lpszMoniker: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IITDatabase_GetObjectPersistence(self: *const T, lpwszObject: ?[*:0]align(1) const u16, dwObjInstance: u32, ppvPersistence: ?*?*anyopaque, fStream: BOOL) callconv(.Inline) HRESULT {
...
pub const IStemSink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStemSink_PutAltWord(self: *const T, pwcInBuf: ?[*:0]align(1) const u16, cwc: u32) callconv(.Inline) HRESULT {
            return @as(*const IStemSink.VTable, @ptrCast(self.vtable)).PutAltWord(@as(*const IStemSink, @ptrCast(self)), pwcInBuf, cwc);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStemSink_PutWord(self: *const T, pwcInBuf: ?[*:0]align(1) const u16, cwc: u32) callconv(.Inline) HRESULT {
...
pub const IITResultSet = extern struct {
    pub const VTable = extern struct {
        ...
        Add1: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IITResultSet,
                PropID: u32,
                lpszwDefault: ?[*:0]align(1) const u16,
                Priority: PRIORITY,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IITResultSet,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IITResultSet_Add1(self: *const T, PropID: u32, lpszwDefault: ?[*:0]align(1) const u16, Priority: PRIORITY) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IITResultSet_Set1(self: *const T, lRowIndex: i32, lColumnIndex: i32, lpwStr: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        pub const HtmlHelp = thismodule.HtmlHelpA;
    },
    .wide => struct {
        pub const HtmlHelp = thismodule.HtmlHelpW;
    },
    .unspecified => if (@import("builtin").is_test) struct {
        pub const HtmlHelp = *opaque{};
    } else struct {
        pub const HtmlHelp = @compileError("'HtmlHelp' requires that UNICODE be set to true or false in the root module");
    },
};
//--------------------------------------------------------------------------------
// Section: Imports (16)
...
const IPersistStreamInit = @import("../../../windows/win32/system/com.zig").IPersistStreamInit;
const IStemmer = @import("../../../windows/win32/system/search.zig").IStemmer;
