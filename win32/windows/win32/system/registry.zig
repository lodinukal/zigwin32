...
pub const REG_ROUTINE_FLAGS = enum(u32) {
    RT_DWORD = 24,
    RT_QWORD = 72,
    RT_REG_NONE = 1,
    RT_REG_SZ = 2,
    ...
    pub fn initFlags(o: struct {
        ...
        RT_REG_NONE: u1 = 0,
        RT_REG_SZ: u1 = 0,
        RT_REG_EXPAND_SZ: u1 = 0,
        RT_REG_BINARY: u1 = 0,
        RT_REG_DWORD: u1 = 0,
        RT_REG_MULTI_SZ: u1 = 0,
        RT_REG_QWORD: u1 = 0,
        RT_ANY: u1 = 0,
        SUBKEY_WOW6464KEY: u1 = 0,
        SUBKEY_WOW6432KEY: u1 = 0,
        WOW64_MASK: u1 = 0,
        NOEXPAND: u1 = 0,
        ZEROONFAILURE: u1 = 0,
    }) REG_ROUTINE_FLAGS {
        return @as(REG_ROUTINE_FLAGS, @enumFromInt(
              (if (o.RT_DWORD == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_DWORD) else 0)
            | (if (o.RT_QWORD == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_QWORD) else 0)
            | (if (o.RT_REG_NONE == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_NONE) else 0)
            | (if (o.RT_REG_SZ == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_SZ) else 0)
            | (if (o.RT_REG_EXPAND_SZ == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_EXPAND_SZ) else 0)
            | (if (o.RT_REG_BINARY == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_BINARY) else 0)
            | (if (o.RT_REG_DWORD == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_DWORD) else 0)
            | (if (o.RT_REG_MULTI_SZ == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_MULTI_SZ) else 0)
            | (if (o.RT_REG_QWORD == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_REG_QWORD) else 0)
            | (if (o.RT_ANY == 1) @intFromEnum(REG_ROUTINE_FLAGS.RT_ANY) else 0)
            | (if (o.SUBKEY_WOW6464KEY == 1) @intFromEnum(REG_ROUTINE_FLAGS.SUBKEY_WOW6464KEY) else 0)
            | (if (o.SUBKEY_WOW6432KEY == 1) @intFromEnum(REG_ROUTINE_FLAGS.SUBKEY_WOW6432KEY) else 0)
            | (if (o.WOW64_MASK == 1) @intFromEnum(REG_ROUTINE_FLAGS.WOW64_MASK) else 0)
            | (if (o.NOEXPAND == 1) @intFromEnum(REG_ROUTINE_FLAGS.NOEXPAND) else 0)
            | (if (o.ZEROONFAILURE == 1) @intFromEnum(REG_ROUTINE_FLAGS.ZEROONFAILURE) else 0)
        ));
    }
};
pub const RRF_RT_DWORD = REG_ROUTINE_FLAGS.RT_DWORD;
pub const RRF_RT_QWORD = REG_ROUTINE_FLAGS.RT_QWORD;
pub const RRF_RT_REG_NONE = REG_ROUTINE_FLAGS.RT_REG_NONE;
pub const RRF_RT_REG_SZ = REG_ROUTINE_FLAGS.RT_REG_SZ;
pub const RRF_RT_REG_EXPAND_SZ = REG_ROUTINE_FLAGS.RT_REG_EXPAND_SZ;
pub const RRF_RT_REG_BINARY = REG_ROUTINE_FLAGS.RT_REG_BINARY;
pub const RRF_RT_REG_DWORD = REG_ROUTINE_FLAGS.RT_REG_DWORD;
pub const RRF_RT_REG_MULTI_SZ = REG_ROUTINE_FLAGS.RT_REG_MULTI_SZ;
pub const RRF_RT_REG_QWORD = REG_ROUTINE_FLAGS.RT_REG_QWORD;
pub const RRF_RT_ANY = REG_ROUTINE_FLAGS.RT_ANY;
pub const RRF_SUBKEY_WOW6464KEY = REG_ROUTINE_FLAGS.SUBKEY_WOW6464KEY;
pub const RRF_SUBKEY_WOW6432KEY = REG_ROUTINE_FLAGS.SUBKEY_WOW6432KEY;
pub const RRF_WOW64_MASK = REG_ROUTINE_FLAGS.WOW64_MASK;
pub const RRF_NOEXPAND = REG_ROUTINE_FLAGS.NOEXPAND;
pub const RRF_ZEROONFAILURE = REG_ROUTINE_FLAGS.ZEROONFAILURE;
...
pub extern "advapi32" fn RegConnectRegistryA(
    lpMachineName: ?[*:0]align(1) const u8,
    hKey: ?HKEY,
    phkResult: ?*?HKEY,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegDeleteValueA(
    hKey: ?HKEY,
    lpValueName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegReplaceKeyA(
    hKey: ?HKEY,
    lpSubKey: ?[*:0]align(1) const u8,
    lpNewFile: ?[*:0]align(1) const u8,
    lpOldFile: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegReplaceKeyW(
    hKey: ?HKEY,
    lpSubKey: ?[*:0]align(1) const u16,
    lpNewFile: ?[*:0]align(1) const u16,
    lpOldFile: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegRenameKey(
    hKey: ?HKEY,
    lpSubKeyName: ?[*:0]align(1) const u16,
    lpNewKeyName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegLoadMUIStringA(
    ...
    pcbData: ?*u32,
    Flags: u32,
    pszDirectory: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "api-ms-win-core-state-helpers-l1-1-0" fn GetRegistryValueWithFallbackW(
    hkeyPrimary: ?HKEY,
    pwszPrimarySubKey: ?[*:0]align(1) const u16,
    hkeyFallback: ?HKEY,
    pwszFallbackSubKey: ?[*:0]align(1) const u16,
