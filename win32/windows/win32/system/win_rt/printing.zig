...
pub const IPrintWorkflowXpsReceiver = extern struct {
    pub const VTable = extern struct {
        ...
        SetDocumentSequenceUri: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintWorkflowXpsReceiver,
                documentSequenceUri: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintWorkflowXpsReceiver,
                documentSequenceUri: ?[*:0]align(1) const u16,
        ...
        AddDocumentData: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                documentUri: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintWorkflowXpsReceiver,
                documentId: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintWorkflowXpsReceiver_SetDocumentSequenceUri(self: *const T, documentSequenceUri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintWorkflowXpsReceiver_AddDocumentData(self: *const T, documentId: u32, documentPrintTicket: ?*IStream, documentUri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintWorkflowXpsReceiver_AddPage(self: *const T, documentId: u32, pageId: u32, pageReference: ?*IXpsOMPageReference, pageUri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const IPrinterPropertyBag = @import("../../../../windows/win32/graphics/printing.zig").IPrinterPropertyBag;
const IPrinterQueue = @import("../../../../windows/win32/graphics/printing.zig").IPrinterQueue;
const IStream = @import("../../../../windows/win32/system/com.zig").IStream;
const IUnknown = @import("../../../../windows/win32/system/com.zig").IUnknown;
const IXpsDocumentPackageTarget = @import("../../../../windows/win32/storage/xps.zig").IXpsDocumentPackageTarget;
const IXpsOMObjectFactory1 = @import("../../../../windows/win32/storage/xps.zig").IXpsOMObjectFactory1;
const IXpsOMPageReference = @import("../../../../windows/win32/storage/xps.zig").IXpsOMPageReference;
