...
pub const FIRMWARE_REQUEST_FLAG_REPLACE_EXISTING_IMAGE = @as(u32, 1073741824);
...
pub const ISCSI_CONNECTION_INFOW = extern struct {
    ...
    InitiatorAddress: ?[*]align(1) u16,
    TargetAddress: ?[*]align(1) u16,
    InitiatorSocket: u16,
    TargetSocket: u16,
    CID: [2]u8,
};
...
pub const ISCSI_SESSION_INFOW = extern struct {
    SessionId: ISCSI_UNIQUE_SESSION_ID,
    InitiatorName: ?[*]align(1) u16,
    TargetNodeName: ?[*]align(1) u16,
    TargetName: ?[*]align(1) u16,
    ISID: [6]u8,
    TSID: [2]u8,
    ConnectionCount: u32,
...
pub const ISCSI_CONNECTION_INFOA = extern struct {
    ConnectionId: ISCSI_UNIQUE_SESSION_ID,
    InitiatorAddress: ?[*]align(1) u8,
    TargetAddress: ?[*]align(1) u8,
    InitiatorSocket: u16,
    TargetSocket: u16,
    CID: [2]u8,
};
...
pub const ISCSI_SESSION_INFOA = extern struct {
    SessionId: ISCSI_UNIQUE_SESSION_ID,
    InitiatorName: ?[*]align(1) u8,
    TargetNodeName: ?[*]align(1) u8,
    TargetName: ?[*]align(1) u8,
    ISID: [6]u8,
    TSID: [2]u8,
    ConnectionCount: u32,
...
pub extern "iscsidsc" fn GetIScsiInitiatorNodeNameW(
    InitiatorNodeName: ?[*]align(1) u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iscsidsc" fn GetIScsiInitiatorNodeNameA(
    InitiatorNodeName: ?[*]align(1) u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
const STORAGE_DEVICE_NUMBER = @import("../../../windows/win32/system/ioctl.zig").STORAGE_DEVICE_NUMBER;
