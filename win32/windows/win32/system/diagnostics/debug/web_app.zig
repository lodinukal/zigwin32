...
pub const IWebApplicationScriptEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebApplicationScriptEvents_ScriptError(self: *const T, htmlWindow: ?*IHTMLWindow2, scriptError: ?*IActiveScriptError, url: ?[*:0]align(1) const u16, errorHandled: BOOL) callconv(.Inline) HRESULT {
...
pub const IWebApplicationNavigationEvents = extern struct {
    pub const VTable = extern struct {
        ...
        BeforeNavigate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                url: ?[*:0]align(1) const u16,
                navigationFlags: u32,
                targetFrameName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWebApplicationNavigationEvents,
                htmlWindow: ?*IHTMLWindow2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebApplicationNavigationEvents_BeforeNavigate(self: *const T, htmlWindow: ?*IHTMLWindow2, url: ?[*:0]align(1) const u16, navigationFlags: u32, targetFrameName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebApplicationNavigationEvents_NavigateComplete(self: *const T, htmlWindow: ?*IHTMLWindow2, url: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebApplicationNavigationEvents_NavigateError(self: *const T, htmlWindow: ?*IHTMLWindow2, url: ?[*:0]align(1) const u16, targetFrameName: ?[*:0]align(1) const u16, statusCode: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebApplicationNavigationEvents_DocumentComplete(self: *const T, htmlWindow: ?*IHTMLWindow2, url: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const IActiveScriptError = @import("../../../../../windows/win32/system/diagnostics/debug/active_script.zig").IActiveScriptError;
