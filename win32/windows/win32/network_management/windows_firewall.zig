...
pub const IDynamicPortMappingCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDynamicPortMappingCollection_Add(self: *const T, bstrRemoteHost: ?BSTR, lExternalPort: i32, bstrProtocol: ?BSTR, lInternalPort: i32, bstrInternalClient: ?BSTR, bEnabled: VARIANT_BOOL, bstrDescription: ?BSTR, lLeaseDuration: i32, ppDPM: ?*?*IDynamicPortMapping) callconv(.Inline) HRESULT {
...
pub const IDynamicPortMapping = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDynamicPortMapping_get_Enabled(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDynamicPortMapping_Enable(self: *const T, vb: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IStaticPortMappingCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStaticPortMappingCollection_Add(self: *const T, lExternalPort: i32, bstrProtocol: ?BSTR, lInternalPort: i32, bstrInternalClient: ?BSTR, bEnabled: VARIANT_BOOL, bstrDescription: ?BSTR, ppSPM: ?*?*IStaticPortMapping) callconv(.Inline) HRESULT {
...
pub const IStaticPortMapping = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStaticPortMapping_get_Enabled(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStaticPortMapping_Enable(self: *const T, vb: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetConnection = extern struct {
    pub const VTable = extern struct {
        ...
        Duplicate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetConnection,
                pszwDuplicateName: ?[*:0]align(1) const u16,
        ...
        Rename: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetConnection,
                pszwNewName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const INetConnection,
                pszwNewName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetConnection_Duplicate(self: *const T, pszwDuplicateName: ?[*:0]align(1) const u16, ppCon: ?*?*INetConnection) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetConnection_Rename(self: *const T, pszwNewName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INetSharingPortMappingProps = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetSharingPortMappingProps_get_Enabled(self: *const T, pbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetSharingConfiguration = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetSharingConfiguration_get_SharingEnabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetSharingConfiguration_get_InternetFirewallEnabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetSharingManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetSharingManager_get_SharingInstalled(self: *const T, pbInstalled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const PNETISO_EDP_ID_CALLBACK_FN = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        context: ?*anyopaque,
        wszEnterpriseId: ?[*:0]align(1) const u16,
        dwErr: u32,
    ) callconv(@import("std").os.windows.WINAPI) void,
    else => *const fn(
        context: ?*anyopaque,
...
pub const FW_DYNAMIC_KEYWORD_ADDRESS0 = extern struct {
    id: Guid,
    keyword: ?[*:0]align(1) const u16,
    flags: u32,
    addresses: ?[*:0]align(1) const u16,
};
...
pub const FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS = enum(i32) {
    E = 1,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
    }) FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS {
        return @as(FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS, @enumFromInt(
              (if (o.E == 1) @intFromEnum(FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS.E) else 0)
        ));
    }
};
pub const FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS_AUTO_RESOLVE = FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS.E;

pub const FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS = enum(i32) {
    AUTO_RESOLVE = 1,
    NON_AUTO_RESOLVE = 2,
    ALL = 3,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS, @enumFromInt(
              (if (o.AUTO_RESOLVE == 1) @intFromEnum(FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.AUTO_RESOLVE) else 0)
            | (if (o.NON_AUTO_RESOLVE == 1) @intFromEnum(FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.NON_AUTO_RESOLVE) else 0)
            | (if (o.ALL == 1) @intFromEnum(FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.ALL) else 0)
        ));
    }
};
pub const FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS_AUTO_RESOLVE = FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.AUTO_RESOLVE;
pub const FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS_NON_AUTO_RESOLVE = FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.NON_AUTO_RESOLVE;
pub const FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS_ALL = FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS.ALL;
...
pub const PFN_FWUPDATEDYNAMICKEYWORDADDRESS0 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        dynamicKeywordAddressId: Guid,
        updatedAddresses: ?[*:0]align(1) const u16,
        append: BOOL,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        dynamicKeywordAddressId: Guid,
...
pub const INetFwRemoteAdminSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRemoteAdminSettings_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRemoteAdminSettings_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwIcmpSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowOutboundDestinationUnreachable(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowOutboundDestinationUnreachable(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowRedirect(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowRedirect(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowInboundEchoRequest(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowInboundEchoRequest(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowOutboundTimeExceeded(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowOutboundTimeExceeded(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowOutboundParameterProblem(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowOutboundParameterProblem(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowOutboundSourceQuench(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowOutboundSourceQuench(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowInboundRouterRequest(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowInboundRouterRequest(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowInboundTimestampRequest(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowInboundTimestampRequest(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowInboundMaskRequest(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowInboundMaskRequest(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_get_AllowOutboundPacketTooBig(self: *const T, allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwIcmpSettings_put_AllowOutboundPacketTooBig(self: *const T, allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwOpenPort = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwOpenPort_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwOpenPort.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const INetFwOpenPort, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwOpenPort_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwOpenPort.VTable, @ptrCast(self.vtable)).put_Enabled(@as(*const INetFwOpenPort, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwOpenPort_get_BuiltIn(self: *const T, builtIn: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwService = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwService_get_Customized(self: *const T, customized: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwService_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwService.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const INetFwService, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwService_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwAuthorizedApplication = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwAuthorizedApplication_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwAuthorizedApplication_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwRule = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRule_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwRule.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const INetFwRule, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRule_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRule_get_EdgeTraversal(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwRule.VTable, @ptrCast(self.vtable)).get_EdgeTraversal(@as(*const INetFwRule, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwRule_put_EdgeTraversal(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwServiceRestriction = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwServiceRestriction_RestrictService(self: *const T, serviceName: ?BSTR, appName: ?BSTR, restrictService: VARIANT_BOOL, serviceSidRestricted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwServiceRestriction_ServiceRestricted(self: *const T, serviceName: ?BSTR, appName: ?BSTR, serviceRestricted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwProfile = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_get_FirewallEnabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwProfile.VTable, @ptrCast(self.vtable)).get_FirewallEnabled(@as(*const INetFwProfile, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_put_FirewallEnabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetFwProfile.VTable, @ptrCast(self.vtable)).put_FirewallEnabled(@as(*const INetFwProfile, @ptrCast(self)), enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_get_ExceptionsNotAllowed(self: *const T, notAllowed: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_put_ExceptionsNotAllowed(self: *const T, notAllowed: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_get_NotificationsDisabled(self: *const T, disabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_put_NotificationsDisabled(self: *const T, disabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_get_UnicastResponsesToMulticastBroadcastDisabled(self: *const T, disabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwProfile_put_UnicastResponsesToMulticastBroadcastDisabled(self: *const T, disabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetFwPolicy2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_get_FirewallEnabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_put_FirewallEnabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_get_BlockAllInboundTraffic(self: *const T, profileType: NET_FW_PROFILE_TYPE2, Block: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_put_BlockAllInboundTraffic(self: *const T, profileType: NET_FW_PROFILE_TYPE2, Block: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_get_NotificationsDisabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, disabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_put_NotificationsDisabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, disabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_get_UnicastResponsesToMulticastBroadcastDisabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, disabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_put_UnicastResponsesToMulticastBroadcastDisabled(self: *const T, profileType: NET_FW_PROFILE_TYPE2, disabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_EnableRuleGroup(self: *const T, profileTypesBitmask: i32, group: ?BSTR, enable: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_IsRuleGroupEnabled(self: *const T, profileTypesBitmask: i32, group: ?BSTR, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetFwPolicy2_get_IsRuleGroupCurrentlyEnabled(self: *const T, group: ?BSTR, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
//--------------------------------------------------------------------------------
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "netshell" fn NcFreeNetconProperties(
    pProps: ?*NETCON_PROPERTIES,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "netshell" fn NcIsValidConnectionName(
    pszwName: ?[*:0]align(1) const u16,
...
pub extern "api-ms-win-net-isolation-l1-1-0" fn NetworkIsolationSetupAppContainerBinaries(
    ...
    packageFolder: ?[*:0]align(1) const u16,
    displayName: ?[*:0]align(1) const u16,
    bBinariesFullyComputed: BOOL,
    binaries: [*]const ?[*:0]align(1) const u16,
    binariesCount: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.0'
pub extern "firewallapi" fn NetworkIsolationEnumerateAppContainerRules(
...
pub extern "api-ms-win-net-isolation-l1-1-0" fn NetworkIsolationDiagnoseConnectFailureAndGetInfo(
    wszServerName: ?[*:0]align(1) const u16,
    netIsoError: ?*NETISO_ERROR_TYPE,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "firewallapi" fn NetworkIsolationGetEnterpriseIdAsync(
    wszServerName: ?[*:0]align(1) const u16,
    dwFlags: u32,
    context: ?*anyopaque,
...
// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "firewallapi" fn NetworkIsolationGetEnterpriseIdClose(
    hOperation: ?HANDLE,
