...
//--------------------------------------------------------------------------------
pub const DXGI_RESOURCE_PRIORITY_MINIMUM = @as(u32, 671088640);
pub const DXGI_RESOURCE_PRIORITY_LOW = @as(u32, 1342177280);
pub const DXGI_RESOURCE_PRIORITY_NORMAL = @as(u32, 2013265920);
pub const DXGI_RESOURCE_PRIORITY_HIGH = @as(u32, 2684354560);
pub const DXGI_RESOURCE_PRIORITY_MAXIMUM = @as(u32, 3355443200);
...
pub const DXGI_ERROR_MPO_UNPINNED = @import("../../../zig.zig").typedConst(HRESULT, @as(i32, -2005270428));
...
pub const DXGI_USAGE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        SHADER_INPUT: u1 = 0,
        RENDER_TARGET_OUTPUT: u1 = 0,
        BACK_BUFFER: u1 = 0,
        SHARED: u1 = 0,
        READ_ONLY: u1 = 0,
        DISCARD_ON_PRESENT: u1 = 0,
        UNORDERED_ACCESS: u1 = 0,
    }) DXGI_USAGE {
        return @as(DXGI_USAGE, @enumFromInt(
              (if (o.SHADER_INPUT == 1) @intFromEnum(DXGI_USAGE.SHADER_INPUT) else 0)
            | (if (o.RENDER_TARGET_OUTPUT == 1) @intFromEnum(DXGI_USAGE.RENDER_TARGET_OUTPUT) else 0)
            | (if (o.BACK_BUFFER == 1) @intFromEnum(DXGI_USAGE.BACK_BUFFER) else 0)
            | (if (o.SHARED == 1) @intFromEnum(DXGI_USAGE.SHARED) else 0)
            | (if (o.READ_ONLY == 1) @intFromEnum(DXGI_USAGE.READ_ONLY) else 0)
            | (if (o.DISCARD_ON_PRESENT == 1) @intFromEnum(DXGI_USAGE.DISCARD_ON_PRESENT) else 0)
            | (if (o.UNORDERED_ACCESS == 1) @intFromEnum(DXGI_USAGE.UNORDERED_ACCESS) else 0)
        ));
    }
};
pub const DXGI_USAGE_SHADER_INPUT = DXGI_USAGE.SHADER_INPUT;
pub const DXGI_USAGE_RENDER_TARGET_OUTPUT = DXGI_USAGE.RENDER_TARGET_OUTPUT;
pub const DXGI_USAGE_BACK_BUFFER = DXGI_USAGE.BACK_BUFFER;
pub const DXGI_USAGE_SHARED = DXGI_USAGE.SHARED;
pub const DXGI_USAGE_READ_ONLY = DXGI_USAGE.READ_ONLY;
pub const DXGI_USAGE_DISCARD_ON_PRESENT = DXGI_USAGE.DISCARD_ON_PRESENT;
pub const DXGI_USAGE_UNORDERED_ACCESS = DXGI_USAGE.UNORDERED_ACCESS;
...
pub const IDXGIResource = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIResource_GetUsage(self: *const T, pUsage: ?*DXGI_USAGE) callconv(.Inline) HRESULT {
            return @as(*const IDXGIResource.VTable, @ptrCast(self.vtable)).GetUsage(@as(*const IDXGIResource, @ptrCast(self)), pUsage);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIResource_SetEvictionPriority(self: *const T, EvictionPriority: u32) callconv(.Inline) HRESULT {
...
pub const IDXGIAdapter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIAdapter_CheckInterfaceSupport(self: *const T, InterfaceName: ?*const Guid, pUMDVersion: ?*i64) callconv(.Inline) HRESULT {
...
pub const IDXGIFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIFactory_CreateSoftwareAdapter(self: *const T, Module: HMODULE, ppAdapter: ?*?*IDXGIAdapter) callconv(.Inline) HRESULT {
...
pub const IDXGIDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIDevice_CreateSurface(self: *const T, pDesc: ?*const DXGI_SURFACE_DESC, NumSurfaces: u32, Usage: DXGI_USAGE, pSharedResource: ?*const DXGI_SHARED_RESOURCE, ppSurface: [*]?*IDXGISurface) callconv(.Inline) HRESULT {
...
pub const DXGI_ADAPTER_FLAG = enum(i32) {
    NONE = 0,
    REMOTE = 1,
    SOFTWARE = 2,
    _,
...
pub const IDXGIResource1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIResource1_CreateSharedHandle(self: *const T, pAttributes: ?*const SECURITY_ATTRIBUTES, dwAccess: u32, lpName: ?[*:0]align(1) const u16, pHandle: ?*?HANDLE) callconv(.Inline) HRESULT {
...
pub const DXGI_ADAPTER_FLAG3 = enum(i32) {
    NONE = 0,
    REMOTE = 1,
    SOFTWARE = 2,
    ACG_COMPATIBLE = 4,
...
pub const DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS = enum(i32) {
    FULLSCREEN = 1,
    WINDOWED = 2,
    CURSOR_STRETCHED = 4,
    _,
...
pub const DXGI_DEBUG_RLO_FLAGS = enum(i32) {
    SUMMARY = 1,
    DETAIL = 2,
    IGNORE_INTERNAL = 4,
    ALL = 7,
...
pub const IDXGIInfoQueue = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIInfoQueue_AddMessage(self: *const T, Producer: Guid, Category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, ID: i32, pDescription: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDXGIInfoQueue_AddApplicationMessage(self: *const T, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, pDescription: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
...
pub extern "dxgi" fn DXGIDisableVBlankVirtualization(
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const DXGI_ALPHA_MODE = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_ALPHA_MODE;
...
const DXGI_GAMMA_CONTROL = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_GAMMA_CONTROL;
const DXGI_GAMMA_CONTROL_CAPABILITIES = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_GAMMA_CONTROL_CAPABILITIES;
const DXGI_MODE_DESC = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_MODE_DESC;
const DXGI_MODE_ROTATION = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_MODE_ROTATION;
const DXGI_MODE_SCALING = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_MODE_SCALING;
const DXGI_MODE_SCANLINE_ORDER = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_MODE_SCANLINE_ORDER;
const DXGI_RATIONAL = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_RATIONAL;
