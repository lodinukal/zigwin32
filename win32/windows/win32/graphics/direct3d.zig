...
pub const D3D_PRIMITIVE_TOPOLOGY = enum(i32) {
    ...
    _PRIMITIVE_TOPOLOGY_TRIANGLEFAN = 6,
...
pub const D3D_PRIMITIVE_TOPOLOGY_TRIANGLEFAN = D3D_PRIMITIVE_TOPOLOGY._PRIMITIVE_TOPOLOGY_TRIANGLEFAN;
...
pub const ID3DInclude = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3DInclude_Open(self: *const T, IncludeType: D3D_INCLUDE_TYPE, pFileName: ?[*:0]align(1) const u8, pParentData: ?*const anyopaque, ppData: ?*?*anyopaque, pBytes: ?*u32) callconv(.Inline) HRESULT {
...
pub const D3D_FORMAT_LAYOUT = enum(i32) {
    STANDARD = 0,
    CUSTOM = -1,
};
pub const D3DFL_STANDARD = D3D_FORMAT_LAYOUT.STANDARD;
pub const D3DFL_CUSTOM = D3D_FORMAT_LAYOUT.CUSTOM;

pub const D3D_FORMAT_TYPE_LEVEL = enum(i32) {
    NO_TYPE = 0,
    PARTIAL_TYPE = -2,
    FULL_TYPE = -1,
};
pub const D3DFTL_NO_TYPE = D3D_FORMAT_TYPE_LEVEL.NO_TYPE;
pub const D3DFTL_PARTIAL_TYPE = D3D_FORMAT_TYPE_LEVEL.PARTIAL_TYPE;
pub const D3DFTL_FULL_TYPE = D3D_FORMAT_TYPE_LEVEL.FULL_TYPE;

pub const D3D_FORMAT_COMPONENT_NAME = enum(i32) {
    R = -4,
    G = -3,
    B = -2,
    A = -1,
...
pub const D3DFCN_R = D3D_FORMAT_COMPONENT_NAME.R;
pub const D3DFCN_G = D3D_FORMAT_COMPONENT_NAME.G;
pub const D3DFCN_B = D3D_FORMAT_COMPONENT_NAME.B;
pub const D3DFCN_A = D3D_FORMAT_COMPONENT_NAME.A;
pub const D3DFCN_D = D3D_FORMAT_COMPONENT_NAME.D;
pub const D3DFCN_S = D3D_FORMAT_COMPONENT_NAME.S;
pub const D3DFCN_X = D3D_FORMAT_COMPONENT_NAME.X;

pub const D3D_FORMAT_COMPONENT_INTERPRETATION = enum(i32) {
    TYPELESS = 0,
    FLOAT = -4,
    SNORM = -3,
    UNORM = -2,
...
pub const D3DFCI_TYPELESS = D3D_FORMAT_COMPONENT_INTERPRETATION.TYPELESS;
pub const D3DFCI_FLOAT = D3D_FORMAT_COMPONENT_INTERPRETATION.FLOAT;
pub const D3DFCI_SNORM = D3D_FORMAT_COMPONENT_INTERPRETATION.SNORM;
pub const D3DFCI_UNORM = D3D_FORMAT_COMPONENT_INTERPRETATION.UNORM;
pub const D3DFCI_SINT = D3D_FORMAT_COMPONENT_INTERPRETATION.SINT;
pub const D3DFCI_UINT = D3D_FORMAT_COMPONENT_INTERPRETATION.UINT;
pub const D3DFCI_UNORM_SRGB = D3D_FORMAT_COMPONENT_INTERPRETATION.UNORM_SRGB;
pub const D3DFCI_BIASED_FIXED_2_8 = D3D_FORMAT_COMPONENT_INTERPRETATION.BIASED_FIXED_2_8;
