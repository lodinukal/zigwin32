...
pub const AUTHZ_INIT_INFO = extern struct {
    version: u16,
    szResourceManagerName: ?[*:0]align(1) const u16,
...
pub const IAzAuthorizationStore3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzAuthorizationStore3_IsUpdateNeeded(self: *const T, pbIsUpdateNeeded: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzAuthorizationStore3_BizruleGroupSupported(self: *const T, pbSupported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzAuthorizationStore3_IsFunctionalLevelUpgradeSupported(self: *const T, lFunctionalLevel: i32, pbSupported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAzClientContext3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzClientContext3_IsInRoleAssignment(self: *const T, bstrScopeName: ?BSTR, bstrRoleName: ?BSTR, pbIsInRole: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAzApplication3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzApplication3_ScopeExists(self: *const T, bstrScopeName: ?BSTR, pbExist: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzApplication3_get_BizRulesEnabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzApplication3_put_BizRulesEnabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAzOperation2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzOperation2_RoleAssignments(self: *const T, bstrScopeName: ?BSTR, bRecursive: VARIANT_BOOL, ppRoleAssignments: ?*?*IAzRoleAssignments) callconv(.Inline) HRESULT {
...
pub const IAzRoleDefinition = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzRoleDefinition_RoleAssignments(self: *const T, bstrScopeName: ?BSTR, bRecursive: VARIANT_BOOL, ppRoleAssignments: ?*?*IAzRoleAssignments) callconv(.Inline) HRESULT {
...
pub const IAzApplicationGroup2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzApplicationGroup2_RoleAssignments(self: *const T, bstrScopeName: ?BSTR, bRecursive: VARIANT_BOOL, ppRoleAssignments: ?*?*IAzRoleAssignments) callconv(.Inline) HRESULT {
...
pub const IAzTask2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IAzTask.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAzTask2_RoleAssignments(self: *const T, bstrScopeName: ?BSTR, bRecursive: VARIANT_BOOL, ppRoleAssignments: ?*?*IAzRoleAssignments) callconv(.Inline) HRESULT {
...
// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE = isize;
...
pub extern "authz" fn AuthzAccessCheck(
    ...
    phAccessCheckResults: ?*AUTHZ_ACCESS_CHECK_RESULTS_HANDLE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "authz" fn AuthzInitializeObjectAccessAuditEvent(
    ...
    phAuditEvent: ?*?AUTHZ_AUDIT_EVENT_HANDLE,
...
pub extern "authz" fn AuthzUninstallSecurityEventSource(
    dwFlags: u32,
    szEventSourceName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "authz" fn AuthzRegisterSecurityEventSource(
    dwFlags: u32,
    szEventSourceName: ?[*:0]align(1) const u16,
    phEventProvider: ?*AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "authz" fn AuthzRegisterCapChangeNotification(
    phCapChangeSubscription: ?*AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE,
...
pub extern "advapi32" fn GetNamedSecurityInfoA(
    pObjectName: ?[*:0]align(1) const u8,
    ObjectType: SE_OBJECT_TYPE,
...
pub extern "advapi32" fn ConvertStringSecurityDescriptorToSecurityDescriptorW(
    StringSecurityDescriptor: ?[*:0]align(1) const u16,
    StringSDRevision: u32,
    SecurityDescriptor: ?*?PSECURITY_DESCRIPTOR,
    SecurityDescriptorSize: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
const ACE_HEADER = @import("../../../windows/win32/security.zig").ACE_HEADER;
...
const SYSTEM_AUDIT_OBJECT_ACE_FLAGS = @import("../../../windows/win32/security.zig").SYSTEM_AUDIT_OBJECT_ACE_FLAGS;
