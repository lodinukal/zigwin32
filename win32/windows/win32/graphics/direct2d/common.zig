...
pub const D2D1_ALPHA_MODE = enum(i32) {
    UNKNOWN = 0,
    PREMULTIPLIED = 1,
    STRAIGHT = 2,
    IGNORE = 3,
...
pub const D2D1_FIGURE_BEGIN = enum(i32) {
    FILLED = 0,
    HOLLOW = 1,
};
...
pub const D2D1_FIGURE_END = enum(i32) {
    OPEN = 0,
    CLOSED = 1,
};
...
pub const D2D1_PATH_SEGMENT = enum(i32) {
    NONE = 0,
    FORCE_UNSTROKED = 1,
...
pub const D2D1_FILL_MODE = enum(i32) {
    ALTERNATE = 0,
    WINDING = 1,
};
...
pub const D2D1_BORDER_MODE = enum(i32) {
    SOFT = 0,
    HARD = 1,
};
...
pub const D2D1_BLEND_MODE = enum(i32) {
    MULTIPLY = 0,
    SCREEN = 1,
    DARKEN = 2,
    LIGHTEN = 3,
...
pub const D2D1_COLORMATRIX_ALPHA_MODE = enum(i32) {
    PREMULTIPLIED = 1,
    STRAIGHT = 2,
};
...
pub const D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
...
pub const D2D1_TURBULENCE_NOISE = enum(i32) {
    FRACTAL_SUM = 0,
    TURBULENCE = 1,
};
...
pub const D2D1_COMPOSITE_MODE = enum(i32) {
    SOURCE_OVER = 0,
    DESTINATION_OVER = 1,
    SOURCE_IN = 2,
    DESTINATION_IN = 3,
