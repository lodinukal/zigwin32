...
pub const USB_RESERVED_USER_BASE = @as(u32, 1024);
...
// Section: Types (208)
//--------------------------------------------------------------------------------
pub const WINUSB_PIPE_POLICY = enum(u32) {
...
pub const SHORT_PACKET_TERMINATE = WINUSB_PIPE_POLICY.SHORT_PACKET_TERMINATE;
pub const AUTO_CLEAR_STALL = WINUSB_PIPE_POLICY.AUTO_CLEAR_STALL;
pub const PIPE_TRANSFER_TIMEOUT = WINUSB_PIPE_POLICY.PIPE_TRANSFER_TIMEOUT;
pub const IGNORE_SHORT_PACKETS = WINUSB_PIPE_POLICY.IGNORE_SHORT_PACKETS;
pub const ALLOW_PARTIAL_READS = WINUSB_PIPE_POLICY.ALLOW_PARTIAL_READS;
pub const AUTO_FLUSH = WINUSB_PIPE_POLICY.AUTO_FLUSH;
pub const RAW_IO = WINUSB_PIPE_POLICY.RAW_IO;
pub const MAXIMUM_TRANSFER_SIZE = WINUSB_PIPE_POLICY.MAXIMUM_TRANSFER_SIZE;
pub const RESET_PIPE_ON_RESUME = WINUSB_PIPE_POLICY.RESET_PIPE_ON_RESUME;

pub const WINUSB_POWER_POLICY = enum(u32) {
    AUTO_SUSPEND = 129,
    SUSPEND_DELAY = 131,
};
pub const AUTO_SUSPEND = WINUSB_POWER_POLICY.AUTO_SUSPEND;
pub const SUSPEND_DELAY = WINUSB_POWER_POLICY.SUSPEND_DELAY;

// TODO: this type has a FreeFunc 'WinUsb_Free', what can Zig do with this information?
// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const WINUSB_INTERFACE_HANDLE = isize;

pub const USB_CHANGE_REGISTRATION_HANDLE = isize;
...
pub const USBD_ENDPOINT_OFFLOAD_INFORMATION = extern struct {
    ...
    EventRingSegmentLA: i64 align(1),
...
pub const USB_HUB_NODE = enum(i32) {
    Hub = 0,
    MIParent = 1,
};
pub const UsbHub = USB_HUB_NODE.Hub;
pub const UsbMIParent = USB_HUB_NODE.MIParent;
...
pub const USB_MI_PARENT_INFORMATION = extern struct {
    NumberOfInterfaces: u32 align(1),
};

pub const USB_NODE_INFORMATION = extern struct {
    NodeType: USB_HUB_NODE align(1),
    u: extern union {
...
pub const USB_PIPE_INFO = extern struct {
    EndpointDescriptor: USB_ENDPOINT_DESCRIPTOR align(1),
    ScheduleOffset: u32 align(1),
};

pub const USB_CONNECTION_STATUS = enum(i32) {
    NoDeviceConnected = 0,
    DeviceConnected = 1,
...
pub const NoDeviceConnected = USB_CONNECTION_STATUS.NoDeviceConnected;
pub const DeviceConnected = USB_CONNECTION_STATUS.DeviceConnected;
pub const DeviceFailedEnumeration = USB_CONNECTION_STATUS.DeviceFailedEnumeration;
pub const DeviceGeneralFailure = USB_CONNECTION_STATUS.DeviceGeneralFailure;
pub const DeviceCausedOvercurrent = USB_CONNECTION_STATUS.DeviceCausedOvercurrent;
pub const DeviceNotEnoughPower = USB_CONNECTION_STATUS.DeviceNotEnoughPower;
pub const DeviceNotEnoughBandwidth = USB_CONNECTION_STATUS.DeviceNotEnoughBandwidth;
pub const DeviceHubNestedTooDeeply = USB_CONNECTION_STATUS.DeviceHubNestedTooDeeply;
pub const DeviceInLegacyHub = USB_CONNECTION_STATUS.DeviceInLegacyHub;
pub const DeviceEnumerating = USB_CONNECTION_STATUS.DeviceEnumerating;
pub const DeviceReset = USB_CONNECTION_STATUS.DeviceReset;

pub const USB_NODE_CONNECTION_INFORMATION = extern struct {
    ConnectionIndex: u32 align(1),
    DeviceDescriptor: USB_DEVICE_DESCRIPTOR align(1),
    CurrentConfigurationValue: u8 align(1),
    LowSpeed: BOOLEAN align(1),
    DeviceIsHub: BOOLEAN align(1),
    DeviceAddress: u16 align(1),
    NumberOfOpenPipes: u32 align(1),
    ConnectionStatus: USB_CONNECTION_STATUS align(1),
    PipeList: [1]USB_PIPE_INFO align(1),
};

pub const USB_NODE_CONNECTION_DRIVERKEY_NAME = extern struct {
    ConnectionIndex: u32 align(1),
    ActualLength: u32 align(1),
    DriverKeyName: [1]u16 align(1),
};

pub const USB_NODE_CONNECTION_NAME = extern struct {
    ConnectionIndex: u32 align(1),
    ActualLength: u32 align(1),
    NodeName: [1]u16 align(1),
};

pub const USB_HUB_NAME = extern struct {
    ActualLength: u32 align(1),
    HubName: [1]u16 align(1),
};

pub const USB_ROOT_HUB_NAME = extern struct {
    ActualLength: u32 align(1),
    RootHubName: [1]u16 align(1),
};
...
pub const USB_DESCRIPTOR_REQUEST = extern struct {
    ConnectionIndex: u32 align(1),
    SetupPacket: extern struct {
        bmRequest: u8 align(1),
        bRequest: u8 align(1),
        wValue: u16 align(1),
        wIndex: u16 align(1),
        wLength: u16 align(1),
...
pub const USB_CYCLE_PORT_PARAMS = extern struct {
    ConnectionIndex: u32 align(1),
    StatusReturned: u32 align(1),
};

pub const USB_ID_STRING = extern struct {
    LanguageId: u16 align(1),
    Pad: u16 align(1),
    LengthInBytes: u32 align(1),
    Buffer: ?[*]align(1) u16 align(1),
};

pub const USB_HUB_DEVICE_UXD_SETTINGS = extern struct {
    Version: u32 align(1),
    PnpGuid: Guid align(1),
    OwnerGuid: Guid align(1),
    DeleteOnShutdown: u32 align(1),
    DeleteOnReload: u32 align(1),
    DeleteOnDisconnect: u32 align(1),
...
pub const HUB_DEVICE_CONFIG_INFO = extern struct {
    Version: u32 align(1),
    Length: u32 align(1),
    HubFlags: USB_HUB_CAP_FLAGS align(1),
    HardwareIds: USB_ID_STRING align(1),
    CompatibleIds: USB_ID_STRING align(1),
    DeviceDescription: USB_ID_STRING align(1),
    Reserved: [19]u32 align(1),
    UxdSettings: USB_HUB_DEVICE_UXD_SETTINGS align(1),
};

pub const HCD_STAT_COUNTERS = extern struct {
    BytesTransferred: u32 align(1),
    IsoMissedCount: u16 align(1),
    DataOverrunErrorCount: u16 align(1),
    CrcErrorCount: u16 align(1),
    ScheduleOverrunCount: u16 align(1),
    TimeoutErrorCount: u16 align(1),
    InternalHcErrorCount: u16 align(1),
    BufferOverrunErrorCount: u16 align(1),
    SWErrorCount: u16 align(1),
    StallPidCount: u16 align(1),
    PortDisableCount: u16 align(1),
};

pub const HCD_ISO_STAT_COUNTERS = extern struct {
    LateUrbs: u16 align(1),
    DoubleBufferedPackets: u16 align(1),
    TransfersCF_5ms: u16 align(1),
    TransfersCF_2ms: u16 align(1),
    TransfersCF_1ms: u16 align(1),
    MaxInterruptLatency: u16 align(1),
    BadStartFrame: u16 align(1),
    StaleUrbs: u16 align(1),
    IsoPacketNotAccesed: u16 align(1),
    IsoPacketHWError: u16 align(1),
    SmallestUrbPacketCount: u16 align(1),
    LargestUrbPacketCount: u16 align(1),
    IsoCRC_Error: u16 align(1),
    IsoOVERRUN_Error: u16 align(1),
    IsoINTERNAL_Error: u16 align(1),
    IsoUNKNOWN_Error: u16 align(1),
    IsoBytesTransferred: u32 align(1),
    LateMissedCount: u16 align(1),
    HWIsoMissedCount: u16 align(1),
    Reserved7: [8]u32 align(1),
};

pub const HCD_STAT_INFORMATION_1 = extern struct {
    Reserved1: u32 align(1),
    Reserved2: u32 align(1),
    ResetCounters: u32 align(1),
    TimeRead: i64 align(1),
    Counters: HCD_STAT_COUNTERS align(1),
};
...
pub const HCD_STAT_INFORMATION_2 = extern struct {
    ...
    ResetCounters: u32 align(1),
    TimeRead: i64 align(1),
    LockedMemoryUsed: i32 align(1),
    Counters: HCD_STAT_COUNTERS align(1),
    IsoCounters: HCD_ISO_STAT_COUNTERS align(1),
};

pub const USB_NOTIFICATION_TYPE = enum(i32) {
...
pub const EnumerationFailure = USB_NOTIFICATION_TYPE.EnumerationFailure;
pub const InsufficentBandwidth = USB_NOTIFICATION_TYPE.InsufficentBandwidth;
pub const InsufficentPower = USB_NOTIFICATION_TYPE.InsufficentPower;
pub const OverCurrent = USB_NOTIFICATION_TYPE.OverCurrent;
pub const ResetOvercurrent = USB_NOTIFICATION_TYPE.ResetOvercurrent;
pub const AcquireBusInfo = USB_NOTIFICATION_TYPE.AcquireBusInfo;
pub const AcquireHubName = USB_NOTIFICATION_TYPE.AcquireHubName;
pub const AcquireControllerName = USB_NOTIFICATION_TYPE.AcquireControllerName;
pub const HubOvercurrent = USB_NOTIFICATION_TYPE.HubOvercurrent;
pub const HubPowerChange = USB_NOTIFICATION_TYPE.HubPowerChange;
pub const HubNestedTooDeeply = USB_NOTIFICATION_TYPE.HubNestedTooDeeply;
pub const ModernDeviceInLegacyHub = USB_NOTIFICATION_TYPE.ModernDeviceInLegacyHub;

pub const USB_NOTIFICATION = extern struct {
    NotificationType: USB_NOTIFICATION_TYPE align(1),
};

pub const USB_CONNECTION_NOTIFICATION = extern struct {
    NotificationType: USB_NOTIFICATION_TYPE align(1),
    ConnectionNumber: u32 align(1),
    RequestedBandwidth: u32 align(1),
    EnumerationFailReason: u32 align(1),
    PowerRequested: u32 align(1),
    HubNameLength: u32 align(1),
};

pub const USB_BUS_NOTIFICATION = extern struct {
    NotificationType: USB_NOTIFICATION_TYPE align(1),
    TotalBandwidth: u32 align(1),
    ConsumedBandwidth: u32 align(1),
    ControllerNameLength: u32 align(1),
};

pub const USB_ACQUIRE_INFO = extern struct {
    NotificationType: USB_NOTIFICATION_TYPE align(1),
    TotalSize: u32 align(1),
    Buffer: [1]u16 align(1),
};

pub const USB_WMI_DEVICE_NODE_TYPE = enum(i32) {
    UsbDevice = 0,
    HubDevice = 1,
    CompositeDevice = 2,
    UsbController = 3,
};
pub const UsbDevice = USB_WMI_DEVICE_NODE_TYPE.UsbDevice;
pub const HubDevice = USB_WMI_DEVICE_NODE_TYPE.HubDevice;
pub const CompositeDevice = USB_WMI_DEVICE_NODE_TYPE.CompositeDevice;
pub const UsbController = USB_WMI_DEVICE_NODE_TYPE.UsbController;
...
pub const USB_HUB_PORT_INFORMATION = extern struct {
    DeviceState: USB_DEVICE_STATE align(1),
    PortNumber: u16 align(1),
    DeviceAddress: u16 align(1),
    ConnectionIndex: u32 align(1),
    ConnectionStatus: USB_CONNECTION_STATUS align(1),
...
pub const USB_HUB_DEVICE_INFO = extern struct {
    HubDescriptor: USB_HUB_DESCRIPTOR align(1),
    HubNumber: u32 align(1),
    DeviceAddress: u16 align(1),
    HubIsSelfPowered: BOOLEAN align(1),
    HubIsRootHub: BOOLEAN align(1),
    HubCapabilities: USB_HUB_CAPABILITIES align(1),
    NumberOfHubPorts: u32 align(1),
    PortInfo: [1]USB_HUB_PORT_INFORMATION align(1),
};
...
pub const USB_DEVICE_INFO = extern struct {
    ...
    DeviceDescriptor: USB_DEVICE_DESCRIPTOR align(1),
    CurrentConfigurationValue: u8 align(1),
    Speed: USB_DEVICE_SPEED align(1),
    DeviceAddress: u16 align(1),
    ConnectionIndex: u32 align(1),
    ConnectionStatus: USB_CONNECTION_STATUS align(1),
    PnpHardwareId: [128]u16 align(1),
    PnpCompatibleId: [128]u16 align(1),
    SerialNumberId: [128]u16 align(1),
    PnpDeviceDescription: [128]u16 align(1),
    NumberOfOpenPipes: u32 align(1),
    PipeList: [1]USB_PIPE_INFO align(1),
};
...
pub const USB_DEVICE_NODE_INFO = extern struct {
    Sig: u32 align(1),
    LengthInBytes: u32 align(1),
    DeviceDescription: [40]u16 align(1),
    NodeType: USB_WMI_DEVICE_NODE_TYPE align(1),
    BusAddress: USB_TOPOLOGY_ADDRESS align(1),
    Anonymous: extern union {
...
pub const USB_DEVICE_PERFORMANCE_INFO = extern struct {
    ...
    IsoBytes: u32 align(1),
    InterruptBytes: u32 align(1),
    BulkUrbCount: u32 align(1),
    ControlUrbCount: u32 align(1),
    IsoUrbCount: u32 align(1),
    InterruptUrbCount: u32 align(1),
    AllocedInterrupt: [6]u32 align(1),
    AllocedIso: u32 align(1),
    Total32secBandwidth: u32 align(1),
    TotalTtBandwidth: u32 align(1),
    DeviceDescription: [60]u16 align(1),
    DeviceSpeed: USB_DEVICE_SPEED align(1),
    TotalIsoLatency: u32 align(1),
    DroppedIsoPackets: u32 align(1),
    TransferErrors: u32 align(1),
    PciInterruptCount: u32 align(1),
    HcIdleState: u32 align(1),
    HcAsyncIdleState: u32 align(1),
    HcAsyncCacheFlushCount: u32 align(1),
    HcPeriodicIdleState: u32 align(1),
    HcPeriodicCacheFlushCount: u32 align(1),
};

pub const USB_HUB_TYPE = enum(i32) {
    RootHub = 1,
    @"20Hub" = 2,
    @"30Hub" = 3,
};
pub const UsbRootHub = USB_HUB_TYPE.RootHub;
pub const Usb20Hub = USB_HUB_TYPE.@"20Hub";
pub const Usb30Hub = USB_HUB_TYPE.@"30Hub";

pub const USB_HUB_INFORMATION_EX = extern struct {
    HubType: USB_HUB_TYPE align(1),
    HighestPortNumber: u16 align(1),
    u: extern union {
...
pub const USB_PORT_CONNECTOR_PROPERTIES = extern struct {
    ConnectionIndex: u32 align(1),
    ActualLength: u32 align(1),
    UsbPortProperties: USB_PORT_PROPERTIES align(1),
    CompanionIndex: u16 align(1),
    CompanionPortNumber: u16 align(1),
    CompanionHubSymbolicLinkName: [1]u16 align(1),
};
...
pub const USB_NODE_CONNECTION_INFORMATION_EX_V2 = extern struct {
    ConnectionIndex: u32 align(1),
    Length: u32 align(1),
    SupportedUsbProtocols: USB_PROTOCOLS align(1),
    Flags: USB_NODE_CONNECTION_INFORMATION_EX_V2_FLAGS align(1),
};

pub const USB_TRANSPORT_CHARACTERISTICS = extern struct {
    Version: u32 align(1),
    TransportCharacteristicsFlags: u32 align(1),
    CurrentRoundtripLatencyInMilliSeconds: u64 align(1),
    MaxPotentialBandwidth: u64 align(1),
};

pub const USB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION = extern struct {
    ChangeNotificationInputFlags: u32 align(1),
    Handle: USB_CHANGE_REGISTRATION_HANDLE align(1),
    UsbTransportCharacteristics: USB_TRANSPORT_CHARACTERISTICS align(1),
};
...
pub const USB_DEVICE_CHARACTERISTICS = extern struct {
    Version: u32 align(1),
    Reserved: [2]u32 align(1),
    UsbDeviceCharacteristicsFlags: u32 align(1),
    MaximumSendPathDelayInMilliSeconds: u32 align(1),
    MaximumCompletionPathDelayInMilliSeconds: u32 align(1),
};
...
pub const USB_FRAME_NUMBER_AND_QPC_FOR_TIME_SYNC_INFORMATION = extern struct {
    ...
    QueryPerformanceCounterAtInputFrameOrMicroFrame: i64 align(1),
    QueryPerformanceCounterFrequency: i64 align(1),
    PredictedAccuracyInMicroSeconds: u32 align(1),
    CurrentGenerationID: u32 align(1),
    CurrentQueryPerformanceCounter: i64 align(1),
