...
pub const DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS = enum(i32) {
    EFAULT = 0,
...
pub const DIALOG_DPI_CHANGE_BEHAVIORS = enum(i32) {
    EFAULT = 0,
    ISABLE_ALL = 1,
    ISABLE_RESIZE = 2,
...
const HTHEME = @import("../../../windows/win32/ui/controls.zig").HTHEME;
...
const SYSTEM_METRICS_INDEX = @import("../../../windows/win32/ui/windows_and_messaging.zig").SYSTEM_METRICS_INDEX;
const WINDOW_EX_STYLE = @import("../../../windows/win32/ui/windows_and_messaging.zig").WINDOW_EX_STYLE;
const WINDOW_STYLE = @import("../../../windows/win32/ui/windows_and_messaging.zig").WINDOW_STYLE;
