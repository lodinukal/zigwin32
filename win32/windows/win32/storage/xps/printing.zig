...
const IID_IPrintDocumentPackageTarget2_Value = Guid.initString("c560298a-535c-48f9-866a-632540660cb4");
pub const IID_IPrintDocumentPackageTarget2 = &IID_IPrintDocumentPackageTarget2_Value;
pub const IPrintDocumentPackageTarget2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetIsTargetIppPrinter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintDocumentPackageTarget2,
                isIppPrinter: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintDocumentPackageTarget2,
        ...
        GetTargetIppPrintDevice: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintDocumentPackageTarget2,
                riid: ?*const Guid,
                ppvTarget: ?*?*anyopaque,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintDocumentPackageTarget2_GetIsTargetIppPrinter(self: *const T, isIppPrinter: ?*BOOL) callconv(.Inline) HRESULT {
            return @as(*const IPrintDocumentPackageTarget2.VTable, @ptrCast(self.vtable)).GetIsTargetIppPrinter(@as(*const IPrintDocumentPackageTarget2, @ptrCast(self)), isIppPrinter);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintDocumentPackageTarget2_GetTargetIppPrintDevice(self: *const T, riid: ?*const Guid, ppvTarget: ?*?*anyopaque) callconv(.Inline) HRESULT {
            return @as(*const IPrintDocumentPackageTarget2.VTable, @ptrCast(self.vtable)).GetTargetIppPrintDevice(@as(*const IPrintDocumentPackageTarget2, @ptrCast(self)), riid, ppvTarget);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IPrintDocumentPackageTargetFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintDocumentPackageTargetFactory_CreateDocumentPackageTargetForPrintJob(self: *const T, printerName: ?[*:0]align(1) const u16, jobName: ?[*:0]align(1) const u16, jobOutputStream: ?*IStream, jobPrintTicketStream: ?*IStream, docPackageTarget: ?*?*IPrintDocumentPackageTarget) callconv(.Inline) HRESULT {
...
const IXpsOMPackageTarget = @import("../../../../windows/win32/storage/xps.zig").IXpsOMPackageTarget;
