...
pub const IRDPSRAPIClipboardUseEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIClipboardUseEvents_OnPasteFromClipboard(self: *const T, clipboardFormat: u32, pAttendee: ?*IDispatch, pRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPSRAPIWindow = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIWindow_get_Shared(self: *const T, pRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IRDPSRAPIWindow.VTable, @ptrCast(self.vtable)).get_Shared(@as(*const IRDPSRAPIWindow, @ptrCast(self)), pRetVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIWindow_put_Shared(self: *const T, NewVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPSRAPIApplication = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIApplication_get_Shared(self: *const T, pRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIApplication_put_Shared(self: *const T, NewVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPSRAPIApplicationFilter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIApplicationFilter_get_Enabled(self: *const T, pRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIApplicationFilter_put_Enabled(self: *const T, NewVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPSRAPIInvitation = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIInvitation_get_Revoked(self: *const T, pRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIInvitation_put_Revoked(self: *const T, NewVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPSRAPIViewer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIViewer_put_SmartSizing(self: *const T, vbSmartSizing: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPSRAPIViewer_get_SmartSizing(self: *const T, pvbSmartSizing: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRDPViewerInputSink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPViewerInputSink_SendMouseButtonEvent(self: *const T, buttonType: RDPSRAPI_MOUSE_BUTTON_TYPE, vbButtonDown: VARIANT_BOOL, xPos: u32, yPos: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRDPViewerInputSink_SendKeyboardEvent(self: *const T, codeType: RDPSRAPI_KBD_CODE_TYPE, keycode: u16, vbKeyUp: VARIANT_BOOL, vbRepeat: VARIANT_BOOL, vbExtended: VARIANT_BOOL) callconv(.Inline) HRESULT {
