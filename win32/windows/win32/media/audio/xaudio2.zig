...
pub const IXAudio2 = extern struct {
    pub const VTable = extern struct {
        ...
        CreateMasteringVoice: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                InputSampleRate: u32,
                Flags: u32,
                szDeviceId: ?[*:0]align(1) const u16,
                pEffectChain: ?*const XAUDIO2_EFFECT_CHAIN,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXAudio2_CreateMasteringVoice(self: *const T, ppMasteringVoice: ?*?*IXAudio2MasteringVoice, InputChannels: u32, InputSampleRate: u32, Flags: u32, szDeviceId: ?[*:0]align(1) const u16, pEffectChain: ?*const XAUDIO2_EFFECT_CHAIN, StreamCategory: AUDIO_STREAM_CATEGORY) callconv(.Inline) HRESULT {
...
const AUDIO_STREAM_CATEGORY = @import("../../../../windows/win32/media/audio.zig").AUDIO_STREAM_CATEGORY;
