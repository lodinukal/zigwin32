...
// Section: Types (132)
//--------------------------------------------------------------------------------
pub const PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE = isize;

pub const PACKAGEDEPENDENCY_CONTEXT = isize;
...
pub const APPX_PACKAGE_WRITER_PAYLOAD_STREAM = extern struct {
    ...
    contentType: ?[*:0]align(1) const u16,
...
pub const APPX_CAPABILITIES = enum(i32) {
    INTERNET_CLIENT = 1,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(APPX_CAPABILITIES, @enumFromInt(
              (if (o.INTERNET_CLIENT == 1) @intFromEnum(APPX_CAPABILITIES.INTERNET_CLIENT) else 0)
            | (if (o.INTERNET_CLIENT_SERVER == 1) @intFromEnum(APPX_CAPABILITIES.INTERNET_CLIENT_SERVER) else 0)
            | (if (o.PRIVATE_NETWORK_CLIENT_SERVER == 1) @intFromEnum(APPX_CAPABILITIES.PRIVATE_NETWORK_CLIENT_SERVER) else 0)
            | (if (o.DOCUMENTS_LIBRARY == 1) @intFromEnum(APPX_CAPABILITIES.DOCUMENTS_LIBRARY) else 0)
            | (if (o.PICTURES_LIBRARY == 1) @intFromEnum(APPX_CAPABILITIES.PICTURES_LIBRARY) else 0)
            | (if (o.VIDEOS_LIBRARY == 1) @intFromEnum(APPX_CAPABILITIES.VIDEOS_LIBRARY) else 0)
            | (if (o.MUSIC_LIBRARY == 1) @intFromEnum(APPX_CAPABILITIES.MUSIC_LIBRARY) else 0)
            | (if (o.ENTERPRISE_AUTHENTICATION == 1) @intFromEnum(APPX_CAPABILITIES.ENTERPRISE_AUTHENTICATION) else 0)
            | (if (o.SHARED_USER_CERTIFICATES == 1) @intFromEnum(APPX_CAPABILITIES.SHARED_USER_CERTIFICATES) else 0)
            | (if (o.REMOVABLE_STORAGE == 1) @intFromEnum(APPX_CAPABILITIES.REMOVABLE_STORAGE) else 0)
            | (if (o.APPOINTMENTS == 1) @intFromEnum(APPX_CAPABILITIES.APPOINTMENTS) else 0)
            | (if (o.CONTACTS == 1) @intFromEnum(APPX_CAPABILITIES.CONTACTS) else 0)
        ));
    }
};
...
pub const IAppxFactory = extern struct {
    pub const VTable = extern struct {
        ...
        CreateValidatedBlockMapReader: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                signatureFileName: ?[*:0]align(1) const u16,
                blockMapReader: ?*?*IAppxBlockMapReader,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxFactory,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxFactory_CreateValidatedBlockMapReader(self: *const T, blockMapStream: ?*IStream, signatureFileName: ?[*:0]align(1) const u16, blockMapReader: ?*?*IAppxBlockMapReader) callconv(.Inline) HRESULT {
...
const IID_IAppxFactory3_Value = Guid.initString("776b2c05-e21d-4e24-ba1a-cd529a8bfdbb");
pub const IID_IAppxFactory3 = &IID_IAppxFactory3_Value;
pub const IAppxFactory3 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        CreatePackageReader2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxFactory3,
                inputStream: ?*IStream,
                expectedDigest: ?[*:0]align(1) const u16,
                packageReader: ?*?*IAppxPackageReader,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxFactory3,
        ...
        CreateManifestReader2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxFactory3,
                inputStream: ?*IStream,
                expectedDigest: ?[*:0]align(1) const u16,
        ...
        CreateAppInstallerReader: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxFactory3,
                inputStream: ?*IStream,
                expectedDigest: ?[*:0]align(1) const u16,
                appInstallerReader: ?*?*IAppxAppInstallerReader,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxFactory3,
                inputStream: ?*IStream,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxFactory3_CreatePackageReader2(self: *const T, inputStream: ?*IStream, expectedDigest: ?[*:0]align(1) const u16, packageReader: ?*?*IAppxPackageReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxFactory3.VTable, @ptrCast(self.vtable)).CreatePackageReader2(@as(*const IAppxFactory3, @ptrCast(self)), inputStream, expectedDigest, packageReader);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxFactory3_CreateManifestReader2(self: *const T, inputStream: ?*IStream, expectedDigest: ?[*:0]align(1) const u16, manifestReader: ?*?*IAppxManifestReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxFactory3.VTable, @ptrCast(self.vtable)).CreateManifestReader2(@as(*const IAppxFactory3, @ptrCast(self)), inputStream, expectedDigest, manifestReader);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxFactory3_CreateAppInstallerReader(self: *const T, inputStream: ?*IStream, expectedDigest: ?[*:0]align(1) const u16, appInstallerReader: ?*?*IAppxAppInstallerReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxFactory3.VTable, @ptrCast(self.vtable)).CreateAppInstallerReader(@as(*const IAppxFactory3, @ptrCast(self)), inputStream, expectedDigest, appInstallerReader);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IAppxPackageReader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackageReader_GetPayloadFile(self: *const T, fileName: ?[*:0]align(1) const u16, file: ?*?*IAppxFile) callconv(.Inline) HRESULT {
...
pub const IAppxPackageWriter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackageWriter_AddPayloadFile(self: *const T, fileName: ?[*:0]align(1) const u16, contentType: ?[*:0]align(1) const u16, compressionOption: APPX_COMPRESSION_OPTION, inputStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IAppxBlockMapReader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBlockMapReader_GetFile(self: *const T, filename: ?[*:0]align(1) const u16, file: ?*?*IAppxBlockMapFile) callconv(.Inline) HRESULT {
...
pub const IAppxManifestReader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxManifestReader_GetPrerequisite(self: *const T, name: ?[*:0]align(1) const u16, value: ?*u64) callconv(.Inline) HRESULT {
...
pub const IAppxManifestPackageId = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxManifestPackageId_ComparePublisher(self: *const T, other: ?[*:0]align(1) const u16, isSame: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IAppxManifestProperties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxManifestProperties_GetBoolValue(self: *const T, name: ?[*:0]align(1) const u16, value: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxManifestProperties_GetStringValue(self: *const T, name: ?[*:0]align(1) const u16, value: ?*?PWSTR) callconv(.Inline) HRESULT {
...
pub const IAppxManifestApplication = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxManifestApplication_GetStringValue(self: *const T, name: ?[*:0]align(1) const u16, value: ?*?PWSTR) callconv(.Inline) HRESULT {
...
const IID_IAppxBundleFactory2_Value = Guid.initString("7325b83d-0185-42c4-82ac-be34ab1a2a8a");
pub const IID_IAppxBundleFactory2 = &IID_IAppxBundleFactory2_Value;
pub const IAppxBundleFactory2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        CreateBundleReader2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxBundleFactory2,
                inputStream: ?*IStream,
                expectedDigest: ?[*:0]align(1) const u16,
                bundleReader: ?*?*IAppxBundleReader,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleFactory2_CreateBundleReader2(self: *const T, inputStream: ?*IStream, expectedDigest: ?[*:0]align(1) const u16, bundleReader: ?*?*IAppxBundleReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxBundleFactory2.VTable, @ptrCast(self.vtable)).CreateBundleReader2(@as(*const IAppxBundleFactory2, @ptrCast(self)), inputStream, expectedDigest, bundleReader);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IAppxBundleWriter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter_AddPayloadPackage(self: *const T, fileName: ?[*:0]align(1) const u16, packageStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IAppxBundleWriter2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter2_AddExternalPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IAppxBundleWriter3 = extern struct {
    pub const VTable = extern struct {
        ...
        Close: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxBundleWriter3,
                hashMethodString: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxBundleWriter3,
                hashMethodString: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter3_AddPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter3_Close(self: *const T, hashMethodString: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IAppxBundleWriter4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter4_AddPayloadPackage(self: *const T, fileName: ?[*:0]align(1) const u16, packageStream: ?*IStream, isDefaultApplicablePackage: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter4_AddPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream, isDefaultApplicablePackage: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleWriter4_AddExternalPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream, isDefaultApplicablePackage: BOOL) callconv(.Inline) HRESULT {
...
pub const IAppxBundleReader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxBundleReader_GetPayloadPackage(self: *const T, fileName: ?[*:0]align(1) const u16, payloadPackage: ?*?*IAppxFile) callconv(.Inline) HRESULT {
...
pub const IAppxContentGroupMapWriter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxContentGroupMapWriter_AddAutomaticGroup(self: *const T, groupName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxContentGroupMapWriter_AddAutomaticFile(self: *const T, fileName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IAppxPackagingDiagnosticEventSink = extern struct {
    pub const VTable = extern struct {
        ...
        ReportContextChange: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                contextId: i32,
                contextName: ?[*:0]align(1) const u8,
                contextMessage: ?[*:0]align(1) const u16,
                detailsMessage: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxPackagingDiagnosticEventSink,
                changeType: APPX_PACKAGING_CONTEXT_CHANGE_TYPE,
        ...
        ReportError: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxPackagingDiagnosticEventSink,
                errorMessage: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxPackagingDiagnosticEventSink,
                errorMessage: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackagingDiagnosticEventSink_ReportContextChange(self: *const T, changeType: APPX_PACKAGING_CONTEXT_CHANGE_TYPE, contextId: i32, contextName: ?[*:0]align(1) const u8, contextMessage: ?[*:0]align(1) const u16, detailsMessage: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackagingDiagnosticEventSink_ReportError(self: *const T, errorMessage: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const IID_IAppxAppInstallerReader_Value = Guid.initString("f35bc38c-1d2f-43db-a1f4-586430d1fed2");
pub const IID_IAppxAppInstallerReader = &IID_IAppxAppInstallerReader_Value;
pub const IAppxAppInstallerReader = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetXmlDom: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxAppInstallerReader,
                dom: ?*?*IXMLDOMDocument,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxAppInstallerReader,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxAppInstallerReader_GetXmlDom(self: *const T, dom: ?*?*IXMLDOMDocument) callconv(.Inline) HRESULT {
            return @as(*const IAppxAppInstallerReader.VTable, @ptrCast(self.vtable)).GetXmlDom(@as(*const IAppxAppInstallerReader, @ptrCast(self)), dom);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IAppxDigestProvider_Value = Guid.initString("9fe2702b-7640-4659-8e6c-349e43c4cdbd");
pub const IID_IAppxDigestProvider = &IID_IAppxDigestProvider_Value;
pub const IAppxDigestProvider = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetDigest: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxDigestProvider,
                digest: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxDigestProvider,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxDigestProvider_GetDigest(self: *const T, digest: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IAppxDigestProvider.VTable, @ptrCast(self.vtable)).GetDigest(@as(*const IAppxDigestProvider, @ptrCast(self)), digest);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const APPX_ENCRYPTED_PACKAGE_SETTINGS = extern struct {
    keyLength: u32,
    encryptionAlgorithm: ?[*:0]align(1) const u16,
    useDiffusion: BOOL,
    blockMapHashAlgorithm: ?*IUri,
};

pub const APPX_ENCRYPTED_PACKAGE_OPTIONS = enum(i32) {
    NONE = 0,
    DIFFUSION = 1,
    PAGE_HASHING = 2,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(APPX_ENCRYPTED_PACKAGE_OPTIONS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.NONE) else 0)
            | (if (o.DIFFUSION == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.DIFFUSION) else 0)
            | (if (o.PAGE_HASHING == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.PAGE_HASHING) else 0)
        ));
    }
};
...
const IID_IAppxEncryptionFactory5_Value = Guid.initString("68d6e77a-f446-480f-b0f0-d91a24c60746");
pub const IID_IAppxEncryptionFactory5 = &IID_IAppxEncryptionFactory5_Value;
pub const IAppxEncryptionFactory5 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        CreateEncryptedPackageReader2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxEncryptionFactory5,
                inputStream: ?*IStream,
                keyInfo: ?*const APPX_KEY_INFO,
                expectedDigest: ?[*:0]align(1) const u16,
                packageReader: ?*?*IAppxPackageReader,
        ...
        CreateEncryptedBundleReader2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAppxEncryptionFactory5,
                inputStream: ?*IStream,
                keyInfo: ?*const APPX_KEY_INFO,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptionFactory5_CreateEncryptedPackageReader2(self: *const T, inputStream: ?*IStream, keyInfo: ?*const APPX_KEY_INFO, expectedDigest: ?[*:0]align(1) const u16, packageReader: ?*?*IAppxPackageReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxEncryptionFactory5.VTable, @ptrCast(self.vtable)).CreateEncryptedPackageReader2(@as(*const IAppxEncryptionFactory5, @ptrCast(self)), inputStream, keyInfo, expectedDigest, packageReader);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptionFactory5_CreateEncryptedBundleReader2(self: *const T, inputStream: ?*IStream, keyInfo: ?*const APPX_KEY_INFO, expectedDigest: ?[*:0]align(1) const u16, bundleReader: ?*?*IAppxBundleReader) callconv(.Inline) HRESULT {
            return @as(*const IAppxEncryptionFactory5.VTable, @ptrCast(self.vtable)).CreateEncryptedBundleReader2(@as(*const IAppxEncryptionFactory5, @ptrCast(self)), inputStream, keyInfo, expectedDigest, bundleReader);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IAppxEncryptedPackageWriter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptedPackageWriter_AddPayloadFileEncrypted(self: *const T, fileName: ?[*:0]align(1) const u16, compressionOption: APPX_COMPRESSION_OPTION, inputStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IAppxEncryptedBundleWriter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptedBundleWriter_AddPayloadPackageEncrypted(self: *const T, fileName: ?[*:0]align(1) const u16, packageStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IAppxEncryptedBundleWriter2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptedBundleWriter2_AddExternalPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS = enum(i32) {
    NONE = 0,
    SKIP_VALIDATION = 1,
    LOCALIZED = 2,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.NONE) else 0)
            | (if (o.SKIP_VALIDATION == 1) @intFromEnum(APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.SKIP_VALIDATION) else 0)
            | (if (o.LOCALIZED == 1) @intFromEnum(APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.LOCALIZED) else 0)
        ));
    }
};
...
pub const IAppxEncryptedBundleWriter3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptedBundleWriter3_AddPayloadPackageEncrypted(self: *const T, fileName: ?[*:0]align(1) const u16, packageStream: ?*IStream, isDefaultApplicablePackage: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxEncryptedBundleWriter3_AddExternalPackageReference(self: *const T, fileName: ?[*:0]align(1) const u16, inputStream: ?*IStream, isDefaultApplicablePackage: BOOL) callconv(.Inline) HRESULT {
...
pub const IAppxPackageEditor = extern struct {
    pub const VTable = extern struct {
        ...
        SetWorkingDirectory: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                workingDirectory: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxPackageEditor,
                workingDirectory: ?[*:0]align(1) const u16,
        ...
        CreateDeltaPackageUsingBaselineBlockMap: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                baselinePackageFullName: ?[*:0]align(1) const u16,
                deltaPackageStream: ?*IStream,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAppxPackageEditor,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackageEditor_SetWorkingDirectory(self: *const T, workingDirectory: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAppxPackageEditor_CreateDeltaPackageUsingBaselineBlockMap(self: *const T, updatedPackageStream: ?*IStream, baselineBlockMapStream: ?*IStream, baselinePackageFullName: ?[*:0]align(1) const u16, deltaPackageStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const CreatePackageDependencyOptions = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        None: u1 = 0,
        DoNotVerifyDependencyResolution: u1 = 0,
        ScopeIsSystem: u1 = 0,
    }) CreatePackageDependencyOptions {
        return @as(CreatePackageDependencyOptions, @enumFromInt(
              (if (o.None == 1) @intFromEnum(CreatePackageDependencyOptions.None) else 0)
            | (if (o.DoNotVerifyDependencyResolution == 1) @intFromEnum(CreatePackageDependencyOptions.DoNotVerifyDependencyResolution) else 0)
            | (if (o.ScopeIsSystem == 1) @intFromEnum(CreatePackageDependencyOptions.ScopeIsSystem) else 0)
        ));
    }
};
...
pub const AddPackageDependencyOptions = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        None: u1 = 0,
        PrependIfRankCollision: u1 = 0,
    }) AddPackageDependencyOptions {
        return @as(AddPackageDependencyOptions, @enumFromInt(
              (if (o.None == 1) @intFromEnum(AddPackageDependencyOptions.None) else 0)
            | (if (o.PrependIfRankCollision == 1) @intFromEnum(AddPackageDependencyOptions.PrependIfRankCollision) else 0)
        ));
    }
};
...
pub const PackageDependencyProcessorArchitectures = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PackageDependencyProcessorArchitectures, @enumFromInt(
              (if (o.None == 1) @intFromEnum(PackageDependencyProcessorArchitectures.None) else 0)
            | (if (o.Neutral == 1) @intFromEnum(PackageDependencyProcessorArchitectures.Neutral) else 0)
            | (if (o.X86 == 1) @intFromEnum(PackageDependencyProcessorArchitectures.X86) else 0)
            | (if (o.X64 == 1) @intFromEnum(PackageDependencyProcessorArchitectures.X64) else 0)
            | (if (o.Arm == 1) @intFromEnum(PackageDependencyProcessorArchitectures.Arm) else 0)
            | (if (o.Arm64 == 1) @intFromEnum(PackageDependencyProcessorArchitectures.Arm64) else 0)
            | (if (o.X86A64 == 1) @intFromEnum(PackageDependencyProcessorArchitectures.X86A64) else 0)
        ));
    }
};
...
pub extern "api-ms-win-appmodel-runtime-l1-1-1" fn VerifyApplicationUserModelId(
    applicationUserModelId: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;

pub extern "api-ms-win-appmodel-runtime-l1-1-1" fn VerifyPackageRelativeApplicationId(
    packageRelativeApplicationId: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "api-ms-win-appmodel-runtime-l1-1-6" fn GetPackageGraphRevisionId(
...
pub extern "kernel32" fn DuplicatePackageVirtualizationContext(
    ...
    destContext: ?*PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "kernel32" fn GetCurrentPackageVirtualizationContext(
) callconv(@import("std").os.windows.WINAPI) PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE;
...
const IXMLDOMDocument = @import("../../../../windows/win32/data/xml/ms_xml.zig").IXMLDOMDocument;
