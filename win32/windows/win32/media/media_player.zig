...
pub const IWMPMedia = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMedia_get_isIdentical(self: *const T, pIWMPMedia: ?*IWMPMedia, pvbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMedia_isMemberOf(self: *const T, pPlaylist: ?*IWMPPlaylist, pvarfIsMemberOf: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMedia_isReadOnlyItem(self: *const T, bstrItemName: ?BSTR, pvarfIsReadOnly: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPControls = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPControls_get_isAvailable(self: *const T, bstrItem: ?BSTR, pIsAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_get_isAvailable(self: *const T, bstrItem: ?BSTR, pIsAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_get_autoStart(self: *const T, pfAutoStart: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).get_autoStart(@as(*const IWMPSettings, @ptrCast(self)), pfAutoStart);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_put_autoStart(self: *const T, fAutoStart: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_get_invokeURLs(self: *const T, pfInvokeURLs: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).get_invokeURLs(@as(*const IWMPSettings, @ptrCast(self)), pfInvokeURLs);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_put_invokeURLs(self: *const T, fInvokeURLs: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).put_invokeURLs(@as(*const IWMPSettings, @ptrCast(self)), fInvokeURLs);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_get_mute(self: *const T, pfMute: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).get_mute(@as(*const IWMPSettings, @ptrCast(self)), pfMute);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_put_mute(self: *const T, fMute: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_getMode(self: *const T, bstrMode: ?BSTR, pvarfMode: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).getMode(@as(*const IWMPSettings, @ptrCast(self)), bstrMode, pvarfMode);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_setMode(self: *const T, bstrMode: ?BSTR, varfMode: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPSettings.VTable, @ptrCast(self.vtable)).setMode(@as(*const IWMPSettings, @ptrCast(self)), bstrMode, varfMode);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_get_enableErrorDialogs(self: *const T, pfEnableErrorDialogs: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings_put_enableErrorDialogs(self: *const T, fEnableErrorDialogs: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlaylist = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlaylist_get_isIdentical(self: *const T, pIWMPPlaylist: ?*IWMPPlaylist, pvbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPMediaCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMediaCollection_remove(self: *const T, pItem: ?*IWMPMedia, varfDeleteFile: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMediaCollection_setDeleted(self: *const T, pItem: ?*IWMPMedia, varfIsDeleted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMediaCollection_isDeleted(self: *const T, pItem: ?*IWMPMedia, pvarfIsDeleted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlaylistCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlaylistCollection_setDeleted(self: *const T, pItem: ?*IWMPPlaylist, varfIsDeleted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlaylistCollection_isDeleted(self: *const T, pItem: ?*IWMPPlaylist, pvarfIsDeleted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPNetwork = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPNetwork_getProxyBypassForLocal(self: *const T, bstrProtocol: ?BSTR, pfBypassForLocal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPNetwork_setProxyBypassForLocal(self: *const T, bstrProtocol: ?BSTR, fBypassForLocal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPCore = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPCore_get_isOnline(self: *const T, pfOnline: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlayer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_get_enabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer.VTable, @ptrCast(self.vtable)).get_enabled(@as(*const IWMPPlayer, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_put_enabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer.VTable, @ptrCast(self.vtable)).put_enabled(@as(*const IWMPPlayer, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_get_fullScreen(self: *const T, pbFullScreen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer.VTable, @ptrCast(self.vtable)).get_fullScreen(@as(*const IWMPPlayer, @ptrCast(self)), pbFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_put_fullScreen(self: *const T, bFullScreen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer.VTable, @ptrCast(self.vtable)).put_fullScreen(@as(*const IWMPPlayer, @ptrCast(self)), bFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_get_enableContextMenu(self: *const T, pbEnableContextMenu: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer_put_enableContextMenu(self: *const T, bEnableContextMenu: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlayer2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IWMPCore.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_get_enabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).get_enabled(@as(*const IWMPPlayer2, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_put_enabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).put_enabled(@as(*const IWMPPlayer2, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_get_fullScreen(self: *const T, pbFullScreen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).get_fullScreen(@as(*const IWMPPlayer2, @ptrCast(self)), pbFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_put_fullScreen(self: *const T, bFullScreen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).put_fullScreen(@as(*const IWMPPlayer2, @ptrCast(self)), bFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_get_enableContextMenu(self: *const T, pbEnableContextMenu: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_put_enableContextMenu(self: *const T, bEnableContextMenu: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_get_stretchToFit(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).get_stretchToFit(@as(*const IWMPPlayer2, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_put_stretchToFit(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).put_stretchToFit(@as(*const IWMPPlayer2, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_get_windowlessVideo(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer2.VTable, @ptrCast(self.vtable)).get_windowlessVideo(@as(*const IWMPPlayer2, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer2_put_windowlessVideo(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPDVD = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPDVD_get_isAvailable(self: *const T, bstrItem: ?BSTR, pIsAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlayer3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_get_enabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).get_enabled(@as(*const IWMPPlayer3, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_put_enabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).put_enabled(@as(*const IWMPPlayer3, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_get_fullScreen(self: *const T, pbFullScreen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).get_fullScreen(@as(*const IWMPPlayer3, @ptrCast(self)), pbFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_put_fullScreen(self: *const T, bFullScreen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).put_fullScreen(@as(*const IWMPPlayer3, @ptrCast(self)), bFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_get_enableContextMenu(self: *const T, pbEnableContextMenu: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_put_enableContextMenu(self: *const T, bEnableContextMenu: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_get_stretchToFit(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).get_stretchToFit(@as(*const IWMPPlayer3, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_put_stretchToFit(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).put_stretchToFit(@as(*const IWMPPlayer3, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_get_windowlessVideo(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer3.VTable, @ptrCast(self.vtable)).get_windowlessVideo(@as(*const IWMPPlayer3, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer3_put_windowlessVideo(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPSettings2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSettings2_requestMediaAccessRights(self: *const T, bstrDesiredAccess: ?BSTR, pvbAccepted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlayerApplication = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayerApplication_get_playerDocked(self: *const T, pbPlayerDocked: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayerApplication_get_hasDisplay(self: *const T, pbHasDisplay: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPlayer4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_enabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).get_enabled(@as(*const IWMPPlayer4, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_put_enabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).put_enabled(@as(*const IWMPPlayer4, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_fullScreen(self: *const T, pbFullScreen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).get_fullScreen(@as(*const IWMPPlayer4, @ptrCast(self)), pbFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_put_fullScreen(self: *const T, bFullScreen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).put_fullScreen(@as(*const IWMPPlayer4, @ptrCast(self)), bFullScreen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_enableContextMenu(self: *const T, pbEnableContextMenu: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_put_enableContextMenu(self: *const T, bEnableContextMenu: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_stretchToFit(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).get_stretchToFit(@as(*const IWMPPlayer4, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_put_stretchToFit(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).put_stretchToFit(@as(*const IWMPPlayer4, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_windowlessVideo(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).get_windowlessVideo(@as(*const IWMPPlayer4, @ptrCast(self)), pbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_put_windowlessVideo(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWMPPlayer4.VTable, @ptrCast(self.vtable)).put_windowlessVideo(@as(*const IWMPPlayer4, @ptrCast(self)), bEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPlayer4_get_isRemote(self: *const T, pvarfIsRemote: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPSyncDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSyncDevice_get_connected(self: *const T, pvbConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSyncDevice_createPartnership(self: *const T, vbShowUI: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPSyncDevice_isIdentical(self: *const T, pDevice: ?*IWMPSyncDevice, pvbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPCdromBurn = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPCdromBurn_isAvailable(self: *const T, bstrItem: ?BSTR, pIsAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPMediaCollection2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMediaCollection2_getPlaylistByQuery(self: *const T, pQuery: ?*IWMPQuery, bstrMediaType: ?BSTR, bstrSortAttribute: ?BSTR, fSortAscending: VARIANT_BOOL, ppPlaylist: ?*?*IWMPPlaylist) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPMediaCollection2_getStringCollectionByQuery(self: *const T, bstrAttribute: ?BSTR, pQuery: ?*IWMPQuery, bstrMediaType: ?BSTR, bstrSortAttribute: ?BSTR, fSortAscending: VARIANT_BOOL, ppStringCollection: ?*?*IWMPStringCollection) callconv(.Inline) HRESULT {
...
pub const IWMPStringCollection2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPStringCollection2_isIdentical(self: *const T, pIWMPStringCollection2: ?*IWMPStringCollection2, pvbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPLibrary = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPLibrary_isIdentical(self: *const T, pIWMPLibrary: ?*IWMPLibrary, pvbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPLibrarySharingServices = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPLibrarySharingServices_isLibraryShared(self: *const T, pvbShared: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPLibrarySharingServices_isLibrarySharingEnabled(self: *const T, pvbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPEvents_Buffering(self: *const T, Start: VARIANT_BOOL) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPEvents_PlaylistCollectionPlaylistSetAsDeleted(self: *const T, bstrPlaylistName: ?BSTR, varfIsDeleted: VARIANT_BOOL) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPEvents_ModeChange(self: *const T, ModeName: ?BSTR, NewValue: VARIANT_BOOL) callconv(.Inline) void {
...
pub const IWMPTranscodePolicy = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPTranscodePolicy_allowTranscode(self: *const T, pvbAllow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IXFeedsManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_IsSubscribed(self: *const T, pszUrl: ?[*:0]align(1) const u16, pbSubscribed: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_ExistsFeed(self: *const T, pszPath: ?[*:0]align(1) const u16, pbFeedExists: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_GetFeed(self: *const T, pszPath: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
            return @as(*const IXFeedsManager.VTable, @ptrCast(self.vtable)).GetFeed(@as(*const IXFeedsManager, @ptrCast(self)), pszPath, riid, ppv);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_GetFeedByUrl(self: *const T, pszUrl: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_ExistsFolder(self: *const T, pszPath: ?[*:0]align(1) const u16, pbFolderExists: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_GetFolder(self: *const T, pszPath: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_DeleteFeed(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedsManager.VTable, @ptrCast(self.vtable)).DeleteFeed(@as(*const IXFeedsManager, @ptrCast(self)), pszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedsManager_DeleteFolder(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXFeedFolder = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_CreateFeed(self: *const T, pszName: ?[*:0]align(1) const u16, pszUrl: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_CreateSubfolder(self: *const T, pszName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_ExistsFeed(self: *const T, pszName: ?[*:0]align(1) const u16, pbFeedExists: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_ExistsSubfolder(self: *const T, pszName: ?[*:0]align(1) const u16, pbSubfolderExists: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_GetFeed(self: *const T, pszName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
            return @as(*const IXFeedFolder.VTable, @ptrCast(self.vtable)).GetFeed(@as(*const IXFeedFolder, @ptrCast(self)), pszName, riid, ppv);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_GetSubfolder(self: *const T, pszName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_Rename(self: *const T, pszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolder_Move(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXFeedFolderEvents = extern struct {
    pub const VTable = extern struct {
        ...
        FolderRenamed: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXFeedFolderEvents,
                pszPath: ?[*:0]align(1) const u16,
                pszOldPath: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXFeedFolderEvents,
                pszPath: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderAdded(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderDeleted(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderRenamed(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderMovedFrom(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderMovedTo(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FolderItemCountChanged(self: *const T, pszPath: ?[*:0]align(1) const u16, feicfFlags: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedAdded(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedFolderEvents.VTable, @ptrCast(self.vtable)).FeedAdded(@as(*const IXFeedFolderEvents, @ptrCast(self)), pszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedDeleted(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedRenamed(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedUrlChanged(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedMovedFrom(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedMovedTo(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedDownloading(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedDownloadCompleted(self: *const T, pszPath: ?[*:0]align(1) const u16, fde: FEEDS_DOWNLOAD_ERROR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedFolderEvents_FeedItemCountChanged(self: *const T, pszPath: ?[*:0]align(1) const u16, feicfFlags: i32) callconv(.Inline) HRESULT {
...
pub const IXFeed = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeed_Rename(self: *const T, pszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeed_SetUrl(self: *const T, pszUrl: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeed_Move(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeed_Merge(self: *const T, pStream: ?*IStream, pszUrl: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXFeed2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeed2_SetCredentials(self: *const T, pszUsername: ?[*:0]align(1) const u16, pszPassword: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXFeedEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedDeleted(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedEvents.VTable, @ptrCast(self.vtable)).FeedDeleted(@as(*const IXFeedEvents, @ptrCast(self)), pszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedRenamed(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedUrlChanged(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedEvents.VTable, @ptrCast(self.vtable)).FeedUrlChanged(@as(*const IXFeedEvents, @ptrCast(self)), pszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedMoved(self: *const T, pszPath: ?[*:0]align(1) const u16, pszOldPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedEvents.VTable, @ptrCast(self.vtable)).FeedMoved(@as(*const IXFeedEvents, @ptrCast(self)), pszPath, pszOldPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedDownloading(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IXFeedEvents.VTable, @ptrCast(self.vtable)).FeedDownloading(@as(*const IXFeedEvents, @ptrCast(self)), pszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedDownloadCompleted(self: *const T, pszPath: ?[*:0]align(1) const u16, fde: FEEDS_DOWNLOAD_ERROR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEvents_FeedItemCountChanged(self: *const T, pszPath: ?[*:0]align(1) const u16, feicfFlags: i32) callconv(.Inline) HRESULT {
...
pub const IXFeedEnclosure = extern struct {
    pub const VTable = extern struct {
        ...
        SetFile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXFeedEnclosure,
                pszDownloadUrl: ?[*:0]align(1) const u16,
                pszDownloadFilePath: ?[*:0]align(1) const u16,
                pszDownloadMimeType: ?[*:0]align(1) const u16,
                pszEnclosureFilename: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXFeedEnclosure,
                pszDownloadUrl: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXFeedEnclosure_SetFile(self: *const T, pszDownloadUrl: ?[*:0]align(1) const u16, pszDownloadFilePath: ?[*:0]align(1) const u16, pszDownloadMimeType: ?[*:0]align(1) const u16, pszEnclosureFilename: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IFeedsManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedsManager_IsSubscribed(self: *const T, feedUrl: ?BSTR, subscribed: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedsManager_ExistsFeed(self: *const T, feedPath: ?BSTR, exists: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedsManager_ExistsFolder(self: *const T, folderPath: ?BSTR, exists: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IFeedFolder = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedFolder_ExistsFeed(self: *const T, feedName: ?BSTR, exists: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedFolder_ExistsSubfolder(self: *const T, folderName: ?BSTR, exists: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedFolder_get_IsRoot(self: *const T, isRoot: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IFeed = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeed_get_DownloadEnclosuresAutomatically(self: *const T, downloadEnclosuresAutomatically: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeed_put_DownloadEnclosuresAutomatically(self: *const T, downloadEnclosuresAutomatically: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeed_get_IsList(self: *const T, isList: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IFeedItem = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedItem_get_IsRead(self: *const T, isRead: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IFeedItem.VTable, @ptrCast(self.vtable)).get_IsRead(@as(*const IFeedItem, @ptrCast(self)), isRead);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFeedItem_put_IsRead(self: *const T, isRead: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWMPPluginUI = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPluginUI_GetProperty(self: *const T, pwszName: ?[*:0]align(1) const u16, pvarProperty: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPluginUI_SetProperty(self: *const T, pwszName: ?[*:0]align(1) const u16, pvarProperty: ?*const VARIANT) callconv(.Inline) HRESULT {
...
pub const IWMPContentPartner = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPContentPartner_CanBuySilent(self: *const T, pInfo: ?*IWMPContentContainerList, pbstrTotalPrice: ?*?BSTR, pSilentOK: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPContentPartner_RefreshLicense(self: *const T, dwCookie: u32, fLocal: VARIANT_BOOL, bstrURL: ?BSTR, type_: WMPStreamingType, contentID: u32, bstrRefreshReason: ?BSTR, pReasonContext: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPContentPartner_Login(self: *const T, userInfo: BLOB, pwdInfo: BLOB, fUsedCachedCreds: VARIANT_BOOL, fOkToCache: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IMFActivate = @import("../../../windows/win32/media/media_foundation.zig").IMFActivate;
