...
pub const IGraphicsEffectD2D1Interop = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGraphicsEffectD2D1Interop_GetNamedPropertyMapping(self: *const T, name: ?[*:0]align(1) const u16, index: ?*u32, mapping: ?*GRAPHICS_EFFECT_PROPERTY_MAPPING) callconv(.Inline) HRESULT {
...
const ID2D1Factory = @import("../../../../../windows/win32/graphics/direct2d.zig").ID2D1Factory;
const ID2D1Geometry = @import("../../../../../windows/win32/graphics/direct2d.zig").ID2D1Geometry;
