...
pub const DEVPKEY_Storage_Portable = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 2 };
pub const DEVPKEY_Storage_Removable_Media = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 3 };
pub const DEVPKEY_Storage_System_Critical = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 4 };
pub const DEVPKEY_Storage_Disk_Number = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 5 };
pub const DEVPKEY_Storage_Partition_Number = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 6 };
pub const DEVPKEY_Storage_Mbr_Type = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 7 };
pub const DEVPKEY_Storage_Gpt_Type = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 8 };
pub const DEVPKEY_Storage_Gpt_Name = DEVPROPKEY { .fmtid = Guid.initIntString("1293860584, 2051, 18292, 152, 66, 183, 125, 181, 2, 101, 233"), .pid = 9 };
...
pub const STORAGE_HW_FIRMWARE_REQUEST_FLAG_REPLACE_EXISTING_IMAGE = @as(u32, 1073741824);
...
pub const IOCTL_SCM_BUS_REFRESH_NAMESPACE = @as(u32, 5832728);
...
pub const WMI_DISK_GEOMETRY_GUID = Guid.initString("25007f51-57c2-11d1-a528-00a0c9062910");
...
pub const SERIAL_IOC_FCR_FIFO_ENABLE = @as(u32, 1);
pub const SERIAL_IOC_FCR_RCVR_RESET = @as(u32, 2);
pub const SERIAL_IOC_FCR_XMIT_RESET = @as(u32, 4);
pub const SERIAL_IOC_FCR_DMA_MODE = @as(u32, 8);
pub const SERIAL_IOC_FCR_RES1 = @as(u32, 16);
pub const SERIAL_IOC_FCR_RES2 = @as(u32, 32);
pub const SERIAL_IOC_FCR_RCVR_TRIGGER_LSB = @as(u32, 64);
pub const SERIAL_IOC_FCR_RCVR_TRIGGER_MSB = @as(u32, 128);
pub const SERIAL_IOC_MCR_DTR = @as(u32, 1);
pub const SERIAL_IOC_MCR_RTS = @as(u32, 2);
pub const SERIAL_IOC_MCR_OUT1 = @as(u32, 4);
pub const SERIAL_IOC_MCR_OUT2 = @as(u32, 8);
pub const SERIAL_IOC_MCR_LOOP = @as(u32, 16);
...
pub const FSCTL_REFS_DEALLOCATE_RANGES_EX = @as(u32, 590924);
pub const FSCTL_SET_CACHED_RUNS_STATE = @as(u32, 590928);
pub const FSCTL_REFS_SET_VOLUME_COMPRESSION_INFO = @as(u32, 590932);
pub const FSCTL_REFS_QUERY_VOLUME_COMPRESSION_INFO = @as(u32, 590936);
pub const FSCTL_DUPLICATE_CLUSTER = @as(u32, 590940);
pub const FSCTL_CREATE_LCN_WEAK_REFERENCE = @as(u32, 590944);
pub const FSCTL_DELETE_LCN_WEAK_REFERENCE = @as(u32, 590948);
pub const FSCTL_QUERY_LCN_WEAK_REFERENCE = @as(u32, 590952);
pub const FSCTL_DELETE_LCN_WEAK_REFERENCES = @as(u32, 590956);
pub const FSCTL_REFS_SET_VOLUME_DEDUP_INFO = @as(u32, 590960);
pub const FSCTL_REFS_QUERY_VOLUME_DEDUP_INFO = @as(u32, 590964);
pub const FSCTL_LMR_QUERY_INFO = @as(u32, 590968);
...
pub const STORAGE_ENCRYPTION_TYPE = enum(i32) {
    Unknown = 0,
    EDrive = 1,
    TcgOpal = 2,
};
pub const StorageEncryptionTypeUnknown = STORAGE_ENCRYPTION_TYPE.Unknown;
pub const StorageEncryptionTypeEDrive = STORAGE_ENCRYPTION_TYPE.EDrive;
pub const StorageEncryptionTypeTcgOpal = STORAGE_ENCRYPTION_TYPE.TcgOpal;
...
pub const LMR_QUERY_INFO_CLASS = enum(i32) {
    o = 1,
};
pub const LMRQuerySessionInfo = LMR_QUERY_INFO_CLASS.o;
...
pub const FS_BPIO_INFLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        None: u1 = 0,
        SKIP_STORAGE_STACK_QUERY: u1 = 0,
    }) FS_BPIO_INFLAGS {
        return @as(FS_BPIO_INFLAGS, @enumFromInt(
              (if (o.None == 1) @intFromEnum(FS_BPIO_INFLAGS.None) else 0)
            | (if (o.SKIP_STORAGE_STACK_QUERY == 1) @intFromEnum(FS_BPIO_INFLAGS.SKIP_STORAGE_STACK_QUERY) else 0)
        ));
    }
};
...
pub const FS_BPIO_OUTFLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        None: u1 = 0,
        VOLUME_STACK_BYPASS_PAUSED: u1 = 0,
        STREAM_BYPASS_PAUSED: u1 = 0,
        FILTER_ATTACH_BLOCKED: u1 = 0,
        COMPATIBLE_STORAGE_DRIVER: u1 = 0,
    }) FS_BPIO_OUTFLAGS {
        return @as(FS_BPIO_OUTFLAGS, @enumFromInt(
              (if (o.None == 1) @intFromEnum(FS_BPIO_OUTFLAGS.None) else 0)
            | (if (o.VOLUME_STACK_BYPASS_PAUSED == 1) @intFromEnum(FS_BPIO_OUTFLAGS.VOLUME_STACK_BYPASS_PAUSED) else 0)
            | (if (o.STREAM_BYPASS_PAUSED == 1) @intFromEnum(FS_BPIO_OUTFLAGS.STREAM_BYPASS_PAUSED) else 0)
            | (if (o.FILTER_ATTACH_BLOCKED == 1) @intFromEnum(FS_BPIO_OUTFLAGS.FILTER_ATTACH_BLOCKED) else 0)
            | (if (o.COMPATIBLE_STORAGE_DRIVER == 1) @intFromEnum(FS_BPIO_OUTFLAGS.COMPATIBLE_STORAGE_DRIVER) else 0)
        ));
    }
};
...
const FILE_ID_128 = @import("../../../windows/win32/storage/file_system.zig").FILE_ID_128;
const HANDLE = @import("../../../windows/win32/foundation.zig").HANDLE;
const SID = @import("../../../windows/win32/security.zig").SID;
const STORAGE_BUS_TYPE = @import("../../../windows/win32/storage/file_system.zig").STORAGE_BUS_TYPE;
