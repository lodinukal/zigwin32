...
pub const DNS_RCLASS_MDNS_CACHE_FLUSH = @as(u32, 128);
...
pub const DDR_MAX_IP_HINTS = @as(u32, 4);
...
pub const DNS_TYPE = enum(u16) {
    ...
    MAILA = 254,
    ALL = 255,
    // ANY = 255, this enum value conflicts with ALL
    WINS = 65281,
    WINSR = 65282,
    // NBSTAT = 65282, this enum value conflicts with WINSR
};
pub const DNS_TYPE_ZERO = DNS_TYPE.ZERO;
pub const DNS_TYPE_A = DNS_TYPE.A;
pub const DNS_TYPE_NS = DNS_TYPE.NS;
pub const DNS_TYPE_MD = DNS_TYPE.MD;
pub const DNS_TYPE_MF = DNS_TYPE.MF;
pub const DNS_TYPE_CNAME = DNS_TYPE.CNAME;
pub const DNS_TYPE_SOA = DNS_TYPE.SOA;
pub const DNS_TYPE_MB = DNS_TYPE.MB;
pub const DNS_TYPE_MG = DNS_TYPE.MG;
pub const DNS_TYPE_MR = DNS_TYPE.MR;
pub const DNS_TYPE_NULL = DNS_TYPE.NULL;
pub const DNS_TYPE_WKS = DNS_TYPE.WKS;
pub const DNS_TYPE_PTR = DNS_TYPE.PTR;
pub const DNS_TYPE_HINFO = DNS_TYPE.HINFO;
pub const DNS_TYPE_MINFO = DNS_TYPE.MINFO;
pub const DNS_TYPE_MX = DNS_TYPE.MX;
pub const DNS_TYPE_TEXT = DNS_TYPE.TEXT;
pub const DNS_TYPE_RP = DNS_TYPE.RP;
pub const DNS_TYPE_AFSDB = DNS_TYPE.AFSDB;
pub const DNS_TYPE_X25 = DNS_TYPE.X25;
pub const DNS_TYPE_ISDN = DNS_TYPE.ISDN;
pub const DNS_TYPE_RT = DNS_TYPE.RT;
pub const DNS_TYPE_NSAP = DNS_TYPE.NSAP;
pub const DNS_TYPE_NSAPPTR = DNS_TYPE.NSAPPTR;
pub const DNS_TYPE_SIG = DNS_TYPE.SIG;
pub const DNS_TYPE_KEY = DNS_TYPE.KEY;
pub const DNS_TYPE_PX = DNS_TYPE.PX;
pub const DNS_TYPE_GPOS = DNS_TYPE.GPOS;
pub const DNS_TYPE_AAAA = DNS_TYPE.AAAA;
pub const DNS_TYPE_LOC = DNS_TYPE.LOC;
pub const DNS_TYPE_NXT = DNS_TYPE.NXT;
pub const DNS_TYPE_EID = DNS_TYPE.EID;
pub const DNS_TYPE_NIMLOC = DNS_TYPE.NIMLOC;
pub const DNS_TYPE_SRV = DNS_TYPE.SRV;
pub const DNS_TYPE_ATMA = DNS_TYPE.ATMA;
pub const DNS_TYPE_NAPTR = DNS_TYPE.NAPTR;
pub const DNS_TYPE_KX = DNS_TYPE.KX;
pub const DNS_TYPE_CERT = DNS_TYPE.CERT;
pub const DNS_TYPE_A6 = DNS_TYPE.A6;
pub const DNS_TYPE_DNAME = DNS_TYPE.DNAME;
pub const DNS_TYPE_SINK = DNS_TYPE.SINK;
pub const DNS_TYPE_OPT = DNS_TYPE.OPT;
pub const DNS_TYPE_DS = DNS_TYPE.DS;
pub const DNS_TYPE_RRSIG = DNS_TYPE.RRSIG;
pub const DNS_TYPE_NSEC = DNS_TYPE.NSEC;
pub const DNS_TYPE_DNSKEY = DNS_TYPE.DNSKEY;
pub const DNS_TYPE_DHCID = DNS_TYPE.DHCID;
pub const DNS_TYPE_NSEC3 = DNS_TYPE.NSEC3;
pub const DNS_TYPE_NSEC3PARAM = DNS_TYPE.NSEC3PARAM;
pub const DNS_TYPE_TLSA = DNS_TYPE.TLSA;
pub const DNS_TYPE_SVCB = DNS_TYPE.SVCB;
pub const DNS_TYPE_HTTPS = DNS_TYPE.HTTPS;
pub const DNS_TYPE_UINFO = DNS_TYPE.UINFO;
pub const DNS_TYPE_UID = DNS_TYPE.UID;
pub const DNS_TYPE_GID = DNS_TYPE.GID;
pub const DNS_TYPE_UNSPEC = DNS_TYPE.UNSPEC;
pub const DNS_TYPE_ADDRS = DNS_TYPE.ADDRS;
pub const DNS_TYPE_TKEY = DNS_TYPE.TKEY;
pub const DNS_TYPE_TSIG = DNS_TYPE.TSIG;
pub const DNS_TYPE_IXFR = DNS_TYPE.IXFR;
pub const DNS_TYPE_AXFR = DNS_TYPE.AXFR;
pub const DNS_TYPE_MAILB = DNS_TYPE.MAILB;
pub const DNS_TYPE_MAILA = DNS_TYPE.MAILA;
pub const DNS_TYPE_ALL = DNS_TYPE.ALL;
pub const DNS_TYPE_ANY = DNS_TYPE.ALL;
pub const DNS_TYPE_WINS = DNS_TYPE.WINS;
pub const DNS_TYPE_WINSR = DNS_TYPE.WINSR;
pub const DNS_TYPE_NBSTAT = DNS_TYPE.WINSR;

pub const DNS_QUERY_OPTIONS = enum(u32) {
    STANDARD = 0,
    ...
    DISABLE_IDN_ENCODING = 2097152,
    APPEND_MULTILABEL = 8388608,
    DNSSEC_OK = 16777216,
    DNSSEC_CHECKING_DISABLED = 33554432,
    RESERVED = 4026531840,
    // CACHE_ONLY = 16, this enum value conflicts with NO_WIRE_QUERY
    // REQUEST_VERSION1 = 1, this enum value conflicts with ACCEPT_TRUNCATED_RESPONSE
    // REQUEST_VERSION2 = 2, this enum value conflicts with USE_TCP_ONLY
    // RESULTS_VERSION1 = 1, this enum value conflicts with ACCEPT_TRUNCATED_RESPONSE
    REQUEST_VERSION3 = 3,
    _,
    pub fn initFlags(o: struct {
        STANDARD: u1 = 0,
        ACCEPT_TRUNCATED_RESPONSE: u1 = 0,
        USE_TCP_ONLY: u1 = 0,
        NO_RECURSION: u1 = 0,
        BYPASS_CACHE: u1 = 0,
        NO_WIRE_QUERY: u1 = 0,
        ...
        ADDRCONFIG: u1 = 0,
        DUAL_ADDR: u1 = 0,
        DONT_RESET_TTL_VALUES: u1 = 0,
        DISABLE_IDN_ENCODING: u1 = 0,
        APPEND_MULTILABEL: u1 = 0,
        DNSSEC_OK: u1 = 0,
        DNSSEC_CHECKING_DISABLED: u1 = 0,
        RESERVED: u1 = 0,
        REQUEST_VERSION3: u1 = 0,
    }) DNS_QUERY_OPTIONS {
        return @as(DNS_QUERY_OPTIONS, @enumFromInt(
              (if (o.STANDARD == 1) @intFromEnum(DNS_QUERY_OPTIONS.STANDARD) else 0)
            | (if (o.ACCEPT_TRUNCATED_RESPONSE == 1) @intFromEnum(DNS_QUERY_OPTIONS.ACCEPT_TRUNCATED_RESPONSE) else 0)
            | (if (o.USE_TCP_ONLY == 1) @intFromEnum(DNS_QUERY_OPTIONS.USE_TCP_ONLY) else 0)
            | (if (o.NO_RECURSION == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_RECURSION) else 0)
            | (if (o.BYPASS_CACHE == 1) @intFromEnum(DNS_QUERY_OPTIONS.BYPASS_CACHE) else 0)
            | (if (o.NO_WIRE_QUERY == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_WIRE_QUERY) else 0)
            | (if (o.NO_LOCAL_NAME == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_LOCAL_NAME) else 0)
            | (if (o.NO_HOSTS_FILE == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_HOSTS_FILE) else 0)
            | (if (o.NO_NETBT == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_NETBT) else 0)
            | (if (o.WIRE_ONLY == 1) @intFromEnum(DNS_QUERY_OPTIONS.WIRE_ONLY) else 0)
            | (if (o.RETURN_MESSAGE == 1) @intFromEnum(DNS_QUERY_OPTIONS.RETURN_MESSAGE) else 0)
            | (if (o.MULTICAST_ONLY == 1) @intFromEnum(DNS_QUERY_OPTIONS.MULTICAST_ONLY) else 0)
            | (if (o.NO_MULTICAST == 1) @intFromEnum(DNS_QUERY_OPTIONS.NO_MULTICAST) else 0)
            | (if (o.TREAT_AS_FQDN == 1) @intFromEnum(DNS_QUERY_OPTIONS.TREAT_AS_FQDN) else 0)
            | (if (o.ADDRCONFIG == 1) @intFromEnum(DNS_QUERY_OPTIONS.ADDRCONFIG) else 0)
            | (if (o.DUAL_ADDR == 1) @intFromEnum(DNS_QUERY_OPTIONS.DUAL_ADDR) else 0)
            | (if (o.DONT_RESET_TTL_VALUES == 1) @intFromEnum(DNS_QUERY_OPTIONS.DONT_RESET_TTL_VALUES) else 0)
            | (if (o.DISABLE_IDN_ENCODING == 1) @intFromEnum(DNS_QUERY_OPTIONS.DISABLE_IDN_ENCODING) else 0)
            | (if (o.APPEND_MULTILABEL == 1) @intFromEnum(DNS_QUERY_OPTIONS.APPEND_MULTILABEL) else 0)
            | (if (o.DNSSEC_OK == 1) @intFromEnum(DNS_QUERY_OPTIONS.DNSSEC_OK) else 0)
            | (if (o.DNSSEC_CHECKING_DISABLED == 1) @intFromEnum(DNS_QUERY_OPTIONS.DNSSEC_CHECKING_DISABLED) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(DNS_QUERY_OPTIONS.RESERVED) else 0)
            | (if (o.REQUEST_VERSION3 == 1) @intFromEnum(DNS_QUERY_OPTIONS.REQUEST_VERSION3) else 0)
        ));
    }
};
pub const DNS_QUERY_STANDARD = DNS_QUERY_OPTIONS.STANDARD;
pub const DNS_QUERY_ACCEPT_TRUNCATED_RESPONSE = DNS_QUERY_OPTIONS.ACCEPT_TRUNCATED_RESPONSE;
pub const DNS_QUERY_USE_TCP_ONLY = DNS_QUERY_OPTIONS.USE_TCP_ONLY;
pub const DNS_QUERY_NO_RECURSION = DNS_QUERY_OPTIONS.NO_RECURSION;
pub const DNS_QUERY_BYPASS_CACHE = DNS_QUERY_OPTIONS.BYPASS_CACHE;
pub const DNS_QUERY_NO_WIRE_QUERY = DNS_QUERY_OPTIONS.NO_WIRE_QUERY;
pub const DNS_QUERY_NO_LOCAL_NAME = DNS_QUERY_OPTIONS.NO_LOCAL_NAME;
pub const DNS_QUERY_NO_HOSTS_FILE = DNS_QUERY_OPTIONS.NO_HOSTS_FILE;
pub const DNS_QUERY_NO_NETBT = DNS_QUERY_OPTIONS.NO_NETBT;
pub const DNS_QUERY_WIRE_ONLY = DNS_QUERY_OPTIONS.WIRE_ONLY;
pub const DNS_QUERY_RETURN_MESSAGE = DNS_QUERY_OPTIONS.RETURN_MESSAGE;
pub const DNS_QUERY_MULTICAST_ONLY = DNS_QUERY_OPTIONS.MULTICAST_ONLY;
pub const DNS_QUERY_NO_MULTICAST = DNS_QUERY_OPTIONS.NO_MULTICAST;
pub const DNS_QUERY_TREAT_AS_FQDN = DNS_QUERY_OPTIONS.TREAT_AS_FQDN;
pub const DNS_QUERY_ADDRCONFIG = DNS_QUERY_OPTIONS.ADDRCONFIG;
pub const DNS_QUERY_DUAL_ADDR = DNS_QUERY_OPTIONS.DUAL_ADDR;
pub const DNS_QUERY_DONT_RESET_TTL_VALUES = DNS_QUERY_OPTIONS.DONT_RESET_TTL_VALUES;
pub const DNS_QUERY_DISABLE_IDN_ENCODING = DNS_QUERY_OPTIONS.DISABLE_IDN_ENCODING;
pub const DNS_QUERY_APPEND_MULTILABEL = DNS_QUERY_OPTIONS.APPEND_MULTILABEL;
pub const DNS_QUERY_DNSSEC_OK = DNS_QUERY_OPTIONS.DNSSEC_OK;
pub const DNS_QUERY_DNSSEC_CHECKING_DISABLED = DNS_QUERY_OPTIONS.DNSSEC_CHECKING_DISABLED;
pub const DNS_QUERY_RESERVED = DNS_QUERY_OPTIONS.RESERVED;
pub const DNS_QUERY_CACHE_ONLY = DNS_QUERY_OPTIONS.NO_WIRE_QUERY;
pub const DNS_QUERY_REQUEST_VERSION1 = DNS_QUERY_OPTIONS.ACCEPT_TRUNCATED_RESPONSE;
pub const DNS_QUERY_REQUEST_VERSION2 = DNS_QUERY_OPTIONS.USE_TCP_ONLY;
pub const DNS_QUERY_RESULTS_VERSION1 = DNS_QUERY_OPTIONS.ACCEPT_TRUNCATED_RESPONSE;
pub const DNS_QUERY_REQUEST_VERSION3 = DNS_QUERY_OPTIONS.REQUEST_VERSION3;
...
pub const DNS_SVCB_PARAM_TYPE = enum(i32) {
    Mandatory = 0,
    Alpn = 1,
    NoDefaultAlpn = 2,
    Port = 3,
    ...
    DohPath = 7,
    DohPathQuad9 = 65380,
    DohPathOpenDns = 65432,
};
pub const DnsSvcbParamMandatory = DNS_SVCB_PARAM_TYPE.Mandatory;
pub const DnsSvcbParamAlpn = DNS_SVCB_PARAM_TYPE.Alpn;
pub const DnsSvcbParamNoDefaultAlpn = DNS_SVCB_PARAM_TYPE.NoDefaultAlpn;
pub const DnsSvcbParamPort = DNS_SVCB_PARAM_TYPE.Port;
pub const DnsSvcbParamIpv4Hint = DNS_SVCB_PARAM_TYPE.Ipv4Hint;
pub const DnsSvcbParamEch = DNS_SVCB_PARAM_TYPE.Ech;
pub const DnsSvcbParamIpv6Hint = DNS_SVCB_PARAM_TYPE.Ipv6Hint;
pub const DnsSvcbParamDohPath = DNS_SVCB_PARAM_TYPE.DohPath;
pub const DnsSvcbParamDohPathQuad9 = DNS_SVCB_PARAM_TYPE.DohPathQuad9;
pub const DnsSvcbParamDohPathOpenDns = DNS_SVCB_PARAM_TYPE.DohPathOpenDns;
...
pub const DNS_SVCB_PARAM_IPV6 = extern struct {
    cIps: u16,
    rgIps: [1]IP6_ADDRESS,
};
...
pub const DNS_SVCB_PARAM = extern struct {
    wSvcParamKey: u16,
    Anonymous: extern union {
        pIpv4Hints: ?*DNS_SVCB_PARAM_IPV4,
        pIpv6Hints: ?*DNS_SVCB_PARAM_IPV6,
        pMandatory: ?*DNS_SVCB_PARAM_MANDATORY,
        pAlpn: ?*DNS_SVCB_PARAM_ALPN,
        wPort: u16,
        pUnknown: ?*DNS_SVCB_PARAM_UNKNOWN,
        pszDohPath: ?PSTR,
        pReserved: ?*anyopaque,
    },
};

pub const DNS_SVCB_DATA = extern struct {
    wSvcPriority: u16,
    pszTargetName: ?PSTR,
    cSvcParams: u16,
...
pub const DNS_CONNECTION_IFINDEX_ENTRY = extern struct {
    pwszConnectionName: ?[*:0]align(1) const u16,
    dwIfIndex: u32,
};
...
pub const DNS_CONNECTION_POLICY_ENTRY = extern struct {
    ...
    pwszAppId: ?[*:0]align(1) const u16,
    cbAppSid: u32,
    pbAppSid: ?*u8,
    nConnections: u32,
    ppwszConnections: ?*const ?PWSTR,
...
pub extern "dnsapi" fn DnsQueryConfig(
    ...
    Flag: u32,
    pwsAdapterName: ?[*:0]align(1) const u16,
    pReserved: ?*anyopaque,
...
pub extern "dnsapi" fn DnsNameCompare_A(
    pName1: ?[*:0]align(1) const u8,
    pName2: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "dnsapi" fn DnsNameCompare_W(
    pName1: ?[*:0]align(1) const u16,
    pName2: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "dnsapi" fn DnsConnectionGetProxyInfoForHostUrl(
    pwszHostUrl: ?[*:0]align(1) const u16,
...
pub extern "dnsapi" fn DnsConnectionGetProxyInfoForHostUrlEx(
    pwszHostUrl: ?[*:0]align(1) const u16,
    pSelectionContext: ?[*:0]u8,
    dwSelectionContextLength: u32,
    dwExplicitInterfaceIndex: u32,
...
pub extern "dnsapi" fn DnsServiceConstructInstance(
    ...
    keys: [*]const ?[*:0]align(1) const u16,
    values: [*]const ?[*:0]align(1) const u16,
