...
pub const DEVPKEY_PciRootBus_SecondaryInterface = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 1 };
pub const DEVPKEY_PciRootBus_CurrentSpeedAndMode = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 2 };
pub const DEVPKEY_PciRootBus_SupportedSpeedsAndModes = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 3 };
pub const DEVPKEY_PciRootBus_DeviceIDMessagingCapable = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 4 };
pub const DEVPKEY_PciRootBus_SecondaryBusWidth = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 5 };
pub const DEVPKEY_PciRootBus_ExtendedConfigAvailable = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 6 };
pub const DEVPKEY_PciRootBus_ExtendedPCIConfigOpRegionSupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 7 };
pub const DEVPKEY_PciRootBus_ASPMSupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 8 };
pub const DEVPKEY_PciRootBus_ClockPowerManagementSupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 9 };
pub const DEVPKEY_PciRootBus_PCISegmentGroupsSupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 10 };
pub const DEVPKEY_PciRootBus_MSISupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 11 };
pub const DEVPKEY_PciRootBus_PCIExpressNativeHotPlugControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 12 };
pub const DEVPKEY_PciRootBus_SHPCNativeHotPlugControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 13 };
pub const DEVPKEY_PciRootBus_PCIExpressNativePMEControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 14 };
pub const DEVPKEY_PciRootBus_PCIExpressAERControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 15 };
pub const DEVPKEY_PciRootBus_PCIExpressCapabilityControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 16 };
pub const DEVPKEY_PciRootBus_NativePciExpressControl = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 17 };
pub const DEVPKEY_PciRootBus_SystemMsiSupport = DEVPROPKEY { .fmtid = Guid.initIntString("3625450536, 31038, 19358, 153, 112, 70, 157, 139, 230, 48, 115"), .pid = 18 };
...
pub const DEVPKEY_WiFiDirect_DeviceAddress = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 1 };
pub const DEVPKEY_WiFiDirect_InterfaceAddress = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 2 };
pub const DEVPKEY_WiFiDirect_InterfaceGuid = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 3 };
pub const DEVPKEY_WiFiDirect_GroupId = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 4 };
pub const DEVPKEY_WiFiDirect_IsConnected = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 5 };
pub const DEVPKEY_WiFiDirect_IsVisible = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 6 };
pub const DEVPKEY_WiFiDirect_IsLegacyDevice = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 7 };
pub const DEVPKEY_WiFiDirect_MiracastVersion = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 8 };
pub const DEVPKEY_WiFiDirect_IsMiracastLCPSupported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 9 };
pub const DEVPKEY_WiFiDirect_Services = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 10 };
pub const DEVPKEY_WiFiDirect_SupportedChannelList = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 11 };
pub const DEVPKEY_WiFiDirect_InformationElements = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 12 };
pub const DEVPKEY_WiFiDirect_DeviceAddressCopy = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 13 };
pub const DEVPKEY_WiFiDirect_IsRecentlyAssociated = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 14 };
pub const DEVPKEY_WiFiDirect_Service_Aeps = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 15 };
pub const DEVPKEY_WiFiDirect_NoMiracastAutoProject = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 16 };
pub const DEVPKEY_InfraCast_Supported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 17 };
pub const DEVPKEY_InfraCast_StreamSecuritySupported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 18 };
pub const DEVPKEY_InfraCast_AccessPointBssid = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 19 };
pub const DEVPKEY_InfraCast_SinkHostName = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 20 };
pub const DEVPKEY_InfraCast_ChallengeAep = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 21 };
pub const DEVPKEY_WiFiDirect_IsDMGCapable = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 22 };
pub const DEVPKEY_InfraCast_DevnodeAep = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 23 };
pub const DEVPKEY_WiFiDirect_FoundWsbService = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 24 };
pub const DEVPKEY_InfraCast_HostName_ResolutionMode = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 25 };
pub const DEVPKEY_InfraCast_SinkIpAddress = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 26 };
pub const DEVPKEY_WiFiDirect_TransientAssociation = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 27 };
pub const DEVPKEY_WiFiDirect_LinkQuality = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 28 };
pub const DEVPKEY_InfraCast_PinSupported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 29 };
pub const DEVPKEY_InfraCast_RtspTcpConnectionParametersSupported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 30 };
pub const DEVPKEY_WiFiDirect_Miracast_SessionMgmtControlPort = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 31 };
pub const DEVPKEY_WiFiDirect_RtspTcpConnectionParametersSupported = DEVPROPKEY { .fmtid = Guid.initIntString("352752477, 58343, 17679, 134, 55, 130, 35, 62, 190, 95, 110"), .pid = 32 };
pub const DEVPKEY_WiFiDirectServices_ServiceAddress = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 2 };
pub const DEVPKEY_WiFiDirectServices_ServiceName = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 3 };
pub const DEVPKEY_WiFiDirectServices_ServiceInformation = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 4 };
pub const DEVPKEY_WiFiDirectServices_AdvertisementId = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 5 };
pub const DEVPKEY_WiFiDirectServices_ServiceConfigMethods = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 6 };
pub const DEVPKEY_WiFiDirectServices_RequestServiceInformation = DEVPROPKEY { .fmtid = Guid.initIntString("833845059, 31838, 16389, 147, 230, 233, 83, 249, 43, 130, 233"), .pid = 7 };
pub const DEVPKEY_WiFi_InterfaceGuid = DEVPROPKEY { .fmtid = Guid.initIntString("4010895339, 52220, 17217, 165, 104, 167, 201, 26, 104, 152, 44"), .pid = 2 };
...
pub const WLAN_NOTIFICATION_SOURCES = enum(u32) {
    NONE = 0,
    ALL = 65535,
    ACM = 8,
    MSM = 16,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(WLAN_NOTIFICATION_SOURCES, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.NONE) else 0)
            | (if (o.ALL == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.ALL) else 0)
            | (if (o.ACM == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.ACM) else 0)
            | (if (o.MSM == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.MSM) else 0)
            | (if (o.SECURITY == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.SECURITY) else 0)
            | (if (o.IHV == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.IHV) else 0)
            | (if (o.HNWK == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.HNWK) else 0)
            | (if (o.ONEX == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.ONEX) else 0)
            | (if (o.DEVICE_SERVICE == 1) @intFromEnum(WLAN_NOTIFICATION_SOURCES.DEVICE_SERVICE) else 0)
        ));
    }
};
pub const WLAN_NOTIFICATION_SOURCE_NONE = WLAN_NOTIFICATION_SOURCES.NONE;
pub const WLAN_NOTIFICATION_SOURCE_ALL = WLAN_NOTIFICATION_SOURCES.ALL;
pub const WLAN_NOTIFICATION_SOURCE_ACM = WLAN_NOTIFICATION_SOURCES.ACM;
pub const WLAN_NOTIFICATION_SOURCE_MSM = WLAN_NOTIFICATION_SOURCES.MSM;
pub const WLAN_NOTIFICATION_SOURCE_SECURITY = WLAN_NOTIFICATION_SOURCES.SECURITY;
pub const WLAN_NOTIFICATION_SOURCE_IHV = WLAN_NOTIFICATION_SOURCES.IHV;
pub const WLAN_NOTIFICATION_SOURCE_HNWK = WLAN_NOTIFICATION_SOURCES.HNWK;
pub const WLAN_NOTIFICATION_SOURCE_ONEX = WLAN_NOTIFICATION_SOURCES.ONEX;
pub const WLAN_NOTIFICATION_SOURCE_DEVICE_SERVICE = WLAN_NOTIFICATION_SOURCES.DEVICE_SERVICE;

pub const DEVPROP_PCIROOTBUS_SECONDARYINTERFACE = enum(u32) {
    Conventional = 0,
    XMode1 = 1,
    XMode2 = 2,
    Express = 3,
};
pub const DevProp_PciRootBus_SecondaryInterface_PciConventional = DEVPROP_PCIROOTBUS_SECONDARYINTERFACE.Conventional;
pub const DevProp_PciRootBus_SecondaryInterface_PciXMode1 = DEVPROP_PCIROOTBUS_SECONDARYINTERFACE.XMode1;
pub const DevProp_PciRootBus_SecondaryInterface_PciXMode2 = DEVPROP_PCIROOTBUS_SECONDARYINTERFACE.XMode2;
pub const DevProp_PciRootBus_SecondaryInterface_PciExpress = DEVPROP_PCIROOTBUS_SECONDARYINTERFACE.Express;

pub const DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = enum(u32) {
    Conventional_33Mhz = 0,
    Conventional_66Mhz = 1,
    X_Mode1_66Mhz = 2,
    X_Mode1_100Mhz = 3,
    X_Mode1_133Mhz = 4,
    X_Mode1_ECC_66Mhz = 5,
    X_Mode1_ECC_100Mhz = 6,
    X_Mode1_ECC_133Mhz = 7,
    X_266_Mode2_66Mhz = 8,
    X_266_Mode2_100Mhz = 9,
    X_266_Mode2_133Mhz = 10,
    X_533_Mode2_66Mhz = 11,
    X_533_Mode2_100Mhz = 12,
    X_533_Mode2_133Mhz = 13,
};
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_Conventional_33Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.Conventional_33Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_Conventional_66Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.Conventional_66Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_66Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_66Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_100Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_100Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_133Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_133Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_66Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_ECC_66Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_100Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_ECC_100Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_133Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_Mode1_ECC_133Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_66Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_266_Mode2_66Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_100Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_266_Mode2_100Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_133Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_266_Mode2_133Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_66Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_533_Mode2_66Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_100Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_533_Mode2_100Mhz;
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_133Mhz = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE.X_533_Mode2_133Mhz;

pub const DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = enum(u32) {
    Conventional_33Mhz = 1,
    Conventional_66Mhz = 2,
    X_66Mhz = 4,
    X_133Mhz = 8,
    X_266Mhz = 16,
    X_533Mhz = 32,
};
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_Conventional_33Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.Conventional_33Mhz;
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_Conventional_66Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.Conventional_66Mhz;
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_66Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.X_66Mhz;
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_133Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.X_133Mhz;
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_266Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.X_266Mhz;
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_533Mhz = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES.X_533Mhz;

pub const DEVPROP_PCIROOTBUS_BUSWIDTH = enum(u32) {
    @"32Bits" = 0,
    @"64Bits" = 1,
};
pub const DevProp_PciRootBus_BusWidth_32Bits = DEVPROP_PCIROOTBUS_BUSWIDTH.@"32Bits";
pub const DevProp_PciRootBus_BusWidth_64Bits = DEVPROP_PCIROOTBUS_BUSWIDTH.@"64Bits";

pub const DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = enum(u32) {
    DeviceType_PciConventional = 0,
    DeviceType_PciX = 1,
    DeviceType_PciExpressEndpoint = 2,
    DeviceType_PciExpressLegacyEndpoint = 3,
    DeviceType_PciExpressRootComplexIntegratedEndpoint = 4,
    DeviceType_PciExpressTreatedAsPci = 5,
    BridgeType_PciConventional = 6,
    BridgeType_PciX = 7,
    BridgeType_PciExpressRootPort = 8,
    BridgeType_PciExpressUpstreamSwitchPort = 9,
    BridgeType_PciExpressDownstreamSwitchPort = 10,
    BridgeType_PciExpressToPciXBridge = 11,
    BridgeType_PciXToExpressBridge = 12,
    BridgeType_PciExpressTreatedAsPci = 13,
    BridgeType_PciExpressEventCollector = 14,
};
pub const DevProp_PciDevice_DeviceType_PciConventional = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciConventional;
pub const DevProp_PciDevice_DeviceType_PciX = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciX;
pub const DevProp_PciDevice_DeviceType_PciExpressEndpoint = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciExpressEndpoint;
pub const DevProp_PciDevice_DeviceType_PciExpressLegacyEndpoint = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciExpressLegacyEndpoint;
pub const DevProp_PciDevice_DeviceType_PciExpressRootComplexIntegratedEndpoint = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciExpressRootComplexIntegratedEndpoint;
pub const DevProp_PciDevice_DeviceType_PciExpressTreatedAsPci = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.DeviceType_PciExpressTreatedAsPci;
pub const DevProp_PciDevice_BridgeType_PciConventional = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciConventional;
pub const DevProp_PciDevice_BridgeType_PciX = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciX;
pub const DevProp_PciDevice_BridgeType_PciExpressRootPort = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressRootPort;
pub const DevProp_PciDevice_BridgeType_PciExpressUpstreamSwitchPort = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressUpstreamSwitchPort;
pub const DevProp_PciDevice_BridgeType_PciExpressDownstreamSwitchPort = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressDownstreamSwitchPort;
pub const DevProp_PciDevice_BridgeType_PciExpressToPciXBridge = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressToPciXBridge;
pub const DevProp_PciDevice_BridgeType_PciXToExpressBridge = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciXToExpressBridge;
pub const DevProp_PciDevice_BridgeType_PciExpressTreatedAsPci = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressTreatedAsPci;
pub const DevProp_PciDevice_BridgeType_PciExpressEventCollector = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE.BridgeType_PciExpressEventCollector;

pub const DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = enum(u32) {
    _Conventional_33MHz = 0,
    _Conventional_66MHz = 1,
    // X_Mode_Conventional_Pci = 0, this enum value conflicts with _Conventional_33MHz
    // X_Mode1_66Mhz = 1, this enum value conflicts with _Conventional_66MHz
    X_Mode1_100Mhz = 2,
    X_Mode1_133MHZ = 3,
    X_Mode1_ECC_66Mhz = 5,
    X_Mode1_ECC_100Mhz = 6,
    X_Mode1_ECC_133Mhz = 7,
    X_Mode2_266_66MHz = 9,
    X_Mode2_266_100MHz = 10,
    X_Mode2_266_133MHz = 11,
    X_Mode2_533_66MHz = 13,
    X_Mode2_533_100MHz = 14,
    X_Mode2_533_133MHz = 15,
};
pub const DevProp_PciDevice_CurrentSpeedAndMode_Pci_Conventional_33MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE._Conventional_33MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_Pci_Conventional_66MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE._Conventional_66MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode_Conventional_Pci = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE._Conventional_33MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_66Mhz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE._Conventional_66MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_100Mhz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode1_100Mhz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_133MHZ = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode1_133MHZ;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_66Mhz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode1_ECC_66Mhz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_100Mhz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode1_ECC_100Mhz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_133Mhz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode1_ECC_133Mhz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_66MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_266_66MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_100MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_266_100MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_133MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_266_133MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_66MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_533_66MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_100MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_533_100MHz;
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_133MHz = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE.X_Mode2_533_133MHz;

pub const DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE = enum(u32) {
    @"128Bytes" = 0,
    @"256Bytes" = 1,
    @"512Bytes" = 2,
    @"1024Bytes" = 3,
...
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_128Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"128Bytes";
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_256Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"256Bytes";
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_512Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"512Bytes";
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_1024Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"1024Bytes";
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_2048Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"2048Bytes";
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_4096Bytes = DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE.@"4096Bytes";

pub const DEVPROP_PCIEXPRESSDEVICE_LINKSPEED = enum(u32) {
    TwoAndHalf_Gbps = 1,
    Five_Gbps = 2,
};
pub const DevProp_PciExpressDevice_LinkSpeed_TwoAndHalf_Gbps = DEVPROP_PCIEXPRESSDEVICE_LINKSPEED.TwoAndHalf_Gbps;
pub const DevProp_PciExpressDevice_LinkSpeed_Five_Gbps = DEVPROP_PCIEXPRESSDEVICE_LINKSPEED.Five_Gbps;

pub const DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH = enum(u32) {
    @"1" = 1,
    @"2" = 2,
    @"4" = 4,
    @"8" = 8,
...
pub const DevProp_PciExpressDevice_LinkWidth_By_1 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"1";
pub const DevProp_PciExpressDevice_LinkWidth_By_2 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"2";
pub const DevProp_PciExpressDevice_LinkWidth_By_4 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"4";
pub const DevProp_PciExpressDevice_LinkWidth_By_8 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"8";
pub const DevProp_PciExpressDevice_LinkWidth_By_12 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"12";
pub const DevProp_PciExpressDevice_LinkWidth_By_16 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"16";
pub const DevProp_PciExpressDevice_LinkWidth_By_32 = DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH.@"32";

pub const DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION = enum(u32) {
    @"0" = 1,
    @"1" = 2,
};
pub const DevProp_PciExpressDevice_Spec_Version_10 = DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION.@"0";
pub const DevProp_PciExpressDevice_Spec_Version_11 = DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION.@"1";

pub const DEVPROP_PCIDEVICE_INTERRUPTTYPE = enum(u32) {
    LineBased = 1,
    Msi = 2,
    MsiX = 4,
};
pub const DevProp_PciDevice_InterruptType_LineBased = DEVPROP_PCIDEVICE_INTERRUPTTYPE.LineBased;
pub const DevProp_PciDevice_InterruptType_Msi = DEVPROP_PCIDEVICE_INTERRUPTTYPE.Msi;
pub const DevProp_PciDevice_InterruptType_MsiX = DEVPROP_PCIDEVICE_INTERRUPTTYPE.MsiX;

pub const DEVPROP_PCIDEVICE_SRIOVSUPPORT = enum(u32) {
    Ok = 0,
    MissingAcs = 1,
    MissingPfDriver = 2,
    NoBusResource = 3,
    DidntGetVfBarSpace = 4,
};
pub const DevProp_PciDevice_SriovSupport_Ok = DEVPROP_PCIDEVICE_SRIOVSUPPORT.Ok;
pub const DevProp_PciDevice_SriovSupport_MissingAcs = DEVPROP_PCIDEVICE_SRIOVSUPPORT.MissingAcs;
pub const DevProp_PciDevice_SriovSupport_MissingPfDriver = DEVPROP_PCIDEVICE_SRIOVSUPPORT.MissingPfDriver;
pub const DevProp_PciDevice_SriovSupport_NoBusResource = DEVPROP_PCIDEVICE_SRIOVSUPPORT.NoBusResource;
pub const DevProp_PciDevice_SriovSupport_DidntGetVfBarSpace = DEVPROP_PCIDEVICE_SRIOVSUPPORT.DidntGetVfBarSpace;

pub const DEVPROP_PCIDEVICE_ACSSUPPORT = enum(u32) {
    Present = 0,
    NotNeeded = 1,
    Missing = 2,
};
pub const DevProp_PciDevice_AcsSupport_Present = DEVPROP_PCIDEVICE_ACSSUPPORT.Present;
pub const DevProp_PciDevice_AcsSupport_NotNeeded = DEVPROP_PCIDEVICE_ACSSUPPORT.NotNeeded;
pub const DevProp_PciDevice_AcsSupport_Missing = DEVPROP_PCIDEVICE_ACSSUPPORT.Missing;

pub const DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = enum(u32) {
    NotSupported = 0,
    SingleFunctionSupported = 1,
    NoP2PSupported = 2,
    Supported = 3,
    Enhanced = 4,
};
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_NotSupported = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY.NotSupported;
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_SingleFunctionSupported = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY.SingleFunctionSupported;
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_NoP2PSupported = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY.NoP2PSupported;
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_Supported = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY.Supported;
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_Enhanced = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY.Enhanced;
...
pub const dot11_phy_type_eht = DOT11_PHY_TYPE.eht;
...
pub const WLAN_CONNECTION_PARAMETERS = extern struct {
    wlanConnectionMode: WLAN_CONNECTION_MODE,
    strProfile: ?[*:0]align(1) const u16,
...
pub const IDot11AdHocManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IDot11AdHocManager_CreateNetwork(self: *const T, Name: ?[*:0]align(1) const u16, Password: ?[*:0]align(1) const u16, GeographicalId: i32, pInterface: ?*IDot11AdHocInterface, pSecurity: ?*IDot11AdHocSecuritySettings, pContextGuid: ?*Guid, pIAdHoc: ?*?*IDot11AdHocNetwork) callconv(.Inline) HRESULT {
...
pub const IDot11AdHocNetwork = extern struct {
    pub const VTable = extern struct {
        ...
        Connect: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDot11AdHocNetwork,
                Passphrase: ?[*:0]align(1) const u16,
                GeographicalId: i32,
                fSaveProfile: BOOLEAN,
                fMakeSavedProfileUserSpecific: BOOLEAN,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDot11AdHocNetwork_Connect(self: *const T, Passphrase: ?[*:0]align(1) const u16, GeographicalId: i32, fSaveProfile: BOOLEAN, fMakeSavedProfileUserSpecific: BOOLEAN) callconv(.Inline) HRESULT {
...
pub extern "wlanapi" fn WlanGetProfile(
    hClientHandle: ?HANDLE,
    pInterfaceGuid: ?*const Guid,
    strProfileName: ?[*:0]align(1) const u16,
    pReserved: ?*anyopaque,
...
pub extern "wlanapi" fn WlanSetProfileEapXmlUserData(
    ...
    strProfileName: ?[*:0]align(1) const u16,
    dwFlags: WLAN_SET_EAPHOST_FLAGS,
    strEapXmlUserData: ?[*:0]align(1) const u16,
    pReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetProfile(
    ...
    pInterfaceGuid: ?*const Guid,
    dwFlags: u32,
    strProfileXml: ?[*:0]align(1) const u16,
    strAllUserProfileSecurity: ?[*:0]align(1) const u16,
    bOverwrite: BOOL,
    pReserved: ?*anyopaque,
    pdwReasonCode: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanRenameProfile(
    hClientHandle: ?HANDLE,
    pInterfaceGuid: ?*const Guid,
    strOldProfileName: ?[*:0]align(1) const u16,
    strNewProfileName: ?[*:0]align(1) const u16,
    pReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetProfileList(
    ...
    pInterfaceGuid: ?*const Guid,
    dwItems: u32,
    strProfileNames: [*]const ?[*:0]align(1) const u16,
    pReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetSecuritySettings(
    ...
    strModifiedSDDL: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanui" fn WlanUIEditProfile(
    dwClientVersion: u32,
    wstrProfileName: ?[*:0]align(1) const u16,
    pInterfaceGuid: ?*Guid,
    hWnd: ?HWND,
...
const EAP_ATTRIBUTES = @import("../../../windows/win32/security/extensible_authentication_protocol.zig").EAP_ATTRIBUTES;
const EAP_METHOD_TYPE = @import("../../../windows/win32/security/extensible_authentication_protocol.zig").EAP_METHOD_TYPE;
...
const NDIS_OBJECT_HEADER = @import("../../../windows/win32/network_management/ndis.zig").NDIS_OBJECT_HEADER;
const PWSTR = @import("../../../windows/win32/foundation.zig").PWSTR;
const WTSSESSION_NOTIFICATION = @import("../../../windows/win32/system/remote_desktop.zig").WTSSESSION_NOTIFICATION;
