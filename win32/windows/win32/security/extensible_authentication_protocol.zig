...
pub const IRouterProtocolConfig = extern struct {
    pub const VTable = extern struct {
        ...
        AddProtocol: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszMachineName: ?[*:0]align(1) const u16,
                dwTransportId: u32,
                dwProtocolId: u32,
                hWnd: ?HWND,
                dwFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IRouterProtocolConfig_AddProtocol(self: *const T, pszMachineName: ?[*:0]align(1) const u16, dwTransportId: u32, dwProtocolId: u32, hWnd: ?HWND, dwFlags: u32, pRouter: ?*IUnknown, uReserved1: usize) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRouterProtocolConfig_RemoveProtocol(self: *const T, pszMachineName: ?[*:0]align(1) const u16, dwTransportId: u32, dwProtocolId: u32, hWnd: ?HWND, dwFlags: u32, pRouter: ?*IUnknown, uReserved1: usize) callconv(.Inline) HRESULT {
...
pub const IAuthenticationProviderConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAuthenticationProviderConfig_Initialize(self: *const T, pszMachineName: ?[*:0]align(1) const u16, puConnectionParam: ?*usize) callconv(.Inline) HRESULT {
...
pub const IAccountingProviderConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAccountingProviderConfig_Initialize(self: *const T, pszMachineName: ?[*:0]align(1) const u16, puConnectionParam: ?*usize) callconv(.Inline) HRESULT {
...
pub const IEAPProviderConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEAPProviderConfig_Initialize(self: *const T, pszMachineName: ?[*:0]align(1) const u16, dwEapTypeId: u32, puConnectionParam: ?*usize) callconv(.Inline) HRESULT {
...
const IXMLDOMNode = @import("../../../windows/win32/data/xml/ms_xml.zig").IXMLDOMNode;
