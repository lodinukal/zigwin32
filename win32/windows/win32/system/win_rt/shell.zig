...
pub const IDDEInitializer = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                fileExtensionOrProtocol: ?[*:0]align(1) const u16,
                method: CreateProcessMethod,
                currentDirectory: ?[*:0]align(1) const u16,
                execTarget: ?*IShellItem,
                site: ?*IUnknown,
                application: ?[*:0]align(1) const u16,
                targetFile: ?[*:0]align(1) const u16,
                arguments: ?[*:0]align(1) const u16,
                verb: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IDDEInitializer_Initialize(self: *const T, fileExtensionOrProtocol: ?[*:0]align(1) const u16, method: CreateProcessMethod, currentDirectory: ?[*:0]align(1) const u16, execTarget: ?*IShellItem, site: ?*IUnknown, application: ?[*:0]align(1) const u16, targetFile: ?[*:0]align(1) const u16, arguments: ?[*:0]align(1) const u16, verb: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const IShellItem = @import("../../../../windows/win32/ui/shell.zig").IShellItem;
