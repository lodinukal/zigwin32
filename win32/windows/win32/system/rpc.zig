...
pub const TARGET_IS_NT1012_OR_LATER = @as(u32, 1);
pub const TARGET_IS_NT102_OR_LATER = @as(u32, 1);
...
pub const __RPCPROXY_H_VERSION__ = @as(u32, 477);
...
// Section: Types (238)
//--------------------------------------------------------------------------------
pub const PFN_RPC_ALLOCATE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: usize,
...
pub const PFN_RPC_FREE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?*anyopaque,
...
pub extern "rpcrt4" fn NDRSContextUnmarshall(
    pBuff: ?*anyopaque,
    DataRepresentation: u32,
) callconv(@import("std").os.windows.WINAPI) ?*NDR_SCONTEXT;
...
const IRpcChannelBuffer = @import("../../../windows/win32/system/com.zig").IRpcChannelBuffer;
const IRpcStubBuffer = @import("../../../windows/win32/system/com.zig").IRpcStubBuffer;
...
const RPC_C_IMP_LEVEL = @import("../../../windows/win32/system/com.zig").RPC_C_IMP_LEVEL;
const SYSTEMTIME = @import("../../../windows/win32/foundation.zig").SYSTEMTIME;

test {
    // The following '_ = <FuncPtrType>' lines are a workaround for https://github.com/ziglang/zig/issues/4476
    if (@hasDecl(@This(), "PFN_RPC_ALLOCATE")) { _ = PFN_RPC_ALLOCATE; }
    if (@hasDecl(@This(), "PFN_RPC_FREE")) { _ = PFN_RPC_FREE; }
