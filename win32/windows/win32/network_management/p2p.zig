...
pub extern "p2pgraph" fn PeerGraphCreate(
    ...
    pwzDatabaseName: ?[*:0]align(1) const u16,
...
pub extern "p2pgraph" fn PeerGraphOpen(
    pwzGraphId: ?[*:0]align(1) const u16,
    pwzPeerId: ?[*:0]align(1) const u16,
    pwzDatabaseName: ?[*:0]align(1) const u16,
    pSecurityInterface: ?*PEER_SECURITY_INTERFACE,
...
pub extern "p2pgraph" fn PeerGraphSearchRecords(
    hGraph: ?*anyopaque,
    pwzCriteria: ?[*:0]align(1) const u16,
    phPeerEnum: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphSetNodeAttributes(
    hGraph: ?*anyopaque,
    pwzAttributes: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupOpen(
    pwzIdentity: ?[*:0]align(1) const u16,
    pwzGroupPeerName: ?[*:0]align(1) const u16,
    pwzCloud: ?[*:0]align(1) const u16,
    phGroup: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupJoin(
    pwzIdentity: ?[*:0]align(1) const u16,
    pwzInvitation: ?[*:0]align(1) const u16,
    pwzCloud: ?[*:0]align(1) const u16,
    phGroup: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupPasswordJoin(
    pwzIdentity: ?[*:0]align(1) const u16,
    pwzInvitation: ?[*:0]align(1) const u16,
    pwzPassword: ?[*:0]align(1) const u16,
    pwzCloud: ?[*:0]align(1) const u16,
    phGroup: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupCreateInvitation(
    hGroup: ?*anyopaque,
    pwzIdentityInfo: ?[*:0]align(1) const u16,
...
pub extern "p2p" fn PeerGroupIssueCredentials(
    hGroup: ?*anyopaque,
    pwzSubjectIdentity: ?[*:0]align(1) const u16,
    pCredentialInfo: ?*PEER_CREDENTIAL_INFO,
    dwFlags: u32,
    ppwzInvitation: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerIdentityCreate(
    pwzClassifier: ?[*:0]align(1) const u16,
...
pub extern "p2p" fn PeerIdentityImport(
    pwzImportXML: ?[*:0]align(1) const u16,
    pwzPassword: ?[*:0]align(1) const u16,
    ppwzIdentity: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabSetEndpointName(
    pwzEndpointName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabAddContact(
    pwzContactData: ?[*:0]align(1) const u16,
...
pub extern "p2p" fn PeerCollabDeleteContact(
    pwzPeerName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerHostNameToPeerName(
    pwzHostName: ?[*:0]align(1) const u16,
    ppwzPeerName: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerPnrpRegister(
    pcwzPeerName: ?[*:0]align(1) const u16,
...
pub extern "p2p" fn PeerPnrpResolve(
    pcwzPeerName: ?[*:0]align(1) const u16,
    pcwzCloudName: ?[*:0]align(1) const u16,
    pcEndpoints: ?*u32,
...
pub extern "drtprov" fn DrtCreatePnrpBootstrapResolver(
    fPublish: BOOL,
    pwzPeerName: ?[*:0]align(1) const u16,
    pwzCloudName: ?[*:0]align(1) const u16,
    pwzPublishingIdentity: ?[*:0]align(1) const u16,
...
pub extern "drtprov" fn DrtCreateDnsBootstrapResolver(
    port: u16,
    pwszAddress: ?[*:0]align(1) const u16,
...
const CERT_PUBLIC_KEY_INFO = @import("../../../windows/win32/security/cryptography.zig").CERT_PUBLIC_KEY_INFO;
...
const SOCKET_ADDRESS_LIST = @import("../../../windows/win32/networking/win_sock.zig").SOCKET_ADDRESS_LIST;
