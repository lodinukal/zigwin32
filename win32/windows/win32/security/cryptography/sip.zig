...
pub const SIP_SUBJECTINFO = extern struct {
    ...
    pgSubjectType: ?*Guid,
    hFile: ?HANDLE,
    pwsFileName: ?[*:0]align(1) const u16,
    pwsDisplayName: ?[*:0]align(1) const u16,
    dwReserved1: u32,
    dwIntVersion: u32,
    hProv: usize,
...
const CERT_QUERY_ENCODING_TYPE = @import("../../../../windows/win32/security/cryptography.zig").CERT_QUERY_ENCODING_TYPE;
...
const MS_ADDINFO_CATALOGMEMBER = @import("../../../../windows/win32/security/cryptography/catalog.zig").MS_ADDINFO_CATALOGMEMBER;
