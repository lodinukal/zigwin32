...
pub const SECBUFFER_CERTIFICATE_REQUEST_CONTEXT = @as(u32, 29);
...
pub const ISC_RET_NO_POST_HANDSHAKE_AUTH = @as(u64, 17179869184);
...
pub const SECPKG_ATTR_SERIALIZED_REMOTE_CERT_CONTEXT_INPROC = @as(u32, 116);
pub const SECPKG_ATTR_SERIALIZED_REMOTE_CERT_CONTEXT = @as(u32, 117);
...
pub const LSAD_AES_CRYPT_SHA512_HASH_SIZE = @as(u32, 64);
pub const LSAD_AES_KEY_SIZE = @as(u32, 16);
pub const LSAD_AES_SALT_SIZE = @as(u32, 16);
pub const LSAD_AES_BLOCK_SIZE = @as(u32, 16);
...
pub const TRUST_ATTRIBUTE_DISABLE_AUTH_TARGET_VALIDATION = @as(u32, 4096);
...
pub const LSA_SCANNER_INFO_DISABLE_AUTH_TARGET_VALIDATION = @as(i32, 1);
pub const LSA_SCANNER_INFO_ADMIN_ALL_FLAGS = @as(i32, 1);
...
pub const KERB_CHECKSUM_SHA256 = @as(i32, -139);
pub const KERB_CHECKSUM_SHA384 = @as(i32, -140);
pub const KERB_CHECKSUM_SHA512 = @as(i32, -141);
...
pub const KERB_CLOUD_KERBEROS_DEBUG_DATA_VERSION = @as(u32, 1);
...
pub const SECPKG_MSVAV_FLAGS_VALID = @as(u32, 1);
pub const SECPKG_MSVAV_TIMESTAMP_VALID = @as(u32, 2);
...
pub const SECPKG_REDIRECTED_LOGON_GUID_INITIALIZER = Guid.initString("c2be5457-82eb-483e-ae4e-7468ef14d509");
...
pub const SECPKG_INTERFACE_VERSION_11 = @as(u32, 67108864);
...
pub const ISC_REQ_HIGH_FLAGS = enum(u64) {
    MESSAGES = 4294967296,
    DEFERRED_CRED_VALIDATION = 8589934592,
    NO_POST_HANDSHAKE_AUTH = 17179869184,
    _,
    pub fn initFlags(o: struct {
        MESSAGES: u1 = 0,
        DEFERRED_CRED_VALIDATION: u1 = 0,
        NO_POST_HANDSHAKE_AUTH: u1 = 0,
    }) ISC_REQ_HIGH_FLAGS {
        return @as(ISC_REQ_HIGH_FLAGS, @enumFromInt(
              (if (o.MESSAGES == 1) @intFromEnum(ISC_REQ_HIGH_FLAGS.MESSAGES) else 0)
            | (if (o.DEFERRED_CRED_VALIDATION == 1) @intFromEnum(ISC_REQ_HIGH_FLAGS.DEFERRED_CRED_VALIDATION) else 0)
            | (if (o.NO_POST_HANDSHAKE_AUTH == 1) @intFromEnum(ISC_REQ_HIGH_FLAGS.NO_POST_HANDSHAKE_AUTH) else 0)
        ));
    }
};
pub const ISC_REQ_MESSAGES = ISC_REQ_HIGH_FLAGS.MESSAGES;
pub const ISC_REQ_DEFERRED_CRED_VALIDATION = ISC_REQ_HIGH_FLAGS.DEFERRED_CRED_VALIDATION;
pub const ISC_REQ_NO_POST_HANDSHAKE_AUTH = ISC_REQ_HIGH_FLAGS.NO_POST_HANDSHAKE_AUTH;

pub const ISC_REQ_FLAGS = enum(u32) {
    DELEGATE = 1,
    MUTUAL_AUTH = 2,
    REPLAY_DETECT = 4,
    SEQUENCE_DETECT = 8,
    ...
    FORWARD_CREDENTIALS = 4194304,
    NO_INTEGRITY = 8388608,
    USE_HTTP_STYLE = 16777216,
    UNVERIFIED_TARGET_NAME = 536870912,
    CONFIDENTIALITY_ONLY = 1073741824,
    _,
    pub fn initFlags(o: struct {
        DELEGATE: u1 = 0,
        MUTUAL_AUTH: u1 = 0,
        ...
        return @as(ISC_REQ_FLAGS, @enumFromInt(
              (if (o.DELEGATE == 1) @intFromEnum(ISC_REQ_FLAGS.DELEGATE) else 0)
            | (if (o.MUTUAL_AUTH == 1) @intFromEnum(ISC_REQ_FLAGS.MUTUAL_AUTH) else 0)
            | (if (o.REPLAY_DETECT == 1) @intFromEnum(ISC_REQ_FLAGS.REPLAY_DETECT) else 0)
            | (if (o.SEQUENCE_DETECT == 1) @intFromEnum(ISC_REQ_FLAGS.SEQUENCE_DETECT) else 0)
            | (if (o.CONFIDENTIALITY == 1) @intFromEnum(ISC_REQ_FLAGS.CONFIDENTIALITY) else 0)
            | (if (o.USE_SESSION_KEY == 1) @intFromEnum(ISC_REQ_FLAGS.USE_SESSION_KEY) else 0)
            | (if (o.PROMPT_FOR_CREDS == 1) @intFromEnum(ISC_REQ_FLAGS.PROMPT_FOR_CREDS) else 0)
            | (if (o.USE_SUPPLIED_CREDS == 1) @intFromEnum(ISC_REQ_FLAGS.USE_SUPPLIED_CREDS) else 0)
            | (if (o.ALLOCATE_MEMORY == 1) @intFromEnum(ISC_REQ_FLAGS.ALLOCATE_MEMORY) else 0)
            | (if (o.USE_DCE_STYLE == 1) @intFromEnum(ISC_REQ_FLAGS.USE_DCE_STYLE) else 0)
            | (if (o.DATAGRAM == 1) @intFromEnum(ISC_REQ_FLAGS.DATAGRAM) else 0)
            | (if (o.CONNECTION == 1) @intFromEnum(ISC_REQ_FLAGS.CONNECTION) else 0)
            | (if (o.CALL_LEVEL == 1) @intFromEnum(ISC_REQ_FLAGS.CALL_LEVEL) else 0)
            | (if (o.FRAGMENT_SUPPLIED == 1) @intFromEnum(ISC_REQ_FLAGS.FRAGMENT_SUPPLIED) else 0)
            | (if (o.EXTENDED_ERROR == 1) @intFromEnum(ISC_REQ_FLAGS.EXTENDED_ERROR) else 0)
            | (if (o.STREAM == 1) @intFromEnum(ISC_REQ_FLAGS.STREAM) else 0)
            | (if (o.INTEGRITY == 1) @intFromEnum(ISC_REQ_FLAGS.INTEGRITY) else 0)
            | (if (o.IDENTIFY == 1) @intFromEnum(ISC_REQ_FLAGS.IDENTIFY) else 0)
            | (if (o.NULL_SESSION == 1) @intFromEnum(ISC_REQ_FLAGS.NULL_SESSION) else 0)
            | (if (o.MANUAL_CRED_VALIDATION == 1) @intFromEnum(ISC_REQ_FLAGS.MANUAL_CRED_VALIDATION) else 0)
            | (if (o.RESERVED1 == 1) @intFromEnum(ISC_REQ_FLAGS.RESERVED1) else 0)
            | (if (o.FRAGMENT_TO_FIT == 1) @intFromEnum(ISC_REQ_FLAGS.FRAGMENT_TO_FIT) else 0)
            | (if (o.FORWARD_CREDENTIALS == 1) @intFromEnum(ISC_REQ_FLAGS.FORWARD_CREDENTIALS) else 0)
            | (if (o.NO_INTEGRITY == 1) @intFromEnum(ISC_REQ_FLAGS.NO_INTEGRITY) else 0)
            | (if (o.USE_HTTP_STYLE == 1) @intFromEnum(ISC_REQ_FLAGS.USE_HTTP_STYLE) else 0)
            | (if (o.UNVERIFIED_TARGET_NAME == 1) @intFromEnum(ISC_REQ_FLAGS.UNVERIFIED_TARGET_NAME) else 0)
            | (if (o.CONFIDENTIALITY_ONLY == 1) @intFromEnum(ISC_REQ_FLAGS.CONFIDENTIALITY_ONLY) else 0)
        ));
    }
};
pub const ISC_REQ_DELEGATE = ISC_REQ_FLAGS.DELEGATE;
pub const ISC_REQ_MUTUAL_AUTH = ISC_REQ_FLAGS.MUTUAL_AUTH;
pub const ISC_REQ_REPLAY_DETECT = ISC_REQ_FLAGS.REPLAY_DETECT;
pub const ISC_REQ_SEQUENCE_DETECT = ISC_REQ_FLAGS.SEQUENCE_DETECT;
pub const ISC_REQ_CONFIDENTIALITY = ISC_REQ_FLAGS.CONFIDENTIALITY;
pub const ISC_REQ_USE_SESSION_KEY = ISC_REQ_FLAGS.USE_SESSION_KEY;
pub const ISC_REQ_PROMPT_FOR_CREDS = ISC_REQ_FLAGS.PROMPT_FOR_CREDS;
pub const ISC_REQ_USE_SUPPLIED_CREDS = ISC_REQ_FLAGS.USE_SUPPLIED_CREDS;
pub const ISC_REQ_ALLOCATE_MEMORY = ISC_REQ_FLAGS.ALLOCATE_MEMORY;
pub const ISC_REQ_USE_DCE_STYLE = ISC_REQ_FLAGS.USE_DCE_STYLE;
pub const ISC_REQ_DATAGRAM = ISC_REQ_FLAGS.DATAGRAM;
pub const ISC_REQ_CONNECTION = ISC_REQ_FLAGS.CONNECTION;
pub const ISC_REQ_CALL_LEVEL = ISC_REQ_FLAGS.CALL_LEVEL;
pub const ISC_REQ_FRAGMENT_SUPPLIED = ISC_REQ_FLAGS.FRAGMENT_SUPPLIED;
pub const ISC_REQ_EXTENDED_ERROR = ISC_REQ_FLAGS.EXTENDED_ERROR;
pub const ISC_REQ_STREAM = ISC_REQ_FLAGS.STREAM;
pub const ISC_REQ_INTEGRITY = ISC_REQ_FLAGS.INTEGRITY;
pub const ISC_REQ_IDENTIFY = ISC_REQ_FLAGS.IDENTIFY;
pub const ISC_REQ_NULL_SESSION = ISC_REQ_FLAGS.NULL_SESSION;
pub const ISC_REQ_MANUAL_CRED_VALIDATION = ISC_REQ_FLAGS.MANUAL_CRED_VALIDATION;
pub const ISC_REQ_RESERVED1 = ISC_REQ_FLAGS.RESERVED1;
pub const ISC_REQ_FRAGMENT_TO_FIT = ISC_REQ_FLAGS.FRAGMENT_TO_FIT;
pub const ISC_REQ_FORWARD_CREDENTIALS = ISC_REQ_FLAGS.FORWARD_CREDENTIALS;
pub const ISC_REQ_NO_INTEGRITY = ISC_REQ_FLAGS.NO_INTEGRITY;
pub const ISC_REQ_USE_HTTP_STYLE = ISC_REQ_FLAGS.USE_HTTP_STYLE;
pub const ISC_REQ_UNVERIFIED_TARGET_NAME = ISC_REQ_FLAGS.UNVERIFIED_TARGET_NAME;
pub const ISC_REQ_CONFIDENTIALITY_ONLY = ISC_REQ_FLAGS.CONFIDENTIALITY_ONLY;

pub const ASC_REQ_HIGH_FLAGS = enum(u64) {
    S = 4294967296,
    _,
    pub fn initFlags(o: struct {
        S: u1 = 0,
    }) ASC_REQ_HIGH_FLAGS {
        return @as(ASC_REQ_HIGH_FLAGS, @enumFromInt(
              (if (o.S == 1) @intFromEnum(ASC_REQ_HIGH_FLAGS.S) else 0)
        ));
    }
};
pub const ASC_REQ_MESSAGES = ASC_REQ_HIGH_FLAGS.S;

pub const ASC_REQ_FLAGS = enum(u32) {
    DELEGATE = 1,
    MUTUAL_AUTH = 2,
    REPLAY_DETECT = 4,
    SEQUENCE_DETECT = 8,
    ...
    LICENSING = 262144,
    IDENTIFY = 524288,
    ALLOW_NULL_SESSION = 1048576,
    ALLOW_NON_USER_LOGONS = 2097152,
    ALLOW_CONTEXT_REPLAY = 4194304,
    FRAGMENT_TO_FIT = 8388608,
    NO_TOKEN = 16777216,
    PROXY_BINDINGS = 67108864,
    ALLOW_MISSING_BINDINGS = 268435456,
    _,
    pub fn initFlags(o: struct {
        DELEGATE: u1 = 0,
        MUTUAL_AUTH: u1 = 0,
        ...
        return @as(ASC_REQ_FLAGS, @enumFromInt(
              (if (o.DELEGATE == 1) @intFromEnum(ASC_REQ_FLAGS.DELEGATE) else 0)
            | (if (o.MUTUAL_AUTH == 1) @intFromEnum(ASC_REQ_FLAGS.MUTUAL_AUTH) else 0)
            | (if (o.REPLAY_DETECT == 1) @intFromEnum(ASC_REQ_FLAGS.REPLAY_DETECT) else 0)
            | (if (o.SEQUENCE_DETECT == 1) @intFromEnum(ASC_REQ_FLAGS.SEQUENCE_DETECT) else 0)
            | (if (o.CONFIDENTIALITY == 1) @intFromEnum(ASC_REQ_FLAGS.CONFIDENTIALITY) else 0)
            | (if (o.USE_SESSION_KEY == 1) @intFromEnum(ASC_REQ_FLAGS.USE_SESSION_KEY) else 0)
            | (if (o.SESSION_TICKET == 1) @intFromEnum(ASC_REQ_FLAGS.SESSION_TICKET) else 0)
            | (if (o.ALLOCATE_MEMORY == 1) @intFromEnum(ASC_REQ_FLAGS.ALLOCATE_MEMORY) else 0)
            | (if (o.USE_DCE_STYLE == 1) @intFromEnum(ASC_REQ_FLAGS.USE_DCE_STYLE) else 0)
            | (if (o.DATAGRAM == 1) @intFromEnum(ASC_REQ_FLAGS.DATAGRAM) else 0)
            | (if (o.CONNECTION == 1) @intFromEnum(ASC_REQ_FLAGS.CONNECTION) else 0)
            | (if (o.CALL_LEVEL == 1) @intFromEnum(ASC_REQ_FLAGS.CALL_LEVEL) else 0)
            | (if (o.FRAGMENT_SUPPLIED == 1) @intFromEnum(ASC_REQ_FLAGS.FRAGMENT_SUPPLIED) else 0)
            | (if (o.EXTENDED_ERROR == 1) @intFromEnum(ASC_REQ_FLAGS.EXTENDED_ERROR) else 0)
            | (if (o.STREAM == 1) @intFromEnum(ASC_REQ_FLAGS.STREAM) else 0)
            | (if (o.INTEGRITY == 1) @intFromEnum(ASC_REQ_FLAGS.INTEGRITY) else 0)
            | (if (o.LICENSING == 1) @intFromEnum(ASC_REQ_FLAGS.LICENSING) else 0)
            | (if (o.IDENTIFY == 1) @intFromEnum(ASC_REQ_FLAGS.IDENTIFY) else 0)
            | (if (o.ALLOW_NULL_SESSION == 1) @intFromEnum(ASC_REQ_FLAGS.ALLOW_NULL_SESSION) else 0)
            | (if (o.ALLOW_NON_USER_LOGONS == 1) @intFromEnum(ASC_REQ_FLAGS.ALLOW_NON_USER_LOGONS) else 0)
            | (if (o.ALLOW_CONTEXT_REPLAY == 1) @intFromEnum(ASC_REQ_FLAGS.ALLOW_CONTEXT_REPLAY) else 0)
            | (if (o.FRAGMENT_TO_FIT == 1) @intFromEnum(ASC_REQ_FLAGS.FRAGMENT_TO_FIT) else 0)
            | (if (o.NO_TOKEN == 1) @intFromEnum(ASC_REQ_FLAGS.NO_TOKEN) else 0)
            | (if (o.PROXY_BINDINGS == 1) @intFromEnum(ASC_REQ_FLAGS.PROXY_BINDINGS) else 0)
            | (if (o.ALLOW_MISSING_BINDINGS == 1) @intFromEnum(ASC_REQ_FLAGS.ALLOW_MISSING_BINDINGS) else 0)
        ));
    }
};
pub const ASC_REQ_DELEGATE = ASC_REQ_FLAGS.DELEGATE;
pub const ASC_REQ_MUTUAL_AUTH = ASC_REQ_FLAGS.MUTUAL_AUTH;
pub const ASC_REQ_REPLAY_DETECT = ASC_REQ_FLAGS.REPLAY_DETECT;
pub const ASC_REQ_SEQUENCE_DETECT = ASC_REQ_FLAGS.SEQUENCE_DETECT;
pub const ASC_REQ_CONFIDENTIALITY = ASC_REQ_FLAGS.CONFIDENTIALITY;
pub const ASC_REQ_USE_SESSION_KEY = ASC_REQ_FLAGS.USE_SESSION_KEY;
pub const ASC_REQ_SESSION_TICKET = ASC_REQ_FLAGS.SESSION_TICKET;
pub const ASC_REQ_ALLOCATE_MEMORY = ASC_REQ_FLAGS.ALLOCATE_MEMORY;
pub const ASC_REQ_USE_DCE_STYLE = ASC_REQ_FLAGS.USE_DCE_STYLE;
pub const ASC_REQ_DATAGRAM = ASC_REQ_FLAGS.DATAGRAM;
pub const ASC_REQ_CONNECTION = ASC_REQ_FLAGS.CONNECTION;
pub const ASC_REQ_CALL_LEVEL = ASC_REQ_FLAGS.CALL_LEVEL;
pub const ASC_REQ_FRAGMENT_SUPPLIED = ASC_REQ_FLAGS.FRAGMENT_SUPPLIED;
pub const ASC_REQ_EXTENDED_ERROR = ASC_REQ_FLAGS.EXTENDED_ERROR;
pub const ASC_REQ_STREAM = ASC_REQ_FLAGS.STREAM;
pub const ASC_REQ_INTEGRITY = ASC_REQ_FLAGS.INTEGRITY;
pub const ASC_REQ_LICENSING = ASC_REQ_FLAGS.LICENSING;
pub const ASC_REQ_IDENTIFY = ASC_REQ_FLAGS.IDENTIFY;
pub const ASC_REQ_ALLOW_NULL_SESSION = ASC_REQ_FLAGS.ALLOW_NULL_SESSION;
pub const ASC_REQ_ALLOW_NON_USER_LOGONS = ASC_REQ_FLAGS.ALLOW_NON_USER_LOGONS;
pub const ASC_REQ_ALLOW_CONTEXT_REPLAY = ASC_REQ_FLAGS.ALLOW_CONTEXT_REPLAY;
pub const ASC_REQ_FRAGMENT_TO_FIT = ASC_REQ_FLAGS.FRAGMENT_TO_FIT;
pub const ASC_REQ_NO_TOKEN = ASC_REQ_FLAGS.NO_TOKEN;
pub const ASC_REQ_PROXY_BINDINGS = ASC_REQ_FLAGS.PROXY_BINDINGS;
pub const ASC_REQ_ALLOW_MISSING_BINDINGS = ASC_REQ_FLAGS.ALLOW_MISSING_BINDINGS;
...
pub const TRUSTED_INFORMATION_CLASS = enum(i32) {
    ...
    DomainAuthInformationInternalAes = 14,
    DomainFullInformationInternalAes = 15,
};
...
pub const TrustedDomainAuthInformationInternalAes = TRUSTED_INFORMATION_CLASS.DomainAuthInformationInternalAes;
pub const TrustedDomainFullInformationInternalAes = TRUSTED_INFORMATION_CLASS.DomainFullInformationInternalAes;
...
pub const LSA_FOREST_TRUST_RECORD_TYPE = enum(i32) {
    ...
    BinaryInfo = 3,
    ScannerInfo = 4,
    // RecordTypeLast = 4, this enum value conflicts with ScannerInfo
};
...
pub const ForestTrustBinaryInfo = LSA_FOREST_TRUST_RECORD_TYPE.BinaryInfo;
pub const ForestTrustScannerInfo = LSA_FOREST_TRUST_RECORD_TYPE.ScannerInfo;
pub const ForestTrustRecordTypeLast = LSA_FOREST_TRUST_RECORD_TYPE.ScannerInfo;
...
pub const PLSA_ADD_CREDENTIAL = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        PrimaryKeyValue: ?*LSA_STRING,
        Credentials: ?*LSA_STRING,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
        LogonId: ?*LUID,
        AuthenticationPackage: u32,
...
pub const PLSA_AP_LOGON_USER_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        AccountName: ?*?*LSA_UNICODE_STRING,
        AuthenticatingAuthority: ?*?*LSA_UNICODE_STRING,
        MachineName: ?*?*LSA_UNICODE_STRING,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
        ClientRequest: ?*?*anyopaque,
        LogonType: SECURITY_LOGON_TYPE,
...
pub const PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ClearPassword: ?*LSA_UNICODE_STRING,
        ...
        UPN: ?*LSA_UNICODE_STRING,
        UserName: ?*LSA_UNICODE_STRING,
        NetbiosDomainName: ?*LSA_UNICODE_STRING,
        DnsDomainName: ?*LSA_UNICODE_STRING,
...
pub const PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        CredentialName: ?*LSA_UNICODE_STRING,
    ) callconv(@import("std").os.windows.WINAPI) BOOLEAN,
    else => *const fn(
        CredentialName: ?*LSA_UNICODE_STRING,
    ) callconv(@import("std").os.windows.WINAPI) BOOLEAN,
...
pub const SECPKG_TARGETINFO = extern struct {
    DomainSid: ?PSID,
    ComputerName: ?[*:0]align(1) const u16,
};
...
pub const PLSA_REDIRECTED_LOGON_GET_SID = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        RedirectedLogonHandle: ?HANDLE,
        Sid: ?*?PSID,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
...
pub const PLSA_GET_CLIENT_INFO_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ClientInfo: ?*SECPKG_CLIENT_INFO_EX,
        StructSize: u32,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
        ClientInfo: ?*SECPKG_CLIENT_INFO_EX,
...
pub const PLSA_CREATE_TOKEN = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        AccountName: ?*LSA_UNICODE_STRING,
        AuthorityName: ?*LSA_UNICODE_STRING,
        Workstation: ?*LSA_UNICODE_STRING,
        ProfilePath: ?*LSA_UNICODE_STRING,
        Token: ?*?HANDLE,
        SubStatus: ?*i32,
...
pub const PLSA_AUDIT_LOGON = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        AccountName: ?*LSA_UNICODE_STRING,
        AuthenticatingAuthority: ?*LSA_UNICODE_STRING,
        WorkstationName: ?*LSA_UNICODE_STRING,
        UserSid: ?PSID,
        LogonType: SECURITY_LOGON_TYPE,
        TokenSource: ?*TOKEN_SOURCE,
        LogonId: ?*LUID,
...
pub const PLSA_GET_AUTH_DATA_FOR_USER = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        UserAuthData: ?*?*u8,
        UserAuthDataSize: ?*u32,
        UserFlatName: ?*LSA_UNICODE_STRING,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
        Name: ?*SECURITY_STRING,
        NameType: SECPKG_NAME_TYPE,
...
pub const PLSA_CRACK_SINGLE_NAME = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        FormatOffered: u32,
        PerformAtGC: BOOLEAN,
        NameInput: ?*LSA_UNICODE_STRING,
        Prefix: ?*LSA_UNICODE_STRING,
        RequestedFormat: u32,
        CrackedName: ?*LSA_UNICODE_STRING,
        DnsDomainName: ?*LSA_UNICODE_STRING,
        SubStatus: ?*u32,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
...
pub const PLSA_AUDIT_ACCOUNT_LOGON = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        AuditId: u32,
        Success: BOOLEAN,
        Source: ?*LSA_UNICODE_STRING,
        ClientName: ?*LSA_UNICODE_STRING,
        MappedName: ?*LSA_UNICODE_STRING,
        Status: NTSTATUS,
    ) callconv(@import("std").os.windows.WINAPI) NTSTATUS,
    else => *const fn(
        AuditId: u32,
...
pub const PLSA_GET_SERVICE_ACCOUNT_PASSWORD = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        CurrentPassword: ?*LSA_UNICODE_STRING,
        PreviousPassword: ?*LSA_UNICODE_STRING,
...
pub const SpAcquireCredentialsHandleFn = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        PrincipalName: ?*LSA_UNICODE_STRING,
...
pub const SpChangeAccountPasswordFn = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pDomainName: ?*LSA_UNICODE_STRING,
        pAccountName: ?*LSA_UNICODE_STRING,
        pOldPassword: ?*LSA_UNICODE_STRING,
        pNewPassword: ?*LSA_UNICODE_STRING,
        Impersonating: BOOLEAN,
...
pub const SpExtractTargetInfoFn = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ClientRequest: ?*?*anyopaque,
        // TODO: what to do with BytesParamIndex 3?
        ProtocolSubmitBuffer: ?*anyopaque,
...
pub const eTlsAlgorithmUsage = enum(i32) {
    KeyExchange = 0,
    Signature = 1,
    Cipher = 2,
    Digest = 3,
...
pub const TlsParametersCngAlgUsageKeyExchange = eTlsAlgorithmUsage.KeyExchange;
pub const TlsParametersCngAlgUsageSignature = eTlsAlgorithmUsage.Signature;
pub const TlsParametersCngAlgUsageCipher = eTlsAlgorithmUsage.Cipher;
pub const TlsParametersCngAlgUsageDigest = eTlsAlgorithmUsage.Digest;
pub const TlsParametersCngAlgUsageCertSig = eTlsAlgorithmUsage.CertSig;
...
pub const SchGetExtensionsOptions = enum(i32) {
...
pub const SslDeserializeCertificateStoreFn = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        SerializedCertificateStore: CRYPT_INTEGER_BLOB,
...
pub const USER_ALL_INFORMATION = extern struct {
    LastLogon: i64 align(4),
    LastLogoff: i64 align(4),
    PasswordLastSet: i64 align(4),
    AccountExpires: i64 align(4),
    PasswordCanChange: i64 align(4),
    PasswordMustChange: i64 align(4),
    UserName: LSA_UNICODE_STRING align(4),
    FullName: LSA_UNICODE_STRING align(4),
    HomeDirectory: LSA_UNICODE_STRING align(4),
    HomeDirectoryDrive: LSA_UNICODE_STRING align(4),
    ScriptPath: LSA_UNICODE_STRING align(4),
    ProfilePath: LSA_UNICODE_STRING align(4),
    AdminComment: LSA_UNICODE_STRING align(4),
    WorkStations: LSA_UNICODE_STRING align(4),
    UserComment: LSA_UNICODE_STRING align(4),
    Parameters: LSA_UNICODE_STRING align(4),
    LmPassword: LSA_UNICODE_STRING align(4),
    NtPassword: LSA_UNICODE_STRING align(4),
    PrivateData: LSA_UNICODE_STRING align(4),
...
pub const SL_AD_ACTIVATION_INFO = extern struct {
    ...
    pwszProductKey: ?[*:0]align(1) const u16,
    pwszActivationObjectName: ?[*:0]align(1) const u16,
};
...
pub const ICcgDomainAuthCredentials = extern struct {
    pub const VTable = extern struct {
        ...
        GetPasswordCredentials: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pluginInput: ?[*:0]align(1) const u16,
                domainName: ?*?PWSTR,
                username: ?*?PWSTR,
                password: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn ICcgDomainAuthCredentials_GetPasswordCredentials(self: *const T, pluginInput: ?[*:0]align(1) const u16, domainName: ?*?PWSTR, username: ?*?PWSTR, password: ?*?PWSTR) callconv(.Inline) HRESULT {
...
//--------------------------------------------------------------------------------
pub extern "advapi32" fn RtlGenRandom(
    // TODO: what to do with BytesParamIndex 1?
    RandomBuffer: ?*anyopaque,
    RandomBufferLength: u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

pub extern "advapi32" fn RtlEncryptMemory(
    // TODO: what to do with BytesParamIndex 1?
    Memory: ?*anyopaque,
    MemorySize: u32,
    OptionFlags: u32,
...
pub extern "advapi32" fn RtlDecryptMemory(
    // TODO: what to do with BytesParamIndex 1?
    Memory: ?*anyopaque,
    MemorySize: u32,
    OptionFlags: u32,
...
pub extern "advapi32" fn LsaQueryForestTrustInformation2(
    PolicyHandle: LSA_HANDLE,
    TrustedDomainName: ?*LSA_UNICODE_STRING,
    HighestRecordType: LSA_FOREST_TRUST_RECORD_TYPE,
    ForestTrustInfo: ?*?*LSA_FOREST_TRUST_INFORMATION2,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "advapi32" fn LsaSetForestTrustInformation2(
    PolicyHandle: LSA_HANDLE,
    TrustedDomainName: ?*LSA_UNICODE_STRING,
    HighestRecordType: LSA_FOREST_TRUST_RECORD_TYPE,
    ForestTrustInfo: ?*LSA_FOREST_TRUST_INFORMATION2,
...
pub extern "advapi32" fn AuditSetGlobalSaclW(
    ObjectTypeName: ?[*:0]align(1) const u16,
    Acl: ?*ACL,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows6.1'
pub extern "advapi32" fn AuditSetGlobalSaclA(
    ObjectTypeName: ?[*:0]align(1) const u8,
    Acl: ?*ACL,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "credui" fn SspiPromptForCredentialsW(
    ...
    pUiInfo: ?*anyopaque,
    dwAuthError: u32,
    pszPackage: ?[*:0]align(1) const u16,
...
pub extern "credui" fn SspiPromptForCredentialsA(
    pszTargetName: ?[*:0]align(1) const u8,
    pUiInfo: ?*anyopaque,
    dwAuthError: u32,
    pszPackage: ?[*:0]align(1) const u8,
    pInputAuthIdentity: ?*anyopaque,
    ppAuthIdentity: ?*?*anyopaque,
    pfSave: ?*i32,
    dwFlags: u32,
...
pub extern "secur32" fn SspiPrepareForCredRead(
    ...
    ppszCredmanTargetName: ?*const ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiPrepareForCredWrite(
    ...
    pCredmanCredentialType: ?*u32,
    ppszCredmanTargetName: ?*const ?PWSTR,
    ppszCredmanUserName: ?*const ?PWSTR,
    ppCredentialBlob: ?*?*u8,
...
pub extern "secur32" fn SspiEncodeAuthIdentityAsStrings(
    ...
    ppszUserName: ?*const ?PWSTR,
    ppszDomainName: ?*const ?PWSTR,
    ppszPackedCredentialsString: ?*const ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiEncodeStringsAsAuthIdentity(
    ...
    pszDomainName: ?[*:0]align(1) const u16,
    pszPackedCredentialsString: ?[*:0]align(1) const u16,
    ppAuthIdentity: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiExcludePackage(
    AuthIdentity: ?*anyopaque,
    pszPackageName: ?[*:0]align(1) const u16,
...
pub extern "schannel" fn SslDeserializeCertificateStore(
    SerializedCertificateStore: CRYPT_INTEGER_BLOB,
    ppCertContext: ?*?*CERT_CONTEXT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn TranslateNameA(
    lpAccountName: ?[*:0]align(1) const u8,
...
pub extern "secur32" fn TranslateNameW(
    lpAccountName: ?[*:0]align(1) const u16,
    AccountNameFormat: EXTENDED_NAME_FORMAT,
    DesiredNameFormat: EXTENDED_NAME_FORMAT,
...
pub extern "slc" fn SLInstallProofOfPurchase(
    hSLC: ?*anyopaque,
    pwszPKeyAlgorithm: ?[*:0]align(1) const u16,
    pwszPKeyString: ?[*:0]align(1) const u16,
...
pub extern "slc" fn SLConsumeRight(
    ...
    pwszRightName: ?[*:0]align(1) const u16,
...
pub extern "slcext" fn SLActivateProduct(
    ...
    pwszProxyServer: ?[*:0]align(1) const u16,
    wProxyPort: u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.0'
pub extern "slcext" fn SLGetServerStatus(
    pwszServerURL: ?[*:0]align(1) const u16,
    pwszAcquisitionType: ?[*:0]align(1) const u16,
    pwszProxyServer: ?[*:0]align(1) const u16,
    wProxyPort: u16,
    phrStatus: ?*HRESULT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLDepositOfflineConfirmationId(
    hSLC: ?*anyopaque,
    pProductSkuId: ?*const Guid,
    pwszInstallationId: ?[*:0]align(1) const u16,
    pwszConfirmationId: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLFireEvent(
    hSLC: ?*anyopaque,
    pwszEventId: ?[*:0]align(1) const u16,
    pApplicationId: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slcext" fn SLAcquireGenuineTicket(
    ...
    pcbTicketBlob: ?*u32,
    pwszTemplateId: ?[*:0]align(1) const u16,
    pwszServerUrl: ?[*:0]align(1) const u16,
    pwszClientToken: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const CERT_CONTEXT = @import("../../../../windows/win32/security/cryptography.zig").CERT_CONTEXT;
const CHAR = @import("../../../../windows/win32/foundation.zig").CHAR;
const CREDENTIAL_TARGET_INFORMATIONW = @import("../../../../windows/win32/security/credentials.zig").CREDENTIAL_TARGET_INFORMATIONW;
const CREDENTIALW = @import("../../../../windows/win32/security/credentials.zig").CREDENTIALW;
const CRYPT_INTEGER_BLOB = @import("../../../../windows/win32/security/cryptography.zig").CRYPT_INTEGER_BLOB;
const CYPHER_BLOCK = @import("../../../../windows/win32/system/password_management.zig").CYPHER_BLOCK;
const FILETIME = @import("../../../../windows/win32/foundation.zig").FILETIME;
const HANDLE = @import("../../../../windows/win32/foundation.zig").HANDLE;
const HCERTSTORE = @import("../../../../windows/win32/security/cryptography.zig").HCERTSTORE;
...
const LM_OWF_PASSWORD = @import("../../../../windows/win32/system/password_management.zig").LM_OWF_PASSWORD;
...
const QUOTA_LIMITS = @import("../../../../windows/win32/security.zig").QUOTA_LIMITS;
const SEC_WINNT_AUTH_IDENTITY_A = @import("../../../../windows/win32/system/rpc.zig").SEC_WINNT_AUTH_IDENTITY_A;
const SEC_WINNT_AUTH_IDENTITY_W = @import("../../../../windows/win32/system/rpc.zig").SEC_WINNT_AUTH_IDENTITY_W;
const SecHandle = @import("../../../../windows/win32/security/credentials.zig").SecHandle;
const SECURITY_ATTRIBUTES = @import("../../../../windows/win32/security.zig").SECURITY_ATTRIBUTES;
const SECURITY_IMPERSONATION_LEVEL = @import("../../../../windows/win32/security.zig").SECURITY_IMPERSONATION_LEVEL;
const SID_NAME_USE = @import("../../../../windows/win32/security.zig").SID_NAME_USE;
const TOKEN_DEFAULT_DACL = @import("../../../../windows/win32/security.zig").TOKEN_DEFAULT_DACL;
const TOKEN_DEVICE_CLAIMS = @import("../../../../windows/win32/security.zig").TOKEN_DEVICE_CLAIMS;
const TOKEN_GROUPS = @import("../../../../windows/win32/security.zig").TOKEN_GROUPS;
const TOKEN_OWNER = @import("../../../../windows/win32/security.zig").TOKEN_OWNER;
const TOKEN_PRIMARY_GROUP = @import("../../../../windows/win32/security.zig").TOKEN_PRIMARY_GROUP;
const TOKEN_PRIVILEGES = @import("../../../../windows/win32/security.zig").TOKEN_PRIVILEGES;
const TOKEN_SOURCE = @import("../../../../windows/win32/security.zig").TOKEN_SOURCE;
const TOKEN_USER = @import("../../../../windows/win32/security.zig").TOKEN_USER;
const TOKEN_USER_CLAIMS = @import("../../../../windows/win32/security.zig").TOKEN_USER_CLAIMS;
...
test {
    ...
    if (@hasDecl(@This(), "PLSA_REDIRECTED_LOGON_GET_SID")) { _ = PLSA_REDIRECTED_LOGON_GET_SID; }
    ...
    if (@hasDecl(@This(), "PLSA_GET_CLIENT_INFO_EX")) { _ = PLSA_GET_CLIENT_INFO_EX; }
    ...
    if (@hasDecl(@This(), "SpExtractTargetInfoFn")) { _ = SpExtractTargetInfoFn; }
    ...
    if (@hasDecl(@This(), "SslDeserializeCertificateStoreFn")) { _ = SslDeserializeCertificateStoreFn; }
