...
pub const IWinMLModel = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinMLModel_EnumerateMetadata(self: *const T, Index: u32, pKey: ?*const ?PWSTR, pValue: ?*const ?PWSTR) callconv(.Inline) HRESULT {
...
pub const IWinMLEvaluationContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinMLEvaluationContext_GetValueByName(self: *const T, Name: ?[*:0]align(1) const u16, pDescriptor: ?*?*WINML_BINDING_DESC) callconv(.Inline) HRESULT {
...
pub const IWinMLRuntime = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinMLRuntime_LoadModel(self: *const T, Path: ?[*:0]align(1) const u16, ppModel: ?*?*IWinMLModel) callconv(.Inline) HRESULT {
...
pub const IMLOperatorAttributes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLOperatorAttributes_GetAttributeElementCount(self: *const T, name: ?[*:0]align(1) const u8, type_: MLOperatorAttributeType, elementCount: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLOperatorAttributes_GetAttribute(self: *const T, name: ?[*:0]align(1) const u8, type_: MLOperatorAttributeType, elementCount: u32, elementByteSize: usize, value: ?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLOperatorAttributes_GetStringAttributeElementLength(self: *const T, name: ?[*:0]align(1) const u8, elementIndex: u32, attributeElementByteSize: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLOperatorAttributes_GetStringAttributeElement(self: *const T, name: ?[*:0]align(1) const u8, elementIndex: u32, attributeElementByteSize: u32, attributeElement: [*:0]u8) callconv(.Inline) HRESULT {
...
const ID3D12Device = @import("../../../../windows/win32/graphics/direct3d12.zig").ID3D12Device;
const ID3D12Resource = @import("../../../../windows/win32/graphics/direct3d12.zig").ID3D12Resource;
