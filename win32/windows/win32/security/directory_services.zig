...
pub extern "dssec" fn DSCreateISecurityInfoObject(
    pwszObjectPath: ?[*:0]align(1) const u16,
    pwszObjectClass: ?[*:0]align(1) const u16,
    dwFlags: u32,
...
pub extern "dssec" fn DSEditSecurity(
    ...
    pwszObjectClass: ?[*:0]align(1) const u16,
    dwFlags: u32,
    pwszCaption: ?[*:0]align(1) const u16,
    pfnReadSD: ?PFNREADOBJECTSECURITY,
    pfnWriteSD: ?PFNWRITEOBJECTSECURITY,
    lpContext: LPARAM,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const ISecurityInformation = @import("../../../windows/win32/security/authorization/ui.zig").ISecurityInformation;
