...
const IID_ILearningModelSessionOptionsNative1_Value = Guid.initString("5da37a26-0526-414b-91e4-2a0fa3ddba40");
pub const IID_ILearningModelSessionOptionsNative1 = &IID_ILearningModelSessionOptionsNative1_Value;
pub const ILearningModelSessionOptionsNative1 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        SetIntraOpThreadSpinning: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ILearningModelSessionOptionsNative1,
                allowSpinning: u8,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ILearningModelSessionOptionsNative1,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ILearningModelSessionOptionsNative1_SetIntraOpThreadSpinning(self: *const T, allowSpinning: u8) callconv(.Inline) HRESULT {
            return @as(*const ILearningModelSessionOptionsNative1.VTable, @ptrCast(self.vtable)).SetIntraOpThreadSpinning(@as(*const ILearningModelSessionOptionsNative1, @ptrCast(self)), allowSpinning);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const ID3D12CommandQueue = @import("../../../../windows/win32/graphics/direct3d12.zig").ID3D12CommandQueue;
const ID3D12Resource = @import("../../../../windows/win32/graphics/direct3d12.zig").ID3D12Resource;
const IMLOperatorRegistry = @import("../../../../windows/win32/ai/machine_learning/win_ml.zig").IMLOperatorRegistry;
