...
pub const IME_CONVERSION_MODE = enum(u32) {
    ALPHANUMERIC = 0,
    NATIVE = 1,
    // CHINESE = 1, this enum value conflicts with NATIVE
    // HANGUL = 1, this enum value conflicts with NATIVE
    // JAPANESE = 1, this enum value conflicts with NATIVE
    KATAKANA = 2,
    LANGUAGE = 3,
    FULLSHAPE = 8,
    ROMAN = 16,
    ...
    HANJACONVERT = 64,
    NATIVESYMBOL = 128,
    // HANGEUL = 1, this enum value conflicts with NATIVE
    // SOFTKBD = 128, this enum value conflicts with NATIVESYMBOL
    NOCONVERSION = 256,
    EUDC = 512,
    SYMBOL = 1024,
    FIXED = 2048,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IME_CONVERSION_MODE, @enumFromInt(
              (if (o.ALPHANUMERIC == 1) @intFromEnum(IME_CONVERSION_MODE.ALPHANUMERIC) else 0)
            | (if (o.NATIVE == 1) @intFromEnum(IME_CONVERSION_MODE.NATIVE) else 0)
            | (if (o.KATAKANA == 1) @intFromEnum(IME_CONVERSION_MODE.KATAKANA) else 0)
            | (if (o.LANGUAGE == 1) @intFromEnum(IME_CONVERSION_MODE.LANGUAGE) else 0)
            | (if (o.FULLSHAPE == 1) @intFromEnum(IME_CONVERSION_MODE.FULLSHAPE) else 0)
            | (if (o.ROMAN == 1) @intFromEnum(IME_CONVERSION_MODE.ROMAN) else 0)
            | (if (o.CHARCODE == 1) @intFromEnum(IME_CONVERSION_MODE.CHARCODE) else 0)
            | (if (o.HANJACONVERT == 1) @intFromEnum(IME_CONVERSION_MODE.HANJACONVERT) else 0)
            | (if (o.NATIVESYMBOL == 1) @intFromEnum(IME_CONVERSION_MODE.NATIVESYMBOL) else 0)
            | (if (o.NOCONVERSION == 1) @intFromEnum(IME_CONVERSION_MODE.NOCONVERSION) else 0)
            | (if (o.EUDC == 1) @intFromEnum(IME_CONVERSION_MODE.EUDC) else 0)
            | (if (o.SYMBOL == 1) @intFromEnum(IME_CONVERSION_MODE.SYMBOL) else 0)
            | (if (o.FIXED == 1) @intFromEnum(IME_CONVERSION_MODE.FIXED) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(IME_CONVERSION_MODE.RESERVED) else 0)
        ));
    }
};
pub const IME_CMODE_ALPHANUMERIC = IME_CONVERSION_MODE.ALPHANUMERIC;
pub const IME_CMODE_NATIVE = IME_CONVERSION_MODE.NATIVE;
pub const IME_CMODE_CHINESE = IME_CONVERSION_MODE.NATIVE;
pub const IME_CMODE_HANGUL = IME_CONVERSION_MODE.NATIVE;
pub const IME_CMODE_JAPANESE = IME_CONVERSION_MODE.NATIVE;
pub const IME_CMODE_KATAKANA = IME_CONVERSION_MODE.KATAKANA;
pub const IME_CMODE_LANGUAGE = IME_CONVERSION_MODE.LANGUAGE;
pub const IME_CMODE_FULLSHAPE = IME_CONVERSION_MODE.FULLSHAPE;
pub const IME_CMODE_ROMAN = IME_CONVERSION_MODE.ROMAN;
pub const IME_CMODE_CHARCODE = IME_CONVERSION_MODE.CHARCODE;
pub const IME_CMODE_HANJACONVERT = IME_CONVERSION_MODE.HANJACONVERT;
pub const IME_CMODE_NATIVESYMBOL = IME_CONVERSION_MODE.NATIVESYMBOL;
pub const IME_CMODE_HANGEUL = IME_CONVERSION_MODE.NATIVE;
pub const IME_CMODE_SOFTKBD = IME_CONVERSION_MODE.NATIVESYMBOL;
pub const IME_CMODE_NOCONVERSION = IME_CONVERSION_MODE.NOCONVERSION;
pub const IME_CMODE_EUDC = IME_CONVERSION_MODE.EUDC;
pub const IME_CMODE_SYMBOL = IME_CONVERSION_MODE.SYMBOL;
pub const IME_CMODE_FIXED = IME_CONVERSION_MODE.FIXED;
pub const IME_CMODE_RESERVED = IME_CONVERSION_MODE.RESERVED;

pub const IME_SENTENCE_MODE = enum(u32) {
    NONE = 0,
    PLAURALCLAUSE = 1,
    SINGLECONVERT = 2,
    AUTOMATIC = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IME_SENTENCE_MODE, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(IME_SENTENCE_MODE.NONE) else 0)
            | (if (o.PLAURALCLAUSE == 1) @intFromEnum(IME_SENTENCE_MODE.PLAURALCLAUSE) else 0)
            | (if (o.SINGLECONVERT == 1) @intFromEnum(IME_SENTENCE_MODE.SINGLECONVERT) else 0)
            | (if (o.AUTOMATIC == 1) @intFromEnum(IME_SENTENCE_MODE.AUTOMATIC) else 0)
            | (if (o.PHRASEPREDICT == 1) @intFromEnum(IME_SENTENCE_MODE.PHRASEPREDICT) else 0)
            | (if (o.CONVERSATION == 1) @intFromEnum(IME_SENTENCE_MODE.CONVERSATION) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(IME_SENTENCE_MODE.RESERVED) else 0)
        ));
    }
};
pub const IME_SMODE_NONE = IME_SENTENCE_MODE.NONE;
pub const IME_SMODE_PLAURALCLAUSE = IME_SENTENCE_MODE.PLAURALCLAUSE;
pub const IME_SMODE_SINGLECONVERT = IME_SENTENCE_MODE.SINGLECONVERT;
pub const IME_SMODE_AUTOMATIC = IME_SENTENCE_MODE.AUTOMATIC;
pub const IME_SMODE_PHRASEPREDICT = IME_SENTENCE_MODE.PHRASEPREDICT;
pub const IME_SMODE_CONVERSATION = IME_SENTENCE_MODE.CONVERSATION;
pub const IME_SMODE_RESERVED = IME_SENTENCE_MODE.RESERVED;

pub const IME_COMPOSITION_STRING = enum(u32) {
    COMPREADSTR = 1,
    COMPREADATTR = 2,
    COMPREADCLAUSE = 4,
    COMPSTR = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IME_COMPOSITION_STRING, @enumFromInt(
              (if (o.COMPREADSTR == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPREADSTR) else 0)
            | (if (o.COMPREADATTR == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPREADATTR) else 0)
            | (if (o.COMPREADCLAUSE == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPREADCLAUSE) else 0)
            | (if (o.COMPSTR == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPSTR) else 0)
            | (if (o.COMPATTR == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPATTR) else 0)
            | (if (o.COMPCLAUSE == 1) @intFromEnum(IME_COMPOSITION_STRING.COMPCLAUSE) else 0)
            | (if (o.CURSORPOS == 1) @intFromEnum(IME_COMPOSITION_STRING.CURSORPOS) else 0)
            | (if (o.DELTASTART == 1) @intFromEnum(IME_COMPOSITION_STRING.DELTASTART) else 0)
            | (if (o.RESULTREADSTR == 1) @intFromEnum(IME_COMPOSITION_STRING.RESULTREADSTR) else 0)
            | (if (o.RESULTREADCLAUSE == 1) @intFromEnum(IME_COMPOSITION_STRING.RESULTREADCLAUSE) else 0)
            | (if (o.RESULTSTR == 1) @intFromEnum(IME_COMPOSITION_STRING.RESULTSTR) else 0)
            | (if (o.RESULTCLAUSE == 1) @intFromEnum(IME_COMPOSITION_STRING.RESULTCLAUSE) else 0)
        ));
    }
};
pub const GCS_COMPREADSTR = IME_COMPOSITION_STRING.COMPREADSTR;
pub const GCS_COMPREADATTR = IME_COMPOSITION_STRING.COMPREADATTR;
pub const GCS_COMPREADCLAUSE = IME_COMPOSITION_STRING.COMPREADCLAUSE;
pub const GCS_COMPSTR = IME_COMPOSITION_STRING.COMPSTR;
pub const GCS_COMPATTR = IME_COMPOSITION_STRING.COMPATTR;
pub const GCS_COMPCLAUSE = IME_COMPOSITION_STRING.COMPCLAUSE;
pub const GCS_CURSORPOS = IME_COMPOSITION_STRING.CURSORPOS;
pub const GCS_DELTASTART = IME_COMPOSITION_STRING.DELTASTART;
pub const GCS_RESULTREADSTR = IME_COMPOSITION_STRING.RESULTREADSTR;
pub const GCS_RESULTREADCLAUSE = IME_COMPOSITION_STRING.RESULTREADCLAUSE;
pub const GCS_RESULTSTR = IME_COMPOSITION_STRING.RESULTSTR;
pub const GCS_RESULTCLAUSE = IME_COMPOSITION_STRING.RESULTCLAUSE;
...
pub const REGISTERWORDENUMPROCA = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszReading: ?[*:0]align(1) const u8,
        param1: u32,
...
pub const REGISTERWORDENUMPROCW = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszReading: ?[*:0]align(1) const u16,
        param1: u32,
...
pub const IFELanguage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFELanguage_GetJMorphResult(self: *const T, dwRequest: u32, dwCMode: u32, cwchInput: i32, pwchInput: ?[*:0]align(1) const u16, pfCInfo: ?*u32, ppResult: ?*?*MORRSLT) callconv(.Inline) HRESULT {
...
pub const IFEDictionary = extern struct {
    pub const VTable = extern struct {
        ...
        GetWords: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IFEDictionary,
                pwchFirst: ?[*:0]align(1) const u16,
                pwchLast: ?[*:0]align(1) const u16,
                pwchDisplay: ?[*:0]align(1) const u16,
                ulPos: u32,
                ulSelect: u32,
                ulWordSrc: u32,
                pchBuffer: ?*u8,
        ...
        Create: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IFEDictionary,
                pchDictPath: ?[*:0]align(1) const u8,
                pshf: ?*IMESHF,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IFEDictionary,
        ...
        GetDependencies: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IFEDictionary,
                pwchKakariReading: ?[*:0]align(1) const u16,
                pwchKakariDisplay: ?[*:0]align(1) const u16,
                ulKakariPos: u32,
                pwchUkeReading: ?[*:0]align(1) const u16,
                pwchUkeDisplay: ?[*:0]align(1) const u16,
                ulUkePos: u32,
                jrel: IMEREL,
                ulWordSrc: u32,
                pchBuffer: ?*u8,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFEDictionary_GetWords(self: *const T, pwchFirst: ?[*:0]align(1) const u16, pwchLast: ?[*:0]align(1) const u16, pwchDisplay: ?[*:0]align(1) const u16, ulPos: u32, ulSelect: u32, ulWordSrc: u32, pchBuffer: ?*u8, cbBuffer: u32, pcWrd: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFEDictionary_Create(self: *const T, pchDictPath: ?[*:0]align(1) const u8, pshf: ?*IMESHF) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFEDictionary_GetDependencies(self: *const T, pwchKakariReading: ?[*:0]align(1) const u16, pwchKakariDisplay: ?[*:0]align(1) const u16, ulKakariPos: u32, pwchUkeReading: ?[*:0]align(1) const u16, pwchUkeDisplay: ?[*:0]align(1) const u16, ulUkePos: u32, jrel: IMEREL, ulWordSrc: u32, pchBuffer: ?*u8, cbBuffer: u32, pcdp: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFEDictionary_ConvertFromOldMSIME(self: *const T, pchDic: ?[*:0]align(1) const u8, pfnLog: ?PFNLOG, reg: IMEREG) callconv(.Inline) HRESULT {
...
pub const IActiveIMMRegistrar = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterIME: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                rclsid: ?*const Guid,
                lgid: u16,
                pszIconFile: ?[*:0]align(1) const u16,
                pszDesc: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IActiveIMMRegistrar,
                rclsid: ?*const Guid,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IActiveIMMRegistrar_RegisterIME(self: *const T, rclsid: ?*const Guid, lgid: u16, pszIconFile: ?[*:0]align(1) const u16, pszDesc: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub extern "imm32" fn ImmInstallIMEA(
    lpszIMEFileName: ?[*:0]align(1) const u8,
    lpszLayoutText: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HKL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "imm32" fn ImmInstallIMEW(
    lpszIMEFileName: ?[*:0]align(1) const u16,
    lpszLayoutText: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HKL;
...
pub extern "imm32" fn ImmRegisterWordA(
    ...
    lpszReading: ?[*:0]align(1) const u8,
    param2: u32,
    lpszRegister: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "imm32" fn ImmRegisterWordW(
    ...
    lpszReading: ?[*:0]align(1) const u16,
    param2: u32,
    lpszRegister: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "imm32" fn ImmUnregisterWordA(
    ...
    lpszReading: ?[*:0]align(1) const u8,
    param2: u32,
    lpszUnregister: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "imm32" fn ImmUnregisterWordW(
    ...
    lpszReading: ?[*:0]align(1) const u16,
    param2: u32,
    lpszUnregister: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
const HIMCC = @import("../../../../windows/win32/globalization.zig").HIMCC;
const HKL = @import("../../../../windows/win32/ui/text_services.zig").HKL;
