...
pub const INTERNET_OPTION_REQUEST_ANNOTATION = @as(u32, 193);
pub const INTERNET_FIRST_OPTION = @as(u32, 1);
pub const INTERNET_LAST_OPTION = @as(u32, 193);
...
pub const INTERNET_OPTION_REQUEST_ANNOTATION_MAX_LENGTH = @as(u32, 64000);
...
pub const INTERNET_OPTION_CALLER_MODULE = @as(u32, 192);
pub const INTERNET_LAST_OPTION_INTERNAL = @as(u32, 193);
...
pub const INTERNET_GLOBAL_CALLBACK_DETECTING_PROXY = @as(u32, 2);
...
pub const INTERNET_CONNECTION = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(INTERNET_CONNECTION, @enumFromInt(
            ...
            | (if (o.CONNECTION_LAN == 1) @intFromEnum(INTERNET_CONNECTION.CONNECTION_LAN) else 0)
            ...
            | (if (o.CONNECTION_OFFLINE == 1) @intFromEnum(INTERNET_CONNECTION.CONNECTION_OFFLINE) else 0)
...
pub const INTERNET_CONNECTION_LAN = INTERNET_CONNECTION.CONNECTION_LAN;
...
pub const INTERNET_CONNECTION_OFFLINE = INTERNET_CONNECTION.CONNECTION_OFFLINE;
...
pub const INTERNET_BUFFERSA = extern struct {
    ...
    lpcszHeader: ?[*:0]align(1) const u8,
    dwHeadersLength: u32,
    dwHeadersTotal: u32,
    lpvBuffer: ?*anyopaque,
    dwBufferLength: u32,
...
pub const INTERNET_BUFFERSW = extern struct {
    ...
    lpcszHeader: ?[*:0]align(1) const u16,
    dwHeadersLength: u32,
    dwHeadersTotal: u32,
    lpvBuffer: ?*anyopaque,
    dwBufferLength: u32,
...
pub const IncomingCookieState = extern struct {
    ...
    cDowngraded: i32,
    cBlocked: i32,
    pszLocation: ?[*:0]align(1) const u8,
};
...
pub const IDialEngine = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwzConnectoid: ?[*:0]align(1) const u16,
        ...
        GetProperty: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDialEngine,
                pwzProperty: ?[*:0]align(1) const u16,
                pwzValue: ?PWSTR,
                dwBufSize: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDialEngine_Initialize(self: *const T, pwzConnectoid: ?[*:0]align(1) const u16, pIDES: ?*IDialEventSink) callconv(.Inline) HRESULT {
            return @as(*const IDialEngine.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDialEngine, @ptrCast(self)), pwzConnectoid, pIDES);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDialEngine_GetProperty(self: *const T, pwzProperty: ?[*:0]align(1) const u16, pwzValue: ?PWSTR, dwBufSize: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDialEngine_SetProperty(self: *const T, pwzProperty: ?[*:0]align(1) const u16, pwzValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDialBranding = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDialBranding_Initialize(self: *const T, pwzConnectoid: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INTERNET_DOWNLOAD_MODE_HANDLE = extern struct {
    pcwszFileName: ?[*:0]align(1) const u16,
    phFile: ?*?HANDLE,
};
...
pub const INTERNET_SERVER_CONNECTION_STATE = extern struct {
    lpcwszHostName: ?[*:0]align(1) const u16,
    fProxy: BOOL,
    dwCounter: u32,
...
pub const INTERNET_CALLBACK_COOKIE = extern struct {
    ...
    pcwszValue: ?[*:0]align(1) const u16,
    pcwszDomain: ?[*:0]align(1) const u16,
    pcwszPath: ?[*:0]align(1) const u16,
    ftExpires: FILETIME,
    dwFlags: u32,
};
...
pub const INTERNET_CREDENTIALS = extern struct {
    ...
    lpcwszRealm: ?[*:0]align(1) const u16,
    fAuthIdentity: BOOL,
    Anonymous: extern union {
        Anonymous: extern struct {
            lpcwszUserName: ?[*:0]align(1) const u16,
            lpcwszPassword: ?[*:0]align(1) const u16,
        },
...
pub const IProofOfPossessionCookieInfoManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProofOfPossessionCookieInfoManager_GetCookieInfoForUri(self: *const T, uri: ?[*:0]align(1) const u16, cookieInfoCount: ?*u32, cookieInfo: [*]?*ProofOfPossessionCookieInfo) callconv(.Inline) HRESULT {
...
pub const IProofOfPossessionCookieInfoManager2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProofOfPossessionCookieInfoManager2_GetCookieInfoWithUriForAccount(self: *const T, webAccount: ?*IInspectable, uri: ?[*:0]align(1) const u16, cookieInfoCount: ?*u32, cookieInfo: [*]?*ProofOfPossessionCookieInfo) callconv(.Inline) HRESULT {
...
pub extern "wininet" fn InternetCombineUrlA(
    lpszBaseUrl: ?[*:0]align(1) const u8,
    lpszRelativeUrl: ?[*:0]align(1) const u8,
    lpszBuffer: [*:0]u8,
    lpdwBufferLength: ?*u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn InternetCombineUrlW(
    lpszBaseUrl: ?[*:0]align(1) const u16,
    lpszRelativeUrl: ?[*:0]align(1) const u16,
    lpszBuffer: [*:0]u16,
    lpdwBufferLength: ?*u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn InternetOpenA(
    lpszAgent: ?[*:0]align(1) const u8,
    dwAccessType: u32,
    lpszProxy: ?[*:0]align(1) const u8,
    lpszProxyBypass: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn InternetOpenW(
    lpszAgent: ?[*:0]align(1) const u16,
    dwAccessType: u32,
    lpszProxy: ?[*:0]align(1) const u16,
    lpszProxyBypass: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "wininet" fn InternetConnectA(
    hInternet: ?*anyopaque,
    lpszServerName: ?[*:0]align(1) const u8,
    nServerPort: u16,
    lpszUserName: ?[*:0]align(1) const u8,
    lpszPassword: ?[*:0]align(1) const u8,
    dwService: u32,
    dwFlags: u32,
    dwContext: usize,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "wininet" fn InternetConnectW(
    hInternet: ?*anyopaque,
    lpszServerName: ?[*:0]align(1) const u16,
    nServerPort: u16,
...
pub extern "wininet" fn FtpFindFirstFileA(
    hConnect: ?*anyopaque,
    lpszSearchFile: ?[*:0]align(1) const u8,
...
pub extern "wininet" fn FtpFindFirstFileW(
    hConnect: ?*anyopaque,
    lpszSearchFile: ?[*:0]align(1) const u16,
...
pub extern "wininet" fn FtpGetFileA(
    hConnect: ?*anyopaque,
    lpszRemoteFile: ?[*:0]align(1) const u8,
    lpszNewFile: ?[*:0]align(1) const u8,
    fFailIfExists: BOOL,
...
pub extern "wininet" fn FtpGetFileW(
    hConnect: ?*anyopaque,
    lpszRemoteFile: ?[*:0]align(1) const u16,
    lpszNewFile: ?[*:0]align(1) const u16,
    fFailIfExists: BOOL,
    dwFlagsAndAttributes: u32,
    dwFlags: u32,
    dwContext: usize,
...
pub extern "wininet" fn FtpPutFileA(
    hConnect: ?*anyopaque,
    lpszLocalFile: ?[*:0]align(1) const u8,
    lpszNewRemoteFile: ?[*:0]align(1) const u8,
    dwFlags: FTP_FLAGS,
    dwContext: usize,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn FtpPutFileW(
    hConnect: ?*anyopaque,
    lpszLocalFile: ?[*:0]align(1) const u16,
    lpszNewRemoteFile: ?[*:0]align(1) const u16,
    dwFlags: FTP_FLAGS,
    dwContext: usize,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn FtpRenameFileA(
    hConnect: ?*anyopaque,
    lpszExisting: ?[*:0]align(1) const u8,
    lpszNew: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn FtpRenameFileW(
    hConnect: ?*anyopaque,
    lpszExisting: ?[*:0]align(1) const u16,
    lpszNew: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn FtpCreateDirectoryA(
    hConnect: ?*anyopaque,
    lpszDirectory: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn FtpCreateDirectoryW(
    hConnect: ?*anyopaque,
    lpszDirectory: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn FtpCommandA(
    ...
    dwFlags: FTP_FLAGS,
    lpszCommand: ?[*:0]align(1) const u8,
    dwContext: usize,
...
pub extern "wininet" fn FtpCommandW(
    ...
    fExpectResponse: BOOL,
    dwFlags: FTP_FLAGS,
    lpszCommand: ?[*:0]align(1) const u16,
    dwContext: usize,
    phFtpCommand: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn GopherCreateLocatorA(
    lpszHost: ?[*:0]align(1) const u8,
    nServerPort: u16,
    lpszDisplayString: ?[*:0]align(1) const u8,
    lpszSelectorString: ?[*:0]align(1) const u8,
    dwGopherType: u32,
    lpszLocator: ?[*:0]u8,
    lpdwBufferLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn GopherCreateLocatorW(
    lpszHost: ?[*:0]align(1) const u16,
    nServerPort: u16,
    lpszDisplayString: ?[*:0]align(1) const u16,
    lpszSelectorString: ?[*:0]align(1) const u16,
    dwGopherType: u32,
    lpszLocator: ?[*:0]u16,
    lpdwBufferLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn GopherGetLocatorTypeA(
    lpszLocator: ?[*:0]align(1) const u8,
    lpdwGopherType: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn GopherGetLocatorTypeW(
    lpszLocator: ?[*:0]align(1) const u16,
    lpdwGopherType: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn GopherFindFirstFileA(
    hConnect: ?*anyopaque,
    lpszLocator: ?[*:0]align(1) const u8,
    lpszSearchString: ?[*:0]align(1) const u8,
...
pub extern "wininet" fn GopherFindFirstFileW(
    hConnect: ?*anyopaque,
    lpszLocator: ?[*:0]align(1) const u16,
    lpszSearchString: ?[*:0]align(1) const u16,
...
pub extern "wininet" fn GopherGetAttributeA(
    hConnect: ?*anyopaque,
    lpszLocator: ?[*:0]align(1) const u8,
    lpszAttributeName: ?[*:0]align(1) const u8,
    lpBuffer: [*:0]u8,
    dwBufferLength: u32,
...
pub extern "wininet" fn GopherGetAttributeW(
    hConnect: ?*anyopaque,
    lpszLocator: ?[*:0]align(1) const u16,
    lpszAttributeName: ?[*:0]align(1) const u16,
    lpBuffer: [*:0]u8,
    dwBufferLength: u32,
    lpdwCharactersReturned: ?*u32,
    lpfnEnumerator: ?GOPHER_ATTRIBUTE_ENUMERATOR,
...
pub extern "wininet" fn HttpOpenRequestA(
    hConnect: ?*anyopaque,
    lpszVerb: ?[*:0]align(1) const u8,
    lpszObjectName: ?[*:0]align(1) const u8,
    lpszVersion: ?[*:0]align(1) const u8,
    lpszReferrer: ?[*:0]align(1) const u8,
...
pub extern "wininet" fn HttpOpenRequestW(
    hConnect: ?*anyopaque,
    lpszVerb: ?[*:0]align(1) const u16,
    lpszObjectName: ?[*:0]align(1) const u16,
    lpszVersion: ?[*:0]align(1) const u16,
    lpszReferrer: ?[*:0]align(1) const u16,
...
pub extern "wininet" fn InternetSetCookieA(
    lpszUrl: ?[*:0]align(1) const u8,
    lpszCookieName: ?[*:0]align(1) const u8,
    lpszCookieData: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn InternetGetCookieEx2(
    ...
    pcwszCookieName: ?[*:0]align(1) const u16,
    dwFlags: u32,
...
pub extern "wininet" fn InternetSetCookieEx2(
    ...
    pcwszP3PPolicy: ?[*:0]align(1) const u16,
    dwFlags: u32,
    pdwCookieState: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wininet" fn CreateUrlCacheEntryA(
    lpszUrlName: ?[*:0]align(1) const u8,
    dwExpectedFileSize: u32,
    lpszFileExtension: ?[*:0]align(1) const u8,
    lpszFileName: *[260]u8,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn CreateUrlCacheEntryW(
    lpszUrlName: ?[*:0]align(1) const u16,
    dwExpectedFileSize: u32,
    lpszFileExtension: ?[*:0]align(1) const u16,
...
pub extern "wininet" fn CommitUrlCacheEntryA(
    lpszUrlName: ?[*:0]align(1) const u8,
    lpszLocalFileName: ?[*:0]align(1) const u8,
    ExpireTime: FILETIME,
    LastModifiedTime: FILETIME,
    CacheEntryType: u32,
    lpHeaderInfo: ?[*:0]u8,
    cchHeaderInfo: u32,
    lpszFileExtension: ?[*:0]align(1) const u8,
    lpszOriginalUrl: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn CommitUrlCacheEntryW(
    lpszUrlName: ?[*:0]align(1) const u16,
    lpszLocalFileName: ?[*:0]align(1) const u16,
    ExpireTime: FILETIME,
    LastModifiedTime: FILETIME,
    CacheEntryType: u32,
    ...
    cchHeaderInfo: u32,
    lpszFileExtension: ?[*:0]align(1) const u16,
    lpszOriginalUrl: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn FindFirstUrlCacheEntryExA(
    lpszUrlSearchPattern: ?[*:0]align(1) const u8,
    dwFlags: u32,
    dwFilter: u32,
    GroupId: i64,
...
pub extern "wininet" fn FindFirstUrlCacheEntryExW(
    lpszUrlSearchPattern: ?[*:0]align(1) const u16,
    dwFlags: u32,
    dwFilter: u32,
    GroupId: i64,
    // TODO: what to do with BytesParamIndex 5?
...
pub extern "wininet" fn InternetSetDialStateA(
    lpszConnectoid: ?[*:0]align(1) const u8,
    dwState: u32,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "wininet" fn InternetSetDialStateW(
    lpszConnectoid: ?[*:0]align(1) const u16,
    dwState: u32,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn InternetSetPerSiteCookieDecisionA(
    pchHostName: ?[*:0]align(1) const u8,
    dwDecision: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn InternetSetPerSiteCookieDecisionW(
    pchHostName: ?[*:0]align(1) const u16,
    dwDecision: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn PrivacySetZonePreferenceW(
    ...
    dwType: u32,
    dwTemplate: u32,
    pszPreference: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wininet" fn HttpCheckDavComplianceA(
    lpszUrl: ?[*:0]align(1) const u8,
    lpszComplianceToken: ?[*:0]align(1) const u8,
    lpfFound: ?*BOOL,
    hWnd: ?HWND,
...
pub extern "wininet" fn HttpCheckDavComplianceW(
    lpszUrl: ?[*:0]align(1) const u16,
    lpszComplianceToken: ?[*:0]align(1) const u16,
    lpfFound: ?*BOOL,
    hWnd: ?HWND,
    lpvReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn GetUrlCacheEntryBinaryBlob(
    pwszUrlName: ?[*:0]align(1) const u16,
    dwType: ?*u32,
...
pub extern "wininet" fn CreateUrlCacheContainerA(
    ...
    lpCachePrefix: ?[*:0]align(1) const u8,
    lpszCachePath: ?[*:0]align(1) const u8,
    KBCacheLimit: u32,
    dwContainerType: u32,
    dwOptions: u32,
    pvBuffer: ?*anyopaque,
...
pub extern "wininet" fn CreateUrlCacheContainerW(
    ...
    lpCachePrefix: ?[*:0]align(1) const u16,
    lpszCachePath: ?[*:0]align(1) const u16,
    KBCacheLimit: u32,
    dwContainerType: u32,
    dwOptions: u32,
    pvBuffer: ?*anyopaque,
...
pub extern "wininet" fn AppCacheCheckManifest(
    pwszMasterUrl: ?[*:0]align(1) const u16,
    pwszManifestUrl: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 3?
...
pub extern "wininet" fn AppCacheCreateAndCommitFile(
    hAppCache: ?*anyopaque,
    pwszSourceFilePath: ?[*:0]align(1) const u16,
    pwszUrl: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "wininet" fn UrlCacheCreateContainer(
    ...
    pwszPrefix: ?[*:0]align(1) const u16,
    pwszDirectory: ?[*:0]align(1) const u16,
    ullLimit: u64,
    dwOptions: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "wininet" fn UrlCacheCheckEntriesExist(
    rgpwszUrls: [*]const ?[*:0]align(1) const u16,
    cEntries: u32,
    rgfExist: [*]BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wininet" fn PerformOperationOverUrlCacheA(
    pszUrlSearchPattern: ?[*:0]align(1) const u8,
    dwFlags: u32,
    dwFilter: u32,
    GroupId: i64,
...
pub extern "wininet" fn IsDomainLegalCookieDomainA(
    pchDomain: ?[*:0]align(1) const u8,
    pchFullDomain: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "wininet" fn IsDomainLegalCookieDomainW(
    pchDomain: ?[*:0]align(1) const u16,
    pchFullDomain: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wininet" fn InternetConvertUrlFromWireToWideChar(
    pcszUrl: [*:0]const u8,
    cchUrl: u32,
    pcwszBaseUrl: ?[*:0]align(1) const u16,
    dwCodePageHost: u32,
    dwCodePagePath: u32,
...
const CERT_CHAIN_CONTEXT = @import("../../../windows/win32/security/cryptography.zig").CERT_CHAIN_CONTEXT;
...
const SecPkgContext_Bindings = @import("../../../windows/win32/security/authentication/identity.zig").SecPkgContext_Bindings;
const SecPkgContext_CipherInfo = @import("../../../windows/win32/security/authentication/identity.zig").SecPkgContext_CipherInfo;
const SecPkgContext_ConnectionInfo = @import("../../../windows/win32/security/authentication/identity.zig").SecPkgContext_ConnectionInfo;
...
const WIN32_FIND_DATAW = @import("../../../windows/win32/storage/file_system.zig").WIN32_FIND_DATAW;
const WIN_HTTP_CREATE_URL_FLAGS = @import("../../../windows/win32/networking/win_http.zig").WIN_HTTP_CREATE_URL_FLAGS;
