...
pub const KeyCredentialManagerOperationErrorStates = enum(i32) {
    None = 0,
    DeviceJoinFailure = 1,
    TokenFailure = 2,
...
pub const CREDUI_INFOA = extern struct {
    cbSize: u32,
    hwndParent: ?HWND,
    pszMessageText: ?[*:0]align(1) const u8,
    pszCaptionText: ?[*:0]align(1) const u8,
    hbmBanner: ?HBITMAP,
};
...
pub const CREDUI_INFOW = extern struct {
    cbSize: u32,
    hwndParent: ?HWND,
    pszMessageText: ?[*:0]align(1) const u16,
    pszCaptionText: ?[*:0]align(1) const u16,
    hbmBanner: ?HBITMAP,
};
...
pub const OPENCARDNAME_EXA = extern struct {
    ...
    lpstrSearchDesc: ?[*:0]align(1) const u8,
    hIcon: ?HICON,
...
pub const OPENCARDNAME_EXW = extern struct {
    ...
    lpstrSearchDesc: ?[*:0]align(1) const u16,
    hIcon: ?HICON,
...
pub extern "advapi32" fn CredRenameW(
    OldTargetName: ?[*:0]align(1) const u16,
    NewTargetName: ?[*:0]align(1) const u16,
    Type: CRED_TYPE,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredRenameA(
    OldTargetName: ?[*:0]align(1) const u8,
    NewTargetName: ?[*:0]align(1) const u8,
    Type: CRED_TYPE,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredUnmarshalCredentialW(
    MarshaledCredential: ?[*:0]align(1) const u16,
    CredType: ?*CRED_MARSHAL_TYPE,
    Credential: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredUnmarshalCredentialA(
    MarshaledCredential: ?[*:0]align(1) const u8,
    CredType: ?*CRED_MARSHAL_TYPE,
    Credential: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winscard" fn SCardGetCardTypeProviderNameW(
    hContext: usize,
    szCardName: ?[*:0]align(1) const u16,
    dwProviderId: u32,
    szProvider: [*:0]u16,
    pcchProvider: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardIntroduceReaderGroupA(
    hContext: usize,
    szGroupName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winscard" fn SCardIntroduceReaderGroupW(
    hContext: usize,
    szGroupName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardIntroduceReaderA(
    hContext: usize,
    szReaderName: ?[*:0]align(1) const u8,
    szDeviceName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winscard" fn SCardIntroduceReaderW(
    hContext: usize,
    szReaderName: ?[*:0]align(1) const u16,
    szDeviceName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardListReadersWithDeviceInstanceIdA(
    hContext: usize,
    szDeviceInstanceId: ?[*:0]align(1) const u8,
    mszReaders: ?[*:0]u8,
    pcchReaders: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardListReadersWithDeviceInstanceIdW(
    hContext: usize,
    szDeviceInstanceId: ?[*:0]align(1) const u16,
    mszReaders: ?[*:0]u16,
    pcchReaders: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
