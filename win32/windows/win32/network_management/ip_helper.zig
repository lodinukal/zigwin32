...
pub const DNS_INTERFACE_SETTINGS_VERSION4 = @as(u32, 4);
...
pub const DNS_SETTING_ENCRYPTED_DNS_ADAPTER_FLAGS = @as(u32, 16384);
pub const DNS_SETTING_DDR = @as(u32, 32768);
...
pub const DNS_ENABLE_DDR = @as(u32, 64);
...
pub const DNS_DOH_SERVER_SETTINGS_ENABLE_DDR = @as(u32, 16);
pub const DNS_DDR_ADAPTER_ENABLE_DOH = @as(u32, 1);
pub const DNS_DDR_ADAPTER_ENABLE_UDP_FALLBACK = @as(u32, 2);
pub const TCPIP_OWNING_MODULE_SIZE = @as(u32, 16);
pub const FILTER_ICMP_TYPE_ANY = @as(u8, 255);
pub const FILTER_ICMP_CODE_ANY = @as(u8, 255);
...
pub const TCPIP_OWNER_MODULE_BASIC_INFO = extern struct {
    pModuleName: ?[*]align(1) u16,
    pModulePath: ?[*]align(1) u16,
};
...
pub const IP_ADAPTER_ADDRESSES_LH = extern struct {
    ...
    DnsSuffix: ?[*]align(1) u16,
    Description: ?[*]align(1) u16,
    FriendlyName: ?[*]align(1) u16,
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iphlpapi" fn ParseNetworkString(
    NetworkString: ?[*:0]align(1) const u16,
    Types: u32,
    AddressInfo: ?*NET_ADDRESS_INFO,
    PortNumber: ?*u16,
    PrefixLength: ?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn ConvertInterfaceNameToLuidA(
    InterfaceName: ?[*:0]align(1) const u8,
    InterfaceLuid: ?*NET_LUID_LH,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iphlpapi" fn ConvertInterfaceNameToLuidW(
    InterfaceName: ?[*:0]align(1) const u16,
    InterfaceLuid: ?*NET_LUID_LH,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "iphlpapi" fn ConvertInterfaceAliasToLuid(
    InterfaceAlias: ?[*:0]align(1) const u16,
    InterfaceLuid: ?*NET_LUID_LH,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "iphlpapi" fn SetNetworkInformation(
    NetworkGuid: ?*const Guid,
    CompartmentId: u32,
    NetworkName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
const ADDRESS_FAMILY = @import("../../../windows/win32/networking/win_sock.zig").ADDRESS_FAMILY;
...
const IF_OPER_STATUS = @import("../../../windows/win32/network_management/ndis.zig").IF_OPER_STATUS;
const IN6_ADDR = @import("../../../windows/win32/networking/win_sock.zig").IN6_ADDR;
const NDIS_MEDIUM = @import("../../../windows/win32/network_management/ndis.zig").NDIS_MEDIUM;
const NDIS_PHYSICAL_MEDIUM = @import("../../../windows/win32/network_management/ndis.zig").NDIS_PHYSICAL_MEDIUM;
const NET_IF_ACCESS_TYPE = @import("../../../windows/win32/network_management/ndis.zig").NET_IF_ACCESS_TYPE;
const NET_IF_ADMIN_STATUS = @import("../../../windows/win32/network_management/ndis.zig").NET_IF_ADMIN_STATUS;
const NET_IF_CONNECTION_TYPE = @import("../../../windows/win32/network_management/ndis.zig").NET_IF_CONNECTION_TYPE;
const NET_IF_DIRECTION_TYPE = @import("../../../windows/win32/network_management/ndis.zig").NET_IF_DIRECTION_TYPE;
const NET_IF_MEDIA_CONNECT_STATE = @import("../../../windows/win32/network_management/ndis.zig").NET_IF_MEDIA_CONNECT_STATE;
const NET_LUID_LH = @import("../../../windows/win32/network_management/ndis.zig").NET_LUID_LH;
const NL_BANDWIDTH_INFORMATION = @import("../../../windows/win32/networking/win_sock.zig").NL_BANDWIDTH_INFORMATION;
const NL_DAD_STATE = @import("../../../windows/win32/networking/win_sock.zig").NL_DAD_STATE;
const NL_INTERFACE_OFFLOAD_ROD = @import("../../../windows/win32/networking/win_sock.zig").NL_INTERFACE_OFFLOAD_ROD;
const NL_LINK_LOCAL_ADDRESS_BEHAVIOR = @import("../../../windows/win32/networking/win_sock.zig").NL_LINK_LOCAL_ADDRESS_BEHAVIOR;
const NL_NEIGHBOR_STATE = @import("../../../windows/win32/networking/win_sock.zig").NL_NEIGHBOR_STATE;
const NL_NETWORK_CONNECTIVITY_HINT = @import("../../../windows/win32/networking/win_sock.zig").NL_NETWORK_CONNECTIVITY_HINT;
const NL_PREFIX_ORIGIN = @import("../../../windows/win32/networking/win_sock.zig").NL_PREFIX_ORIGIN;
const NL_ROUTE_ORIGIN = @import("../../../windows/win32/networking/win_sock.zig").NL_ROUTE_ORIGIN;
const NL_ROUTE_PROTOCOL = @import("../../../windows/win32/networking/win_sock.zig").NL_ROUTE_PROTOCOL;
const NL_ROUTER_DISCOVERY_BEHAVIOR = @import("../../../windows/win32/networking/win_sock.zig").NL_ROUTER_DISCOVERY_BEHAVIOR;
const NL_SUFFIX_ORIGIN = @import("../../../windows/win32/networking/win_sock.zig").NL_SUFFIX_ORIGIN;
const OVERLAPPED = @import("../../../windows/win32/system/io.zig").OVERLAPPED;
const PIO_APC_ROUTINE = @import("../../../windows/win32/system/io.zig").PIO_APC_ROUTINE;
const PSTR = @import("../../../windows/win32/foundation.zig").PSTR;
const PWSTR = @import("../../../windows/win32/foundation.zig").PWSTR;
const SCOPE_ID = @import("../../../windows/win32/networking/win_sock.zig").SCOPE_ID;
const SOCKADDR = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR;
const SOCKADDR_IN = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR_IN;
const SOCKADDR_IN6 = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR_IN6;
const SOCKADDR_IN6_PAIR = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR_IN6_PAIR;
const SOCKADDR_INET = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR_INET;
const SOCKET_ADDRESS = @import("../../../windows/win32/networking/win_sock.zig").SOCKET_ADDRESS;
const TUNNEL_TYPE = @import("../../../windows/win32/network_management/ndis.zig").TUNNEL_TYPE;
