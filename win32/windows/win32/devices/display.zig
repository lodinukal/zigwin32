...
pub const DEVPKEY_IndirectDisplay = DEVPROPKEY { .fmtid = Guid.initIntString("3305783056, 43612, 16967, 184, 48, 214, 166, 248, 234, 163, 16"), .pid = 1 };
pub const DEVPKEY_Device_TerminalLuid = DEVPROPKEY { .fmtid = Guid.initIntString("3305783056, 43612, 16967, 184, 48, 214, 166, 248, 234, 163, 16"), .pid = 2 };
pub const DEVPKEY_Device_AdapterLuid = DEVPROPKEY { .fmtid = Guid.initIntString("3305783056, 43612, 16967, 184, 48, 214, 166, 248, 234, 163, 16"), .pid = 3 };
pub const DEVPKEY_Device_ActivityId = DEVPROPKEY { .fmtid = Guid.initIntString("3305783056, 43612, 16967, 184, 48, 214, 166, 248, 234, 163, 16"), .pid = 4 };
...
pub const IOCTL_PANEL_GET_MANUFACTURING_MODE = @as(u32, 2296860);
...
// Section: Types (318)
//--------------------------------------------------------------------------------
pub const SET_DISPLAY_CONFIG_FLAGS = enum(u32) {
    USE_DATABASE_CURRENT = 15,
    TOPOLOGY_INTERNAL = 1,
    TOPOLOGY_CLONE = 2,
    TOPOLOGY_EXTEND = 4,
    TOPOLOGY_EXTERNAL = 8,
    TOPOLOGY_SUPPLIED = 16,
    USE_SUPPLIED_DISPLAY_CONFIG = 32,
    VALIDATE = 64,
    APPLY = 128,
    NO_OPTIMIZATION = 256,
    SAVE_TO_DATABASE = 512,
    ALLOW_CHANGES = 1024,
    PATH_PERSIST_IF_REQUIRED = 2048,
    FORCE_MODE_ENUMERATION = 4096,
    ALLOW_PATH_ORDER_CHANGES = 8192,
    VIRTUAL_MODE_AWARE = 32768,
    VIRTUAL_REFRESH_RATE_AWARE = 131072,
    _,
    pub fn initFlags(o: struct {
        USE_DATABASE_CURRENT: u1 = 0,
        ...
        return @as(SET_DISPLAY_CONFIG_FLAGS, @enumFromInt(
              (if (o.USE_DATABASE_CURRENT == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.USE_DATABASE_CURRENT) else 0)
            | (if (o.TOPOLOGY_INTERNAL == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_INTERNAL) else 0)
            | (if (o.TOPOLOGY_CLONE == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_CLONE) else 0)
            | (if (o.TOPOLOGY_EXTEND == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_EXTEND) else 0)
            | (if (o.TOPOLOGY_EXTERNAL == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_EXTERNAL) else 0)
            | (if (o.TOPOLOGY_SUPPLIED == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_SUPPLIED) else 0)
            | (if (o.USE_SUPPLIED_DISPLAY_CONFIG == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.USE_SUPPLIED_DISPLAY_CONFIG) else 0)
            | (if (o.VALIDATE == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.VALIDATE) else 0)
            | (if (o.APPLY == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.APPLY) else 0)
            | (if (o.NO_OPTIMIZATION == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.NO_OPTIMIZATION) else 0)
            | (if (o.SAVE_TO_DATABASE == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.SAVE_TO_DATABASE) else 0)
            | (if (o.ALLOW_CHANGES == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.ALLOW_CHANGES) else 0)
            | (if (o.PATH_PERSIST_IF_REQUIRED == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.PATH_PERSIST_IF_REQUIRED) else 0)
            | (if (o.FORCE_MODE_ENUMERATION == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.FORCE_MODE_ENUMERATION) else 0)
            | (if (o.ALLOW_PATH_ORDER_CHANGES == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.ALLOW_PATH_ORDER_CHANGES) else 0)
            | (if (o.VIRTUAL_MODE_AWARE == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.VIRTUAL_MODE_AWARE) else 0)
            | (if (o.VIRTUAL_REFRESH_RATE_AWARE == 1) @intFromEnum(SET_DISPLAY_CONFIG_FLAGS.VIRTUAL_REFRESH_RATE_AWARE) else 0)
        ));
    }
};
pub const SDC_USE_DATABASE_CURRENT = SET_DISPLAY_CONFIG_FLAGS.USE_DATABASE_CURRENT;
pub const SDC_TOPOLOGY_INTERNAL = SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_INTERNAL;
pub const SDC_TOPOLOGY_CLONE = SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_CLONE;
pub const SDC_TOPOLOGY_EXTEND = SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_EXTEND;
pub const SDC_TOPOLOGY_EXTERNAL = SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_EXTERNAL;
pub const SDC_TOPOLOGY_SUPPLIED = SET_DISPLAY_CONFIG_FLAGS.TOPOLOGY_SUPPLIED;
pub const SDC_USE_SUPPLIED_DISPLAY_CONFIG = SET_DISPLAY_CONFIG_FLAGS.USE_SUPPLIED_DISPLAY_CONFIG;
pub const SDC_VALIDATE = SET_DISPLAY_CONFIG_FLAGS.VALIDATE;
pub const SDC_APPLY = SET_DISPLAY_CONFIG_FLAGS.APPLY;
pub const SDC_NO_OPTIMIZATION = SET_DISPLAY_CONFIG_FLAGS.NO_OPTIMIZATION;
pub const SDC_SAVE_TO_DATABASE = SET_DISPLAY_CONFIG_FLAGS.SAVE_TO_DATABASE;
pub const SDC_ALLOW_CHANGES = SET_DISPLAY_CONFIG_FLAGS.ALLOW_CHANGES;
pub const SDC_PATH_PERSIST_IF_REQUIRED = SET_DISPLAY_CONFIG_FLAGS.PATH_PERSIST_IF_REQUIRED;
pub const SDC_FORCE_MODE_ENUMERATION = SET_DISPLAY_CONFIG_FLAGS.FORCE_MODE_ENUMERATION;
pub const SDC_ALLOW_PATH_ORDER_CHANGES = SET_DISPLAY_CONFIG_FLAGS.ALLOW_PATH_ORDER_CHANGES;
pub const SDC_VIRTUAL_MODE_AWARE = SET_DISPLAY_CONFIG_FLAGS.VIRTUAL_MODE_AWARE;
pub const SDC_VIRTUAL_REFRESH_RATE_AWARE = SET_DISPLAY_CONFIG_FLAGS.VIRTUAL_REFRESH_RATE_AWARE;

pub const QUERY_DISPLAY_CONFIG_FLAGS = enum(u32) {
    ALL_PATHS = 1,
    ONLY_ACTIVE_PATHS = 2,
    DATABASE_CURRENT = 4,
    VIRTUAL_MODE_AWARE = 16,
    INCLUDE_HMD = 32,
    VIRTUAL_REFRESH_RATE_AWARE = 64,
    _,
    pub fn initFlags(o: struct {
        ALL_PATHS: u1 = 0,
        ...
        return @as(QUERY_DISPLAY_CONFIG_FLAGS, @enumFromInt(
              (if (o.ALL_PATHS == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.ALL_PATHS) else 0)
            | (if (o.ONLY_ACTIVE_PATHS == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.ONLY_ACTIVE_PATHS) else 0)
            | (if (o.DATABASE_CURRENT == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.DATABASE_CURRENT) else 0)
            | (if (o.VIRTUAL_MODE_AWARE == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.VIRTUAL_MODE_AWARE) else 0)
            | (if (o.INCLUDE_HMD == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.INCLUDE_HMD) else 0)
            | (if (o.VIRTUAL_REFRESH_RATE_AWARE == 1) @intFromEnum(QUERY_DISPLAY_CONFIG_FLAGS.VIRTUAL_REFRESH_RATE_AWARE) else 0)
        ));
    }
};
pub const QDC_ALL_PATHS = QUERY_DISPLAY_CONFIG_FLAGS.ALL_PATHS;
pub const QDC_ONLY_ACTIVE_PATHS = QUERY_DISPLAY_CONFIG_FLAGS.ONLY_ACTIVE_PATHS;
pub const QDC_DATABASE_CURRENT = QUERY_DISPLAY_CONFIG_FLAGS.DATABASE_CURRENT;
pub const QDC_VIRTUAL_MODE_AWARE = QUERY_DISPLAY_CONFIG_FLAGS.VIRTUAL_MODE_AWARE;
pub const QDC_INCLUDE_HMD = QUERY_DISPLAY_CONFIG_FLAGS.INCLUDE_HMD;
pub const QDC_VIRTUAL_REFRESH_RATE_AWARE = QUERY_DISPLAY_CONFIG_FLAGS.VIRTUAL_REFRESH_RATE_AWARE;
...
pub const ICloneViewHelper = extern struct {
    pub const VTable = extern struct {
        ...
        GetConnectedIDs: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszAdaptorName: ?[*:0]align(1) const u16,
                pulCount: ?*u32,
                pulID: ?*u32,
                ulFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn ICloneViewHelper_GetConnectedIDs(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, pulCount: ?*u32, pulID: ?*u32, ulFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICloneViewHelper_GetActiveTopology(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, ulSourceID: u32, pulCount: ?*u32, pulTargetID: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICloneViewHelper_SetActiveTopology(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, ulSourceID: u32, ulCount: u32, pulTargetID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IViewHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewHelper_GetConnectedIDs(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, pulCount: ?*u32, pulID: ?*u32, ulFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewHelper_GetActiveTopology(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, ulSourceID: u32, pulCount: ?*u32, pulTargetID: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewHelper_SetActiveTopology(self: *const T, wszAdaptorName: ?[*:0]align(1) const u16, ulSourceID: u32, ulCount: u32, pulTargetID: ?*u32) callconv(.Inline) HRESULT {
...
pub const AR_STATE = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(AR_STATE, @enumFromInt(
              (if (o.ENABLED == 1) @intFromEnum(AR_STATE.ENABLED) else 0)
            | (if (o.DISABLED == 1) @intFromEnum(AR_STATE.DISABLED) else 0)
            | (if (o.SUPPRESSED == 1) @intFromEnum(AR_STATE.SUPPRESSED) else 0)
            | (if (o.REMOTESESSION == 1) @intFromEnum(AR_STATE.REMOTESESSION) else 0)
            | (if (o.MULTIMON == 1) @intFromEnum(AR_STATE.MULTIMON) else 0)
            | (if (o.NOSENSOR == 1) @intFromEnum(AR_STATE.NOSENSOR) else 0)
            | (if (o.NOT_SUPPORTED == 1) @intFromEnum(AR_STATE.NOT_SUPPORTED) else 0)
            | (if (o.DOCKED == 1) @intFromEnum(AR_STATE.DOCKED) else 0)
            | (if (o.LAPTOP == 1) @intFromEnum(AR_STATE.LAPTOP) else 0)
        ));
    }
};
...
pub const ORIENTATION_PREFERENCE = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        LANDSCAPE: u1 = 0,
        PORTRAIT: u1 = 0,
        LANDSCAPE_FLIPPED: u1 = 0,
        PORTRAIT_FLIPPED: u1 = 0,
    }) ORIENTATION_PREFERENCE {
        return @as(ORIENTATION_PREFERENCE, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(ORIENTATION_PREFERENCE.NONE) else 0)
            | (if (o.LANDSCAPE == 1) @intFromEnum(ORIENTATION_PREFERENCE.LANDSCAPE) else 0)
            | (if (o.PORTRAIT == 1) @intFromEnum(ORIENTATION_PREFERENCE.PORTRAIT) else 0)
            | (if (o.LANDSCAPE_FLIPPED == 1) @intFromEnum(ORIENTATION_PREFERENCE.LANDSCAPE_FLIPPED) else 0)
            | (if (o.PORTRAIT_FLIPPED == 1) @intFromEnum(ORIENTATION_PREFERENCE.PORTRAIT_FLIPPED) else 0)
        ));
    }
};
...
const CHAR_INFO = @import("../../../windows/win32/system/console.zig").CHAR_INFO;
const COLORADJUSTMENT = @import("../../../windows/win32/graphics/gdi.zig").COLORADJUSTMENT;
const COORD = @import("../../../windows/win32/system/console.zig").COORD;
const DD_CALLBACKS = @import("../../../windows/win32/graphics/direct_draw.zig").DD_CALLBACKS;
const DD_DIRECTDRAW_GLOBAL = @import("../../../windows/win32/graphics/direct_draw.zig").DD_DIRECTDRAW_GLOBAL;
const DD_HALINFO = @import("../../../windows/win32/graphics/direct_draw.zig").DD_HALINFO;
const DD_PALETTECALLBACKS = @import("../../../windows/win32/graphics/direct_draw.zig").DD_PALETTECALLBACKS;
const DD_SURFACE_LOCAL = @import("../../../windows/win32/graphics/direct_draw.zig").DD_SURFACE_LOCAL;
const DD_SURFACECALLBACKS = @import("../../../windows/win32/graphics/direct_draw.zig").DD_SURFACECALLBACKS;
const DESIGNVECTOR = @import("../../../windows/win32/graphics/gdi.zig").DESIGNVECTOR;
...
const DISPLAYCONFIG_COLOR_ENCODING = @import("../../../windows/win32/graphics/gdi.zig").DISPLAYCONFIG_COLOR_ENCODING;
...
const LOGCOLORSPACEW = @import("../../../windows/win32/ui/color_system.zig").LOGCOLORSPACEW;
...
const PIXELFORMATDESCRIPTOR = @import("../../../windows/win32/graphics/open_gl.zig").PIXELFORMATDESCRIPTOR;
...
const TRIVERTEX = @import("../../../windows/win32/graphics/gdi.zig").TRIVERTEX;
const TTPOLYGONHEADER = @import("../../../windows/win32/graphics/gdi.zig").TTPOLYGONHEADER;
const VIDEOMEMORY = @import("../../../windows/win32/graphics/direct_draw.zig").VIDEOMEMORY;
