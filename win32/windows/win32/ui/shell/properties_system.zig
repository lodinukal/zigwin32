...
pub const IInitializeWithFile = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszFilePath: ?[*:0]align(1) const u16,
                grfMode: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IInitializeWithFile_Initialize(self: *const T, pszFilePath: ?[*:0]align(1) const u16, grfMode: u32) callconv(.Inline) HRESULT {
...
pub const INamedPropertyStore = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INamedPropertyStore_GetNamedValue(self: *const T, pszName: ?[*:0]align(1) const u16, ppropvar: ?*PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INamedPropertyStore_SetNamedValue(self: *const T, pszName: ?[*:0]align(1) const u16, propvar: ?*const PROPVARIANT) callconv(.Inline) HRESULT {
...
pub const IPropertyDescriptionRelatedPropertyInfo = extern struct {
    pub const VTable = extern struct {
        ...
        GetRelatedProperty: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszRelationshipName: ?[*:0]align(1) const u16,
                riid: ?*const Guid,
                ppv: ?*?*anyopaque,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IPropertyDescription.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertyDescriptionRelatedPropertyInfo_GetRelatedProperty(self: *const T, pszRelationshipName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
...
pub const IPropertySystem = extern struct {
    pub const VTable = extern struct {
        ...
        GetPropertyDescriptionByName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPropertySystem,
                pszCanonicalName: ?[*:0]align(1) const u16,
                riid: ?*const Guid,
                ppv: ?*?*anyopaque,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        GetPropertyDescriptionListFromString: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPropertySystem,
                pszPropList: ?[*:0]align(1) const u16,
                riid: ?*const Guid,
                ppv: ?*?*anyopaque,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySystem_GetPropertyDescriptionByName(self: *const T, pszCanonicalName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySystem_GetPropertyDescriptionListFromString(self: *const T, pszPropList: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySystem_RegisterPropertySchema(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySystem_UnregisterPropertySchema(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPersistSerializedPropStorage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistSerializedPropStorage_SetPropertyStorage(self: *const T, psps: PCUSERIALIZEDPROPSTORAGE, cb: u32) callconv(.Inline) HRESULT {
...
pub const IPropertyUI = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertyUI_ParsePropertyName(self: *const T, pszName: ?[*:0]align(1) const u16, pfmtid: ?*Guid, ppid: ?*u32, pchEaten: ?*u32) callconv(.Inline) HRESULT {
...
pub extern "shell32" fn PifMgr_OpenProperties(
    pszApp: ?[*:0]align(1) const u16,
    pszPIF: ?[*:0]align(1) const u16,
    hInf: u32,
    flOpt: u32,
...
const CONDITION_OPERATION = @import("../../../../windows/win32/system/search/common.zig").CONDITION_OPERATION;
...
const IPropertySetStorage = @import("../../../../windows/win32/system/com/structured_storage.zig").IPropertySetStorage;
...
const ITEMIDLIST = @import("../../../../windows/win32/ui/shell/common.zig").ITEMIDLIST;
...
const PROPSPEC = @import("../../../../windows/win32/system/com/structured_storage.zig").PROPSPEC;
