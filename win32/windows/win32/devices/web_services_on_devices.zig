...
pub const WSD_SECURITY_CERT_VALIDATION = extern struct {
    ...
    hCertIssuerStore: ?HCERTSTORE,
    dwCertCheckOptions: u32,
    pszCNGHashAlgId: ?[*:0]align(1) const u16,
    pbCertHash: ?*u8,
    dwCertHashSize: u32,
};
...
pub const IWSDAddress = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDAddress_Deserialize(self: *const T, pszBuffer: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWSDTransportAddress = extern struct {
    pub const VTable = extern struct {
        ...
        SetTransportAddress: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDTransportAddress,
                pszAddress: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDTransportAddress,
                pszAddress: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDTransportAddress_GetTransportAddress(self: *const T, ppszAddress: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDTransportAddress_GetTransportAddressEx(self: *const T, fSafe: BOOL, ppszAddress: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDTransportAddress_SetTransportAddress(self: *const T, pszAddress: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWSDHttpMessageParameters = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IWSDMessageParameters.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_SetInboundHttpHeaders(self: *const T, pszHeaders: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_GetInboundHttpHeaders(self: *const T, ppszHeaders: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_SetOutboundHttpHeaders(self: *const T, pszHeaders: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_GetOutboundHttpHeaders(self: *const T, ppszHeaders: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_SetID(self: *const T, pszId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpMessageParameters_GetID(self: *const T, ppszId: ?*const ?PWSTR) callconv(.Inline) HRESULT {
...
pub const IWSDHttpAddress = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpAddress_GetPath(self: *const T, ppszPath: ?*const ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IWSDHttpAddress.VTable, @ptrCast(self.vtable)).GetPath(@as(*const IWSDHttpAddress, @ptrCast(self)), ppszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDHttpAddress_SetPath(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWSDXMLContext = extern struct {
    pub const VTable = extern struct {
        ...
        AddNamespace: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszUri: ?[*:0]align(1) const u16,
                pszSuggestedPrefix: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDXMLContext_AddNamespace(self: *const T, pszUri: ?[*:0]align(1) const u16, pszSuggestedPrefix: ?[*:0]align(1) const u16, ppNamespace: ?*?*WSDXML_NAMESPACE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDXMLContext_AddNameToNamespace(self: *const T, pszUri: ?[*:0]align(1) const u16, pszName: ?[*:0]align(1) const u16, ppName: ?*?*WSDXML_NAME) callconv(.Inline) HRESULT {
...
pub const WSDXML_NAMESPACE = extern struct {
    ...
    PreferredPrefix: ?[*:0]align(1) const u16,
    Names: ?*WSDXML_NAME,
    NamesCount: u16,
    Encoding: u16,
};
...
pub const WSD_SERVICE_METADATA = extern struct {
    ...
    Types: ?*WSD_NAME_LIST,
    ServiceId: ?[*:0]align(1) const u16,
    Any: ?*WSDXML_ELEMENT,
};

pub const WSD_THIS_DEVICE_METADATA = extern struct {
    FriendlyName: ?*WSD_LOCALIZED_STRING_LIST,
    FirmwareVersion: ?[*:0]align(1) const u16,
    SerialNumber: ?[*:0]align(1) const u16,
    Any: ?*WSDXML_ELEMENT,
};

pub const WSD_THIS_MODEL_METADATA = extern struct {
    Manufacturer: ?*WSD_LOCALIZED_STRING_LIST,
    ManufacturerUrl: ?[*:0]align(1) const u16,
    ModelName: ?*WSD_LOCALIZED_STRING_LIST,
    ModelNumber: ?[*:0]align(1) const u16,
    ModelUrl: ?[*:0]align(1) const u16,
    PresentationUrl: ?[*:0]align(1) const u16,
    Any: ?*WSDXML_ELEMENT,
};
...
pub const IWSDiscoveryProvider = extern struct {
    pub const VTable = extern struct {
        ...
        SearchByType: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszMatchBy: ?[*:0]align(1) const u16,
                pszTag: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDiscoveryProvider,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryProvider_SearchById(self: *const T, pszId: ?[*:0]align(1) const u16, pszTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryProvider_SearchByAddress(self: *const T, pszAddress: ?[*:0]align(1) const u16, pszTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryProvider_SearchByType(self: *const T, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pszMatchBy: ?[*:0]align(1) const u16, pszTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWSDiscoveryProviderNotify = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryProviderNotify_SearchFailed(self: *const T, hr: HRESULT, pszTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryProviderNotify_SearchComplete(self: *const T, pszTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWSDiscoveredService = extern struct {
    pub const VTable = extern struct {
        ...
        GetRemoteTransportAddress: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDiscoveredService,
                ppszRemoteTransportAddress: ?*const ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDiscoveredService,
                ppszRemoteTransportAddress: ?*const ?PWSTR,
        ...
        GetLocalTransportAddress: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDiscoveredService,
                ppszLocalTransportAddress: ?*const ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDiscoveredService,
                ppszLocalTransportAddress: ?*const ?PWSTR,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveredService_GetProbeResolveTag(self: *const T, ppszTag: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveredService_GetRemoteTransportAddress(self: *const T, ppszRemoteTransportAddress: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveredService_GetLocalTransportAddress(self: *const T, ppszLocalTransportAddress: ?*const ?PWSTR) callconv(.Inline) HRESULT {
...
pub const IWSDiscoveryPublisher = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryPublisher_Publish(self: *const T, pszId: ?[*:0]align(1) const u16, ullMetadataVersion: u64, ullInstanceId: u64, ullMessageNumber: u64, pszSessionId: ?[*:0]align(1) const u16, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pXAddrsList: ?*const WSD_URI_LIST) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryPublisher_UnPublish(self: *const T, pszId: ?[*:0]align(1) const u16, ullInstanceId: u64, ullMessageNumber: u64, pszSessionId: ?[*:0]align(1) const u16, pAny: ?*const WSDXML_ELEMENT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDiscoveryPublisher_MatchProbe(self: *const T, pProbeMessage: ?*const WSD_SOAP_MESSAGE, pMessageParameters: ?*IWSDMessageParameters, pszId: ?[*:0]align(1) const u16, ullMetadataVersion: u64, ullInstanceId: u64, ullMessageNumber: u64, pszSessionId: ?[*:0]align(1) const u16, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pXAddrsList: ?*const WSD_URI_LIST) callconv(.Inline) HRESULT {
...
pub const IWSDScopeMatchingRule = extern struct {
    pub const VTable = extern struct {
        ...
        GetScopeRule: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                ppszScopeMatchingRule: ?*const ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDScopeMatchingRule,
                ppszScopeMatchingRule: ?*const ?PWSTR,
        ...
        MatchScopes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDScopeMatchingRule,
                pszScope1: ?[*:0]align(1) const u16,
                pszScope2: ?[*:0]align(1) const u16,
                pfMatch: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWSDScopeMatchingRule,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDScopeMatchingRule_GetScopeRule(self: *const T, ppszScopeMatchingRule: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDScopeMatchingRule_MatchScopes(self: *const T, pszScope1: ?[*:0]align(1) const u16, pszScope2: ?[*:0]align(1) const u16, pfMatch: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IWSDEndpointProxy = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDEndpointProxy_GetErrorInfo(self: *const T, ppszErrorInfo: ?*const ?PWSTR) callconv(.Inline) HRESULT {
...
pub const IWSDDeviceProxy = extern struct {
    pub const VTable = extern struct {
        ...
        Init: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszDeviceId: ?[*:0]align(1) const u16,
                pDeviceAddress: ?*IWSDAddress,
                pszLocalId: ?[*:0]align(1) const u16,
        ...
        GetServiceProxyById: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDDeviceProxy,
                pszServiceId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceProxy_Init(self: *const T, pszDeviceId: ?[*:0]align(1) const u16, pDeviceAddress: ?*IWSDAddress, pszLocalId: ?[*:0]align(1) const u16, pContext: ?*IWSDXMLContext, pSponsor: ?*IWSDDeviceProxy) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceProxy_GetServiceProxyById(self: *const T, pszServiceId: ?[*:0]align(1) const u16, ppServiceProxy: ?*?*IWSDServiceProxy) callconv(.Inline) HRESULT {
...
pub const IWSDEventingStatus = extern struct {
    pub const VTable = extern struct {
        ...
        SubscriptionRenewed: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszSubscriptionAction: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDEventingStatus_SubscriptionRenewed(self: *const T, pszSubscriptionAction: ?[*:0]align(1) const u16) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDEventingStatus_SubscriptionRenewalFailed(self: *const T, pszSubscriptionAction: ?[*:0]align(1) const u16, hr: HRESULT) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDEventingStatus_SubscriptionEnded(self: *const T, pszSubscriptionAction: ?[*:0]align(1) const u16) callconv(.Inline) void {
...
pub const IWSDDeviceHost = extern struct {
    pub const VTable = extern struct {
        ...
        AddDynamicService: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWSDDeviceHost,
                pszServiceId: ?[*:0]align(1) const u16,
                pszEndpointAddress: ?[*:0]align(1) const u16,
                pPortType: ?*const WSD_PORT_TYPE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_Init(self: *const T, pszLocalId: ?[*:0]align(1) const u16, pContext: ?*IWSDXMLContext, ppHostAddresses: ?[*]?*IWSDAddress, dwHostAddressCount: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_RegisterService(self: *const T, pszServiceId: ?[*:0]align(1) const u16, pService: ?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_RetireService(self: *const T, pszServiceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_AddDynamicService(self: *const T, pszServiceId: ?[*:0]align(1) const u16, pszEndpointAddress: ?[*:0]align(1) const u16, pPortType: ?*const WSD_PORT_TYPE, pPortName: ?*const WSDXML_NAME, pAny: ?*const WSDXML_ELEMENT, pService: ?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_RemoveDynamicService(self: *const T, pszServiceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_SetServiceDiscoverable(self: *const T, pszServiceId: ?[*:0]align(1) const u16, fDiscoverable: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHost_SignalEvent(self: *const T, pszServiceId: ?[*:0]align(1) const u16, pBody: ?*const anyopaque, pOperation: ?*const WSD_OPERATION) callconv(.Inline) HRESULT {
...
pub const IWSDDeviceHostNotify = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDDeviceHostNotify_GetService(self: *const T, pszServiceId: ?[*:0]align(1) const u16, ppService: ?*?*IUnknown) callconv(.Inline) HRESULT {
...
pub extern "wsdapi" fn WSDXMLGetNameFromBuiltinNamespace(
    pszNamespace: ?[*:0]align(1) const u16,
    pszName: ?[*:0]align(1) const u16,
    ppName: ?*?*WSDXML_NAME,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "wsdapi" fn WSDGenerateFault(
    ...
    pszSubCode: ?[*:0]align(1) const u16,
    pszReason: ?[*:0]align(1) const u16,
    pszDetail: ?[*:0]align(1) const u16,
    pContext: ?*IWSDXMLContext,
    ppFault: ?*?*WSD_SOAP_FAULT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
