...
pub const SAFER_CODE_PROPERTIES_V2 = extern struct {
    ...
    hWndParent: ?HWND,
    dwWVTUIChoice: u32,
    PackageMoniker: ?[*:0]align(1) const u16,
    PackagePublisher: ?[*:0]align(1) const u16,
...
pub extern "advapi32" fn SaferRecordEventLogEntry(
    ...
    szTargetPath: ?[*:0]align(1) const u16,
    lpReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn SaferiIsExecutableFileType(
    szFullPathname: ?[*:0]align(1) const u16,
...
const SAFER_LEVEL_HANDLE = @import("../../../windows/win32/security.zig").SAFER_LEVEL_HANDLE;
