...
pub const SIPAEV_EFI_VARIABLE_BOOT2 = @as(u32, 2147483660);
...
pub const SIPAEVENT_MODULE_HSP = @as(u32, 458764);
...
pub const OSDEVICE_TYPE_CIMFS = @as(u32, 393216);
...
pub const MAX_HSP_UPGRADE_FILENAME_LENGTH = @as(u32, 64);
pub const WBCL_MAX_HSP_UPGRADE_HASH_LEN = @as(u32, 64);
...
pub const HSP_UPGRADE_IMAGEDATA = extern struct {
    hashAlgID: u16 align(1),
    digestSize: u16 align(1),
    digest: [64]u8 align(1),
    fileName: [64]u16 align(1),
};
...
const FLOWSPEC = @import("../../../windows/win32/networking/win_sock.zig").FLOWSPEC;
const HANDLE = @import("../../../windows/win32/foundation.zig").HANDLE;
const IN_ADDR = @import("../../../windows/win32/networking/win_sock.zig").IN_ADDR;
const NETWORK_ADDRESS_LIST = @import("../../../windows/win32/network_management/ndis.zig").NETWORK_ADDRESS_LIST;
