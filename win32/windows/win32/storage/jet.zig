...
pub const JET_ccolTaggedMost = @as(u32, 64993);
...
pub const JET_paramPerfmonRefreshInterval = @as(u32, 217);
pub const JET_paramMaxValueInvalid = @as(u32, 218);
...
pub const JET_sesparamMaxValueInvalid = @as(u32, 4111);
...
pub const JET_errSuccess = @as(i32, 0);
...
pub const JET_errDbTimeBeyondMaxRequired = @as(i32, -625);
...
pub const JET_RECPOS2 = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        cbStruct: u32,
    ...
    .X86 => extern struct {
        cbStruct: u32 align(4),
        centriesLTDeprecated: u32 align(4),
        centriesInRangeDeprecated: u32 align(4),
        centriesTotalDeprecated: u32 align(4),
        centriesLT: u64 align(4),
        centriesTotal: u64 align(4),
    },
};
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const JET_CONVERT_ = thismodule.JET_CONVERT_A;
    ...
    .wide => struct {
        ...
        pub const JET_CONVERT_ = thismodule.JET_CONVERT_W;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const JET_CONVERT_ = @compileError("'JET_CONVERT_' requires that UNICODE be set to true or false in the root module");
...
const JET_API_PTR = @import("../../../windows/win32/storage/structured_storage.zig").JET_API_PTR;
const JET_HANDLE = @import("../../../windows/win32/storage/structured_storage.zig").JET_HANDLE;
const JET_INSTANCE = @import("../../../windows/win32/storage/structured_storage.zig").JET_INSTANCE;
const JET_SESID = @import("../../../windows/win32/storage/structured_storage.zig").JET_SESID;
const JET_TABLEID = @import("../../../windows/win32/storage/structured_storage.zig").JET_TABLEID;
