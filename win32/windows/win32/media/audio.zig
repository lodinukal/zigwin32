...
pub const PKEY_AudioEndpoint_FormFactor = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 0 };
pub const PKEY_AudioEndpoint_ControlPanelPageProvider = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 1 };
pub const PKEY_AudioEndpoint_Association = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 2 };
pub const PKEY_AudioEndpoint_PhysicalSpeakers = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 3 };
pub const PKEY_AudioEndpoint_GUID = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 4 };
pub const PKEY_AudioEndpoint_Disable_SysFx = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 5 };
pub const ENDPOINT_SYSFX_ENABLED = @as(u32, 0);
pub const ENDPOINT_SYSFX_DISABLED = @as(u32, 1);
pub const PKEY_AudioEndpoint_FullRangeSpeakers = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 6 };
pub const PKEY_AudioEndpoint_Supports_EventDriven_Mode = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 7 };
pub const PKEY_AudioEndpoint_JackSubType = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 8 };
pub const PKEY_AudioEndpoint_Default_VolumeInDb = PROPERTYKEY { .fmtid = Guid.initIntString("497408003, 54418, 20189, 140, 35, 224, 192, 255, 238, 127, 14"), .pid = 9 };
pub const PKEY_AudioEngine_DeviceFormat = PROPERTYKEY { .fmtid = Guid.initIntString("4053730893, 2092, 20007, 188, 115, 104, 130, 161, 187, 142, 76"), .pid = 0 };
pub const PKEY_AudioEngine_OEMFormat = PROPERTYKEY { .fmtid = Guid.initIntString("3834056230, 15557, 19666, 186, 70, 202, 10, 154, 112, 237, 4"), .pid = 3 };
pub const PKEY_AudioEndpointLogo_IconEffects = PROPERTYKEY { .fmtid = Guid.initIntString("4054546445, 8208, 20179, 163, 166, 139, 135, 240, 240, 196, 118"), .pid = 0 };
pub const PKEY_AudioEndpointLogo_IconPath = PROPERTYKEY { .fmtid = Guid.initIntString("4054546445, 8208, 20179, 163, 166, 139, 135, 240, 240, 196, 118"), .pid = 1 };
pub const PKEY_AudioEndpointSettings_MenuText = PROPERTYKEY { .fmtid = Guid.initIntString("337911810, 800, 19940, 149, 85, 167, 216, 43, 115, 194, 134"), .pid = 0 };
pub const PKEY_AudioEndpointSettings_LaunchContract = PROPERTYKEY { .fmtid = Guid.initIntString("337911810, 800, 19940, 149, 85, 167, 216, 43, 115, 194, 134"), .pid = 1 };
...
pub const MEVT_SHORTMSG = @as(u8, 0);
pub const MEVT_TEMPO = @as(u8, 1);
pub const MEVT_NOP = @as(u8, 2);
pub const MEVT_LONGMSG = @as(u8, 128);
pub const MEVT_COMMENT = @as(u8, 130);
pub const MEVT_VERSION = @as(u8, 132);
...
pub const SND_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SND_FLAGS, @enumFromInt(
              (if (o.APPLICATION == 1) @intFromEnum(SND_FLAGS.APPLICATION) else 0)
            | (if (o.ALIAS == 1) @intFromEnum(SND_FLAGS.ALIAS) else 0)
            | (if (o.ALIAS_ID == 1) @intFromEnum(SND_FLAGS.ALIAS_ID) else 0)
            | (if (o.FILENAME == 1) @intFromEnum(SND_FLAGS.FILENAME) else 0)
            | (if (o.RESOURCE == 1) @intFromEnum(SND_FLAGS.RESOURCE) else 0)
            | (if (o.ASYNC == 1) @intFromEnum(SND_FLAGS.ASYNC) else 0)
            | (if (o.NODEFAULT == 1) @intFromEnum(SND_FLAGS.NODEFAULT) else 0)
            | (if (o.LOOP == 1) @intFromEnum(SND_FLAGS.LOOP) else 0)
            | (if (o.MEMORY == 1) @intFromEnum(SND_FLAGS.MEMORY) else 0)
            | (if (o.NOSTOP == 1) @intFromEnum(SND_FLAGS.NOSTOP) else 0)
            | (if (o.NOWAIT == 1) @intFromEnum(SND_FLAGS.NOWAIT) else 0)
            | (if (o.PURGE == 1) @intFromEnum(SND_FLAGS.PURGE) else 0)
            | (if (o.SENTRY == 1) @intFromEnum(SND_FLAGS.SENTRY) else 0)
            | (if (o.SYNC == 1) @intFromEnum(SND_FLAGS.SYNC) else 0)
            | (if (o.SYSTEM == 1) @intFromEnum(SND_FLAGS.SYSTEM) else 0)
        ));
    }
};
pub const SND_APPLICATION = SND_FLAGS.APPLICATION;
pub const SND_ALIAS = SND_FLAGS.ALIAS;
pub const SND_ALIAS_ID = SND_FLAGS.ALIAS_ID;
pub const SND_FILENAME = SND_FLAGS.FILENAME;
pub const SND_RESOURCE = SND_FLAGS.RESOURCE;
pub const SND_ASYNC = SND_FLAGS.ASYNC;
pub const SND_NODEFAULT = SND_FLAGS.NODEFAULT;
pub const SND_LOOP = SND_FLAGS.LOOP;
pub const SND_MEMORY = SND_FLAGS.MEMORY;
pub const SND_NOSTOP = SND_FLAGS.NOSTOP;
pub const SND_NOWAIT = SND_FLAGS.NOWAIT;
pub const SND_PURGE = SND_FLAGS.PURGE;
pub const SND_SENTRY = SND_FLAGS.SENTRY;
pub const SND_SYNC = SND_FLAGS.SYNC;
pub const SND_SYSTEM = SND_FLAGS.SYSTEM;
...
pub const AUDCLNT_STREAMOPTIONS = enum(i32) {
    NONE = 0,
    RAW = 1,
    MATCH_FORMAT = 2,
    AMBISONICS = 4,
...
pub const AUDIO_DUCKING_OPTIONS = enum(i32) {
    EFAULT = 0,
...
const IID_IAudioViewManagerService_Value = Guid.initString("a7a7ef10-1f49-45e0-ad35-612057cc8f74");
pub const IID_IAudioViewManagerService = &IID_IAudioViewManagerService_Value;
pub const IAudioViewManagerService = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        SetAudioStreamWindow: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAudioViewManagerService,
                hwnd: ?HWND,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAudioViewManagerService,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioViewManagerService_SetAudioStreamWindow(self: *const T, hwnd: ?HWND) callconv(.Inline) HRESULT {
            return @as(*const IAudioViewManagerService.VTable, @ptrCast(self.vtable)).SetAudioStreamWindow(@as(*const IAudioViewManagerService, @ptrCast(self)), hwnd);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const IID_IAcousticEchoCancellationControl_Value = Guid.initString("f4ae25b5-aaa3-437d-b6b3-dbbe2d0e9549");
pub const IID_IAcousticEchoCancellationControl = &IID_IAcousticEchoCancellationControl_Value;
pub const IAcousticEchoCancellationControl = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        SetEchoCancellationRenderEndpoint: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAcousticEchoCancellationControl,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAcousticEchoCancellationControl_SetEchoCancellationRenderEndpoint(self: *const T, endpointId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IAcousticEchoCancellationControl.VTable, @ptrCast(self.vtable)).SetEchoCancellationRenderEndpoint(@as(*const IAcousticEchoCancellationControl, @ptrCast(self)), endpointId);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const AudioObjectType = enum(i32) {
    None = 0,
    Dynamic = 1,
    FrontLeft = 2,
    FrontRight = 4,
...
pub const SPATIAL_AUDIO_STREAM_OPTIONS = enum(i32) {
    NONE = 0,
    OFFLOAD = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const IMMNotificationClient = extern struct {
    pub const VTable = extern struct {
        ...
        OnDeviceStateChanged: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwstrDeviceId: ?[*:0]align(1) const u16,
                dwNewState: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMMNotificationClient,
        ...
        OnDefaultDeviceChanged: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                flow: EDataFlow,
                role: ERole,
                pwstrDefaultDeviceId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMMNotificationClient,
                flow: EDataFlow,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMNotificationClient_OnDeviceStateChanged(self: *const T, pwstrDeviceId: ?[*:0]align(1) const u16, dwNewState: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMNotificationClient_OnDeviceAdded(self: *const T, pwstrDeviceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMNotificationClient_OnDeviceRemoved(self: *const T, pwstrDeviceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMNotificationClient_OnDefaultDeviceChanged(self: *const T, flow: EDataFlow, role: ERole, pwstrDefaultDeviceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMNotificationClient_OnPropertyValueChanged(self: *const T, pwstrDeviceId: ?[*:0]align(1) const u16, key: PROPERTYKEY) callconv(.Inline) HRESULT {
...
pub const IMMDeviceEnumerator = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMMDeviceEnumerator_GetDevice(self: *const T, pwstrId: ?[*:0]align(1) const u16, ppDevice: ?*?*IMMDevice) callconv(.Inline) HRESULT {
...
pub const IAudioSessionEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnDisplayNameChanged: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                NewDisplayName: ?[*:0]align(1) const u16,
                EventContext: ?*const Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAudioSessionEvents,
        ...
        OnIconPathChanged: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAudioSessionEvents,
                NewIconPath: ?[*:0]align(1) const u16,
                EventContext: ?*const Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAudioSessionEvents,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioSessionEvents_OnDisplayNameChanged(self: *const T, NewDisplayName: ?[*:0]align(1) const u16, EventContext: ?*const Guid) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioSessionEvents_OnIconPathChanged(self: *const T, NewIconPath: ?[*:0]align(1) const u16, EventContext: ?*const Guid) callconv(.Inline) HRESULT {
...
pub const IAudioSessionControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioSessionControl_SetDisplayName(self: *const T, Value: ?[*:0]align(1) const u16, EventContext: ?*const Guid) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioSessionControl_SetIconPath(self: *const T, Value: ?[*:0]align(1) const u16, EventContext: ?*const Guid) callconv(.Inline) HRESULT {
...
pub const IAudioVolumeDuckNotification = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioVolumeDuckNotification_OnVolumeDuckNotification(self: *const T, sessionID: ?[*:0]align(1) const u16, countCommunicationSessions: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioVolumeDuckNotification_OnVolumeUnduckNotification(self: *const T, sessionID: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IAudioSessionManager2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioSessionManager2_RegisterDuckNotification(self: *const T, sessionID: ?[*:0]align(1) const u16, duckNotification: ?*IAudioVolumeDuckNotification) callconv(.Inline) HRESULT {
...
pub const ACMFORMATCHOOSEA = extern struct {
    ...
    pwfx: ?*WAVEFORMATEX align(1),
    cbwfx: u32 align(1),
    pszTitle: ?[*:0]align(1) const u8 align(1),
    szFormatTag: [48]CHAR align(1),
    szFormat: [128]CHAR align(1),
    ...
    pszTemplateName: ?[*:0]align(1) const u8 align(1),
...
pub const ACMFORMATCHOOSEW = extern struct {
    ...
    pwfx: ?*WAVEFORMATEX align(1),
    cbwfx: u32 align(1),
    pszTitle: ?[*:0]align(1) const u16 align(1),
    szFormatTag: [48]u16 align(1),
    szFormat: [128]u16 align(1),
    ...
    pwfxEnum: ?*WAVEFORMATEX align(1),
    hInstance: ?HINSTANCE align(1),
    pszTemplateName: ?[*:0]align(1) const u16 align(1),
    lCustData: LPARAM align(1),
...
pub const ACMDRVOPENDESCA = extern struct {
    ...
    dwFlags: u32 align(1),
    dwError: u32 align(1),
    pszSectionName: ?[*:0]align(1) const u8 align(1),
    pszAliasName: ?[*:0]align(1) const u8 align(1),
...
pub const ACMDRVOPENDESCW = extern struct {
    ...
    dwFlags: u32 align(1),
    dwError: u32 align(1),
    pszSectionName: ?[*:0]align(1) const u16 align(1),
    pszAliasName: ?[*:0]align(1) const u16 align(1),
    dnDevNode: u32 align(1),
};
...
pub extern "winmm" fn sndPlaySoundA(
    pszSound: ?[*:0]align(1) const u8,
    fuSound: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "winmm" fn sndPlaySoundW(
    pszSound: ?[*:0]align(1) const u16,
    fuSound: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "mmdevapi" fn ActivateAudioInterfaceAsync(
    deviceInterfacePath: ?[*:0]align(1) const u16,
    riid: ?*const Guid,
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const ACMDRVOPENDESC = thismodule.ACMDRVOPENDESCA;
    ...
    .wide => struct {
        ...
        pub const ACMDRVOPENDESC = thismodule.ACMDRVOPENDESCW;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const ACMDRVOPENDESC = *opaque{};
        ...
        pub const ACMDRVOPENDESC = @compileError("'ACMDRVOPENDESC' requires that UNICODE be set to true or false in the root module");
...
const HDRVR = @import("../../../windows/win32/media/multimedia.zig").HDRVR;
...
const INTERFACEINFO = @import("../../../windows/win32/system/com.zig").INTERFACEINFO;
...
const MMTIME = @import("../../../windows/win32/media.zig").MMTIME;
