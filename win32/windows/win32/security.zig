...
//--------------------------------------------------------------------------------
pub const SECURITY_DYNAMIC_TRACKING = @import("../../zig.zig").typedConst(BOOLEAN, @as(u8, 1));
pub const SECURITY_STATIC_TRACKING = @import("../../zig.zig").typedConst(BOOLEAN, @as(u8, 0));
pub const SECURITY_NULL_SID_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 0 } };
...
pub const SECURITY_CREATOR_SID_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 3 } };
pub const SECURITY_NON_UNIQUE_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 4 } };
pub const SECURITY_NT_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 5 } };
pub const SECURITY_RESOURCE_MANAGER_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 9 } };
pub const SECURITY_APP_PACKAGE_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 15 } };
pub const SECURITY_MANDATORY_LABEL_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 16 } };
pub const SECURITY_SCOPED_POLICY_ID_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 17 } };
pub const SECURITY_AUTHENTICATION_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 18 } };
pub const SECURITY_PROCESS_TRUST_AUTHORITY = SID_IDENTIFIER_AUTHORITY{ .Value = .{ 0, 0, 0, 0, 0, 19 } };
...
pub const SECURITY_DESCRIPTOR_CONTROL = enum(u16) {
    OWNER_DEFAULTED = 1,
    GROUP_DEFAULTED = 2,
    DACL_PRESENT = 4,
    DACL_DEFAULTED = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SECURITY_DESCRIPTOR_CONTROL, @enumFromInt(
              (if (o.OWNER_DEFAULTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.OWNER_DEFAULTED) else 0)
            | (if (o.GROUP_DEFAULTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.GROUP_DEFAULTED) else 0)
            | (if (o.DACL_PRESENT == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.DACL_PRESENT) else 0)
            | (if (o.DACL_DEFAULTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.DACL_DEFAULTED) else 0)
            | (if (o.SACL_PRESENT == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SACL_PRESENT) else 0)
            | (if (o.SACL_DEFAULTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SACL_DEFAULTED) else 0)
            | (if (o.DACL_AUTO_INHERIT_REQ == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.DACL_AUTO_INHERIT_REQ) else 0)
            | (if (o.SACL_AUTO_INHERIT_REQ == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SACL_AUTO_INHERIT_REQ) else 0)
            | (if (o.DACL_AUTO_INHERITED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.DACL_AUTO_INHERITED) else 0)
            | (if (o.SACL_AUTO_INHERITED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SACL_AUTO_INHERITED) else 0)
            | (if (o.DACL_PROTECTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.DACL_PROTECTED) else 0)
            | (if (o.SACL_PROTECTED == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SACL_PROTECTED) else 0)
            | (if (o.RM_CONTROL_VALID == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.RM_CONTROL_VALID) else 0)
            | (if (o.SELF_RELATIVE == 1) @intFromEnum(SECURITY_DESCRIPTOR_CONTROL.SELF_RELATIVE) else 0)
        ));
    }
};
pub const SE_OWNER_DEFAULTED = SECURITY_DESCRIPTOR_CONTROL.OWNER_DEFAULTED;
pub const SE_GROUP_DEFAULTED = SECURITY_DESCRIPTOR_CONTROL.GROUP_DEFAULTED;
pub const SE_DACL_PRESENT = SECURITY_DESCRIPTOR_CONTROL.DACL_PRESENT;
pub const SE_DACL_DEFAULTED = SECURITY_DESCRIPTOR_CONTROL.DACL_DEFAULTED;
pub const SE_SACL_PRESENT = SECURITY_DESCRIPTOR_CONTROL.SACL_PRESENT;
pub const SE_SACL_DEFAULTED = SECURITY_DESCRIPTOR_CONTROL.SACL_DEFAULTED;
pub const SE_DACL_AUTO_INHERIT_REQ = SECURITY_DESCRIPTOR_CONTROL.DACL_AUTO_INHERIT_REQ;
pub const SE_SACL_AUTO_INHERIT_REQ = SECURITY_DESCRIPTOR_CONTROL.SACL_AUTO_INHERIT_REQ;
pub const SE_DACL_AUTO_INHERITED = SECURITY_DESCRIPTOR_CONTROL.DACL_AUTO_INHERITED;
pub const SE_SACL_AUTO_INHERITED = SECURITY_DESCRIPTOR_CONTROL.SACL_AUTO_INHERITED;
pub const SE_DACL_PROTECTED = SECURITY_DESCRIPTOR_CONTROL.DACL_PROTECTED;
pub const SE_SACL_PROTECTED = SECURITY_DESCRIPTOR_CONTROL.SACL_PROTECTED;
pub const SE_RM_CONTROL_VALID = SECURITY_DESCRIPTOR_CONTROL.RM_CONTROL_VALID;
pub const SE_SELF_RELATIVE = SECURITY_DESCRIPTOR_CONTROL.SELF_RELATIVE;
...
pub const TOKEN_ACCESS_MASK = enum(u32) {
    ...
    READ = 131080,
    WRITE = 131296,
    // EXECUTE = 131072, this enum value conflicts with READ_CONTROL
    TRUST_CONSTRAINT_MASK = 131096,
    ACCESS_PSEUDO_HANDLE_WIN8 = 24,
    // ACCESS_PSEUDO_HANDLE = 24, this enum value conflicts with ACCESS_PSEUDO_HANDLE_WIN8
    ALL_ACCESS = 983551,
    _,
    pub fn initFlags(o: struct {
        DELETE: u1 = 0,
        ...
        READ: u1 = 0,
        WRITE: u1 = 0,
        TRUST_CONSTRAINT_MASK: u1 = 0,
        ACCESS_PSEUDO_HANDLE_WIN8: u1 = 0,
        ALL_ACCESS: u1 = 0,
    }) TOKEN_ACCESS_MASK {
        return @as(TOKEN_ACCESS_MASK, @enumFromInt(
            ...
            | (if (o.READ == 1) @intFromEnum(TOKEN_ACCESS_MASK.READ) else 0)
            | (if (o.WRITE == 1) @intFromEnum(TOKEN_ACCESS_MASK.WRITE) else 0)
            | (if (o.TRUST_CONSTRAINT_MASK == 1) @intFromEnum(TOKEN_ACCESS_MASK.TRUST_CONSTRAINT_MASK) else 0)
            | (if (o.ACCESS_PSEUDO_HANDLE_WIN8 == 1) @intFromEnum(TOKEN_ACCESS_MASK.ACCESS_PSEUDO_HANDLE_WIN8) else 0)
...
pub const TOKEN_READ = TOKEN_ACCESS_MASK.READ;
pub const TOKEN_WRITE = TOKEN_ACCESS_MASK.WRITE;
pub const TOKEN_EXECUTE = TOKEN_ACCESS_MASK.READ_CONTROL;
pub const TOKEN_TRUST_CONSTRAINT_MASK = TOKEN_ACCESS_MASK.TRUST_CONSTRAINT_MASK;
pub const TOKEN_ACCESS_PSEUDO_HANDLE_WIN8 = TOKEN_ACCESS_MASK.ACCESS_PSEUDO_HANDLE_WIN8;
pub const TOKEN_ACCESS_PSEUDO_HANDLE = TOKEN_ACCESS_MASK.ACCESS_PSEUDO_HANDLE_WIN8;
...
pub const TokenIsAppSilo = TOKEN_INFORMATION_CLASS.TokenIsAppSilo;
...
pub extern "advapi32" fn AccessCheckAndAuditAlarmW(
    SubsystemName: ?[*:0]align(1) const u16,
    HandleId: ?*anyopaque,
...
pub extern "advapi32" fn AccessCheckByTypeAndAuditAlarmW(
    ...
    ObjectName: ?[*:0]align(1) const u16,
    SecurityDescriptor: ?PSECURITY_DESCRIPTOR,
    PrincipalSelfSid: ?PSID,
    DesiredAccess: u32,
...
pub extern "advapi32" fn AccessCheckAndAuditAlarmA(
    SubsystemName: ?[*:0]align(1) const u8,
    HandleId: ?*anyopaque,
    ObjectTypeName: ?PSTR,
    ObjectName: ?PSTR,
    SecurityDescriptor: ?PSECURITY_DESCRIPTOR,
...
pub extern "advapi32" fn LookupAccountSidA(
    lpSystemName: ?[*:0]align(1) const u8,
    Sid: ?PSID,
    Name: ?[*:0]u8,
    cchName: ?*u32,
...
pub extern "advapi32" fn LookupAccountSidW(
    lpSystemName: ?[*:0]align(1) const u16,
    Sid: ?PSID,
    Name: ?[*:0]u16,
    cchName: ?*u32,
...
pub extern "advapi32" fn LogonUserW(
    ...
    lpszDomain: ?[*:0]align(1) const u16,
