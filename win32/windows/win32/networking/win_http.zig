...
//--------------------------------------------------------------------------------
// Section: Constants (560)
//--------------------------------------------------------------------------------
pub const HTTPREQUEST_PROXYSETTING_DEFAULT = @as(u32, 0);
pub const HTTPREQUEST_PROXYSETTING_PRECONFIG = @as(u32, 0);
pub const HTTPREQUEST_PROXYSETTING_DIRECT = @as(u32, 1);
pub const HTTPREQUEST_PROXYSETTING_PROXY = @as(u32, 2);
pub const HTTPREQUEST_SETCREDENTIALS_FOR_SERVER = @as(u32, 0);
pub const HTTPREQUEST_SETCREDENTIALS_FOR_PROXY = @as(u32, 1);
pub const INTERNET_DEFAULT_PORT = @as(u16, 0);
pub const INTERNET_DEFAULT_HTTP_PORT = @as(u16, 80);
pub const INTERNET_DEFAULT_HTTPS_PORT = @as(u16, 443);
pub const WINHTTP_FLAG_ASYNC = @as(u32, 268435456);
pub const WINHTTP_FLAG_SECURE_DEFAULTS = @as(u32, 805306368);
pub const WINHTTP_FLAG_AUTOMATIC_CHUNKING = @as(u32, 512);
...
pub const WINHTTP_AUTOPROXY_USE_INTERFACE_CONFIG = @as(u32, 2048);
...
pub const WINHTTP_OPTION_NETWORK_INTERFACE_AFFINITY = @as(u32, 105);
...
pub const WINHTTP_OPTION_FEATURE_SUPPORTED = @as(u32, 184);
pub const WINHTTP_OPTION_QUIC_STATS = @as(u32, 185);
pub const WINHTTP_OPTION_HTTP3_KEEPALIVE = @as(u32, 188);
pub const WINHTTP_OPTION_HTTP3_HANDSHAKE_TIMEOUT = @as(u32, 189);
pub const WINHTTP_OPTION_HTTP3_INITIAL_RTT = @as(u32, 190);
pub const WINHTTP_OPTION_HTTP3_STREAM_ERROR_CODE = @as(u32, 191);
pub const WINHTTP_OPTION_REQUEST_ANNOTATION = @as(u32, 192);
pub const WINHTTP_OPTION_DISABLE_PROXY_AUTH_SCHEMES = @as(u32, 193);
pub const WINHTTP_OPTION_REVERT_IMPERSONATION_SERVER_CERT = @as(u32, 194);
pub const WINHTTP_OPTION_DISABLE_GLOBAL_POOLING = @as(u32, 195);
pub const WINHTTP_OPTION_USE_SESSION_SCH_CRED = @as(u32, 196);
pub const WINHTTP_LAST_OPTION = @as(u32, 196);
...
pub const WINHTTP_OPTION_REQUEST_ANNOTATION_MAX_LENGTH = @as(u32, 64000);
...
pub const WINHTTP_AUTOLOGON_SECURITY_LEVEL_PROXY_ONLY = @as(u32, 3);
pub const WINHTTP_AUTOLOGON_SECURITY_LEVEL_DEFAULT = @as(u32, 0);
pub const WINHTTP_AUTOLOGON_SECURITY_LEVEL_MAX = @as(u32, 3);
...
pub const WINHTTP_PROXY_DISABLE_SCHEME_BASIC = @as(u32, 1);
pub const WINHTTP_PROXY_DISABLE_SCHEME_DIGEST = @as(u32, 2);
pub const WINHTTP_PROXY_DISABLE_SCHEME_NTLM = @as(u32, 4);
pub const WINHTTP_PROXY_DISABLE_SCHEME_KERBEROS = @as(u32, 8);
pub const WINHTTP_PROXY_DISABLE_SCHEME_NEGOTIATE = @as(u32, 16);
pub const WINHTTP_PROXY_DISABLE_AUTH_LOCAL_SERVICE = @as(u32, 256);
...
pub const WINHTTP_HANDLE_TYPE_PROXY_RESOLVER = @as(u32, 4);
pub const WINHTTP_HANDLE_TYPE_WEBSOCKET = @as(u32, 5);
...
pub const WINHTTP_CALLBACK_STATUS_GETPROXYSETTINGS_COMPLETE = @as(u32, 134217728);
...
pub const API_GET_PROXY_SETTINGS = @as(u32, 7);
...
pub const WINHTTP_CALLBACK_FLAG_GETPROXYSETTINGS_COMPLETE = @as(u32, 134217728);
...
pub const WINHTTP_PROXY_NOTIFY_CHANGE = @as(u32, 1);
pub const WINHTTP_FEATURE_DISABLE_STREAM_QUEUE = @as(u32, 1);
pub const WINHTTP_FEATURE_IPV6_FAST_FALLBACK = @as(u32, 2);
pub const WINHTTP_FEATURE_CONNECTION_STATS_V0 = @as(u32, 3);
pub const WINHTTP_FEATURE_REQUEST_TIMES = @as(u32, 4);
pub const WINHTTP_FEATURE_EXPIRE_CONNECTION = @as(u32, 5);
pub const WINHTTP_FEATURE_DISABLE_SECURE_PROTOCOL_FALLBACK = @as(u32, 6);
pub const WINHTTP_FEATURE_HTTP_PROTOCOL_REQUIRED = @as(u32, 7);
pub const WINHTTP_FEATURE_REQUEST_STATS = @as(u32, 8);
pub const WINHTTP_FEATURE_SERVER_CERT_CHAIN_CONTEXT = @as(u32, 9);
pub const WINHTTP_FEATURE_CONNECTION_STATS_V1 = @as(u32, 12);
pub const WINHTTP_FEATURE_SECURITY_INFO = @as(u32, 13);
pub const WINHTTP_FEATURE_TCP_KEEPALIVE = @as(u32, 14);
pub const WINHTTP_FEATURE_TCP_FAST_OPEN = @as(u32, 15);
pub const WINHTTP_FEATURE_TLS_FALSE_START = @as(u32, 16);
pub const WINHTTP_FEATURE_IGNORE_CERT_REVOCATION_OFFLINE = @as(u32, 17);
pub const WINHTTP_FEATURE_TLS_PROTOCOL_INSECURE_FALLBACK = @as(u32, 20);
pub const WINHTTP_FEATURE_STREAM_ERROR_CODE = @as(u32, 21);
pub const WINHTTP_FEATURE_REQUIRE_STREAM_END = @as(u32, 22);
pub const WINHTTP_FEATURE_ENABLE_HTTP2_PLUS_CLIENT_CERT = @as(u32, 23);
pub const WINHTTP_FEATURE_FAILED_CONNECTION_RETRIES = @as(u32, 24);
pub const WINHTTP_FEATURE_HTTP2_KEEPALIVE = @as(u32, 26);
pub const WINHTTP_FEATURE_RESOLUTION_HOSTNAME = @as(u32, 27);
pub const WINHTTP_FEATURE_SET_TOKEN_BINDING = @as(u32, 28);
pub const WINHTTP_FEATURE_TOKEN_BINDING_PUBLIC_KEY = @as(u32, 29);
pub const WINHTTP_FEATURE_REFERER_TOKEN_BINDING_HOSTNAME = @as(u32, 30);
pub const WINHTTP_FEATURE_HTTP2_PLUS_TRANSFER_ENCODING = @as(u32, 31);
pub const WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG = @as(u32, 32);
pub const WINHTTP_FEATURE_DISABLE_CERT_CHAIN_BUILDING = @as(u32, 33);
pub const WINHTTP_FEATURE_BACKGROUND_CONNECTIONS = @as(u32, 34);
pub const WINHTTP_FEATURE_FIRST_AVAILABLE_CONNECTION = @as(u32, 35);
pub const WINHTTP_FEATURE_TCP_PRIORITY_STATUS = @as(u32, 37);
pub const WINHTTP_FEATURE_CONNECTION_GUID = @as(u32, 38);
pub const WINHTTP_FEATURE_MATCH_CONNECTION_GUID = @as(u32, 39);
pub const WINHTTP_FEATURE_HTTP2_RECEIVE_WINDOW = @as(u32, 43);
pub const WINHTTP_FEATURE_IS_FEATURE_SUPPORTED = @as(u32, 44);
pub const WINHTTP_FEATURE_ADD_REQUEST_HEADERS_EX = @as(u32, 46);
pub const WINHTTP_FEATURE_SET_PROXY_SETINGS_PER_USER = @as(u32, 47);
pub const WINHTTP_FEATURE_READ_DATA_EX = @as(u32, 48);
pub const WINHTTP_FEATURE_QUERY_HEADERS_EX = @as(u32, 49);
pub const WINHTTP_FEATURE_QUERY_CONNECTION_GROUP = @as(u32, 50);
pub const WINHTTP_FEATURE_FREE_QUERY_CONNECTION_GROUP_RESULT = @as(u32, 51);
pub const WINHTTP_FEATURE_SECURITY_FLAG_IGNORE_ALL_CERT_ERRORS = @as(u32, 52);
pub const WINHTTP_FEATURE_FLAG_SECURE_DEFAULTS = @as(u32, 53);
pub const WINHTTP_FEATURE_EXTENDED_HEADER_FLAG_UNICODE = @as(u32, 54);
pub const WINHTTP_FEATURE_QUERY_FLAG_TRAILERS = @as(u32, 55);
pub const WINHTTP_FEATURE_QUERY_FLAG_WIRE_ENCODING = @as(u32, 56);
pub const WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_SOFT_LIMIT = @as(u32, 57);
pub const WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_BYPASS_CACHE = @as(u32, 58);
pub const WINHTTP_FEATURE_FLAG_AUTOMATIC_CHUNKING = @as(u32, 59);
pub const WINHTTP_FEATURE_QUERY_CONNECTION_GROUP_FLAG_INSECURE = @as(u32, 60);
pub const WINHTTP_FEATURE_MATCH_CONNECTION_GUID_FLAG_REQUIRE_MARKED_CONNECTION = @as(u32, 61);
pub const WINHTTP_FEATURE_QUERY_EX_ALL_HEADERS = @as(u32, 62);
pub const WINHTTP_FEATURE_READ_DATA_EX_FLAG_FILL_BUFFER = @as(u32, 63);
pub const WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_USE_DNS_TTL = @as(u32, 64);
pub const WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_CONN_USE_TTL = @as(u32, 65);
pub const WINHTTP_FEATURE_QUIC_STATS = @as(u32, 66);
pub const WINHTTP_FEATURE_HTTP3_KEEPALIVE = @as(u32, 69);
pub const WINHTTP_FEATURE_HTTP3_HANDSHAKE_TIMEOUT = @as(u32, 70);
pub const WINHTTP_FEATURE_HTTP3_INITIAL_RTT = @as(u32, 71);
pub const WINHTTP_FEATURE_HTTP3_STREAM_ERROR_CODE = @as(u32, 72);
pub const WINHTTP_FEATURE_REQUEST_ANNOTATION = @as(u32, 73);
pub const WINHTTP_FEATURE_DISABLE_PROXY_AUTH_SCHEMES = @as(u32, 74);
pub const WINHTTP_FEATURE_REVERT_IMPERSONATION_SERVER_CERT = @as(u32, 75);
...
pub const WINHTTP_INTERNET_SCHEME = enum(i32) {
    HTTP = 1,
    HTTPS = 2,
    FTP = 3,
    SOCKS = 4,
...
pub const WINHTTP_AUTOPROXY_OPTIONS = extern struct {
    ...
    lpszAutoConfigUrl: ?[*:0]align(1) const u16,
...
pub const WINHTTP_EXTENDED_HEADER = extern struct {
    Anonymous1: extern union {
        ...
        pszName: ?[*:0]align(1) const u8,
    },
    Anonymous2: extern union {
        pwszValue: ?[*:0]align(1) const u16,
        pszValue: ?[*:0]align(1) const u8,
    },
};
...
pub const WINHTTP_PROXY_CHANGE_CALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ullFlags: u64,
        pvContext: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) void,
...
pub const WINHTTP_PROXY_SETTINGS_TYPE = enum(i32) {
    Unknown = 0,
    Wsl = 1,
    Wsa = 2,
};
pub const WinHttpProxySettingsTypeUnknown = WINHTTP_PROXY_SETTINGS_TYPE.Unknown;
pub const WinHttpProxySettingsTypeWsl = WINHTTP_PROXY_SETTINGS_TYPE.Wsl;
pub const WinHttpProxySettingsTypeWsa = WINHTTP_PROXY_SETTINGS_TYPE.Wsa;



pub const WinHttpRequestOption = enum(i32) {
    UserAgentString = 0,
    URL = 1,
    URLCodePage = 2,
...
pub const WinHttpRequestOption_UserAgentString = WinHttpRequestOption.UserAgentString;
pub const WinHttpRequestOption_URL = WinHttpRequestOption.URL;
pub const WinHttpRequestOption_URLCodePage = WinHttpRequestOption.URLCodePage;
pub const WinHttpRequestOption_EscapePercentInURL = WinHttpRequestOption.EscapePercentInURL;
pub const WinHttpRequestOption_SslErrorIgnoreFlags = WinHttpRequestOption.SslErrorIgnoreFlags;
pub const WinHttpRequestOption_SelectCertificate = WinHttpRequestOption.SelectCertificate;
pub const WinHttpRequestOption_EnableRedirects = WinHttpRequestOption.EnableRedirects;
pub const WinHttpRequestOption_UrlEscapeDisable = WinHttpRequestOption.UrlEscapeDisable;
pub const WinHttpRequestOption_UrlEscapeDisableQuery = WinHttpRequestOption.UrlEscapeDisableQuery;
pub const WinHttpRequestOption_SecureProtocols = WinHttpRequestOption.SecureProtocols;
pub const WinHttpRequestOption_EnableTracing = WinHttpRequestOption.EnableTracing;
pub const WinHttpRequestOption_RevertImpersonationOverSsl = WinHttpRequestOption.RevertImpersonationOverSsl;
pub const WinHttpRequestOption_EnableHttpsToHttpRedirects = WinHttpRequestOption.EnableHttpsToHttpRedirects;
pub const WinHttpRequestOption_EnablePassportAuthentication = WinHttpRequestOption.EnablePassportAuthentication;
pub const WinHttpRequestOption_MaxAutomaticRedirects = WinHttpRequestOption.MaxAutomaticRedirects;
pub const WinHttpRequestOption_MaxResponseHeaderSize = WinHttpRequestOption.MaxResponseHeaderSize;
pub const WinHttpRequestOption_MaxResponseDrainSize = WinHttpRequestOption.MaxResponseDrainSize;
pub const WinHttpRequestOption_EnableHttp1_1 = WinHttpRequestOption.EnableHttp1_1;
pub const WinHttpRequestOption_EnableCertificateRevocationCheck = WinHttpRequestOption.EnableCertificateRevocationCheck;
pub const WinHttpRequestOption_RejectUserpwd = WinHttpRequestOption.RejectUserpwd;

pub const WinHttpRequestAutoLogonPolicy = enum(i32) {
    Always = 0,
    OnlyIfBypassProxy = 1,
    Never = 2,
};
pub const AutoLogonPolicy_Always = WinHttpRequestAutoLogonPolicy.Always;
pub const AutoLogonPolicy_OnlyIfBypassProxy = WinHttpRequestAutoLogonPolicy.OnlyIfBypassProxy;
pub const AutoLogonPolicy_Never = WinHttpRequestAutoLogonPolicy.Never;

pub const WinHttpRequestSslErrorFlags = enum(i32) {
    UnknownCA = 256,
    CertWrongUsage = 512,
    CertCNInvalid = 4096,
    CertDateInvalid = 8192,
    Ignore_All = 13056,
};
pub const SslErrorFlag_UnknownCA = WinHttpRequestSslErrorFlags.UnknownCA;
pub const SslErrorFlag_CertWrongUsage = WinHttpRequestSslErrorFlags.CertWrongUsage;
pub const SslErrorFlag_CertCNInvalid = WinHttpRequestSslErrorFlags.CertCNInvalid;
pub const SslErrorFlag_CertDateInvalid = WinHttpRequestSslErrorFlags.CertDateInvalid;
pub const SslErrorFlag_Ignore_All = WinHttpRequestSslErrorFlags.Ignore_All;

pub const WinHttpRequestSecureProtocols = enum(i32) {
    SSL2 = 8,
    SSL3 = 32,
    TLS1 = 128,
    TLS1_1 = 512,
...
pub const SecureProtocol_SSL2 = WinHttpRequestSecureProtocols.SSL2;
pub const SecureProtocol_SSL3 = WinHttpRequestSecureProtocols.SSL3;
pub const SecureProtocol_TLS1 = WinHttpRequestSecureProtocols.TLS1;
pub const SecureProtocol_TLS1_1 = WinHttpRequestSecureProtocols.TLS1_1;
pub const SecureProtocol_TLS1_2 = WinHttpRequestSecureProtocols.TLS1_2;
pub const SecureProtocol_ALL = WinHttpRequestSecureProtocols.ALL;

const IID_IWinHttpRequest_Value = Guid.initString("016fe2ec-b2c8-45f8-b23b-39e53a75396b");
pub const IID_IWinHttpRequest = &IID_IWinHttpRequest_Value;
pub const IWinHttpRequest = extern struct {
    pub const VTable = extern struct {
        base: IDispatch.VTable,
        SetProxy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequest,
                ProxySetting: i32,
                ProxyServer: VARIANT,
                BypassList: VARIANT,
        ...
        get_Option: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequest,
        ...
        put_Option: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequest,
                Option: WinHttpRequestOption,
                Value: VARIANT,
        ...
        SetAutoLogonPolicy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequest,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IWinHttpRequest_SetProxy(self: *const T, ProxySetting: i32, ProxyServer: VARIANT, BypassList: VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetProxy(@as(*const IWinHttpRequest, @ptrCast(self)), ProxySetting, ProxyServer, BypassList);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_SetCredentials(self: *const T, UserName: ?BSTR, Password: ?BSTR, Flags: i32) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetCredentials(@as(*const IWinHttpRequest, @ptrCast(self)), UserName, Password, Flags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_Open(self: *const T, Method: ?BSTR, Url: ?BSTR, Async: VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).Open(@as(*const IWinHttpRequest, @ptrCast(self)), Method, Url, Async);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_SetRequestHeader(self: *const T, Header: ?BSTR, Value: ?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetRequestHeader(@as(*const IWinHttpRequest, @ptrCast(self)), Header, Value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_GetResponseHeader(self: *const T, Header: ?BSTR, Value: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).GetResponseHeader(@as(*const IWinHttpRequest, @ptrCast(self)), Header, Value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_GetAllResponseHeaders(self: *const T, Headers: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).GetAllResponseHeaders(@as(*const IWinHttpRequest, @ptrCast(self)), Headers);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_Send(self: *const T, Body: VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).Send(@as(*const IWinHttpRequest, @ptrCast(self)), Body);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_Status(self: *const T, Status: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_Status(@as(*const IWinHttpRequest, @ptrCast(self)), Status);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_StatusText(self: *const T, Status: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_StatusText(@as(*const IWinHttpRequest, @ptrCast(self)), Status);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_ResponseText(self: *const T, Body: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_ResponseText(@as(*const IWinHttpRequest, @ptrCast(self)), Body);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_ResponseBody(self: *const T, Body: ?*VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_ResponseBody(@as(*const IWinHttpRequest, @ptrCast(self)), Body);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_ResponseStream(self: *const T, Body: ?*VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_ResponseStream(@as(*const IWinHttpRequest, @ptrCast(self)), Body);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_get_Option(self: *const T, Option: WinHttpRequestOption, Value: ?*VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).get_Option(@as(*const IWinHttpRequest, @ptrCast(self)), Option, Value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_put_Option(self: *const T, Option: WinHttpRequestOption, Value: VARIANT) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).put_Option(@as(*const IWinHttpRequest, @ptrCast(self)), Option, Value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_WaitForResponse(self: *const T, Timeout: VARIANT, Succeeded: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).WaitForResponse(@as(*const IWinHttpRequest, @ptrCast(self)), Timeout, Succeeded);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_Abort(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).Abort(@as(*const IWinHttpRequest, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_SetTimeouts(self: *const T, ResolveTimeout: i32, ConnectTimeout: i32, SendTimeout: i32, ReceiveTimeout: i32) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetTimeouts(@as(*const IWinHttpRequest, @ptrCast(self)), ResolveTimeout, ConnectTimeout, SendTimeout, ReceiveTimeout);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_SetClientCertificate(self: *const T, ClientCertificate: ?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetClientCertificate(@as(*const IWinHttpRequest, @ptrCast(self)), ClientCertificate);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequest_SetAutoLogonPolicy(self: *const T, AutoLogonPolicy: WinHttpRequestAutoLogonPolicy) callconv(.Inline) HRESULT {
            return @as(*const IWinHttpRequest.VTable, @ptrCast(self.vtable)).SetAutoLogonPolicy(@as(*const IWinHttpRequest, @ptrCast(self)), AutoLogonPolicy);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IWinHttpRequestEvents_Value = Guid.initString("f97f4e15-b787-4212-80d1-d380cbbf982e");
pub const IID_IWinHttpRequestEvents = &IID_IWinHttpRequestEvents_Value;
pub const IWinHttpRequestEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnResponseStart: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequestEvents,
                Status: i32,
                ContentType: ?BSTR,
            ) callconv(@import("std").os.windows.WINAPI) void,
            else => *const fn(
        ...
        OnResponseDataAvailable: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequestEvents,
                Data: ?*?*SAFEARRAY,
            ) callconv(@import("std").os.windows.WINAPI) void,
        ...
        OnResponseFinished: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWinHttpRequestEvents,
            ) callconv(@import("std").os.windows.WINAPI) void,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequestEvents_OnResponseStart(self: *const T, Status: i32, ContentType: ?BSTR) callconv(.Inline) void {
            return @as(*const IWinHttpRequestEvents.VTable, @ptrCast(self.vtable)).OnResponseStart(@as(*const IWinHttpRequestEvents, @ptrCast(self)), Status, ContentType);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequestEvents_OnResponseDataAvailable(self: *const T, Data: ?*?*SAFEARRAY) callconv(.Inline) void {
            return @as(*const IWinHttpRequestEvents.VTable, @ptrCast(self.vtable)).OnResponseDataAvailable(@as(*const IWinHttpRequestEvents, @ptrCast(self)), Data);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequestEvents_OnResponseFinished(self: *const T) callconv(.Inline) void {
            return @as(*const IWinHttpRequestEvents.VTable, @ptrCast(self.vtable)).OnResponseFinished(@as(*const IWinHttpRequestEvents, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinHttpRequestEvents_OnError(self: *const T, ErrorNumber: i32, ErrorDescription: ?BSTR) callconv(.Inline) void {
            return @as(*const IWinHttpRequestEvents.VTable, @ptrCast(self.vtable)).OnError(@as(*const IWinHttpRequestEvents, @ptrCast(self)), ErrorNumber, ErrorDescription);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const CLSID_WinHttpRequest_Value = Guid.initString("2087c2f4-2cef-4953-a8ab-66779b670495");
pub const CLSID_WinHttpRequest = &CLSID_WinHttpRequest_Value;
...
pub const WINHTTP_PROXY_SETTINGS_EX = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ullGenerationId: u64,
        ullFlags: u64,
        pcwszAutoconfigUrl: ?[*:0]align(1) const u16,
        pcwszProxy: ?[*:0]align(1) const u16,
        pcwszSecureProxy: ?[*:0]align(1) const u16,
        cProxyBypasses: u32,
        rgpcwszProxyBypasses: ?*const ?PWSTR,
        dwInterfaceIndex: u32,
        pcwszConnectionName: ?[*:0]align(1) const u16,
    },
    .X86 => extern struct {
        ullGenerationId: u64 align(4),
        ullFlags: u64 align(4),
        pcwszAutoconfigUrl: ?[*:0]align(1) const u16 align(4),
        pcwszProxy: ?[*:0]align(1) const u16 align(4),
        pcwszSecureProxy: ?[*:0]align(1) const u16 align(4),
        cProxyBypasses: u32 align(4),
        rgpcwszProxyBypasses: ?*const ?PWSTR align(4),
        dwInterfaceIndex: u32 align(4),
        pcwszConnectionName: ?[*:0]align(1) const u16 align(4),
    },
};
pub const WINHTTP_PROXY_SETTINGS_PARAM = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ullFlags: u64,
        pcwszConnectionName: ?[*:0]align(1) const u16,
        pcwszProbeHost: ?[*:0]align(1) const u16,
    },
    .X86 => extern struct {
        ullFlags: u64 align(4),
        pcwszConnectionName: ?[*:0]align(1) const u16 align(4),
        pcwszProbeHost: ?[*:0]align(1) const u16 align(4),
    },
};
...
pub extern "winhttp" fn WinHttpOpen(
    pszAgentW: ?[*:0]align(1) const u16,
    dwAccessType: WINHTTP_ACCESS_TYPE,
    pszProxyW: ?[*:0]align(1) const u16,
    pszProxyBypassW: ?[*:0]align(1) const u16,
    dwFlags: u32,
...
pub extern "winhttp" fn WinHttpConnect(
    hSession: ?*anyopaque,
    pswzServerName: ?[*:0]align(1) const u16,
    nServerPort: u16,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "winhttp" fn WinHttpOpenRequest(
    hConnect: ?*anyopaque,
    pwszVerb: ?[*:0]align(1) const u16,
    pwszObjectName: ?[*:0]align(1) const u16,
    pwszVersion: ?[*:0]align(1) const u16,
    pwszReferrer: ?[*:0]align(1) const u16,
    ppwszAcceptTypes: ?*const ?PWSTR,
...
pub extern "winhttp" fn WinHttpSetCredentials(
    ...
    AuthTargets: u32,
    AuthScheme: u32,
    pwszUserName: ?[*:0]align(1) const u16,
...
pub extern "winhttp" fn WinHttpRegisterProxyChangeNotification(
    ullFlags: u64,
...
pub extern "winhttp" fn WinHttpUnregisterProxyChangeNotification(
    hRegistration: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpGetProxySettingsEx(
    hResolver: ?*anyopaque,
    ProxySettingsType: WINHTTP_PROXY_SETTINGS_TYPE,
    pProxySettingsParam: ?*WINHTTP_PROXY_SETTINGS_PARAM,
    pContext: usize,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpGetProxySettingsResultEx(
    hResolver: ?*anyopaque,
    pProxySettingsEx: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpFreeProxySettingsEx(
    ProxySettingsType: WINHTTP_PROXY_SETTINGS_TYPE,
    pProxySettingsEx: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
const SOCKADDR_STORAGE = @import("../../../windows/win32/networking/win_sock.zig").SOCKADDR_STORAGE;
...
test {
    ...
    if (@hasDecl(@This(), "WINHTTP_PROXY_CHANGE_CALLBACK")) { _ = WINHTTP_PROXY_CHANGE_CALLBACK; }
