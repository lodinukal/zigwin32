...
pub const PARTITION_SBL_CACHE_SSD_GUID = Guid.initString("eeff8352-dd2a-44db-ae83-bee1cf7481dc");
pub const PARTITION_SBL_CACHE_SSD_RESERVED_GUID = Guid.initString("dcc0c7c1-55ad-4f17-9d43-4bc776e0117e");
pub const PARTITION_SBL_CACHE_HDD_GUID = Guid.initString("03aaa829-ebfc-4e7e-aac9-c4d76c63b24b");
...
pub const INVALID_FILE_SIZE = @as(u32, 4294967295);
...
pub const SHARE_QOS_POLICY_PARMNUM = @as(u32, 504);
...
pub const SHI1005_FLAGS_ISOLATED_TRANSPORT = @as(u32, 2097152);
pub const SHI1005_FLAGS_DISABLE_DIRECTORY_HANDLE_LEASING = @as(u32, 4194304);
...
pub const FIND_FIRST_EX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FIND_FIRST_EX_FLAGS, @enumFromInt(
              (if (o.CASE_SENSITIVE == 1) @intFromEnum(FIND_FIRST_EX_FLAGS.CASE_SENSITIVE) else 0)
            | (if (o.LARGE_FETCH == 1) @intFromEnum(FIND_FIRST_EX_FLAGS.LARGE_FETCH) else 0)
            | (if (o.ON_DISK_ENTRIES_ONLY == 1) @intFromEnum(FIND_FIRST_EX_FLAGS.ON_DISK_ENTRIES_ONLY) else 0)
        ));
    }
};
...
pub const DEFINE_DOS_DEVICE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DEFINE_DOS_DEVICE_FLAGS, @enumFromInt(
              (if (o.RAW_TARGET_PATH == 1) @intFromEnum(DEFINE_DOS_DEVICE_FLAGS.RAW_TARGET_PATH) else 0)
            | (if (o.REMOVE_DEFINITION == 1) @intFromEnum(DEFINE_DOS_DEVICE_FLAGS.REMOVE_DEFINITION) else 0)
            | (if (o.EXACT_MATCH_ON_REMOVE == 1) @intFromEnum(DEFINE_DOS_DEVICE_FLAGS.EXACT_MATCH_ON_REMOVE) else 0)
            | (if (o.NO_BROADCAST_SYSTEM == 1) @intFromEnum(DEFINE_DOS_DEVICE_FLAGS.NO_BROADCAST_SYSTEM) else 0)
            | (if (o.LUID_BROADCAST_DRIVE == 1) @intFromEnum(DEFINE_DOS_DEVICE_FLAGS.LUID_BROADCAST_DRIVE) else 0)
        ));
    }
};
...
pub const FILE_FLAGS_AND_ATTRIBUTES = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_FLAGS_AND_ATTRIBUTES, @enumFromInt(
              (if (o.FILE_ATTRIBUTE_READONLY == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_READONLY) else 0)
            | (if (o.FILE_ATTRIBUTE_HIDDEN == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_HIDDEN) else 0)
            | (if (o.FILE_ATTRIBUTE_SYSTEM == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_SYSTEM) else 0)
            | (if (o.FILE_ATTRIBUTE_DIRECTORY == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_DIRECTORY) else 0)
            | (if (o.FILE_ATTRIBUTE_ARCHIVE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_ARCHIVE) else 0)
            | (if (o.FILE_ATTRIBUTE_DEVICE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_DEVICE) else 0)
            | (if (o.FILE_ATTRIBUTE_NORMAL == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_NORMAL) else 0)
            | (if (o.FILE_ATTRIBUTE_TEMPORARY == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_TEMPORARY) else 0)
            | (if (o.FILE_ATTRIBUTE_SPARSE_FILE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_SPARSE_FILE) else 0)
            | (if (o.FILE_ATTRIBUTE_REPARSE_POINT == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_REPARSE_POINT) else 0)
            | (if (o.FILE_ATTRIBUTE_COMPRESSED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_COMPRESSED) else 0)
            | (if (o.FILE_ATTRIBUTE_OFFLINE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_OFFLINE) else 0)
            | (if (o.FILE_ATTRIBUTE_NOT_CONTENT_INDEXED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_NOT_CONTENT_INDEXED) else 0)
            | (if (o.FILE_ATTRIBUTE_ENCRYPTED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_ENCRYPTED) else 0)
            | (if (o.FILE_ATTRIBUTE_INTEGRITY_STREAM == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_INTEGRITY_STREAM) else 0)
            | (if (o.FILE_ATTRIBUTE_VIRTUAL == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_VIRTUAL) else 0)
            | (if (o.FILE_ATTRIBUTE_NO_SCRUB_DATA == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_NO_SCRUB_DATA) else 0)
            | (if (o.FILE_ATTRIBUTE_EA == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_EA) else 0)
            | (if (o.FILE_ATTRIBUTE_PINNED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_PINNED) else 0)
            | (if (o.FILE_ATTRIBUTE_UNPINNED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_UNPINNED) else 0)
            | (if (o.FILE_ATTRIBUTE_RECALL_ON_DATA_ACCESS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_ATTRIBUTE_RECALL_ON_DATA_ACCESS) else 0)
            | (if (o.FILE_FLAG_WRITE_THROUGH == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_WRITE_THROUGH) else 0)
            | (if (o.FILE_FLAG_OVERLAPPED == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_OVERLAPPED) else 0)
            | (if (o.FILE_FLAG_NO_BUFFERING == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_NO_BUFFERING) else 0)
            | (if (o.FILE_FLAG_RANDOM_ACCESS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_RANDOM_ACCESS) else 0)
            | (if (o.FILE_FLAG_SEQUENTIAL_SCAN == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_SEQUENTIAL_SCAN) else 0)
            | (if (o.FILE_FLAG_DELETE_ON_CLOSE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_DELETE_ON_CLOSE) else 0)
            | (if (o.FILE_FLAG_BACKUP_SEMANTICS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_BACKUP_SEMANTICS) else 0)
            | (if (o.FILE_FLAG_POSIX_SEMANTICS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_POSIX_SEMANTICS) else 0)
            | (if (o.FILE_FLAG_SESSION_AWARE == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_SESSION_AWARE) else 0)
            | (if (o.FILE_FLAG_OPEN_REPARSE_POINT == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.FILE_FLAG_OPEN_REPARSE_POINT) else 0)
            | (if (o.PIPE_ACCESS_DUPLEX == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.PIPE_ACCESS_DUPLEX) else 0)
            | (if (o.SECURITY_ANONYMOUS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.SECURITY_ANONYMOUS) else 0)
            | (if (o.SECURITY_DELEGATION == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.SECURITY_DELEGATION) else 0)
            | (if (o.SECURITY_VALID_SQOS_FLAGS == 1) @intFromEnum(FILE_FLAGS_AND_ATTRIBUTES.SECURITY_VALID_SQOS_FLAGS) else 0)
        ));
    }
};
...
pub const FILE_ACCESS_RIGHTS = enum(u32) {
    FILE_READ_DATA = 1,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_ACCESS_RIGHTS, @enumFromInt(
              (if (o.FILE_READ_DATA == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_READ_DATA) else 0)
            | (if (o.FILE_WRITE_DATA == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_WRITE_DATA) else 0)
            | (if (o.FILE_APPEND_DATA == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_APPEND_DATA) else 0)
            | (if (o.FILE_READ_EA == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_READ_EA) else 0)
            | (if (o.FILE_WRITE_EA == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_WRITE_EA) else 0)
            | (if (o.FILE_EXECUTE == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_EXECUTE) else 0)
            | (if (o.FILE_DELETE_CHILD == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_DELETE_CHILD) else 0)
            | (if (o.FILE_READ_ATTRIBUTES == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_READ_ATTRIBUTES) else 0)
            | (if (o.FILE_WRITE_ATTRIBUTES == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_WRITE_ATTRIBUTES) else 0)
            | (if (o.DELETE == 1) @intFromEnum(FILE_ACCESS_RIGHTS.DELETE) else 0)
            | (if (o.READ_CONTROL == 1) @intFromEnum(FILE_ACCESS_RIGHTS.READ_CONTROL) else 0)
            | (if (o.WRITE_DAC == 1) @intFromEnum(FILE_ACCESS_RIGHTS.WRITE_DAC) else 0)
            | (if (o.WRITE_OWNER == 1) @intFromEnum(FILE_ACCESS_RIGHTS.WRITE_OWNER) else 0)
            | (if (o.SYNCHRONIZE == 1) @intFromEnum(FILE_ACCESS_RIGHTS.SYNCHRONIZE) else 0)
            | (if (o.STANDARD_RIGHTS_REQUIRED == 1) @intFromEnum(FILE_ACCESS_RIGHTS.STANDARD_RIGHTS_REQUIRED) else 0)
            | (if (o.STANDARD_RIGHTS_ALL == 1) @intFromEnum(FILE_ACCESS_RIGHTS.STANDARD_RIGHTS_ALL) else 0)
            | (if (o.SPECIFIC_RIGHTS_ALL == 1) @intFromEnum(FILE_ACCESS_RIGHTS.SPECIFIC_RIGHTS_ALL) else 0)
            | (if (o.FILE_ALL_ACCESS == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_ALL_ACCESS) else 0)
            | (if (o.FILE_GENERIC_READ == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_GENERIC_READ) else 0)
            | (if (o.FILE_GENERIC_WRITE == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_GENERIC_WRITE) else 0)
            | (if (o.FILE_GENERIC_EXECUTE == 1) @intFromEnum(FILE_ACCESS_RIGHTS.FILE_GENERIC_EXECUTE) else 0)
        ));
    }
};
pub const FILE_READ_DATA = FILE_ACCESS_RIGHTS.FILE_READ_DATA;
pub const FILE_LIST_DIRECTORY = FILE_ACCESS_RIGHTS.FILE_READ_DATA;
pub const FILE_WRITE_DATA = FILE_ACCESS_RIGHTS.FILE_WRITE_DATA;
pub const FILE_ADD_FILE = FILE_ACCESS_RIGHTS.FILE_WRITE_DATA;
pub const FILE_APPEND_DATA = FILE_ACCESS_RIGHTS.FILE_APPEND_DATA;
pub const FILE_ADD_SUBDIRECTORY = FILE_ACCESS_RIGHTS.FILE_APPEND_DATA;
pub const FILE_CREATE_PIPE_INSTANCE = FILE_ACCESS_RIGHTS.FILE_APPEND_DATA;
pub const FILE_READ_EA = FILE_ACCESS_RIGHTS.FILE_READ_EA;
pub const FILE_WRITE_EA = FILE_ACCESS_RIGHTS.FILE_WRITE_EA;
pub const FILE_EXECUTE = FILE_ACCESS_RIGHTS.FILE_EXECUTE;
pub const FILE_TRAVERSE = FILE_ACCESS_RIGHTS.FILE_EXECUTE;
pub const FILE_DELETE_CHILD = FILE_ACCESS_RIGHTS.FILE_DELETE_CHILD;
pub const FILE_READ_ATTRIBUTES = FILE_ACCESS_RIGHTS.FILE_READ_ATTRIBUTES;
pub const FILE_WRITE_ATTRIBUTES = FILE_ACCESS_RIGHTS.FILE_WRITE_ATTRIBUTES;
pub const DELETE = FILE_ACCESS_RIGHTS.DELETE;
pub const READ_CONTROL = FILE_ACCESS_RIGHTS.READ_CONTROL;
pub const WRITE_DAC = FILE_ACCESS_RIGHTS.WRITE_DAC;
pub const WRITE_OWNER = FILE_ACCESS_RIGHTS.WRITE_OWNER;
pub const SYNCHRONIZE = FILE_ACCESS_RIGHTS.SYNCHRONIZE;
pub const STANDARD_RIGHTS_REQUIRED = FILE_ACCESS_RIGHTS.STANDARD_RIGHTS_REQUIRED;
pub const STANDARD_RIGHTS_READ = FILE_ACCESS_RIGHTS.READ_CONTROL;
pub const STANDARD_RIGHTS_WRITE = FILE_ACCESS_RIGHTS.READ_CONTROL;
pub const STANDARD_RIGHTS_EXECUTE = FILE_ACCESS_RIGHTS.READ_CONTROL;
pub const STANDARD_RIGHTS_ALL = FILE_ACCESS_RIGHTS.STANDARD_RIGHTS_ALL;
pub const SPECIFIC_RIGHTS_ALL = FILE_ACCESS_RIGHTS.SPECIFIC_RIGHTS_ALL;
pub const FILE_ALL_ACCESS = FILE_ACCESS_RIGHTS.FILE_ALL_ACCESS;
pub const FILE_GENERIC_READ = FILE_ACCESS_RIGHTS.FILE_GENERIC_READ;
pub const FILE_GENERIC_WRITE = FILE_ACCESS_RIGHTS.FILE_GENERIC_WRITE;
pub const FILE_GENERIC_EXECUTE = FILE_ACCESS_RIGHTS.FILE_GENERIC_EXECUTE;
...
pub const GET_FILE_VERSION_INFO_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(GET_FILE_VERSION_INFO_FLAGS, @enumFromInt(
              (if (o.LOCALISED == 1) @intFromEnum(GET_FILE_VERSION_INFO_FLAGS.LOCALISED) else 0)
            | (if (o.NEUTRAL == 1) @intFromEnum(GET_FILE_VERSION_INFO_FLAGS.NEUTRAL) else 0)
            | (if (o.PREFETCHED == 1) @intFromEnum(GET_FILE_VERSION_INFO_FLAGS.PREFETCHED) else 0)
        ));
    }
};
...
pub const VER_FIND_FILE_STATUS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(VER_FIND_FILE_STATUS, @enumFromInt(
              (if (o.CURNEDEST == 1) @intFromEnum(VER_FIND_FILE_STATUS.CURNEDEST) else 0)
            | (if (o.FILEINUSE == 1) @intFromEnum(VER_FIND_FILE_STATUS.FILEINUSE) else 0)
            | (if (o.BUFFTOOSMALL == 1) @intFromEnum(VER_FIND_FILE_STATUS.BUFFTOOSMALL) else 0)
        ));
    }
};
...
pub const VER_INSTALL_FILE_STATUS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(VER_INSTALL_FILE_STATUS, @enumFromInt(
              (if (o.TEMPFILE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.TEMPFILE) else 0)
            | (if (o.MISMATCH == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.MISMATCH) else 0)
            | (if (o.SRCOLD == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.SRCOLD) else 0)
            | (if (o.DIFFLANG == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.DIFFLANG) else 0)
            | (if (o.DIFFCODEPG == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.DIFFCODEPG) else 0)
            | (if (o.DIFFTYPE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.DIFFTYPE) else 0)
            | (if (o.WRITEPROT == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.WRITEPROT) else 0)
            | (if (o.FILEINUSE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.FILEINUSE) else 0)
            | (if (o.OUTOFSPACE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.OUTOFSPACE) else 0)
            | (if (o.ACCESSVIOLATION == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.ACCESSVIOLATION) else 0)
            | (if (o.SHARINGVIOLATION == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.SHARINGVIOLATION) else 0)
            | (if (o.CANNOTCREATE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTCREATE) else 0)
            | (if (o.CANNOTDELETE == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTDELETE) else 0)
            | (if (o.CANNOTRENAME == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTRENAME) else 0)
            | (if (o.CANNOTDELETECUR == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTDELETECUR) else 0)
            | (if (o.OUTOFMEMORY == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.OUTOFMEMORY) else 0)
            | (if (o.CANNOTREADSRC == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTREADSRC) else 0)
            | (if (o.CANNOTREADDST == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTREADDST) else 0)
            | (if (o.BUFFTOOSMALL == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.BUFFTOOSMALL) else 0)
            | (if (o.CANNOTLOADLZ32 == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTLOADLZ32) else 0)
            | (if (o.CANNOTLOADCABINET == 1) @intFromEnum(VER_INSTALL_FILE_STATUS.CANNOTLOADCABINET) else 0)
        ));
    }
};
...
pub const VS_FIXEDFILEINFO_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(VS_FIXEDFILEINFO_FILE_FLAGS, @enumFromInt(
              (if (o.DEBUG == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.DEBUG) else 0)
            | (if (o.PRERELEASE == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.PRERELEASE) else 0)
            | (if (o.PATCHED == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.PATCHED) else 0)
            | (if (o.PRIVATEBUILD == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.PRIVATEBUILD) else 0)
            | (if (o.INFOINFERRED == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.INFOINFERRED) else 0)
            | (if (o.SPECIALBUILD == 1) @intFromEnum(VS_FIXEDFILEINFO_FILE_FLAGS.SPECIALBUILD) else 0)
        ));
    }
};
...
pub const VS_FIXEDFILEINFO_FILE_OS = enum(u32) {
    UNKNOWN = 0,
    DOS = 65536,
    OS216 = 131072,
    OS232 = 196608,
...
pub const FILE_SHARE_MODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_SHARE_MODE, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(FILE_SHARE_MODE.NONE) else 0)
            | (if (o.DELETE == 1) @intFromEnum(FILE_SHARE_MODE.DELETE) else 0)
            | (if (o.READ == 1) @intFromEnum(FILE_SHARE_MODE.READ) else 0)
            | (if (o.WRITE == 1) @intFromEnum(FILE_SHARE_MODE.WRITE) else 0)
        ));
    }
};
...
pub const SHARE_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SHARE_TYPE, @enumFromInt(
              (if (o.DISKTREE == 1) @intFromEnum(SHARE_TYPE.DISKTREE) else 0)
            | (if (o.PRINTQ == 1) @intFromEnum(SHARE_TYPE.PRINTQ) else 0)
            | (if (o.DEVICE == 1) @intFromEnum(SHARE_TYPE.DEVICE) else 0)
            | (if (o.IPC == 1) @intFromEnum(SHARE_TYPE.IPC) else 0)
            | (if (o.SPECIAL == 1) @intFromEnum(SHARE_TYPE.SPECIAL) else 0)
            | (if (o.TEMPORARY == 1) @intFromEnum(SHARE_TYPE.TEMPORARY) else 0)
            | (if (o.MASK == 1) @intFromEnum(SHARE_TYPE.MASK) else 0)
        ));
    }
};
...
pub const CLFS_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CLFS_FLAG, @enumFromInt(
              (if (o.FORCE_APPEND == 1) @intFromEnum(CLFS_FLAG.FORCE_APPEND) else 0)
            | (if (o.FORCE_FLUSH == 1) @intFromEnum(CLFS_FLAG.FORCE_FLUSH) else 0)
            | (if (o.NO_FLAGS == 1) @intFromEnum(CLFS_FLAG.NO_FLAGS) else 0)
            | (if (o.USE_RESERVATION == 1) @intFromEnum(CLFS_FLAG.USE_RESERVATION) else 0)
        ));
    }
};
...
pub const MOVE_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(MOVE_FILE_FLAGS, @enumFromInt(
              (if (o.COPY_ALLOWED == 1) @intFromEnum(MOVE_FILE_FLAGS.COPY_ALLOWED) else 0)
            | (if (o.CREATE_HARDLINK == 1) @intFromEnum(MOVE_FILE_FLAGS.CREATE_HARDLINK) else 0)
            | (if (o.DELAY_UNTIL_REBOOT == 1) @intFromEnum(MOVE_FILE_FLAGS.DELAY_UNTIL_REBOOT) else 0)
            | (if (o.REPLACE_EXISTING == 1) @intFromEnum(MOVE_FILE_FLAGS.REPLACE_EXISTING) else 0)
            | (if (o.WRITE_THROUGH == 1) @intFromEnum(MOVE_FILE_FLAGS.WRITE_THROUGH) else 0)
            | (if (o.FAIL_IF_NOT_TRACKABLE == 1) @intFromEnum(MOVE_FILE_FLAGS.FAIL_IF_NOT_TRACKABLE) else 0)
        ));
    }
};
...
pub const GETFINALPATHNAMEBYHANDLE_FLAGS = enum(u32) {
    VOLUME_NAME_DOS = 0,
    VOLUME_NAME_GUID = 1,
    VOLUME_NAME_NT = 2,
    VOLUME_NAME_NONE = 4,
    // FILE_NAME_NORMALIZED = 0, this enum value conflicts with VOLUME_NAME_DOS
    FILE_NAME_OPENED = 8,
};
pub const VOLUME_NAME_DOS = GETFINALPATHNAMEBYHANDLE_FLAGS.VOLUME_NAME_DOS;
pub const VOLUME_NAME_GUID = GETFINALPATHNAMEBYHANDLE_FLAGS.VOLUME_NAME_GUID;
pub const VOLUME_NAME_NT = GETFINALPATHNAMEBYHANDLE_FLAGS.VOLUME_NAME_NT;
pub const VOLUME_NAME_NONE = GETFINALPATHNAMEBYHANDLE_FLAGS.VOLUME_NAME_NONE;
pub const FILE_NAME_NORMALIZED = GETFINALPATHNAMEBYHANDLE_FLAGS.VOLUME_NAME_DOS;
pub const FILE_NAME_OPENED = GETFINALPATHNAMEBYHANDLE_FLAGS.FILE_NAME_OPENED;

pub const LZOPENFILE_STYLE = enum(u16) {
    CANCEL = 2048,
    CREATE = 4096,
    DELETE = 512,
    EXIST = 16384,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(LZOPENFILE_STYLE, @enumFromInt(
              (if (o.CANCEL == 1) @intFromEnum(LZOPENFILE_STYLE.CANCEL) else 0)
            | (if (o.CREATE == 1) @intFromEnum(LZOPENFILE_STYLE.CREATE) else 0)
            | (if (o.DELETE == 1) @intFromEnum(LZOPENFILE_STYLE.DELETE) else 0)
            | (if (o.EXIST == 1) @intFromEnum(LZOPENFILE_STYLE.EXIST) else 0)
            | (if (o.PARSE == 1) @intFromEnum(LZOPENFILE_STYLE.PARSE) else 0)
            | (if (o.PROMPT == 1) @intFromEnum(LZOPENFILE_STYLE.PROMPT) else 0)
            | (if (o.READ == 1) @intFromEnum(LZOPENFILE_STYLE.READ) else 0)
            | (if (o.READWRITE == 1) @intFromEnum(LZOPENFILE_STYLE.READWRITE) else 0)
            | (if (o.REOPEN == 1) @intFromEnum(LZOPENFILE_STYLE.REOPEN) else 0)
            | (if (o.SHARE_DENY_NONE == 1) @intFromEnum(LZOPENFILE_STYLE.SHARE_DENY_NONE) else 0)
            | (if (o.SHARE_DENY_READ == 1) @intFromEnum(LZOPENFILE_STYLE.SHARE_DENY_READ) else 0)
            | (if (o.SHARE_DENY_WRITE == 1) @intFromEnum(LZOPENFILE_STYLE.SHARE_DENY_WRITE) else 0)
            | (if (o.SHARE_EXCLUSIVE == 1) @intFromEnum(LZOPENFILE_STYLE.SHARE_EXCLUSIVE) else 0)
            | (if (o.WRITE == 1) @intFromEnum(LZOPENFILE_STYLE.WRITE) else 0)
            | (if (o.VERIFY == 1) @intFromEnum(LZOPENFILE_STYLE.VERIFY) else 0)
        ));
    }
};
...
pub const FILE_NOTIFY_CHANGE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_NOTIFY_CHANGE, @enumFromInt(
              (if (o.FILE_NAME == 1) @intFromEnum(FILE_NOTIFY_CHANGE.FILE_NAME) else 0)
            | (if (o.DIR_NAME == 1) @intFromEnum(FILE_NOTIFY_CHANGE.DIR_NAME) else 0)
            | (if (o.ATTRIBUTES == 1) @intFromEnum(FILE_NOTIFY_CHANGE.ATTRIBUTES) else 0)
            | (if (o.SIZE == 1) @intFromEnum(FILE_NOTIFY_CHANGE.SIZE) else 0)
            | (if (o.LAST_WRITE == 1) @intFromEnum(FILE_NOTIFY_CHANGE.LAST_WRITE) else 0)
            | (if (o.LAST_ACCESS == 1) @intFromEnum(FILE_NOTIFY_CHANGE.LAST_ACCESS) else 0)
            | (if (o.CREATION == 1) @intFromEnum(FILE_NOTIFY_CHANGE.CREATION) else 0)
            | (if (o.SECURITY == 1) @intFromEnum(FILE_NOTIFY_CHANGE.SECURITY) else 0)
        ));
    }
};
...
pub const TAPE_POSITION_TYPE = enum(u32) {
    ABSOLUTE_POSITION = 0,
    LOGICAL_POSITION = 1,
};
...
pub const CREATE_TAPE_PARTITION_METHOD = enum(u32) {
    FIXED_PARTITIONS = 0,
...
pub const REPLACE_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(REPLACE_FILE_FLAGS, @enumFromInt(
              (if (o.WRITE_THROUGH == 1) @intFromEnum(REPLACE_FILE_FLAGS.WRITE_THROUGH) else 0)
            | (if (o.IGNORE_MERGE_ERRORS == 1) @intFromEnum(REPLACE_FILE_FLAGS.IGNORE_MERGE_ERRORS) else 0)
            | (if (o.IGNORE_ACL_ERRORS == 1) @intFromEnum(REPLACE_FILE_FLAGS.IGNORE_ACL_ERRORS) else 0)
        ));
    }
};
...
pub const TAPEMARK_TYPE = enum(u32) {
    FILEMARKS = 1,
    LONG_FILEMARKS = 3,
    SETMARKS = 0,
    SHORT_FILEMARKS = 2,
...
pub const TAPE_POSITION_METHOD = enum(u32) {
    ABSOLUTE_BLOCK = 1,
    LOGICAL_BLOCK = 2,
    REWIND = 0,
    SPACE_END_OF_DATA = 4,
...
pub const LOCK_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(LOCK_FILE_FLAGS, @enumFromInt(
              (if (o.EXCLUSIVE_LOCK == 1) @intFromEnum(LOCK_FILE_FLAGS.EXCLUSIVE_LOCK) else 0)
            | (if (o.FAIL_IMMEDIATELY == 1) @intFromEnum(LOCK_FILE_FLAGS.FAIL_IMMEDIATELY) else 0)
        ));
    }
};
...
pub const PREPARE_TAPE_OPERATION = enum(u32) {
    FORMAT = 5,
    LOAD = 0,
    LOCK = 3,
    TENSION = 2,
...
pub const ERASE_TAPE_TYPE = enum(u32) {
    LONG = 1,
    SHORT = 0,
};
...
pub const FILE_INFO_FLAGS_PERMISSIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_INFO_FLAGS_PERMISSIONS, @enumFromInt(
              (if (o.READ == 1) @intFromEnum(FILE_INFO_FLAGS_PERMISSIONS.READ) else 0)
            | (if (o.WRITE == 1) @intFromEnum(FILE_INFO_FLAGS_PERMISSIONS.WRITE) else 0)
            | (if (o.CREATE == 1) @intFromEnum(FILE_INFO_FLAGS_PERMISSIONS.CREATE) else 0)
        ));
    }
};
...
pub const SYMBOLIC_LINK_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SYMBOLIC_LINK_FLAGS, @enumFromInt(
              (if (o.DIRECTORY == 1) @intFromEnum(SYMBOLIC_LINK_FLAGS.DIRECTORY) else 0)
            | (if (o.ALLOW_UNPRIVILEGED_CREATE == 1) @intFromEnum(SYMBOLIC_LINK_FLAGS.ALLOW_UNPRIVILEGED_CREATE) else 0)
        ));
    }
};
...
pub const FILE_DISPOSITION_INFO_EX_FLAGS = enum(u32) {
    DO_NOT_DELETE = 0,
    DELETE = 1,
    POSIX_SEMANTICS = 2,
    FORCE_IMAGE_SECTION_CHECK = 4,
    ON_CLOSE = 8,
    IGNORE_READONLY_ATTRIBUTE = 16,
};
pub const FILE_DISPOSITION_FLAG_DO_NOT_DELETE = FILE_DISPOSITION_INFO_EX_FLAGS.DO_NOT_DELETE;
pub const FILE_DISPOSITION_FLAG_DELETE = FILE_DISPOSITION_INFO_EX_FLAGS.DELETE;
pub const FILE_DISPOSITION_FLAG_POSIX_SEMANTICS = FILE_DISPOSITION_INFO_EX_FLAGS.POSIX_SEMANTICS;
pub const FILE_DISPOSITION_FLAG_FORCE_IMAGE_SECTION_CHECK = FILE_DISPOSITION_INFO_EX_FLAGS.FORCE_IMAGE_SECTION_CHECK;
pub const FILE_DISPOSITION_FLAG_ON_CLOSE = FILE_DISPOSITION_INFO_EX_FLAGS.ON_CLOSE;
pub const FILE_DISPOSITION_FLAG_IGNORE_READONLY_ATTRIBUTE = FILE_DISPOSITION_INFO_EX_FLAGS.IGNORE_READONLY_ATTRIBUTE;

pub const FILE_DISPOSITION_INFO = extern struct {
    DeleteFile: BOOLEAN,
};

// TODO: this type has a FreeFunc 'CloseIoRing', what can Zig do with this information?
pub const HIORING = isize;
...
pub const ReadDirectoryNotifyFullInformation = READ_DIRECTORY_NOTIFY_INFORMATION_CLASS.FullInformation;
pub const ReadDirectoryNotifyMaximumInformation = READ_DIRECTORY_NOTIFY_INFORMATION_CLASS.MaximumInformation;
...
pub const IDiskQuotaControl = extern struct {
    pub const VTable = extern struct {
        ...
        AddUserName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDiskQuotaControl,
                pszLogonName: ?[*:0]align(1) const u16,
                fNameResolution: DISKQUOTA_USERNAME_RESOLVE,
                ppUser: ?*?*IDiskQuotaUser,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_Initialize(self: *const T, pszPath: ?[*:0]align(1) const u16, bReadWrite: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_AddUserName(self: *const T, pszLogonName: ?[*:0]align(1) const u16, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: ?*?*IDiskQuotaUser) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_FindUserName(self: *const T, pszLogonName: ?[*:0]align(1) const u16, ppUser: ?*?*IDiskQuotaUser) callconv(.Inline) HRESULT {
...
pub const IORING_VERSION_3 = IORING_VERSION.@"3";
...
pub const IORING_FEATURE_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        FLAGS_NONE: u1 = 0,
        UM_EMULATION: u1 = 0,
        SET_COMPLETION_EVENT: u1 = 0,
    }) IORING_FEATURE_FLAGS {
        return @as(IORING_FEATURE_FLAGS, @enumFromInt(
              (if (o.FLAGS_NONE == 1) @intFromEnum(IORING_FEATURE_FLAGS.FLAGS_NONE) else 0)
            | (if (o.UM_EMULATION == 1) @intFromEnum(IORING_FEATURE_FLAGS.UM_EMULATION) else 0)
            | (if (o.SET_COMPLETION_EVENT == 1) @intFromEnum(IORING_FEATURE_FLAGS.SET_COMPLETION_EVENT) else 0)
        ));
    }
};
...
pub const IORING_OP_WRITE = IORING_OP_CODE.WRITE;
pub const IORING_OP_FLUSH = IORING_OP_CODE.FLUSH;
...
pub const IORING_SQE_FLAGS = enum(i32) {
    NONE = 0,
    DRAIN_PRECEDING_OPS = 1,
    _,
    pub fn initFlags(o: struct {
        NONE: u1 = 0,
        DRAIN_PRECEDING_OPS: u1 = 0,
    }) IORING_SQE_FLAGS {
        return @as(IORING_SQE_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(IORING_SQE_FLAGS.NONE) else 0)
            | (if (o.DRAIN_PRECEDING_OPS == 1) @intFromEnum(IORING_SQE_FLAGS.DRAIN_PRECEDING_OPS) else 0)
        ));
    }
};
pub const IOSQE_FLAGS_NONE = IORING_SQE_FLAGS.NONE;
pub const IOSQE_FLAGS_DRAIN_PRECEDING_OPS = IORING_SQE_FLAGS.DRAIN_PRECEDING_OPS;
...
pub const IORING_CREATE_REQUIRED_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IORING_CREATE_REQUIRED_FLAGS, @enumFromInt(
              (if (o.E == 1) @intFromEnum(IORING_CREATE_REQUIRED_FLAGS.E) else 0)
        ));
    }
};
...
pub const IORING_CREATE_ADVISORY_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IORING_CREATE_ADVISORY_FLAGS, @enumFromInt(
              (if (o.E == 1) @intFromEnum(IORING_CREATE_ADVISORY_FLAGS.E) else 0)
        ));
    }
};
...
pub const FILE_WRITE_FLAGS = enum(i32) {
    NONE = 0,
    WRITE_THROUGH = 1,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(FILE_WRITE_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(FILE_WRITE_FLAGS.NONE) else 0)
            | (if (o.WRITE_THROUGH == 1) @intFromEnum(FILE_WRITE_FLAGS.WRITE_THROUGH) else 0)
        ));
    }
};
pub const FILE_WRITE_FLAGS_NONE = FILE_WRITE_FLAGS.NONE;
pub const FILE_WRITE_FLAGS_WRITE_THROUGH = FILE_WRITE_FLAGS.WRITE_THROUGH;

pub const FILE_FLUSH_MODE = enum(i32) {
    DEFAULT = 0,
    DATA = 1,
    MIN_METADATA = 2,
    NO_SYNC = 3,
};
pub const FILE_FLUSH_DEFAULT = FILE_FLUSH_MODE.DEFAULT;
pub const FILE_FLUSH_DATA = FILE_FLUSH_MODE.DATA;
pub const FILE_FLUSH_MIN_METADATA = FILE_FLUSH_MODE.MIN_METADATA;
pub const FILE_FLUSH_NO_SYNC = FILE_FLUSH_MODE.NO_SYNC;
...
pub extern "kernel32" fn SearchPathW(
    ...
    lpExtension: ?[*:0]align(1) const u16,
    nBufferLength: u32,
    lpBuffer: ?[*:0]u16,
    lpFilePart: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn SearchPathA(
    lpPath: ?[*:0]align(1) const u8,
    lpFileName: ?[*:0]align(1) const u8,
    lpExtension: ?[*:0]align(1) const u8,
    nBufferLength: u32,
    lpBuffer: ?[*:0]u8,
    lpFilePart: ?*?PSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn DefineDosDeviceW(
    ...
    lpDeviceName: ?[*:0]align(1) const u16,
    lpTargetPath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn DeleteVolumeMountPointW(
    lpszVolumeMountPoint: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetDiskFreeSpaceA(
    lpRootPathName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn GetDiskFreeSpaceW(
    lpRootPathName: ?[*:0]align(1) const u16,
    lpSectorsPerCluster: ?*u32,
    lpBytesPerSector: ?*u32,
    lpNumberOfFreeClusters: ?*u32,
    lpTotalNumberOfClusters: ?*u32,
...
pub extern "kernel32" fn GetDiskFreeSpaceExA(
    lpDirectoryName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn GetDiskFreeSpaceExW(
    lpDirectoryName: ?[*:0]align(1) const u16,
    lpFreeBytesAvailableToCaller: ?*u64,
    lpTotalNumberOfBytes: ?*u64,
    lpTotalNumberOfFreeBytes: ?*u64,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetFileType(
    hFile: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) FILE_TYPE;
...
pub extern "kernel32" fn GetLongPathNameA(
    lpszShortPath: ?[*:0]align(1) const u8,
    lpszLongPath: ?[*:0]u8,
    cchBuffer: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetLongPathNameW(
    lpszShortPath: ?[*:0]align(1) const u16,
    lpszLongPath: ?[*:0]u16,
    cchBuffer: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetShortPathNameW(
    lpszLongPath: ?[*:0]align(1) const u16,
    lpszShortPath: ?[*:0]u16,
    cchBuffer: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetTempFileNameW(
    lpPathName: ?[*:0]align(1) const u16,
    lpPrefixString: ?[*:0]align(1) const u16,
    uUnique: u32,
...
pub extern "kernel32" fn GetVolumePathNamesForVolumeNameW(
    lpszVolumeName: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn GetTempFileNameA(
    lpPathName: ?[*:0]align(1) const u8,
    lpPrefixString: ?[*:0]align(1) const u8,
    uUnique: u32,
...
pub extern "api-ms-win-core-file-fromapp-l1-1-0" fn ReplaceFileFromAppW(
    lpReplacedFileName: ?[*:0]align(1) const u16,
    lpReplacementFileName: ?[*:0]align(1) const u16,
    lpBackupFileName: ?[*:0]align(1) const u16,
    dwReplaceFlags: u32,
    lpExclude: ?*anyopaque,
    lpReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "version" fn VerFindFileA(
    ...
    szFileName: ?[*:0]align(1) const u8,
    szWinDir: ?[*:0]align(1) const u8,
    szAppDir: ?[*:0]align(1) const u8,
    szCurDir: [*:0]u8,
    puCurDirLen: ?*u32,
    szDestDir: [*:0]u8,
    puDestDirLen: ?*u32,
...
pub extern "version" fn VerFindFileW(
    ...
    szWinDir: ?[*:0]align(1) const u16,
    szAppDir: ?[*:0]align(1) const u16,
    szCurDir: [*:0]u16,
    puCurDirLen: ?*u32,
    szDestDir: [*:0]u16,
    puDestDirLen: ?*u32,
...
pub extern "version" fn VerInstallFileA(
    ...
    szSrcFileName: ?[*:0]align(1) const u8,
    szDestFileName: ?[*:0]align(1) const u8,
    szSrcDir: ?[*:0]align(1) const u8,
    szDestDir: ?[*:0]align(1) const u8,
    szCurDir: ?[*:0]align(1) const u8,
    szTmpFile: [*:0]u8,
    puTmpFileLen: ?*u32,
...
pub extern "version" fn VerInstallFileW(
    uFlags: VER_INSTALL_FILE_FLAGS,
    szSrcFileName: ?[*:0]align(1) const u16,
    szDestFileName: ?[*:0]align(1) const u16,
    szSrcDir: ?[*:0]align(1) const u16,
    szDestDir: ?[*:0]align(1) const u16,
    szCurDir: ?[*:0]align(1) const u16,
    szTmpFile: [*:0]u16,
    puTmpFileLen: ?*u32,
) callconv(@import("std").os.windows.WINAPI) VER_INSTALL_FILE_STATUS;
...
pub extern "version" fn GetFileVersionInfoSizeA(
    lptstrFilename: ?[*:0]align(1) const u8,
    lpdwHandle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "version" fn GetFileVersionInfoSizeW(
    lptstrFilename: ?[*:0]align(1) const u16,
    lpdwHandle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "version" fn GetFileVersionInfoSizeExA(
    ...
    lpwstrFilename: ?[*:0]align(1) const u8,
    lpdwHandle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "version" fn GetFileVersionInfoSizeExW(
    dwFlags: GET_FILE_VERSION_INFO_FLAGS,
    lpwstrFilename: ?[*:0]align(1) const u16,
    lpdwHandle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "version" fn VerQueryValueW(
    pBlock: ?*const anyopaque,
    lpSubBlock: ?[*:0]align(1) const u16,
    lplpBuffer: ?*?*anyopaque,
    puLen: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "clfsw32" fn CreateLogFile(
    pszLogFileName: ?[*:0]align(1) const u16,
    fDesiredAccess: u32,
    dwShareMode: FILE_SHARE_MODE,
...
pub extern "clfsw32" fn GetLogContainerName(
    ...
    pwstrContainerName: ?[*:0]align(1) const u16,
...
pub extern "advapi32" fn EncryptionDisable(
    DirPath: ?[*:0]align(1) const u16,
    Disable: BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn DuplicateEncryptionInfoFile(
    SrcFileName: ?[*:0]align(1) const u16,
    DstFileName: ?[*:0]align(1) const u16,
...
pub extern "wofutil" fn WofEnumEntries(
    VolumeName: ?[*:0]align(1) const u16,
    Provider: u32,
...
pub extern "wofutil" fn WofWimUpdateEntry(
    VolumeName: ?[*:0]align(1) const u16,
    DataSourceId: i64,
    NewWimPath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "kernel32" fn BuildIoRingWriteFile(
    ioRing: HIORING,
    fileRef: IORING_HANDLE_REF,
...
pub extern "kernel32" fn BuildIoRingFlushFile(
    ioRing: HIORING,
    fileRef: IORING_HANDLE_REF,
...
pub extern "kernel32" fn GetBinaryTypeA(
    lpApplicationName: ?[*:0]align(1) const u8,
    lpBinaryType: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn GetBinaryTypeW(
    lpApplicationName: ?[*:0]align(1) const u16,
    lpBinaryType: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn GetShortPathNameA(
    lpszLongPath: ?[*:0]align(1) const u8,
    lpszShortPath: ?[*:0]u8,
    cchBuffer: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn SetFileShortNameA(
    hFile: ?HANDLE,
    lpShortName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn SetFileShortNameW(
    hFile: ?HANDLE,
    lpShortName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn CreateDirectoryExA(
    lpTemplateDirectory: ?[*:0]align(1) const u8,
    lpNewDirectory: ?[*:0]align(1) const u8,
    lpSecurityAttributes: ?*SECURITY_ATTRIBUTES,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn CreateDirectoryExW(
    lpTemplateDirectory: ?[*:0]align(1) const u16,
    lpNewDirectory: ?[*:0]align(1) const u16,
    lpSecurityAttributes: ?*SECURITY_ATTRIBUTES,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn DefineDosDeviceA(
    dwFlags: DEFINE_DOS_DEVICE_FLAGS,
    lpDeviceName: ?[*:0]align(1) const u8,
    lpTargetPath: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn CopyFileA(
    lpExistingFileName: ?[*:0]align(1) const u8,
    lpNewFileName: ?[*:0]align(1) const u8,
    bFailIfExists: BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn CopyFile2(
    pwszExistingFileName: ?[*:0]align(1) const u16,
    pwszNewFileName: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn ReplaceFileA(
    lpReplacedFileName: ?[*:0]align(1) const u8,
    lpReplacementFileName: ?[*:0]align(1) const u8,
    lpBackupFileName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn SetVolumeLabelA(
    lpRootPathName: ?[*:0]align(1) const u8,
    lpVolumeName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn SetVolumeLabelW(
    lpRootPathName: ?[*:0]align(1) const u16,
    lpVolumeName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn FindFirstVolumeMountPointA(
    lpszRootPathName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn FindFirstVolumeMountPointW(
    lpszRootPathName: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn SetVolumeMountPointA(
    lpszVolumeMountPoint: ?[*:0]align(1) const u8,
    lpszVolumeName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetVolumePathNameA(
    lpszFileName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn CreateSymbolicLinkA(
    lpSymlinkFileName: ?[*:0]align(1) const u8,
    lpTargetFileName: ?[*:0]align(1) const u8,
    dwFlags: SYMBOLIC_LINK_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "kernel32" fn CreateSymbolicLinkW(
    lpSymlinkFileName: ?[*:0]align(1) const u16,
    lpTargetFileName: ?[*:0]align(1) const u16,
    dwFlags: SYMBOLIC_LINK_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
const ALG_ID = @import("../../../windows/win32/security/cryptography.zig").ALG_ID;
...
const GENERIC_MAPPING = @import("../../../windows/win32/security.zig").GENERIC_MAPPING;
const HANDLE = @import("../../../windows/win32/foundation.zig").HANDLE;
const HRESULT = @import("../../../windows/win32/foundation.zig").HRESULT;
const IConnectionPointContainer = @import("../../../windows/win32/system/com.zig").IConnectionPointContainer;
...
const PRIVILEGE_SET = @import("../../../windows/win32/security.zig").PRIVILEGE_SET;
