...
pub const PRINTER_DEVICE_CAPABILITIES = enum(u16) {
    BINNAMES = 12,
    BINS = 6,
    COLLATE = 22,
    COLORDEVICE = 32,
...
pub const DC_BINNAMES = PRINTER_DEVICE_CAPABILITIES.BINNAMES;
pub const DC_BINS = PRINTER_DEVICE_CAPABILITIES.BINS;
pub const DC_COLLATE = PRINTER_DEVICE_CAPABILITIES.COLLATE;
pub const DC_COLORDEVICE = PRINTER_DEVICE_CAPABILITIES.COLORDEVICE;
pub const DC_COPIES = PRINTER_DEVICE_CAPABILITIES.COPIES;
pub const DC_DRIVER = PRINTER_DEVICE_CAPABILITIES.DRIVER;
pub const DC_DUPLEX = PRINTER_DEVICE_CAPABILITIES.DUPLEX;
pub const DC_ENUMRESOLUTIONS = PRINTER_DEVICE_CAPABILITIES.ENUMRESOLUTIONS;
pub const DC_EXTRA = PRINTER_DEVICE_CAPABILITIES.EXTRA;
pub const DC_FIELDS = PRINTER_DEVICE_CAPABILITIES.FIELDS;
pub const DC_FILEDEPENDENCIES = PRINTER_DEVICE_CAPABILITIES.FILEDEPENDENCIES;
pub const DC_MAXEXTENT = PRINTER_DEVICE_CAPABILITIES.MAXEXTENT;
pub const DC_MEDIAREADY = PRINTER_DEVICE_CAPABILITIES.MEDIAREADY;
pub const DC_MEDIATYPENAMES = PRINTER_DEVICE_CAPABILITIES.MEDIATYPENAMES;
pub const DC_MEDIATYPES = PRINTER_DEVICE_CAPABILITIES.MEDIATYPES;
pub const DC_MINEXTENT = PRINTER_DEVICE_CAPABILITIES.MINEXTENT;
pub const DC_ORIENTATION = PRINTER_DEVICE_CAPABILITIES.ORIENTATION;
pub const DC_NUP = PRINTER_DEVICE_CAPABILITIES.NUP;
pub const DC_PAPERNAMES = PRINTER_DEVICE_CAPABILITIES.PAPERNAMES;
pub const DC_PAPERS = PRINTER_DEVICE_CAPABILITIES.PAPERS;
pub const DC_PAPERSIZE = PRINTER_DEVICE_CAPABILITIES.PAPERSIZE;
pub const DC_PERSONALITY = PRINTER_DEVICE_CAPABILITIES.PERSONALITY;
pub const DC_PRINTERMEM = PRINTER_DEVICE_CAPABILITIES.PRINTERMEM;
pub const DC_PRINTRATE = PRINTER_DEVICE_CAPABILITIES.PRINTRATE;
pub const DC_PRINTRATEPPM = PRINTER_DEVICE_CAPABILITIES.PRINTRATEPPM;
pub const DC_PRINTRATEUNIT = PRINTER_DEVICE_CAPABILITIES.PRINTRATEUNIT;
pub const DC_SIZE = PRINTER_DEVICE_CAPABILITIES.SIZE;
pub const DC_STAPLE = PRINTER_DEVICE_CAPABILITIES.STAPLE;
pub const DC_TRUETYPE = PRINTER_DEVICE_CAPABILITIES.TRUETYPE;
pub const DC_VERSION = PRINTER_DEVICE_CAPABILITIES.VERSION;
...
pub const DOCINFOA = extern struct {
    cbSize: i32,
    lpszDocName: ?[*:0]align(1) const u8,
    lpszOutput: ?[*:0]align(1) const u8,
    lpszDatatype: ?[*:0]align(1) const u8,
    fwType: u32,
};

pub const DOCINFOW = extern struct {
    cbSize: i32,
    lpszDocName: ?[*:0]align(1) const u16,
    lpszOutput: ?[*:0]align(1) const u16,
    lpszDatatype: ?[*:0]align(1) const u16,
    fwType: u32,
};
...
pub const IXpsOMVisual = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisual_SetTransformLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisual_SetClipGeometryLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisual_SetOpacityMaskBrushLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisual_SetName(self: *const T, name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisual_SetLanguage(self: *const T, language: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMGlyphsEditor = extern struct {
    pub const VTable = extern struct {
        ...
        SetUnicodeString: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMGlyphsEditor,
                unicodeString: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMGlyphsEditor,
                unicodeString: ?[*:0]align(1) const u16,
        ...
        SetDeviceFontName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMGlyphsEditor,
                deviceFontName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMGlyphsEditor,
                deviceFontName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMGlyphsEditor_SetUnicodeString(self: *const T, unicodeString: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMGlyphsEditor_SetDeviceFontName(self: *const T, deviceFontName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMGlyphs = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMGlyphs_SetFillBrushLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMGeometry = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMGeometry_SetTransformLookup(self: *const T, lookup: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMPath = extern struct {
    pub const VTable = extern struct {
        ...
        SetAccessibilityShortDescription: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMPath,
                shortDescription: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMPath,
                shortDescription: ?[*:0]align(1) const u16,
        ...
        SetAccessibilityLongDescription: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMPath,
                longDescription: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMPath,
                longDescription: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPath_SetGeometryLookup(self: *const T, lookup: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPath_SetAccessibilityShortDescription(self: *const T, shortDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPath_SetAccessibilityLongDescription(self: *const T, longDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPath_SetStrokeBrushLookup(self: *const T, lookup: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPath_SetFillBrushLookup(self: *const T, lookup: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMTileBrush = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMTileBrush_SetTransformLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMVisualBrush = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMVisualBrush_SetVisualLookup(self: *const T, lookup: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMGradientBrush = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMGradientBrush_SetTransformLookup(self: *const T, key: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMDictionary = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMDictionary_GetByKey(self: *const T, key: ?[*:0]align(1) const u16, beforeEntry: ?*IXpsOMShareable, entry: ?*?*IXpsOMShareable) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMDictionary_Append(self: *const T, key: ?[*:0]align(1) const u16, entry: ?*IXpsOMShareable) callconv(.Inline) HRESULT {
            return @as(*const IXpsOMDictionary.VTable, @ptrCast(self.vtable)).Append(@as(*const IXpsOMDictionary, @ptrCast(self)), key, entry);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMDictionary_InsertAt(self: *const T, index: u32, key: ?[*:0]align(1) const u16, entry: ?*IXpsOMShareable) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMDictionary_SetAt(self: *const T, index: u32, key: ?[*:0]align(1) const u16, entry: ?*IXpsOMShareable) callconv(.Inline) HRESULT {
...
pub const IXpsOMCanvas = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCanvas_SetAccessibilityShortDescription(self: *const T, shortDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCanvas_SetAccessibilityLongDescription(self: *const T, longDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMPage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPage_SetLanguage(self: *const T, language: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPage_SetName(self: *const T, name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMCoreProperties = extern struct {
    pub const VTable = extern struct {
        ...
        SetContentStatus: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMCoreProperties,
                contentStatus: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMCoreProperties,
                contentStatus: ?[*:0]align(1) const u16,
        ...
        SetLastModifiedBy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsOMCoreProperties,
                lastModifiedBy: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsOMCoreProperties,
                lastModifiedBy: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetCategory(self: *const T, category: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetContentStatus(self: *const T, contentStatus: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetContentType(self: *const T, contentType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetCreator(self: *const T, creator: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetDescription(self: *const T, description: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetIdentifier(self: *const T, identifier: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetKeywords(self: *const T, keywords: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetLanguage(self: *const T, language: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetLastModifiedBy(self: *const T, lastModifiedBy: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetRevision(self: *const T, revision: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetSubject(self: *const T, subject: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetTitle(self: *const T, title: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMCoreProperties_SetVersion(self: *const T, version: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsOMPackage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPackage_WriteToFile(self: *const T, fileName: ?[*:0]align(1) const u16, securityAttributes: ?*SECURITY_ATTRIBUTES, flagsAndAttributes: u32, optimizeMarkupSize: BOOL) callconv(.Inline) HRESULT {
...
pub const IXpsOMObjectFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory_CreatePackageFromFile(self: *const T, filename: ?[*:0]align(1) const u16, reuseObjects: BOOL, package: ?*?*IXpsOMPackage) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory_CreatePage(self: *const T, pageDimensions: ?*const XPS_SIZE, language: ?[*:0]align(1) const u16, partUri: ?*IOpcPartUri, page: ?*?*IXpsOMPage) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory_CreatePartUri(self: *const T, uri: ?[*:0]align(1) const u16, partUri: ?*?*IOpcPartUri) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory_CreateReadOnlyStreamOnFile(self: *const T, filename: ?[*:0]align(1) const u16, stream: ?*?*IStream) callconv(.Inline) HRESULT {
...
pub const IXpsOMObjectFactory1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory1_GetDocumentTypeFromFile(self: *const T, filename: ?[*:0]align(1) const u16, documentType: ?*XPS_DOCUMENT_TYPE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory1_CreatePackageFromFile1(self: *const T, filename: ?[*:0]align(1) const u16, reuseObjects: BOOL, package: ?*?*IXpsOMPackage1) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMObjectFactory1_CreatePage1(self: *const T, pageDimensions: ?*const XPS_SIZE, language: ?[*:0]align(1) const u16, partUri: ?*IOpcPartUri, page: ?*?*IXpsOMPage1) callconv(.Inline) HRESULT {
...
pub const IXpsOMPackage1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsOMPackage1_WriteToFile1(self: *const T, fileName: ?[*:0]align(1) const u16, securityAttributes: ?*SECURITY_ATTRIBUTES, flagsAndAttributes: u32, optimizeMarkupSize: BOOL, documentType: XPS_DOCUMENT_TYPE) callconv(.Inline) HRESULT {
...
pub const XPS_SIGN_POLICY = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        NONE: u1 = 0,
        CORE_PROPERTIES: u1 = 0,
        SIGNATURE_RELATIONSHIPS: u1 = 0,
        PRINT_TICKET: u1 = 0,
        DISCARD_CONTROL: u1 = 0,
        ALL: u1 = 0,
    }) XPS_SIGN_POLICY {
        return @as(XPS_SIGN_POLICY, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(XPS_SIGN_POLICY.NONE) else 0)
            | (if (o.CORE_PROPERTIES == 1) @intFromEnum(XPS_SIGN_POLICY.CORE_PROPERTIES) else 0)
            | (if (o.SIGNATURE_RELATIONSHIPS == 1) @intFromEnum(XPS_SIGN_POLICY.SIGNATURE_RELATIONSHIPS) else 0)
            | (if (o.PRINT_TICKET == 1) @intFromEnum(XPS_SIGN_POLICY.PRINT_TICKET) else 0)
            | (if (o.DISCARD_CONTROL == 1) @intFromEnum(XPS_SIGN_POLICY.DISCARD_CONTROL) else 0)
            | (if (o.ALL == 1) @intFromEnum(XPS_SIGN_POLICY.ALL) else 0)
        ));
    }
};
...
pub const XPS_SIGN_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        NONE: u1 = 0,
        IGNORE_MARKUP_COMPATIBILITY: u1 = 0,
    }) XPS_SIGN_FLAGS {
        return @as(XPS_SIGN_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(XPS_SIGN_FLAGS.NONE) else 0)
            | (if (o.IGNORE_MARKUP_COMPATIBILITY == 1) @intFromEnum(XPS_SIGN_FLAGS.IGNORE_MARKUP_COMPATIBILITY) else 0)
        ));
    }
};
...
pub const IXpsSigningOptions = extern struct {
    pub const VTable = extern struct {
        ...
        SetSignatureId: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsSigningOptions,
                signatureId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsSigningOptions,
                signatureId: ?[*:0]align(1) const u16,
        ...
        SetSignatureMethod: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsSigningOptions,
                signatureMethod: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsSigningOptions,
                signatureMethod: ?[*:0]align(1) const u16,
        ...
        SetDigestMethod: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsSigningOptions,
                digestMethod: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsSigningOptions,
                digestMethod: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSigningOptions_SetSignatureId(self: *const T, signatureId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSigningOptions_SetSignatureMethod(self: *const T, signatureMethod: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSigningOptions_SetDigestMethod(self: *const T, digestMethod: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsSignatureBlock = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureBlock_CreateRequest(self: *const T, requestId: ?[*:0]align(1) const u16, signatureRequest: ?*?*IXpsSignatureRequest) callconv(.Inline) HRESULT {
...
pub const IXpsSignatureRequest = extern struct {
    pub const VTable = extern struct {
        ...
        SetRequestedSigner: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsSignatureRequest,
                signerName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsSignatureRequest,
                signerName: ?[*:0]align(1) const u16,
        ...
        SetRequestSignByDate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXpsSignatureRequest,
                dateString: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXpsSignatureRequest,
                dateString: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureRequest_SetIntent(self: *const T, intent: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureRequest_SetRequestedSigner(self: *const T, signerName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureRequest_SetRequestSignByDate(self: *const T, dateString: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureRequest_SetSigningLocale(self: *const T, place: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IXpsSignatureManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureManager_LoadPackageFile(self: *const T, fileName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsSignatureManager_SavePackageToFile(self: *const T, fileName: ?[*:0]align(1) const u16, securityAttributes: ?*SECURITY_ATTRIBUTES, flagsAndAttributes: u32) callconv(.Inline) HRESULT {
...
pub extern "winspool" fn DeviceCapabilitiesA(
    pDevice: ?[*:0]align(1) const u8,
    pPort: ?[*:0]align(1) const u8,
...
pub extern "winspool" fn DeviceCapabilitiesW(
    pDevice: ?[*:0]align(1) const u16,
    pPort: ?[*:0]align(1) const u16,
    fwCapability: PRINTER_DEVICE_CAPABILITIES,
    pOutput: ?PWSTR,
...
const IOpcCertificateEnumerator = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcCertificateEnumerator;
const IOpcCertificateSet = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcCertificateSet;
const IOpcPartUri = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcPartUri;
const IOpcSignatureCustomObjectEnumerator = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcSignatureCustomObjectEnumerator;
const IOpcSignatureCustomObjectSet = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcSignatureCustomObjectSet;
const IOpcSignatureReferenceEnumerator = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcSignatureReferenceEnumerator;
const IOpcSignatureReferenceSet = @import("../../../windows/win32/storage/packaging/opc.zig").IOpcSignatureReferenceSet;
...
const OPC_SIGNATURE_TIME_FORMAT = @import("../../../windows/win32/storage/packaging/opc.zig").OPC_SIGNATURE_TIME_FORMAT;
