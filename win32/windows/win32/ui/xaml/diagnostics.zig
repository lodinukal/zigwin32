...
pub const IVisualTreeServiceCallback2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVisualTreeServiceCallback2_OnElementStateChanged(self: *const T, element: u64, elementState: VisualElementState, context: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IVisualTreeService2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVisualTreeService2_GetPropertyIndex(self: *const T, object: u64, propertyName: ?[*:0]align(1) const u16, pPropertyIndex: ?*u32) callconv(.Inline) HRESULT {
...
pub const IVisualTreeService3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVisualTreeService3_ResolveResource(self: *const T, resourceContext: u64, resourceName: ?[*:0]align(1) const u16, resourceType: ResourceType, propertyIndex: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVisualTreeService3_GetDictionaryItem(self: *const T, dictionaryHandle: u64, resourceName: ?[*:0]align(1) const u16, resourceIsImplicitStyle: BOOL, resourceHandle: ?*u64) callconv(.Inline) HRESULT {
...
pub extern "windows.ui.xaml" fn InitializeXamlDiagnostic(
    ...
    pid: u32,
    wszDllXamlDiagnostics: ?[*:0]align(1) const u16,
    wszTAPDllName: ?[*:0]align(1) const u16,
    tapClsid: Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "windows.ui.xaml" fn InitializeXamlDiagnosticsEx(
    ...
    wszTAPDllName: ?[*:0]align(1) const u16,
    tapClsid: Guid,
    wszInitializationData: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
