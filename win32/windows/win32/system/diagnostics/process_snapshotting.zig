...
pub const PSS_HANDLE_FLAGS = enum(i32) {
    NONE = 0,
    HAVE_TYPE = 1,
    HAVE_NAME = 2,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PSS_HANDLE_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(PSS_HANDLE_FLAGS.NONE) else 0)
            | (if (o.HAVE_TYPE == 1) @intFromEnum(PSS_HANDLE_FLAGS.HAVE_TYPE) else 0)
            | (if (o.HAVE_NAME == 1) @intFromEnum(PSS_HANDLE_FLAGS.HAVE_NAME) else 0)
            | (if (o.HAVE_BASIC_INFORMATION == 1) @intFromEnum(PSS_HANDLE_FLAGS.HAVE_BASIC_INFORMATION) else 0)
            | (if (o.HAVE_TYPE_SPECIFIC_INFORMATION == 1) @intFromEnum(PSS_HANDLE_FLAGS.HAVE_TYPE_SPECIFIC_INFORMATION) else 0)
        ));
    }
};
...
pub const PSS_CAPTURE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PSS_CAPTURE_FLAGS, @enumFromInt(
              (if (o.APTURE_NONE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_NONE) else 0)
            | (if (o.APTURE_VA_CLONE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_VA_CLONE) else 0)
            | (if (o.APTURE_RESERVED_00000002 == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_RESERVED_00000002) else 0)
            | (if (o.APTURE_HANDLES == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_HANDLES) else 0)
            | (if (o.APTURE_HANDLE_NAME_INFORMATION == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_HANDLE_NAME_INFORMATION) else 0)
            | (if (o.APTURE_HANDLE_BASIC_INFORMATION == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_HANDLE_BASIC_INFORMATION) else 0)
            | (if (o.APTURE_HANDLE_TYPE_SPECIFIC_INFORMATION == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_HANDLE_TYPE_SPECIFIC_INFORMATION) else 0)
            | (if (o.APTURE_HANDLE_TRACE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_HANDLE_TRACE) else 0)
            | (if (o.APTURE_THREADS == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_THREADS) else 0)
            | (if (o.APTURE_THREAD_CONTEXT == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_THREAD_CONTEXT) else 0)
            | (if (o.APTURE_THREAD_CONTEXT_EXTENDED == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_THREAD_CONTEXT_EXTENDED) else 0)
            | (if (o.APTURE_RESERVED_00000400 == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_RESERVED_00000400) else 0)
            | (if (o.APTURE_VA_SPACE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_VA_SPACE) else 0)
            | (if (o.APTURE_VA_SPACE_SECTION_INFORMATION == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_VA_SPACE_SECTION_INFORMATION) else 0)
            | (if (o.APTURE_IPT_TRACE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_IPT_TRACE) else 0)
            | (if (o.APTURE_RESERVED_00004000 == 1) @intFromEnum(PSS_CAPTURE_FLAGS.APTURE_RESERVED_00004000) else 0)
            | (if (o.REATE_BREAKAWAY_OPTIONAL == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_BREAKAWAY_OPTIONAL) else 0)
            | (if (o.REATE_BREAKAWAY == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_BREAKAWAY) else 0)
            | (if (o.REATE_FORCE_BREAKAWAY == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_FORCE_BREAKAWAY) else 0)
            | (if (o.REATE_USE_VM_ALLOCATIONS == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_USE_VM_ALLOCATIONS) else 0)
            | (if (o.REATE_MEASURE_PERFORMANCE == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_MEASURE_PERFORMANCE) else 0)
            | (if (o.REATE_RELEASE_SECTION == 1) @intFromEnum(PSS_CAPTURE_FLAGS.REATE_RELEASE_SECTION) else 0)
        ));
    }
};
...
pub const PSS_DUPLICATE_FLAGS = enum(i32) {
    NONE = 0,
    CLOSE_SOURCE = 1,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(PSS_DUPLICATE_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(PSS_DUPLICATE_FLAGS.NONE) else 0)
            | (if (o.CLOSE_SOURCE == 1) @intFromEnum(PSS_DUPLICATE_FLAGS.CLOSE_SOURCE) else 0)
        ));
    }
};
...
pub const PSS_PROCESS_FLAGS = enum(i32) {
    NONE = 0,
    PROTECTED = 1,
    WOW64 = 2,
    RESERVED_03 = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PSS_PROCESS_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(PSS_PROCESS_FLAGS.NONE) else 0)
            | (if (o.PROTECTED == 1) @intFromEnum(PSS_PROCESS_FLAGS.PROTECTED) else 0)
            | (if (o.WOW64 == 1) @intFromEnum(PSS_PROCESS_FLAGS.WOW64) else 0)
            | (if (o.RESERVED_03 == 1) @intFromEnum(PSS_PROCESS_FLAGS.RESERVED_03) else 0)
            | (if (o.RESERVED_04 == 1) @intFromEnum(PSS_PROCESS_FLAGS.RESERVED_04) else 0)
            | (if (o.FROZEN == 1) @intFromEnum(PSS_PROCESS_FLAGS.FROZEN) else 0)
        ));
    }
};
...
pub const PSS_VA_SPACE_ENTRY = extern struct {
    ...
    MappedFileName: ?[*:0]align(1) const u16,
};
...
pub const PSS_THREAD_FLAGS = enum(i32) {
    NONE = 0,
    TERMINATED = 1,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(PSS_THREAD_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(PSS_THREAD_FLAGS.NONE) else 0)
            | (if (o.TERMINATED == 1) @intFromEnum(PSS_THREAD_FLAGS.TERMINATED) else 0)
        ));
    }
};
...
const MEMORY_BASIC_INFORMATION = @import("../../../../windows/win32/system/memory.zig").MEMORY_BASIC_INFORMATION;
