...
pub const USER_OBJECT_INFORMATION_INDEX = enum(i32) {
    FLAGS = 1,
    HEAPSIZE = 5,
    IO = 6,
    NAME = 2,
...
pub extern "user32" fn CreateDesktopA(
    lpszDesktop: ?[*:0]align(1) const u8,
    lpszDevice: ?[*:0]align(1) const u8,
    pDevmode: ?*DEVMODEA,
...
pub extern "user32" fn CreateDesktopW(
    lpszDesktop: ?[*:0]align(1) const u16,
    lpszDevice: ?[*:0]align(1) const u16,
    pDevmode: ?*DEVMODEW,
    dwFlags: DESKTOP_CONTROL_FLAGS,
    dwDesiredAccess: u32,
    lpsa: ?*SECURITY_ATTRIBUTES,
...
pub extern "user32" fn OpenWindowStationW(
    lpszWinSta: ?[*:0]align(1) const u16,
    fInherit: BOOL,
    dwDesiredAccess: u32,
) callconv(@import("std").os.windows.WINAPI) ?HWINSTA;
...
const WNDENUMPROC = @import("../../../windows/win32/ui/windows_and_messaging.zig").WNDENUMPROC;
