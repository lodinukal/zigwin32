...
pub const IWiaPropertyStorage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWiaPropertyStorage_WritePropertyNames(self: *const T, cpropid: u32, rgpropid: [*]const u32, rglpwstrName: [*]const ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWiaItemExtras = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWiaItemExtras_Escape(self: *const T, dwEscapeCode: u32, lpInData: [*:0]u8, cbInDataSize: u32, pOutData: [*:0]u8, dwOutDataSize: u32, pdwActualDataSize: ?*u32) callconv(.Inline) HRESULT {
...
const IEnumSTATPROPSTG = @import("../../../windows/win32/system/com/structured_storage.zig").IEnumSTATPROPSTG;
...
const STATPROPSETSTG = @import("../../../windows/win32/system/com/structured_storage.zig").STATPROPSETSTG;
