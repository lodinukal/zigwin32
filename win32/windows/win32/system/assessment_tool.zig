...
pub const IWinSATInitiateEvents = extern struct {
    pub const VTable = extern struct {
        ...
        WinSATComplete: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                hresult: HRESULT,
                strDescription: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWinSATInitiateEvents,
                hresult: HRESULT,
        ...
        WinSATUpdate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                uCurrentTick: u32,
                uTickTotal: u32,
                strCurrentState: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWinSATInitiateEvents,
                uCurrentTick: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinSATInitiateEvents_WinSATComplete(self: *const T, hresult: HRESULT, strDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinSATInitiateEvents_WinSATUpdate(self: *const T, uCurrentTick: u32, uTickTotal: u32, strCurrentState: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IInitiateWinSATAssessment = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInitiateWinSATAssessment_InitiateAssessment(self: *const T, cmdLine: ?[*:0]align(1) const u16, pCallbacks: ?*IWinSATInitiateEvents, callerHwnd: ?HWND) callconv(.Inline) HRESULT {
...
pub const IAccessibleWinSAT = extern struct {
    pub const VTable = extern struct {
        ...
        SetAccessiblityData: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wsName: ?[*:0]align(1) const u16,
                wsValue: ?[*:0]align(1) const u16,
                wsDesc: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IAccessibleWinSAT,
                wsName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAccessibleWinSAT_SetAccessiblityData(self: *const T, wsName: ?[*:0]align(1) const u16, wsValue: ?[*:0]align(1) const u16, wsDesc: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IQueryOEMWinSATCustomization = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IQueryOEMWinSATCustomization_GetOEMPrePopulationInfo(self: *const T, state: ?*WINSAT_OEM_CUSTOMIZATION_STATE) callconv(.Inline) HRESULT {
...
const IAccessible = @import("../../../windows/win32/ui/accessibility.zig").IAccessible;
