...
// Section: Constants (1)
//--------------------------------------------------------------------------------
pub const WDAG_CLIPBOARD_TAG = "CrossIsolatedEnvironmentContent";
...
pub const IIsolatedAppLauncher = extern struct {
    pub const VTable = extern struct {
        ...
        Launch: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                appUserModelId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IIsolatedAppLauncher_Launch(self: *const T, appUserModelId: ?[*:0]align(1) const u16, arguments: ?[*:0]align(1) const u16, telemetryParameters: ?*const IsolatedAppLauncherTelemetryParameters) callconv(.Inline) HRESULT {
...
pub extern "isolatedwindowsenvironmentutils" fn IsCrossIsolatedEnvironmentClipboardContent(
    isCrossIsolatedEnvironmentClipboardContent: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.0'
pub extern "userenv" fn CreateAppContainerProfile(
    pszAppContainerName: ?[*:0]align(1) const u16,
...
pub extern "userenv" fn GetAppContainerFolderPath(
    pszAppContainerSid: ?[*:0]align(1) const u16,
    ppszPath: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "userenv" fn DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName(
    ...
    pszRestrictedAppContainerName: ?[*:0]align(1) const u16,
