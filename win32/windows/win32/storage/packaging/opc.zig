...
pub const OPC_READ_FLAGS = enum(i32) {
    READ_DEFAULT = 0,
    VALIDATE_ON_LOAD = 1,
    CACHE_ON_ACCESS = 2,
    _,
...
pub const OPC_WRITE_FLAGS = enum(i32) {
    DEFAULT = 0,
    FORCE_ZIP32 = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const IOpcPartSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcPartSet_CreatePart(self: *const T, name: ?*IOpcPartUri, contentType: ?[*:0]align(1) const u16, compressionOptions: OPC_COMPRESSION_OPTIONS, part: ?*?*IOpcPart) callconv(.Inline) HRESULT {
...
pub const IOpcRelationshipSet = extern struct {
    pub const VTable = extern struct {
        ...
        GetRelationship: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                relationshipIdentifier: ?[*:0]align(1) const u16,
        ...
        CreateRelationship: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IOpcRelationshipSet,
                relationshipIdentifier: ?[*:0]align(1) const u16,
                relationshipType: ?[*:0]align(1) const u16,
                targetUri: ?*IUri,
                targetMode: OPC_URI_TARGET_MODE,
                relationship: ?*?*IOpcRelationship,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSet_GetRelationship(self: *const T, relationshipIdentifier: ?[*:0]align(1) const u16, relationship: ?*?*IOpcRelationship) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSet_CreateRelationship(self: *const T, relationshipIdentifier: ?[*:0]align(1) const u16, relationshipType: ?[*:0]align(1) const u16, targetUri: ?*IUri, targetMode: OPC_URI_TARGET_MODE, relationship: ?*?*IOpcRelationship) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSet_DeleteRelationship(self: *const T, relationshipIdentifier: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSet_RelationshipExists(self: *const T, relationshipIdentifier: ?[*:0]align(1) const u16, relationshipExists: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSet_GetEnumeratorForType(self: *const T, relationshipType: ?[*:0]align(1) const u16, relationshipEnumerator: ?*?*IOpcRelationshipEnumerator) callconv(.Inline) HRESULT {
...
pub const IOpcSigningOptions = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcSigningOptions_SetSignatureId(self: *const T, signatureId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcSigningOptions_SetSignatureMethod(self: *const T, signatureMethod: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcSigningOptions_SetDefaultDigestMethod(self: *const T, digestMethod: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOpcDigitalSignatureManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcDigitalSignatureManager_ReplaceSignatureXml(self: *const T, signaturePartName: ?*IOpcPartUri, newSignatureXml: [*:0]const u8, count: u32, digitalSignature: ?*?*IOpcDigitalSignature) callconv(.Inline) HRESULT {
...
pub const IOpcSignaturePartReferenceSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcSignaturePartReferenceSet_Create(self: *const T, partUri: ?*IOpcPartUri, digestMethod: ?[*:0]align(1) const u16, transformMethod: OPC_CANONICALIZATION_METHOD, partReference: ?*?*IOpcSignaturePartReference) callconv(.Inline) HRESULT {
...
pub const IOpcRelationshipSelectorSet = extern struct {
    pub const VTable = extern struct {
        ...
        Create: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                selector: OPC_RELATIONSHIP_SELECTOR,
                selectionCriterion: ?[*:0]align(1) const u16,
                relationshipSelector: ?*?*IOpcRelationshipSelector,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IOpcRelationshipSelectorSet,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcRelationshipSelectorSet_Create(self: *const T, selector: OPC_RELATIONSHIP_SELECTOR, selectionCriterion: ?[*:0]align(1) const u16, relationshipSelector: ?*?*IOpcRelationshipSelector) callconv(.Inline) HRESULT {
...
pub const IOpcSignatureReferenceSet = extern struct {
    pub const VTable = extern struct {
        ...
        Create: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                referenceUri: ?*IUri,
                referenceId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcSignatureReferenceSet_Create(self: *const T, referenceUri: ?*IUri, referenceId: ?[*:0]align(1) const u16, type_: ?[*:0]align(1) const u16, digestMethod: ?[*:0]align(1) const u16, transformMethod: OPC_CANONICALIZATION_METHOD, reference: ?*?*IOpcSignatureReference) callconv(.Inline) HRESULT {
...
pub const IOpcFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcFactory_CreatePartUri(self: *const T, pwzUri: ?[*:0]align(1) const u16, partUri: ?*?*IOpcPartUri) callconv(.Inline) HRESULT {
            return @as(*const IOpcFactory.VTable, @ptrCast(self.vtable)).CreatePartUri(@as(*const IOpcFactory, @ptrCast(self)), pwzUri, partUri);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcFactory_CreateStreamOnFile(self: *const T, filename: ?[*:0]align(1) const u16, ioMode: OPC_STREAM_IO_MODE, securityAttributes: ?*SECURITY_ATTRIBUTES, dwFlagsAndAttributes: u32, stream: ?*?*IStream) callconv(.Inline) HRESULT {
