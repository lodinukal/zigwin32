...
pub const NLM_DOMAIN_AUTHENTICATION_KIND = enum(i32) {
    NONE = 0,
    LDAP = 1,
    TLS = 2,
};
pub const NLM_DOMAIN_AUTHENTICATION_KIND_NONE = NLM_DOMAIN_AUTHENTICATION_KIND.NONE;
pub const NLM_DOMAIN_AUTHENTICATION_KIND_LDAP = NLM_DOMAIN_AUTHENTICATION_KIND.LDAP;
pub const NLM_DOMAIN_AUTHENTICATION_KIND_TLS = NLM_DOMAIN_AUTHENTICATION_KIND.TLS;
...
pub const INetworkListManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkListManager_get_IsConnectedToInternet(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkListManager_get_IsConnected(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const INetwork = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetwork_get_IsConnectedToInternet(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetwork_get_IsConnected(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IID_INetwork2_Value = Guid.initString("b5550abb-3391-4310-804f-25dcc325ed81");
pub const IID_INetwork2 = &IID_INetwork2_Value;
pub const INetwork2 = extern struct {
    pub const VTable = extern struct {
        base: INetwork.VTable,
        IsDomainAuthenticatedBy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetwork2,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace INetwork.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetwork2_IsDomainAuthenticatedBy(self: *const T, domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND, pValue: ?*BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetwork2.VTable, @ptrCast(self.vtable)).IsDomainAuthenticatedBy(@as(*const INetwork2, @ptrCast(self)), domainAuthenticationKind, pValue);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const INetworkConnection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkConnection_get_IsConnectedToInternet(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkConnection_get_IsConnected(self: *const T, pbIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IID_INetworkConnection2_Value = Guid.initString("00e676ed-5a35-4738-92eb-8581738d0f0a");
pub const IID_INetworkConnection2 = &IID_INetworkConnection2_Value;
pub const INetworkConnection2 = extern struct {
    pub const VTable = extern struct {
        base: INetworkConnection.VTable,
        IsDomainAuthenticatedBy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetworkConnection2,
                domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND,
                pValue: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace INetworkConnection.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkConnection2_IsDomainAuthenticatedBy(self: *const T, domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND, pValue: ?*BOOL) callconv(.Inline) HRESULT {
            return @as(*const INetworkConnection2.VTable, @ptrCast(self.vtable)).IsDomainAuthenticatedBy(@as(*const INetworkConnection2, @ptrCast(self)), domainAuthenticationKind, pValue);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const INetworkCostManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetworkCostManager_SetDestinationAddresses(self: *const T, length: u32, pDestIPAddrList: [*]NLM_SOCKADDR, bAppend: VARIANT_BOOL) callconv(.Inline) HRESULT {
