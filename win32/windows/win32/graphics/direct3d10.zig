...
pub const ID3D10Device = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Device_OMSetBlendState(self: *const T, pBlendState: ?*ID3D10BlendState, BlendFactor: *[4]f32, SampleMask: u32) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Device_ClearRenderTargetView(self: *const T, pRenderTargetView: ?*ID3D10RenderTargetView, ColorRGBA: *[4]f32) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Device_OMGetBlendState(self: *const T, ppBlendState: ?*?*ID3D10BlendState, BlendFactor: ?*[4]f32, pSampleMask: ?*u32) callconv(.Inline) void {
...
pub const ID3D10InfoQueue = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10InfoQueue_AddMessage(self: *const T, Category: D3D10_MESSAGE_CATEGORY, Severity: D3D10_MESSAGE_SEVERITY, ID: D3D10_MESSAGE_ID, pDescription: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10InfoQueue_AddApplicationMessage(self: *const T, Severity: D3D10_MESSAGE_SEVERITY, pDescription: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
...
pub const ID3D10ShaderReflectionType = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflectionType_GetMemberTypeByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10ShaderReflectionType {
...
pub const ID3D10ShaderReflectionConstantBuffer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflectionConstantBuffer_GetVariableByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10ShaderReflectionVariable {
...
pub const ID3D10ShaderReflection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflection_GetConstantBufferByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10ShaderReflectionConstantBuffer {
...
pub const ID3D10EffectType = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectType_GetMemberTypeByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectType {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectType_GetMemberTypeBySemantic(self: *const T, Semantic: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectType {
...
pub const ID3D10EffectVariable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectVariable_GetAnnotationByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectVariable_GetMemberByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectVariable_GetMemberBySemantic(self: *const T, Semantic: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
...
pub const ID3D10EffectStringVariable = extern struct {
    pub const VTable = extern struct {
        ...
        GetStringArray: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ID3D10EffectStringVariable,
                ppStrings: [*]const ?[*:0]align(1) const u8,
                Offset: u32,
                Count: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace ID3D10EffectVariable.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectStringVariable_GetString(self: *const T, ppString: ?*const ?PSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectStringVariable_GetStringArray(self: *const T, ppStrings: [*]const ?[*:0]align(1) const u8, Offset: u32, Count: u32) callconv(.Inline) HRESULT {
...
pub const ID3D10EffectPass = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectPass_GetAnnotationByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
...
pub const ID3D10EffectTechnique = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectTechnique_GetAnnotationByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10EffectTechnique_GetPassByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectPass {
...
pub const ID3D10Effect = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Effect_GetConstantBufferByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectConstantBuffer {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Effect_GetVariableByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
            return @as(*const ID3D10Effect.VTable, @ptrCast(self.vtable)).GetVariableByName(@as(*const ID3D10Effect, @ptrCast(self)), Name);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Effect_GetVariableBySemantic(self: *const T, Semantic: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectVariable {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10Effect_GetTechniqueByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10EffectTechnique {
...
pub const ID3D10ShaderReflection1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflection1_GetConstantBufferByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10ShaderReflectionConstantBuffer {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflection1_GetVariableByName(self: *const T, Name: ?[*:0]align(1) const u8) callconv(.Inline) ?*ID3D10ShaderReflectionVariable {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID3D10ShaderReflection1_GetResourceBindingDescByName(self: *const T, Name: ?[*:0]align(1) const u8, pDesc: ?*D3D10_SHADER_INPUT_BIND_DESC) callconv(.Inline) HRESULT {
...
pub extern "d3d10" fn D3D10CompileShader(
    // TODO: what to do with BytesParamIndex 1?
    pSrcData: ?[*:0]align(1) const u8,
    SrcDataSize: usize,
    pFileName: ?[*:0]align(1) const u8,
    pDefines: ?*const D3D_SHADER_MACRO,
    pInclude: ?*ID3DInclude,
    pFunctionName: ?[*:0]align(1) const u8,
    pProfile: ?[*:0]align(1) const u8,
    Flags: u32,
    ppShader: ?*?*ID3DBlob,
...
pub extern "d3d10" fn D3D10CompileEffectFromMemory(
    ...
    pData: ?*anyopaque,
    DataLength: usize,
    pSrcFileName: ?[*:0]align(1) const u8,
    pDefines: ?*const D3D_SHADER_MACRO,
    pInclude: ?*ID3DInclude,
    HLSLFlags: u32,
    FXFlags: u32,
...
const D3D_SHADER_MACRO = @import("../../../windows/win32/graphics/direct3d.zig").D3D_SHADER_MACRO;
...
const DXGI_SWAP_CHAIN_DESC = @import("../../../windows/win32/graphics/dxgi.zig").DXGI_SWAP_CHAIN_DESC;
...
const ID3DInclude = @import("../../../windows/win32/graphics/direct3d.zig").ID3DInclude;
const IDXGIAdapter = @import("../../../windows/win32/graphics/dxgi.zig").IDXGIAdapter;
const IDXGISwapChain = @import("../../../windows/win32/graphics/dxgi.zig").IDXGISwapChain;
