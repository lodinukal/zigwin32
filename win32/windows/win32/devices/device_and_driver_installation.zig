...
pub const GUID_DEVCLASS_GENERIC = Guid.initString("ff494df1-c4ed-4fac-9b3f-3786f6e91e7e");
...
pub const GUID_DEVCLASS_PRIMITIVE = Guid.initString("242681d1-eed3-41d2-a1ef-1468fc843106");
...
pub const SZ_KEY_FAILUREACTIONS = "FailureActions";
...
pub const INFSTR_KEY_RESET_PERIOD = "ResetPeriod";
pub const INFSTR_KEY_NON_CRASH_FAILURES = "NonCrashFailures";
pub const INFSTR_KEY_FAILURE_ACTION = "Action";
...
pub const SP_COPY_STYLE = enum(u32) {
    ...
    REPLACEONLY = 2,
    NEWER = 4,
    // NEWER_OR_SAME = 4, this enum value conflicts with NEWER
    NOOVERWRITE = 8,
    NODECOMP = 16,
    LANGUAGEAWARE = 32,
    SOURCE_ABSOLUTE = 64,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SP_COPY_STYLE, @enumFromInt(
              (if (o.DELETESOURCE == 1) @intFromEnum(SP_COPY_STYLE.DELETESOURCE) else 0)
            | (if (o.REPLACEONLY == 1) @intFromEnum(SP_COPY_STYLE.REPLACEONLY) else 0)
            | (if (o.NEWER == 1) @intFromEnum(SP_COPY_STYLE.NEWER) else 0)
            | (if (o.NOOVERWRITE == 1) @intFromEnum(SP_COPY_STYLE.NOOVERWRITE) else 0)
            | (if (o.NODECOMP == 1) @intFromEnum(SP_COPY_STYLE.NODECOMP) else 0)
            | (if (o.LANGUAGEAWARE == 1) @intFromEnum(SP_COPY_STYLE.LANGUAGEAWARE) else 0)
            | (if (o.SOURCE_ABSOLUTE == 1) @intFromEnum(SP_COPY_STYLE.SOURCE_ABSOLUTE) else 0)
            | (if (o.SOURCEPATH_ABSOLUTE == 1) @intFromEnum(SP_COPY_STYLE.SOURCEPATH_ABSOLUTE) else 0)
            | (if (o.IN_USE_NEEDS_REBOOT == 1) @intFromEnum(SP_COPY_STYLE.IN_USE_NEEDS_REBOOT) else 0)
            | (if (o.FORCE_IN_USE == 1) @intFromEnum(SP_COPY_STYLE.FORCE_IN_USE) else 0)
            | (if (o.NOSKIP == 1) @intFromEnum(SP_COPY_STYLE.NOSKIP) else 0)
            | (if (o.FORCE_NOOVERWRITE == 1) @intFromEnum(SP_COPY_STYLE.FORCE_NOOVERWRITE) else 0)
            | (if (o.FORCE_NEWER == 1) @intFromEnum(SP_COPY_STYLE.FORCE_NEWER) else 0)
            | (if (o.WARNIFSKIP == 1) @intFromEnum(SP_COPY_STYLE.WARNIFSKIP) else 0)
            | (if (o.NOBROWSE == 1) @intFromEnum(SP_COPY_STYLE.NOBROWSE) else 0)
            | (if (o.NEWER_ONLY == 1) @intFromEnum(SP_COPY_STYLE.NEWER_ONLY) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(SP_COPY_STYLE.RESERVED) else 0)
            | (if (o.OEMINF_CATALOG_ONLY == 1) @intFromEnum(SP_COPY_STYLE.OEMINF_CATALOG_ONLY) else 0)
            | (if (o.REPLACE_BOOT_FILE == 1) @intFromEnum(SP_COPY_STYLE.REPLACE_BOOT_FILE) else 0)
            | (if (o.NOPRUNE == 1) @intFromEnum(SP_COPY_STYLE.NOPRUNE) else 0)
            | (if (o.OEM_F6_INF == 1) @intFromEnum(SP_COPY_STYLE.OEM_F6_INF) else 0)
            | (if (o.ALREADYDECOMP == 1) @intFromEnum(SP_COPY_STYLE.ALREADYDECOMP) else 0)
            | (if (o.WINDOWS_SIGNED == 1) @intFromEnum(SP_COPY_STYLE.WINDOWS_SIGNED) else 0)
            | (if (o.PNPLOCKED == 1) @intFromEnum(SP_COPY_STYLE.PNPLOCKED) else 0)
            | (if (o.IN_USE_TRY_RENAME == 1) @intFromEnum(SP_COPY_STYLE.IN_USE_TRY_RENAME) else 0)
            | (if (o.INBOX_INF == 1) @intFromEnum(SP_COPY_STYLE.INBOX_INF) else 0)
            | (if (o.HARDLINK == 1) @intFromEnum(SP_COPY_STYLE.HARDLINK) else 0)
        ));
    }
};
...
pub const SP_COPY_NEWER_OR_SAME = SP_COPY_STYLE.NEWER;
...
pub const DIINSTALLDEVICE_FLAGS = enum(u32) {
    SHOWSEARCHUI = 1,
    NOFINISHINSTALLUI = 2,
    INSTALLNULLDRIVER = 4,
    INSTALLCOPYINFDRIVERS = 8,
    BITS = 15,
    _,
    pub fn initFlags(o: struct {
        SHOWSEARCHUI: u1 = 0,
        NOFINISHINSTALLUI: u1 = 0,
        INSTALLNULLDRIVER: u1 = 0,
        INSTALLCOPYINFDRIVERS: u1 = 0,
        BITS: u1 = 0,
    }) DIINSTALLDEVICE_FLAGS {
        return @as(DIINSTALLDEVICE_FLAGS, @enumFromInt(
              (if (o.SHOWSEARCHUI == 1) @intFromEnum(DIINSTALLDEVICE_FLAGS.SHOWSEARCHUI) else 0)
            | (if (o.NOFINISHINSTALLUI == 1) @intFromEnum(DIINSTALLDEVICE_FLAGS.NOFINISHINSTALLUI) else 0)
            | (if (o.INSTALLNULLDRIVER == 1) @intFromEnum(DIINSTALLDEVICE_FLAGS.INSTALLNULLDRIVER) else 0)
            | (if (o.INSTALLCOPYINFDRIVERS == 1) @intFromEnum(DIINSTALLDEVICE_FLAGS.INSTALLCOPYINFDRIVERS) else 0)
            | (if (o.BITS == 1) @intFromEnum(DIINSTALLDEVICE_FLAGS.BITS) else 0)
        ));
    }
};
pub const DIIDFLAG_SHOWSEARCHUI = DIINSTALLDEVICE_FLAGS.SHOWSEARCHUI;
pub const DIIDFLAG_NOFINISHINSTALLUI = DIINSTALLDEVICE_FLAGS.NOFINISHINSTALLUI;
pub const DIIDFLAG_INSTALLNULLDRIVER = DIINSTALLDEVICE_FLAGS.INSTALLNULLDRIVER;
pub const DIIDFLAG_INSTALLCOPYINFDRIVERS = DIINSTALLDEVICE_FLAGS.INSTALLCOPYINFDRIVERS;
pub const DIIDFLAG_BITS = DIINSTALLDEVICE_FLAGS.BITS;

pub const DIINSTALLDRIVER_FLAGS = enum(u32) {
    BITS = 106,
    SYSTEM_BITS = 127,
    INF_ALREADY_COPIED = 1,
    FORCE_INF = 2,
    HW_USING_THE_INF = 4,
    HOTPATCH = 8,
    NOBACKUP = 16,
    PRE_CONFIGURE_INF = 32,
    INSTALL_AS_SET = 64,
    _,
    pub fn initFlags(o: struct {
        BITS: u1 = 0,
        SYSTEM_BITS: u1 = 0,
        INF_ALREADY_COPIED: u1 = 0,
        FORCE_INF: u1 = 0,
        HW_USING_THE_INF: u1 = 0,
        HOTPATCH: u1 = 0,
        NOBACKUP: u1 = 0,
        PRE_CONFIGURE_INF: u1 = 0,
        INSTALL_AS_SET: u1 = 0,
    }) DIINSTALLDRIVER_FLAGS {
        return @as(DIINSTALLDRIVER_FLAGS, @enumFromInt(
              (if (o.BITS == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.BITS) else 0)
            | (if (o.SYSTEM_BITS == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.SYSTEM_BITS) else 0)
            | (if (o.INF_ALREADY_COPIED == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.INF_ALREADY_COPIED) else 0)
            | (if (o.FORCE_INF == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.FORCE_INF) else 0)
            | (if (o.HW_USING_THE_INF == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.HW_USING_THE_INF) else 0)
            | (if (o.HOTPATCH == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.HOTPATCH) else 0)
            | (if (o.NOBACKUP == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.NOBACKUP) else 0)
            | (if (o.PRE_CONFIGURE_INF == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.PRE_CONFIGURE_INF) else 0)
            | (if (o.INSTALL_AS_SET == 1) @intFromEnum(DIINSTALLDRIVER_FLAGS.INSTALL_AS_SET) else 0)
        ));
    }
};
pub const DIIRFLAG_BITS = DIINSTALLDRIVER_FLAGS.BITS;
pub const DIIRFLAG_SYSTEM_BITS = DIINSTALLDRIVER_FLAGS.SYSTEM_BITS;
pub const DIIRFLAG_INF_ALREADY_COPIED = DIINSTALLDRIVER_FLAGS.INF_ALREADY_COPIED;
pub const DIIRFLAG_FORCE_INF = DIINSTALLDRIVER_FLAGS.FORCE_INF;
pub const DIIRFLAG_HW_USING_THE_INF = DIINSTALLDRIVER_FLAGS.HW_USING_THE_INF;
pub const DIIRFLAG_HOTPATCH = DIINSTALLDRIVER_FLAGS.HOTPATCH;
pub const DIIRFLAG_NOBACKUP = DIINSTALLDRIVER_FLAGS.NOBACKUP;
pub const DIIRFLAG_PRE_CONFIGURE_INF = DIINSTALLDRIVER_FLAGS.PRE_CONFIGURE_INF;
pub const DIIRFLAG_INSTALL_AS_SET = DIINSTALLDRIVER_FLAGS.INSTALL_AS_SET;

pub const DIUNINSTALLDRIVER_FLAGS = enum(u32) {
    VALID = 3,
    NO_REMOVE_INF = 1,
    RESERVED = 2,
    _,
    pub fn initFlags(o: struct {
        ...
        NO_REMOVE_INF: u1 = 0,
        RESERVED: u1 = 0,
    }) DIUNINSTALLDRIVER_FLAGS {
        return @as(DIUNINSTALLDRIVER_FLAGS, @enumFromInt(
              (if (o.VALID == 1) @intFromEnum(DIUNINSTALLDRIVER_FLAGS.VALID) else 0)
            | (if (o.NO_REMOVE_INF == 1) @intFromEnum(DIUNINSTALLDRIVER_FLAGS.NO_REMOVE_INF) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(DIUNINSTALLDRIVER_FLAGS.RESERVED) else 0)
        ));
    }
};
pub const DIURFLAG_VALID = DIUNINSTALLDRIVER_FLAGS.VALID;
pub const DIURFLAG_NO_REMOVE_INF = DIUNINSTALLDRIVER_FLAGS.NO_REMOVE_INF;
pub const DIURFLAG_RESERVED = DIUNINSTALLDRIVER_FLAGS.RESERVED;

pub const DIROLLBACKDRIVER_FLAGS = enum(u32) {
    FLAG_NO_UI = 1,
    // BITS = 1, this enum value conflicts with FLAG_NO_UI
    _,
    pub fn initFlags(o: struct {
        FLAG_NO_UI: u1 = 0,
    }) DIROLLBACKDRIVER_FLAGS {
        return @as(DIROLLBACKDRIVER_FLAGS, @enumFromInt(
              (if (o.FLAG_NO_UI == 1) @intFromEnum(DIROLLBACKDRIVER_FLAGS.FLAG_NO_UI) else 0)
        ));
    }
};
pub const ROLLBACK_FLAG_NO_UI = DIROLLBACKDRIVER_FLAGS.FLAG_NO_UI;
pub const ROLLBACK_BITS = DIROLLBACKDRIVER_FLAGS.FLAG_NO_UI;

pub const UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS = enum(u32) {
    FORCE = 1,
    READONLY = 2,
    NONINTERACTIVE = 4,
    BITS = 7,
    ...
    pub fn initFlags(o: struct {
        ...
        NONINTERACTIVE: u1 = 0,
        BITS: u1 = 0,
    }) UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS {
        return @as(UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS, @enumFromInt(
              (if (o.FORCE == 1) @intFromEnum(UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.FORCE) else 0)
            | (if (o.READONLY == 1) @intFromEnum(UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.READONLY) else 0)
            | (if (o.NONINTERACTIVE == 1) @intFromEnum(UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.NONINTERACTIVE) else 0)
            | (if (o.BITS == 1) @intFromEnum(UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.BITS) else 0)
        ));
    }
};
pub const INSTALLFLAG_FORCE = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.FORCE;
pub const INSTALLFLAG_READONLY = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.READONLY;
pub const INSTALLFLAG_NONINTERACTIVE = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.NONINTERACTIVE;
pub const INSTALLFLAG_BITS = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS.BITS;

pub const CM_RESTYPE = enum(u32) {
    All = 0,
    // None = 0, this enum value conflicts with All
    Mem = 1,
    IO = 2,
    DMA = 3,
    IRQ = 4,
    ...
    BusNumber = 6,
    MemLarge = 7,
    // MAX = 7, this enum value conflicts with MemLarge
    Ignored_Bit = 32768,
    ClassSpecific = 65535,
    // Reserved = 32768, this enum value conflicts with Ignored_Bit
    DevicePrivate = 32769,
    PcCardConfig = 32770,
    MfCardConfig = 32771,
    Connection = 32772,
};
pub const ResType_All = CM_RESTYPE.All;
pub const ResType_None = CM_RESTYPE.All;
pub const ResType_Mem = CM_RESTYPE.Mem;
pub const ResType_IO = CM_RESTYPE.IO;
pub const ResType_DMA = CM_RESTYPE.DMA;
pub const ResType_IRQ = CM_RESTYPE.IRQ;
pub const ResType_DoNotUse = CM_RESTYPE.DoNotUse;
pub const ResType_BusNumber = CM_RESTYPE.BusNumber;
pub const ResType_MemLarge = CM_RESTYPE.MemLarge;
pub const ResType_MAX = CM_RESTYPE.MemLarge;
pub const ResType_Ignored_Bit = CM_RESTYPE.Ignored_Bit;
pub const ResType_ClassSpecific = CM_RESTYPE.ClassSpecific;
pub const ResType_Reserved = CM_RESTYPE.Ignored_Bit;
pub const ResType_DevicePrivate = CM_RESTYPE.DevicePrivate;
pub const ResType_PcCardConfig = CM_RESTYPE.PcCardConfig;
pub const ResType_MfCardConfig = CM_RESTYPE.MfCardConfig;
pub const ResType_Connection = CM_RESTYPE.Connection;

pub const CM_GET_DEVICE_INTERFACE_LIST_FLAGS = enum(u32) {
    PRESENT = 0,
    ALL_DEVICES = 1,
    // BITS = 1, this enum value conflicts with ALL_DEVICES
};
pub const CM_GET_DEVICE_INTERFACE_LIST_PRESENT = CM_GET_DEVICE_INTERFACE_LIST_FLAGS.PRESENT;
pub const CM_GET_DEVICE_INTERFACE_LIST_ALL_DEVICES = CM_GET_DEVICE_INTERFACE_LIST_FLAGS.ALL_DEVICES;
pub const CM_GET_DEVICE_INTERFACE_LIST_BITS = CM_GET_DEVICE_INTERFACE_LIST_FLAGS.ALL_DEVICES;

pub const CM_LOCATE_DEVNODE_FLAGS = enum(u32) {
    NORMAL = 0,
    PHANTOM = 1,
    CANCELREMOVE = 2,
    NOVALIDATION = 4,
...
pub const CM_LOCATE_DEVNODE_NORMAL = CM_LOCATE_DEVNODE_FLAGS.NORMAL;
pub const CM_LOCATE_DEVNODE_PHANTOM = CM_LOCATE_DEVNODE_FLAGS.PHANTOM;
pub const CM_LOCATE_DEVNODE_CANCELREMOVE = CM_LOCATE_DEVNODE_FLAGS.CANCELREMOVE;
pub const CM_LOCATE_DEVNODE_NOVALIDATION = CM_LOCATE_DEVNODE_FLAGS.NOVALIDATION;
pub const CM_LOCATE_DEVNODE_BITS = CM_LOCATE_DEVNODE_FLAGS.BITS;

pub const CM_REENUMERATE_FLAGS = enum(u32) {
    NORMAL = 0,
    SYNCHRONOUS = 1,
    RETRY_INSTALLATION = 2,
    ASYNCHRONOUS = 4,
    BITS = 7,
    _,
    pub fn initFlags(o: struct {
        NORMAL: u1 = 0,
        SYNCHRONOUS: u1 = 0,
        RETRY_INSTALLATION: u1 = 0,
        ASYNCHRONOUS: u1 = 0,
        BITS: u1 = 0,
    }) CM_REENUMERATE_FLAGS {
        return @as(CM_REENUMERATE_FLAGS, @enumFromInt(
              (if (o.NORMAL == 1) @intFromEnum(CM_REENUMERATE_FLAGS.NORMAL) else 0)
            | (if (o.SYNCHRONOUS == 1) @intFromEnum(CM_REENUMERATE_FLAGS.SYNCHRONOUS) else 0)
            | (if (o.RETRY_INSTALLATION == 1) @intFromEnum(CM_REENUMERATE_FLAGS.RETRY_INSTALLATION) else 0)
            | (if (o.ASYNCHRONOUS == 1) @intFromEnum(CM_REENUMERATE_FLAGS.ASYNCHRONOUS) else 0)
            | (if (o.BITS == 1) @intFromEnum(CM_REENUMERATE_FLAGS.BITS) else 0)
        ));
    }
};
pub const CM_REENUMERATE_NORMAL = CM_REENUMERATE_FLAGS.NORMAL;
pub const CM_REENUMERATE_SYNCHRONOUS = CM_REENUMERATE_FLAGS.SYNCHRONOUS;
pub const CM_REENUMERATE_RETRY_INSTALLATION = CM_REENUMERATE_FLAGS.RETRY_INSTALLATION;
pub const CM_REENUMERATE_ASYNCHRONOUS = CM_REENUMERATE_FLAGS.ASYNCHRONOUS;
pub const CM_REENUMERATE_BITS = CM_REENUMERATE_FLAGS.BITS;

pub const CM_ENUMERATE_FLAGS = enum(u32) {
    INSTALLER = 0,
    INTERFACE = 1,
    // BITS = 1, this enum value conflicts with INTERFACE
    _,
    pub fn initFlags(o: struct {
        INSTALLER: u1 = 0,
        INTERFACE: u1 = 0,
    }) CM_ENUMERATE_FLAGS {
        return @as(CM_ENUMERATE_FLAGS, @enumFromInt(
              (if (o.INSTALLER == 1) @intFromEnum(CM_ENUMERATE_FLAGS.INSTALLER) else 0)
            | (if (o.INTERFACE == 1) @intFromEnum(CM_ENUMERATE_FLAGS.INTERFACE) else 0)
        ));
    }
};
pub const CM_ENUMERATE_CLASSES_INSTALLER = CM_ENUMERATE_FLAGS.INSTALLER;
pub const CM_ENUMERATE_CLASSES_INTERFACE = CM_ENUMERATE_FLAGS.INTERFACE;
pub const CM_ENUMERATE_CLASSES_BITS = CM_ENUMERATE_FLAGS.INTERFACE;

pub const INF_STYLE = enum(u32) {
    NONE = 0,
    OLDNT = 1,
    WIN4 = 2,
    CACHE_ENABLE = 16,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(INF_STYLE, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(INF_STYLE.NONE) else 0)
            | (if (o.OLDNT == 1) @intFromEnum(INF_STYLE.OLDNT) else 0)
            | (if (o.WIN4 == 1) @intFromEnum(INF_STYLE.WIN4) else 0)
            | (if (o.CACHE_ENABLE == 1) @intFromEnum(INF_STYLE.CACHE_ENABLE) else 0)
            | (if (o.CACHE_DISABLE == 1) @intFromEnum(INF_STYLE.CACHE_DISABLE) else 0)
            | (if (o.CACHE_IGNORE == 1) @intFromEnum(INF_STYLE.CACHE_IGNORE) else 0)
        ));
    }
};
pub const INF_STYLE_NONE = INF_STYLE.NONE;
pub const INF_STYLE_OLDNT = INF_STYLE.OLDNT;
pub const INF_STYLE_WIN4 = INF_STYLE.WIN4;
pub const INF_STYLE_CACHE_ENABLE = INF_STYLE.CACHE_ENABLE;
pub const INF_STYLE_CACHE_DISABLE = INF_STYLE.CACHE_DISABLE;
pub const INF_STYLE_CACHE_IGNORE = INF_STYLE.CACHE_IGNORE;

pub const SETUPSCANFILEQUEUE_FLAGS = enum(u32) {
    FILE_PRESENCE = 1,
    FILE_VALIDITY = 2,
    USE_CALLBACK = 4,
    USE_CALLBACKEX = 8,
    INFORM_USER = 16,
    PRUNE_COPY_QUEUE = 32,
    USE_CALLBACK_SIGNERINFO = 64,
    PRUNE_DELREN = 128,
    FILE_PRESENCE_WITHOUT_SOURCE = 256,
    FILE_COMPARISON = 512,
    ACTIVATE_DRP = 1024,
    _,
    pub fn initFlags(o: struct {
        ...
        USE_CALLBACKEX: u1 = 0,
        INFORM_USER: u1 = 0,
        PRUNE_COPY_QUEUE: u1 = 0,
        USE_CALLBACK_SIGNERINFO: u1 = 0,
        PRUNE_DELREN: u1 = 0,
        FILE_PRESENCE_WITHOUT_SOURCE: u1 = 0,
        FILE_COMPARISON: u1 = 0,
        ACTIVATE_DRP: u1 = 0,
    }) SETUPSCANFILEQUEUE_FLAGS {
        return @as(SETUPSCANFILEQUEUE_FLAGS, @enumFromInt(
              (if (o.FILE_PRESENCE == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.FILE_PRESENCE) else 0)
            | (if (o.FILE_VALIDITY == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.FILE_VALIDITY) else 0)
            | (if (o.USE_CALLBACK == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACK) else 0)
            | (if (o.USE_CALLBACKEX == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACKEX) else 0)
            | (if (o.INFORM_USER == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.INFORM_USER) else 0)
            | (if (o.PRUNE_COPY_QUEUE == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.PRUNE_COPY_QUEUE) else 0)
            | (if (o.USE_CALLBACK_SIGNERINFO == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACK_SIGNERINFO) else 0)
            | (if (o.PRUNE_DELREN == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.PRUNE_DELREN) else 0)
            | (if (o.FILE_PRESENCE_WITHOUT_SOURCE == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.FILE_PRESENCE_WITHOUT_SOURCE) else 0)
            | (if (o.FILE_COMPARISON == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.FILE_COMPARISON) else 0)
            | (if (o.ACTIVATE_DRP == 1) @intFromEnum(SETUPSCANFILEQUEUE_FLAGS.ACTIVATE_DRP) else 0)
        ));
    }
};
pub const SPQ_SCAN_FILE_PRESENCE = SETUPSCANFILEQUEUE_FLAGS.FILE_PRESENCE;
pub const SPQ_SCAN_FILE_VALIDITY = SETUPSCANFILEQUEUE_FLAGS.FILE_VALIDITY;
pub const SPQ_SCAN_USE_CALLBACK = SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACK;
pub const SPQ_SCAN_USE_CALLBACKEX = SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACKEX;
pub const SPQ_SCAN_INFORM_USER = SETUPSCANFILEQUEUE_FLAGS.INFORM_USER;
pub const SPQ_SCAN_PRUNE_COPY_QUEUE = SETUPSCANFILEQUEUE_FLAGS.PRUNE_COPY_QUEUE;
pub const SPQ_SCAN_USE_CALLBACK_SIGNERINFO = SETUPSCANFILEQUEUE_FLAGS.USE_CALLBACK_SIGNERINFO;
pub const SPQ_SCAN_PRUNE_DELREN = SETUPSCANFILEQUEUE_FLAGS.PRUNE_DELREN;
pub const SPQ_SCAN_FILE_PRESENCE_WITHOUT_SOURCE = SETUPSCANFILEQUEUE_FLAGS.FILE_PRESENCE_WITHOUT_SOURCE;
pub const SPQ_SCAN_FILE_COMPARISON = SETUPSCANFILEQUEUE_FLAGS.FILE_COMPARISON;
pub const SPQ_SCAN_ACTIVATE_DRP = SETUPSCANFILEQUEUE_FLAGS.ACTIVATE_DRP;

pub const CM_LOG_CONF = enum(u32) {
    BASIC_LOG_CONF = 0,
    FILTERED_LOG_CONF = 1,
    ALLOC_LOG_CONF = 2,
    BOOT_LOG_CONF = 3,
...
pub const BASIC_LOG_CONF = CM_LOG_CONF.BASIC_LOG_CONF;
pub const FILTERED_LOG_CONF = CM_LOG_CONF.FILTERED_LOG_CONF;
pub const ALLOC_LOG_CONF = CM_LOG_CONF.ALLOC_LOG_CONF;
pub const BOOT_LOG_CONF = CM_LOG_CONF.BOOT_LOG_CONF;
pub const FORCED_LOG_CONF = CM_LOG_CONF.FORCED_LOG_CONF;
pub const OVERRIDE_LOG_CONF = CM_LOG_CONF.OVERRIDE_LOG_CONF;
pub const NUM_LOG_CONF = CM_LOG_CONF.NUM_LOG_CONF;

pub const CM_DEVNODE_STATUS_FLAGS = enum(u32) {
    CHANGEABLE_FLAGS = 1639670464,
    ROOT_ENUMERATED = 1,
    DRIVER_LOADED = 2,
    ENUM_LOADED = 4,
    STARTED = 8,
    ...
    // NEED_RESTART = 256, this enum value conflicts with LIAR
    // DRIVER_BLOCKED = 64, this enum value conflicts with NOT_FIRST_TIME
    // LEGACY_DRIVER = 4096, this enum value conflicts with MOVED
    // CHILD_WITH_INVALID_ID = 512, this enum value conflicts with HAS_MARK
    // DEVICE_DISCONNECTED = 33554432, this enum value conflicts with NEEDS_LOCKING
    // QUERY_REMOVE_PENDING = 65536, this enum value conflicts with MF_PARENT
    // QUERY_REMOVE_ACTIVE = 131072, this enum value conflicts with MF_CHILD
    _,
    pub fn initFlags(o: struct {
        CHANGEABLE_FLAGS: u1 = 0,
        ROOT_ENUMERATED: u1 = 0,
        DRIVER_LOADED: u1 = 0,
        ENUM_LOADED: u1 = 0,
        STARTED: u1 = 0,
        MANUAL: u1 = 0,
        ...
        DISABLEABLE: u1 = 0,
        REMOVABLE: u1 = 0,
        PRIVATE_PROBLEM: u1 = 0,
        MF_PARENT: u1 = 0,
        MF_CHILD: u1 = 0,
        WILL_BE_REMOVED: u1 = 0,
        NOT_FIRST_TIMEE: u1 = 0,
        STOP_FREE_RES: u1 = 0,
        REBAL_CANDIDATE: u1 = 0,
        BAD_PARTIAL: u1 = 0,
        NT_ENUMERATOR: u1 = 0,
        NT_DRIVER: u1 = 0,
        NEEDS_LOCKING: u1 = 0,
        ...
        return @as(CM_DEVNODE_STATUS_FLAGS, @enumFromInt(
              (if (o.CHANGEABLE_FLAGS == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.CHANGEABLE_FLAGS) else 0)
            | (if (o.ROOT_ENUMERATED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.ROOT_ENUMERATED) else 0)
            | (if (o.DRIVER_LOADED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.DRIVER_LOADED) else 0)
            | (if (o.ENUM_LOADED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.ENUM_LOADED) else 0)
            | (if (o.STARTED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.STARTED) else 0)
            | (if (o.MANUAL == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.MANUAL) else 0)
            | (if (o.NEED_TO_ENUM == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NEED_TO_ENUM) else 0)
            | (if (o.NOT_FIRST_TIME == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NOT_FIRST_TIME) else 0)
            | (if (o.HARDWARE_ENUM == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.HARDWARE_ENUM) else 0)
            | (if (o.LIAR == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.LIAR) else 0)
            | (if (o.HAS_MARK == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.HAS_MARK) else 0)
            | (if (o.HAS_PROBLEM == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.HAS_PROBLEM) else 0)
            | (if (o.FILTERED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.FILTERED) else 0)
            | (if (o.MOVED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.MOVED) else 0)
            | (if (o.DISABLEABLE == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.DISABLEABLE) else 0)
            | (if (o.REMOVABLE == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.REMOVABLE) else 0)
            | (if (o.PRIVATE_PROBLEM == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.PRIVATE_PROBLEM) else 0)
            | (if (o.MF_PARENT == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.MF_PARENT) else 0)
            | (if (o.MF_CHILD == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.MF_CHILD) else 0)
            | (if (o.WILL_BE_REMOVED == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.WILL_BE_REMOVED) else 0)
            | (if (o.NOT_FIRST_TIMEE == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NOT_FIRST_TIMEE) else 0)
            | (if (o.STOP_FREE_RES == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.STOP_FREE_RES) else 0)
            | (if (o.REBAL_CANDIDATE == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.REBAL_CANDIDATE) else 0)
            | (if (o.BAD_PARTIAL == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.BAD_PARTIAL) else 0)
            | (if (o.NT_ENUMERATOR == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NT_ENUMERATOR) else 0)
            | (if (o.NT_DRIVER == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NT_DRIVER) else 0)
            | (if (o.NEEDS_LOCKING == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NEEDS_LOCKING) else 0)
            | (if (o.ARM_WAKEUP == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.ARM_WAKEUP) else 0)
            | (if (o.APM_ENUMERATOR == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.APM_ENUMERATOR) else 0)
            | (if (o.APM_DRIVER == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.APM_DRIVER) else 0)
            | (if (o.SILENT_INSTALL == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.SILENT_INSTALL) else 0)
            | (if (o.NO_SHOW_IN_DM == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.NO_SHOW_IN_DM) else 0)
            | (if (o.BOOT_LOG_PROB == 1) @intFromEnum(CM_DEVNODE_STATUS_FLAGS.BOOT_LOG_PROB) else 0)
        ));
    }
};
pub const DN_CHANGEABLE_FLAGS = CM_DEVNODE_STATUS_FLAGS.CHANGEABLE_FLAGS;
pub const DN_ROOT_ENUMERATED = CM_DEVNODE_STATUS_FLAGS.ROOT_ENUMERATED;
pub const DN_DRIVER_LOADED = CM_DEVNODE_STATUS_FLAGS.DRIVER_LOADED;
pub const DN_ENUM_LOADED = CM_DEVNODE_STATUS_FLAGS.ENUM_LOADED;
pub const DN_STARTED = CM_DEVNODE_STATUS_FLAGS.STARTED;
pub const DN_MANUAL = CM_DEVNODE_STATUS_FLAGS.MANUAL;
pub const DN_NEED_TO_ENUM = CM_DEVNODE_STATUS_FLAGS.NEED_TO_ENUM;
pub const DN_NOT_FIRST_TIME = CM_DEVNODE_STATUS_FLAGS.NOT_FIRST_TIME;
pub const DN_HARDWARE_ENUM = CM_DEVNODE_STATUS_FLAGS.HARDWARE_ENUM;
pub const DN_LIAR = CM_DEVNODE_STATUS_FLAGS.LIAR;
pub const DN_HAS_MARK = CM_DEVNODE_STATUS_FLAGS.HAS_MARK;
pub const DN_HAS_PROBLEM = CM_DEVNODE_STATUS_FLAGS.HAS_PROBLEM;
pub const DN_FILTERED = CM_DEVNODE_STATUS_FLAGS.FILTERED;
pub const DN_MOVED = CM_DEVNODE_STATUS_FLAGS.MOVED;
pub const DN_DISABLEABLE = CM_DEVNODE_STATUS_FLAGS.DISABLEABLE;
pub const DN_REMOVABLE = CM_DEVNODE_STATUS_FLAGS.REMOVABLE;
pub const DN_PRIVATE_PROBLEM = CM_DEVNODE_STATUS_FLAGS.PRIVATE_PROBLEM;
pub const DN_MF_PARENT = CM_DEVNODE_STATUS_FLAGS.MF_PARENT;
pub const DN_MF_CHILD = CM_DEVNODE_STATUS_FLAGS.MF_CHILD;
pub const DN_WILL_BE_REMOVED = CM_DEVNODE_STATUS_FLAGS.WILL_BE_REMOVED;
pub const DN_NOT_FIRST_TIMEE = CM_DEVNODE_STATUS_FLAGS.NOT_FIRST_TIMEE;
pub const DN_STOP_FREE_RES = CM_DEVNODE_STATUS_FLAGS.STOP_FREE_RES;
pub const DN_REBAL_CANDIDATE = CM_DEVNODE_STATUS_FLAGS.REBAL_CANDIDATE;
pub const DN_BAD_PARTIAL = CM_DEVNODE_STATUS_FLAGS.BAD_PARTIAL;
pub const DN_NT_ENUMERATOR = CM_DEVNODE_STATUS_FLAGS.NT_ENUMERATOR;
pub const DN_NT_DRIVER = CM_DEVNODE_STATUS_FLAGS.NT_DRIVER;
pub const DN_NEEDS_LOCKING = CM_DEVNODE_STATUS_FLAGS.NEEDS_LOCKING;
pub const DN_ARM_WAKEUP = CM_DEVNODE_STATUS_FLAGS.ARM_WAKEUP;
pub const DN_APM_ENUMERATOR = CM_DEVNODE_STATUS_FLAGS.APM_ENUMERATOR;
pub const DN_APM_DRIVER = CM_DEVNODE_STATUS_FLAGS.APM_DRIVER;
pub const DN_SILENT_INSTALL = CM_DEVNODE_STATUS_FLAGS.SILENT_INSTALL;
pub const DN_NO_SHOW_IN_DM = CM_DEVNODE_STATUS_FLAGS.NO_SHOW_IN_DM;
pub const DN_BOOT_LOG_PROB = CM_DEVNODE_STATUS_FLAGS.BOOT_LOG_PROB;
pub const DN_NEED_RESTART = CM_DEVNODE_STATUS_FLAGS.LIAR;
pub const DN_DRIVER_BLOCKED = CM_DEVNODE_STATUS_FLAGS.NOT_FIRST_TIME;
pub const DN_LEGACY_DRIVER = CM_DEVNODE_STATUS_FLAGS.MOVED;
pub const DN_CHILD_WITH_INVALID_ID = CM_DEVNODE_STATUS_FLAGS.HAS_MARK;
pub const DN_DEVICE_DISCONNECTED = CM_DEVNODE_STATUS_FLAGS.NEEDS_LOCKING;
pub const DN_QUERY_REMOVE_PENDING = CM_DEVNODE_STATUS_FLAGS.MF_PARENT;
pub const DN_QUERY_REMOVE_ACTIVE = CM_DEVNODE_STATUS_FLAGS.MF_CHILD;

pub const CM_PROB = enum(u32) {
    NOT_CONFIGURED = 1,
    DEVLOADER_FAILED = 2,
    OUT_OF_MEMORY = 3,
    ...
    DEVICE_RESET = 54,
    CONSOLE_LOCKED = 55,
    NEED_CLASS_CONFIG = 56,
    GUEST_ASSIGNMENT_FAILED = 57,
};
pub const CM_PROB_NOT_CONFIGURED = CM_PROB.NOT_CONFIGURED;
pub const CM_PROB_DEVLOADER_FAILED = CM_PROB.DEVLOADER_FAILED;
pub const CM_PROB_OUT_OF_MEMORY = CM_PROB.OUT_OF_MEMORY;
pub const CM_PROB_ENTRY_IS_WRONG_TYPE = CM_PROB.ENTRY_IS_WRONG_TYPE;
pub const CM_PROB_LACKED_ARBITRATOR = CM_PROB.LACKED_ARBITRATOR;
pub const CM_PROB_BOOT_CONFIG_CONFLICT = CM_PROB.BOOT_CONFIG_CONFLICT;
pub const CM_PROB_FAILED_FILTER = CM_PROB.FAILED_FILTER;
pub const CM_PROB_DEVLOADER_NOT_FOUND = CM_PROB.DEVLOADER_NOT_FOUND;
pub const CM_PROB_INVALID_DATA = CM_PROB.INVALID_DATA;
pub const CM_PROB_FAILED_START = CM_PROB.FAILED_START;
pub const CM_PROB_LIAR = CM_PROB.LIAR;
pub const CM_PROB_NORMAL_CONFLICT = CM_PROB.NORMAL_CONFLICT;
pub const CM_PROB_NOT_VERIFIED = CM_PROB.NOT_VERIFIED;
pub const CM_PROB_NEED_RESTART = CM_PROB.NEED_RESTART;
pub const CM_PROB_REENUMERATION = CM_PROB.REENUMERATION;
pub const CM_PROB_PARTIAL_LOG_CONF = CM_PROB.PARTIAL_LOG_CONF;
pub const CM_PROB_UNKNOWN_RESOURCE = CM_PROB.UNKNOWN_RESOURCE;
pub const CM_PROB_REINSTALL = CM_PROB.REINSTALL;
pub const CM_PROB_REGISTRY = CM_PROB.REGISTRY;
pub const CM_PROB_VXDLDR = CM_PROB.VXDLDR;
pub const CM_PROB_WILL_BE_REMOVED = CM_PROB.WILL_BE_REMOVED;
pub const CM_PROB_DISABLED = CM_PROB.DISABLED;
pub const CM_PROB_DEVLOADER_NOT_READY = CM_PROB.DEVLOADER_NOT_READY;
pub const CM_PROB_DEVICE_NOT_THERE = CM_PROB.DEVICE_NOT_THERE;
pub const CM_PROB_MOVED = CM_PROB.MOVED;
pub const CM_PROB_TOO_EARLY = CM_PROB.TOO_EARLY;
pub const CM_PROB_NO_VALID_LOG_CONF = CM_PROB.NO_VALID_LOG_CONF;
pub const CM_PROB_FAILED_INSTALL = CM_PROB.FAILED_INSTALL;
pub const CM_PROB_HARDWARE_DISABLED = CM_PROB.HARDWARE_DISABLED;
pub const CM_PROB_CANT_SHARE_IRQ = CM_PROB.CANT_SHARE_IRQ;
pub const CM_PROB_FAILED_ADD = CM_PROB.FAILED_ADD;
pub const CM_PROB_DISABLED_SERVICE = CM_PROB.DISABLED_SERVICE;
pub const CM_PROB_TRANSLATION_FAILED = CM_PROB.TRANSLATION_FAILED;
pub const CM_PROB_NO_SOFTCONFIG = CM_PROB.NO_SOFTCONFIG;
pub const CM_PROB_BIOS_TABLE = CM_PROB.BIOS_TABLE;
pub const CM_PROB_IRQ_TRANSLATION_FAILED = CM_PROB.IRQ_TRANSLATION_FAILED;
pub const CM_PROB_FAILED_DRIVER_ENTRY = CM_PROB.FAILED_DRIVER_ENTRY;
pub const CM_PROB_DRIVER_FAILED_PRIOR_UNLOAD = CM_PROB.DRIVER_FAILED_PRIOR_UNLOAD;
pub const CM_PROB_DRIVER_FAILED_LOAD = CM_PROB.DRIVER_FAILED_LOAD;
pub const CM_PROB_DRIVER_SERVICE_KEY_INVALID = CM_PROB.DRIVER_SERVICE_KEY_INVALID;
pub const CM_PROB_LEGACY_SERVICE_NO_DEVICES = CM_PROB.LEGACY_SERVICE_NO_DEVICES;
pub const CM_PROB_DUPLICATE_DEVICE = CM_PROB.DUPLICATE_DEVICE;
pub const CM_PROB_FAILED_POST_START = CM_PROB.FAILED_POST_START;
pub const CM_PROB_HALTED = CM_PROB.HALTED;
pub const CM_PROB_PHANTOM = CM_PROB.PHANTOM;
pub const CM_PROB_SYSTEM_SHUTDOWN = CM_PROB.SYSTEM_SHUTDOWN;
pub const CM_PROB_HELD_FOR_EJECT = CM_PROB.HELD_FOR_EJECT;
pub const CM_PROB_DRIVER_BLOCKED = CM_PROB.DRIVER_BLOCKED;
pub const CM_PROB_REGISTRY_TOO_LARGE = CM_PROB.REGISTRY_TOO_LARGE;
pub const CM_PROB_SETPROPERTIES_FAILED = CM_PROB.SETPROPERTIES_FAILED;
pub const CM_PROB_WAITING_ON_DEPENDENCY = CM_PROB.WAITING_ON_DEPENDENCY;
pub const CM_PROB_UNSIGNED_DRIVER = CM_PROB.UNSIGNED_DRIVER;
pub const CM_PROB_USED_BY_DEBUGGER = CM_PROB.USED_BY_DEBUGGER;
pub const CM_PROB_DEVICE_RESET = CM_PROB.DEVICE_RESET;
pub const CM_PROB_CONSOLE_LOCKED = CM_PROB.CONSOLE_LOCKED;
pub const CM_PROB_NEED_CLASS_CONFIG = CM_PROB.NEED_CLASS_CONFIG;
pub const CM_PROB_GUEST_ASSIGNMENT_FAILED = CM_PROB.GUEST_ASSIGNMENT_FAILED;

pub const SPSVCINST_FLAGS = enum(u32) {
    TAGTOFRONT = 1,
    ASSOCSERVICE = 2,
    DELETEEVENTLOGENTRY = 4,
    NOCLOBBER_DISPLAYNAME = 8,
    NOCLOBBER_STARTTYPE = 16,
    NOCLOBBER_ERRORCONTROL = 32,
    NOCLOBBER_LOADORDERGROUP = 64,
    NOCLOBBER_DEPENDENCIES = 128,
    NOCLOBBER_DESCRIPTION = 256,
    STOPSERVICE = 512,
    CLOBBER_SECURITY = 1024,
    STARTSERVICE = 2048,
    NOCLOBBER_REQUIREDPRIVILEGES = 4096,
    NOCLOBBER_TRIGGERS = 8192,
    NOCLOBBER_SERVICESIDTYPE = 16384,
    NOCLOBBER_DELAYEDAUTOSTART = 32768,
    UNIQUE_NAME = 65536,
    NOCLOBBER_FAILUREACTIONS = 131072,
    _,
    pub fn initFlags(o: struct {
        TAGTOFRONT: u1 = 0,
        ASSOCSERVICE: u1 = 0,
        DELETEEVENTLOGENTRY: u1 = 0,
        NOCLOBBER_DISPLAYNAME: u1 = 0,
        NOCLOBBER_STARTTYPE: u1 = 0,
        NOCLOBBER_ERRORCONTROL: u1 = 0,
        NOCLOBBER_LOADORDERGROUP: u1 = 0,
        NOCLOBBER_DEPENDENCIES: u1 = 0,
        NOCLOBBER_DESCRIPTION: u1 = 0,
        STOPSERVICE: u1 = 0,
        CLOBBER_SECURITY: u1 = 0,
        STARTSERVICE: u1 = 0,
        NOCLOBBER_REQUIREDPRIVILEGES: u1 = 0,
        NOCLOBBER_TRIGGERS: u1 = 0,
        NOCLOBBER_SERVICESIDTYPE: u1 = 0,
        NOCLOBBER_DELAYEDAUTOSTART: u1 = 0,
        UNIQUE_NAME: u1 = 0,
        NOCLOBBER_FAILUREACTIONS: u1 = 0,
    }) SPSVCINST_FLAGS {
        return @as(SPSVCINST_FLAGS, @enumFromInt(
              (if (o.TAGTOFRONT == 1) @intFromEnum(SPSVCINST_FLAGS.TAGTOFRONT) else 0)
            | (if (o.ASSOCSERVICE == 1) @intFromEnum(SPSVCINST_FLAGS.ASSOCSERVICE) else 0)
            | (if (o.DELETEEVENTLOGENTRY == 1) @intFromEnum(SPSVCINST_FLAGS.DELETEEVENTLOGENTRY) else 0)
            | (if (o.NOCLOBBER_DISPLAYNAME == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_DISPLAYNAME) else 0)
            | (if (o.NOCLOBBER_STARTTYPE == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_STARTTYPE) else 0)
            | (if (o.NOCLOBBER_ERRORCONTROL == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_ERRORCONTROL) else 0)
            | (if (o.NOCLOBBER_LOADORDERGROUP == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_LOADORDERGROUP) else 0)
            | (if (o.NOCLOBBER_DEPENDENCIES == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_DEPENDENCIES) else 0)
            | (if (o.NOCLOBBER_DESCRIPTION == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_DESCRIPTION) else 0)
            | (if (o.STOPSERVICE == 1) @intFromEnum(SPSVCINST_FLAGS.STOPSERVICE) else 0)
            | (if (o.CLOBBER_SECURITY == 1) @intFromEnum(SPSVCINST_FLAGS.CLOBBER_SECURITY) else 0)
            | (if (o.STARTSERVICE == 1) @intFromEnum(SPSVCINST_FLAGS.STARTSERVICE) else 0)
            | (if (o.NOCLOBBER_REQUIREDPRIVILEGES == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_REQUIREDPRIVILEGES) else 0)
            | (if (o.NOCLOBBER_TRIGGERS == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_TRIGGERS) else 0)
            | (if (o.NOCLOBBER_SERVICESIDTYPE == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_SERVICESIDTYPE) else 0)
            | (if (o.NOCLOBBER_DELAYEDAUTOSTART == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_DELAYEDAUTOSTART) else 0)
            | (if (o.UNIQUE_NAME == 1) @intFromEnum(SPSVCINST_FLAGS.UNIQUE_NAME) else 0)
            | (if (o.NOCLOBBER_FAILUREACTIONS == 1) @intFromEnum(SPSVCINST_FLAGS.NOCLOBBER_FAILUREACTIONS) else 0)
        ));
    }
};
pub const SPSVCINST_TAGTOFRONT = SPSVCINST_FLAGS.TAGTOFRONT;
pub const SPSVCINST_ASSOCSERVICE = SPSVCINST_FLAGS.ASSOCSERVICE;
pub const SPSVCINST_DELETEEVENTLOGENTRY = SPSVCINST_FLAGS.DELETEEVENTLOGENTRY;
pub const SPSVCINST_NOCLOBBER_DISPLAYNAME = SPSVCINST_FLAGS.NOCLOBBER_DISPLAYNAME;
pub const SPSVCINST_NOCLOBBER_STARTTYPE = SPSVCINST_FLAGS.NOCLOBBER_STARTTYPE;
pub const SPSVCINST_NOCLOBBER_ERRORCONTROL = SPSVCINST_FLAGS.NOCLOBBER_ERRORCONTROL;
pub const SPSVCINST_NOCLOBBER_LOADORDERGROUP = SPSVCINST_FLAGS.NOCLOBBER_LOADORDERGROUP;
pub const SPSVCINST_NOCLOBBER_DEPENDENCIES = SPSVCINST_FLAGS.NOCLOBBER_DEPENDENCIES;
pub const SPSVCINST_NOCLOBBER_DESCRIPTION = SPSVCINST_FLAGS.NOCLOBBER_DESCRIPTION;
pub const SPSVCINST_STOPSERVICE = SPSVCINST_FLAGS.STOPSERVICE;
pub const SPSVCINST_CLOBBER_SECURITY = SPSVCINST_FLAGS.CLOBBER_SECURITY;
pub const SPSVCINST_STARTSERVICE = SPSVCINST_FLAGS.STARTSERVICE;
pub const SPSVCINST_NOCLOBBER_REQUIREDPRIVILEGES = SPSVCINST_FLAGS.NOCLOBBER_REQUIREDPRIVILEGES;
pub const SPSVCINST_NOCLOBBER_TRIGGERS = SPSVCINST_FLAGS.NOCLOBBER_TRIGGERS;
pub const SPSVCINST_NOCLOBBER_SERVICESIDTYPE = SPSVCINST_FLAGS.NOCLOBBER_SERVICESIDTYPE;
pub const SPSVCINST_NOCLOBBER_DELAYEDAUTOSTART = SPSVCINST_FLAGS.NOCLOBBER_DELAYEDAUTOSTART;
pub const SPSVCINST_UNIQUE_NAME = SPSVCINST_FLAGS.UNIQUE_NAME;
pub const SPSVCINST_NOCLOBBER_FAILUREACTIONS = SPSVCINST_FLAGS.NOCLOBBER_FAILUREACTIONS;

pub const CM_CDMASK = enum(u32) {
    DEVINST = 1,
    RESDES = 2,
    FLAGS = 4,
    DESCRIPTION = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CM_CDMASK, @enumFromInt(
              (if (o.DEVINST == 1) @intFromEnum(CM_CDMASK.DEVINST) else 0)
            | (if (o.RESDES == 1) @intFromEnum(CM_CDMASK.RESDES) else 0)
            | (if (o.FLAGS == 1) @intFromEnum(CM_CDMASK.FLAGS) else 0)
            | (if (o.DESCRIPTION == 1) @intFromEnum(CM_CDMASK.DESCRIPTION) else 0)
            | (if (o.VALID == 1) @intFromEnum(CM_CDMASK.VALID) else 0)
        ));
    }
};
pub const CM_CDMASK_DEVINST = CM_CDMASK.DEVINST;
pub const CM_CDMASK_RESDES = CM_CDMASK.RESDES;
pub const CM_CDMASK_FLAGS = CM_CDMASK.FLAGS;
pub const CM_CDMASK_DESCRIPTION = CM_CDMASK.DESCRIPTION;
pub const CM_CDMASK_VALID = CM_CDMASK.VALID;

pub const CM_CDFLAGS = enum(u32) {
    DRIVER = 1,
    ROOT_OWNED = 2,
    RESERVED = 4,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(CM_CDFLAGS, @enumFromInt(
              (if (o.DRIVER == 1) @intFromEnum(CM_CDFLAGS.DRIVER) else 0)
            | (if (o.ROOT_OWNED == 1) @intFromEnum(CM_CDFLAGS.ROOT_OWNED) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(CM_CDFLAGS.RESERVED) else 0)
        ));
    }
};
pub const CM_CDFLAGS_DRIVER = CM_CDFLAGS.DRIVER;
pub const CM_CDFLAGS_ROOT_OWNED = CM_CDFLAGS.ROOT_OWNED;
pub const CM_CDFLAGS_RESERVED = CM_CDFLAGS.RESERVED;

pub const CM_REMOVAL_POLICY = enum(u32) {
    NO_REMOVAL = 1,
    ORDERLY_REMOVAL = 2,
    SURPRISE_REMOVAL = 3,
};
pub const CM_REMOVAL_POLICY_EXPECT_NO_REMOVAL = CM_REMOVAL_POLICY.NO_REMOVAL;
pub const CM_REMOVAL_POLICY_EXPECT_ORDERLY_REMOVAL = CM_REMOVAL_POLICY.ORDERLY_REMOVAL;
pub const CM_REMOVAL_POLICY_EXPECT_SURPRISE_REMOVAL = CM_REMOVAL_POLICY.SURPRISE_REMOVAL;

pub const CM_INSTALL_STATE = enum(u32) {
    INSTALLED = 0,
    NEEDS_REINSTALL = 1,
    FAILED_INSTALL = 2,
    FINISH_INSTALL = 3,
};
pub const CM_INSTALL_STATE_INSTALLED = CM_INSTALL_STATE.INSTALLED;
pub const CM_INSTALL_STATE_NEEDS_REINSTALL = CM_INSTALL_STATE.NEEDS_REINSTALL;
pub const CM_INSTALL_STATE_FAILED_INSTALL = CM_INSTALL_STATE.FAILED_INSTALL;
pub const CM_INSTALL_STATE_FINISH_INSTALL = CM_INSTALL_STATE.FINISH_INSTALL;

pub const CM_DEVCAP = enum(u32) {
    LOCKSUPPORTED = 1,
    EJECTSUPPORTED = 2,
    REMOVABLE = 4,
    DOCKDEVICE = 8,
    ...
    SILENTINSTALL = 32,
    RAWDEVICEOK = 64,
    SURPRISEREMOVALOK = 128,
    HARDWAREDISABLED = 256,
    NONDYNAMIC = 512,
    SECUREDEVICE = 1024,
    _,
    pub fn initFlags(o: struct {
        ...
        SILENTINSTALL: u1 = 0,
        RAWDEVICEOK: u1 = 0,
        SURPRISEREMOVALOK: u1 = 0,
        HARDWAREDISABLED: u1 = 0,
        NONDYNAMIC: u1 = 0,
        SECUREDEVICE: u1 = 0,
    }) CM_DEVCAP {
        return @as(CM_DEVCAP, @enumFromInt(
              (if (o.LOCKSUPPORTED == 1) @intFromEnum(CM_DEVCAP.LOCKSUPPORTED) else 0)
            | (if (o.EJECTSUPPORTED == 1) @intFromEnum(CM_DEVCAP.EJECTSUPPORTED) else 0)
            | (if (o.REMOVABLE == 1) @intFromEnum(CM_DEVCAP.REMOVABLE) else 0)
            | (if (o.DOCKDEVICE == 1) @intFromEnum(CM_DEVCAP.DOCKDEVICE) else 0)
            | (if (o.UNIQUEID == 1) @intFromEnum(CM_DEVCAP.UNIQUEID) else 0)
            | (if (o.SILENTINSTALL == 1) @intFromEnum(CM_DEVCAP.SILENTINSTALL) else 0)
            | (if (o.RAWDEVICEOK == 1) @intFromEnum(CM_DEVCAP.RAWDEVICEOK) else 0)
            | (if (o.SURPRISEREMOVALOK == 1) @intFromEnum(CM_DEVCAP.SURPRISEREMOVALOK) else 0)
            | (if (o.HARDWAREDISABLED == 1) @intFromEnum(CM_DEVCAP.HARDWAREDISABLED) else 0)
            | (if (o.NONDYNAMIC == 1) @intFromEnum(CM_DEVCAP.NONDYNAMIC) else 0)
            | (if (o.SECUREDEVICE == 1) @intFromEnum(CM_DEVCAP.SECUREDEVICE) else 0)
        ));
    }
};
pub const CM_DEVCAP_LOCKSUPPORTED = CM_DEVCAP.LOCKSUPPORTED;
pub const CM_DEVCAP_EJECTSUPPORTED = CM_DEVCAP.EJECTSUPPORTED;
pub const CM_DEVCAP_REMOVABLE = CM_DEVCAP.REMOVABLE;
pub const CM_DEVCAP_DOCKDEVICE = CM_DEVCAP.DOCKDEVICE;
pub const CM_DEVCAP_UNIQUEID = CM_DEVCAP.UNIQUEID;
pub const CM_DEVCAP_SILENTINSTALL = CM_DEVCAP.SILENTINSTALL;
pub const CM_DEVCAP_RAWDEVICEOK = CM_DEVCAP.RAWDEVICEOK;
pub const CM_DEVCAP_SURPRISEREMOVALOK = CM_DEVCAP.SURPRISEREMOVALOK;
pub const CM_DEVCAP_HARDWAREDISABLED = CM_DEVCAP.HARDWAREDISABLED;
pub const CM_DEVCAP_NONDYNAMIC = CM_DEVCAP.NONDYNAMIC;
pub const CM_DEVCAP_SECUREDEVICE = CM_DEVCAP.SECUREDEVICE;
...
pub const FILEPATHS_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        Target: ?[*:0]align(1) const u8,
        Source: ?[*:0]align(1) const u8,
        Win32Error: u32,
        Flags: u32,
    },
    .X86 => extern struct {
        Target: ?[*:0]align(1) const u8 align(1),
        Source: ?[*:0]align(1) const u8 align(1),
...
pub const FILEPATHS_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        Target: ?[*:0]align(1) const u16,
        Source: ?[*:0]align(1) const u16,
        Win32Error: u32,
        Flags: u32,
    },
    .X86 => extern struct {
        Target: ?[*:0]align(1) const u16 align(1),
        Source: ?[*:0]align(1) const u16 align(1),
        Win32Error: u32 align(1),
        Flags: u32 align(1),
    },
};
pub const FILEPATHS_SIGNERINFO_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        Win32Error: u32,
        Flags: u32,
        DigitalSigner: ?[*:0]align(1) const u8,
        Version: ?[*:0]align(1) const u8,
        CatalogFile: ?[*:0]align(1) const u8,
    },
    .X86 => extern struct {
        Target: ?[*:0]align(1) const u8 align(1),
        Source: ?[*:0]align(1) const u8 align(1),
        Win32Error: u32 align(1),
        Flags: u32 align(1),
        DigitalSigner: ?[*:0]align(1) const u8 align(1),
        Version: ?[*:0]align(1) const u8 align(1),
        CatalogFile: ?[*:0]align(1) const u8 align(1),
    },
};
pub const FILEPATHS_SIGNERINFO_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        Win32Error: u32,
        Flags: u32,
        DigitalSigner: ?[*:0]align(1) const u16,
        Version: ?[*:0]align(1) const u16,
        CatalogFile: ?[*:0]align(1) const u16,
    },
    .X86 => extern struct {
        Target: ?[*:0]align(1) const u16 align(1),
        Source: ?[*:0]align(1) const u16 align(1),
        Win32Error: u32 align(1),
        Flags: u32 align(1),
        DigitalSigner: ?[*:0]align(1) const u16 align(1),
        Version: ?[*:0]align(1) const u16 align(1),
        CatalogFile: ?[*:0]align(1) const u16 align(1),
    },
};
pub const SOURCE_MEDIA_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        Reserved: ?[*:0]align(1) const u8,
        Tagfile: ?[*:0]align(1) const u8,
        Description: ?[*:0]align(1) const u8,
        SourcePath: ?[*:0]align(1) const u8,
        SourceFile: ?[*:0]align(1) const u8,
        Flags: u32,
    },
    .X86 => extern struct {
        Reserved: ?[*:0]align(1) const u8 align(1),
        Tagfile: ?[*:0]align(1) const u8 align(1),
        Description: ?[*:0]align(1) const u8 align(1),
        SourcePath: ?[*:0]align(1) const u8 align(1),
        SourceFile: ?[*:0]align(1) const u8 align(1),
        Flags: u32 align(1),
    },
};
pub const SOURCE_MEDIA_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        Reserved: ?[*:0]align(1) const u16,
        Tagfile: ?[*:0]align(1) const u16,
        Description: ?[*:0]align(1) const u16,
        SourcePath: ?[*:0]align(1) const u16,
        SourceFile: ?[*:0]align(1) const u16,
        Flags: u32,
    },
    .X86 => extern struct {
        Reserved: ?[*:0]align(1) const u16 align(1),
        Tagfile: ?[*:0]align(1) const u16 align(1),
        Description: ?[*:0]align(1) const u16 align(1),
        SourcePath: ?[*:0]align(1) const u16 align(1),
        SourceFile: ?[*:0]align(1) const u16 align(1),
        Flags: u32 align(1),
    },
};
pub const CABINET_INFO_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        CabinetPath: ?[*:0]align(1) const u8,
        CabinetFile: ?[*:0]align(1) const u8,
        DiskName: ?[*:0]align(1) const u8,
        SetId: u16,
        CabinetNumber: u16,
    },
    .X86 => extern struct {
        CabinetPath: ?[*:0]align(1) const u8 align(1),
        CabinetFile: ?[*:0]align(1) const u8 align(1),
        DiskName: ?[*:0]align(1) const u8 align(1),
        SetId: u16 align(1),
...
pub const CABINET_INFO_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        CabinetPath: ?[*:0]align(1) const u16,
        CabinetFile: ?[*:0]align(1) const u16,
        DiskName: ?[*:0]align(1) const u16,
        SetId: u16,
        CabinetNumber: u16,
    },
    .X86 => extern struct {
        CabinetPath: ?[*:0]align(1) const u16 align(1),
        CabinetFile: ?[*:0]align(1) const u16 align(1),
        DiskName: ?[*:0]align(1) const u16 align(1),
        SetId: u16 align(1),
        CabinetNumber: u16 align(1),
    },
};
pub const FILE_IN_CABINET_INFO_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        NameInCabinet: ?[*:0]align(1) const u8,
        FileSize: u32,
        Win32Error: u32,
        DosDate: u16,
        DosTime: u16,
    ...
    .X86 => extern struct {
        NameInCabinet: ?[*:0]align(1) const u8 align(1),
...
pub const FILE_IN_CABINET_INFO_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        NameInCabinet: ?[*:0]align(1) const u16,
        FileSize: u32,
        Win32Error: u32,
        DosDate: u16,
        DosTime: u16,
    ...
    .X86 => extern struct {
        NameInCabinet: ?[*:0]align(1) const u16 align(1),
        FileSize: u32 align(1),
        Win32Error: u32 align(1),
        DosDate: u16 align(1),
        DosTime: u16 align(1),
...
pub const SP_REGISTER_CONTROL_STATUSA = switch(@import("../../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        cbSize: u32 align(1),
        FileName: ?[*:0]align(1) const u8 align(1),
        Win32Error: u32 align(1),
...
pub const SP_REGISTER_CONTROL_STATUSW = switch(@import("../../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        cbSize: u32 align(1),
        FileName: ?[*:0]align(1) const u16 align(1),
        Win32Error: u32 align(1),
        FailureCode: u32 align(1),
    },
};
pub const SP_FILE_COPY_PARAMS_A = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        SourceRootPath: ?[*:0]align(1) const u8,
        SourcePath: ?[*:0]align(1) const u8,
        SourceFilename: ?[*:0]align(1) const u8,
        SourceDescription: ?[*:0]align(1) const u8,
        SourceTagfile: ?[*:0]align(1) const u8,
        TargetDirectory: ?[*:0]align(1) const u8,
        TargetFilename: ?[*:0]align(1) const u8,
        CopyStyle: u32,
        LayoutInf: ?*anyopaque,
        SecurityDescriptor: ?[*:0]align(1) const u8,
    },
    .X86 => extern struct {
        cbSize: u32 align(1),
        QueueHandle: ?*anyopaque align(1),
        SourceRootPath: ?[*:0]align(1) const u8 align(1),
        SourcePath: ?[*:0]align(1) const u8 align(1),
        SourceFilename: ?[*:0]align(1) const u8 align(1),
        SourceDescription: ?[*:0]align(1) const u8 align(1),
        SourceTagfile: ?[*:0]align(1) const u8 align(1),
        TargetDirectory: ?[*:0]align(1) const u8 align(1),
        TargetFilename: ?[*:0]align(1) const u8 align(1),
        CopyStyle: u32 align(1),
        LayoutInf: ?*anyopaque align(1),
        SecurityDescriptor: ?[*:0]align(1) const u8 align(1),
    },
};
pub const SP_FILE_COPY_PARAMS_W = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        cbSize: u32,
        QueueHandle: ?*anyopaque,
        SourceRootPath: ?[*:0]align(1) const u16,
        SourcePath: ?[*:0]align(1) const u16,
        SourceFilename: ?[*:0]align(1) const u16,
        SourceDescription: ?[*:0]align(1) const u16,
        SourceTagfile: ?[*:0]align(1) const u16,
        TargetDirectory: ?[*:0]align(1) const u16,
        TargetFilename: ?[*:0]align(1) const u16,
        CopyStyle: u32,
        LayoutInf: ?*anyopaque,
        SecurityDescriptor: ?[*:0]align(1) const u16,
    },
    .X86 => extern struct {
        cbSize: u32 align(1),
        QueueHandle: ?*anyopaque align(1),
        SourceRootPath: ?[*:0]align(1) const u16 align(1),
        SourcePath: ?[*:0]align(1) const u16 align(1),
        SourceFilename: ?[*:0]align(1) const u16 align(1),
        SourceDescription: ?[*:0]align(1) const u16 align(1),
        SourceTagfile: ?[*:0]align(1) const u16 align(1),
        TargetDirectory: ?[*:0]align(1) const u16 align(1),
        TargetFilename: ?[*:0]align(1) const u16 align(1),
        CopyStyle: u32 align(1),
        LayoutInf: ?*anyopaque align(1),
        SecurityDescriptor: ?[*:0]align(1) const u16 align(1),
    },
};
...
pub const SP_DEVINSTALL_PARAMS_W = switch(@import("../../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        ...
        FlagsEx: u32 align(1),
        hwndParent: ?HWND align(1),
        InstallMsgHandler: ?PSP_FILE_CALLBACK_W align(1),
        InstallMsgHandlerContext: ?*anyopaque align(1),
        FileQueue: ?*anyopaque align(1),
        ClassInstallReserved: usize align(1),
        Reserved: u32 align(1),
...
pub extern "setupapi" fn SetupGetInfPublishedNameA(
    DriverStoreLocation: ?[*:0]align(1) const u8,
    ReturnBuffer: [*:0]u8,
    ReturnBufferSize: u32,
    RequiredSize: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetInfPublishedNameW(
    DriverStoreLocation: ?[*:0]align(1) const u16,
    ReturnBuffer: [*:0]u16,
    ReturnBufferSize: u32,
    RequiredSize: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetInfFileListA(
    DirectoryPath: ?[*:0]align(1) const u8,
    InfStyle: INF_STYLE,
    ReturnBuffer: ?[*:0]u8,
    ReturnBufferSize: u32,
    RequiredSize: ?*u32,
...
pub extern "setupapi" fn SetupGetInfFileListW(
    DirectoryPath: ?[*:0]align(1) const u16,
    InfStyle: INF_STYLE,
    ReturnBuffer: [*:0]u16,
    ReturnBufferSize: u32,
    RequiredSize: ?*u32,
...
pub extern "setupapi" fn SetupSetSourceListA(
    Flags: u32,
    SourceList: [*]const ?[*:0]align(1) const u8,
    SourceCount: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupSetSourceListW(
    Flags: u32,
    SourceList: [*]const ?[*:0]align(1) const u16,
    SourceCount: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupFreeSourceListA(
    List: [*]const ?*const ?PSTR,
    Count: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupFreeSourceListW(
    List: [*]const ?*const ?PWSTR,
    Count: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupPromptForDiskA(
    hwndParent: ?HWND,
    DialogTitle: ?[*:0]align(1) const u8,
    DiskName: ?[*:0]align(1) const u8,
    PathToSource: ?[*:0]align(1) const u8,
    FileSought: ?[*:0]align(1) const u8,
    TagFile: ?[*:0]align(1) const u8,
    DiskPromptStyle: u32,
    PathBuffer: ?[*:0]u8,
    PathBufferSize: u32,
...
pub extern "setupapi" fn SetupPromptForDiskW(
    hwndParent: ?HWND,
    DialogTitle: ?[*:0]align(1) const u16,
    DiskName: ?[*:0]align(1) const u16,
    PathToSource: ?[*:0]align(1) const u16,
    FileSought: ?[*:0]align(1) const u16,
    TagFile: ?[*:0]align(1) const u16,
    DiskPromptStyle: u32,
    PathBuffer: ?[*:0]u16,
    PathBufferSize: u32,
...
pub extern "setupapi" fn SetupCopyErrorA(
    ...
    PathToSource: ?[*:0]align(1) const u8,
    SourceFile: ?[*:0]align(1) const u8,
    TargetPathFile: ?[*:0]align(1) const u8,
    Win32ErrorCode: u32,
    Style: u32,
    PathBuffer: ?[*:0]u8,
    PathBufferSize: u32,
...
pub extern "setupapi" fn SetupCopyErrorW(
    ...
    PathToSource: ?[*:0]align(1) const u16,
    SourceFile: ?[*:0]align(1) const u16,
    TargetPathFile: ?[*:0]align(1) const u16,
    Win32ErrorCode: u32,
    Style: u32,
    PathBuffer: ?[*:0]u16,
    PathBufferSize: u32,
...
pub extern "setupapi" fn SetupRenameErrorW(
    ...
    DialogTitle: ?[*:0]align(1) const u16,
    SourceFile: ?[*:0]align(1) const u16,
    TargetFile: ?[*:0]align(1) const u16,
    Win32ErrorCode: u32,
    Style: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "setupapi" fn SetupInstallFileA(
    ...
    InfContext: ?*INFCONTEXT,
    SourceFile: ?[*:0]align(1) const u8,
    SourcePathRoot: ?[*:0]align(1) const u8,
    DestinationName: ?[*:0]align(1) const u8,
...
pub extern "setupapi" fn SetupInstallFileW(
    ...
    InfContext: ?*INFCONTEXT,
    SourceFile: ?[*:0]align(1) const u16,
    SourcePathRoot: ?[*:0]align(1) const u16,
    DestinationName: ?[*:0]align(1) const u16,
    CopyStyle: SP_COPY_STYLE,
...
pub extern "setupapi" fn SetupSetFileQueueAlternatePlatformA(
    QueueHandle: ?*anyopaque,
    AlternatePlatformInfo: ?*SP_ALTPLATFORM_INFO_V2,
    AlternateDefaultCatalogFile: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueueDeleteA(
    QueueHandle: ?*anyopaque,
    PathPart1: ?[*:0]align(1) const u8,
    PathPart2: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupQueueDeleteW(
    QueueHandle: ?*anyopaque,
    PathPart1: ?[*:0]align(1) const u16,
    PathPart2: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueueRenameW(
    ...
    SourcePath: ?[*:0]align(1) const u16,
    SourceFilename: ?[*:0]align(1) const u16,
    TargetPath: ?[*:0]align(1) const u16,
    TargetFilename: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupCopyOEMInfA(
    SourceInfFileName: ?[*:0]align(1) const u8,
    OEMSourceMediaLocation: ?[*:0]align(1) const u8,
...
pub extern "setupapi" fn SetupCopyOEMInfW(
    SourceInfFileName: ?[*:0]align(1) const u16,
    OEMSourceMediaLocation: ?[*:0]align(1) const u16,
    OEMSourceMediaType: OEM_SOURCE_MEDIA_TYPE,
    CopyStyle: SP_COPY_STYLE,
...
pub extern "setupapi" fn SetupUninstallOEMInfA(
    InfFileName: ?[*:0]align(1) const u8,
    Flags: u32,
    Reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupUninstallOEMInfW(
    InfFileName: ?[*:0]align(1) const u16,
    Flags: u32,
    Reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupAddToDiskSpaceListA(
    DiskSpace: ?*anyopaque,
    TargetFilespec: ?[*:0]align(1) const u8,
    FileSize: i64,
...
pub extern "setupapi" fn SetupAddToDiskSpaceListW(
    DiskSpace: ?*anyopaque,
    TargetFilespec: ?[*:0]align(1) const u16,
    FileSize: i64,
    Operation: SETUP_FILE_OPERATION,
    Reserved1: ?*anyopaque,
    Reserved2: u32,
...
pub extern "setupapi" fn SetupAddSectionToDiskSpaceListA(
    ...
    InfHandle: ?*anyopaque,
    ListInfHandle: ?*anyopaque,
    SectionName: ?[*:0]align(1) const u8,
    Operation: SETUP_FILE_OPERATION,
    Reserved1: ?*anyopaque,
    Reserved2: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupAddSectionToDiskSpaceListW(
    ...
    InfHandle: ?*anyopaque,
    ListInfHandle: ?*anyopaque,
    SectionName: ?[*:0]align(1) const u16,
    Operation: SETUP_FILE_OPERATION,
    Reserved1: ?*anyopaque,
    Reserved2: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn InstallHinfSectionA(
    ...
    CommandLine: ?[*:0]align(1) const u8,
    ShowCommand: i32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "setupapi" fn InstallHinfSectionW(
    Window: ?HWND,
    ModuleHandle: ?HINSTANCE,
    CommandLine: ?[*:0]align(1) const u16,
    ShowCommand: i32,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupInitializeFileLogA(
    LogFileName: ?[*:0]align(1) const u8,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupInitializeFileLogW(
    LogFileName: ?[*:0]align(1) const u16,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "setupapi" fn SetupLogFileA(
    FileLogHandle: ?*anyopaque,
    LogSectionName: ?[*:0]align(1) const u8,
    SourceFilename: ?[*:0]align(1) const u8,
    TargetFilename: ?[*:0]align(1) const u8,
    Checksum: u32,
    DiskTagfile: ?[*:0]align(1) const u8,
    DiskDescription: ?[*:0]align(1) const u8,
    OtherInfo: ?[*:0]align(1) const u8,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupLogFileW(
    FileLogHandle: ?*anyopaque,
    LogSectionName: ?[*:0]align(1) const u16,
    SourceFilename: ?[*:0]align(1) const u16,
    TargetFilename: ?[*:0]align(1) const u16,
    Checksum: u32,
    DiskTagfile: ?[*:0]align(1) const u16,
    DiskDescription: ?[*:0]align(1) const u16,
    OtherInfo: ?[*:0]align(1) const u16,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupLogErrorA(
    MessageString: ?[*:0]align(1) const u8,
    Severity: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupLogErrorW(
    MessageString: ?[*:0]align(1) const u16,
    Severity: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupPrepareQueueForRestoreA(
    QueueHandle: ?*anyopaque,
    BackupPath: ?[*:0]align(1) const u8,
    RestoreFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "setupapi" fn SetupPrepareQueueForRestoreW(
    QueueHandle: ?*anyopaque,
    BackupPath: ?[*:0]align(1) const u16,
    RestoreFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiCreateDeviceInfoListExA(
    ClassGuid: ?*const Guid,
    hwndParent: ?HWND,
    MachineName: ?[*:0]align(1) const u8,
    Reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HDEVINFO;
...
pub extern "setupapi" fn SetupDiCreateDeviceInfoListExW(
    ClassGuid: ?*const Guid,
    hwndParent: ?HWND,
    MachineName: ?[*:0]align(1) const u16,
    Reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HDEVINFO;
...
pub extern "setupapi" fn SetupDiCreateDeviceInfoA(
    DeviceInfoSet: HDEVINFO,
    DeviceName: ?[*:0]align(1) const u8,
    ClassGuid: ?*const Guid,
    DeviceDescription: ?[*:0]align(1) const u8,
    hwndParent: ?HWND,
    CreationFlags: u32,
    DeviceInfoData: ?*SP_DEVINFO_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiCreateDeviceInfoW(
    DeviceInfoSet: HDEVINFO,
    DeviceName: ?[*:0]align(1) const u16,
    ClassGuid: ?*const Guid,
...
pub extern "setupapi" fn SetupDiOpenDeviceInfoA(
    DeviceInfoSet: HDEVINFO,
    DeviceInstanceId: ?[*:0]align(1) const u8,
    hwndParent: ?HWND,
    OpenFlags: u32,
    DeviceInfoData: ?*SP_DEVINFO_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiOpenDeviceInfoW(
    DeviceInfoSet: HDEVINFO,
    DeviceInstanceId: ?[*:0]align(1) const u16,
    hwndParent: ?HWND,
    OpenFlags: u32,
    DeviceInfoData: ?*SP_DEVINFO_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiCreateDeviceInterfaceA(
    ...
    DeviceInfoData: ?*SP_DEVINFO_DATA,
    InterfaceClassGuid: ?*const Guid,
    ReferenceString: ?[*:0]align(1) const u8,
    CreationFlags: u32,
    DeviceInterfaceData: ?*SP_DEVICE_INTERFACE_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiCreateDeviceInterfaceW(
    ...
    DeviceInfoData: ?*SP_DEVINFO_DATA,
    InterfaceClassGuid: ?*const Guid,
    ReferenceString: ?[*:0]align(1) const u16,
    CreationFlags: u32,
    DeviceInterfaceData: ?*SP_DEVICE_INTERFACE_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiOpenDeviceInterfaceW(
    DeviceInfoSet: HDEVINFO,
    DevicePath: ?[*:0]align(1) const u16,
    OpenFlags: u32,
    DeviceInterfaceData: ?*SP_DEVICE_INTERFACE_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassDevsW(
    ClassGuid: ?*const Guid,
    Enumerator: ?[*:0]align(1) const u16,
    hwndParent: ?HWND,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) HDEVINFO;
...
pub extern "setupapi" fn SetupDiCreateDeviceInterfaceRegKeyA(
    ...
    samDesired: u32,
    InfHandle: ?*anyopaque,
    InfSectionName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HKEY;
...
pub extern "setupapi" fn SetupDiCreateDeviceInterfaceRegKeyW(
    ...
    samDesired: u32,
    InfHandle: ?*anyopaque,
    InfSectionName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HKEY;
...
pub extern "setupapi" fn SetupDiGetCustomDevicePropertyA(
    DeviceInfoSet: HDEVINFO,
    DeviceInfoData: ?*SP_DEVINFO_DATA,
    CustomPropertyName: ?[*:0]align(1) const u8,
    Flags: u32,
    PropertyRegDataType: ?*u32,
...
pub extern "setupapi" fn SetupDiGetCustomDevicePropertyW(
    DeviceInfoSet: HDEVINFO,
    DeviceInfoData: ?*SP_DEVINFO_DATA,
    CustomPropertyName: ?[*:0]align(1) const u16,
    Flags: u32,
    PropertyRegDataType: ?*u32,
    // TODO: what to do with BytesParamIndex 6?
    PropertyBuffer: ?*u8,
...
pub extern "cfgmgr32" fn CM_Connect_MachineA(
    UNCServerName: ?[*:0]align(1) const u8,
    phMachine: ?*isize,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;

// TODO: this type is limited to platform 'windows5.0'
pub extern "cfgmgr32" fn CM_Connect_MachineW(
    UNCServerName: ?[*:0]align(1) const u16,
    phMachine: ?*isize,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_DevNode_Custom_PropertyA(
    dnDevInst: u32,
    pszCustomPropertyName: ?[*:0]align(1) const u8,
    pulRegDataType: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    Buffer: ?*anyopaque,
    pulLength: ?*u32,
...
pub extern "cfgmgr32" fn CM_Get_DevNode_Custom_PropertyW(
    dnDevInst: u32,
    pszCustomPropertyName: ?[*:0]align(1) const u16,
    pulRegDataType: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    Buffer: ?*anyopaque,
    pulLength: ?*u32,
...
pub extern "cfgmgr32" fn CM_Get_DevNode_Status(
    pulStatus: ?*CM_DEVNODE_STATUS_FLAGS,
    pulProblemNumber: ?*CM_PROB,
    dnDevInst: u32,
    ulFlags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Hardware_Profile_InfoA(
    ulIndex: u32,
    pHWProfileInfo: ?*HWPROFILEINFO_A,
    ulFlags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Device_Interface_AliasA(
    pszDeviceInterface: ?[*:0]align(1) const u8,
...
pub extern "cfgmgr32" fn CM_Get_Device_Interface_AliasW(
    pszDeviceInterface: ?[*:0]align(1) const u16,
    AliasInterfaceGuid: ?*Guid,
...
pub extern "cfgmgr32" fn CM_Open_Class_KeyA(
    ClassGuid: ?*Guid,
    pszClassName: ?[*:0]align(1) const u8,
    samDesired: u32,
    Disposition: u32,
    phkClass: ?*?HKEY,
    ulFlags: u32,
...
pub extern "cfgmgr32" fn CM_Open_Class_KeyW(
    ClassGuid: ?*Guid,
    pszClassName: ?[*:0]align(1) const u16,
    samDesired: u32,
    Disposition: u32,
    phkClass: ?*?HKEY,
    ulFlags: u32,
...
pub extern "cfgmgr32" fn CM_Register_Device_InterfaceA(
    dnDevInst: u32,
    InterfaceClassGuid: ?*Guid,
    pszReference: ?[*:0]align(1) const u8,
...
pub extern "cfgmgr32" fn CM_Register_Device_InterfaceW(
    dnDevInst: u32,
    InterfaceClassGuid: ?*Guid,
    pszReference: ?[*:0]align(1) const u16,
...
pub extern "cfgmgr32" fn CM_Register_Notification(
    ...
    pNotifyContext: ?*?HCMNOTIFICATION,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "newdev" fn UpdateDriverForPlugAndPlayDevicesA(
    hwndParent: ?HWND,
    HardwareId: ?[*:0]align(1) const u8,
    FullInfPath: ?[*:0]align(1) const u8,
...
pub extern "newdev" fn UpdateDriverForPlugAndPlayDevicesW(
    hwndParent: ?HWND,
    HardwareId: ?[*:0]align(1) const u16,
    FullInfPath: ?[*:0]align(1) const u16,
    InstallFlags: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS,
    bRebootRequired: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const HWPROFILEINFO_ = thismodule.HWPROFILEINFO_A;
    ...
    .wide => struct {
        ...
        pub const HWPROFILEINFO_ = thismodule.HWPROFILEINFO_W;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const HWPROFILEINFO_ = *opaque{};
        ...
        pub const HWPROFILEINFO_ = @compileError("'HWPROFILEINFO_' requires that UNICODE be set to true or false in the root module");
...
const HIMAGELIST = @import("../../../windows/win32/ui/controls.zig").HIMAGELIST;
const HINSTANCE = @import("../../../windows/win32/foundation.zig").HINSTANCE;
const HKEY = @import("../../../windows/win32/system/registry.zig").HKEY;
const HPROPSHEETPAGE = @import("../../../windows/win32/ui/controls.zig").HPROPSHEETPAGE;
const HWND = @import("../../../windows/win32/foundation.zig").HWND;
const LPARAM = @import("../../../windows/win32/foundation.zig").LPARAM;
const PRIORITY = @import("../../../windows/win32/data/html_help.zig").PRIORITY;
const PROPSHEETHEADERA_V2 = @import("../../../windows/win32/ui/controls.zig").PROPSHEETHEADERA_V2;
const PROPSHEETHEADERW_V2 = @import("../../../windows/win32/ui/controls.zig").PROPSHEETHEADERW_V2;
...
const VER_PLATFORM = @import("../../../windows/win32/system/diagnostics/debug.zig").VER_PLATFORM;
