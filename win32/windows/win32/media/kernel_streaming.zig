...
pub const RT_STRING = @import("../../../zig.zig").typedConst([*:0]align(1) const u16, @as(u16, 6));
pub const RT_RCDATA = @import("../../../zig.zig").typedConst([*:0]align(1) const u16, @as(u16, 10));
...
pub const DEVPKEY_KsAudio_PacketSize_Constraints = DEVPROPKEY { .fmtid = Guid.initIntString("333448406, 45158, 17341, 145, 59, 164, 21, 205, 19, 218, 135"), .pid = 2 };
pub const DEVPKEY_KsAudio_Controller_DeviceInterface_Path = DEVPROPKEY { .fmtid = Guid.initIntString("333448406, 45158, 17341, 145, 59, 164, 21, 205, 19, 218, 135"), .pid = 3 };
pub const DEVPKEY_KsAudio_PacketSize_Constraints2 = DEVPROPKEY { .fmtid = Guid.initIntString("2483353473, 29073, 16539, 139, 11, 128, 191, 110, 194, 41, 174"), .pid = 2 };
...
pub const KSCAMERA_EXTENDEDPROP_EYEGAZECORRECTION_STARE = @as(u64, 2);
...
pub const KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_SHALLOWFOCUS = @as(u64, 4);
...
pub const IKsPropertySet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IKsPropertySet_Set(self: *const T, guidPropSet: ?*const Guid, dwPropID: u32, pInstanceData: ?*anyopaque, cbInstanceData: u32, pPropData: ?*anyopaque, cbPropData: u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).Set(@as(*const IKsPropertySet, @ptrCast(self)), guidPropSet, dwPropID, pInstanceData, cbInstanceData, pPropData, cbPropData);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPropertySet_Get(self: *const T, guidPropSet: ?*const Guid, dwPropID: u32, pInstanceData: ?*anyopaque, cbInstanceData: u32, pPropData: ?*anyopaque, cbPropData: u32, pcbReturned: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).Get(@as(*const IKsPropertySet, @ptrCast(self)), guidPropSet, dwPropID, pInstanceData, cbInstanceData, pPropData, cbPropData, pcbReturned);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPropertySet_QuerySupported(self: *const T, guidPropSet: ?*const Guid, dwPropID: u32, pTypeSupport: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).QuerySupported(@as(*const IKsPropertySet, @ptrCast(self)), guidPropSet, dwPropID, pTypeSupport);
        }
    };}
...
const IID_IKsJackDescription3_Value = Guid.initString("e3f6778b-6660-4cc8-a291-ecc4192d9967");
pub const IID_IKsJackDescription3 = &IID_IKsJackDescription3_Value;
pub const IKsJackDescription3 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetJackCount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsJackDescription3,
                pcJacks: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsJackDescription3,
        ...
        GetJackDescription3: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsJackDescription3,
                nJack: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsJackDescription3_GetJackCount(self: *const T, pcJacks: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IKsJackDescription3.VTable, @ptrCast(self.vtable)).GetJackCount(@as(*const IKsJackDescription3, @ptrCast(self)), pcJacks);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsJackDescription3_GetJackDescription3(self: *const T, nJack: u32, pDescription3: ?*KSJACK_DESCRIPTION3) callconv(.Inline) HRESULT {
            return @as(*const IKsJackDescription3.VTable, @ptrCast(self.vtable)).GetJackDescription3(@as(*const IKsJackDescription3, @ptrCast(self)), nJack, pDescription3);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const KSPROPERTY_JACK_DESCRIPTION3 = KSPROPERTY_JACK.DESCRIPTION3;
...
pub const KSPROPERTY_AUDIOENGINE_DEVICECONTROLS = KSPROPERTY_AUDIOENGINE.DEVICECONTROLS;
...
pub const EDeviceControlUseType = enum(i32) {
    Missing = 0,
    Primary = 1,
    Secondary = 2,
};
pub const eDeviceControlUseMissing = EDeviceControlUseType.Missing;
pub const eDeviceControlUsePrimary = EDeviceControlUseType.Primary;
pub const eDeviceControlUseSecondary = EDeviceControlUseType.Secondary;
...
const IID_IKsClockPropertySet_Value = Guid.initString("5c5cbd84-e755-11d0-ac18-00a0c9223196");
pub const IID_IKsClockPropertySet = &IID_IKsClockPropertySet_Value;
pub const IKsClockPropertySet = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsGetTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                Time: ?*i64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsClockPropertySet,
        ...
        KsSetTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                Time: i64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetPhysicalTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                Time: ?*i64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsSetPhysicalTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                Time: i64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetCorrelatedTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
        ...
        KsSetCorrelatedTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                CorrelatedTime: ?*KSCORRELATED_TIME,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetCorrelatedPhysicalTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                CorrelatedTime: ?*KSCORRELATED_TIME,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsSetCorrelatedPhysicalTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                CorrelatedTime: ?*KSCORRELATED_TIME,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetResolution: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
        ...
        KsGetState: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsClockPropertySet,
                State: ?*KSSTATE,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetTime(self: *const T, Time: ?*i64) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetTime(@as(*const IKsClockPropertySet, @ptrCast(self)), Time);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsSetTime(self: *const T, Time: i64) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsSetTime(@as(*const IKsClockPropertySet, @ptrCast(self)), Time);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetPhysicalTime(self: *const T, Time: ?*i64) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetPhysicalTime(@as(*const IKsClockPropertySet, @ptrCast(self)), Time);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsSetPhysicalTime(self: *const T, Time: i64) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsSetPhysicalTime(@as(*const IKsClockPropertySet, @ptrCast(self)), Time);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetCorrelatedTime(self: *const T, CorrelatedTime: ?*KSCORRELATED_TIME) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetCorrelatedTime(@as(*const IKsClockPropertySet, @ptrCast(self)), CorrelatedTime);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsSetCorrelatedTime(self: *const T, CorrelatedTime: ?*KSCORRELATED_TIME) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsSetCorrelatedTime(@as(*const IKsClockPropertySet, @ptrCast(self)), CorrelatedTime);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetCorrelatedPhysicalTime(self: *const T, CorrelatedTime: ?*KSCORRELATED_TIME) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetCorrelatedPhysicalTime(@as(*const IKsClockPropertySet, @ptrCast(self)), CorrelatedTime);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsSetCorrelatedPhysicalTime(self: *const T, CorrelatedTime: ?*KSCORRELATED_TIME) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsSetCorrelatedPhysicalTime(@as(*const IKsClockPropertySet, @ptrCast(self)), CorrelatedTime);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetResolution(self: *const T, Resolution: ?*KSRESOLUTION) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetResolution(@as(*const IKsClockPropertySet, @ptrCast(self)), Resolution);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsClockPropertySet_KsGetState(self: *const T, State: ?*KSSTATE) callconv(.Inline) HRESULT {
            return @as(*const IKsClockPropertySet.VTable, @ptrCast(self.vtable)).KsGetState(@as(*const IKsClockPropertySet, @ptrCast(self)), State);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsAllocator_Value = Guid.initString("8da64899-c0d9-11d0-8413-0000f822fe8a");
pub const IID_IKsAllocator = &IID_IKsAllocator_Value;
pub const IKsAllocator = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsGetAllocatorHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocator,
            ) callconv(@import("std").os.windows.WINAPI) ?HANDLE,
            else => *const fn(
                self: *const IKsAllocator,
            ) callconv(@import("std").os.windows.WINAPI) ?HANDLE,
        },
        KsGetAllocatorMode: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocator,
            ) callconv(@import("std").os.windows.WINAPI) KSALLOCATORMODE,
            else => *const fn(
                self: *const IKsAllocator,
            ) callconv(@import("std").os.windows.WINAPI) KSALLOCATORMODE,
        },
        KsGetAllocatorStatus: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocator,
        ...
        KsSetAllocatorMode: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocator,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocator_KsGetAllocatorHandle(self: *const T) callconv(.Inline) ?HANDLE {
            return @as(*const IKsAllocator.VTable, @ptrCast(self.vtable)).KsGetAllocatorHandle(@as(*const IKsAllocator, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocator_KsGetAllocatorMode(self: *const T) callconv(.Inline) KSALLOCATORMODE {
            return @as(*const IKsAllocator.VTable, @ptrCast(self.vtable)).KsGetAllocatorMode(@as(*const IKsAllocator, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocator_KsGetAllocatorStatus(self: *const T, AllocatorStatus: ?*KSSTREAMALLOCATOR_STATUS) callconv(.Inline) HRESULT {
            return @as(*const IKsAllocator.VTable, @ptrCast(self.vtable)).KsGetAllocatorStatus(@as(*const IKsAllocator, @ptrCast(self)), AllocatorStatus);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocator_KsSetAllocatorMode(self: *const T, Mode: KSALLOCATORMODE) callconv(.Inline) void {
            return @as(*const IKsAllocator.VTable, @ptrCast(self.vtable)).KsSetAllocatorMode(@as(*const IKsAllocator, @ptrCast(self)), Mode);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsAllocatorEx_Value = Guid.initString("091bb63a-603f-11d1-b067-00a0c9062802");
pub const IID_IKsAllocatorEx = &IID_IKsAllocatorEx_Value;
pub const IKsAllocatorEx = extern struct {
    pub const VTable = extern struct {
        base: IKsAllocator.VTable,
        KsGetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocatorEx,
            ) callconv(@import("std").os.windows.WINAPI) ?*ALLOCATOR_PROPERTIES_EX,
            else => *const fn(
                self: *const IKsAllocatorEx,
            ) callconv(@import("std").os.windows.WINAPI) ?*ALLOCATOR_PROPERTIES_EX,
        },
        KsSetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocatorEx,
                param0: ?*ALLOCATOR_PROPERTIES_EX,
            ) callconv(@import("std").os.windows.WINAPI) void,
            else => *const fn(
                self: *const IKsAllocatorEx,
                param0: ?*ALLOCATOR_PROPERTIES_EX,
        ...
        KsSetAllocatorHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocatorEx,
        ...
        KsCreateAllocatorAndGetHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsAllocatorEx,
                KsPin: ?*IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) ?HANDLE,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IKsAllocator.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocatorEx_KsGetProperties(self: *const T) callconv(.Inline) ?*ALLOCATOR_PROPERTIES_EX {
            return @as(*const IKsAllocatorEx.VTable, @ptrCast(self.vtable)).KsGetProperties(@as(*const IKsAllocatorEx, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocatorEx_KsSetProperties(self: *const T, param0: ?*ALLOCATOR_PROPERTIES_EX) callconv(.Inline) void {
            return @as(*const IKsAllocatorEx.VTable, @ptrCast(self.vtable)).KsSetProperties(@as(*const IKsAllocatorEx, @ptrCast(self)), param0);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocatorEx_KsSetAllocatorHandle(self: *const T, AllocatorHandle: ?HANDLE) callconv(.Inline) void {
            return @as(*const IKsAllocatorEx.VTable, @ptrCast(self.vtable)).KsSetAllocatorHandle(@as(*const IKsAllocatorEx, @ptrCast(self)), AllocatorHandle);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsAllocatorEx_KsCreateAllocatorAndGetHandle(self: *const T, KsPin: ?*IKsPin) callconv(.Inline) ?HANDLE {
            return @as(*const IKsAllocatorEx.VTable, @ptrCast(self.vtable)).KsCreateAllocatorAndGetHandle(@as(*const IKsAllocatorEx, @ptrCast(self)), KsPin);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const KSPEEKOPERATION = enum(i32) {
    PeekOnly = 0,
    AddRef = 1,
};
pub const KsPeekOperation_PeekOnly = KSPEEKOPERATION.PeekOnly;
pub const KsPeekOperation_AddRef = KSPEEKOPERATION.AddRef;

const IID_IKsPin_Value = Guid.initString("b61178d1-a2d9-11cf-9e53-00aa00a216a1");
pub const IID_IKsPin = &IID_IKsPin_Value;
pub const IKsPin = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsQueryMediums: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                MediumList: ?*?*KSMULTIPLE_ITEM,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPin,
                MediumList: ?*?*KSMULTIPLE_ITEM,
        ...
        KsQueryInterfaces: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                InterfaceList: ?*?*KSMULTIPLE_ITEM,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPin,
                InterfaceList: ?*?*KSMULTIPLE_ITEM,
        ...
        KsCreateSinkPinHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                Interface: ?*KSIDENTIFIER,
                Medium: ?*KSIDENTIFIER,
        ...
        KsGetCurrentCommunication: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
        ...
        KsPropagateAcquire: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        KsDeliver: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                Sample: ?*IMediaSample,
                Flags: u32,
        ...
        KsMediaSamplesCompleted: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                StreamSegment: ?*KSSTREAM_SEGMENT,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPin,
                StreamSegment: ?*KSSTREAM_SEGMENT,
        ...
        KsPeekAllocator: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                Operation: KSPEEKOPERATION,
            ) callconv(@import("std").os.windows.WINAPI) ?*IMemAllocator,
            else => *const fn(
                self: *const IKsPin,
                Operation: KSPEEKOPERATION,
            ) callconv(@import("std").os.windows.WINAPI) ?*IMemAllocator,
        },
        KsReceiveAllocator: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                MemAllocator: ?*IMemAllocator,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPin,
                MemAllocator: ?*IMemAllocator,
        ...
        KsRenegotiateAllocator: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        KsIncrementPendingIoCount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
        ...
        KsDecrementPendingIoCount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) i32,
            else => *const fn(
        ...
        KsQualityNotify: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPin,
                Proportion: u32,
                TimeDelta: i64,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsQueryMediums(self: *const T, MediumList: ?*?*KSMULTIPLE_ITEM) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsQueryMediums(@as(*const IKsPin, @ptrCast(self)), MediumList);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsQueryInterfaces(self: *const T, InterfaceList: ?*?*KSMULTIPLE_ITEM) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsQueryInterfaces(@as(*const IKsPin, @ptrCast(self)), InterfaceList);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsCreateSinkPinHandle(self: *const T, Interface: ?*KSIDENTIFIER, Medium: ?*KSIDENTIFIER) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsCreateSinkPinHandle(@as(*const IKsPin, @ptrCast(self)), Interface, Medium);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsGetCurrentCommunication(self: *const T, Communication: ?*KSPIN_COMMUNICATION, Interface: ?*KSIDENTIFIER, Medium: ?*KSIDENTIFIER) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsGetCurrentCommunication(@as(*const IKsPin, @ptrCast(self)), Communication, Interface, Medium);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsPropagateAcquire(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsPropagateAcquire(@as(*const IKsPin, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsDeliver(self: *const T, Sample: ?*IMediaSample, Flags: u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsDeliver(@as(*const IKsPin, @ptrCast(self)), Sample, Flags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsMediaSamplesCompleted(self: *const T, StreamSegment: ?*KSSTREAM_SEGMENT) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsMediaSamplesCompleted(@as(*const IKsPin, @ptrCast(self)), StreamSegment);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsPeekAllocator(self: *const T, Operation: KSPEEKOPERATION) callconv(.Inline) ?*IMemAllocator {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsPeekAllocator(@as(*const IKsPin, @ptrCast(self)), Operation);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsReceiveAllocator(self: *const T, MemAllocator: ?*IMemAllocator) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsReceiveAllocator(@as(*const IKsPin, @ptrCast(self)), MemAllocator);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsRenegotiateAllocator(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsRenegotiateAllocator(@as(*const IKsPin, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsIncrementPendingIoCount(self: *const T) callconv(.Inline) i32 {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsIncrementPendingIoCount(@as(*const IKsPin, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsDecrementPendingIoCount(self: *const T) callconv(.Inline) i32 {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsDecrementPendingIoCount(@as(*const IKsPin, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPin_KsQualityNotify(self: *const T, Proportion: u32, TimeDelta: i64) callconv(.Inline) HRESULT {
            return @as(*const IKsPin.VTable, @ptrCast(self.vtable)).KsQualityNotify(@as(*const IKsPin, @ptrCast(self)), Proportion, TimeDelta);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsPinEx_Value = Guid.initString("7bb38260-d19c-11d2-b38a-00a0c95ec22e");
pub const IID_IKsPinEx = &IID_IKsPinEx_Value;
pub const IKsPinEx = extern struct {
    pub const VTable = extern struct {
        base: IKsPin.VTable,
        KsNotifyError: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinEx,
                Sample: ?*IMediaSample,
                hr: HRESULT,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IKsPin.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinEx_KsNotifyError(self: *const T, Sample: ?*IMediaSample, hr: HRESULT) callconv(.Inline) void {
            return @as(*const IKsPinEx.VTable, @ptrCast(self.vtable)).KsNotifyError(@as(*const IKsPinEx, @ptrCast(self)), Sample, hr);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsPinPipe_Value = Guid.initString("e539cd90-a8b4-11d1-8189-00a0c9062802");
pub const IID_IKsPinPipe = &IID_IKsPinPipe_Value;
pub const IKsPinPipe = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsGetPinFramingCache: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                FramingEx: ?*?*KSALLOCATOR_FRAMING_EX,
                FramingProp: ?*FRAMING_PROP,
        ...
        KsSetPinFramingCache: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                FramingEx: ?*KSALLOCATOR_FRAMING_EX,
                FramingProp: ?*FRAMING_PROP,
        ...
        KsGetConnectedPin: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
            ) callconv(@import("std").os.windows.WINAPI) ?*IPin,
            else => *const fn(
                self: *const IKsPinPipe,
            ) callconv(@import("std").os.windows.WINAPI) ?*IPin,
        },
        KsGetPipe: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                Operation: KSPEEKOPERATION,
            ) callconv(@import("std").os.windows.WINAPI) ?*IKsAllocatorEx,
            else => *const fn(
                self: *const IKsPinPipe,
                Operation: KSPEEKOPERATION,
            ) callconv(@import("std").os.windows.WINAPI) ?*IKsAllocatorEx,
        },
        KsSetPipe: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                KsAllocator: ?*IKsAllocatorEx,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPinPipe,
                KsAllocator: ?*IKsAllocatorEx,
        ...
        KsGetPipeAllocatorFlag: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
        ...
        KsSetPipeAllocatorFlag: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                Flag: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetPinBusCache: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
        ...
        KsSetPinBusCache: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
                Bus: Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsGetPinName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
        ...
        KsGetFilterName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinPipe,
            ) callconv(@import("std").os.windows.WINAPI) ?PWSTR,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetPinFramingCache(self: *const T, FramingEx: ?*?*KSALLOCATOR_FRAMING_EX, FramingProp: ?*FRAMING_PROP, Option: FRAMING_CACHE_OPS) callconv(.Inline) HRESULT {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetPinFramingCache(@as(*const IKsPinPipe, @ptrCast(self)), FramingEx, FramingProp, Option);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsSetPinFramingCache(self: *const T, FramingEx: ?*KSALLOCATOR_FRAMING_EX, FramingProp: ?*FRAMING_PROP, Option: FRAMING_CACHE_OPS) callconv(.Inline) HRESULT {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsSetPinFramingCache(@as(*const IKsPinPipe, @ptrCast(self)), FramingEx, FramingProp, Option);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetConnectedPin(self: *const T) callconv(.Inline) ?*IPin {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetConnectedPin(@as(*const IKsPinPipe, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetPipe(self: *const T, Operation: KSPEEKOPERATION) callconv(.Inline) ?*IKsAllocatorEx {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetPipe(@as(*const IKsPinPipe, @ptrCast(self)), Operation);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsSetPipe(self: *const T, KsAllocator: ?*IKsAllocatorEx) callconv(.Inline) HRESULT {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsSetPipe(@as(*const IKsPinPipe, @ptrCast(self)), KsAllocator);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetPipeAllocatorFlag(self: *const T) callconv(.Inline) u32 {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetPipeAllocatorFlag(@as(*const IKsPinPipe, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsSetPipeAllocatorFlag(self: *const T, Flag: u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsSetPipeAllocatorFlag(@as(*const IKsPinPipe, @ptrCast(self)), Flag);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetPinBusCache(self: *const T) callconv(.Inline) Guid {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetPinBusCache(@as(*const IKsPinPipe, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsSetPinBusCache(self: *const T, Bus: Guid) callconv(.Inline) HRESULT {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsSetPinBusCache(@as(*const IKsPinPipe, @ptrCast(self)), Bus);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetPinName(self: *const T) callconv(.Inline) ?PWSTR {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetPinName(@as(*const IKsPinPipe, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinPipe_KsGetFilterName(self: *const T) callconv(.Inline) ?PWSTR {
            return @as(*const IKsPinPipe.VTable, @ptrCast(self.vtable)).KsGetFilterName(@as(*const IKsPinPipe, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsPinFactory_Value = Guid.initString("cd5ebe6b-8b6e-11d1-8ae0-00a0c9223196");
pub const IID_IKsPinFactory = &IID_IKsPinFactory_Value;
pub const IKsPinFactory = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsPinFactory: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsPinFactory,
                PinFactory: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsPinFactory,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsPinFactory_KsPinFactory(self: *const T, PinFactory: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IKsPinFactory.VTable, @ptrCast(self.vtable)).KsPinFactory(@as(*const IKsPinFactory, @ptrCast(self)), PinFactory);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const KSIOOPERATION = enum(i32) {
    Write = 0,
    Read = 1,
};
pub const KsIoOperation_Write = KSIOOPERATION.Write;
pub const KsIoOperation_Read = KSIOOPERATION.Read;

const IID_IKsDataTypeHandler_Value = Guid.initString("5ffbaa02-49a3-11d0-9f36-00aa00a216a1");
pub const IID_IKsDataTypeHandler = &IID_IKsDataTypeHandler_Value;
pub const IKsDataTypeHandler = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsCompleteIoOperation: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeHandler,
                Sample: ?*IMediaSample,
                StreamHeader: ?*anyopaque,
        ...
        KsIsMediaTypeInRanges: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeHandler,
                DataRanges: ?*anyopaque,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsDataTypeHandler,
                DataRanges: ?*anyopaque,
        ...
        KsPrepareIoOperation: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeHandler,
                Sample: ?*IMediaSample,
                StreamHeader: ?*anyopaque,
        ...
        KsQueryExtendedSize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeHandler,
                ExtendedSize: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        KsSetMediaType: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeHandler,
                AmMediaType: ?*const AM_MEDIA_TYPE,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsDataTypeHandler,
                AmMediaType: ?*const AM_MEDIA_TYPE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeHandler_KsCompleteIoOperation(self: *const T, Sample: ?*IMediaSample, StreamHeader: ?*anyopaque, IoOperation: KSIOOPERATION, Cancelled: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeHandler.VTable, @ptrCast(self.vtable)).KsCompleteIoOperation(@as(*const IKsDataTypeHandler, @ptrCast(self)), Sample, StreamHeader, IoOperation, Cancelled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeHandler_KsIsMediaTypeInRanges(self: *const T, DataRanges: ?*anyopaque) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeHandler.VTable, @ptrCast(self.vtable)).KsIsMediaTypeInRanges(@as(*const IKsDataTypeHandler, @ptrCast(self)), DataRanges);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeHandler_KsPrepareIoOperation(self: *const T, Sample: ?*IMediaSample, StreamHeader: ?*anyopaque, IoOperation: KSIOOPERATION) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeHandler.VTable, @ptrCast(self.vtable)).KsPrepareIoOperation(@as(*const IKsDataTypeHandler, @ptrCast(self)), Sample, StreamHeader, IoOperation);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeHandler_KsQueryExtendedSize(self: *const T, ExtendedSize: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeHandler.VTable, @ptrCast(self.vtable)).KsQueryExtendedSize(@as(*const IKsDataTypeHandler, @ptrCast(self)), ExtendedSize);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeHandler_KsSetMediaType(self: *const T, AmMediaType: ?*const AM_MEDIA_TYPE) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeHandler.VTable, @ptrCast(self.vtable)).KsSetMediaType(@as(*const IKsDataTypeHandler, @ptrCast(self)), AmMediaType);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsDataTypeCompletion_Value = Guid.initString("827d1a0e-0f73-11d2-b27a-00a0c9223196");
pub const IID_IKsDataTypeCompletion = &IID_IKsDataTypeCompletion_Value;
pub const IKsDataTypeCompletion = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsCompleteMediaType: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsDataTypeCompletion,
                FilterHandle: ?HANDLE,
                PinFactoryId: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsDataTypeCompletion_KsCompleteMediaType(self: *const T, FilterHandle: ?HANDLE, PinFactoryId: u32, AmMediaType: ?*AM_MEDIA_TYPE) callconv(.Inline) HRESULT {
            return @as(*const IKsDataTypeCompletion.VTable, @ptrCast(self.vtable)).KsCompleteMediaType(@as(*const IKsDataTypeCompletion, @ptrCast(self)), FilterHandle, PinFactoryId, AmMediaType);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsInterfaceHandler_Value = Guid.initString("d3abc7e0-9a61-11d0-a40d-00a0c9223196");
pub const IID_IKsInterfaceHandler = &IID_IKsInterfaceHandler_Value;
pub const IKsInterfaceHandler = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsSetPin: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsInterfaceHandler,
                KsPin: ?*IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IKsInterfaceHandler,
        ...
        KsProcessMediaSamples: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsInterfaceHandler,
        ...
        KsCompleteIo: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsInterfaceHandler,
                StreamSegment: ?*KSSTREAM_SEGMENT,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsInterfaceHandler_KsSetPin(self: *const T, KsPin: ?*IKsPin) callconv(.Inline) HRESULT {
            return @as(*const IKsInterfaceHandler.VTable, @ptrCast(self.vtable)).KsSetPin(@as(*const IKsInterfaceHandler, @ptrCast(self)), KsPin);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsInterfaceHandler_KsProcessMediaSamples(self: *const T, KsDataTypeHandler: ?*IKsDataTypeHandler, SampleList: [*]?*IMediaSample, SampleCount: ?*i32, IoOperation: KSIOOPERATION, StreamSegment: ?*?*KSSTREAM_SEGMENT) callconv(.Inline) HRESULT {
            return @as(*const IKsInterfaceHandler.VTable, @ptrCast(self.vtable)).KsProcessMediaSamples(@as(*const IKsInterfaceHandler, @ptrCast(self)), KsDataTypeHandler, SampleList, SampleCount, IoOperation, StreamSegment);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsInterfaceHandler_KsCompleteIo(self: *const T, StreamSegment: ?*KSSTREAM_SEGMENT) callconv(.Inline) HRESULT {
            return @as(*const IKsInterfaceHandler.VTable, @ptrCast(self.vtable)).KsCompleteIo(@as(*const IKsInterfaceHandler, @ptrCast(self)), StreamSegment);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const KSSTREAM_SEGMENT = extern struct {
...
const IID_IKsObject_Value = Guid.initString("423c13a2-2070-11d0-9ef7-00aa00a216a1");
pub const IID_IKsObject = &IID_IKsObject_Value;
pub const IKsObject = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsGetObjectHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsObject,
            ) callconv(@import("std").os.windows.WINAPI) ?HANDLE,
            else => *const fn(
                self: *const IKsObject,
            ) callconv(@import("std").os.windows.WINAPI) ?HANDLE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsObject_KsGetObjectHandle(self: *const T) callconv(.Inline) ?HANDLE {
            return @as(*const IKsObject.VTable, @ptrCast(self.vtable)).KsGetObjectHandle(@as(*const IKsObject, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsQualityForwarder_Value = Guid.initString("97ebaacb-95bd-11d0-a3ea-00a0c9223196");
pub const IID_IKsQualityForwarder = &IID_IKsQualityForwarder_Value;
pub const IKsQualityForwarder = extern struct {
    pub const VTable = extern struct {
        base: IKsObject.VTable,
        KsFlushClient: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsQualityForwarder,
                Pin: ?*IKsPin,
            ) callconv(@import("std").os.windows.WINAPI) void,
            else => *const fn(
                self: *const IKsQualityForwarder,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IKsObject.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsQualityForwarder_KsFlushClient(self: *const T, Pin: ?*IKsPin) callconv(.Inline) void {
            return @as(*const IKsQualityForwarder.VTable, @ptrCast(self.vtable)).KsFlushClient(@as(*const IKsQualityForwarder, @ptrCast(self)), Pin);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IKsNotifyEvent_Value = Guid.initString("412bd695-f84b-46c1-ac73-54196dbc8fa7");
pub const IID_IKsNotifyEvent = &IID_IKsNotifyEvent_Value;
pub const IKsNotifyEvent = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        KsNotifyEvent: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IKsNotifyEvent,
                Event: u32,
                lParam1: usize,
                lParam2: usize,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IKsNotifyEvent_KsNotifyEvent(self: *const T, Event: u32, lParam1: usize, lParam2: usize) callconv(.Inline) HRESULT {
            return @as(*const IKsNotifyEvent.VTable, @ptrCast(self.vtable)).KsNotifyEvent(@as(*const IKsNotifyEvent, @ptrCast(self)), Event, lParam1, lParam2);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub extern "ksproxy" fn KsResolveRequiredAttributes(
    DataRange: ?*KSDATAFORMAT,
    Attributes: ?*KSMULTIPLE_ITEM,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "ksproxy" fn KsOpenDefaultDevice(
    Category: ?*const Guid,
    Access: u32,
    DeviceHandle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "ksproxy" fn KsSynchronousDeviceControl(
    Handle: ?HANDLE,
    IoControl: u32,
    // TODO: what to do with BytesParamIndex 3?
    InBuffer: ?*anyopaque,
...
pub extern "ksproxy" fn KsGetMultiplePinFactoryItems(
    FilterHandle: ?HANDLE,
    PinFactoryId: u32,
    PropertyId: u32,
    Items: ?*?*anyopaque,
...
pub extern "ksproxy" fn KsGetMediaTypeCount(
    FilterHandle: ?HANDLE,
    PinFactoryId: u32,
    MediaTypeCount: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "ksproxy" fn KsGetMediaType(
    Position: i32,
    AmMediaType: ?*AM_MEDIA_TYPE,
    FilterHandle: ?HANDLE,
    PinFactoryId: u32,
...
const IMediaSample = @import("../../../windows/win32/media/direct_show.zig").IMediaSample;
const IMemAllocator = @import("../../../windows/win32/media/direct_show.zig").IMemAllocator;
