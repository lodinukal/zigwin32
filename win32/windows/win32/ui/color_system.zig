...
pub const COLOR_MATCH_TO_TARGET_ACTION = enum(u32) {
    ENABLE = 1,
    DISABLE = 2,
    DELETE_TRANSFORM = 3,
};
...
pub const ENUMTYPEA = extern struct {
    ...
    dwVersion: u32,
    dwFields: u32,
    pDeviceName: ?[*:0]align(1) const u8,
    dwMediaType: u32,
    dwDitheringMode: u32,
    dwResolution: [2]u32,
    dwCMMType: u32,
...
pub const ENUMTYPEW = extern struct {
    ...
    dwVersion: u32,
    dwFields: u32,
    pDeviceName: ?[*:0]align(1) const u16,
    dwMediaType: u32,
    dwDitheringMode: u32,
    dwResolution: [2]u32,
    dwCMMType: u32,
...
pub extern "mscms" fn InstallColorProfileA(
    pMachineName: ?[*:0]align(1) const u8,
    pProfileName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "mscms" fn InstallColorProfileW(
    pMachineName: ?[*:0]align(1) const u16,
    pProfileName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
const CIEXYZ = @import("../../../windows/win32/graphics/gdi.zig").CIEXYZ;
const CIEXYZTRIPLE = @import("../../../windows/win32/graphics/gdi.zig").CIEXYZTRIPLE;
...
const EMR = @import("../../../windows/win32/graphics/gdi.zig").EMR;
...
const RGBTRIPLE = @import("../../../windows/win32/graphics/gdi.zig").RGBTRIPLE;
