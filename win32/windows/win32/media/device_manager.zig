...
pub const IWMDMMetaData = extern struct {
    pub const VTable = extern struct {
        ...
        AddItem: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszTagName: ?[*:0]align(1) const u16,
                pValue: ?[*:0]u8,
                iLength: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IWMDMMetaData_AddItem(self: *const T, Type: WMDM_TAG_DATATYPE, pwszTagName: ?[*:0]align(1) const u16, pValue: ?[*:0]u8, iLength: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMMetaData_QueryByName(self: *const T, pwszTagName: ?[*:0]align(1) const u16, pType: ?*WMDM_TAG_DATATYPE, pValue: ?*?*u8, pcbLength: ?*u32) callconv(.Inline) HRESULT {
...
pub const IWMDeviceManager2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetDeviceFromCanonicalName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszCanonicalName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDeviceManager2_GetDeviceFromCanonicalName(self: *const T, pwszCanonicalName: ?[*:0]align(1) const u16, ppDevice: ?*?*IWMDMDevice) callconv(.Inline) HRESULT {
...
pub const IWMDMStorageGlobals = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMStorageGlobals_GetSerialNumber(self: *const T, pSerialNum: ?*WMDMID, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IWMDMStorage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMStorage_GetRights(self: *const T, ppRights: ?*?*WMDMRIGHTS, pnRightsCount: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IWMDMStorage2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetStorage: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszStorageName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMStorage2_GetStorage(self: *const T, pszStorageName: ?[*:0]align(1) const u16, ppStorage: ?*?*IWMDMStorage) callconv(.Inline) HRESULT {
...
pub const IWMDMStorage4 = extern struct {
    pub const VTable = extern struct {
        ...
        GetSpecifiedMetadata: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWMDMStorage4,
                cProperties: u32,
                ppwszPropNames: [*]const ?[*:0]align(1) const u16,
                ppMetadata: ?*?*IWMDMMetaData,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWMDMStorage4,
        ...
        FindStorage: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszUniqueID: ?[*:0]align(1) const u16,
                ppStorage: ?*?*IWMDMStorage,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWMDMStorage4,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMStorage4_GetSpecifiedMetadata(self: *const T, cProperties: u32, ppwszPropNames: [*]const ?[*:0]align(1) const u16, ppMetadata: ?*?*IWMDMMetaData) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMStorage4_FindStorage(self: *const T, findScope: WMDM_FIND_SCOPE, pwszUniqueID: ?[*:0]align(1) const u16, ppStorage: ?*?*IWMDMStorage) callconv(.Inline) HRESULT {
...
pub const IWMDMOperation = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMOperation_TransferObjectData(self: *const T, pData: [*:0]u8, pdwSize: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IWMDMDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMDevice_GetSerialNumber(self: *const T, pSerialNumber: ?*WMDMID, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IWMDMDevice2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMDevice2_GetStorage(self: *const T, pszStorageName: ?[*:0]align(1) const u16, ppStorage: ?*?*IWMDMStorage) callconv(.Inline) HRESULT {
...
pub const IWMDMDevice3 = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperty: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszPropName: ?[*:0]align(1) const u16,
                pValue: ?*PROPVARIANT,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWMDMDevice3,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMDevice3_GetProperty(self: *const T, pwszPropName: ?[*:0]align(1) const u16, pValue: ?*PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMDevice3_SetProperty(self: *const T, pwszPropName: ?[*:0]align(1) const u16, pValue: ?*const PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMDevice3_FindStorage(self: *const T, findScope: WMDM_FIND_SCOPE, pwszUniqueID: ?[*:0]align(1) const u16, ppStorage: ?*?*IWMDMStorage) callconv(.Inline) HRESULT {
...
pub const IWMDMNotification = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMDMNotification_WMDMMessage(self: *const T, dwMessageType: u32, pwszCanonicalName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IMDServiceProvider2 = extern struct {
    pub const VTable = extern struct {
        ...
        CreateDevice: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszDevicePath: ?[*:0]align(1) const u16,
                pdwCount: ?*u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDServiceProvider2_CreateDevice(self: *const T, pwszDevicePath: ?[*:0]align(1) const u16, pdwCount: ?*u32, pppDeviceArray: ?*?*?*IMDSPDevice) callconv(.Inline) HRESULT {
...
pub const IMDSPDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDevice_GetSerialNumber(self: *const T, pSerialNumber: ?*WMDMID, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IMDSPDevice2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDevice2_GetStorage(self: *const T, pszStorageName: ?[*:0]align(1) const u16, ppStorage: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
...
pub const IMDSPDevice3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDevice3_GetProperty(self: *const T, pwszPropName: ?[*:0]align(1) const u16, pValue: ?*PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDevice3_SetProperty(self: *const T, pwszPropName: ?[*:0]align(1) const u16, pValue: ?*const PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDevice3_FindStorage(self: *const T, findScope: WMDM_FIND_SCOPE, pwszUniqueID: ?[*:0]align(1) const u16, ppStorage: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
...
pub const IMDSPStorage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorage_GetRights(self: *const T, ppRights: ?*?*WMDMRIGHTS, pnRightsCount: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IMDSPStorage2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorage2_GetStorage(self: *const T, pszStorageName: ?[*:0]align(1) const u16, ppStorage: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
...
pub const IMDSPStorage4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorage4_CreateStorageWithMetadata(self: *const T, dwAttributes: u32, pwszName: ?[*:0]align(1) const u16, pMetadata: ?*IWMDMMetaData, qwFileSize: u64, ppNewStorage: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorage4_GetSpecifiedMetadata(self: *const T, cProperties: u32, ppwszPropNames: [*]const ?[*:0]align(1) const u16, pMetadata: ?*IWMDMMetaData) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorage4_FindStorage(self: *const T, findScope: WMDM_FIND_SCOPE, pwszUniqueID: ?[*:0]align(1) const u16, ppStorage: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
...
pub const IMDSPStorageGlobals = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPStorageGlobals_GetSerialNumber(self: *const T, pSerialNum: ?*WMDMID, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IMDSPObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPObject_Read(self: *const T, pData: [*:0]u8, pdwSize: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
            return @as(*const IMDSPObject.VTable, @ptrCast(self.vtable)).Read(@as(*const IMDSPObject, @ptrCast(self)), pData, pdwSize, abMac);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPObject_Write(self: *const T, pData: [*:0]u8, pdwSize: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const IMDSPDirectTransfer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMDSPDirectTransfer_TransferToDevice(self: *const T, pwszSourceFilePath: ?[*:0]align(1) const u16, pSourceOperation: ?*IWMDMOperation, fuFlags: u32, pwszDestinationName: ?PWSTR, pSourceMetaData: ?*IWMDMMetaData, pTransferProgress: ?*IWMDMProgress, ppNewObject: ?*?*IMDSPStorage) callconv(.Inline) HRESULT {
...
pub const ISCPSecureQuery = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureQuery_GetDataDemands(self: *const T, pfuFlags: ?*u32, pdwMinRightsData: ?*u32, pdwMinExamineData: ?*u32, pdwMinDecideData: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureQuery_ExamineData(self: *const T, fuFlags: u32, pwszExtension: ?PWSTR, pData: [*:0]u8, dwSize: u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureQuery_MakeDecision(self: *const T, fuFlags: u32, pData: [*:0]u8, dwSize: u32, dwAppSec: u32, pbSPSessionKey: [*:0]u8, dwSessionKeyLen: u32, pStorageGlobals: ?*IMDSPStorageGlobals, ppExchange: ?*?*ISCPSecureExchange, abMac: *[8]u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureQuery_GetRights(self: *const T, pData: [*:0]u8, dwSize: u32, pbSPSessionKey: [*:0]u8, dwSessionKeyLen: u32, pStgGlobals: ?*IMDSPStorageGlobals, ppRights: ?*?*WMDMRIGHTS, pnRightsCount: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const ISCPSecureExchange = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureExchange_TransferContainerData(self: *const T, pData: [*:0]u8, dwSize: u32, pfuReadyFlags: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureExchange_ObjectData(self: *const T, pData: [*:0]u8, pdwSize: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
pub const ISCPSecureExchange2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISCPSecureExchange2_TransferContainerData2(self: *const T, pData: [*:0]u8, dwSize: u32, pProgressCallback: ?*IWMDMProgress3, pfuReadyFlags: ?*u32, abMac: *[8]u8) callconv(.Inline) HRESULT {
...
const ISpecifyPropertyPages = @import("../../../windows/win32/system/ole.zig").ISpecifyPropertyPages;
...
const VIDEOINFOHEADER = @import("../../../windows/win32/media/media_foundation.zig").VIDEOINFOHEADER;
