...
pub const VIRTUAL_DISK_ACCESS_MASK = enum(i32) {
    NONE = 0,
    ATTACH_RO = 65536,
    ATTACH_RW = 131072,
    DETACH = 262144,
...
pub const OPEN_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
    NO_PARENTS = 1,
    BLANK_FILE = 2,
    BOOT_DRIVE = 4,
...
pub const CREATE_VIRTUAL_DISK_PARAMETERS = extern struct {
    ...
    Anonymous: extern union {
        Version1: extern struct {
            ...
            ParentPath: ?[*:0]align(1) const u16,
        ...
        Version3: extern struct {
            ...
            SourceVirtualStorageType: VIRTUAL_STORAGE_TYPE,
            ResiliencyGuid: Guid,
            SourceLimitPath: ?[*:0]align(1) const u16,
...
pub const CREATE_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
...
pub const ATTACH_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
    READ_ONLY = 1,
    NO_DRIVE_LETTER = 2,
...
pub const DETACH_VIRTUAL_DISK_FLAG = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const DEPENDENT_DISK_FLAG = enum(i32) {
    NONE = 0,
...
pub const GET_STORAGE_DEPENDENCY_FLAG = enum(i32) {
    NONE = 0,
    HOST_VOLUMES = 1,
    DISK_HANDLE = 2,
    _,
...
pub const SET_VIRTUAL_DISK_INFO = extern struct {
    ...
    Anonymous: extern union {
        ParentFilePath: ?[*:0]align(1) const u16,
...
pub const COMPACT_VIRTUAL_DISK_FLAG = enum(i32) {
    NE = 0,
    _ZERO_SCAN = 1,
    _BLOCK_MOVES = 2,
    _,
...
pub const MERGE_VIRTUAL_DISK_FLAG = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const EXPAND_VIRTUAL_DISK_FLAG = enum(i32) {
    NE = 0,
    TIFY_CHANGE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const RESIZE_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
...
pub const MIRROR_VIRTUAL_DISK_PARAMETERS = extern struct {
    ...
    Anonymous: extern union {
        Version1: extern struct {
            MirrorVirtualDiskPath: ?[*:0]align(1) const u16,
        },
    },
};

pub const MIRROR_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
    EXISTING_FILE = 1,
...
pub const QUERY_CHANGES_VIRTUAL_DISK_FLAG = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const TAKE_SNAPSHOT_VHDSET_FLAG = enum(i32) {
    NONE = 0,
    WRITEABLE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const DELETE_SNAPSHOT_VHDSET_FLAG = enum(i32) {
    NONE = 0,
    PERSIST_RCT = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const MODIFY_VHDSET_FLAG = enum(i32) {
    NONE = 0,
...
pub const MODIFY_VHDSET_PARAMETERS = extern struct {
    ...
    Anonymous: extern union {
        SnapshotPath: extern struct {
            SnapshotId: Guid,
            SnapshotFilePath: ?[*:0]align(1) const u16,
        },
        SnapshotId: Guid,
        DefaultFilePath: ?[*:0]align(1) const u16,
    },
};

pub const APPLY_SNAPSHOT_VHDSET_FLAG = enum(i32) {
    NONE = 0,
    WRITEABLE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const RAW_SCSI_VIRTUAL_DISK_FLAG = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const FORK_VIRTUAL_DISK_PARAMETERS = extern struct {
    ...
    Anonymous: extern union {
        Version1: extern struct {
            ForkedVirtualDiskPath: ?[*:0]align(1) const u16,
        },
    },
};

pub const FORK_VIRTUAL_DISK_FLAG = enum(i32) {
    NONE = 0,
    EXISTING_FILE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub extern "virtdisk" fn QueryChangesVirtualDisk(
    VirtualDiskHandle: ?HANDLE,
    ChangeTrackingId: ?[*:0]align(1) const u16,
    ByteOffset: u64,
    ByteLength: u64,
