...
pub const IContactManager = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszAppName: ?[*:0]align(1) const u16,
                pszAppVersion: ?[*:0]align(1) const u16,
        ...
        Load: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactManager,
                pszContactID: ?[*:0]align(1) const u16,
                ppContact: ?*?*IContact,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactManager,
        ...
        MergeContactIDs: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactManager,
                pszNewContactID: ?[*:0]align(1) const u16,
                pszOldContactID: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactManager,
                pszNewContactID: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IContactManager_Initialize(self: *const T, pszAppName: ?[*:0]align(1) const u16, pszAppVersion: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactManager_Load(self: *const T, pszContactID: ?[*:0]align(1) const u16, ppContact: ?*?*IContact) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactManager_MergeContactIDs(self: *const T, pszNewContactID: ?[*:0]align(1) const u16, pszOldContactID: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactProperties = extern struct {
    pub const VTable = extern struct {
        ...
        GetLabels: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactProperties,
                pszArrayElementName: ?[*:0]align(1) const u16,
                dwFlags: u32,
                pszLabels: [*:0]u16,
                cchLabels: u32,
        ...
        SetBinary: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszPropertyName: ?[*:0]align(1) const u16,
                dwFlags: u32,
                pszContentType: ?[*:0]align(1) const u16,
                pStream: ?*IStream,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactProperties,
        ...
        SetLabels: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                dwFlags: u32,
                dwLabelCount: u32,
                ppszLabels: [*]const ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactProperties,
                pszArrayElementName: ?[*:0]align(1) const u16,
        ...
        CreateArrayNode: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactProperties,
                pszArrayName: ?[*:0]align(1) const u16,
                dwFlags: u32,
                fAppend: BOOL,
        ...
        GetPropertyCollection: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                dwFlags: u32,
                pszMultiValueName: ?[*:0]align(1) const u16,
                dwLabelCount: u32,
                ppszLabels: [*]const ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_GetString(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, pszValue: [*:0]u16, cchValue: u32, pdwcchPropertyValueRequired: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_GetDate(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, pftDateTime: ?*FILETIME) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_GetBinary(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, pszContentType: [*:0]u16, cchContentType: u32, pdwcchContentTypeRequired: ?*u32, ppStream: ?*?*IStream) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_GetLabels(self: *const T, pszArrayElementName: ?[*:0]align(1) const u16, dwFlags: u32, pszLabels: [*:0]u16, cchLabels: u32, pdwcchLabelsRequired: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_SetString(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, pszValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_SetDate(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, ftDateTime: FILETIME) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_SetBinary(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32, pszContentType: ?[*:0]align(1) const u16, pStream: ?*IStream) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_SetLabels(self: *const T, pszArrayElementName: ?[*:0]align(1) const u16, dwFlags: u32, dwLabelCount: u32, ppszLabels: [*]const ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_CreateArrayNode(self: *const T, pszArrayName: ?[*:0]align(1) const u16, dwFlags: u32, fAppend: BOOL, pszNewArrayElementName: [*:0]u16, cchNewArrayElementName: u32, pdwcchNewArrayElementNameRequired: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_DeleteProperty(self: *const T, pszPropertyName: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_DeleteArrayNode(self: *const T, pszArrayElementName: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_DeleteLabels(self: *const T, pszArrayElementName: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactProperties_GetPropertyCollection(self: *const T, ppPropertyCollection: ?*?*IContactPropertyCollection, dwFlags: u32, pszMultiValueName: ?[*:0]align(1) const u16, dwLabelCount: u32, ppszLabels: [*]const ?[*:0]align(1) const u16, fAnyLabelMatches: BOOL) callconv(.Inline) HRESULT {
...
pub const IContactAggregationManager = extern struct {
    pub const VTable = extern struct {
        ...
        CreateOrOpenGroup: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactAggregationManager,
                pGroupName: ?[*:0]align(1) const u16,
        ...
        get_ServerContactLinks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactAggregationManager,
                pPersonItemId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_CreateOrOpenGroup(self: *const T, pGroupName: ?[*:0]align(1) const u16, options: CONTACT_AGGREGATION_CREATE_OR_OPEN_OPTIONS, pCreatedGroup: ?*BOOL, ppGroup: ?*?*IContactAggregationGroup) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_OpenAggregateContact(self: *const T, pItemId: ?[*:0]align(1) const u16, ppItem: ?*?*IContactAggregationAggregate) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_OpenContact(self: *const T, pItemId: ?[*:0]align(1) const u16, ppItem: ?*?*IContactAggregationContact) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_OpenServerContactLink(self: *const T, pItemId: ?[*:0]align(1) const u16, ppItem: ?*?*IContactAggregationLink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_OpenServerPerson(self: *const T, pItemId: ?[*:0]align(1) const u16, ppItem: ?*?*IContactAggregationServerPerson) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationManager_get_ServerContactLinks(self: *const T, pPersonItemId: ?[*:0]align(1) const u16, ppServerContactLinkCollection: ?*?*IContactAggregationLinkCollection) callconv(.Inline) HRESULT {
...
pub const IContactAggregationContact = extern struct {
    pub const VTable = extern struct {
        ...
        MoveToAggregate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactAggregationContact,
                pAggregateId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactAggregationContact,
                pAggregateId: ?[*:0]align(1) const u16,
        ...
        put_AccountId: switch (@import("builtin").zig_backend) {
            ...
            .stage1 => fn(
                self: *const IContactAggregationContact,
                pAccountId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            else => *const fn(
                self: *const IContactAggregationContact,
        ...
        put_NetworkSourceIdString: switch (@import("builtin").zig_backend) {
            ...
            .stage1 => fn(
                self: *const IContactAggregationContact,
                pNetworkSourceId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            else => *const fn(
                self: *const IContactAggregationContact,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationContact_MoveToAggregate(self: *const T, pAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationContact_put_AccountId(self: *const T, pAccountId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationContact_put_NetworkSourceIdString(self: *const T, pNetworkSourceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactAggregationContactCollection = extern struct {
    pub const VTable = extern struct {
        ...
        FindFirstByIdentityHash: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactAggregationContactCollection,
                pSourceType: ?[*:0]align(1) const u16,
                pAccountId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationContactCollection_FindFirstByIdentityHash(self: *const T, pSourceType: ?[*:0]align(1) const u16, pAccountId: ?[*:0]align(1) const u16, pIdentityHash: ?*const CONTACT_AGGREGATION_BLOB, ppItem: ?*?*IContactAggregationContact) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationContactCollection_FindFirstByRemoteId(self: *const T, pSourceType: ?[*:0]align(1) const u16, pAccountId: ?[*:0]align(1) const u16, pRemoteObjectId: ?*const CONTACT_AGGREGATION_BLOB, ppItem: ?*?*IContactAggregationContact) callconv(.Inline) HRESULT {
...
pub const IContactAggregationAggregate = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationAggregate_Link(self: *const T, pAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationAggregate_put_AntiLink(self: *const T, pAntiLink: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactAggregationAggregateCollection = extern struct {
    pub const VTable = extern struct {
        ...
        FindFirstByAntiLinkId: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContactAggregationAggregateCollection,
                pAntiLinkId: ?[*:0]align(1) const u16,
                ppAggregate: ?*?*IContactAggregationAggregate,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IContactAggregationAggregateCollection,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationAggregateCollection_FindFirstByAntiLinkId(self: *const T, pAntiLinkId: ?[*:0]align(1) const u16, ppAggregate: ?*?*IContactAggregationAggregate) callconv(.Inline) HRESULT {
...
pub const IContactAggregationGroup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationGroup_Add(self: *const T, pAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationGroup_Remove(self: *const T, pAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationGroup_put_Name(self: *const T, pName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactAggregationLink = extern struct {
    pub const VTable = extern struct {
        ...
        put_ServerPerson: switch (@import("builtin").zig_backend) {
            ...
            .stage1 => fn(
                self: *const IContactAggregationLink,
                pServerPersonId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            else => *const fn(
                self: *const IContactAggregationLink,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationLink_put_AccountId(self: *const T, pAccountId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationLink_put_NetworkSourceIdString(self: *const T, pNetworkSourceId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationLink_put_ServerPerson(self: *const T, pServerPersonId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationLink_put_ServerPersonBaseline(self: *const T, pServerPersonId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactAggregationLinkCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationLinkCollection_FindFirstByRemoteId(self: *const T, pSourceType: ?[*:0]align(1) const u16, pAccountId: ?[*:0]align(1) const u16, pRemoteId: ?*const CONTACT_AGGREGATION_BLOB, ppServerContactLink: ?*?*IContactAggregationLink) callconv(.Inline) HRESULT {
...
pub const IContactAggregationServerPerson = extern struct {
    pub const VTable = extern struct {
        ...
        put_LinkedAggregateId: switch (@import("builtin").zig_backend) {
            ...
            .stage1 => fn(
                self: *const IContactAggregationServerPerson,
                pLinkedAggregateId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            else => *const fn(
                self: *const IContactAggregationServerPerson,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPerson_put_AggregateId(self: *const T, pAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPerson_put_AntiLink(self: *const T, pAntiLink: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPerson_put_AntiLinkBaseline(self: *const T, pAntiLink: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPerson_put_LinkedAggregateId(self: *const T, pLinkedAggregateId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPerson_put_ObjectId(self: *const T, pObjectId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IContactAggregationServerPersonCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPersonCollection_FindFirstByServerId(self: *const T, pServerId: ?[*:0]align(1) const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPersonCollection_FindFirstByAggregateId(self: *const T, pAggregateId: ?[*:0]align(1) const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContactAggregationServerPersonCollection_FindFirstByLinkedAggregateId(self: *const T, pAggregateId: ?[*:0]align(1) const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) callconv(.Inline) HRESULT {
