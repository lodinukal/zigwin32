...
pub const IMbnConnection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnection_Connect(self: *const T, connectionMode: MBN_CONNECTION_MODE, strProfile: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMbnInterface = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnInterface_InEmergencyMode(self: *const T, emergencyMode: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMbnInterfaceManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetInterface: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                interfaceID: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnInterfaceManager_GetInterface(self: *const T, interfaceID: ?[*:0]align(1) const u16, mbnInterface: ?*?*IMbnInterface) callconv(.Inline) HRESULT {
...
pub const IMbnRegistration = extern struct {
    pub const VTable = extern struct {
        ...
        SetRegisterMode: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMbnRegistration,
                registerMode: MBN_REGISTER_MODE,
                providerID: ?[*:0]align(1) const u16,
                dataClass: u32,
                requestID: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnRegistration_SetRegisterMode(self: *const T, registerMode: MBN_REGISTER_MODE, providerID: ?[*:0]align(1) const u16, dataClass: u32, requestID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMbnConnectionManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetConnection: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                connectionID: ?[*:0]align(1) const u16,
                mbnConnection: ?*?*IMbnConnection,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMbnConnectionManager,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnectionManager_GetConnection(self: *const T, connectionID: ?[*:0]align(1) const u16, mbnConnection: ?*?*IMbnConnection) callconv(.Inline) HRESULT {
...
pub const IMbnConnectionContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnectionContext_SetProvisionedContext(self: *const T, provisionedContexts: MBN_CONTEXT, providerID: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMbnConnectionProfileManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetConnectionProfile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMbnConnectionProfileManager,
                mbnInterface: ?*IMbnInterface,
                profileName: ?[*:0]align(1) const u16,
        ...
        CreateConnectionProfile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMbnConnectionProfileManager,
                xmlProfile: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMbnConnectionProfileManager,
                xmlProfile: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnectionProfileManager_GetConnectionProfile(self: *const T, mbnInterface: ?*IMbnInterface, profileName: ?[*:0]align(1) const u16, connectionProfile: ?*?*IMbnConnectionProfile) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnectionProfileManager_CreateConnectionProfile(self: *const T, xmlProfile: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IMbnConnectionProfile = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnConnectionProfile_UpdateProfile(self: *const T, strProfile: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IMbnSmsConfiguration = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnSmsConfiguration_put_ServiceCenterAddress(self: *const T, scAddress: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IMbnSms = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnSms_SmsSendPdu(self: *const T, pduData: ?[*:0]align(1) const u16, size: u8, requestID: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IMbnSms.VTable, @ptrCast(self.vtable)).SmsSendPdu(@as(*const IMbnSms, @ptrCast(self)), pduData, size, requestID);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnSms_SmsSendCdma(self: *const T, address: ?[*:0]align(1) const u16, encoding: MBN_SMS_CDMA_ENCODING, language: MBN_SMS_CDMA_LANG, sizeInCharacters: u32, message: ?*SAFEARRAY, requestID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMbnSmsEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnSmsEvents_OnSmsReadComplete(self: *const T, sms: ?*IMbnSms, smsFormat: MBN_SMS_FORMAT, readMsgs: ?*SAFEARRAY, moreMsgs: VARIANT_BOOL, requestID: u32, status: HRESULT) callconv(.Inline) HRESULT {
...
pub const IMbnPin = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnPin_Enable(self: *const T, pin: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IMbnPin.VTable, @ptrCast(self.vtable)).Enable(@as(*const IMbnPin, @ptrCast(self)), pin, requestID);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnPin_Disable(self: *const T, pin: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IMbnPin.VTable, @ptrCast(self.vtable)).Disable(@as(*const IMbnPin, @ptrCast(self)), pin, requestID);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnPin_Enter(self: *const T, pin: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IMbnPin.VTable, @ptrCast(self.vtable)).Enter(@as(*const IMbnPin, @ptrCast(self)), pin, requestID);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnPin_Change(self: *const T, pin: ?[*:0]align(1) const u16, newPin: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IMbnPin.VTable, @ptrCast(self.vtable)).Change(@as(*const IMbnPin, @ptrCast(self)), pin, newPin, requestID);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMbnPin_Unblock(self: *const T, puk: ?[*:0]align(1) const u16, newPin: ?[*:0]align(1) const u16, requestID: ?*u32) callconv(.Inline) HRESULT {
