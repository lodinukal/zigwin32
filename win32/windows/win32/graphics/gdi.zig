...
pub const TEXT_ALIGN_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(TEXT_ALIGN_OPTIONS, @enumFromInt(
              (if (o.TA_NOUPDATECP == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_NOUPDATECP) else 0)
            | (if (o.TA_UPDATECP == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_UPDATECP) else 0)
            | (if (o.TA_RIGHT == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_RIGHT) else 0)
            | (if (o.TA_CENTER == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_CENTER) else 0)
            | (if (o.TA_BOTTOM == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_BOTTOM) else 0)
            | (if (o.TA_BASELINE == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_BASELINE) else 0)
            | (if (o.TA_RTLREADING == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_RTLREADING) else 0)
            | (if (o.TA_MASK == 1) @intFromEnum(TEXT_ALIGN_OPTIONS.TA_MASK) else 0)
        ));
    }
};
...
pub const GET_STOCK_OBJECT_FLAGS = enum(i32) {
    BLACK_BRUSH = 4,
    DKGRAY_BRUSH = 3,
    DC_BRUSH = 18,
    GRAY_BRUSH = 2,
...
pub const FONT_CLIP_PRECISION = enum(u8) {
    DEFAULT_PRECIS = 0,
    CHARACTER_PRECIS = 1,
    STROKE_PRECIS = 2,
    MASK = 15,
    ...
    DFA_DISABLE = 64,
    EMBEDDED = 128,
    // DFA_OVERRIDE = 64, this enum value conflicts with DFA_DISABLE
    _,
    pub fn initFlags(o: struct {
        DEFAULT_PRECIS: u1 = 0,
...
pub const CLIP_DFA_OVERRIDE = FONT_CLIP_PRECISION.DFA_DISABLE;

pub const CREATE_POLYGON_RGN_MODE = enum(i32) {
    ALTERNATE = 1,
    WINDING = 2,
};
...
pub const FONT_OUTPUT_PRECISION = enum(u8) {
    DEFAULT_PRECIS = 0,
    STRING_PRECIS = 1,
    CHARACTER_PRECIS = 2,
    STROKE_PRECIS = 3,
...
pub const OUT_SCREEN_OUTLINE_PRECIS = FONT_OUTPUT_PRECISION.SCREEN_OUTLINE_PRECIS;
pub const OUT_PS_ONLY_PRECIS = FONT_OUTPUT_PRECISION.PS_ONLY_PRECIS;

pub const FONT_WEIGHT = enum(u32) {
    DONTCARE = 0,
    THIN = 100,
    EXTRALIGHT = 200,
    LIGHT = 300,
    ...
    EXTRABOLD = 800,
    HEAVY = 900,
    // ULTRALIGHT = 200, this enum value conflicts with EXTRALIGHT
    // REGULAR = 400, this enum value conflicts with NORMAL
    // DEMIBOLD = 600, this enum value conflicts with SEMIBOLD
    // ULTRABOLD = 800, this enum value conflicts with EXTRABOLD
    // BLACK = 900, this enum value conflicts with HEAVY
};
pub const FW_DONTCARE = FONT_WEIGHT.DONTCARE;
pub const FW_THIN = FONT_WEIGHT.THIN;
pub const FW_EXTRALIGHT = FONT_WEIGHT.EXTRALIGHT;
pub const FW_LIGHT = FONT_WEIGHT.LIGHT;
pub const FW_NORMAL = FONT_WEIGHT.NORMAL;
pub const FW_MEDIUM = FONT_WEIGHT.MEDIUM;
pub const FW_SEMIBOLD = FONT_WEIGHT.SEMIBOLD;
pub const FW_BOLD = FONT_WEIGHT.BOLD;
pub const FW_EXTRABOLD = FONT_WEIGHT.EXTRABOLD;
pub const FW_HEAVY = FONT_WEIGHT.HEAVY;
pub const FW_ULTRALIGHT = FONT_WEIGHT.EXTRALIGHT;
pub const FW_REGULAR = FONT_WEIGHT.NORMAL;
pub const FW_DEMIBOLD = FONT_WEIGHT.SEMIBOLD;
pub const FW_ULTRABOLD = FONT_WEIGHT.EXTRABOLD;
pub const FW_BLACK = FONT_WEIGHT.HEAVY;

pub const FONT_CHARSET = enum(u8) {
    ANSI_CHARSET = 0,
    DEFAULT_CHARSET = 1,
    SYMBOL_CHARSET = 2,
    SHIFTJIS_CHARSET = 128,
    HANGEUL_CHARSET = 129,
    // HANGUL_CHARSET = 129, this enum value conflicts with HANGEUL_CHARSET
    GB2312_CHARSET = 134,
...
pub const ANSI_CHARSET = FONT_CHARSET.ANSI_CHARSET;
pub const DEFAULT_CHARSET = FONT_CHARSET.DEFAULT_CHARSET;
pub const SYMBOL_CHARSET = FONT_CHARSET.SYMBOL_CHARSET;
pub const SHIFTJIS_CHARSET = FONT_CHARSET.SHIFTJIS_CHARSET;
pub const HANGEUL_CHARSET = FONT_CHARSET.HANGEUL_CHARSET;
pub const HANGUL_CHARSET = FONT_CHARSET.HANGEUL_CHARSET;
pub const GB2312_CHARSET = FONT_CHARSET.GB2312_CHARSET;
pub const CHINESEBIG5_CHARSET = FONT_CHARSET.CHINESEBIG5_CHARSET;
pub const OEM_CHARSET = FONT_CHARSET.OEM_CHARSET;
pub const JOHAB_CHARSET = FONT_CHARSET.JOHAB_CHARSET;
pub const HEBREW_CHARSET = FONT_CHARSET.HEBREW_CHARSET;
pub const ARABIC_CHARSET = FONT_CHARSET.ARABIC_CHARSET;
pub const GREEK_CHARSET = FONT_CHARSET.GREEK_CHARSET;
pub const TURKISH_CHARSET = FONT_CHARSET.TURKISH_CHARSET;
pub const VIETNAMESE_CHARSET = FONT_CHARSET.VIETNAMESE_CHARSET;
pub const THAI_CHARSET = FONT_CHARSET.THAI_CHARSET;
pub const EASTEUROPE_CHARSET = FONT_CHARSET.EASTEUROPE_CHARSET;
pub const RUSSIAN_CHARSET = FONT_CHARSET.RUSSIAN_CHARSET;
pub const MAC_CHARSET = FONT_CHARSET.MAC_CHARSET;
pub const BALTIC_CHARSET = FONT_CHARSET.BALTIC_CHARSET;

pub const ARC_DIRECTION = enum(i32) {
    OUNTERCLOCKWISE = 1,
    LOCKWISE = 2,
};
...
pub const STRETCH_BLT_MODE = enum(i32) {
    BLACKONWHITE = 1,
    COLORONCOLOR = 3,
    HALFTONE = 4,
...
pub const FONT_QUALITY = enum(u8) {
    DEFAULT_QUALITY = 0,
    DRAFT_QUALITY = 1,
    PROOF_QUALITY = 2,
...
pub const SYS_COLOR_INDEX = enum(i32) {
    SCROLLBAR = 0,
    BACKGROUND = 1,
    ACTIVECAPTION = 2,
    INACTIVECAPTION = 3,
    ...
    // @"3DFACE" = 15, this enum value conflicts with BTNFACE
    // @"3DSHADOW" = 16, this enum value conflicts with BTNSHADOW
    // @"3DHIGHLIGHT" = 20, this enum value conflicts with BTNHIGHLIGHT
    // @"3DHILIGHT" = 20, this enum value conflicts with BTNHIGHLIGHT
    // BTNHILIGHT = 20, this enum value conflicts with BTNHIGHLIGHT
};
...
pub const COLOR_BTNFACE = SYS_COLOR_INDEX.BTNFACE;
pub const COLOR_BTNSHADOW = SYS_COLOR_INDEX.BTNSHADOW;
...
pub const COLOR_BTNHIGHLIGHT = SYS_COLOR_INDEX.BTNHIGHLIGHT;
...
pub const COLOR_3DFACE = SYS_COLOR_INDEX.BTNFACE;
pub const COLOR_3DSHADOW = SYS_COLOR_INDEX.BTNSHADOW;
pub const COLOR_3DHIGHLIGHT = SYS_COLOR_INDEX.BTNHIGHLIGHT;
pub const COLOR_3DHILIGHT = SYS_COLOR_INDEX.BTNHIGHLIGHT;
pub const COLOR_BTNHILIGHT = SYS_COLOR_INDEX.BTNHIGHLIGHT;
...
pub const CREATE_FONT_PACKAGE_SUBSET_ENCODING = enum(i16) {
    STD_MAC_CHAR_SET = 0,
...
pub const HATCH_BRUSH_STYLE = enum(i32) {
    BDIAGONAL = 3,
    CROSS = 4,
    DIAGCROSS = 5,
    FDIAGONAL = 2,
...
pub const GRAPHICS_MODE = enum(i32) {
    COMPATIBLE = 1,
    ADVANCED = 2,
};
...
pub const FONT_PITCH = enum(u8) {
    DEFAULT_PITCH = 0,
    FIXED_PITCH = 1,
    VARIABLE_PITCH = 2,
};
pub const DEFAULT_PITCH = FONT_PITCH.DEFAULT_PITCH;
pub const FIXED_PITCH = FONT_PITCH.FIXED_PITCH;
pub const VARIABLE_PITCH = FONT_PITCH.VARIABLE_PITCH;

pub const FONT_FAMILY = enum(u8) {
    DECORATIVE = 80,
    DONTCARE = 0,
    MODERN = 48,
    ROMAN = 16,
...
pub const FF_DECORATIVE = FONT_FAMILY.DECORATIVE;
pub const FF_DONTCARE = FONT_FAMILY.DONTCARE;
pub const FF_MODERN = FONT_FAMILY.MODERN;
pub const FF_ROMAN = FONT_FAMILY.ROMAN;
pub const FF_SCRIPT = FONT_FAMILY.SCRIPT;
pub const FF_SWISS = FONT_FAMILY.SWISS;
...
pub const ROP_CODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(ROP_CODE, @enumFromInt(
              (if (o.BLACKNESS == 1) @intFromEnum(ROP_CODE.BLACKNESS) else 0)
            | (if (o.NOTSRCERASE == 1) @intFromEnum(ROP_CODE.NOTSRCERASE) else 0)
            | (if (o.NOTSRCCOPY == 1) @intFromEnum(ROP_CODE.NOTSRCCOPY) else 0)
            | (if (o.SRCERASE == 1) @intFromEnum(ROP_CODE.SRCERASE) else 0)
            | (if (o.DSTINVERT == 1) @intFromEnum(ROP_CODE.DSTINVERT) else 0)
            | (if (o.PATINVERT == 1) @intFromEnum(ROP_CODE.PATINVERT) else 0)
            | (if (o.SRCINVERT == 1) @intFromEnum(ROP_CODE.SRCINVERT) else 0)
            | (if (o.SRCAND == 1) @intFromEnum(ROP_CODE.SRCAND) else 0)
            | (if (o.MERGEPAINT == 1) @intFromEnum(ROP_CODE.MERGEPAINT) else 0)
            | (if (o.MERGECOPY == 1) @intFromEnum(ROP_CODE.MERGECOPY) else 0)
            | (if (o.SRCCOPY == 1) @intFromEnum(ROP_CODE.SRCCOPY) else 0)
            | (if (o.SRCPAINT == 1) @intFromEnum(ROP_CODE.SRCPAINT) else 0)
            | (if (o.PATCOPY == 1) @intFromEnum(ROP_CODE.PATCOPY) else 0)
            | (if (o.PATPAINT == 1) @intFromEnum(ROP_CODE.PATPAINT) else 0)
            | (if (o.WHITENESS == 1) @intFromEnum(ROP_CODE.WHITENESS) else 0)
            | (if (o.CAPTUREBLT == 1) @intFromEnum(ROP_CODE.CAPTUREBLT) else 0)
            | (if (o.NOMIRRORBITMAP == 1) @intFromEnum(ROP_CODE.NOMIRRORBITMAP) else 0)
        ));
    }
};
...
pub const CREATE_FONT_PACKAGE_SUBSET_PLATFORM = enum(i16) {
...
pub const HDC_MAP_MODE = enum(i32) {
    ANISOTROPIC = 8,
    HIENGLISH = 5,
    HIMETRIC = 3,
    ISOTROPIC = 7,
...
pub const BRUSH_STYLE = enum(u32) {
    SOLID = 0,
    NULL = 1,
    // HOLLOW = 1, this enum value conflicts with NULL
    HATCHED = 2,
    PATTERN = 3,
    INDEXED = 4,
    DIBPATTERN = 5,
...
pub const BS_SOLID = BRUSH_STYLE.SOLID;
pub const BS_NULL = BRUSH_STYLE.NULL;
pub const BS_HOLLOW = BRUSH_STYLE.NULL;
pub const BS_HATCHED = BRUSH_STYLE.HATCHED;
pub const BS_PATTERN = BRUSH_STYLE.PATTERN;
pub const BS_INDEXED = BRUSH_STYLE.INDEXED;
pub const BS_DIBPATTERN = BRUSH_STYLE.DIBPATTERN;
pub const BS_DIBPATTERNPT = BRUSH_STYLE.DIBPATTERNPT;
pub const BS_PATTERN8X8 = BRUSH_STYLE.PATTERN8X8;
pub const BS_DIBPATTERN8X8 = BRUSH_STYLE.DIBPATTERN8X8;
pub const BS_MONOPATTERN = BRUSH_STYLE.MONOPATTERN;

pub const TMPF_FLAGS = enum(u8) {
    FIXED_PITCH = 1,
    VECTOR = 2,
    DEVICE = 8,
    TRUETYPE = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(TMPF_FLAGS, @enumFromInt(
              (if (o.FIXED_PITCH == 1) @intFromEnum(TMPF_FLAGS.FIXED_PITCH) else 0)
            | (if (o.VECTOR == 1) @intFromEnum(TMPF_FLAGS.VECTOR) else 0)
            | (if (o.DEVICE == 1) @intFromEnum(TMPF_FLAGS.DEVICE) else 0)
            | (if (o.TRUETYPE == 1) @intFromEnum(TMPF_FLAGS.TRUETYPE) else 0)
        ));
    }
};
pub const TMPF_FIXED_PITCH = TMPF_FLAGS.FIXED_PITCH;
pub const TMPF_VECTOR = TMPF_FLAGS.VECTOR;
pub const TMPF_DEVICE = TMPF_FLAGS.DEVICE;
pub const TMPF_TRUETYPE = TMPF_FLAGS.TRUETYPE;

pub const BI_COMPRESSION = enum(u32) {
    RGB = 0,
    RLE8 = 1,
    RLE4 = 2,
    BITFIELDS = 3,
...
pub const BI_RGB = BI_COMPRESSION.RGB;
pub const BI_RLE8 = BI_COMPRESSION.RLE8;
pub const BI_RLE4 = BI_COMPRESSION.RLE4;
pub const BI_BITFIELDS = BI_COMPRESSION.BITFIELDS;
pub const BI_JPEG = BI_COMPRESSION.JPEG;
pub const BI_PNG = BI_COMPRESSION.PNG;

pub const ENHANCED_METAFILE_RECORD_TYPE = enum(u32) {
    HEADER = 1,
    POLYBEZIER = 2,
    POLYGON = 3,
    POLYLINE = 4,
    ...
    // MIN = 1, this enum value conflicts with HEADER
    // MAX = 122, this enum value conflicts with CREATECOLORSPACEW
};
pub const EMR_HEADER = ENHANCED_METAFILE_RECORD_TYPE.HEADER;
pub const EMR_POLYBEZIER = ENHANCED_METAFILE_RECORD_TYPE.POLYBEZIER;
pub const EMR_POLYGON = ENHANCED_METAFILE_RECORD_TYPE.POLYGON;
pub const EMR_POLYLINE = ENHANCED_METAFILE_RECORD_TYPE.POLYLINE;
pub const EMR_POLYBEZIERTO = ENHANCED_METAFILE_RECORD_TYPE.POLYBEZIERTO;
pub const EMR_POLYLINETO = ENHANCED_METAFILE_RECORD_TYPE.POLYLINETO;
pub const EMR_POLYPOLYLINE = ENHANCED_METAFILE_RECORD_TYPE.POLYPOLYLINE;
pub const EMR_POLYPOLYGON = ENHANCED_METAFILE_RECORD_TYPE.POLYPOLYGON;
pub const EMR_SETWINDOWEXTEX = ENHANCED_METAFILE_RECORD_TYPE.SETWINDOWEXTEX;
pub const EMR_SETWINDOWORGEX = ENHANCED_METAFILE_RECORD_TYPE.SETWINDOWORGEX;
pub const EMR_SETVIEWPORTEXTEX = ENHANCED_METAFILE_RECORD_TYPE.SETVIEWPORTEXTEX;
pub const EMR_SETVIEWPORTORGEX = ENHANCED_METAFILE_RECORD_TYPE.SETVIEWPORTORGEX;
pub const EMR_SETBRUSHORGEX = ENHANCED_METAFILE_RECORD_TYPE.SETBRUSHORGEX;
pub const EMR_EOF = ENHANCED_METAFILE_RECORD_TYPE.EOF;
pub const EMR_SETPIXELV = ENHANCED_METAFILE_RECORD_TYPE.SETPIXELV;
pub const EMR_SETMAPPERFLAGS = ENHANCED_METAFILE_RECORD_TYPE.SETMAPPERFLAGS;
pub const EMR_SETMAPMODE = ENHANCED_METAFILE_RECORD_TYPE.SETMAPMODE;
pub const EMR_SETBKMODE = ENHANCED_METAFILE_RECORD_TYPE.SETBKMODE;
pub const EMR_SETPOLYFILLMODE = ENHANCED_METAFILE_RECORD_TYPE.SETPOLYFILLMODE;
pub const EMR_SETROP2 = ENHANCED_METAFILE_RECORD_TYPE.SETROP2;
pub const EMR_SETSTRETCHBLTMODE = ENHANCED_METAFILE_RECORD_TYPE.SETSTRETCHBLTMODE;
pub const EMR_SETTEXTALIGN = ENHANCED_METAFILE_RECORD_TYPE.SETTEXTALIGN;
pub const EMR_SETCOLORADJUSTMENT = ENHANCED_METAFILE_RECORD_TYPE.SETCOLORADJUSTMENT;
pub const EMR_SETTEXTCOLOR = ENHANCED_METAFILE_RECORD_TYPE.SETTEXTCOLOR;
pub const EMR_SETBKCOLOR = ENHANCED_METAFILE_RECORD_TYPE.SETBKCOLOR;
pub const EMR_OFFSETCLIPRGN = ENHANCED_METAFILE_RECORD_TYPE.OFFSETCLIPRGN;
pub const EMR_MOVETOEX = ENHANCED_METAFILE_RECORD_TYPE.MOVETOEX;
pub const EMR_SETMETARGN = ENHANCED_METAFILE_RECORD_TYPE.SETMETARGN;
pub const EMR_EXCLUDECLIPRECT = ENHANCED_METAFILE_RECORD_TYPE.EXCLUDECLIPRECT;
pub const EMR_INTERSECTCLIPRECT = ENHANCED_METAFILE_RECORD_TYPE.INTERSECTCLIPRECT;
pub const EMR_SCALEVIEWPORTEXTEX = ENHANCED_METAFILE_RECORD_TYPE.SCALEVIEWPORTEXTEX;
pub const EMR_SCALEWINDOWEXTEX = ENHANCED_METAFILE_RECORD_TYPE.SCALEWINDOWEXTEX;
pub const EMR_SAVEDC = ENHANCED_METAFILE_RECORD_TYPE.SAVEDC;
pub const EMR_RESTOREDC = ENHANCED_METAFILE_RECORD_TYPE.RESTOREDC;
pub const EMR_SETWORLDTRANSFORM = ENHANCED_METAFILE_RECORD_TYPE.SETWORLDTRANSFORM;
pub const EMR_MODIFYWORLDTRANSFORM = ENHANCED_METAFILE_RECORD_TYPE.MODIFYWORLDTRANSFORM;
pub const EMR_SELECTOBJECT = ENHANCED_METAFILE_RECORD_TYPE.SELECTOBJECT;
pub const EMR_CREATEPEN = ENHANCED_METAFILE_RECORD_TYPE.CREATEPEN;
pub const EMR_CREATEBRUSHINDIRECT = ENHANCED_METAFILE_RECORD_TYPE.CREATEBRUSHINDIRECT;
pub const EMR_DELETEOBJECT = ENHANCED_METAFILE_RECORD_TYPE.DELETEOBJECT;
pub const EMR_ANGLEARC = ENHANCED_METAFILE_RECORD_TYPE.ANGLEARC;
pub const EMR_ELLIPSE = ENHANCED_METAFILE_RECORD_TYPE.ELLIPSE;
pub const EMR_RECTANGLE = ENHANCED_METAFILE_RECORD_TYPE.RECTANGLE;
pub const EMR_ROUNDRECT = ENHANCED_METAFILE_RECORD_TYPE.ROUNDRECT;
pub const EMR_ARC = ENHANCED_METAFILE_RECORD_TYPE.ARC;
pub const EMR_CHORD = ENHANCED_METAFILE_RECORD_TYPE.CHORD;
pub const EMR_PIE = ENHANCED_METAFILE_RECORD_TYPE.PIE;
pub const EMR_SELECTPALETTE = ENHANCED_METAFILE_RECORD_TYPE.SELECTPALETTE;
pub const EMR_CREATEPALETTE = ENHANCED_METAFILE_RECORD_TYPE.CREATEPALETTE;
pub const EMR_SETPALETTEENTRIES = ENHANCED_METAFILE_RECORD_TYPE.SETPALETTEENTRIES;
pub const EMR_RESIZEPALETTE = ENHANCED_METAFILE_RECORD_TYPE.RESIZEPALETTE;
pub const EMR_REALIZEPALETTE = ENHANCED_METAFILE_RECORD_TYPE.REALIZEPALETTE;
pub const EMR_EXTFLOODFILL = ENHANCED_METAFILE_RECORD_TYPE.EXTFLOODFILL;
pub const EMR_LINETO = ENHANCED_METAFILE_RECORD_TYPE.LINETO;
pub const EMR_ARCTO = ENHANCED_METAFILE_RECORD_TYPE.ARCTO;
pub const EMR_POLYDRAW = ENHANCED_METAFILE_RECORD_TYPE.POLYDRAW;
pub const EMR_SETARCDIRECTION = ENHANCED_METAFILE_RECORD_TYPE.SETARCDIRECTION;
pub const EMR_SETMITERLIMIT = ENHANCED_METAFILE_RECORD_TYPE.SETMITERLIMIT;
pub const EMR_BEGINPATH = ENHANCED_METAFILE_RECORD_TYPE.BEGINPATH;
pub const EMR_ENDPATH = ENHANCED_METAFILE_RECORD_TYPE.ENDPATH;
pub const EMR_CLOSEFIGURE = ENHANCED_METAFILE_RECORD_TYPE.CLOSEFIGURE;
pub const EMR_FILLPATH = ENHANCED_METAFILE_RECORD_TYPE.FILLPATH;
pub const EMR_STROKEANDFILLPATH = ENHANCED_METAFILE_RECORD_TYPE.STROKEANDFILLPATH;
pub const EMR_STROKEPATH = ENHANCED_METAFILE_RECORD_TYPE.STROKEPATH;
pub const EMR_FLATTENPATH = ENHANCED_METAFILE_RECORD_TYPE.FLATTENPATH;
pub const EMR_WIDENPATH = ENHANCED_METAFILE_RECORD_TYPE.WIDENPATH;
pub const EMR_SELECTCLIPPATH = ENHANCED_METAFILE_RECORD_TYPE.SELECTCLIPPATH;
pub const EMR_ABORTPATH = ENHANCED_METAFILE_RECORD_TYPE.ABORTPATH;
pub const EMR_GDICOMMENT = ENHANCED_METAFILE_RECORD_TYPE.GDICOMMENT;
pub const EMR_FILLRGN = ENHANCED_METAFILE_RECORD_TYPE.FILLRGN;
pub const EMR_FRAMERGN = ENHANCED_METAFILE_RECORD_TYPE.FRAMERGN;
pub const EMR_INVERTRGN = ENHANCED_METAFILE_RECORD_TYPE.INVERTRGN;
pub const EMR_PAINTRGN = ENHANCED_METAFILE_RECORD_TYPE.PAINTRGN;
pub const EMR_EXTSELECTCLIPRGN = ENHANCED_METAFILE_RECORD_TYPE.EXTSELECTCLIPRGN;
pub const EMR_BITBLT = ENHANCED_METAFILE_RECORD_TYPE.BITBLT;
pub const EMR_STRETCHBLT = ENHANCED_METAFILE_RECORD_TYPE.STRETCHBLT;
pub const EMR_MASKBLT = ENHANCED_METAFILE_RECORD_TYPE.MASKBLT;
pub const EMR_PLGBLT = ENHANCED_METAFILE_RECORD_TYPE.PLGBLT;
pub const EMR_SETDIBITSTODEVICE = ENHANCED_METAFILE_RECORD_TYPE.SETDIBITSTODEVICE;
pub const EMR_STRETCHDIBITS = ENHANCED_METAFILE_RECORD_TYPE.STRETCHDIBITS;
pub const EMR_EXTCREATEFONTINDIRECTW = ENHANCED_METAFILE_RECORD_TYPE.EXTCREATEFONTINDIRECTW;
pub const EMR_EXTTEXTOUTA = ENHANCED_METAFILE_RECORD_TYPE.EXTTEXTOUTA;
pub const EMR_EXTTEXTOUTW = ENHANCED_METAFILE_RECORD_TYPE.EXTTEXTOUTW;
pub const EMR_POLYBEZIER16 = ENHANCED_METAFILE_RECORD_TYPE.POLYBEZIER16;
pub const EMR_POLYGON16 = ENHANCED_METAFILE_RECORD_TYPE.POLYGON16;
pub const EMR_POLYLINE16 = ENHANCED_METAFILE_RECORD_TYPE.POLYLINE16;
pub const EMR_POLYBEZIERTO16 = ENHANCED_METAFILE_RECORD_TYPE.POLYBEZIERTO16;
pub const EMR_POLYLINETO16 = ENHANCED_METAFILE_RECORD_TYPE.POLYLINETO16;
pub const EMR_POLYPOLYLINE16 = ENHANCED_METAFILE_RECORD_TYPE.POLYPOLYLINE16;
pub const EMR_POLYPOLYGON16 = ENHANCED_METAFILE_RECORD_TYPE.POLYPOLYGON16;
pub const EMR_POLYDRAW16 = ENHANCED_METAFILE_RECORD_TYPE.POLYDRAW16;
pub const EMR_CREATEMONOBRUSH = ENHANCED_METAFILE_RECORD_TYPE.CREATEMONOBRUSH;
pub const EMR_CREATEDIBPATTERNBRUSHPT = ENHANCED_METAFILE_RECORD_TYPE.CREATEDIBPATTERNBRUSHPT;
pub const EMR_EXTCREATEPEN = ENHANCED_METAFILE_RECORD_TYPE.EXTCREATEPEN;
pub const EMR_POLYTEXTOUTA = ENHANCED_METAFILE_RECORD_TYPE.POLYTEXTOUTA;
pub const EMR_POLYTEXTOUTW = ENHANCED_METAFILE_RECORD_TYPE.POLYTEXTOUTW;
pub const EMR_SETICMMODE = ENHANCED_METAFILE_RECORD_TYPE.SETICMMODE;
pub const EMR_CREATECOLORSPACE = ENHANCED_METAFILE_RECORD_TYPE.CREATECOLORSPACE;
pub const EMR_SETCOLORSPACE = ENHANCED_METAFILE_RECORD_TYPE.SETCOLORSPACE;
pub const EMR_DELETECOLORSPACE = ENHANCED_METAFILE_RECORD_TYPE.DELETECOLORSPACE;
pub const EMR_GLSRECORD = ENHANCED_METAFILE_RECORD_TYPE.GLSRECORD;
pub const EMR_GLSBOUNDEDRECORD = ENHANCED_METAFILE_RECORD_TYPE.GLSBOUNDEDRECORD;
pub const EMR_PIXELFORMAT = ENHANCED_METAFILE_RECORD_TYPE.PIXELFORMAT;
pub const EMR_RESERVED_105 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_105;
pub const EMR_RESERVED_106 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_106;
pub const EMR_RESERVED_107 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_107;
pub const EMR_RESERVED_108 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_108;
pub const EMR_RESERVED_109 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_109;
pub const EMR_RESERVED_110 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_110;
pub const EMR_COLORCORRECTPALETTE = ENHANCED_METAFILE_RECORD_TYPE.COLORCORRECTPALETTE;
pub const EMR_SETICMPROFILEA = ENHANCED_METAFILE_RECORD_TYPE.SETICMPROFILEA;
pub const EMR_SETICMPROFILEW = ENHANCED_METAFILE_RECORD_TYPE.SETICMPROFILEW;
pub const EMR_ALPHABLEND = ENHANCED_METAFILE_RECORD_TYPE.ALPHABLEND;
pub const EMR_SETLAYOUT = ENHANCED_METAFILE_RECORD_TYPE.SETLAYOUT;
pub const EMR_TRANSPARENTBLT = ENHANCED_METAFILE_RECORD_TYPE.TRANSPARENTBLT;
pub const EMR_RESERVED_117 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_117;
pub const EMR_GRADIENTFILL = ENHANCED_METAFILE_RECORD_TYPE.GRADIENTFILL;
pub const EMR_RESERVED_119 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_119;
pub const EMR_RESERVED_120 = ENHANCED_METAFILE_RECORD_TYPE.RESERVED_120;
pub const EMR_COLORMATCHTOTARGETW = ENHANCED_METAFILE_RECORD_TYPE.COLORMATCHTOTARGETW;
pub const EMR_CREATECOLORSPACEW = ENHANCED_METAFILE_RECORD_TYPE.CREATECOLORSPACEW;
pub const EMR_MIN = ENHANCED_METAFILE_RECORD_TYPE.HEADER;
pub const EMR_MAX = ENHANCED_METAFILE_RECORD_TYPE.CREATECOLORSPACEW;

pub const DEVMODE_FIELD_FLAGS = enum(u32) {
    SPECVERSION = 1025,
    ORIENTATION = 1,
    PAPERSIZE = 2,
    PAPERLENGTH = 4,
    ...
    // INTERLACED = 2, this enum value conflicts with PAPERSIZE
    // UPDATE = 1, this enum value conflicts with ORIENTATION
    // COPY = 2, this enum value conflicts with PAPERSIZE
    // PROMPT = 4, this enum value conflicts with PAPERLENGTH
    // MODIFY = 8, this enum value conflicts with PAPERWIDTH
    // IN_BUFFER = 8, this enum value conflicts with PAPERWIDTH
    // IN_PROMPT = 4, this enum value conflicts with PAPERLENGTH
    // OUT_BUFFER = 2, this enum value conflicts with PAPERSIZE
    // OUT_DEFAULT = 1, this enum value conflicts with ORIENTATION
    _,
    pub fn initFlags(o: struct {
        SPECVERSION: u1 = 0,
        ORIENTATION: u1 = 0,
        ...
        PANNINGWIDTH: u1 = 0,
        PANNINGHEIGHT: u1 = 0,
        DISPLAYFIXEDOUTPUT: u1 = 0,
    }) DEVMODE_FIELD_FLAGS {
        return @as(DEVMODE_FIELD_FLAGS, @enumFromInt(
              (if (o.SPECVERSION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.SPECVERSION) else 0)
            | (if (o.ORIENTATION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.ORIENTATION) else 0)
            | (if (o.PAPERSIZE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PAPERSIZE) else 0)
            | (if (o.PAPERLENGTH == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PAPERLENGTH) else 0)
            | (if (o.PAPERWIDTH == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PAPERWIDTH) else 0)
            | (if (o.SCALE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.SCALE) else 0)
            | (if (o.POSITION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.POSITION) else 0)
            | (if (o.NUP == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.NUP) else 0)
            | (if (o.DISPLAYORIENTATION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DISPLAYORIENTATION) else 0)
            | (if (o.COPIES == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.COPIES) else 0)
            | (if (o.DEFAULTSOURCE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DEFAULTSOURCE) else 0)
            | (if (o.PRINTQUALITY == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PRINTQUALITY) else 0)
            | (if (o.COLOR == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.COLOR) else 0)
            | (if (o.DUPLEX == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DUPLEX) else 0)
            | (if (o.YRESOLUTION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.YRESOLUTION) else 0)
            | (if (o.TTOPTION == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.TTOPTION) else 0)
            | (if (o.COLLATE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.COLLATE) else 0)
            | (if (o.FORMNAME == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.FORMNAME) else 0)
            | (if (o.LOGPIXELS == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.LOGPIXELS) else 0)
            | (if (o.BITSPERPEL == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.BITSPERPEL) else 0)
            | (if (o.PELSWIDTH == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PELSWIDTH) else 0)
            | (if (o.PELSHEIGHT == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PELSHEIGHT) else 0)
            | (if (o.DISPLAYFLAGS == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DISPLAYFLAGS) else 0)
            | (if (o.DISPLAYFREQUENCY == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DISPLAYFREQUENCY) else 0)
            | (if (o.ICMMETHOD == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.ICMMETHOD) else 0)
            | (if (o.ICMINTENT == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.ICMINTENT) else 0)
            | (if (o.MEDIATYPE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.MEDIATYPE) else 0)
            | (if (o.DITHERTYPE == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DITHERTYPE) else 0)
            | (if (o.PANNINGWIDTH == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PANNINGWIDTH) else 0)
            | (if (o.PANNINGHEIGHT == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.PANNINGHEIGHT) else 0)
            | (if (o.DISPLAYFIXEDOUTPUT == 1) @intFromEnum(DEVMODE_FIELD_FLAGS.DISPLAYFIXEDOUTPUT) else 0)
        ));
    }
};
pub const DM_SPECVERSION = DEVMODE_FIELD_FLAGS.SPECVERSION;
pub const DM_ORIENTATION = DEVMODE_FIELD_FLAGS.ORIENTATION;
pub const DM_PAPERSIZE = DEVMODE_FIELD_FLAGS.PAPERSIZE;
pub const DM_PAPERLENGTH = DEVMODE_FIELD_FLAGS.PAPERLENGTH;
pub const DM_PAPERWIDTH = DEVMODE_FIELD_FLAGS.PAPERWIDTH;
pub const DM_SCALE = DEVMODE_FIELD_FLAGS.SCALE;
pub const DM_POSITION = DEVMODE_FIELD_FLAGS.POSITION;
pub const DM_NUP = DEVMODE_FIELD_FLAGS.NUP;
pub const DM_DISPLAYORIENTATION = DEVMODE_FIELD_FLAGS.DISPLAYORIENTATION;
pub const DM_COPIES = DEVMODE_FIELD_FLAGS.COPIES;
pub const DM_DEFAULTSOURCE = DEVMODE_FIELD_FLAGS.DEFAULTSOURCE;
pub const DM_PRINTQUALITY = DEVMODE_FIELD_FLAGS.PRINTQUALITY;
pub const DM_COLOR = DEVMODE_FIELD_FLAGS.COLOR;
pub const DM_DUPLEX = DEVMODE_FIELD_FLAGS.DUPLEX;
pub const DM_YRESOLUTION = DEVMODE_FIELD_FLAGS.YRESOLUTION;
pub const DM_TTOPTION = DEVMODE_FIELD_FLAGS.TTOPTION;
pub const DM_COLLATE = DEVMODE_FIELD_FLAGS.COLLATE;
pub const DM_FORMNAME = DEVMODE_FIELD_FLAGS.FORMNAME;
pub const DM_LOGPIXELS = DEVMODE_FIELD_FLAGS.LOGPIXELS;
pub const DM_BITSPERPEL = DEVMODE_FIELD_FLAGS.BITSPERPEL;
pub const DM_PELSWIDTH = DEVMODE_FIELD_FLAGS.PELSWIDTH;
pub const DM_PELSHEIGHT = DEVMODE_FIELD_FLAGS.PELSHEIGHT;
pub const DM_DISPLAYFLAGS = DEVMODE_FIELD_FLAGS.DISPLAYFLAGS;
pub const DM_DISPLAYFREQUENCY = DEVMODE_FIELD_FLAGS.DISPLAYFREQUENCY;
pub const DM_ICMMETHOD = DEVMODE_FIELD_FLAGS.ICMMETHOD;
pub const DM_ICMINTENT = DEVMODE_FIELD_FLAGS.ICMINTENT;
pub const DM_MEDIATYPE = DEVMODE_FIELD_FLAGS.MEDIATYPE;
pub const DM_DITHERTYPE = DEVMODE_FIELD_FLAGS.DITHERTYPE;
pub const DM_PANNINGWIDTH = DEVMODE_FIELD_FLAGS.PANNINGWIDTH;
pub const DM_PANNINGHEIGHT = DEVMODE_FIELD_FLAGS.PANNINGHEIGHT;
pub const DM_DISPLAYFIXEDOUTPUT = DEVMODE_FIELD_FLAGS.DISPLAYFIXEDOUTPUT;
pub const DM_INTERLACED = DEVMODE_FIELD_FLAGS.PAPERSIZE;
pub const DM_UPDATE = DEVMODE_FIELD_FLAGS.ORIENTATION;
pub const DM_COPY = DEVMODE_FIELD_FLAGS.PAPERSIZE;
pub const DM_PROMPT = DEVMODE_FIELD_FLAGS.PAPERLENGTH;
pub const DM_MODIFY = DEVMODE_FIELD_FLAGS.PAPERWIDTH;
pub const DM_IN_BUFFER = DEVMODE_FIELD_FLAGS.PAPERWIDTH;
pub const DM_IN_PROMPT = DEVMODE_FIELD_FLAGS.PAPERLENGTH;
pub const DM_OUT_BUFFER = DEVMODE_FIELD_FLAGS.PAPERSIZE;
pub const DM_OUT_DEFAULT = DEVMODE_FIELD_FLAGS.ORIENTATION;

pub const DEVMODE_COLOR = enum(i16) {
    MONOCHROME = 1,
    COLOR = 2,
};
...
pub const DEVMODE_DUPLEX = enum(i16) {
    SIMPLEX = 1,
    VERTICAL = 2,
    HORIZONTAL = 3,
};
pub const DMDUP_SIMPLEX = DEVMODE_DUPLEX.SIMPLEX;
pub const DMDUP_VERTICAL = DEVMODE_DUPLEX.VERTICAL;
pub const DMDUP_HORIZONTAL = DEVMODE_DUPLEX.HORIZONTAL;

pub const DEVMODE_COLLATE = enum(i16) {
    FALSE = 0,
    TRUE = 1,
};
pub const DMCOLLATE_FALSE = DEVMODE_COLLATE.FALSE;
pub const DMCOLLATE_TRUE = DEVMODE_COLLATE.TRUE;
...
pub const DEVMODE_TRUETYPE_OPTION = enum(i16) {
    BITMAP = 1,
    DOWNLOAD = 2,
    SUBDEV = 3,
    DOWNLOAD_OUTLINE = 4,
};
pub const DMTT_BITMAP = DEVMODE_TRUETYPE_OPTION.BITMAP;
pub const DMTT_DOWNLOAD = DEVMODE_TRUETYPE_OPTION.DOWNLOAD;
pub const DMTT_SUBDEV = DEVMODE_TRUETYPE_OPTION.SUBDEV;
pub const DMTT_DOWNLOAD_OUTLINE = DEVMODE_TRUETYPE_OPTION.DOWNLOAD_OUTLINE;

pub const PAN_FAMILY_TYPE = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    TEXT_DISPLAY = 2,
    SCRIPT = 3,
...
pub const PAN_FAMILY_ANY = PAN_FAMILY_TYPE.ANY;
pub const PAN_FAMILY_NO_FIT = PAN_FAMILY_TYPE.NO_FIT;
pub const PAN_FAMILY_TEXT_DISPLAY = PAN_FAMILY_TYPE.TEXT_DISPLAY;
pub const PAN_FAMILY_SCRIPT = PAN_FAMILY_TYPE.SCRIPT;
pub const PAN_FAMILY_DECORATIVE = PAN_FAMILY_TYPE.DECORATIVE;
pub const PAN_FAMILY_PICTORIAL = PAN_FAMILY_TYPE.PICTORIAL;

pub const PAN_SERIF_STYLE = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    COVE = 2,
    OBTUSE_COVE = 3,
...
pub const PAN_SERIF_ANY = PAN_SERIF_STYLE.ANY;
pub const PAN_SERIF_NO_FIT = PAN_SERIF_STYLE.NO_FIT;
pub const PAN_SERIF_COVE = PAN_SERIF_STYLE.COVE;
pub const PAN_SERIF_OBTUSE_COVE = PAN_SERIF_STYLE.OBTUSE_COVE;
pub const PAN_SERIF_SQUARE_COVE = PAN_SERIF_STYLE.SQUARE_COVE;
pub const PAN_SERIF_OBTUSE_SQUARE_COVE = PAN_SERIF_STYLE.OBTUSE_SQUARE_COVE;
pub const PAN_SERIF_SQUARE = PAN_SERIF_STYLE.SQUARE;
pub const PAN_SERIF_THIN = PAN_SERIF_STYLE.THIN;
pub const PAN_SERIF_BONE = PAN_SERIF_STYLE.BONE;
pub const PAN_SERIF_EXAGGERATED = PAN_SERIF_STYLE.EXAGGERATED;
pub const PAN_SERIF_TRIANGLE = PAN_SERIF_STYLE.TRIANGLE;
pub const PAN_SERIF_NORMAL_SANS = PAN_SERIF_STYLE.NORMAL_SANS;
pub const PAN_SERIF_OBTUSE_SANS = PAN_SERIF_STYLE.OBTUSE_SANS;
pub const PAN_SERIF_PERP_SANS = PAN_SERIF_STYLE.PERP_SANS;
pub const PAN_SERIF_FLARED = PAN_SERIF_STYLE.FLARED;
pub const PAN_SERIF_ROUNDED = PAN_SERIF_STYLE.ROUNDED;

pub const PAN_WEIGHT = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 2,
    // VERY_LIGHT = 2, this enum value conflicts with INDEX
    LIGHT = 3,
    THIN = 4,
    BOOK = 5,
    MEDIUM = 6,
...
pub const PAN_WEIGHT_ANY = PAN_WEIGHT.ANY;
pub const PAN_WEIGHT_NO_FIT = PAN_WEIGHT.NO_FIT;
pub const PAN_WEIGHT_INDEX = PAN_WEIGHT.INDEX;
pub const PAN_WEIGHT_VERY_LIGHT = PAN_WEIGHT.INDEX;
pub const PAN_WEIGHT_LIGHT = PAN_WEIGHT.LIGHT;
pub const PAN_WEIGHT_THIN = PAN_WEIGHT.THIN;
pub const PAN_WEIGHT_BOOK = PAN_WEIGHT.BOOK;
pub const PAN_WEIGHT_MEDIUM = PAN_WEIGHT.MEDIUM;
pub const PAN_WEIGHT_DEMI = PAN_WEIGHT.DEMI;
pub const PAN_WEIGHT_BOLD = PAN_WEIGHT.BOLD;
pub const PAN_WEIGHT_HEAVY = PAN_WEIGHT.HEAVY;
pub const PAN_WEIGHT_BLACK = PAN_WEIGHT.BLACK;
pub const PAN_WEIGHT_NORD = PAN_WEIGHT.NORD;

pub const PAN_STROKE_VARIATION = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    GRADUAL_DIAG = 2,
    GRADUAL_TRAN = 3,
...
pub const PAN_STROKE_ANY = PAN_STROKE_VARIATION.ANY;
pub const PAN_STROKE_NO_FIT = PAN_STROKE_VARIATION.NO_FIT;
pub const PAN_STROKE_GRADUAL_DIAG = PAN_STROKE_VARIATION.GRADUAL_DIAG;
pub const PAN_STROKE_GRADUAL_TRAN = PAN_STROKE_VARIATION.GRADUAL_TRAN;
pub const PAN_STROKE_GRADUAL_VERT = PAN_STROKE_VARIATION.GRADUAL_VERT;
pub const PAN_STROKE_GRADUAL_HORZ = PAN_STROKE_VARIATION.GRADUAL_HORZ;
pub const PAN_STROKE_RAPID_VERT = PAN_STROKE_VARIATION.RAPID_VERT;
pub const PAN_STROKE_RAPID_HORZ = PAN_STROKE_VARIATION.RAPID_HORZ;
pub const PAN_STROKE_INSTANT_VERT = PAN_STROKE_VARIATION.INSTANT_VERT;

pub const PAN_PROPORTION = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    OLD_STYLE = 2,
    MODERN = 3,
...
pub const PAN_PROP_ANY = PAN_PROPORTION.ANY;
pub const PAN_PROP_NO_FIT = PAN_PROPORTION.NO_FIT;
pub const PAN_PROP_OLD_STYLE = PAN_PROPORTION.OLD_STYLE;
pub const PAN_PROP_MODERN = PAN_PROPORTION.MODERN;
pub const PAN_PROP_EVEN_WIDTH = PAN_PROPORTION.EVEN_WIDTH;
pub const PAN_PROP_EXPANDED = PAN_PROPORTION.EXPANDED;
pub const PAN_PROP_CONDENSED = PAN_PROPORTION.CONDENSED;
pub const PAN_PROP_VERY_EXPANDED = PAN_PROPORTION.VERY_EXPANDED;
pub const PAN_PROP_VERY_CONDENSED = PAN_PROPORTION.VERY_CONDENSED;
pub const PAN_PROP_MONOSPACED = PAN_PROPORTION.MONOSPACED;

pub const PAN_CONTRAST = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 4,
    NONE = 2,
    VERY_LOW = 3,
    // LOW = 4, this enum value conflicts with INDEX
    MEDIUM_LOW = 5,
    MEDIUM = 6,
    MEDIUM_HIGH = 7,
    HIGH = 8,
...
pub const PAN_CONTRAST_ANY = PAN_CONTRAST.ANY;
pub const PAN_CONTRAST_NO_FIT = PAN_CONTRAST.NO_FIT;
pub const PAN_CONTRAST_INDEX = PAN_CONTRAST.INDEX;
pub const PAN_CONTRAST_NONE = PAN_CONTRAST.NONE;
pub const PAN_CONTRAST_VERY_LOW = PAN_CONTRAST.VERY_LOW;
pub const PAN_CONTRAST_LOW = PAN_CONTRAST.INDEX;
pub const PAN_CONTRAST_MEDIUM_LOW = PAN_CONTRAST.MEDIUM_LOW;
pub const PAN_CONTRAST_MEDIUM = PAN_CONTRAST.MEDIUM;
pub const PAN_CONTRAST_MEDIUM_HIGH = PAN_CONTRAST.MEDIUM_HIGH;
pub const PAN_CONTRAST_HIGH = PAN_CONTRAST.HIGH;
pub const PAN_CONTRAST_VERY_HIGH = PAN_CONTRAST.VERY_HIGH;

pub const PAN_ARM_STYLE = enum(u8) {
    ARM_ANY = 0,
    ARM_NO_FIT = 1,
...
pub const PAN_ARM_ANY = PAN_ARM_STYLE.ARM_ANY;
pub const PAN_ARM_NO_FIT = PAN_ARM_STYLE.ARM_NO_FIT;
pub const PAN_STRAIGHT_ARMS_HORZ = PAN_ARM_STYLE.STRAIGHT_ARMS_HORZ;
pub const PAN_STRAIGHT_ARMS_WEDGE = PAN_ARM_STYLE.STRAIGHT_ARMS_WEDGE;
pub const PAN_STRAIGHT_ARMS_VERT = PAN_ARM_STYLE.STRAIGHT_ARMS_VERT;
pub const PAN_STRAIGHT_ARMS_SINGLE_SERIF = PAN_ARM_STYLE.STRAIGHT_ARMS_SINGLE_SERIF;
pub const PAN_STRAIGHT_ARMS_DOUBLE_SERIF = PAN_ARM_STYLE.STRAIGHT_ARMS_DOUBLE_SERIF;
pub const PAN_BENT_ARMS_HORZ = PAN_ARM_STYLE.BENT_ARMS_HORZ;
pub const PAN_BENT_ARMS_WEDGE = PAN_ARM_STYLE.BENT_ARMS_WEDGE;
pub const PAN_BENT_ARMS_VERT = PAN_ARM_STYLE.BENT_ARMS_VERT;
pub const PAN_BENT_ARMS_SINGLE_SERIF = PAN_ARM_STYLE.BENT_ARMS_SINGLE_SERIF;
pub const PAN_BENT_ARMS_DOUBLE_SERIF = PAN_ARM_STYLE.BENT_ARMS_DOUBLE_SERIF;

pub const PAN_LETT_FORM = enum(u8) {
    FORM_ANY = 0,
    FORM_NO_FIT = 1,
    NORMAL_CONTACT = 2,
    NORMAL_WEIGHTED = 3,
...
pub const PAN_LETT_FORM_ANY = PAN_LETT_FORM.FORM_ANY;
pub const PAN_LETT_FORM_NO_FIT = PAN_LETT_FORM.FORM_NO_FIT;
pub const PAN_LETT_NORMAL_CONTACT = PAN_LETT_FORM.NORMAL_CONTACT;
pub const PAN_LETT_NORMAL_WEIGHTED = PAN_LETT_FORM.NORMAL_WEIGHTED;
pub const PAN_LETT_NORMAL_BOXED = PAN_LETT_FORM.NORMAL_BOXED;
pub const PAN_LETT_NORMAL_FLATTENED = PAN_LETT_FORM.NORMAL_FLATTENED;
pub const PAN_LETT_NORMAL_ROUNDED = PAN_LETT_FORM.NORMAL_ROUNDED;
pub const PAN_LETT_NORMAL_OFF_CENTER = PAN_LETT_FORM.NORMAL_OFF_CENTER;
pub const PAN_LETT_NORMAL_SQUARE = PAN_LETT_FORM.NORMAL_SQUARE;
pub const PAN_LETT_OBLIQUE_CONTACT = PAN_LETT_FORM.OBLIQUE_CONTACT;
pub const PAN_LETT_OBLIQUE_WEIGHTED = PAN_LETT_FORM.OBLIQUE_WEIGHTED;
pub const PAN_LETT_OBLIQUE_BOXED = PAN_LETT_FORM.OBLIQUE_BOXED;
pub const PAN_LETT_OBLIQUE_FLATTENED = PAN_LETT_FORM.OBLIQUE_FLATTENED;
pub const PAN_LETT_OBLIQUE_ROUNDED = PAN_LETT_FORM.OBLIQUE_ROUNDED;
pub const PAN_LETT_OBLIQUE_OFF_CENTER = PAN_LETT_FORM.OBLIQUE_OFF_CENTER;
pub const PAN_LETT_OBLIQUE_SQUARE = PAN_LETT_FORM.OBLIQUE_SQUARE;

pub const PAN_MIDLINE = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 8,
    STANDARD_TRIMMED = 2,
    ...
    HIGH_POINTED = 6,
    HIGH_SERIFED = 7,
    // CONSTANT_TRIMMED = 8, this enum value conflicts with INDEX
    CONSTANT_POINTED = 9,
    CONSTANT_SERIFED = 10,
    LOW_TRIMMED = 11,
    LOW_POINTED = 12,
...
pub const PAN_MIDLINE_ANY = PAN_MIDLINE.ANY;
pub const PAN_MIDLINE_NO_FIT = PAN_MIDLINE.NO_FIT;
pub const PAN_MIDLINE_INDEX = PAN_MIDLINE.INDEX;
pub const PAN_MIDLINE_STANDARD_TRIMMED = PAN_MIDLINE.STANDARD_TRIMMED;
pub const PAN_MIDLINE_STANDARD_POINTED = PAN_MIDLINE.STANDARD_POINTED;
pub const PAN_MIDLINE_STANDARD_SERIFED = PAN_MIDLINE.STANDARD_SERIFED;
pub const PAN_MIDLINE_HIGH_TRIMMED = PAN_MIDLINE.HIGH_TRIMMED;
pub const PAN_MIDLINE_HIGH_POINTED = PAN_MIDLINE.HIGH_POINTED;
pub const PAN_MIDLINE_HIGH_SERIFED = PAN_MIDLINE.HIGH_SERIFED;
pub const PAN_MIDLINE_CONSTANT_TRIMMED = PAN_MIDLINE.INDEX;
pub const PAN_MIDLINE_CONSTANT_POINTED = PAN_MIDLINE.CONSTANT_POINTED;
pub const PAN_MIDLINE_CONSTANT_SERIFED = PAN_MIDLINE.CONSTANT_SERIFED;
pub const PAN_MIDLINE_LOW_TRIMMED = PAN_MIDLINE.LOW_TRIMMED;
pub const PAN_MIDLINE_LOW_POINTED = PAN_MIDLINE.LOW_POINTED;
pub const PAN_MIDLINE_LOW_SERIFED = PAN_MIDLINE.LOW_SERIFED;

pub const PAN_XHEIGHT = enum(u8) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 9,
    CONSTANT_SMALL = 2,
...
pub const PAN_XHEIGHT_ANY = PAN_XHEIGHT.ANY;
pub const PAN_XHEIGHT_NO_FIT = PAN_XHEIGHT.NO_FIT;
pub const PAN_XHEIGHT_INDEX = PAN_XHEIGHT.INDEX;
pub const PAN_XHEIGHT_CONSTANT_SMALL = PAN_XHEIGHT.CONSTANT_SMALL;
pub const PAN_XHEIGHT_CONSTANT_STD = PAN_XHEIGHT.CONSTANT_STD;
pub const PAN_XHEIGHT_CONSTANT_LARGE = PAN_XHEIGHT.CONSTANT_LARGE;
pub const PAN_XHEIGHT_DUCKING_SMALL = PAN_XHEIGHT.DUCKING_SMALL;
pub const PAN_XHEIGHT_DUCKING_STD = PAN_XHEIGHT.DUCKING_STD;
pub const PAN_XHEIGHT_DUCKING_LARGE = PAN_XHEIGHT.DUCKING_LARGE;

pub const ENUM_DISPLAY_SETTINGS_FLAGS = enum(u32) {
    AWMODE = 2,
    OTATEDMODE = 4,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(ENUM_DISPLAY_SETTINGS_FLAGS, @enumFromInt(
              (if (o.AWMODE == 1) @intFromEnum(ENUM_DISPLAY_SETTINGS_FLAGS.AWMODE) else 0)
            | (if (o.OTATEDMODE == 1) @intFromEnum(ENUM_DISPLAY_SETTINGS_FLAGS.OTATEDMODE) else 0)
        ));
    }
};
pub const EDS_RAWMODE = ENUM_DISPLAY_SETTINGS_FLAGS.AWMODE;
pub const EDS_ROTATEDMODE = ENUM_DISPLAY_SETTINGS_FLAGS.OTATEDMODE;
...
pub extern "gdi32" fn CreateDCA(
    pwszDriver: ?[*:0]align(1) const u8,
    pwszDevice: ?[*:0]align(1) const u8,
    pszPort: ?[*:0]align(1) const u8,
    pdm: ?*const DEVMODEA,
) callconv(@import("std").os.windows.WINAPI) ?HDC;

// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn CreateDCW(
    pwszDriver: ?[*:0]align(1) const u16,
    pwszDevice: ?[*:0]align(1) const u16,
    pszPort: ?[*:0]align(1) const u16,
    pdm: ?*const DEVMODEW,
) callconv(@import("std").os.windows.WINAPI) ?HDC;
...
pub extern "gdi32" fn CreateFontA(
    ...
    iQuality: u32,
    iPitchAndFamily: u32,
    pszFaceName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HFONT;
...
pub extern "gdi32" fn CreateFontW(
    ...
    iQuality: u32,
    iPitchAndFamily: u32,
    pszFaceName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HFONT;
...
pub extern "gdi32" fn CreateICA(
    pszDriver: ?[*:0]align(1) const u8,
    pszDevice: ?[*:0]align(1) const u8,
    pszPort: ?[*:0]align(1) const u8,
    pdm: ?*const DEVMODEA,
) callconv(@import("std").os.windows.WINAPI) ?HDC;
...
pub extern "gdi32" fn CreateICW(
    pszDriver: ?[*:0]align(1) const u16,
    pszDevice: ?[*:0]align(1) const u16,
    pszPort: ?[*:0]align(1) const u16,
    pdm: ?*const DEVMODEW,
) callconv(@import("std").os.windows.WINAPI) ?HDC;
...
pub extern "gdi32" fn CreateMetaFileA(
    pszFile: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HDC;

// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn CreateMetaFileW(
    pszFile: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HDC;
...
pub extern "gdi32" fn CreateScalableFontResourceA(
    fdwHidden: u32,
    lpszFont: ?[*:0]align(1) const u8,
    lpszFile: ?[*:0]align(1) const u8,
    lpszPath: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn CreateScalableFontResourceW(
    fdwHidden: u32,
    lpszFont: ?[*:0]align(1) const u16,
    lpszFile: ?[*:0]align(1) const u16,
    lpszPath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "gdi32" fn GetROP2(
    hdc: ?HDC,
) callconv(@import("std").os.windows.WINAPI) R2_MODE;
...
pub extern "gdi32" fn GetMapMode(
    hdc: ?HDC,
) callconv(@import("std").os.windows.WINAPI) HDC_MAP_MODE;
...
pub extern "gdi32" fn GetTextAlign(
    hdc: ?HDC,
) callconv(@import("std").os.windows.WINAPI) TEXT_ALIGN_OPTIONS;
...
pub extern "t2embed" fn TTEmbedFontFromFileA(
    hDC: ?HDC,
    szFontFileName: ?[*:0]align(1) const u8,
    usTTCIndex: u16,
    ulFlags: TTEMBED_FLAGS,
    ulCharSet: EMBED_FONT_CHARSET,
    pulPrivStatus: ?*EMBEDDED_FONT_PRIV_STATUS,
...
pub extern "t2embed" fn TTIsEmbeddingEnabledForFacename(
    lpszFacename: ?[*:0]align(1) const u8,
    pbEnabled: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn LoadBitmapA(
    hInstance: ?HINSTANCE,
    lpBitmapName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HBITMAP;
...
pub extern "user32" fn ChangeDisplaySettingsExA(
    lpszDeviceName: ?[*:0]align(1) const u8,
    lpDevMode: ?*DEVMODEA,
    hwnd: ?HWND,
    dwflags: CDS_TYPE,
    lParam: ?*anyopaque,
...
pub extern "user32" fn ChangeDisplaySettingsExW(
    lpszDeviceName: ?[*:0]align(1) const u16,
    lpDevMode: ?*DEVMODEW,
    hwnd: ?HWND,
    dwflags: CDS_TYPE,
    lParam: ?*anyopaque,
...
const POINTS = @import("../../../windows/win32/foundation.zig").POINTS;
