...
pub const IVssComponent = extern struct {
    pub const VTable = extern struct {
        ...
        AddPartialFile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszFilename: ?[*:0]align(1) const u16,
                wszRanges: ?[*:0]align(1) const u16,
                wszMetadata: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszPath: ?[*:0]align(1) const u16,
        ...
        AddDirectedTarget: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszSourcePath: ?[*:0]align(1) const u16,
                wszSourceFilename: ?[*:0]align(1) const u16,
                wszSourceRangeList: ?[*:0]align(1) const u16,
                wszDestinationPath: ?[*:0]align(1) const u16,
                wszDestinationFilename: ?[*:0]align(1) const u16,
                wszDestinationRangeList: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszSourcePath: ?[*:0]align(1) const u16,
        ...
        SetRestoreMetadata: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszRestoreMetadata: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszRestoreMetadata: ?[*:0]align(1) const u16,
        ...
        SetPreRestoreFailureMsg: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszPreRestoreFailureMsg: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszPreRestoreFailureMsg: ?[*:0]align(1) const u16,
        ...
        SetPostRestoreFailureMsg: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszPostRestoreFailureMsg: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszPostRestoreFailureMsg: ?[*:0]align(1) const u16,
        ...
        SetBackupStamp: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszBackupStamp: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponent,
                wszBackupStamp: ?[*:0]align(1) const u16,
        ...
        AddDifferencedFilesByLastModifyTime: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssComponent,
                wszPath: ?[*:0]align(1) const u16,
                wszFilespec: ?[*:0]align(1) const u16,
                bRecursive: BOOL,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_SetBackupMetadata(self: *const T, wszData: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_AddPartialFile(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilename: ?[*:0]align(1) const u16, wszRanges: ?[*:0]align(1) const u16, wszMetadata: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_AddDirectedTarget(self: *const T, wszSourcePath: ?[*:0]align(1) const u16, wszSourceFilename: ?[*:0]align(1) const u16, wszSourceRangeList: ?[*:0]align(1) const u16, wszDestinationPath: ?[*:0]align(1) const u16, wszDestinationFilename: ?[*:0]align(1) const u16, wszDestinationRangeList: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_SetRestoreMetadata(self: *const T, wszRestoreMetadata: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_SetPreRestoreFailureMsg(self: *const T, wszPreRestoreFailureMsg: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_SetPostRestoreFailureMsg(self: *const T, wszPostRestoreFailureMsg: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_SetBackupStamp(self: *const T, wszBackupStamp: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_AddDifferencedFilesByLastModifyTime(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: BOOL, ftLastModifyTime: FILETIME) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponent_AddDifferencedFilesByLastModifyLSN(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: BOOL, bstrLsnString: ?BSTR) callconv(.Inline) HRESULT {
...
pub const IVssComponentEx = extern struct {
    pub const VTable = extern struct {
        ...
        SetPrepareForBackupFailureMsg: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszFailureMsg: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponentEx,
                wszFailureMsg: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponentEx_SetPrepareForBackupFailureMsg(self: *const T, wszFailureMsg: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponentEx_SetPostSnapshotFailureMsg(self: *const T, wszFailureMsg: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IVssComponentEx2 = extern struct {
    pub const VTable = extern struct {
        ...
        SetFailure: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszApplicationMessage: ?[*:0]align(1) const u16,
                dwReserved: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssComponentEx2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssComponentEx2_SetFailure(self: *const T, hr: HRESULT, hrApplication: HRESULT, wszApplicationMessage: ?[*:0]align(1) const u16, dwReserved: u32) callconv(.Inline) HRESULT {
...
pub const IVssCreateWriterMetadata = extern struct {
    pub const VTable = extern struct {
        AddIncludeFiles: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszFilespec: ?[*:0]align(1) const u16,
                bRecursive: u8,
                wszAlternateLocation: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssCreateWriterMetadata,
                wszPath: ?[*:0]align(1) const u16,
        ...
        AddComponent: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszLogicalPath: ?[*:0]align(1) const u16,
                wszComponentName: ?[*:0]align(1) const u16,
                wszCaption: ?[*:0]align(1) const u16,
                pbIcon: ?*const u8,
                cbIcon: u32,
                bRestoreMetadata: u8,
        ...
        AddDatabaseFiles: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssCreateWriterMetadata,
                wszLogicalPath: ?[*:0]align(1) const u16,
                wszDatabaseName: ?[*:0]align(1) const u16,
                wszPath: ?[*:0]align(1) const u16,
                wszFilespec: ?[*:0]align(1) const u16,
        ...
        AddFilesToFileGroup: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssCreateWriterMetadata,
                wszLogicalPath: ?[*:0]align(1) const u16,
                wszGroupName: ?[*:0]align(1) const u16,
                wszPath: ?[*:0]align(1) const u16,
                wszFilespec: ?[*:0]align(1) const u16,
                bRecursive: u8,
                wszAlternateLocation: ?[*:0]align(1) const u16,
        ...
        SetRestoreMethod: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszService: ?[*:0]align(1) const u16,
                wszUserProcedure: ?[*:0]align(1) const u16,
        ...
        AddAlternateLocationMapping: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssCreateWriterMetadata,
                wszSourcePath: ?[*:0]align(1) const u16,
                wszSourceFilespec: ?[*:0]align(1) const u16,
                bRecursive: u8,
                wszDestination: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssCreateWriterMetadata,
                wszSourcePath: ?[*:0]align(1) const u16,
        ...
        AddComponentDependency: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVssCreateWriterMetadata,
                wszForLogicalPath: ?[*:0]align(1) const u16,
                wszForComponentName: ?[*:0]align(1) const u16,
                onWriterId: Guid,
                wszOnLogicalPath: ?[*:0]align(1) const u16,
                wszOnComponentName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVssCreateWriterMetadata,
                wszForLogicalPath: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddIncludeFiles(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: u8, wszAlternateLocation: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddExcludeFiles(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddDatabaseFiles(self: *const T, wszLogicalPath: ?[*:0]align(1) const u16, wszDatabaseName: ?[*:0]align(1) const u16, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, dwBackupTypeMask: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddDatabaseLogFiles(self: *const T, wszLogicalPath: ?[*:0]align(1) const u16, wszDatabaseName: ?[*:0]align(1) const u16, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, dwBackupTypeMask: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddFilesToFileGroup(self: *const T, wszLogicalPath: ?[*:0]align(1) const u16, wszGroupName: ?[*:0]align(1) const u16, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: u8, wszAlternateLocation: ?[*:0]align(1) const u16, dwBackupTypeMask: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_SetRestoreMethod(self: *const T, method: VSS_RESTOREMETHOD_ENUM, wszService: ?[*:0]align(1) const u16, wszUserProcedure: ?[*:0]align(1) const u16, writerRestore: VSS_WRITERRESTORE_ENUM, bRebootRequired: u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddAlternateLocationMapping(self: *const T, wszSourcePath: ?[*:0]align(1) const u16, wszSourceFilespec: ?[*:0]align(1) const u16, bRecursive: u8, wszDestination: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateWriterMetadata_AddComponentDependency(self: *const T, wszForLogicalPath: ?[*:0]align(1) const u16, wszForComponentName: ?[*:0]align(1) const u16, onWriterId: Guid, wszOnLogicalPath: ?[*:0]align(1) const u16, wszOnComponentName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IVssCreateExpressWriterMetadata = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateExpressWriterMetadata_AddExcludeFiles(self: *const T, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateExpressWriterMetadata_AddComponent(self: *const T, ct: VSS_COMPONENT_TYPE, wszLogicalPath: ?[*:0]align(1) const u16, wszComponentName: ?[*:0]align(1) const u16, wszCaption: ?[*:0]align(1) const u16, pbIcon: ?*const u8, cbIcon: u32, bRestoreMetadata: u8, bNotifyOnBackupComplete: u8, bSelectable: u8, bSelectableForRestore: u8, dwComponentFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateExpressWriterMetadata_AddFilesToFileGroup(self: *const T, wszLogicalPath: ?[*:0]align(1) const u16, wszGroupName: ?[*:0]align(1) const u16, wszPath: ?[*:0]align(1) const u16, wszFilespec: ?[*:0]align(1) const u16, bRecursive: u8, wszAlternateLocation: ?[*:0]align(1) const u16, dwBackupTypeMask: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateExpressWriterMetadata_SetRestoreMethod(self: *const T, method: VSS_RESTOREMETHOD_ENUM, wszService: ?[*:0]align(1) const u16, wszUserProcedure: ?[*:0]align(1) const u16, writerRestore: VSS_WRITERRESTORE_ENUM, bRebootRequired: u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssCreateExpressWriterMetadata_AddComponentDependency(self: *const T, wszForLogicalPath: ?[*:0]align(1) const u16, wszForComponentName: ?[*:0]align(1) const u16, onWriterId: Guid, wszOnLogicalPath: ?[*:0]align(1) const u16, wszOnComponentName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IVssExpressWriter = extern struct {
    pub const VTable = extern struct {
        ...
        CreateMetadata: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                writerId: Guid,
                writerName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssExpressWriter_CreateMetadata(self: *const T, writerId: Guid, writerName: ?[*:0]align(1) const u16, usageType: VSS_USAGE_TYPE, versionMajor: u32, versionMinor: u32, reserved: u32, ppMetadata: ?*?*IVssCreateExpressWriterMetadata) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVssExpressWriter_LoadMetadata(self: *const T, metadata: ?[*:0]align(1) const u16, reserved: u32) callconv(.Inline) HRESULT {
...
const VDS_LUN_INFORMATION = @import("../../../windows/win32/storage/virtual_disk_service.zig").VDS_LUN_INFORMATION;
