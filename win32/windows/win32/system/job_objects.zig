...
pub const JOB_OBJECT_CPU_RATE_CONTROL = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(JOB_OBJECT_CPU_RATE_CONTROL, @enumFromInt(
              (if (o.ENABLE == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.ENABLE) else 0)
            | (if (o.WEIGHT_BASED == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.WEIGHT_BASED) else 0)
            | (if (o.HARD_CAP == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.HARD_CAP) else 0)
            | (if (o.NOTIFY == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.NOTIFY) else 0)
            | (if (o.MIN_MAX_RATE == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.MIN_MAX_RATE) else 0)
            | (if (o.VALID_FLAGS == 1) @intFromEnum(JOB_OBJECT_CPU_RATE_CONTROL.VALID_FLAGS) else 0)
        ));
    }
};
pub const JOB_OBJECT_CPU_RATE_CONTROL_ENABLE = JOB_OBJECT_CPU_RATE_CONTROL.ENABLE;
pub const JOB_OBJECT_CPU_RATE_CONTROL_WEIGHT_BASED = JOB_OBJECT_CPU_RATE_CONTROL.WEIGHT_BASED;
pub const JOB_OBJECT_CPU_RATE_CONTROL_HARD_CAP = JOB_OBJECT_CPU_RATE_CONTROL.HARD_CAP;
pub const JOB_OBJECT_CPU_RATE_CONTROL_NOTIFY = JOB_OBJECT_CPU_RATE_CONTROL.NOTIFY;
pub const JOB_OBJECT_CPU_RATE_CONTROL_MIN_MAX_RATE = JOB_OBJECT_CPU_RATE_CONTROL.MIN_MAX_RATE;
pub const JOB_OBJECT_CPU_RATE_CONTROL_VALID_FLAGS = JOB_OBJECT_CPU_RATE_CONTROL.VALID_FLAGS;
...
pub const JOB_OBJECT_NET_RATE_CONTROL_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(JOB_OBJECT_NET_RATE_CONTROL_FLAGS, @enumFromInt(
              (if (o.ENABLE == 1) @intFromEnum(JOB_OBJECT_NET_RATE_CONTROL_FLAGS.ENABLE) else 0)
            | (if (o.MAX_BANDWIDTH == 1) @intFromEnum(JOB_OBJECT_NET_RATE_CONTROL_FLAGS.MAX_BANDWIDTH) else 0)
            | (if (o.DSCP_TAG == 1) @intFromEnum(JOB_OBJECT_NET_RATE_CONTROL_FLAGS.DSCP_TAG) else 0)
            | (if (o.VALID_FLAGS == 1) @intFromEnum(JOB_OBJECT_NET_RATE_CONTROL_FLAGS.VALID_FLAGS) else 0)
        ));
    }
};
...
pub const JOB_OBJECT_IO_RATE_CONTROL_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ENABLE: u1 = 0,
        STANDALONE_VOLUME: u1 = 0,
        FORCE_UNIT_ACCESS_ALL: u1 = 0,
        FORCE_UNIT_ACCESS_ON_SOFT_CAP: u1 = 0,
        VALID_FLAGS: u1 = 0,
    }) JOB_OBJECT_IO_RATE_CONTROL_FLAGS {
        return @as(JOB_OBJECT_IO_RATE_CONTROL_FLAGS, @enumFromInt(
              (if (o.ENABLE == 1) @intFromEnum(JOB_OBJECT_IO_RATE_CONTROL_FLAGS.ENABLE) else 0)
            | (if (o.STANDALONE_VOLUME == 1) @intFromEnum(JOB_OBJECT_IO_RATE_CONTROL_FLAGS.STANDALONE_VOLUME) else 0)
            | (if (o.FORCE_UNIT_ACCESS_ALL == 1) @intFromEnum(JOB_OBJECT_IO_RATE_CONTROL_FLAGS.FORCE_UNIT_ACCESS_ALL) else 0)
            | (if (o.FORCE_UNIT_ACCESS_ON_SOFT_CAP == 1) @intFromEnum(JOB_OBJECT_IO_RATE_CONTROL_FLAGS.FORCE_UNIT_ACCESS_ON_SOFT_CAP) else 0)
            | (if (o.VALID_FLAGS == 1) @intFromEnum(JOB_OBJECT_IO_RATE_CONTROL_FLAGS.VALID_FLAGS) else 0)
        ));
    }
};
...
pub const JobObjectReserved26Information = JOBOBJECTINFOCLASS.JobObjectReserved26Information;
pub const JobObjectReserved27Information = JOBOBJECTINFOCLASS.JobObjectReserved27Information;
...
const IO_COUNTERS = @import("../../../windows/win32/system/threading.zig").IO_COUNTERS;
