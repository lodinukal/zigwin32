...
pub const DIAGNOSTIC_DATA_SEARCH_CRITERIA = extern struct {
    producerNames: ?*const ?PWSTR,
    producerNameCount: u32,
    textToMatch: ?[*:0]align(1) const u16,
...
pub extern "diagnosticdataquery" fn DdqGetDiagnosticRecordProducerCategories(
    hSession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    producerName: ?[*:0]align(1) const u16,
...
pub extern "diagnosticdataquery" fn DdqExtractDiagnosticReport(
    hSession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    reportStoreType: u32,
    reportKey: ?[*:0]align(1) const u16,
    destinationPath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.19041'
pub extern "diagnosticdataquery" fn DdqGetDiagnosticRecordTagDistribution(
    hSession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    producerNames: [*]const ?[*:0]align(1) const u16,
    producerNameCount: u32,
...
const HDIAGNOSTIC_DATA_QUERY_SESSION = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_DATA_QUERY_SESSION;
const HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION;
const HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION;
const HDIAGNOSTIC_EVENT_TAG_DESCRIPTION = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_EVENT_TAG_DESCRIPTION;
const HDIAGNOSTIC_RECORD = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_RECORD;
const HDIAGNOSTIC_REPORT = @import("../../../windows/win32/security.zig").HDIAGNOSTIC_REPORT;
