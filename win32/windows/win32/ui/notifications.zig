...
pub const INotificationActivationCallback = extern struct {
    pub const VTable = extern struct {
        ...
        Activate: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                invokedArgs: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn INotificationActivationCallback_Activate(self: *const T, appUserModelId: ?[*:0]align(1) const u16, invokedArgs: ?[*:0]align(1) const u16, data: [*]const NOTIFICATION_USER_INPUT_DATA, count: u32) callconv(.Inline) HRESULT {
