...
pub const DWRITE_STANDARD_FONT_AXIS_COUNT = @as(u32, 5);
...
pub const DWRITE_GLYPH_IMAGE_FORMATS = enum(i32) {
    NONE = 0,
    TRUETYPE = 1,
    CFF = 2,
    COLR = 4,
...
pub const DWRITE_FONT_SIMULATIONS = enum(i32) {
    NONE = 0,
    BOLD = 1,
    OBLIQUE = 2,
    _,
...
pub const IDWriteLocalizedStrings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteLocalizedStrings_FindLocaleName(self: *const T, localeName: ?[*:0]align(1) const u16, index: ?*u32, exists: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDWriteFontCollection = extern struct {
    pub const VTable = extern struct {
        ...
        FindFamilyName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteFontCollection,
                familyName: ?[*:0]align(1) const u16,
                index: ?*u32,
                exists: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontCollection_FindFamilyName(self: *const T, familyName: ?[*:0]align(1) const u16, index: ?*u32, exists: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const DWRITE_SCRIPT_SHAPES = enum(i32) {
    DEFAULT = 0,
    NO_VISUAL = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const IDWriteTextAnalyzer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextAnalyzer_GetGlyphs(self: *const T, textString: [*:0]const u16, textLength: u32, fontFace: ?*IDWriteFontFace, isSideways: BOOL, isRightToLeft: BOOL, scriptAnalysis: ?*const DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]align(1) const u16, numberSubstitution: ?*IDWriteNumberSubstitution, features: ?[*]const ?*const DWRITE_TYPOGRAPHIC_FEATURES, featureRangeLengths: ?[*]const u32, featureRanges: u32, maxGlyphCount: u32, clusterMap: [*:0]u16, textProps: [*]DWRITE_SHAPING_TEXT_PROPERTIES, glyphIndices: [*:0]u16, glyphProps: [*]DWRITE_SHAPING_GLYPH_PROPERTIES, actualGlyphCount: ?*u32) callconv(.Inline) HRESULT {
...
pub const IDWriteTextLayout = extern struct {
    pub const VTable = extern struct {
        ...
        SetFontFamilyName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteTextLayout,
                fontFamilyName: ?[*:0]align(1) const u16,
                textRange: DWRITE_TEXT_RANGE,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDWriteTextLayout,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextLayout_SetFontFamilyName(self: *const T, fontFamilyName: ?[*:0]align(1) const u16, textRange: DWRITE_TEXT_RANGE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextLayout_SetLocaleName(self: *const T, localeName: ?[*:0]align(1) const u16, textRange: DWRITE_TEXT_RANGE) callconv(.Inline) HRESULT {
...
pub const IDWriteBitmapRenderTarget = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteBitmapRenderTarget_DrawGlyphRun(self: *const T, baselineOriginX: f32, baselineOriginY: f32, measuringMode: DWRITE_MEASURING_MODE, glyphRun: ?*const DWRITE_GLYPH_RUN, renderingParams: ?*IDWriteRenderingParams, textColor: COLORREF, blackBoxRect: ?*RECT) callconv(.Inline) HRESULT {
...
pub const IDWriteFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory_CreateFontFileReference(self: *const T, filePath: ?[*:0]align(1) const u16, lastWriteTime: ?*const FILETIME, fontFile: ?*?*IDWriteFontFile) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory_CreateTextFormat(self: *const T, fontFamilyName: ?[*:0]align(1) const u16, fontCollection: ?*IDWriteFontCollection, fontWeight: DWRITE_FONT_WEIGHT, fontStyle: DWRITE_FONT_STYLE, fontStretch: DWRITE_FONT_STRETCH, fontSize: f32, localeName: ?[*:0]align(1) const u16, textFormat: ?*?*IDWriteTextFormat) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory_CreateNumberSubstitution(self: *const T, substitutionMethod: DWRITE_NUMBER_SUBSTITUTION_METHOD, localeName: ?[*:0]align(1) const u16, ignoreUserOverride: BOOL, numberSubstitution: ?*?*IDWriteNumberSubstitution) callconv(.Inline) HRESULT {
...
pub const IDWriteTextAnalyzer1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextAnalyzer1_GetBaseline(self: *const T, fontFace: ?*IDWriteFontFace, baseline: DWRITE_BASELINE, isVertical: BOOL, isSimulationAllowed: BOOL, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]align(1) const u16, baselineCoordinate: ?*i32, exists: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDWriteTextAnalyzer2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextAnalyzer2_GetTypographicFeatures(self: *const T, fontFace: ?*IDWriteFontFace, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]align(1) const u16, maxTagCount: u32, actualTagCount: ?*u32, tags: [*]DWRITE_FONT_FEATURE_TAG) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteTextAnalyzer2_CheckTypographicFeature(self: *const T, fontFace: ?*IDWriteFontFace, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]align(1) const u16, featureTag: DWRITE_FONT_FEATURE_TAG, glyphCount: u32, glyphIndices: [*:0]const u16, featureApplies: [*:0]u8) callconv(.Inline) HRESULT {
    ...
    pub const VTable = extern struct {
        ...
        MapCharacters: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                baseFamilyName: ?[*:0]align(1) const u16,
...
pub const IDWriteFontFallbackBuilder = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontFallbackBuilder_AddMapping(self: *const T, ranges: [*]const DWRITE_UNICODE_RANGE, rangesCount: u32, targetFamilyNames: [*]const ?*const u16, targetFamilyNamesCount: u32, fontCollection: ?*IDWriteFontCollection, localeName: ?[*:0]align(1) const u16, baseFamilyName: ?[*:0]align(1) const u16, scale: f32) callconv(.Inline) HRESULT {
...
pub const DWRITE_FONT_PROPERTY = extern struct {
    ...
    propertyValue: ?[*:0]align(1) const u16,
    localeName: ?[*:0]align(1) const u16,
};
...
pub const IDWriteFactory3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory3_CreateFontFaceReference1(self: *const T, filePath: ?[*:0]align(1) const u16, lastWriteTime: ?*const FILETIME, faceIndex: u32, fontSimulations: DWRITE_FONT_SIMULATIONS, fontFaceReference: ?*?*IDWriteFontFaceReference) callconv(.Inline) HRESULT {
...
pub const IDWriteFontSet = extern struct {
    pub const VTable = extern struct {
        ...
        GetPropertyValues1: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteFontSet,
                propertyID: DWRITE_FONT_PROPERTY_ID,
                preferredLocaleNames: ?[*:0]align(1) const u16,
                values: ?*?*IDWriteStringList,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDWriteFontSet,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontSet_GetPropertyValues1(self: *const T, propertyID: DWRITE_FONT_PROPERTY_ID, preferredLocaleNames: ?[*:0]align(1) const u16, values: ?*?*IDWriteStringList) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontSet_GetMatchingFonts(self: *const T, familyName: ?[*:0]align(1) const u16, fontWeight: DWRITE_FONT_WEIGHT, fontStretch: DWRITE_FONT_STRETCH, fontStyle: DWRITE_FONT_STYLE, filteredSet: ?*?*IDWriteFontSet) callconv(.Inline) HRESULT {
...
pub const IDWriteRemoteFontFileLoader = extern struct {
    pub const VTable = extern struct {
        ...
        CreateFontFileReferenceFromUrl: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteRemoteFontFileLoader,
                factory: ?*IDWriteFactory,
                baseUrl: ?[*:0]align(1) const u16,
                fontFileUrl: ?[*:0]align(1) const u16,
                fontFile: ?*?*IDWriteFontFile,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDWriteRemoteFontFileLoader,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteRemoteFontFileLoader_CreateFontFileReferenceFromUrl(self: *const T, factory: ?*IDWriteFactory, baseUrl: ?[*:0]align(1) const u16, fontFileUrl: ?[*:0]align(1) const u16, fontFile: ?*?*IDWriteFontFile) callconv(.Inline) HRESULT {
...
pub const IDWriteFactory5 = extern struct {
    pub const VTable = extern struct {
        ...
        CreateHttpFontFileLoader: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteFactory5,
                referrerUrl: ?[*:0]align(1) const u16,
                extraHeaders: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory5_CreateHttpFontFileLoader(self: *const T, referrerUrl: ?[*:0]align(1) const u16, extraHeaders: ?[*:0]align(1) const u16, newLoader: ?*?*IDWriteRemoteFontFileLoader) callconv(.Inline) HRESULT {
...
pub const DWRITE_AUTOMATIC_FONT_AXES = enum(i32) {
    NONE = 0,
    OPTICAL_SIZE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const DWRITE_FONT_AXIS_ATTRIBUTES = enum(i32) {
    NONE = 0,
    VARIABLE = 1,
    HIDDEN = 2,
    _,
...
pub const IDWriteFactory6 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFactory6_CreateTextFormat(self: *const T, fontFamilyName: ?[*:0]align(1) const u16, fontCollection: ?*IDWriteFontCollection, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontSize: f32, localeName: ?[*:0]align(1) const u16, textFormat: ?*?*IDWriteTextFormat3) callconv(.Inline) HRESULT {
...
pub const IDWriteFontSetBuilder2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontSetBuilder2_AddFontFile(self: *const T, filePath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDWriteFontCollection2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontCollection2_GetMatchingFonts(self: *const T, familyName: ?[*:0]align(1) const u16, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontList: ?*?*IDWriteFontList2) callconv(.Inline) HRESULT {
...
pub const IDWriteFontFallback1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontFallback1_MapCharacters(self: *const T, analysisSource: ?*IDWriteTextAnalysisSource, textPosition: u32, textLength: u32, baseFontCollection: ?*IDWriteFontCollection, baseFamilyName: ?[*:0]align(1) const u16, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, mappedLength: ?*u32, scale: ?*f32, mappedFontFace: ?*?*IDWriteFontFace5) callconv(.Inline) HRESULT {
...
// This COM type is Agile, not sure what that means
const IID_IDWriteFontSet4_Value = Guid.initString("eec175fc-bea9-4c86-8b53-ccbdd7df0c82");
pub const IID_IDWriteFontSet4 = &IID_IDWriteFontSet4_Value;
pub const IDWriteFontSet4 = extern struct {
    pub const VTable = extern struct {
        base: IDWriteFontSet3.VTable,
        ConvertWeightStretchStyleToFontAxisValues: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDWriteFontSet4,
                ...
                fontStyle: DWRITE_FONT_STYLE,
                fontSize: f32,
                outputAxisValues: *[5]DWRITE_FONT_AXIS_VALUE,
            ) callconv(@import("std").os.windows.WINAPI) u32,
            else => *const fn(
                self: *const IDWriteFontSet4,
                inputAxisValues: ?[*]const DWRITE_FONT_AXIS_VALUE,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDWriteFontSet3.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontSet4_ConvertWeightStretchStyleToFontAxisValues(self: *const T, inputAxisValues: ?[*]const DWRITE_FONT_AXIS_VALUE, inputAxisCount: u32, fontWeight: DWRITE_FONT_WEIGHT, fontStretch: DWRITE_FONT_STRETCH, fontStyle: DWRITE_FONT_STYLE, fontSize: f32, outputAxisValues: *[5]DWRITE_FONT_AXIS_VALUE) callconv(.Inline) u32 {
            return @as(*const IDWriteFontSet4.VTable, @ptrCast(self.vtable)).ConvertWeightStretchStyleToFontAxisValues(@as(*const IDWriteFontSet4, @ptrCast(self)), inputAxisValues, inputAxisCount, fontWeight, fontStretch, fontStyle, fontSize, outputAxisValues);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDWriteFontSet4_GetMatchingFonts(self: *const T, familyName: ?[*:0]align(1) const u16, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, allowedSimulations: DWRITE_FONT_SIMULATIONS, matchingFonts: ?*?*IDWriteFontSet4) callconv(.Inline) HRESULT {
            return @as(*const IDWriteFontSet4.VTable, @ptrCast(self.vtable)).GetMatchingFonts(@as(*const IDWriteFontSet4, @ptrCast(self)), familyName, fontAxisValues, fontAxisValueCount, allowedSimulations, matchingFonts);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const FONTSIGNATURE = @import("../../../windows/win32/globalization.zig").FONTSIGNATURE;
