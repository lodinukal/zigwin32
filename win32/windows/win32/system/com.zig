...
//--------------------------------------------------------------------------------
pub const COLE_DEFAULT_PRINCIPAL = @import("../../../zig.zig").typedConst([*:0]align(1) const u16, @as(i32, -1));
pub const COLE_DEFAULT_AUTHINFO = @as(i32, -1);
...
pub const ROT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(ROT_FLAGS, @enumFromInt(
              (if (o.REGISTRATIONKEEPSALIVE == 1) @intFromEnum(ROT_FLAGS.REGISTRATIONKEEPSALIVE) else 0)
            | (if (o.ALLOWANYCLIENT == 1) @intFromEnum(ROT_FLAGS.ALLOWANYCLIENT) else 0)
        ));
    }
};
pub const ROTFLAGS_REGISTRATIONKEEPSALIVE = ROT_FLAGS.REGISTRATIONKEEPSALIVE;
pub const ROTFLAGS_ALLOWANYCLIENT = ROT_FLAGS.ALLOWANYCLIENT;

pub const ADVANCED_FEATURE_FLAGS = enum(u16) {
    AUTO = 1,
    STATIC = 2,
    EMBEDDED = 4,
    FIXEDSIZE = 16,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(ADVANCED_FEATURE_FLAGS, @enumFromInt(
              (if (o.AUTO == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.AUTO) else 0)
            | (if (o.STATIC == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.STATIC) else 0)
            | (if (o.EMBEDDED == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.EMBEDDED) else 0)
            | (if (o.FIXEDSIZE == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.FIXEDSIZE) else 0)
            | (if (o.RECORD == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.RECORD) else 0)
            | (if (o.HAVEIID == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.HAVEIID) else 0)
            | (if (o.HAVEVARTYPE == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.HAVEVARTYPE) else 0)
            | (if (o.BSTR == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.BSTR) else 0)
            | (if (o.UNKNOWN == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.UNKNOWN) else 0)
            | (if (o.DISPATCH == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.DISPATCH) else 0)
            | (if (o.VARIANT == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.VARIANT) else 0)
            | (if (o.RESERVED == 1) @intFromEnum(ADVANCED_FEATURE_FLAGS.RESERVED) else 0)
        ));
    }
};
pub const FADF_AUTO = ADVANCED_FEATURE_FLAGS.AUTO;
pub const FADF_STATIC = ADVANCED_FEATURE_FLAGS.STATIC;
pub const FADF_EMBEDDED = ADVANCED_FEATURE_FLAGS.EMBEDDED;
pub const FADF_FIXEDSIZE = ADVANCED_FEATURE_FLAGS.FIXEDSIZE;
pub const FADF_RECORD = ADVANCED_FEATURE_FLAGS.RECORD;
pub const FADF_HAVEIID = ADVANCED_FEATURE_FLAGS.HAVEIID;
pub const FADF_HAVEVARTYPE = ADVANCED_FEATURE_FLAGS.HAVEVARTYPE;
pub const FADF_BSTR = ADVANCED_FEATURE_FLAGS.BSTR;
pub const FADF_UNKNOWN = ADVANCED_FEATURE_FLAGS.UNKNOWN;
pub const FADF_DISPATCH = ADVANCED_FEATURE_FLAGS.DISPATCH;
pub const FADF_VARIANT = ADVANCED_FEATURE_FLAGS.VARIANT;
pub const FADF_RESERVED = ADVANCED_FEATURE_FLAGS.RESERVED;

pub const IMPLTYPEFLAGS = enum(i32) {
    DEFAULT = 1,
    SOURCE = 2,
    RESTRICTED = 4,
    DEFAULTVTABLE = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IMPLTYPEFLAGS, @enumFromInt(
              (if (o.DEFAULT == 1) @intFromEnum(IMPLTYPEFLAGS.DEFAULT) else 0)
            | (if (o.SOURCE == 1) @intFromEnum(IMPLTYPEFLAGS.SOURCE) else 0)
            | (if (o.RESTRICTED == 1) @intFromEnum(IMPLTYPEFLAGS.RESTRICTED) else 0)
            | (if (o.DEFAULTVTABLE == 1) @intFromEnum(IMPLTYPEFLAGS.DEFAULTVTABLE) else 0)
        ));
    }
};
pub const IMPLTYPEFLAG_FDEFAULT = IMPLTYPEFLAGS.DEFAULT;
pub const IMPLTYPEFLAG_FSOURCE = IMPLTYPEFLAGS.SOURCE;
pub const IMPLTYPEFLAG_FRESTRICTED = IMPLTYPEFLAGS.RESTRICTED;
pub const IMPLTYPEFLAG_FDEFAULTVTABLE = IMPLTYPEFLAGS.DEFAULTVTABLE;

pub const IDLFLAGS = enum(u16) {
    NONE = 0,
    FIN = 1,
    FOUT = 2,
    FLCID = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IDLFLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(IDLFLAGS.NONE) else 0)
            | (if (o.FIN == 1) @intFromEnum(IDLFLAGS.FIN) else 0)
            | (if (o.FOUT == 1) @intFromEnum(IDLFLAGS.FOUT) else 0)
            | (if (o.FLCID == 1) @intFromEnum(IDLFLAGS.FLCID) else 0)
            | (if (o.FRETVAL == 1) @intFromEnum(IDLFLAGS.FRETVAL) else 0)
        ));
    }
};
pub const IDLFLAG_NONE = IDLFLAGS.NONE;
pub const IDLFLAG_FIN = IDLFLAGS.FIN;
pub const IDLFLAG_FOUT = IDLFLAGS.FOUT;
pub const IDLFLAG_FLCID = IDLFLAGS.FLCID;
pub const IDLFLAG_FRETVAL = IDLFLAGS.FRETVAL;

pub const DISPATCH_FLAGS = enum(u16) {
    METHOD = 1,
    PROPERTYGET = 2,
    PROPERTYPUT = 4,
    PROPERTYPUTREF = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DISPATCH_FLAGS, @enumFromInt(
              (if (o.METHOD == 1) @intFromEnum(DISPATCH_FLAGS.METHOD) else 0)
            | (if (o.PROPERTYGET == 1) @intFromEnum(DISPATCH_FLAGS.PROPERTYGET) else 0)
            | (if (o.PROPERTYPUT == 1) @intFromEnum(DISPATCH_FLAGS.PROPERTYPUT) else 0)
            | (if (o.PROPERTYPUTREF == 1) @intFromEnum(DISPATCH_FLAGS.PROPERTYPUTREF) else 0)
        ));
    }
};
pub const DISPATCH_METHOD = DISPATCH_FLAGS.METHOD;
pub const DISPATCH_PROPERTYGET = DISPATCH_FLAGS.PROPERTYGET;
pub const DISPATCH_PROPERTYPUT = DISPATCH_FLAGS.PROPERTYPUT;
pub const DISPATCH_PROPERTYPUTREF = DISPATCH_FLAGS.PROPERTYPUTREF;
...
pub const MachineGlobalObjectTableRegistrationToken = isize;
...
pub const REGCLS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(REGCLS, @enumFromInt(
              (if (o.SINGLEUSE == 1) @intFromEnum(REGCLS.SINGLEUSE) else 0)
            | (if (o.MULTIPLEUSE == 1) @intFromEnum(REGCLS.MULTIPLEUSE) else 0)
            | (if (o.MULTI_SEPARATE == 1) @intFromEnum(REGCLS.MULTI_SEPARATE) else 0)
            | (if (o.SUSPENDED == 1) @intFromEnum(REGCLS.SUSPENDED) else 0)
            | (if (o.SURROGATE == 1) @intFromEnum(REGCLS.SURROGATE) else 0)
            | (if (o.AGILE == 1) @intFromEnum(REGCLS.AGILE) else 0)
        ));
    }
};
...
pub const CLSCTX = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        ALLOW_LOWER_TRUST_REGISTRATION: u1 = 0,
        PS_DLL: u1 = 0,
        ALL: u1 = 0,
        SERVER: u1 = 0,
    }) CLSCTX {
        return @as(CLSCTX, @enumFromInt(
            ...
            | (if (o.ALLOW_LOWER_TRUST_REGISTRATION == 1) @intFromEnum(CLSCTX.ALLOW_LOWER_TRUST_REGISTRATION) else 0)
...
pub const CLSCTX_ALLOW_LOWER_TRUST_REGISTRATION = CLSCTX.ALLOW_LOWER_TRUST_REGISTRATION;
...
pub const IStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStream_Seek(self: *const T, dlibMove: i64, dwOrigin: STREAM_SEEK, plibNewPosition: ?*u64) callconv(.Inline) HRESULT {
            return @as(*const IStream.VTable, @ptrCast(self.vtable)).Seek(@as(*const IStream, @ptrCast(self)), dlibMove, dwOrigin, plibNewPosition);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStream_SetSize(self: *const T, libNewSize: u64) callconv(.Inline) HRESULT {
            return @as(*const IStream.VTable, @ptrCast(self.vtable)).SetSize(@as(*const IStream, @ptrCast(self)), libNewSize);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStream_CopyTo(self: *const T, pstm: ?*IStream, cb: u64, pcbRead: ?*u64, pcbWritten: ?*u64) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStream_LockRegion(self: *const T, libOffset: u64, cb: u64, dwLockType: u32) callconv(.Inline) HRESULT {
            return @as(*const IStream.VTable, @ptrCast(self.vtable)).LockRegion(@as(*const IStream, @ptrCast(self)), libOffset, cb, dwLockType);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStream_UnlockRegion(self: *const T, libOffset: u64, cb: u64, dwLockType: u32) callconv(.Inline) HRESULT {
...
pub const IClientSecurity = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IClientSecurity_QueryBlanket(self: *const T, pProxy: ?*IUnknown, pAuthnSvc: ?*u32, pAuthzSvc: ?*u32, pServerPrincName: ?*?*u16, pAuthnLevel: ?*RPC_C_AUTHN_LEVEL, pImpLevel: ?*RPC_C_IMP_LEVEL, pAuthInfo: ?*?*anyopaque, pCapabilites: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IClientSecurity_SetBlanket(self: *const T, pProxy: ?*IUnknown, dwAuthnSvc: u32, dwAuthzSvc: u32, pServerPrincName: ?PWSTR, dwAuthnLevel: RPC_C_AUTHN_LEVEL, dwImpLevel: RPC_C_IMP_LEVEL, pAuthInfo: ?*anyopaque, dwCapabilities: u32) callconv(.Inline) HRESULT {
...
pub const AsyncIPipeByte = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn AsyncIPipeByte_Finish_Pull(self: *const T, buf: ?*u8, pcReturned: ?*u32) callconv(.Inline) HRESULT {
...
pub const ContextProperty = extern struct {
    policyId: Guid,
    flags: u32,
    pUnk: ?*IUnknown,
};
...
// TODO: this type is limited to platform 'windows5.0'
const IID_IEnumContextProps_Value = Guid.initString("000001c1-0000-0000-c000-000000000046");
pub const IID_IEnumContextProps = &IID_IEnumContextProps_Value;
pub const IEnumContextProps = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Next: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IEnumContextProps,
                celt: u32,
                pContextProperties: [*]ContextProperty,
                pceltFetched: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IEnumContextProps,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnumContextProps_Next(self: *const T, celt: u32, pContextProperties: [*]ContextProperty, pceltFetched: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IEnumContextProps.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumContextProps, @ptrCast(self)), celt, pContextProperties, pceltFetched);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnumContextProps_Skip(self: *const T, celt: u32) callconv(.Inline) HRESULT {
            return @as(*const IEnumContextProps.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumContextProps, @ptrCast(self)), celt);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnumContextProps_Reset(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IEnumContextProps.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumContextProps, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnumContextProps_Clone(self: *const T, ppEnumContextProps: ?*?*IEnumContextProps) callconv(.Inline) HRESULT {
            return @as(*const IEnumContextProps.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumContextProps, @ptrCast(self)), ppEnumContextProps);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnumContextProps_Count(self: *const T, pcelt: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IEnumContextProps.VTable, @ptrCast(self.vtable)).Count(@as(*const IEnumContextProps, @ptrCast(self)), pcelt);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows5.0'
const IID_IContext_Value = Guid.initString("000001c0-0000-0000-c000-000000000046");
pub const IID_IContext = &IID_IContext_Value;
pub const IContext = extern struct {
    pub const VTable = extern struct {
        ...
        EnumContextProps: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IContext,
                ppEnumContextProps: ?*?*IEnumContextProps,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContext_SetProperty(self: *const T, rpolicyId: ?*const Guid, flags: u32, pUnk: ?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IContext.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IContext, @ptrCast(self)), rpolicyId, flags, pUnk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContext_RemoveProperty(self: *const T, rPolicyId: ?*const Guid) callconv(.Inline) HRESULT {
            return @as(*const IContext.VTable, @ptrCast(self.vtable)).RemoveProperty(@as(*const IContext, @ptrCast(self)), rPolicyId);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContext_GetProperty(self: *const T, rGuid: ?*const Guid, pFlags: ?*u32, ppUnk: ?*?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IContext.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IContext, @ptrCast(self)), rGuid, pFlags, ppUnk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContext_EnumContextProps(self: *const T, ppEnumContextProps: ?*?*IEnumContextProps) callconv(.Inline) HRESULT {
            return @as(*const IContext.VTable, @ptrCast(self.vtable)).EnumContextProps(@as(*const IContext, @ptrCast(self)), ppEnumContextProps);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IMachineGlobalObjectTable = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                clsid: ?*const Guid,
                identifier: ?[*:0]align(1) const u16,
                object: ?*IUnknown,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMachineGlobalObjectTable_RegisterObject(self: *const T, clsid: ?*const Guid, identifier: ?[*:0]align(1) const u16, object: ?*IUnknown, token: ?*MachineGlobalObjectTableRegistrationToken) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMachineGlobalObjectTable_GetObject(self: *const T, clsid: ?*const Guid, identifier: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMachineGlobalObjectTable_RevokeObject(self: *const T, token: MachineGlobalObjectTableRegistrationToken) callconv(.Inline) HRESULT {
...
const IID_ISupportAllowLowerTrustActivation_Value = Guid.initString("e9956ef2-3828-4b4b-8fa9-7db61dee4954");
pub const IID_ISupportAllowLowerTrustActivation = &IID_ISupportAllowLowerTrustActivation_Value;
pub const ISupportAllowLowerTrustActivation = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
    };
    vtable: *const VTable,
...
pub const IRunningObjectTable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRunningObjectTable_Register(self: *const T, grfFlags: ROT_FLAGS, punkObject: ?*IUnknown, pmkObjectName: ?*IMoniker, pdwRegister: ?*u32) callconv(.Inline) HRESULT {
...
pub const IPersistStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistStream_GetSizeMax(self: *const T, pcbSize: ?*u64) callconv(.Inline) HRESULT {
...
pub const IPersistFile = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistFile_Load(self: *const T, pszFileName: ?[*:0]align(1) const u16, dwMode: STGM) callconv(.Inline) HRESULT {
            return @as(*const IPersistFile.VTable, @ptrCast(self.vtable)).Load(@as(*const IPersistFile, @ptrCast(self)), pszFileName, dwMode);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistFile_Save(self: *const T, pszFileName: ?[*:0]align(1) const u16, fRemember: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IPersistFile.VTable, @ptrCast(self.vtable)).Save(@as(*const IPersistFile, @ptrCast(self)), pszFileName, fRemember);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistFile_SaveCompleted(self: *const T, pszFileName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOplockStorage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOplockStorage_CreateStorageEx(self: *const T, pwcsName: ?[*:0]align(1) const u16, grfMode: u32, stgfmt: u32, grfAttrs: u32, riid: ?*const Guid, ppstgOpen: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOplockStorage_OpenStorageEx(self: *const T, pwcsName: ?[*:0]align(1) const u16, grfMode: u32, stgfmt: u32, grfAttrs: u32, riid: ?*const Guid, ppstgOpen: ?*?*anyopaque) callconv(.Inline) HRESULT {
...
pub const IUrlMon = extern struct {
    pub const VTable = extern struct {
        ...
        AsyncGetClassBits: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IUrlMon,
                rclsid: ?*const Guid,
                pszTYPE: ?[*:0]align(1) const u16,
                pszExt: ?[*:0]align(1) const u16,
                dwFileVersionMS: u32,
                dwFileVersionLS: u32,
                pszCodeBase: ?[*:0]align(1) const u16,
                pbc: ?*IBindCtx,
                dwClassContext: u32,
                riid: ?*const Guid,
                flags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUrlMon_AsyncGetClassBits(self: *const T, rclsid: ?*const Guid, pszTYPE: ?[*:0]align(1) const u16, pszExt: ?[*:0]align(1) const u16, dwFileVersionMS: u32, dwFileVersionLS: u32, pszCodeBase: ?[*:0]align(1) const u16, pbc: ?*IBindCtx, dwClassContext: u32, riid: ?*const Guid, flags: u32) callconv(.Inline) HRESULT {
...
pub const COWAIT_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        INPUTAVAILABLE: u1 = 0,
        DISPATCH_CALLS: u1 = 0,
        DISPATCH_WINDOW_MESSAGES: u1 = 0,
    }) COWAIT_FLAGS {
        return @as(COWAIT_FLAGS, @enumFromInt(
              (if (o.DEFAULT == 1) @intFromEnum(COWAIT_FLAGS.DEFAULT) else 0)
            | (if (o.WAITALL == 1) @intFromEnum(COWAIT_FLAGS.WAITALL) else 0)
            | (if (o.ALERTABLE == 1) @intFromEnum(COWAIT_FLAGS.ALERTABLE) else 0)
            | (if (o.INPUTAVAILABLE == 1) @intFromEnum(COWAIT_FLAGS.INPUTAVAILABLE) else 0)
            | (if (o.DISPATCH_CALLS == 1) @intFromEnum(COWAIT_FLAGS.DISPATCH_CALLS) else 0)
            | (if (o.DISPATCH_WINDOW_MESSAGES == 1) @intFromEnum(COWAIT_FLAGS.DISPATCH_WINDOW_MESSAGES) else 0)
        ));
    }
};
...
pub const CWMO_FLAGS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        EFAULT: u1 = 0,
        ISPATCH_CALLS: u1 = 0,
        ISPATCH_WINDOW_MESSAGES: u1 = 0,
    }) CWMO_FLAGS {
        return @as(CWMO_FLAGS, @enumFromInt(
              (if (o.EFAULT == 1) @intFromEnum(CWMO_FLAGS.EFAULT) else 0)
            | (if (o.ISPATCH_CALLS == 1) @intFromEnum(CWMO_FLAGS.ISPATCH_CALLS) else 0)
            | (if (o.ISPATCH_WINDOW_MESSAGES == 1) @intFromEnum(CWMO_FLAGS.ISPATCH_WINDOW_MESSAGES) else 0)
        ));
    }
};
...
pub const IBindStatusCallback = extern struct {
    pub const VTable = extern struct {
        ...
        OnProgress: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                ulProgressMax: u32,
                ulStatusCode: u32,
                szStatusText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBindStatusCallback,
                ulProgress: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBindStatusCallback_OnProgress(self: *const T, ulProgress: u32, ulProgressMax: u32, ulStatusCode: u32, szStatusText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBindStatusCallback_OnStopBinding(self: *const T, hresult: HRESULT, szError: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IUriBuilder = extern struct {
    pub const VTable = extern struct {
        ...
        SetFragment: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IUriBuilder,
                pwzNewValue: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IUriBuilder,
                pwzNewValue: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetFragment(self: *const T, pcchFragment: ?*u32, ppwzFragment: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetHost(self: *const T, pcchHost: ?*u32, ppwzHost: ?*const ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).GetHost(@as(*const IUriBuilder, @ptrCast(self)), pcchHost, ppwzHost);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetPassword(self: *const T, pcchPassword: ?*u32, ppwzPassword: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetPath(self: *const T, pcchPath: ?*u32, ppwzPath: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetQuery(self: *const T, pcchQuery: ?*u32, ppwzQuery: ?*const ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).GetQuery(@as(*const IUriBuilder, @ptrCast(self)), pcchQuery, ppwzQuery);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetSchemeName(self: *const T, pcchSchemeName: ?*u32, ppwzSchemeName: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_GetUserName(self: *const T, pcchUserName: ?*u32, ppwzUserName: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetFragment(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).SetFragment(@as(*const IUriBuilder, @ptrCast(self)), pwzNewValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetHost(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).SetHost(@as(*const IUriBuilder, @ptrCast(self)), pwzNewValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetPassword(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).SetPassword(@as(*const IUriBuilder, @ptrCast(self)), pwzNewValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetPath(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetQuery(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).SetQuery(@as(*const IUriBuilder, @ptrCast(self)), pwzNewValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetSchemeName(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IUriBuilder.VTable, @ptrCast(self.vtable)).SetSchemeName(@as(*const IUriBuilder, @ptrCast(self)), pwzNewValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUriBuilder_SetUserName(self: *const T, pwzNewValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDispatch = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDispatch_Invoke(self: *const T, dispIdMember: i32, riid: ?*const Guid, lcid: u32, wFlags: DISPATCH_FLAGS, pDispParams: ?*DISPPARAMS, pVarResult: ?*VARIANT, pExcepInfo: ?*EXCEPINFO, puArgErr: ?*u32) callconv(.Inline) HRESULT {
...
pub const ITypeInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITypeInfo_GetImplTypeFlags(self: *const T, index: u32, pImplTypeFlags: ?*IMPLTYPEFLAGS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITypeInfo_Invoke(self: *const T, pvInstance: ?*anyopaque, memid: i32, wFlags: DISPATCH_FLAGS, pDispParams: ?*DISPPARAMS, pVarResult: ?*VARIANT, pExcepInfo: ?*EXCEPINFO, puArgErr: ?*u32) callconv(.Inline) HRESULT {
...
pub const IErrorLog = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IErrorLog_AddError(self: *const T, pszPropName: ?[*:0]align(1) const u16, pExcepInfo: ?*EXCEPINFO) callconv(.Inline) HRESULT {
...
pub const IPersistStreamInit = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistStreamInit_GetSizeMax(self: *const T, pCbSize: ?*u64) callconv(.Inline) HRESULT {
...
pub extern "ole32" fn CLSIDFromProgIDEx(
    lpszProgID: ?[*:0]align(1) const u16,
    lpclsid: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "ole32" fn MkParseDisplayName(
    pbc: ?*IBindCtx,
    szUserName: ?[*:0]align(1) const u16,
    pchEaten: ?*u32,
    ppmk: ?*?*IMoniker,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "ole32" fn CreateItemMoniker(
    lpszDelim: ?[*:0]align(1) const u16,
    lpszItem: ?[*:0]align(1) const u16,
    ppmk: ?*?*IMoniker,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn CreateUriWithFragment(
    pwzURI: ?[*:0]align(1) const u16,
    pwzFragment: ?[*:0]align(1) const u16,
    dwFlags: u32,
    dwReserved: usize,
    ppURI: ?*?*IUri,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn CreateUriFromMultiByteString(
    pszANSIInputUri: ?[*:0]align(1) const u8,
    dwEncodingFlags: u32,
    dwCodePage: u32,
    dwCreateFlags: u32,
    dwReserved: usize,
...
const ARRAYDESC = @import("../../../windows/win32/system/ole.zig").ARRAYDESC;
...
const PARAMDESC = @import("../../../windows/win32/system/ole.zig").PARAMDESC;
...
const userHBITMAP = @import("../../../windows/win32/system/system_services.zig").userHBITMAP;
const userHENHMETAFILE = @import("../../../windows/win32/system/system_services.zig").userHENHMETAFILE;
const userHGLOBAL = @import("../../../windows/win32/system/system_services.zig").userHGLOBAL;
const userHMETAFILEPICT = @import("../../../windows/win32/system/system_services.zig").userHMETAFILEPICT;
const userHPALETTE = @import("../../../windows/win32/system/system_services.zig").userHPALETTE;
