...
pub const WBEM_NO_WAIT = @as(i32, 0);
pub const WBEM_INFINITE = @as(i32, -1);
...
pub const IWbemPathKeyList = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPathKeyList_SetKey(self: *const T, wszName: ?[*:0]align(1) const u16, uFlags: u32, uCimType: u32, pKeyVal: ?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPathKeyList_SetKey2(self: *const T, wszName: ?[*:0]align(1) const u16, uFlags: u32, uCimType: u32, pKeyVal: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPathKeyList_RemoveKey(self: *const T, wszName: ?[*:0]align(1) const u16, uFlags: u32) callconv(.Inline) HRESULT {
...
pub const IWbemPath = extern struct {
    pub const VTable = extern struct {
        ...
        IsLocal: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemPath,
                wszMachine: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) BOOL,
            else => *const fn(
                self: *const IWbemPath,
                wszMachine: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_SetText(self: *const T, uMode: u32, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_SetServer(self: *const T, Name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_SetNamespaceAt(self: *const T, uIndex: u32, pszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_SetClassName(self: *const T, Name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_CreateClassPart(self: *const T, lFlags: i32, Name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_IsLocal(self: *const T, wszMachine: ?[*:0]align(1) const u16) callconv(.Inline) BOOL {
            return @as(*const IWbemPath.VTable, @ptrCast(self.vtable)).IsLocal(@as(*const IWbemPath, @ptrCast(self)), wszMachine);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemPath_IsSameClassName(self: *const T, wszClass: ?[*:0]align(1) const u16) callconv(.Inline) BOOL {
...
pub const IWbemQuery = extern struct {
    pub const VTable = extern struct {
        ...
        Parse: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemQuery,
                pszLang: ?[*:0]align(1) const u16,
                pszQuery: ?[*:0]align(1) const u16,
                uFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemQuery,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemQuery_Parse(self: *const T, pszLang: ?[*:0]align(1) const u16, pszQuery: ?[*:0]align(1) const u16, uFlags: u32) callconv(.Inline) HRESULT {
...
pub const SWbemRpnConst = extern union {
    m_pszStrVal: ?[*:0]align(1) const u16,
    m_bBoolVal: BOOL,
    m_lLongVal: i32,
    m_uLongVal: u32,
    m_dblVal: f64,
...
pub const SWbemRpnQueryToken = extern struct {
    ...
    m_pszRightFunc: ?[*:0]align(1) const u16,
    m_pszLeftFunc: ?[*:0]align(1) const u16,
};
...
pub const WMIQ_RPNF_FEATURE = enum(i32) {
...
pub const WMIQ_RPNF_WHERE_CLAUSE_PRESENT = WMIQ_RPNF_FEATURE.WHERE_CLAUSE_PRESENT;
pub const WMIQ_RPNF_QUERY_IS_CONJUNCTIVE = WMIQ_RPNF_FEATURE.QUERY_IS_CONJUNCTIVE;
pub const WMIQ_RPNF_QUERY_IS_DISJUNCTIVE = WMIQ_RPNF_FEATURE.QUERY_IS_DISJUNCTIVE;
pub const WMIQ_RPNF_PROJECTION = WMIQ_RPNF_FEATURE.PROJECTION;
pub const WMIQ_RPNF_FEATURE_SELECT_STAR = WMIQ_RPNF_FEATURE.FEATURE_SELECT_STAR;
pub const WMIQ_RPNF_EQUALITY_TESTS_ONLY = WMIQ_RPNF_FEATURE.EQUALITY_TESTS_ONLY;
pub const WMIQ_RPNF_COUNT_STAR = WMIQ_RPNF_FEATURE.COUNT_STAR;
pub const WMIQ_RPNF_QUALIFIED_NAMES_USED = WMIQ_RPNF_FEATURE.QUALIFIED_NAMES_USED;
pub const WMIQ_RPNF_SYSPROP_CLASS_USED = WMIQ_RPNF_FEATURE.SYSPROP_CLASS_USED;
pub const WMIQ_RPNF_PROP_TO_PROP_TESTS = WMIQ_RPNF_FEATURE.PROP_TO_PROP_TESTS;
pub const WMIQ_RPNF_ORDER_BY = WMIQ_RPNF_FEATURE.ORDER_BY;
pub const WMIQ_RPNF_ISA_USED = WMIQ_RPNF_FEATURE.ISA_USED;
pub const WMIQ_RPNF_GROUP_BY_HAVING = WMIQ_RPNF_FEATURE.GROUP_BY_HAVING;
pub const WMIQ_RPNF_ARRAY_ACCESS_USED = WMIQ_RPNF_FEATURE.ARRAY_ACCESS_USED;
...
pub const SWbemRpnEncodedQuery = extern struct {
    ...
    m_pszOptionalFromPath: ?[*:0]align(1) const u16,
    m_uFromListSize: u32,
    m_ppszFromList: ?*const ?PWSTR,
...
pub const SWbemAnalysisMatrix = extern struct {
    m_uVersion: u32,
    m_uMatrixType: u32,
    m_pszProperty: ?[*:0]align(1) const u16,
    m_uPropertyType: u32,
    m_uEntries: u32,
    m_pValues: ?*?*anyopaque,
    m_pbTruthTable: ?*BOOL,
...
pub const WBEM_GENERIC_FLAG_TYPE = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        FLAG_RETURN_IMMEDIATELY: u1 = 0,
        FLAG_RETURN_WBEM_COMPLETE: u1 = 0,
        FLAG_FORWARD_ONLY: u1 = 0,
        FLAG_NO_ERROR_OBJECT: u1 = 0,
        FLAG_SEND_STATUS: u1 = 0,
        FLAG_ENSURE_LOCATABLE: u1 = 0,
        FLAG_DIRECT_READ: u1 = 0,
        MASK_RESERVED_FLAGS: u1 = 0,
        FLAG_USE_AMENDED_QUALIFIERS: u1 = 0,
        FLAG_STRONG_VALIDATION: u1 = 0,
    }) WBEM_GENERIC_FLAG_TYPE {
        return @as(WBEM_GENERIC_FLAG_TYPE, @enumFromInt(
              (if (o.FLAG_RETURN_IMMEDIATELY == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_RETURN_IMMEDIATELY) else 0)
            | (if (o.FLAG_RETURN_WBEM_COMPLETE == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_RETURN_WBEM_COMPLETE) else 0)
            | (if (o.FLAG_FORWARD_ONLY == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_FORWARD_ONLY) else 0)
            | (if (o.FLAG_NO_ERROR_OBJECT == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_NO_ERROR_OBJECT) else 0)
            | (if (o.FLAG_SEND_STATUS == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_SEND_STATUS) else 0)
            | (if (o.FLAG_ENSURE_LOCATABLE == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_ENSURE_LOCATABLE) else 0)
            | (if (o.FLAG_DIRECT_READ == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_DIRECT_READ) else 0)
            | (if (o.MASK_RESERVED_FLAGS == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.MASK_RESERVED_FLAGS) else 0)
            | (if (o.FLAG_USE_AMENDED_QUALIFIERS == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_USE_AMENDED_QUALIFIERS) else 0)
            | (if (o.FLAG_STRONG_VALIDATION == 1) @intFromEnum(WBEM_GENERIC_FLAG_TYPE.FLAG_STRONG_VALIDATION) else 0)
        ));
    }
};
...
pub const WBEM_LOCKING_FLAG_TYPE = enum(i32) {
    D = 1,
};
pub const WBEM_FLAG_ALLOW_READ = WBEM_LOCKING_FLAG_TYPE.D;
...
pub const IWbemClassObject = extern struct {
    pub const VTable = extern struct {
        ...
        GetNames: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemClassObject,
                wszQualifierName: ?[*:0]align(1) const u16,
        ...
        GetPropertyQualifierSet: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemClassObject,
                wszProperty: ?[*:0]align(1) const u16,
                ppQualSet: ?*?*IWbemQualifierSet,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemClassObject,
        ...
        InheritsFrom: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemClassObject,
                strAncestor: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemClassObject,
                strAncestor: ?[*:0]align(1) const u16,
        ...
        GetMethodOrigin: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemClassObject,
                wszMethodName: ?[*:0]align(1) const u16,
                pstrClassName: ?*?BSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemClassObject,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_Get(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pVal: ?*VARIANT, pType: ?*i32, plFlavor: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_Put(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pVal: ?*VARIANT, Type: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_Delete(self: *const T, wszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IWbemClassObject.VTable, @ptrCast(self.vtable)).Delete(@as(*const IWbemClassObject, @ptrCast(self)), wszName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetNames(self: *const T, wszQualifierName: ?[*:0]align(1) const u16, lFlags: WBEM_CONDITION_FLAG_TYPE, pQualifierVal: ?*VARIANT, pNames: ?*?*SAFEARRAY) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetPropertyQualifierSet(self: *const T, wszProperty: ?[*:0]align(1) const u16, ppQualSet: ?*?*IWbemQualifierSet) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_CompareTo(self: *const T, lFlags: WBEM_COMPARISON_FLAG, pCompareTo: ?*IWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetPropertyOrigin(self: *const T, wszName: ?[*:0]align(1) const u16, pstrClassName: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_InheritsFrom(self: *const T, strAncestor: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetMethod(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, ppInSignature: ?*?*IWbemClassObject, ppOutSignature: ?*?*IWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_PutMethod(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pInSignature: ?*IWbemClassObject, pOutSignature: ?*IWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_DeleteMethod(self: *const T, wszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetMethodQualifierSet(self: *const T, wszMethod: ?[*:0]align(1) const u16, ppQualSet: ?*?*IWbemQualifierSet) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemClassObject_GetMethodOrigin(self: *const T, wszMethodName: ?[*:0]align(1) const u16, pstrClassName: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const IWbemObjectAccess = extern struct {
    pub const VTable = extern struct {
        ...
        GetPropertyHandle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszPropertyName: ?[*:0]align(1) const u16,
                pType: ?*i32,
                plHandle: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemObjectAccess_GetPropertyHandle(self: *const T, wszPropertyName: ?[*:0]align(1) const u16, pType: ?*i32, plHandle: ?*i32) callconv(.Inline) HRESULT {
...
pub const IWbemQualifierSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemQualifierSet_Get(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pVal: ?*VARIANT, plFlavor: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemQualifierSet_Put(self: *const T, wszName: ?[*:0]align(1) const u16, pVal: ?*VARIANT, lFlavor: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemQualifierSet_Delete(self: *const T, wszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWbemServices = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_OpenNamespace(self: *const T, strNamespace: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppWorkingNamespace: ?*?*IWbemServices, ppResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_QueryObjectSink(self: *const T, lFlags: WBEM_GENERIC_FLAG_TYPE, ppResponseHandler: ?*?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_GetObject(self: *const T, strObjectPath: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppObject: ?*?*IWbemClassObject, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_GetObjectAsync(self: *const T, strObjectPath: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_PutClass(self: *const T, pObject: ?*IWbemClassObject, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_PutClassAsync(self: *const T, pObject: ?*IWbemClassObject, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_DeleteClass(self: *const T, strClass: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_DeleteClassAsync(self: *const T, strClass: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_CreateClassEnum(self: *const T, strSuperclass: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_CreateClassEnumAsync(self: *const T, strSuperclass: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_PutInstance(self: *const T, pInst: ?*IWbemClassObject, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_PutInstanceAsync(self: *const T, pInst: ?*IWbemClassObject, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_DeleteInstance(self: *const T, strObjectPath: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_DeleteInstanceAsync(self: *const T, strObjectPath: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_CreateInstanceEnum(self: *const T, strFilter: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_CreateInstanceEnumAsync(self: *const T, strFilter: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecQuery(self: *const T, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecQueryAsync(self: *const T, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecNotificationQuery(self: *const T, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecNotificationQueryAsync(self: *const T, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecMethod(self: *const T, strObjectPath: ?BSTR, strMethodName: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pInParams: ?*IWbemClassObject, ppOutParams: ?*?*IWbemClassObject, ppCallResult: ?*?*IWbemCallResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemServices_ExecMethodAsync(self: *const T, strObjectPath: ?BSTR, strMethodName: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, pInParams: ?*IWbemClassObject, pResponseHandler: ?*IWbemObjectSink) callconv(.Inline) HRESULT {
...
pub const IWbemContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemContext_SetValue(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pValue: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemContext_GetValue(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32, pValue: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemContext_DeleteValue(self: *const T, wszName: ?[*:0]align(1) const u16, lFlags: i32) callconv(.Inline) HRESULT {
...
pub const IWbemUnsecuredApartment = extern struct {
    pub const VTable = extern struct {
        ...
        CreateSinkStub: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pSink: ?*IWbemObjectSink,
                dwFlags: u32,
                wszReserved: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemUnsecuredApartment_CreateSinkStub(self: *const T, pSink: ?*IWbemObjectSink, dwFlags: u32, wszReserved: ?[*:0]align(1) const u16, ppStub: ?*?*IWbemObjectSink) callconv(.Inline) HRESULT {
...
pub const IWbemBackupRestore = extern struct {
    pub const VTable = extern struct {
        ...
        Backup: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                strBackupToFile: ?[*:0]align(1) const u16,
                lFlags: i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemBackupRestore,
        ...
        Restore: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemBackupRestore,
                strRestoreFromFile: ?[*:0]align(1) const u16,
                lFlags: i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemBackupRestore,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemBackupRestore_Backup(self: *const T, strBackupToFile: ?[*:0]align(1) const u16, lFlags: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemBackupRestore_Restore(self: *const T, strRestoreFromFile: ?[*:0]align(1) const u16, lFlags: i32) callconv(.Inline) HRESULT {
...
pub const IWbemConfigureRefresher = extern struct {
    pub const VTable = extern struct {
        ...
        AddEnum: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemConfigureRefresher,
                pNamespace: ?*IWbemServices,
                wszClassName: ?[*:0]align(1) const u16,
                lFlags: i32,
                pContext: ?*IWbemContext,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemConfigureRefresher_AddObjectByPath(self: *const T, pNamespace: ?*IWbemServices, wszPath: ?[*:0]align(1) const u16, lFlags: i32, pContext: ?*IWbemContext, ppRefreshable: ?*?*IWbemClassObject, plId: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemConfigureRefresher_AddEnum(self: *const T, pNamespace: ?*IWbemServices, wszClassName: ?[*:0]align(1) const u16, lFlags: i32, pContext: ?*IWbemContext, ppEnum: ?*?*IWbemHiPerfEnum, plId: ?*i32) callconv(.Inline) HRESULT {
...
pub const IWbemHiPerfProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemHiPerfProvider_CreateRefreshableEnum(self: *const T, pNamespace: ?*IWbemServices, wszClass: ?[*:0]align(1) const u16, pRefresher: ?*IWbemRefresher, lFlags: i32, pContext: ?*IWbemContext, pHiPerfEnum: ?*IWbemHiPerfEnum, plId: ?*i32) callconv(.Inline) HRESULT {
...
pub const IWbemDecoupledRegistrar = extern struct {
    pub const VTable = extern struct {
        ...
        Register: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                a_User: ?[*:0]align(1) const u16,
                a_Locale: ?[*:0]align(1) const u16,
                a_Scope: ?[*:0]align(1) const u16,
                a_Registration: ?[*:0]align(1) const u16,
                pIUnknown: ?*IUnknown,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemDecoupledRegistrar,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemDecoupledRegistrar_Register(self: *const T, a_Flags: i32, a_Context: ?*IWbemContext, a_User: ?[*:0]align(1) const u16, a_Locale: ?[*:0]align(1) const u16, a_Scope: ?[*:0]align(1) const u16, a_Registration: ?[*:0]align(1) const u16, pIUnknown: ?*IUnknown) callconv(.Inline) HRESULT {
...
pub const IWbemEventSink = extern struct {
    pub const VTable = extern struct {
        ...
        GetRestrictedSink: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemEventSink,
                lNumQueries: i32,
                awszQueries: [*]const ?[*:0]align(1) const u16,
                pCallback: ?*IUnknown,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemEventSink_GetRestrictedSink(self: *const T, lNumQueries: i32, awszQueries: [*]const ?[*:0]align(1) const u16, pCallback: ?*IUnknown, ppSink: ?*?*IWbemEventSink) callconv(.Inline) HRESULT {
...
pub const ISWbemServices = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemServices_ReferencesTo(self: *const T, strObjectPath: ?BSTR, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemServices_ReferencesToAsync(self: *const T, objWbemSink: ?*IDispatch, strObjectPath: ?BSTR, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) callconv(.Inline) HRESULT {
...
pub const ISWbemObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObject_Associators_(self: *const T, strAssocClass: ?BSTR, strResultClass: ?BSTR, strResultRole: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredAssocQualifier: ?BSTR, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObject_AssociatorsAsync_(self: *const T, objWbemSink: ?*IDispatch, strAssocClass: ?BSTR, strResultClass: ?BSTR, strResultRole: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredAssocQualifier: ?BSTR, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObject_References_(self: *const T, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObject_ReferencesAsync_(self: *const T, objWbemSink: ?*IDispatch, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: VARIANT_BOOL, bSchemaOnly: VARIANT_BOOL, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObject_CompareTo_(self: *const T, objWbemObject: ?*IDispatch, iFlags: i32, bResult: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemQualifier = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_get_IsLocal(self: *const T, bIsLocal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const ISWbemQualifier.VTable, @ptrCast(self.vtable)).get_IsLocal(@as(*const ISWbemQualifier, @ptrCast(self)), bIsLocal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_get_PropagatesToSubclass(self: *const T, bPropagatesToSubclass: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_put_PropagatesToSubclass(self: *const T, bPropagatesToSubclass: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_get_PropagatesToInstance(self: *const T, bPropagatesToInstance: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_put_PropagatesToInstance(self: *const T, bPropagatesToInstance: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_get_IsOverridable(self: *const T, bIsOverridable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_put_IsOverridable(self: *const T, bIsOverridable: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifier_get_IsAmended(self: *const T, bIsAmended: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemQualifierSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemQualifierSet_Add(self: *const T, strName: ?BSTR, varVal: ?*VARIANT, bPropagatesToSubclass: VARIANT_BOOL, bPropagatesToInstance: VARIANT_BOOL, bIsOverridable: VARIANT_BOOL, iFlags: i32, objWbemQualifier: ?*?*ISWbemQualifier) callconv(.Inline) HRESULT {
...
pub const ISWbemProperty = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemProperty_get_IsLocal(self: *const T, bIsLocal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemProperty_get_IsArray(self: *const T, bIsArray: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemPropertySet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemPropertySet_Add(self: *const T, strName: ?BSTR, iCIMType: WbemCimtypeEnum, bIsArray: VARIANT_BOOL, iFlags: i32, objWbemProperty: ?*?*ISWbemProperty) callconv(.Inline) HRESULT {
...
pub const ISWbemObjectPath = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObjectPath_get_IsClass(self: *const T, bIsClass: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemObjectPath_get_IsSingleton(self: *const T, bIsSingleton: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemPrivilege = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemPrivilege_get_IsEnabled(self: *const T, bIsEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemPrivilege_put_IsEnabled(self: *const T, bIsEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemPrivilegeSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemPrivilegeSet_Add(self: *const T, iPrivilege: WbemPrivilegeEnum, bIsEnabled: VARIANT_BOOL, objWbemPrivilege: ?*?*ISWbemPrivilege) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemPrivilegeSet_AddAsString(self: *const T, strPrivilege: ?BSTR, bIsEnabled: VARIANT_BOOL, objWbemPrivilege: ?*?*ISWbemPrivilege) callconv(.Inline) HRESULT {
...
pub const ISWbemDateTime = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_YearSpecified(self: *const T, bYearSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_YearSpecified(self: *const T, bYearSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_MonthSpecified(self: *const T, bMonthSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_MonthSpecified(self: *const T, bMonthSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_DaySpecified(self: *const T, bDaySpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_DaySpecified(self: *const T, bDaySpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_HoursSpecified(self: *const T, bHoursSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_HoursSpecified(self: *const T, bHoursSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_MinutesSpecified(self: *const T, bMinutesSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_MinutesSpecified(self: *const T, bMinutesSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_SecondsSpecified(self: *const T, bSecondsSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_SecondsSpecified(self: *const T, bSecondsSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_MicrosecondsSpecified(self: *const T, bMicrosecondsSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_MicrosecondsSpecified(self: *const T, bMicrosecondsSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_UTCSpecified(self: *const T, bUTCSpecified: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_UTCSpecified(self: *const T, bUTCSpecified: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_get_IsInterval(self: *const T, bIsInterval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_put_IsInterval(self: *const T, bIsInterval: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_GetVarDate(self: *const T, bIsLocal: VARIANT_BOOL, dVarDate: ?*f64) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_SetVarDate(self: *const T, dVarDate: f64, bIsLocal: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_GetFileTime(self: *const T, bIsLocal: VARIANT_BOOL, strFileTime: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemDateTime_SetFileTime(self: *const T, strFileTime: ?BSTR, bIsLocal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemRefresher = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemRefresher_get_AutoReconnect(self: *const T, bCount: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemRefresher_put_AutoReconnect(self: *const T, bCount: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISWbemRefreshableItem = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISWbemRefreshableItem_get_IsSet(self: *const T, bIsSet: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const WBEM_LOGIN_TYPE = enum(i32) {
    FLAG_INPROC_LOGIN = 0,
    FLAG_LOCAL_LOGIN = 1,
    FLAG_REMOTE_LOGIN = 2,
...
pub const WBEM_FLAG_INPROC_LOGIN = WBEM_LOGIN_TYPE.FLAG_INPROC_LOGIN;
pub const WBEM_FLAG_LOCAL_LOGIN = WBEM_LOGIN_TYPE.FLAG_LOCAL_LOGIN;
pub const WBEM_FLAG_REMOTE_LOGIN = WBEM_LOGIN_TYPE.FLAG_REMOTE_LOGIN;
pub const WBEM_AUTHENTICATION_METHOD_MASK = WBEM_LOGIN_TYPE.AUTHENTICATION_METHOD_MASK;
pub const WBEM_FLAG_USE_MULTIPLE_CHALLENGES = WBEM_LOGIN_TYPE.FLAG_USE_MULTIPLE_CHALLENGES;
...
pub const IWbemConstructClassObject = extern struct {
    pub const VTable = extern struct {
        ...
        SetServerNamespace: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWbemConstructClassObject,
                wszServer: ?[*:0]align(1) const u16,
                wszNamespace: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWbemConstructClassObject,
                wszServer: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemConstructClassObject_SetPropertyOrigin(self: *const T, wszPropertyName: ?[*:0]align(1) const u16, lOriginIndex: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemConstructClassObject_SetMethodOrigin(self: *const T, wszMethodName: ?[*:0]align(1) const u16, lOriginIndex: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWbemConstructClassObject_SetServerNamespace(self: *const T, wszServer: ?[*:0]align(1) const u16, wszNamespace: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
