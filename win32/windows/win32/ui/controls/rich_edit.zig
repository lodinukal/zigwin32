...
pub const PARAFORMAT_MASK = enum(u32) {
    ...
    NUMBERINGSTYLE = 8192,
    NUMBERINGTAB = 16384,
    NUMBERINGSTART = 32768,
    RTLPARA = 65536,
    KEEP = 131072,
    KEEPNEXT = 262144,
    PAGEBREAKBEFORE = 524288,
    NOLINENUMBER = 1048576,
    NOWIDOWCONTROL = 2097152,
    DONOTHYPHEN = 4194304,
    SIDEBYSIDE = 8388608,
    COLLAPSED = 16777216,
    OUTLINELEVEL = 33554432,
    BOX = 67108864,
    RESERVED2 = 134217728,
    TABLEROWDELIMITER = 268435456,
    TEXTWRAPPINGBREAK = 536870912,
    TABLE = 1073741824,
    ALL = 2147549247,
    EFFECTS = 1358888960,
    ALL2 = 3506437631,
    ...
    pub fn initFlags(o: struct {
        ...
        BOX: u1 = 0,
        RESERVED2: u1 = 0,
        TABLEROWDELIMITER: u1 = 0,
        TEXTWRAPPINGBREAK: u1 = 0,
        TABLE: u1 = 0,
        ALL: u1 = 0,
        EFFECTS: u1 = 0,
        ALL2: u1 = 0,
        ...
        return @as(PARAFORMAT_MASK, @enumFromInt(
            ...
            | (if (o.SPACEBEFORE == 1) @intFromEnum(PARAFORMAT_MASK.SPACEBEFORE) else 0)
            | (if (o.SPACEAFTER == 1) @intFromEnum(PARAFORMAT_MASK.SPACEAFTER) else 0)
            | (if (o.LINESPACING == 1) @intFromEnum(PARAFORMAT_MASK.LINESPACING) else 0)
            | (if (o.STYLE == 1) @intFromEnum(PARAFORMAT_MASK.STYLE) else 0)
            | (if (o.BORDER == 1) @intFromEnum(PARAFORMAT_MASK.BORDER) else 0)
            | (if (o.SHADING == 1) @intFromEnum(PARAFORMAT_MASK.SHADING) else 0)
            | (if (o.NUMBERINGSTYLE == 1) @intFromEnum(PARAFORMAT_MASK.NUMBERINGSTYLE) else 0)
            | (if (o.NUMBERINGTAB == 1) @intFromEnum(PARAFORMAT_MASK.NUMBERINGTAB) else 0)
            | (if (o.NUMBERINGSTART == 1) @intFromEnum(PARAFORMAT_MASK.NUMBERINGSTART) else 0)
            | (if (o.RTLPARA == 1) @intFromEnum(PARAFORMAT_MASK.RTLPARA) else 0)
            | (if (o.KEEP == 1) @intFromEnum(PARAFORMAT_MASK.KEEP) else 0)
            | (if (o.KEEPNEXT == 1) @intFromEnum(PARAFORMAT_MASK.KEEPNEXT) else 0)
            | (if (o.PAGEBREAKBEFORE == 1) @intFromEnum(PARAFORMAT_MASK.PAGEBREAKBEFORE) else 0)
            | (if (o.NOLINENUMBER == 1) @intFromEnum(PARAFORMAT_MASK.NOLINENUMBER) else 0)
            | (if (o.NOWIDOWCONTROL == 1) @intFromEnum(PARAFORMAT_MASK.NOWIDOWCONTROL) else 0)
            | (if (o.DONOTHYPHEN == 1) @intFromEnum(PARAFORMAT_MASK.DONOTHYPHEN) else 0)
            | (if (o.SIDEBYSIDE == 1) @intFromEnum(PARAFORMAT_MASK.SIDEBYSIDE) else 0)
            | (if (o.COLLAPSED == 1) @intFromEnum(PARAFORMAT_MASK.COLLAPSED) else 0)
            | (if (o.OUTLINELEVEL == 1) @intFromEnum(PARAFORMAT_MASK.OUTLINELEVEL) else 0)
            | (if (o.BOX == 1) @intFromEnum(PARAFORMAT_MASK.BOX) else 0)
            | (if (o.RESERVED2 == 1) @intFromEnum(PARAFORMAT_MASK.RESERVED2) else 0)
            | (if (o.TABLEROWDELIMITER == 1) @intFromEnum(PARAFORMAT_MASK.TABLEROWDELIMITER) else 0)
            | (if (o.TEXTWRAPPINGBREAK == 1) @intFromEnum(PARAFORMAT_MASK.TEXTWRAPPINGBREAK) else 0)
            | (if (o.TABLE == 1) @intFromEnum(PARAFORMAT_MASK.TABLE) else 0)
            | (if (o.ALL == 1) @intFromEnum(PARAFORMAT_MASK.ALL) else 0)
            | (if (o.EFFECTS == 1) @intFromEnum(PARAFORMAT_MASK.EFFECTS) else 0)
            | (if (o.ALL2 == 1) @intFromEnum(PARAFORMAT_MASK.ALL2) else 0)
        ));
    }
};
...
pub const PFM_SPACEBEFORE = PARAFORMAT_MASK.SPACEBEFORE;
pub const PFM_SPACEAFTER = PARAFORMAT_MASK.SPACEAFTER;
pub const PFM_LINESPACING = PARAFORMAT_MASK.LINESPACING;
pub const PFM_STYLE = PARAFORMAT_MASK.STYLE;
pub const PFM_BORDER = PARAFORMAT_MASK.BORDER;
pub const PFM_SHADING = PARAFORMAT_MASK.SHADING;
pub const PFM_NUMBERINGSTYLE = PARAFORMAT_MASK.NUMBERINGSTYLE;
pub const PFM_NUMBERINGTAB = PARAFORMAT_MASK.NUMBERINGTAB;
pub const PFM_NUMBERINGSTART = PARAFORMAT_MASK.NUMBERINGSTART;
pub const PFM_RTLPARA = PARAFORMAT_MASK.RTLPARA;
pub const PFM_KEEP = PARAFORMAT_MASK.KEEP;
pub const PFM_KEEPNEXT = PARAFORMAT_MASK.KEEPNEXT;
pub const PFM_PAGEBREAKBEFORE = PARAFORMAT_MASK.PAGEBREAKBEFORE;
pub const PFM_NOLINENUMBER = PARAFORMAT_MASK.NOLINENUMBER;
pub const PFM_NOWIDOWCONTROL = PARAFORMAT_MASK.NOWIDOWCONTROL;
pub const PFM_DONOTHYPHEN = PARAFORMAT_MASK.DONOTHYPHEN;
pub const PFM_SIDEBYSIDE = PARAFORMAT_MASK.SIDEBYSIDE;
pub const PFM_COLLAPSED = PARAFORMAT_MASK.COLLAPSED;
pub const PFM_OUTLINELEVEL = PARAFORMAT_MASK.OUTLINELEVEL;
pub const PFM_BOX = PARAFORMAT_MASK.BOX;
pub const PFM_RESERVED2 = PARAFORMAT_MASK.RESERVED2;
pub const PFM_TABLEROWDELIMITER = PARAFORMAT_MASK.TABLEROWDELIMITER;
pub const PFM_TEXTWRAPPINGBREAK = PARAFORMAT_MASK.TEXTWRAPPINGBREAK;
pub const PFM_TABLE = PARAFORMAT_MASK.TABLE;
pub const PFM_ALL = PARAFORMAT_MASK.ALL;
pub const PFM_EFFECTS = PARAFORMAT_MASK.EFFECTS;
pub const PFM_ALL2 = PARAFORMAT_MASK.ALL2;
...
pub const PARAFORMAT_ALIGNMENT = enum(u16) {
    ...
    CENTER = 3,
    JUSTIFY = 4,
    // FULL_INTERWORD = 4, this enum value conflicts with JUSTIFY
    FULL_NEWSPAPER = 5,
    FULL_INTERLETTER = 6,
    FULL_SCALED = 7,
    FULL_GLYPHS = 8,
...
pub const PFA_JUSTIFY = PARAFORMAT_ALIGNMENT.JUSTIFY;
pub const PFA_FULL_INTERWORD = PARAFORMAT_ALIGNMENT.JUSTIFY;
pub const PFA_FULL_NEWSPAPER = PARAFORMAT_ALIGNMENT.FULL_NEWSPAPER;
pub const PFA_FULL_INTERLETTER = PARAFORMAT_ALIGNMENT.FULL_INTERLETTER;
pub const PFA_FULL_SCALED = PARAFORMAT_ALIGNMENT.FULL_SCALED;
pub const PFA_FULL_GLYPHS = PARAFORMAT_ALIGNMENT.FULL_GLYPHS;

pub const PARAFORMAT_NUMBERING = enum(u16) {
    BULLET = 1,
    ARABIC = 2,
    LCLETTER = 3,
    UCLETTER = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PARAFORMAT_NUMBERING, @enumFromInt(
              (if (o.BULLET == 1) @intFromEnum(PARAFORMAT_NUMBERING.BULLET) else 0)
            | (if (o.ARABIC == 1) @intFromEnum(PARAFORMAT_NUMBERING.ARABIC) else 0)
            | (if (o.LCLETTER == 1) @intFromEnum(PARAFORMAT_NUMBERING.LCLETTER) else 0)
            | (if (o.UCLETTER == 1) @intFromEnum(PARAFORMAT_NUMBERING.UCLETTER) else 0)
            | (if (o.LCROMAN == 1) @intFromEnum(PARAFORMAT_NUMBERING.LCROMAN) else 0)
            | (if (o.UCROMAN == 1) @intFromEnum(PARAFORMAT_NUMBERING.UCROMAN) else 0)
        ));
    }
};
pub const PFN_BULLET = PARAFORMAT_NUMBERING.BULLET;
pub const PFN_ARABIC = PARAFORMAT_NUMBERING.ARABIC;
pub const PFN_LCLETTER = PARAFORMAT_NUMBERING.LCLETTER;
pub const PFN_UCLETTER = PARAFORMAT_NUMBERING.UCLETTER;
pub const PFN_LCROMAN = PARAFORMAT_NUMBERING.LCROMAN;
pub const PFN_UCROMAN = PARAFORMAT_NUMBERING.UCROMAN;
...
pub const ITextServices = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextServices_TxSetText(self: *const T, pszText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ITextHost = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextHost_TxEnableScrollBar(self: *const T, fuSBFlags: SCROLLBAR_CONSTANTS, fuArrowflags: i32) callconv(.Inline) BOOL {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextHost_TxScrollWindowEx(self: *const T, dx: i32, dy: i32, lprcScroll: ?*RECT, lprcClip: ?*RECT, hrgnUpdate: ?HRGN, lprcUpdate: ?*RECT, fuScroll: SCROLL_WINDOW_FLAGS) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextHost_TxGetSysColor(self: *const T, nIndex: SYS_COLOR_INDEX) callconv(.Inline) COLORREF {
...
pub const IRichEditOle = extern struct {
    pub const VTable = extern struct {
        ...
        ConvertObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                lpstrUserTypeNew: ?[*:0]align(1) const u8,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IRichEditOle,
                iob: i32,
        ...
        SetHostNames: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRichEditOle,
                lpstrContainerApp: ?[*:0]align(1) const u8,
                lpstrContainerObj: ?[*:0]align(1) const u8,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IRichEditOle,
                lpstrContainerApp: ?[*:0]align(1) const u8,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOle_ConvertObject(self: *const T, iob: i32, rclsidNew: ?*const Guid, lpstrUserTypeNew: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOle_SetHostNames(self: *const T, lpstrContainerApp: ?[*:0]align(1) const u8, lpstrContainerObj: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOle_ImportDataObject(self: *const T, lpdataobj: ?*IDataObject, cf: u16, hMetaPict: ?HGLOBAL) callconv(.Inline) HRESULT {
...
pub const IRichEditOleCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOleCallback_GetInPlaceContext(self: *const T, lplpFrame: ?*?*IOleInPlaceFrame, lplpDoc: ?*?*IOleInPlaceUIWindow, lpFrameInfo: ?*OLEINPLACEFRAMEINFO) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOleCallback_QueryAcceptData(self: *const T, lpdataobj: ?*IDataObject, lpcfFormat: ?*u16, reco: RECO_FLAGS, fReally: BOOL, hMetaPict: ?HGLOBAL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOleCallback_GetDragDropEffect(self: *const T, fDrag: BOOL, grfKeyState: MODIFIERKEYS_FLAGS, pdwEffect: ?*DROPEFFECT) callconv(.Inline) HRESULT {
...
pub const ITextDocument = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextDocument_Open(self: *const T, pVar: ?*VARIANT, Flags: tomConstants, CodePage: i32) callconv(.Inline) HRESULT {
            return @as(*const ITextDocument.VTable, @ptrCast(self.vtable)).Open(@as(*const ITextDocument, @ptrCast(self)), pVar, Flags, CodePage);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextDocument_Save(self: *const T, pVar: ?*VARIANT, Flags: tomConstants, CodePage: i32) callconv(.Inline) HRESULT {
...
pub const ITextRange = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_FindText(self: *const T, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const ITextRange.VTable, @ptrCast(self.vtable)).FindText(@as(*const ITextRange, @ptrCast(self)), bstr, Count, Flags, pLength);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_FindTextStart(self: *const T, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_FindTextEnd(self: *const T, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_ChangeCase(self: *const T, Type: tomConstants) callconv(.Inline) HRESULT {
            return @as(*const ITextRange.VTable, @ptrCast(self.vtable)).ChangeCase(@as(*const ITextRange, @ptrCast(self)), Type);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_GetPoint(self: *const T, Type: tomConstants, px: ?*i32, py: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const ITextRange.VTable, @ptrCast(self.vtable)).GetPoint(@as(*const ITextRange, @ptrCast(self)), Type, px, py);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange_SetPoint(self: *const T, x: i32, y: i32, Type: tomConstants, Extend: i32) callconv(.Inline) HRESULT {
...
pub const ITextDocument2Old = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextDocument2Old_SetEffectColor(self: *const T, Index: i32, cr: COLORREF) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextDocument2Old_GetEffectColor(self: *const T, Index: i32, pcr: ?*COLORREF) callconv(.Inline) HRESULT {
...
pub const RICHEDIT_IMAGE_PARAMETERS = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        Ascent: i32 align(4),
        Type: i32 align(4),
        pwszAlternateText: ?[*:0]align(1) const u16 align(4),
    ...
    .X86 => extern struct {
        ...
        Ascent: i32,
        Type: i32,
        pwszAlternateText: ?[*:0]align(1) const u16,
        pIStream: ?*IStream,
    },
};
...
pub const FINDTEXTA = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        chrg: CHARRANGE align(4),
        lpstrText: ?[*:0]align(1) const u8 align(4),
    },
    .X86 => extern struct {
        chrg: CHARRANGE,
        lpstrText: ?[*:0]align(1) const u8,
    },
};
pub const FINDTEXTW = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        chrg: CHARRANGE align(4),
        lpstrText: ?[*:0]align(1) const u16 align(4),
    },
    .X86 => extern struct {
        chrg: CHARRANGE,
        lpstrText: ?[*:0]align(1) const u16,
    },
};
...
pub const GETTEXTEX = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        lpDefaultChar: ?[*:0]align(1) const u8 align(4),
        lpUsedDefChar: ?*BOOL align(4),
    },
    .X86 => extern struct {
        cb: u32,
        flags: GETTEXTEX_FLAGS,
        codepage: u32,
        lpDefaultChar: ?[*:0]align(1) const u8,
        lpUsedDefChar: ?*BOOL,
    },
};
...
const DROPEFFECT = @import("../../../../windows/win32/system/ole.zig").DROPEFFECT;
...
const FONT_CHARSET = @import("../../../../windows/win32/graphics/gdi.zig").FONT_CHARSET;
...
const HIMC = @import("../../../../windows/win32/globalization.zig").HIMC;
...
const ID2D1RenderTarget = @import("../../../../windows/win32/graphics/direct2d.zig").ID2D1RenderTarget;
...
const IDropTarget = @import("../../../../windows/win32/system/ole.zig").IDropTarget;
const IOleClientSite = @import("../../../../windows/win32/system/ole.zig").IOleClientSite;
const IOleInPlaceFrame = @import("../../../../windows/win32/system/ole.zig").IOleInPlaceFrame;
const IOleInPlaceUIWindow = @import("../../../../windows/win32/system/ole.zig").IOleInPlaceUIWindow;
...
const OLEINPLACEFRAMEINFO = @import("../../../../windows/win32/system/ole.zig").OLEINPLACEFRAMEINFO;
...
const RECO_FLAGS = @import("../../../../windows/win32/system/system_services.zig").RECO_FLAGS;
const RECT = @import("../../../../windows/win32/foundation.zig").RECT;
const RECTL = @import("../../../../windows/win32/foundation.zig").RECTL;
const SCROLL_WINDOW_FLAGS = @import("../../../../windows/win32/ui/windows_and_messaging.zig").SCROLL_WINDOW_FLAGS;
...
const SYS_COLOR_INDEX = @import("../../../../windows/win32/graphics/gdi.zig").SYS_COLOR_INDEX;
