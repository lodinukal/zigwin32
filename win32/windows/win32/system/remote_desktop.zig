...
//--------------------------------------------------------------------------------
pub const WTS_CURRENT_SERVER = @import("../../../zig.zig").typedConst(HANDLE, @as(i32, 0));
pub const WTS_CURRENT_SERVER_HANDLE = @import("../../../zig.zig").typedConst(HANDLE, @as(i32, 0));
pub const WTS_CURRENT_SERVER_NAME = null;
...
// Section: Types (254)
//--------------------------------------------------------------------------------
pub const WTS_SECURITY_FLAGS = enum(u32) {
    CURRENT_GUEST_ACCESS = 72,
    USER_ACCESS = 329,
    CURRENT_USER_ACCESS = 590,
    ALL_ACCESS = 983999,
    QUERY_INFORMATION = 1,
    SET_INFORMATION = 2,
    RESET = 4,
    ...
    CONNECT = 256,
    DISCONNECT = 512,
    // GUEST_ACCESS = 32, this enum value conflicts with LOGON
    _,
    pub fn initFlags(o: struct {
        CURRENT_GUEST_ACCESS: u1 = 0,
        USER_ACCESS: u1 = 0,
        CURRENT_USER_ACCESS: u1 = 0,
        ALL_ACCESS: u1 = 0,
        QUERY_INFORMATION: u1 = 0,
        SET_INFORMATION: u1 = 0,
        RESET: u1 = 0,
        VIRTUAL_CHANNELS: u1 = 0,
        REMOTE_CONTROL: u1 = 0,
        LOGON: u1 = 0,
        LOGOFF: u1 = 0,
        MESSAGE: u1 = 0,
        ...
        return @as(WTS_SECURITY_FLAGS, @enumFromInt(
              (if (o.CURRENT_GUEST_ACCESS == 1) @intFromEnum(WTS_SECURITY_FLAGS.CURRENT_GUEST_ACCESS) else 0)
            | (if (o.USER_ACCESS == 1) @intFromEnum(WTS_SECURITY_FLAGS.USER_ACCESS) else 0)
            | (if (o.CURRENT_USER_ACCESS == 1) @intFromEnum(WTS_SECURITY_FLAGS.CURRENT_USER_ACCESS) else 0)
            | (if (o.ALL_ACCESS == 1) @intFromEnum(WTS_SECURITY_FLAGS.ALL_ACCESS) else 0)
            | (if (o.QUERY_INFORMATION == 1) @intFromEnum(WTS_SECURITY_FLAGS.QUERY_INFORMATION) else 0)
            | (if (o.SET_INFORMATION == 1) @intFromEnum(WTS_SECURITY_FLAGS.SET_INFORMATION) else 0)
            | (if (o.RESET == 1) @intFromEnum(WTS_SECURITY_FLAGS.RESET) else 0)
            | (if (o.VIRTUAL_CHANNELS == 1) @intFromEnum(WTS_SECURITY_FLAGS.VIRTUAL_CHANNELS) else 0)
            | (if (o.REMOTE_CONTROL == 1) @intFromEnum(WTS_SECURITY_FLAGS.REMOTE_CONTROL) else 0)
            | (if (o.LOGON == 1) @intFromEnum(WTS_SECURITY_FLAGS.LOGON) else 0)
            | (if (o.LOGOFF == 1) @intFromEnum(WTS_SECURITY_FLAGS.LOGOFF) else 0)
            | (if (o.MESSAGE == 1) @intFromEnum(WTS_SECURITY_FLAGS.MESSAGE) else 0)
            | (if (o.CONNECT == 1) @intFromEnum(WTS_SECURITY_FLAGS.CONNECT) else 0)
            | (if (o.DISCONNECT == 1) @intFromEnum(WTS_SECURITY_FLAGS.DISCONNECT) else 0)
        ));
    }
};
pub const WTS_SECURITY_CURRENT_GUEST_ACCESS = WTS_SECURITY_FLAGS.CURRENT_GUEST_ACCESS;
pub const WTS_SECURITY_USER_ACCESS = WTS_SECURITY_FLAGS.USER_ACCESS;
pub const WTS_SECURITY_CURRENT_USER_ACCESS = WTS_SECURITY_FLAGS.CURRENT_USER_ACCESS;
pub const WTS_SECURITY_ALL_ACCESS = WTS_SECURITY_FLAGS.ALL_ACCESS;
pub const WTS_SECURITY_QUERY_INFORMATION = WTS_SECURITY_FLAGS.QUERY_INFORMATION;
pub const WTS_SECURITY_SET_INFORMATION = WTS_SECURITY_FLAGS.SET_INFORMATION;
pub const WTS_SECURITY_RESET = WTS_SECURITY_FLAGS.RESET;
pub const WTS_SECURITY_VIRTUAL_CHANNELS = WTS_SECURITY_FLAGS.VIRTUAL_CHANNELS;
pub const WTS_SECURITY_REMOTE_CONTROL = WTS_SECURITY_FLAGS.REMOTE_CONTROL;
pub const WTS_SECURITY_LOGON = WTS_SECURITY_FLAGS.LOGON;
pub const WTS_SECURITY_LOGOFF = WTS_SECURITY_FLAGS.LOGOFF;
pub const WTS_SECURITY_MESSAGE = WTS_SECURITY_FLAGS.MESSAGE;
pub const WTS_SECURITY_CONNECT = WTS_SECURITY_FLAGS.CONNECT;
pub const WTS_SECURITY_DISCONNECT = WTS_SECURITY_FLAGS.DISCONNECT;
pub const WTS_SECURITY_GUEST_ACCESS = WTS_SECURITY_FLAGS.LOGON;
...
pub const IWorkspace2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspace2_StartRemoteApplicationEx(self: *const T, bstrWorkspaceId: ?BSTR, bstrRequestingAppId: ?BSTR, bstrRequestingAppFamilyName: ?BSTR, bLaunchIntoImmersiveClient: VARIANT_BOOL, bstrImmersiveClientActivationContext: ?BSTR, psaParams: ?*SAFEARRAY) callconv(.Inline) HRESULT {
...
pub const IWorkspaceScriptable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceScriptable_IsWorkspaceCredentialSpecified(self: *const T, bstrWorkspaceId: ?BSTR, bCountUnauthenticatedCredentials: VARIANT_BOOL, pbCredExist: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceScriptable_IsWorkspaceSSOEnabled(self: *const T, pbSSOEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWorkspaceReportMessage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceReportMessage_IsErrorMessageRegistered(self: *const T, bstrWkspId: ?BSTR, dwErrorType: u32, bstrErrorMessageType: ?BSTR, dwErrorCode: u32, pfErrorExist: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ItsPubPlugin = extern struct {
    pub const VTable = extern struct {
        ...
        ResolveResource: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ItsPubPlugin,
                resourceType: ?*u32,
                resourceLocation: *[256]u16,
                endPointName: *[256]u16,
                userID: ?PWSTR,
                alias: ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin_GetResourceList(self: *const T, userID: ?[*:0]align(1) const u16, pceAppListSize: ?*i32, resourceList: ?*?*pluginResource) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin_GetResource(self: *const T, alias: ?[*:0]align(1) const u16, flags: i32, resource: ?*pluginResource) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin_ResolveResource(self: *const T, resourceType: ?*u32, resourceLocation: *[256]u16, endPointName: *[256]u16, userID: ?PWSTR, alias: ?PWSTR) callconv(.Inline) HRESULT {
...
pub const ItsPubPlugin2 = extern struct {
    pub const VTable = extern struct {
        ...
        DeletePersonalDesktopAssignment: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                userId: ?[*:0]align(1) const u16,
                poolId: ?[*:0]align(1) const u16,
                endpointName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ItsPubPlugin2,
                userId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin2_GetResource2List(self: *const T, userID: ?[*:0]align(1) const u16, pceAppListSize: ?*i32, resourceList: ?*?*pluginResource2) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin2_GetResource2(self: *const T, alias: ?[*:0]align(1) const u16, flags: i32, resource: ?*pluginResource2) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin2_ResolvePersonalDesktop(self: *const T, userId: ?[*:0]align(1) const u16, poolId: ?[*:0]align(1) const u16, ePdResolutionType: TSPUB_PLUGIN_PD_RESOLUTION_TYPE, pPdAssignmentType: ?*TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE, endPointName: *[256]u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ItsPubPlugin2_DeletePersonalDesktopAssignment(self: *const T, userId: ?[*:0]align(1) const u16, poolId: ?[*:0]align(1) const u16, endpointName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IWorkspaceResTypeRegistry = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceResTypeRegistry_AddResourceType(self: *const T, fMachineWide: VARIANT_BOOL, bstrFileExtension: ?BSTR, bstrLauncher: ?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceResTypeRegistry_DeleteResourceType(self: *const T, fMachineWide: VARIANT_BOOL, bstrFileExtension: ?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceResTypeRegistry_GetRegisteredFileExtensions(self: *const T, fMachineWide: VARIANT_BOOL, psaFileExtensions: ?*?*SAFEARRAY) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceResTypeRegistry_GetResourceTypeInfo(self: *const T, fMachineWide: VARIANT_BOOL, bstrFileExtension: ?BSTR, pbstrLauncher: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWorkspaceResTypeRegistry_ModifyResourceType(self: *const T, fMachineWide: VARIANT_BOOL, bstrFileExtension: ?BSTR, bstrLauncher: ?BSTR) callconv(.Inline) HRESULT {
...
pub const IWTSVirtualChannelManager = extern struct {
    pub const VTable = extern struct {
        ...
        CreateListener: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszChannelName: ?[*:0]align(1) const u8,
                uFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSVirtualChannelManager_CreateListener(self: *const T, pszChannelName: ?[*:0]align(1) const u8, uFlags: u32, pListenerCallback: ?*IWTSListenerCallback, ppListener: ?*?*IWTSListener) callconv(.Inline) HRESULT {
...
pub const IWTSProtocolLogonErrorRedirector = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolLogonErrorRedirector_RedirectStatus(self: *const T, pszMessage: ?[*:0]align(1) const u16, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolLogonErrorRedirector_RedirectMessage(self: *const T, pszCaption: ?[*:0]align(1) const u16, pszMessage: ?[*:0]align(1) const u16, uType: u32, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolLogonErrorRedirector_RedirectLogonError(self: *const T, ntsStatus: i32, ntsSubstatus: i32, pszCaption: ?[*:0]align(1) const u16, pszMessage: ?[*:0]align(1) const u16, uType: u32, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
...
pub const IWRdsProtocolLogonErrorRedirector = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolLogonErrorRedirector_RedirectStatus(self: *const T, pszMessage: ?[*:0]align(1) const u16, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolLogonErrorRedirector_RedirectMessage(self: *const T, pszCaption: ?[*:0]align(1) const u16, pszMessage: ?[*:0]align(1) const u16, uType: u32, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolLogonErrorRedirector_RedirectLogonError(self: *const T, ntsStatus: i32, ntsSubstatus: i32, pszCaption: ?[*:0]align(1) const u16, pszMessage: ?[*:0]align(1) const u16, uType: u32, pResponse: ?*WTS_LOGON_ERROR_REDIRECTOR_RESPONSE) callconv(.Inline) HRESULT {
...
pub const IRemoteDesktopClientTouchPointer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRemoteDesktopClientTouchPointer_put_Enabled(self: *const T, enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRemoteDesktopClientTouchPointer_get_Enabled(self: *const T, enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRemoteDesktopClientTouchPointer_put_EventsEnabled(self: *const T, eventsEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRemoteDesktopClientTouchPointer_get_EventsEnabled(self: *const T, eventsEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const PRODUCT_INFO = thismodule.PRODUCT_INFOA;
    ...
    .wide => struct {
        ...
        pub const PRODUCT_INFO = thismodule.PRODUCT_INFOW;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const PRODUCT_INFO = @compileError("'PRODUCT_INFO' requires that UNICODE be set to true or false in the root module");
...
const APO_CONNECTION_PROPERTY = @import("../../../windows/win32/media/audio/apo.zig").APO_CONNECTION_PROPERTY;
...
const MESSAGEBOX_RESULT = @import("../../../windows/win32/ui/windows_and_messaging.zig").MESSAGEBOX_RESULT;
