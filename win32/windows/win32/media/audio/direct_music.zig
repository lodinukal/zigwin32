...
pub const IDirectMusicSynth = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectMusicSynth_Download(self: *const T, phDownload: ?*?HANDLE, pvData: ?*anyopaque, pbFree: ?*BOOL) callconv(.Inline) HRESULT {
...
const HMIDI = @import("../../../../windows/win32/media/audio.zig").HMIDI;
...
const MIDIOPENSTRMID = @import("../../../../windows/win32/media/multimedia.zig").MIDIOPENSTRMID;
