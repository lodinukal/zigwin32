...
pub const IInkExtendedProperties = extern struct {
    pub const VTable = extern struct {
        ...
        DoesPropertyExist: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IInkExtendedProperties,
                Guid: ?BSTR,
                DoesPropertyExist: ?*VARIANT_BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IInkExtendedProperties,
                Guid: ?BSTR,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkExtendedProperties_DoesPropertyExist(self: *const T, _param_Guid: ?BSTR, DoesPropertyExist: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkDrawingAttributes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_get_FitToCurve(self: *const T, Flag: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_put_FitToCurve(self: *const T, Flag: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_get_IgnorePressure(self: *const T, Flag: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_put_IgnorePressure(self: *const T, Flag: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_get_AntiAliased(self: *const T, Flag: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDrawingAttributes_put_AntiAliased(self: *const T, Flag: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkTransform = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkTransform_Reflect(self: *const T, Horizontally: VARIANT_BOOL, Vertically: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkCursor = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCursor_get_Inverted(self: *const T, Status: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkTablet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkTablet_IsPacketPropertySupported(self: *const T, packetPropertyName: ?BSTR, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkTablet3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkTablet3_get_IsMultiTouch(self: *const T, pIsMultiTouch: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkTablets = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkTablets_IsPacketPropertySupported(self: *const T, packetPropertyName: ?BSTR, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkStrokeDisp = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkStrokeDisp_get_Deleted(self: *const T, Deleted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkStrokeDisp_HitTestCircle(self: *const T, X: i32, Y: i32, Radius: f32, Intersects: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkStrokeDisp_Transform(self: *const T, Transform: ?*IInkTransform, ApplyOnPenWidth: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkStrokes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkStrokes_Transform(self: *const T, Transform: ?*IInkTransform, ApplyOnPenWidth: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkDisp = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDisp_get_Dirty(self: *const T, Dirty: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkDisp.VTable, @ptrCast(self.vtable)).get_Dirty(@as(*const IInkDisp, @ptrCast(self)), Dirty);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDisp_put_Dirty(self: *const T, Dirty: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkDisp_CanPaste(self: *const T, DataObject: ?*IDataObject, CanPaste: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkRenderer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkRenderer_ScaleTransform(self: *const T, HorizontalMultiplier: f32, VerticalMultiplier: f32, ApplyOnPenWidth: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkCollector = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_get_Enabled(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkCollector.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const IInkCollector, @ptrCast(self)), Collecting);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_put_Enabled(self: *const T, Collecting: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_get_AutoRedraw(self: *const T, AutoRedraw: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkCollector.VTable, @ptrCast(self.vtable)).get_AutoRedraw(@as(*const IInkCollector, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_put_AutoRedraw(self: *const T, AutoRedraw: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkCollector.VTable, @ptrCast(self.vtable)).put_AutoRedraw(@as(*const IInkCollector, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_get_CollectingInk(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_get_DynamicRendering(self: *const T, Enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_put_DynamicRendering(self: *const T, Enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_get_SupportHighContrastInk(self: *const T, Support: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_put_SupportHighContrastInk(self: *const T, Support: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_SetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_GetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listening: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_SetAllTabletsMode(self: *const T, UseMouseForInput: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_GetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkCollector_SetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkOverlay = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_Enabled(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const IInkOverlay, @ptrCast(self)), Collecting);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_put_Enabled(self: *const T, Collecting: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_AutoRedraw(self: *const T, AutoRedraw: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).get_AutoRedraw(@as(*const IInkOverlay, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_put_AutoRedraw(self: *const T, AutoRedraw: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).put_AutoRedraw(@as(*const IInkOverlay, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_CollectingInk(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_DynamicRendering(self: *const T, Enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).get_DynamicRendering(@as(*const IInkOverlay, @ptrCast(self)), Enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_put_DynamicRendering(self: *const T, Enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_SupportHighContrastInk(self: *const T, Support: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_put_SupportHighContrastInk(self: *const T, Support: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_get_SupportHighContrastSelectionUI(self: *const T, Support: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_put_SupportHighContrastSelectionUI(self: *const T, Support: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_SetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).SetGestureStatus(@as(*const IInkOverlay, @ptrCast(self)), Gesture, Listen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_GetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listening: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_SetAllTabletsMode(self: *const T, UseMouseForInput: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_GetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkOverlay.VTable, @ptrCast(self.vtable)).GetEventInterest(@as(*const IInkOverlay, @ptrCast(self)), EventId, Listen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkOverlay_SetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkPicture = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_AutoRedraw(self: *const T, AutoRedraw: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).get_AutoRedraw(@as(*const IInkPicture, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_AutoRedraw(self: *const T, AutoRedraw: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).put_AutoRedraw(@as(*const IInkPicture, @ptrCast(self)), AutoRedraw);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_CollectingInk(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_DynamicRendering(self: *const T, Enabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).get_DynamicRendering(@as(*const IInkPicture, @ptrCast(self)), Enabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_DynamicRendering(self: *const T, Enabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_SupportHighContrastInk(self: *const T, Support: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_SupportHighContrastInk(self: *const T, Support: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_SupportHighContrastSelectionUI(self: *const T, Support: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_SupportHighContrastSelectionUI(self: *const T, Support: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_SetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).SetGestureStatus(@as(*const IInkPicture, @ptrCast(self)), Gesture, Listen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_GetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listening: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_SetAllTabletsMode(self: *const T, UseMouseForInput: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_GetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).GetEventInterest(@as(*const IInkPicture, @ptrCast(self)), EventId, Listen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_SetEventInterest(self: *const T, EventId: InkCollectorEventInterest, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).SetEventInterest(@as(*const IInkPicture, @ptrCast(self)), EventId, Listen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_InkEnabled(self: *const T, Collecting: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).get_InkEnabled(@as(*const IInkPicture, @ptrCast(self)), Collecting);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_InkEnabled(self: *const T, Collecting: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).put_InkEnabled(@as(*const IInkPicture, @ptrCast(self)), Collecting);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_get_Enabled(self: *const T, pbool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkPicture.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const IInkPicture, @ptrCast(self)), pbool);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkPicture_put_Enabled(self: *const T, vbool: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkRecognizerContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkRecognizerContext_IsStringSupported(self: *const T, String: ?BSTR, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IPenInputPanel = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_get_Busy(self: *const T, Busy: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_get_Visible(self: *const T, Visible: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IPenInputPanel.VTable, @ptrCast(self.vtable)).get_Visible(@as(*const IPenInputPanel, @ptrCast(self)), Visible);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_put_Visible(self: *const T, Visible: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_get_AutoShow(self: *const T, pAutoShow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IPenInputPanel.VTable, @ptrCast(self.vtable)).get_AutoShow(@as(*const IPenInputPanel, @ptrCast(self)), pAutoShow);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_put_AutoShow(self: *const T, AutoShow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPenInputPanel_EnableTsf(self: *const T, Enable: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInkEdit = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_UseMouseForInput(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).get_UseMouseForInput(@as(*const IInkEdit, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_put_UseMouseForInput(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_GetGestureStatus(self: *const T, Gesture: InkApplicationGesture, pListen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).GetGestureStatus(@as(*const IInkEdit, @ptrCast(self)), Gesture, pListen);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_SetGestureStatus(self: *const T, Gesture: InkApplicationGesture, Listen: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_Hwnd(self: *const T, pohHwnd: ?*OLE_HANDLE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_Locked(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).get_Locked(@as(*const IInkEdit, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_put_Locked(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).put_Locked(@as(*const IInkEdit, @ptrCast(self)), newVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_Enabled(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const IInkEdit, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_put_Enabled(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_MultiLine(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).get_MultiLine(@as(*const IInkEdit, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_put_MultiLine(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_get_DisableNoScroll(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IInkEdit.VTable, @ptrCast(self.vtable)).get_DisableNoScroll(@as(*const IInkEdit, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInkEdit_put_DisableNoScroll(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMathInputControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMathInputControl_IsVisible(self: *const T, pvbShown: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMathInputControl_SetCustomPaint(self: *const T, Element: i32, Paint: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMathInputControl_EnableExtendedButtons(self: *const T, Extended: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMathInputControl_EnableAutoGrow(self: *const T, AutoGrow: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "inkobjcore" fn SetFactoid(
    hrc: ?HRECOCONTEXT,
    cwcFactoid: u32,
    pwcFactoid: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const XFORM = @import("../../../windows/win32/graphics/gdi.zig").XFORM;
