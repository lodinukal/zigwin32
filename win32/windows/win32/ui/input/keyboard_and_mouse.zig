...
pub const VIRTUAL_KEY = enum(u16) {
    ...
    ABNT_C1 = 193,
    ABNT_C2 = 194,
    DBE_ALPHANUMERIC = 240,
    DBE_CODEINPUT = 250,
    DBE_DBCSCHAR = 244,
    DBE_DETERMINESTRING = 252,
    DBE_ENTERDLGCONVERSIONMODE = 253,
    DBE_ENTERIMECONFIGMODE = 248,
    DBE_ENTERWORDREGISTERMODE = 247,
    DBE_FLUSHSTRING = 249,
    DBE_HIRAGANA = 242,
    DBE_KATAKANA = 241,
    DBE_NOCODEINPUT = 251,
    ...
    OEM_WSCTRL = 238,
    OEM_CUSEL = 239,
    // OEM_ATTN = 240, this enum value conflicts with DBE_ALPHANUMERIC
    // OEM_FINISH = 241, this enum value conflicts with DBE_KATAKANA
    // OEM_COPY = 242, this enum value conflicts with DBE_HIRAGANA
    // OEM_AUTO = 243, this enum value conflicts with DBE_SBCSCHAR
    // OEM_ENLW = 244, this enum value conflicts with DBE_DBCSCHAR
    // OEM_BACKTAB = 245, this enum value conflicts with DBE_ROMAN
    // ATTN = 246, this enum value conflicts with DBE_NOROMAN
    // CRSEL = 247, this enum value conflicts with DBE_ENTERWORDREGISTERMODE
    // EXSEL = 248, this enum value conflicts with DBE_ENTERIMECONFIGMODE
    // EREOF = 249, this enum value conflicts with DBE_FLUSHSTRING
    // PLAY = 250, this enum value conflicts with DBE_CODEINPUT
    // ZOOM = 251, this enum value conflicts with DBE_NOCODEINPUT
    // NONAME = 252, this enum value conflicts with DBE_DETERMINESTRING
    // PA1 = 253, this enum value conflicts with DBE_ENTERDLGCONVERSIONMODE
    OEM_CLEAR = 254,
};
// TODO: enum 'VIRTUAL_KEY' has known issues with its value aliases
