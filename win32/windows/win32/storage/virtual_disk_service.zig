...
pub const VDS_PACK_STATUS = enum(i32) {
    UNKNOWN = 0,
    ONLINE = 1,
    OFFLINE = 4,
};
pub const VDS_PS_UNKNOWN = VDS_PACK_STATUS.UNKNOWN;
pub const VDS_PS_ONLINE = VDS_PACK_STATUS.ONLINE;
pub const VDS_PS_OFFLINE = VDS_PACK_STATUS.OFFLINE;

pub const VDS_PACK_FLAG = enum(i32) {
    FOREIGN = 1,
    NOQUORUM = 2,
    POLICY = 4,
    CORRUPTED = 8,
...
pub const VDS_PKF_FOREIGN = VDS_PACK_FLAG.FOREIGN;
pub const VDS_PKF_NOQUORUM = VDS_PACK_FLAG.NOQUORUM;
pub const VDS_PKF_POLICY = VDS_PACK_FLAG.POLICY;
pub const VDS_PKF_CORRUPTED = VDS_PACK_FLAG.CORRUPTED;
pub const VDS_PKF_ONLINE_ERROR = VDS_PACK_FLAG.ONLINE_ERROR;

pub const VDS_DISK_STATUS = enum(i32) {
    UNKNOWN = 0,
    ONLINE = 1,
    NOT_READY = 2,
    NO_MEDIA = 3,
...
pub const VDS_DS_UNKNOWN = VDS_DISK_STATUS.UNKNOWN;
pub const VDS_DS_ONLINE = VDS_DISK_STATUS.ONLINE;
pub const VDS_DS_NOT_READY = VDS_DISK_STATUS.NOT_READY;
pub const VDS_DS_NO_MEDIA = VDS_DISK_STATUS.NO_MEDIA;
pub const VDS_DS_FAILED = VDS_DISK_STATUS.FAILED;
pub const VDS_DS_MISSING = VDS_DISK_STATUS.MISSING;
pub const VDS_DS_OFFLINE = VDS_DISK_STATUS.OFFLINE;

pub const VDS_PARTITION_STYLE = enum(i32) {
    UNKNOWN = 0,
    MBR = 1,
    GPT = 2,
};
pub const VDS_PST_UNKNOWN = VDS_PARTITION_STYLE.UNKNOWN;
pub const VDS_PST_MBR = VDS_PARTITION_STYLE.MBR;
pub const VDS_PST_GPT = VDS_PARTITION_STYLE.GPT;

pub const VDS_DISK_FLAG = enum(i32) {
    AUDIO_CD = 1,
    HOTSPARE = 2,
    RESERVE_CAPABLE = 4,
    MASKED = 8,
    STYLE_CONVERTIBLE = 16,
    CLUSTERED = 32,
    READ_ONLY = 64,
    SYSTEM_DISK = 128,
    BOOT_DISK = 256,
    PAGEFILE_DISK = 512,
    HIBERNATIONFILE_DISK = 1024,
    CRASHDUMP_DISK = 2048,
    HAS_ARC_PATH = 4096,
    DYNAMIC = 8192,
    BOOT_FROM_DISK = 16384,
    CURRENT_READ_ONLY = 32768,
    REFS_NOT_SUPPORTED = 65536,
};
pub const VDS_DF_AUDIO_CD = VDS_DISK_FLAG.AUDIO_CD;
pub const VDS_DF_HOTSPARE = VDS_DISK_FLAG.HOTSPARE;
pub const VDS_DF_RESERVE_CAPABLE = VDS_DISK_FLAG.RESERVE_CAPABLE;
pub const VDS_DF_MASKED = VDS_DISK_FLAG.MASKED;
pub const VDS_DF_STYLE_CONVERTIBLE = VDS_DISK_FLAG.STYLE_CONVERTIBLE;
pub const VDS_DF_CLUSTERED = VDS_DISK_FLAG.CLUSTERED;
pub const VDS_DF_READ_ONLY = VDS_DISK_FLAG.READ_ONLY;
pub const VDS_DF_SYSTEM_DISK = VDS_DISK_FLAG.SYSTEM_DISK;
pub const VDS_DF_BOOT_DISK = VDS_DISK_FLAG.BOOT_DISK;
pub const VDS_DF_PAGEFILE_DISK = VDS_DISK_FLAG.PAGEFILE_DISK;
pub const VDS_DF_HIBERNATIONFILE_DISK = VDS_DISK_FLAG.HIBERNATIONFILE_DISK;
pub const VDS_DF_CRASHDUMP_DISK = VDS_DISK_FLAG.CRASHDUMP_DISK;
pub const VDS_DF_HAS_ARC_PATH = VDS_DISK_FLAG.HAS_ARC_PATH;
pub const VDS_DF_DYNAMIC = VDS_DISK_FLAG.DYNAMIC;
pub const VDS_DF_BOOT_FROM_DISK = VDS_DISK_FLAG.BOOT_FROM_DISK;
pub const VDS_DF_CURRENT_READ_ONLY = VDS_DISK_FLAG.CURRENT_READ_ONLY;
pub const VDS_DF_REFS_NOT_SUPPORTED = VDS_DISK_FLAG.REFS_NOT_SUPPORTED;

pub const VDS_PARTITION_FLAG = enum(i32) {
    M = 1,
};
pub const VDS_PTF_SYSTEM = VDS_PARTITION_FLAG.M;

pub const VDS_LUN_RESERVE_MODE = enum(i32) {
    NONE = 0,
    EXCLUSIVE_RW = 1,
    EXCLUSIVE_RO = 2,
    SHARED_RO = 3,
...
pub const VDS_LRM_NONE = VDS_LUN_RESERVE_MODE.NONE;
pub const VDS_LRM_EXCLUSIVE_RW = VDS_LUN_RESERVE_MODE.EXCLUSIVE_RW;
pub const VDS_LRM_EXCLUSIVE_RO = VDS_LUN_RESERVE_MODE.EXCLUSIVE_RO;
pub const VDS_LRM_SHARED_RO = VDS_LUN_RESERVE_MODE.SHARED_RO;
pub const VDS_LRM_SHARED_RW = VDS_LUN_RESERVE_MODE.SHARED_RW;

pub const VDS_VOLUME_STATUS = enum(i32) {
    UNKNOWN = 0,
    ONLINE = 1,
    NO_MEDIA = 3,
    FAILED = 5,
...
pub const VDS_VS_UNKNOWN = VDS_VOLUME_STATUS.UNKNOWN;
pub const VDS_VS_ONLINE = VDS_VOLUME_STATUS.ONLINE;
pub const VDS_VS_NO_MEDIA = VDS_VOLUME_STATUS.NO_MEDIA;
pub const VDS_VS_FAILED = VDS_VOLUME_STATUS.FAILED;
pub const VDS_VS_OFFLINE = VDS_VOLUME_STATUS.OFFLINE;

pub const VDS_VOLUME_TYPE = enum(i32) {
    UNKNOWN = 0,
    SIMPLE = 10,
    SPAN = 11,
    STRIPE = 12,
...
pub const VDS_VT_UNKNOWN = VDS_VOLUME_TYPE.UNKNOWN;
pub const VDS_VT_SIMPLE = VDS_VOLUME_TYPE.SIMPLE;
pub const VDS_VT_SPAN = VDS_VOLUME_TYPE.SPAN;
pub const VDS_VT_STRIPE = VDS_VOLUME_TYPE.STRIPE;
pub const VDS_VT_MIRROR = VDS_VOLUME_TYPE.MIRROR;
pub const VDS_VT_PARITY = VDS_VOLUME_TYPE.PARITY;

pub const VDS_VOLUME_FLAG = enum(i32) {
    SYSTEM_VOLUME = 1,
    BOOT_VOLUME = 2,
    ACTIVE = 4,
    READONLY = 8,
    ...
    CRASHDUMP = 512,
    INSTALLABLE = 1024,
    LBN_REMAP_ENABLED = 2048,
    FORMATTING = 4096,
    NOT_FORMATTABLE = 8192,
    NTFS_NOT_SUPPORTED = 16384,
    FAT32_NOT_SUPPORTED = 32768,
    FAT_NOT_SUPPORTED = 65536,
    NO_DEFAULT_DRIVE_LETTER = 131072,
    PERMANENTLY_DISMOUNTED = 262144,
    PERMANENT_DISMOUNT_SUPPORTED = 524288,
    SHADOW_COPY = 1048576,
    FVE_ENABLED = 2097152,
    DIRTY = 4194304,
    REFS_NOT_SUPPORTED = 8388608,
    BACKS_BOOT_VOLUME = 16777216,
    BACKED_BY_WIM_IMAGE = 33554432,
};
pub const VDS_VF_SYSTEM_VOLUME = VDS_VOLUME_FLAG.SYSTEM_VOLUME;
pub const VDS_VF_BOOT_VOLUME = VDS_VOLUME_FLAG.BOOT_VOLUME;
pub const VDS_VF_ACTIVE = VDS_VOLUME_FLAG.ACTIVE;
pub const VDS_VF_READONLY = VDS_VOLUME_FLAG.READONLY;
pub const VDS_VF_HIDDEN = VDS_VOLUME_FLAG.HIDDEN;
pub const VDS_VF_CAN_EXTEND = VDS_VOLUME_FLAG.CAN_EXTEND;
pub const VDS_VF_CAN_SHRINK = VDS_VOLUME_FLAG.CAN_SHRINK;
pub const VDS_VF_PAGEFILE = VDS_VOLUME_FLAG.PAGEFILE;
pub const VDS_VF_HIBERNATION = VDS_VOLUME_FLAG.HIBERNATION;
pub const VDS_VF_CRASHDUMP = VDS_VOLUME_FLAG.CRASHDUMP;
pub const VDS_VF_INSTALLABLE = VDS_VOLUME_FLAG.INSTALLABLE;
pub const VDS_VF_LBN_REMAP_ENABLED = VDS_VOLUME_FLAG.LBN_REMAP_ENABLED;
pub const VDS_VF_FORMATTING = VDS_VOLUME_FLAG.FORMATTING;
pub const VDS_VF_NOT_FORMATTABLE = VDS_VOLUME_FLAG.NOT_FORMATTABLE;
pub const VDS_VF_NTFS_NOT_SUPPORTED = VDS_VOLUME_FLAG.NTFS_NOT_SUPPORTED;
pub const VDS_VF_FAT32_NOT_SUPPORTED = VDS_VOLUME_FLAG.FAT32_NOT_SUPPORTED;
pub const VDS_VF_FAT_NOT_SUPPORTED = VDS_VOLUME_FLAG.FAT_NOT_SUPPORTED;
pub const VDS_VF_NO_DEFAULT_DRIVE_LETTER = VDS_VOLUME_FLAG.NO_DEFAULT_DRIVE_LETTER;
pub const VDS_VF_PERMANENTLY_DISMOUNTED = VDS_VOLUME_FLAG.PERMANENTLY_DISMOUNTED;
pub const VDS_VF_PERMANENT_DISMOUNT_SUPPORTED = VDS_VOLUME_FLAG.PERMANENT_DISMOUNT_SUPPORTED;
pub const VDS_VF_SHADOW_COPY = VDS_VOLUME_FLAG.SHADOW_COPY;
pub const VDS_VF_FVE_ENABLED = VDS_VOLUME_FLAG.FVE_ENABLED;
pub const VDS_VF_DIRTY = VDS_VOLUME_FLAG.DIRTY;
pub const VDS_VF_REFS_NOT_SUPPORTED = VDS_VOLUME_FLAG.REFS_NOT_SUPPORTED;
pub const VDS_VF_BACKS_BOOT_VOLUME = VDS_VOLUME_FLAG.BACKS_BOOT_VOLUME;
pub const VDS_VF_BACKED_BY_WIM_IMAGE = VDS_VOLUME_FLAG.BACKED_BY_WIM_IMAGE;

pub const VDS_VOLUME_PLEX_TYPE = enum(i32) {
    UNKNOWN = 0,
    SIMPLE = 10,
    SPAN = 11,
    STRIPE = 12,
...
pub const VDS_VPT_UNKNOWN = VDS_VOLUME_PLEX_TYPE.UNKNOWN;
pub const VDS_VPT_SIMPLE = VDS_VOLUME_PLEX_TYPE.SIMPLE;
pub const VDS_VPT_SPAN = VDS_VOLUME_PLEX_TYPE.SPAN;
pub const VDS_VPT_STRIPE = VDS_VOLUME_PLEX_TYPE.STRIPE;
pub const VDS_VPT_PARITY = VDS_VOLUME_PLEX_TYPE.PARITY;

pub const VDS_VOLUME_PLEX_STATUS = enum(i32) {
    UNKNOWN = 0,
    ONLINE = 1,
    NO_MEDIA = 3,
    FAILED = 5,
};
pub const VDS_VPS_UNKNOWN = VDS_VOLUME_PLEX_STATUS.UNKNOWN;
pub const VDS_VPS_ONLINE = VDS_VOLUME_PLEX_STATUS.ONLINE;
pub const VDS_VPS_NO_MEDIA = VDS_VOLUME_PLEX_STATUS.NO_MEDIA;
pub const VDS_VPS_FAILED = VDS_VOLUME_PLEX_STATUS.FAILED;

pub const VDS_DISK_EXTENT_TYPE = enum(i32) {
    UNKNOWN = 0,
    FREE = 1,
    DATA = 2,
    OEM = 3,
...
pub const VDS_DET_UNKNOWN = VDS_DISK_EXTENT_TYPE.UNKNOWN;
pub const VDS_DET_FREE = VDS_DISK_EXTENT_TYPE.FREE;
pub const VDS_DET_DATA = VDS_DISK_EXTENT_TYPE.DATA;
pub const VDS_DET_OEM = VDS_DISK_EXTENT_TYPE.OEM;
pub const VDS_DET_ESP = VDS_DISK_EXTENT_TYPE.ESP;
pub const VDS_DET_MSR = VDS_DISK_EXTENT_TYPE.MSR;
pub const VDS_DET_LDM = VDS_DISK_EXTENT_TYPE.LDM;
pub const VDS_DET_CLUSTER = VDS_DISK_EXTENT_TYPE.CLUSTER;
pub const VDS_DET_UNUSABLE = VDS_DISK_EXTENT_TYPE.UNUSABLE;
...
pub const VDS_DISK_OFFLINE_REASON = enum(i32) {
    None = 0,
    Policy = 1,
    RedundantPath = 2,
    Snapshot = 3,
    ...
    WriteFailure = 6,
    DIScan = 7,
    LostDataPersistence = 8,
};
pub const VDSDiskOfflineReasonNone = VDS_DISK_OFFLINE_REASON.None;
pub const VDSDiskOfflineReasonPolicy = VDS_DISK_OFFLINE_REASON.Policy;
pub const VDSDiskOfflineReasonRedundantPath = VDS_DISK_OFFLINE_REASON.RedundantPath;
pub const VDSDiskOfflineReasonSnapshot = VDS_DISK_OFFLINE_REASON.Snapshot;
pub const VDSDiskOfflineReasonCollision = VDS_DISK_OFFLINE_REASON.Collision;
pub const VDSDiskOfflineReasonResourceExhaustion = VDS_DISK_OFFLINE_REASON.ResourceExhaustion;
pub const VDSDiskOfflineReasonWriteFailure = VDS_DISK_OFFLINE_REASON.WriteFailure;
pub const VDSDiskOfflineReasonDIScan = VDS_DISK_OFFLINE_REASON.DIScan;
pub const VDSDiskOfflineReasonLostDataPersistence = VDS_DISK_OFFLINE_REASON.LostDataPersistence;
...
pub const __VDS_PARTITION_STYLE = enum(i32) {
    MBR = 0,
    GPT = 1,
    RAW = 2,
};
pub const VDS_PARTITION_STYLE_MBR = __VDS_PARTITION_STYLE.MBR;
pub const VDS_PARTITION_STYLE_GPT = __VDS_PARTITION_STYLE.GPT;
pub const VDS_PARTITION_STYLE_RAW = __VDS_PARTITION_STYLE.RAW;
...
pub const CREATE_PARTITION_PARAMETERS = extern struct {
    ...
    Anonymous: extern union {
        MbrPartInfo: extern struct {
            partitionType: u8,
            bootIndicator: BOOLEAN,
        },
        GptPartInfo: extern struct {
            partitionType: Guid,
            partitionId: Guid,
            attributes: u64,
            name: [36]u16,
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsSwProvider_Value = Guid.initString("9aa58360-ce33-4f92-b658-ed24b14425b8");
pub const IID_IVdsSwProvider = &IID_IVdsSwProvider_Value;
pub const IVdsSwProvider = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryPacks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsSwProvider,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsSwProvider,
        ...
        CreatePack: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsSwProvider,
                ppPack: ?*?*IVdsPack,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsSwProvider_QueryPacks(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsSwProvider.VTable, @ptrCast(self.vtable)).QueryPacks(@as(*const IVdsSwProvider, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsSwProvider_CreatePack(self: *const T, ppPack: ?*?*IVdsPack) callconv(.Inline) HRESULT {
            return @as(*const IVdsSwProvider.VTable, @ptrCast(self.vtable)).CreatePack(@as(*const IVdsSwProvider, @ptrCast(self)), ppPack);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsPack_Value = Guid.initString("3b69d7f5-9d94-4648-91ca-79939ba263bf");
pub const IID_IVdsPack = &IID_IVdsPack_Value;
pub const IVdsPack = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
        ...
        QueryVolumes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        QueryDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        CreateVolume: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                type: VDS_VOLUME_TYPE,
        ...
        AddDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                DiskId: Guid,
                PartitionStyle: VDS_PARTITION_STYLE,
        ...
        MigrateDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                pDiskArray: [*]Guid,
                lNumberOfDisks: i32,
        ...
        ReplaceDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                OldDiskId: Guid,
                NewDiskId: Guid,
        ...
        RemoveMissingDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack,
                DiskId: Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_GetProperties(self: *const T, pPackProp: ?*VDS_PACK_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsPack, @ptrCast(self)), pPackProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_GetProvider(self: *const T, ppProvider: ?*?*IVdsProvider) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).GetProvider(@as(*const IVdsPack, @ptrCast(self)), ppProvider);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_QueryVolumes(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).QueryVolumes(@as(*const IVdsPack, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_QueryDisks(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).QueryDisks(@as(*const IVdsPack, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_CreateVolume(self: *const T, type_: VDS_VOLUME_TYPE, pInputDiskArray: [*]VDS_INPUT_DISK, lNumberOfDisks: i32, ulStripeSize: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).CreateVolume(@as(*const IVdsPack, @ptrCast(self)), type_, pInputDiskArray, lNumberOfDisks, ulStripeSize, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_AddDisk(self: *const T, DiskId: Guid, PartitionStyle: VDS_PARTITION_STYLE, bAsHotSpare: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).AddDisk(@as(*const IVdsPack, @ptrCast(self)), DiskId, PartitionStyle, bAsHotSpare);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_MigrateDisks(self: *const T, pDiskArray: [*]Guid, lNumberOfDisks: i32, TargetPack: Guid, bForce: BOOL, bQueryOnly: BOOL, pResults: [*]HRESULT, pbRebootNeeded: ?*BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).MigrateDisks(@as(*const IVdsPack, @ptrCast(self)), pDiskArray, lNumberOfDisks, TargetPack, bForce, bQueryOnly, pResults, pbRebootNeeded);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_ReplaceDisk(self: *const T, OldDiskId: Guid, NewDiskId: Guid, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).ReplaceDisk(@as(*const IVdsPack, @ptrCast(self)), OldDiskId, NewDiskId, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_RemoveMissingDisk(self: *const T, DiskId: Guid) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).RemoveMissingDisk(@as(*const IVdsPack, @ptrCast(self)), DiskId);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack_Recover(self: *const T, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack.VTable, @ptrCast(self.vtable)).Recover(@as(*const IVdsPack, @ptrCast(self)), ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsPack2_Value = Guid.initString("13b50bff-290a-47dd-8558-b7c58db1a71a");
pub const IID_IVdsPack2 = &IID_IVdsPack2_Value;
pub const IVdsPack2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        CreateVolume2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsPack2,
                type: VDS_VOLUME_TYPE,
                pInputDiskArray: [*]VDS_INPUT_DISK,
                lNumberOfDisks: i32,
                ulStripeSize: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsPack2_CreateVolume2(self: *const T, type_: VDS_VOLUME_TYPE, pInputDiskArray: [*]VDS_INPUT_DISK, lNumberOfDisks: i32, ulStripeSize: u32, ulAlign: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsPack2.VTable, @ptrCast(self.vtable)).CreateVolume2(@as(*const IVdsPack2, @ptrCast(self)), type_, pInputDiskArray, lNumberOfDisks, ulStripeSize, ulAlign, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsDisk_Value = Guid.initString("07e5c822-f00c-47a1-8fce-b244da56fd06");
pub const IID_IVdsDisk = &IID_IVdsDisk_Value;
pub const IVdsDisk = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
        ...
        GetPack: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDisk,
                ppPack: ?*?*IVdsPack,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        ConvertStyle: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDisk,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_GetProperties(self: *const T, pDiskProperties: ?*VDS_DISK_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsDisk, @ptrCast(self)), pDiskProperties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_GetPack(self: *const T, ppPack: ?*?*IVdsPack) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).GetPack(@as(*const IVdsDisk, @ptrCast(self)), ppPack);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_GetIdentificationData(self: *const T, pLunInfo: ?*VDS_LUN_INFORMATION) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).GetIdentificationData(@as(*const IVdsDisk, @ptrCast(self)), pLunInfo);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_QueryExtents(self: *const T, ppExtentArray: [*]?*VDS_DISK_EXTENT, plNumberOfExtents: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).QueryExtents(@as(*const IVdsDisk, @ptrCast(self)), ppExtentArray, plNumberOfExtents);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_ConvertStyle(self: *const T, NewStyle: VDS_PARTITION_STYLE) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).ConvertStyle(@as(*const IVdsDisk, @ptrCast(self)), NewStyle);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_SetFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).SetFlags(@as(*const IVdsDisk, @ptrCast(self)), ulFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk_ClearFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk.VTable, @ptrCast(self.vtable)).ClearFlags(@as(*const IVdsDisk, @ptrCast(self)), ulFlags);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsDisk2_Value = Guid.initString("40f73c8b-687d-4a13-8d96-3d7f2e683936");
pub const IID_IVdsDisk2 = &IID_IVdsDisk2_Value;
pub const IVdsDisk2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        SetSANMode: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDisk2,
                bEnable: BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsDisk2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk2_SetSANMode(self: *const T, bEnable: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk2.VTable, @ptrCast(self.vtable)).SetSANMode(@as(*const IVdsDisk2, @ptrCast(self)), bEnable);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsDiskOnline_Value = Guid.initString("90681b1d-6a7f-48e8-9061-31b7aa125322");
pub const IID_IVdsDiskOnline = &IID_IVdsDiskOnline_Value;
pub const IVdsDiskOnline = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Online: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskOnline,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsDiskOnline,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskOnline_Online(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskOnline.VTable, @ptrCast(self.vtable)).Online(@as(*const IVdsDiskOnline, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskOnline_Offline(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskOnline.VTable, @ptrCast(self.vtable)).Offline(@as(*const IVdsDiskOnline, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsAdvancedDisk_Value = Guid.initString("6e6f6b40-977c-4069-bddd-ac710059f8c0");
pub const IID_IVdsAdvancedDisk = &IID_IVdsAdvancedDisk_Value;
pub const IVdsAdvancedDisk = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetPartitionProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
        ...
        QueryPartitions: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ppPartitionPropArray: [*]?*VDS_PARTITION_PROP,
                plNumberOfPartitions: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsAdvancedDisk,
                ppPartitionPropArray: [*]?*VDS_PARTITION_PROP,
        ...
        CreatePartition: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                ullSize: u64,
        ...
        DeletePartition: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                bForce: BOOL,
        ...
        ChangeAttributes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                para: ?*CHANGE_ATTRIBUTES_PARAMETERS,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
        ...
        AssignDriveLetter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                wcLetter: u16,
        ...
        DeleteDriveLetter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                wcLetter: u16,
        ...
        GetDriveLetter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
                pwcLetter: ?PWSTR,
        ...
        FormatPartition: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                ullOffset: u64,
        ...
        Clean: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk,
                bForce: BOOL,
                bForceOEM: BOOL,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_GetPartitionProperties(self: *const T, ullOffset: u64, pPartitionProp: ?*VDS_PARTITION_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).GetPartitionProperties(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, pPartitionProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_QueryPartitions(self: *const T, ppPartitionPropArray: [*]?*VDS_PARTITION_PROP, plNumberOfPartitions: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).QueryPartitions(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ppPartitionPropArray, plNumberOfPartitions);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_CreatePartition(self: *const T, ullOffset: u64, ullSize: u64, para: ?*CREATE_PARTITION_PARAMETERS, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).CreatePartition(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, ullSize, para, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_DeletePartition(self: *const T, ullOffset: u64, bForce: BOOL, bForceProtected: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).DeletePartition(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, bForce, bForceProtected);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_ChangeAttributes(self: *const T, ullOffset: u64, para: ?*CHANGE_ATTRIBUTES_PARAMETERS) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).ChangeAttributes(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, para);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_AssignDriveLetter(self: *const T, ullOffset: u64, wcLetter: u16) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).AssignDriveLetter(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, wcLetter);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_DeleteDriveLetter(self: *const T, ullOffset: u64, wcLetter: u16) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).DeleteDriveLetter(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, wcLetter);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_GetDriveLetter(self: *const T, ullOffset: u64, pwcLetter: ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).GetDriveLetter(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, pwcLetter);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_FormatPartition(self: *const T, ullOffset: u64, type_: VDS_FILE_SYSTEM_TYPE, pwszLabel: ?PWSTR, dwUnitAllocationSize: u32, bForce: BOOL, bQuickFormat: BOOL, bEnableCompression: BOOL, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).FormatPartition(@as(*const IVdsAdvancedDisk, @ptrCast(self)), ullOffset, type_, pwszLabel, dwUnitAllocationSize, bForce, bQuickFormat, bEnableCompression, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk_Clean(self: *const T, bForce: BOOL, bForceOEM: BOOL, bFullClean: BOOL, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk.VTable, @ptrCast(self.vtable)).Clean(@as(*const IVdsAdvancedDisk, @ptrCast(self)), bForce, bForceOEM, bFullClean, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsAdvancedDisk2_Value = Guid.initString("9723f420-9355-42de-ab66-e31bb15beeac");
pub const IID_IVdsAdvancedDisk2 = &IID_IVdsAdvancedDisk2_Value;
pub const IVdsAdvancedDisk2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        ChangePartitionType: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk2,
                ullOffset: u64,
                bForce: BOOL,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk2_ChangePartitionType(self: *const T, ullOffset: u64, bForce: BOOL, para: ?*CHANGE_PARTITION_TYPE_PARAMETERS) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk2.VTable, @ptrCast(self.vtable)).ChangePartitionType(@as(*const IVdsAdvancedDisk2, @ptrCast(self)), ullOffset, bForce, para);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IVdsAdvancedDisk3_Value = Guid.initString("3858c0d5-0f35-4bf5-9714-69874963bc36");
pub const IID_IVdsAdvancedDisk3 = &IID_IVdsAdvancedDisk3_Value;
pub const IVdsAdvancedDisk3 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk3,
        ...
        GetUniqueId: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsAdvancedDisk3,
                ppwszId: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk3_GetProperties(self: *const T, pAdvDiskProp: ?*VDS_ADVANCEDDISK_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk3.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsAdvancedDisk3, @ptrCast(self)), pAdvDiskProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsAdvancedDisk3_GetUniqueId(self: *const T, ppwszId: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsAdvancedDisk3.VTable, @ptrCast(self.vtable)).GetUniqueId(@as(*const IVdsAdvancedDisk3, @ptrCast(self)), ppwszId);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsCreatePartitionEx_Value = Guid.initString("9882f547-cfc3-420b-9750-00dfbec50662");
pub const IID_IVdsCreatePartitionEx = &IID_IVdsCreatePartitionEx_Value;
pub const IVdsCreatePartitionEx = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        CreatePartitionEx: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsCreatePartitionEx,
                ullOffset: u64,
                ullSize: u64,
                ulAlign: u32,
                para: ?*CREATE_PARTITION_PARAMETERS,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsCreatePartitionEx_CreatePartitionEx(self: *const T, ullOffset: u64, ullSize: u64, ulAlign: u32, para: ?*CREATE_PARTITION_PARAMETERS, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsCreatePartitionEx.VTable, @ptrCast(self.vtable)).CreatePartitionEx(@as(*const IVdsCreatePartitionEx, @ptrCast(self)), ullOffset, ullSize, ulAlign, para, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsRemovable_Value = Guid.initString("0316560b-5db4-4ed9-bbb5-213436ddc0d9");
pub const IID_IVdsRemovable = &IID_IVdsRemovable_Value;
pub const IVdsRemovable = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryMedia: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsRemovable,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsRemovable,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsRemovable_QueryMedia(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsRemovable.VTable, @ptrCast(self.vtable)).QueryMedia(@as(*const IVdsRemovable, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsRemovable_Eject(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsRemovable.VTable, @ptrCast(self.vtable)).Eject(@as(*const IVdsRemovable, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolume_Value = Guid.initString("88306bb2-e71f-478c-86a2-79da200a0f11");
pub const IID_IVdsVolume = &IID_IVdsVolume_Value;
pub const IVdsVolume = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolume,
        ...
        BreakPlex: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolume,
                plexId: Guid,
                ppAsync: ?*?*IVdsAsync,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_GetProperties(self: *const T, pVolumeProperties: ?*VDS_VOLUME_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsVolume, @ptrCast(self)), pVolumeProperties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_GetPack(self: *const T, ppPack: ?*?*IVdsPack) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).GetPack(@as(*const IVdsVolume, @ptrCast(self)), ppPack);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_QueryPlexes(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).QueryPlexes(@as(*const IVdsVolume, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_Extend(self: *const T, pInputDiskArray: [*]VDS_INPUT_DISK, lNumberOfDisks: i32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).Extend(@as(*const IVdsVolume, @ptrCast(self)), pInputDiskArray, lNumberOfDisks, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_Shrink(self: *const T, ullNumberOfBytesToRemove: u64, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).Shrink(@as(*const IVdsVolume, @ptrCast(self)), ullNumberOfBytesToRemove, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_AddPlex(self: *const T, VolumeId: Guid, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).AddPlex(@as(*const IVdsVolume, @ptrCast(self)), VolumeId, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_BreakPlex(self: *const T, plexId: Guid, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).BreakPlex(@as(*const IVdsVolume, @ptrCast(self)), plexId, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_RemovePlex(self: *const T, plexId: Guid, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).RemovePlex(@as(*const IVdsVolume, @ptrCast(self)), plexId, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_Delete(self: *const T, bForce: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).Delete(@as(*const IVdsVolume, @ptrCast(self)), bForce);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_SetFlags(self: *const T, ulFlags: u32, bRevertOnClose: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).SetFlags(@as(*const IVdsVolume, @ptrCast(self)), ulFlags, bRevertOnClose);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume_ClearFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume.VTable, @ptrCast(self.vtable)).ClearFlags(@as(*const IVdsVolume, @ptrCast(self)), ulFlags);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const IID_IVdsVolume2_Value = Guid.initString("72ae6713-dcbb-4a03-b36b-371f6ac6b53d");
pub const IID_IVdsVolume2 = &IID_IVdsVolume2_Value;
pub const IVdsVolume2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolume2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolume2_GetProperties2(self: *const T, pVolumeProperties: ?*VDS_VOLUME_PROP2) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolume2.VTable, @ptrCast(self.vtable)).GetProperties2(@as(*const IVdsVolume2, @ptrCast(self)), pVolumeProperties);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolumeOnline_Value = Guid.initString("1be2275a-b315-4f70-9e44-879b3a2a53f2");
pub const IID_IVdsVolumeOnline = &IID_IVdsVolumeOnline_Value;
pub const IVdsVolumeOnline = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Online: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeOnline,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeOnline,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeOnline_Online(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeOnline.VTable, @ptrCast(self.vtable)).Online(@as(*const IVdsVolumeOnline, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolumePlex_Value = Guid.initString("4daa0135-e1d1-40f1-aaa5-3cc1e53221c3");
pub const IID_IVdsVolumePlex = &IID_IVdsVolumePlex_Value;
pub const IVdsVolumePlex = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumePlex,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumePlex_GetProperties(self: *const T, pPlexProperties: ?*VDS_VOLUME_PLEX_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumePlex.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsVolumePlex, @ptrCast(self)), pPlexProperties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumePlex_GetVolume(self: *const T, ppVolume: ?*?*IVdsVolume) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumePlex.VTable, @ptrCast(self.vtable)).GetVolume(@as(*const IVdsVolumePlex, @ptrCast(self)), ppVolume);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumePlex_QueryExtents(self: *const T, ppExtentArray: [*]?*VDS_DISK_EXTENT, plNumberOfExtents: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumePlex.VTable, @ptrCast(self.vtable)).QueryExtents(@as(*const IVdsVolumePlex, @ptrCast(self)), ppExtentArray, plNumberOfExtents);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumePlex_Repair(self: *const T, pInputDiskArray: [*]VDS_INPUT_DISK, lNumberOfDisks: i32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumePlex.VTable, @ptrCast(self.vtable)).Repair(@as(*const IVdsVolumePlex, @ptrCast(self)), pInputDiskArray, lNumberOfDisks, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsDisk3_Value = Guid.initString("8f4b2f5d-ec15-4357-992f-473ef10975b9");
pub const IID_IVdsDisk3 = &IID_IVdsDisk3_Value;
pub const IVdsDisk3 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDisk3,
        ...
        QueryFreeExtents: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDisk3,
                ulAlign: u32,
                ppFreeExtentArray: [*]?*VDS_DISK_FREE_EXTENT,
                plNumberOfFreeExtents: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsDisk3,
                ulAlign: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk3_GetProperties2(self: *const T, pDiskProperties: ?*VDS_DISK_PROP2) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk3.VTable, @ptrCast(self.vtable)).GetProperties2(@as(*const IVdsDisk3, @ptrCast(self)), pDiskProperties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDisk3_QueryFreeExtents(self: *const T, ulAlign: u32, ppFreeExtentArray: [*]?*VDS_DISK_FREE_EXTENT, plNumberOfFreeExtents: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsDisk3.VTable, @ptrCast(self.vtable)).QueryFreeExtents(@as(*const IVdsDisk3, @ptrCast(self)), ulAlign, ppFreeExtentArray, plNumberOfFreeExtents);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsVdProvider_Value = Guid.initString("b481498c-8354-45f9-84a0-0bdd2832a91f");
pub const IID_IVdsVdProvider = &IID_IVdsVdProvider_Value;
pub const IVdsVdProvider = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryVDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVdProvider,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVdProvider,
        ...
        CreateVDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVdProvider,
        ...
        AddVDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVdProvider,
                VirtualDeviceType: ?*VIRTUAL_STORAGE_TYPE,
                pPath: ?PWSTR,
        ...
        GetDiskFromVDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVdProvider,
                pVDisk: ?*IVdsVDisk,
                ppDisk: ?*?*IVdsDisk,
        ...
        GetVDiskFromDisk: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVdProvider,
                pDisk: ?*IVdsDisk,
                ppVDisk: ?*?*IVdsVDisk,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVdProvider_QueryVDisks(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsVdProvider.VTable, @ptrCast(self.vtable)).QueryVDisks(@as(*const IVdsVdProvider, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVdProvider_CreateVDisk(self: *const T, VirtualDeviceType: ?*VIRTUAL_STORAGE_TYPE, pPath: ?PWSTR, pStringSecurityDescriptor: ?PWSTR, Flags: CREATE_VIRTUAL_DISK_FLAG, ProviderSpecificFlags: u32, Reserved: u32, pCreateDiskParameters: ?*VDS_CREATE_VDISK_PARAMETERS, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVdProvider.VTable, @ptrCast(self.vtable)).CreateVDisk(@as(*const IVdsVdProvider, @ptrCast(self)), VirtualDeviceType, pPath, pStringSecurityDescriptor, Flags, ProviderSpecificFlags, Reserved, pCreateDiskParameters, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVdProvider_AddVDisk(self: *const T, VirtualDeviceType: ?*VIRTUAL_STORAGE_TYPE, pPath: ?PWSTR, ppVDisk: ?*?*IVdsVDisk) callconv(.Inline) HRESULT {
            return @as(*const IVdsVdProvider.VTable, @ptrCast(self.vtable)).AddVDisk(@as(*const IVdsVdProvider, @ptrCast(self)), VirtualDeviceType, pPath, ppVDisk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVdProvider_GetDiskFromVDisk(self: *const T, pVDisk: ?*IVdsVDisk, ppDisk: ?*?*IVdsDisk) callconv(.Inline) HRESULT {
            return @as(*const IVdsVdProvider.VTable, @ptrCast(self.vtable)).GetDiskFromVDisk(@as(*const IVdsVdProvider, @ptrCast(self)), pVDisk, ppDisk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVdProvider_GetVDiskFromDisk(self: *const T, pDisk: ?*IVdsDisk, ppVDisk: ?*?*IVdsVDisk) callconv(.Inline) HRESULT {
            return @as(*const IVdsVdProvider.VTable, @ptrCast(self.vtable)).GetVDiskFromDisk(@as(*const IVdsVdProvider, @ptrCast(self)), pDisk, ppVDisk);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const VDS_VDISK_STATE = enum(i32) {
    UNKNOWN = 0,
    ADDED = 1,
    OPEN = 2,
    ATTACH_PENDING = 3,
...
pub const VDS_VST_UNKNOWN = VDS_VDISK_STATE.UNKNOWN;
pub const VDS_VST_ADDED = VDS_VDISK_STATE.ADDED;
pub const VDS_VST_OPEN = VDS_VDISK_STATE.OPEN;
pub const VDS_VST_ATTACH_PENDING = VDS_VDISK_STATE.ATTACH_PENDING;
pub const VDS_VST_ATTACHED_NOT_OPEN = VDS_VDISK_STATE.ATTACHED_NOT_OPEN;
pub const VDS_VST_ATTACHED = VDS_VDISK_STATE.ATTACHED;
pub const VDS_VST_DETACH_PENDING = VDS_VDISK_STATE.DETACH_PENDING;
pub const VDS_VST_COMPACTING = VDS_VDISK_STATE.COMPACTING;
pub const VDS_VST_MERGING = VDS_VDISK_STATE.MERGING;
pub const VDS_VST_EXPANDING = VDS_VDISK_STATE.EXPANDING;
pub const VDS_VST_DELETED = VDS_VDISK_STATE.DELETED;
pub const VDS_VST_MAX = VDS_VDISK_STATE.MAX;
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsVDisk_Value = Guid.initString("1e062b84-e5e6-4b4b-8a25-67b81e8f13e8");
pub const IID_IVdsVDisk = &IID_IVdsVDisk_Value;
pub const IVdsVDisk = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Open: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVDisk,
                AccessMask: VIRTUAL_DISK_ACCESS_MASK,
                Flags: OPEN_VIRTUAL_DISK_FLAG,
                ReadWriteDepth: u32,
                ppOpenVDisk: ?*?*IVdsOpenVDisk,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVDisk,
                AccessMask: VIRTUAL_DISK_ACCESS_MASK,
        ...
        GetHostVolume: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVDisk,
                ppVolume: ?*?*IVdsVolume,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVDisk_Open(self: *const T, AccessMask: VIRTUAL_DISK_ACCESS_MASK, Flags: OPEN_VIRTUAL_DISK_FLAG, ReadWriteDepth: u32, ppOpenVDisk: ?*?*IVdsOpenVDisk) callconv(.Inline) HRESULT {
            return @as(*const IVdsVDisk.VTable, @ptrCast(self.vtable)).Open(@as(*const IVdsVDisk, @ptrCast(self)), AccessMask, Flags, ReadWriteDepth, ppOpenVDisk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVDisk_GetProperties(self: *const T, pDiskProperties: ?*VDS_VDISK_PROPERTIES) callconv(.Inline) HRESULT {
            return @as(*const IVdsVDisk.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsVDisk, @ptrCast(self)), pDiskProperties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVDisk_GetHostVolume(self: *const T, ppVolume: ?*?*IVdsVolume) callconv(.Inline) HRESULT {
            return @as(*const IVdsVDisk.VTable, @ptrCast(self.vtable)).GetHostVolume(@as(*const IVdsVDisk, @ptrCast(self)), ppVolume);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVDisk_GetDeviceName(self: *const T, ppDeviceName: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsVDisk.VTable, @ptrCast(self.vtable)).GetDeviceName(@as(*const IVdsVDisk, @ptrCast(self)), ppDeviceName);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsOpenVDisk_Value = Guid.initString("75c8f324-f715-4fe3-a28e-f9011b61a4a1");
pub const IID_IVdsOpenVDisk = &IID_IVdsOpenVDisk_Value;
pub const IVdsOpenVDisk = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Attach: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsOpenVDisk,
                pStringSecurityDescriptor: ?PWSTR,
        ...
        DetachAndDelete: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsOpenVDisk,
                Flags: DETACH_VIRTUAL_DISK_FLAG,
                ProviderSpecificFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_Attach(self: *const T, pStringSecurityDescriptor: ?PWSTR, Flags: ATTACH_VIRTUAL_DISK_FLAG, ProviderSpecificFlags: u32, TimeoutInMs: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).Attach(@as(*const IVdsOpenVDisk, @ptrCast(self)), pStringSecurityDescriptor, Flags, ProviderSpecificFlags, TimeoutInMs, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_Detach(self: *const T, Flags: DETACH_VIRTUAL_DISK_FLAG, ProviderSpecificFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).Detach(@as(*const IVdsOpenVDisk, @ptrCast(self)), Flags, ProviderSpecificFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_DetachAndDelete(self: *const T, Flags: DETACH_VIRTUAL_DISK_FLAG, ProviderSpecificFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).DetachAndDelete(@as(*const IVdsOpenVDisk, @ptrCast(self)), Flags, ProviderSpecificFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_Compact(self: *const T, Flags: COMPACT_VIRTUAL_DISK_FLAG, Reserved: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).Compact(@as(*const IVdsOpenVDisk, @ptrCast(self)), Flags, Reserved, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_Merge(self: *const T, Flags: MERGE_VIRTUAL_DISK_FLAG, MergeDepth: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).Merge(@as(*const IVdsOpenVDisk, @ptrCast(self)), Flags, MergeDepth, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsOpenVDisk_Expand(self: *const T, Flags: EXPAND_VIRTUAL_DISK_FLAG, NewSize: u64, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsOpenVDisk.VTable, @ptrCast(self.vtable)).Expand(@as(*const IVdsOpenVDisk, @ptrCast(self)), Flags, NewSize, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const VDS_SERVICE_FLAG = enum(i32) {
    SUPPORT_DYNAMIC = 1,
    SUPPORT_FAULT_TOLERANT = 2,
    SUPPORT_GPT = 4,
    SUPPORT_DYNAMIC_1394 = 8,
    CLUSTER_SERVICE_CONFIGURED = 16,
    AUTO_MOUNT_OFF = 32,
    OS_UNINSTALL_VALID = 64,
    EFI = 128,
    SUPPORT_MIRROR = 256,
    SUPPORT_RAID5 = 512,
    SUPPORT_REFS = 1024,
};
pub const VDS_SVF_SUPPORT_DYNAMIC = VDS_SERVICE_FLAG.SUPPORT_DYNAMIC;
pub const VDS_SVF_SUPPORT_FAULT_TOLERANT = VDS_SERVICE_FLAG.SUPPORT_FAULT_TOLERANT;
pub const VDS_SVF_SUPPORT_GPT = VDS_SERVICE_FLAG.SUPPORT_GPT;
pub const VDS_SVF_SUPPORT_DYNAMIC_1394 = VDS_SERVICE_FLAG.SUPPORT_DYNAMIC_1394;
pub const VDS_SVF_CLUSTER_SERVICE_CONFIGURED = VDS_SERVICE_FLAG.CLUSTER_SERVICE_CONFIGURED;
pub const VDS_SVF_AUTO_MOUNT_OFF = VDS_SERVICE_FLAG.AUTO_MOUNT_OFF;
pub const VDS_SVF_OS_UNINSTALL_VALID = VDS_SERVICE_FLAG.OS_UNINSTALL_VALID;
pub const VDS_SVF_EFI = VDS_SERVICE_FLAG.EFI;
pub const VDS_SVF_SUPPORT_MIRROR = VDS_SERVICE_FLAG.SUPPORT_MIRROR;
pub const VDS_SVF_SUPPORT_RAID5 = VDS_SERVICE_FLAG.SUPPORT_RAID5;
pub const VDS_SVF_SUPPORT_REFS = VDS_SERVICE_FLAG.SUPPORT_REFS;
...
pub const VDS_SAN_POLICY = enum(i32) {
    UNKNOWN = 0,
    ONLINE = 1,
    OFFLINE_SHARED = 2,
    OFFLINE = 3,
...
pub const VDS_SP_UNKNOWN = VDS_SAN_POLICY.UNKNOWN;
pub const VDS_SP_ONLINE = VDS_SAN_POLICY.ONLINE;
pub const VDS_SP_OFFLINE_SHARED = VDS_SAN_POLICY.OFFLINE_SHARED;
pub const VDS_SP_OFFLINE = VDS_SAN_POLICY.OFFLINE;
pub const VDS_SP_OFFLINE_INTERNAL = VDS_SAN_POLICY.OFFLINE_INTERNAL;
pub const VDS_SP_MAX = VDS_SAN_POLICY.MAX;
...
pub const VDS_DRIVE_LETTER_FLAG = enum(i32) {
    T = 1,
};
pub const VDS_DLF_NON_PERSISTENT = VDS_DRIVE_LETTER_FLAG.T;
...
pub const VDS_FILE_SYSTEM_FLAG = enum(i32) {
    SUPPORT_FORMAT = 1,
    SUPPORT_QUICK_FORMAT = 2,
    SUPPORT_COMPRESS = 4,
    SUPPORT_SPECIFY_LABEL = 8,
    SUPPORT_MOUNT_POINT = 16,
    SUPPORT_REMOVABLE_MEDIA = 32,
    SUPPORT_EXTEND = 64,
    ALLOCATION_UNIT_512 = 65536,
    ALLOCATION_UNIT_1K = 131072,
    ALLOCATION_UNIT_2K = 262144,
    ALLOCATION_UNIT_4K = 524288,
    ALLOCATION_UNIT_8K = 1048576,
    ALLOCATION_UNIT_16K = 2097152,
    ALLOCATION_UNIT_32K = 4194304,
    ALLOCATION_UNIT_64K = 8388608,
    ALLOCATION_UNIT_128K = 16777216,
    ALLOCATION_UNIT_256K = 33554432,
};
pub const VDS_FSF_SUPPORT_FORMAT = VDS_FILE_SYSTEM_FLAG.SUPPORT_FORMAT;
pub const VDS_FSF_SUPPORT_QUICK_FORMAT = VDS_FILE_SYSTEM_FLAG.SUPPORT_QUICK_FORMAT;
pub const VDS_FSF_SUPPORT_COMPRESS = VDS_FILE_SYSTEM_FLAG.SUPPORT_COMPRESS;
pub const VDS_FSF_SUPPORT_SPECIFY_LABEL = VDS_FILE_SYSTEM_FLAG.SUPPORT_SPECIFY_LABEL;
pub const VDS_FSF_SUPPORT_MOUNT_POINT = VDS_FILE_SYSTEM_FLAG.SUPPORT_MOUNT_POINT;
pub const VDS_FSF_SUPPORT_REMOVABLE_MEDIA = VDS_FILE_SYSTEM_FLAG.SUPPORT_REMOVABLE_MEDIA;
pub const VDS_FSF_SUPPORT_EXTEND = VDS_FILE_SYSTEM_FLAG.SUPPORT_EXTEND;
pub const VDS_FSF_ALLOCATION_UNIT_512 = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_512;
pub const VDS_FSF_ALLOCATION_UNIT_1K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_1K;
pub const VDS_FSF_ALLOCATION_UNIT_2K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_2K;
pub const VDS_FSF_ALLOCATION_UNIT_4K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_4K;
pub const VDS_FSF_ALLOCATION_UNIT_8K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_8K;
pub const VDS_FSF_ALLOCATION_UNIT_16K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_16K;
pub const VDS_FSF_ALLOCATION_UNIT_32K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_32K;
pub const VDS_FSF_ALLOCATION_UNIT_64K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_64K;
pub const VDS_FSF_ALLOCATION_UNIT_128K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_128K;
pub const VDS_FSF_ALLOCATION_UNIT_256K = VDS_FILE_SYSTEM_FLAG.ALLOCATION_UNIT_256K;
...
pub const VDS_FILE_SYSTEM_FORMAT_SUPPORT_FLAG = enum(i32) {
    DEFAULT = 1,
    PREVIOUS_REVISION = 2,
    RECOMMENDED = 4,
};
pub const VDS_FSS_DEFAULT = VDS_FILE_SYSTEM_FORMAT_SUPPORT_FLAG.DEFAULT;
pub const VDS_FSS_PREVIOUS_REVISION = VDS_FILE_SYSTEM_FORMAT_SUPPORT_FLAG.PREVIOUS_REVISION;
pub const VDS_FSS_RECOMMENDED = VDS_FILE_SYSTEM_FORMAT_SUPPORT_FLAG.RECOMMENDED;
...
pub const VDS_FILE_SYSTEM_PROP_FLAG = enum(i32) {
    D = 1,
};
pub const VDS_FPF_COMPRESSED = VDS_FILE_SYSTEM_PROP_FLAG.D;

pub const VDS_FORMAT_OPTION_FLAGS = enum(i32) {
    NONE = 0,
    FORCE = 1,
    QUICK = 2,
    COMPRESSION = 4,
    DUPLICATE_METADATA = 8,
};
pub const VDS_FSOF_NONE = VDS_FORMAT_OPTION_FLAGS.NONE;
pub const VDS_FSOF_FORCE = VDS_FORMAT_OPTION_FLAGS.FORCE;
pub const VDS_FSOF_QUICK = VDS_FORMAT_OPTION_FLAGS.QUICK;
pub const VDS_FSOF_COMPRESSION = VDS_FORMAT_OPTION_FLAGS.COMPRESSION;
pub const VDS_FSOF_DUPLICATE_METADATA = VDS_FORMAT_OPTION_FLAGS.DUPLICATE_METADATA;
...
pub const VDS_QUERY_PROVIDER_FLAG = enum(i32) {
    SOFTWARE_PROVIDERS = 1,
    HARDWARE_PROVIDERS = 2,
    VIRTUALDISK_PROVIDERS = 4,
};
pub const VDS_QUERY_SOFTWARE_PROVIDERS = VDS_QUERY_PROVIDER_FLAG.SOFTWARE_PROVIDERS;
pub const VDS_QUERY_HARDWARE_PROVIDERS = VDS_QUERY_PROVIDER_FLAG.HARDWARE_PROVIDERS;
pub const VDS_QUERY_VIRTUALDISK_PROVIDERS = VDS_QUERY_PROVIDER_FLAG.VIRTUALDISK_PROVIDERS;

// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsServiceLoader_Value = Guid.initString("e0393303-90d4-4a97-ab71-e9b671ee2729");
pub const IID_IVdsServiceLoader = &IID_IVdsServiceLoader_Value;
pub const IVdsServiceLoader = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        LoadService: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceLoader,
                pwszMachineName: ?PWSTR,
                ppService: ?*?*IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceLoader,
                pwszMachineName: ?PWSTR,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceLoader_LoadService(self: *const T, pwszMachineName: ?PWSTR, ppService: ?*?*IVdsService) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceLoader.VTable, @ptrCast(self.vtable)).LoadService(@as(*const IVdsServiceLoader, @ptrCast(self)), pwszMachineName, ppService);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsService_Value = Guid.initString("0818a8ef-9ba9-40d8-a6f9-e22833cc771e");
pub const IID_IVdsService = &IID_IVdsService_Value;
pub const IVdsService = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        IsServiceReady: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        },
        WaitForServiceReady: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        QueryMaskedDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        QueryUnallocatedDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        QueryDriveLetters: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
                wcFirstLetter: u16,
                count: u32,
        ...
        QueryFileSystemTypes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
                ppFileSystemTypeProps: [*]?*VDS_FILE_SYSTEM_TYPE_PROP,
                plNumberOfFileSystems: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsService,
                ppFileSystemTypeProps: [*]?*VDS_FILE_SYSTEM_TYPE_PROP,
        ...
        CleanupObsoleteMountPoints: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        Reboot: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsService,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_IsServiceReady(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).IsServiceReady(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_WaitForServiceReady(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).WaitForServiceReady(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_GetProperties(self: *const T, pServiceProp: ?*VDS_SERVICE_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsService, @ptrCast(self)), pServiceProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_QueryProviders(self: *const T, masks: u32, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).QueryProviders(@as(*const IVdsService, @ptrCast(self)), masks, ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_QueryMaskedDisks(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).QueryMaskedDisks(@as(*const IVdsService, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_QueryUnallocatedDisks(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).QueryUnallocatedDisks(@as(*const IVdsService, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_GetObject(self: *const T, ObjectId: Guid, type_: VDS_OBJECT_TYPE, ppObjectUnk: ?*?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).GetObject(@as(*const IVdsService, @ptrCast(self)), ObjectId, type_, ppObjectUnk);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_QueryDriveLetters(self: *const T, wcFirstLetter: u16, count: u32, pDriveLetterPropArray: [*]VDS_DRIVE_LETTER_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).QueryDriveLetters(@as(*const IVdsService, @ptrCast(self)), wcFirstLetter, count, pDriveLetterPropArray);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_QueryFileSystemTypes(self: *const T, ppFileSystemTypeProps: [*]?*VDS_FILE_SYSTEM_TYPE_PROP, plNumberOfFileSystems: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).QueryFileSystemTypes(@as(*const IVdsService, @ptrCast(self)), ppFileSystemTypeProps, plNumberOfFileSystems);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_Reenumerate(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).Reenumerate(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_Refresh(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).Refresh(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_CleanupObsoleteMountPoints(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).CleanupObsoleteMountPoints(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_Advise(self: *const T, pSink: ?*IVdsAdviseSink, pdwCookie: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).Advise(@as(*const IVdsService, @ptrCast(self)), pSink, pdwCookie);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_Unadvise(self: *const T, dwCookie: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).Unadvise(@as(*const IVdsService, @ptrCast(self)), dwCookie);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_Reboot(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).Reboot(@as(*const IVdsService, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_SetFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).SetFlags(@as(*const IVdsService, @ptrCast(self)), ulFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsService_ClearFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsService.VTable, @ptrCast(self.vtable)).ClearFlags(@as(*const IVdsService, @ptrCast(self)), ulFlags);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsServiceUninstallDisk_Value = Guid.initString("b6b22da8-f903-4be7-b492-c09d875ac9da");
pub const IID_IVdsServiceUninstallDisk = &IID_IVdsServiceUninstallDisk_Value;
pub const IVdsServiceUninstallDisk = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetDiskIdFromLunInfo: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceUninstallDisk,
                pLunInfo: ?*VDS_LUN_INFORMATION,
                pDiskId: ?*Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        UninstallDisks: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceUninstallDisk,
                pDiskIdArray: [*]Guid,
                ulCount: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceUninstallDisk_GetDiskIdFromLunInfo(self: *const T, pLunInfo: ?*VDS_LUN_INFORMATION, pDiskId: ?*Guid) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceUninstallDisk.VTable, @ptrCast(self.vtable)).GetDiskIdFromLunInfo(@as(*const IVdsServiceUninstallDisk, @ptrCast(self)), pLunInfo, pDiskId);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceUninstallDisk_UninstallDisks(self: *const T, pDiskIdArray: [*]Guid, ulCount: u32, bForce: BOOLEAN, pbReboot: ?*u8, pResults: [*]HRESULT) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceUninstallDisk.VTable, @ptrCast(self.vtable)).UninstallDisks(@as(*const IVdsServiceUninstallDisk, @ptrCast(self)), pDiskIdArray, ulCount, bForce, pbReboot, pResults);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsServiceHba_Value = Guid.initString("0ac13689-3134-47c6-a17c-4669216801be");
pub const IID_IVdsServiceHba = &IID_IVdsServiceHba_Value;
pub const IVdsServiceHba = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryHbaPorts: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceHba,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceHba,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceHba_QueryHbaPorts(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceHba.VTable, @ptrCast(self.vtable)).QueryHbaPorts(@as(*const IVdsServiceHba, @ptrCast(self)), ppEnum);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsServiceIscsi_Value = Guid.initString("14fbe036-3ed7-4e10-90e9-a5ff991aff01");
pub const IID_IVdsServiceIscsi = &IID_IVdsServiceIscsi_Value;
pub const IVdsServiceIscsi = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetInitiatorName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                ppwszIscsiName: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceIscsi,
                ppwszIscsiName: ?*?PWSTR,
        ...
        QueryInitiatorAdapters: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        SetAllIpsecTunnelAddresses: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                pTunnelAddress: ?*VDS_IPADDRESS,
                pDestinationAddress: ?*VDS_IPADDRESS,
        ...
        SetAllIpsecSecurity: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                targetPortalId: Guid,
                ullSecurityFlags: u64,
        ...
        SetInitiatorSharedSecret: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                pInitiatorSharedSecret: ?*VDS_ISCSI_SHARED_SECRET,
                targetId: Guid,
        ...
        RememberTargetSharedSecret: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceIscsi,
                targetId: Guid,
                pTargetSharedSecret: ?*VDS_ISCSI_SHARED_SECRET,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_GetInitiatorName(self: *const T, ppwszIscsiName: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).GetInitiatorName(@as(*const IVdsServiceIscsi, @ptrCast(self)), ppwszIscsiName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_QueryInitiatorAdapters(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).QueryInitiatorAdapters(@as(*const IVdsServiceIscsi, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_SetIpsecGroupPresharedKey(self: *const T, pIpsecKey: ?*VDS_ISCSI_IPSEC_KEY) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).SetIpsecGroupPresharedKey(@as(*const IVdsServiceIscsi, @ptrCast(self)), pIpsecKey);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_SetAllIpsecTunnelAddresses(self: *const T, pTunnelAddress: ?*VDS_IPADDRESS, pDestinationAddress: ?*VDS_IPADDRESS) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).SetAllIpsecTunnelAddresses(@as(*const IVdsServiceIscsi, @ptrCast(self)), pTunnelAddress, pDestinationAddress);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_SetAllIpsecSecurity(self: *const T, targetPortalId: Guid, ullSecurityFlags: u64, pIpsecKey: ?*VDS_ISCSI_IPSEC_KEY) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).SetAllIpsecSecurity(@as(*const IVdsServiceIscsi, @ptrCast(self)), targetPortalId, ullSecurityFlags, pIpsecKey);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_SetInitiatorSharedSecret(self: *const T, pInitiatorSharedSecret: ?*VDS_ISCSI_SHARED_SECRET, targetId: Guid) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).SetInitiatorSharedSecret(@as(*const IVdsServiceIscsi, @ptrCast(self)), pInitiatorSharedSecret, targetId);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceIscsi_RememberTargetSharedSecret(self: *const T, targetId: Guid, pTargetSharedSecret: ?*VDS_ISCSI_SHARED_SECRET) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceIscsi.VTable, @ptrCast(self.vtable)).RememberTargetSharedSecret(@as(*const IVdsServiceIscsi, @ptrCast(self)), targetId, pTargetSharedSecret);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IVdsServiceInitialization_Value = Guid.initString("4afc3636-db01-4052-80c3-03bbcb8d3c69");
pub const IID_IVdsServiceInitialization = &IID_IVdsServiceInitialization_Value;
pub const IVdsServiceInitialization = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceInitialization,
                pwszMachineName: ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceInitialization,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceInitialization_Initialize(self: *const T, pwszMachineName: ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceInitialization.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IVdsServiceInitialization, @ptrCast(self)), pwszMachineName);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsHbaPort_Value = Guid.initString("2abd757f-2851-4997-9a13-47d2a885d6ca");
pub const IID_IVdsHbaPort = &IID_IVdsHbaPort_Value;
pub const IVdsHbaPort = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsHbaPort,
                pHbaPortProp: ?*VDS_HBAPORT_PROP,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsHbaPort,
        ...
        SetAllPathStatuses: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsHbaPort,
                status: VDS_PATH_STATUS,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsHbaPort_GetProperties(self: *const T, pHbaPortProp: ?*VDS_HBAPORT_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsHbaPort.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsHbaPort, @ptrCast(self)), pHbaPortProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsHbaPort_SetAllPathStatuses(self: *const T, status: VDS_PATH_STATUS) callconv(.Inline) HRESULT {
            return @as(*const IVdsHbaPort.VTable, @ptrCast(self.vtable)).SetAllPathStatuses(@as(*const IVdsHbaPort, @ptrCast(self)), status);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsIscsiInitiatorAdapter_Value = Guid.initString("b07fedd4-1682-4440-9189-a39b55194dc5");
pub const IID_IVdsIscsiInitiatorAdapter = &IID_IVdsIscsiInitiatorAdapter_Value;
pub const IVdsIscsiInitiatorAdapter = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorAdapter,
        ...
        QueryInitiatorPortals: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorAdapter,
                ppEnum: ?*?*IEnumVdsObject,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        LoginToTarget: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorAdapter,
        ...
        LogoutFromTarget: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorAdapter,
                targetId: Guid,
                ppAsync: ?*?*IVdsAsync,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorAdapter_GetProperties(self: *const T, pInitiatorAdapterProp: ?*VDS_ISCSI_INITIATOR_ADAPTER_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorAdapter.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsIscsiInitiatorAdapter, @ptrCast(self)), pInitiatorAdapterProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorAdapter_QueryInitiatorPortals(self: *const T, ppEnum: ?*?*IEnumVdsObject) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorAdapter.VTable, @ptrCast(self.vtable)).QueryInitiatorPortals(@as(*const IVdsIscsiInitiatorAdapter, @ptrCast(self)), ppEnum);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorAdapter_LoginToTarget(self: *const T, loginType: VDS_ISCSI_LOGIN_TYPE, targetId: Guid, targetPortalId: Guid, initiatorPortalId: Guid, ulLoginFlags: u32, bHeaderDigest: BOOL, bDataDigest: BOOL, authType: VDS_ISCSI_AUTH_TYPE, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorAdapter.VTable, @ptrCast(self.vtable)).LoginToTarget(@as(*const IVdsIscsiInitiatorAdapter, @ptrCast(self)), loginType, targetId, targetPortalId, initiatorPortalId, ulLoginFlags, bHeaderDigest, bDataDigest, authType, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorAdapter_LogoutFromTarget(self: *const T, targetId: Guid, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorAdapter.VTable, @ptrCast(self.vtable)).LogoutFromTarget(@as(*const IVdsIscsiInitiatorAdapter, @ptrCast(self)), targetId, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsIscsiInitiatorPortal_Value = Guid.initString("38a0a9ab-7cc8-4693-ac07-1f28bd03c3da");
pub const IID_IVdsIscsiInitiatorPortal = &IID_IVdsIscsiInitiatorPortal_Value;
pub const IVdsIscsiInitiatorPortal = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorPortal,
        ...
        GetInitiatorAdapter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiInitiatorPortal,
                ppInitiatorAdapter: ?*?*IVdsIscsiInitiatorAdapter,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsIscsiInitiatorPortal,
                ppInitiatorAdapter: ?*?*IVdsIscsiInitiatorAdapter,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorPortal_GetProperties(self: *const T, pInitiatorPortalProp: ?*VDS_ISCSI_INITIATOR_PORTAL_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorPortal.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsIscsiInitiatorPortal, @ptrCast(self)), pInitiatorPortalProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorPortal_GetInitiatorAdapter(self: *const T, ppInitiatorAdapter: ?*?*IVdsIscsiInitiatorAdapter) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorPortal.VTable, @ptrCast(self.vtable)).GetInitiatorAdapter(@as(*const IVdsIscsiInitiatorPortal, @ptrCast(self)), ppInitiatorAdapter);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorPortal_SetIpsecTunnelAddress(self: *const T, pTunnelAddress: ?*VDS_IPADDRESS, pDestinationAddress: ?*VDS_IPADDRESS) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorPortal.VTable, @ptrCast(self.vtable)).SetIpsecTunnelAddress(@as(*const IVdsIscsiInitiatorPortal, @ptrCast(self)), pTunnelAddress, pDestinationAddress);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorPortal_GetIpsecSecurity(self: *const T, targetPortalId: Guid, pullSecurityFlags: ?*u64) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorPortal.VTable, @ptrCast(self.vtable)).GetIpsecSecurity(@as(*const IVdsIscsiInitiatorPortal, @ptrCast(self)), targetPortalId, pullSecurityFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiInitiatorPortal_SetIpsecSecurity(self: *const T, targetPortalId: Guid, ullSecurityFlags: u64, pIpsecKey: ?*VDS_ISCSI_IPSEC_KEY) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiInitiatorPortal.VTable, @ptrCast(self.vtable)).SetIpsecSecurity(@as(*const IVdsIscsiInitiatorPortal, @ptrCast(self)), targetPortalId, ullSecurityFlags, pIpsecKey);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsDiskPartitionMF_Value = Guid.initString("538684e0-ba3d-4bc0-aca9-164aff85c2a9");
pub const IID_IVdsDiskPartitionMF = &IID_IVdsDiskPartitionMF_Value;
pub const IVdsDiskPartitionMF = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetPartitionFileSystemProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskPartitionMF,
                ullOffset: u64,
        ...
        GetPartitionFileSystemTypeName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskPartitionMF,
                ullOffset: u64,
                ppwszFileSystemTypeName: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsDiskPartitionMF,
                ullOffset: u64,
        ...
        QueryPartitionFileSystemFormatSupport: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskPartitionMF,
                ullOffset: u64,
                ppFileSystemSupportProps: [*]?*VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP,
                plNumberOfFileSystems: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsDiskPartitionMF,
        ...
        FormatPartitionEx: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskPartitionMF,
                ullOffset: u64,
                pwszFileSystemTypeName: ?PWSTR,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskPartitionMF_GetPartitionFileSystemProperties(self: *const T, ullOffset: u64, pFileSystemProp: ?*VDS_FILE_SYSTEM_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskPartitionMF.VTable, @ptrCast(self.vtable)).GetPartitionFileSystemProperties(@as(*const IVdsDiskPartitionMF, @ptrCast(self)), ullOffset, pFileSystemProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskPartitionMF_GetPartitionFileSystemTypeName(self: *const T, ullOffset: u64, ppwszFileSystemTypeName: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskPartitionMF.VTable, @ptrCast(self.vtable)).GetPartitionFileSystemTypeName(@as(*const IVdsDiskPartitionMF, @ptrCast(self)), ullOffset, ppwszFileSystemTypeName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskPartitionMF_QueryPartitionFileSystemFormatSupport(self: *const T, ullOffset: u64, ppFileSystemSupportProps: [*]?*VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plNumberOfFileSystems: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskPartitionMF.VTable, @ptrCast(self.vtable)).QueryPartitionFileSystemFormatSupport(@as(*const IVdsDiskPartitionMF, @ptrCast(self)), ullOffset, ppFileSystemSupportProps, plNumberOfFileSystems);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskPartitionMF_FormatPartitionEx(self: *const T, ullOffset: u64, pwszFileSystemTypeName: ?PWSTR, usFileSystemRevision: u16, ulDesiredUnitAllocationSize: u32, pwszLabel: ?PWSTR, bForce: BOOL, bQuickFormat: BOOL, bEnableCompression: BOOL, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskPartitionMF.VTable, @ptrCast(self.vtable)).FormatPartitionEx(@as(*const IVdsDiskPartitionMF, @ptrCast(self)), ullOffset, pwszFileSystemTypeName, usFileSystemRevision, ulDesiredUnitAllocationSize, pwszLabel, bForce, bQuickFormat, bEnableCompression, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolumeMF_Value = Guid.initString("ee2d5ded-6236-4169-931d-b9778ce03dc6");
pub const IID_IVdsVolumeMF = &IID_IVdsVolumeMF_Value;
pub const IVdsVolumeMF = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetFileSystemProperties: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                pFileSystemProp: ?*VDS_FILE_SYSTEM_PROP,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeMF,
        ...
        AddAccessPath: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                pwszPath: ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        QueryAccessPaths: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                pwszPathArray: [*]?*?PWSTR,
                plNumberOfAccessPaths: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeMF,
                pwszPathArray: [*]?*?PWSTR,
        ...
        QueryReparsePoints: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                ppReparsePointProps: [*]?*VDS_REPARSE_POINT_PROP,
                plNumberOfReparsePointProps: ?*i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeMF,
                ppReparsePointProps: [*]?*VDS_REPARSE_POINT_PROP,
        ...
        DeleteAccessPath: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                pwszPath: ?PWSTR,
                bForce: BOOL,
        ...
        Mount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        Dismount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                bForce: BOOL,
                bPermanent: BOOL,
        ...
        SetFileSystemFlags: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                ulFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        ClearFileSystemFlags: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF,
                ulFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_GetFileSystemProperties(self: *const T, pFileSystemProp: ?*VDS_FILE_SYSTEM_PROP) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).GetFileSystemProperties(@as(*const IVdsVolumeMF, @ptrCast(self)), pFileSystemProp);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_Format(self: *const T, type_: VDS_FILE_SYSTEM_TYPE, pwszLabel: ?PWSTR, dwUnitAllocationSize: u32, bForce: BOOL, bQuickFormat: BOOL, bEnableCompression: BOOL, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).Format(@as(*const IVdsVolumeMF, @ptrCast(self)), type_, pwszLabel, dwUnitAllocationSize, bForce, bQuickFormat, bEnableCompression, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_AddAccessPath(self: *const T, pwszPath: ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).AddAccessPath(@as(*const IVdsVolumeMF, @ptrCast(self)), pwszPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_QueryAccessPaths(self: *const T, pwszPathArray: [*]?*?PWSTR, plNumberOfAccessPaths: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).QueryAccessPaths(@as(*const IVdsVolumeMF, @ptrCast(self)), pwszPathArray, plNumberOfAccessPaths);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_QueryReparsePoints(self: *const T, ppReparsePointProps: [*]?*VDS_REPARSE_POINT_PROP, plNumberOfReparsePointProps: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).QueryReparsePoints(@as(*const IVdsVolumeMF, @ptrCast(self)), ppReparsePointProps, plNumberOfReparsePointProps);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_DeleteAccessPath(self: *const T, pwszPath: ?PWSTR, bForce: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).DeleteAccessPath(@as(*const IVdsVolumeMF, @ptrCast(self)), pwszPath, bForce);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_Mount(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).Mount(@as(*const IVdsVolumeMF, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_Dismount(self: *const T, bForce: BOOL, bPermanent: BOOL) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).Dismount(@as(*const IVdsVolumeMF, @ptrCast(self)), bForce, bPermanent);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_SetFileSystemFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).SetFileSystemFlags(@as(*const IVdsVolumeMF, @ptrCast(self)), ulFlags);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF_ClearFileSystemFlags(self: *const T, ulFlags: u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF.VTable, @ptrCast(self.vtable)).ClearFileSystemFlags(@as(*const IVdsVolumeMF, @ptrCast(self)), ulFlags);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolumeMF2_Value = Guid.initString("4dbcee9a-6343-4651-b85f-5e75d74d983c");
pub const IID_IVdsVolumeMF2 = &IID_IVdsVolumeMF2_Value;
pub const IVdsVolumeMF2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetFileSystemTypeName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF2,
                ppwszFileSystemTypeName: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeMF2,
        ...
        QueryFileSystemFormatSupport: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF2,
                ppFileSystemSupportProps: [*]?*VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP,
                plNumberOfFileSystems: ?*i32,
        ...
        FormatEx: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF2,
                pwszFileSystemTypeName: ?PWSTR,
                usFileSystemRevision: u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF2_GetFileSystemTypeName(self: *const T, ppwszFileSystemTypeName: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF2.VTable, @ptrCast(self.vtable)).GetFileSystemTypeName(@as(*const IVdsVolumeMF2, @ptrCast(self)), ppwszFileSystemTypeName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF2_QueryFileSystemFormatSupport(self: *const T, ppFileSystemSupportProps: [*]?*VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plNumberOfFileSystems: ?*i32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF2.VTable, @ptrCast(self.vtable)).QueryFileSystemFormatSupport(@as(*const IVdsVolumeMF2, @ptrCast(self)), ppFileSystemSupportProps, plNumberOfFileSystems);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF2_FormatEx(self: *const T, pwszFileSystemTypeName: ?PWSTR, usFileSystemRevision: u16, ulDesiredUnitAllocationSize: u32, pwszLabel: ?PWSTR, bForce: BOOL, bQuickFormat: BOOL, bEnableCompression: BOOL, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF2.VTable, @ptrCast(self.vtable)).FormatEx(@as(*const IVdsVolumeMF2, @ptrCast(self)), pwszFileSystemTypeName, usFileSystemRevision, ulDesiredUnitAllocationSize, pwszLabel, bForce, bQuickFormat, bEnableCompression, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsVolumeShrink_Value = Guid.initString("d68168c9-82a2-4f85-b6e9-74707c49a58f");
pub const IID_IVdsVolumeShrink = &IID_IVdsVolumeShrink_Value;
pub const IVdsVolumeShrink = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryMaxReclaimableBytes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeShrink,
                pullMaxNumberOfReclaimableBytes: ?*u64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeShrink,
                pullMaxNumberOfReclaimableBytes: ?*u64,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeShrink_QueryMaxReclaimableBytes(self: *const T, pullMaxNumberOfReclaimableBytes: ?*u64) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeShrink.VTable, @ptrCast(self.vtable)).QueryMaxReclaimableBytes(@as(*const IVdsVolumeShrink, @ptrCast(self)), pullMaxNumberOfReclaimableBytes);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeShrink_Shrink(self: *const T, ullDesiredNumberOfReclaimableBytes: u64, ullMinNumberOfReclaimableBytes: u64, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeShrink.VTable, @ptrCast(self.vtable)).Shrink(@as(*const IVdsVolumeShrink, @ptrCast(self)), ullDesiredNumberOfReclaimableBytes, ullMinNumberOfReclaimableBytes, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsSubSystemImportTarget_Value = Guid.initString("83bfb87f-43fb-4903-baa6-127f01029eec");
pub const IID_IVdsSubSystemImportTarget = &IID_IVdsSubSystemImportTarget_Value;
pub const IVdsSubSystemImportTarget = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetImportTarget: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsSubSystemImportTarget,
                ppwszIscsiName: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsSubSystemImportTarget,
        ...
        SetImportTarget: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsSubSystemImportTarget,
                pwszIscsiName: ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsSubSystemImportTarget_GetImportTarget(self: *const T, ppwszIscsiName: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsSubSystemImportTarget.VTable, @ptrCast(self.vtable)).GetImportTarget(@as(*const IVdsSubSystemImportTarget, @ptrCast(self)), ppwszIscsiName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsSubSystemImportTarget_SetImportTarget(self: *const T, pwszIscsiName: ?PWSTR) callconv(.Inline) HRESULT {
            return @as(*const IVdsSubSystemImportTarget.VTable, @ptrCast(self.vtable)).SetImportTarget(@as(*const IVdsSubSystemImportTarget, @ptrCast(self)), pwszIscsiName);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsIscsiPortalLocal_Value = Guid.initString("ad837c28-52c1-421d-bf04-fae7da665396");
pub const IID_IVdsIscsiPortalLocal = &IID_IVdsIscsiPortalLocal_Value;
pub const IVdsIscsiPortalLocal = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        SetIpsecSecurityLocal: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsIscsiPortalLocal,
                ullSecurityFlags: u64,
                pIpsecKey: ?*VDS_ISCSI_IPSEC_KEY,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsIscsiPortalLocal_SetIpsecSecurityLocal(self: *const T, ullSecurityFlags: u64, pIpsecKey: ?*VDS_ISCSI_IPSEC_KEY) callconv(.Inline) HRESULT {
            return @as(*const IVdsIscsiPortalLocal.VTable, @ptrCast(self.vtable)).SetIpsecSecurityLocal(@as(*const IVdsIscsiPortalLocal, @ptrCast(self)), ullSecurityFlags, pIpsecKey);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
const IID_IVdsServiceSAN_Value = Guid.initString("fc5d23e8-a88b-41a5-8de0-2d2f73c5a630");
pub const IID_IVdsServiceSAN = &IID_IVdsServiceSAN_Value;
pub const IVdsServiceSAN = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetSANPolicy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceSAN,
                pSanPolicy: ?*VDS_SAN_POLICY,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceSAN,
                pSanPolicy: ?*VDS_SAN_POLICY,
        ...
        SetSANPolicy: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceSAN,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceSAN_GetSANPolicy(self: *const T, pSanPolicy: ?*VDS_SAN_POLICY) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceSAN.VTable, @ptrCast(self.vtable)).GetSANPolicy(@as(*const IVdsServiceSAN, @ptrCast(self)), pSanPolicy);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceSAN_SetSANPolicy(self: *const T, SanPolicy: VDS_SAN_POLICY) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceSAN.VTable, @ptrCast(self.vtable)).SetSANPolicy(@as(*const IVdsServiceSAN, @ptrCast(self)), SanPolicy);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsVolumeMF3_Value = Guid.initString("6788faf9-214e-4b85-ba59-266953616e09");
pub const IID_IVdsVolumeMF3 = &IID_IVdsVolumeMF3_Value;
pub const IVdsVolumeMF3 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QueryVolumeGuidPathnames: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF3,
                pwszPathArray: [*]?*?PWSTR,
                pulNumberOfPaths: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsVolumeMF3,
                pwszPathArray: [*]?*?PWSTR,
        ...
        FormatEx2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF3,
                pwszFileSystemTypeName: ?PWSTR,
                usFileSystemRevision: u16,
        ...
        OfflineVolume: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsVolumeMF3,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF3_QueryVolumeGuidPathnames(self: *const T, pwszPathArray: [*]?*?PWSTR, pulNumberOfPaths: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF3.VTable, @ptrCast(self.vtable)).QueryVolumeGuidPathnames(@as(*const IVdsVolumeMF3, @ptrCast(self)), pwszPathArray, pulNumberOfPaths);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF3_FormatEx2(self: *const T, pwszFileSystemTypeName: ?PWSTR, usFileSystemRevision: u16, ulDesiredUnitAllocationSize: u32, pwszLabel: ?PWSTR, Options: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF3.VTable, @ptrCast(self.vtable)).FormatEx2(@as(*const IVdsVolumeMF3, @ptrCast(self)), pwszFileSystemTypeName, usFileSystemRevision, ulDesiredUnitAllocationSize, pwszLabel, Options, ppAsync);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsVolumeMF3_OfflineVolume(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IVdsVolumeMF3.VTable, @ptrCast(self.vtable)).OfflineVolume(@as(*const IVdsVolumeMF3, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
// TODO: this type is limited to platform 'windows6.1'
const IID_IVdsDiskPartitionMF2_Value = Guid.initString("9cbe50ca-f2d2-4bf4-ace1-96896b729625");
pub const IID_IVdsDiskPartitionMF2 = &IID_IVdsDiskPartitionMF2_Value;
pub const IVdsDiskPartitionMF2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        FormatPartitionEx2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsDiskPartitionMF2,
                ullOffset: u64,
                pwszFileSystemTypeName: ?PWSTR,
                usFileSystemRevision: u16,
                ulDesiredUnitAllocationSize: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsDiskPartitionMF2_FormatPartitionEx2(self: *const T, ullOffset: u64, pwszFileSystemTypeName: ?PWSTR, usFileSystemRevision: u16, ulDesiredUnitAllocationSize: u32, pwszLabel: ?PWSTR, Options: u32, ppAsync: ?*?*IVdsAsync) callconv(.Inline) HRESULT {
            return @as(*const IVdsDiskPartitionMF2.VTable, @ptrCast(self.vtable)).FormatPartitionEx2(@as(*const IVdsDiskPartitionMF2, @ptrCast(self)), ullOffset, pwszFileSystemTypeName, usFileSystemRevision, ulDesiredUnitAllocationSize, pwszLabel, Options, ppAsync);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

const IID_IVdsServiceSw_Value = Guid.initString("15fc031c-0652-4306-b2c3-f558b8f837e2");
pub const IID_IVdsServiceSw = &IID_IVdsServiceSw_Value;
pub const IVdsServiceSw = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetDiskObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IVdsServiceSw,
                pwszDeviceID: ?[*:0]align(1) const u16,
                ppDiskUnk: ?*?*IUnknown,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IVdsServiceSw,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVdsServiceSw_GetDiskObject(self: *const T, pwszDeviceID: ?[*:0]align(1) const u16, ppDiskUnk: ?*?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IVdsServiceSw.VTable, @ptrCast(self.vtable)).GetDiskObject(@as(*const IVdsServiceSw, @ptrCast(self)), pwszDeviceID, ppDiskUnk);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const ATTACH_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").ATTACH_VIRTUAL_DISK_FLAG;
const BOOL = @import("../../../windows/win32/foundation.zig").BOOL;
const BOOLEAN = @import("../../../windows/win32/foundation.zig").BOOLEAN;
const COMPACT_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").COMPACT_VIRTUAL_DISK_FLAG;
const CREATE_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").CREATE_VIRTUAL_DISK_FLAG;
const DEPENDENT_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").DEPENDENT_DISK_FLAG;
const DETACH_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").DETACH_VIRTUAL_DISK_FLAG;
const EXPAND_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").EXPAND_VIRTUAL_DISK_FLAG;
const HRESULT = @import("../../../windows/win32/foundation.zig").HRESULT;
const IUnknown = @import("../../../windows/win32/system/com.zig").IUnknown;
const MERGE_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").MERGE_VIRTUAL_DISK_FLAG;
const OPEN_VIRTUAL_DISK_FLAG = @import("../../../windows/win32/storage/vhd.zig").OPEN_VIRTUAL_DISK_FLAG;
const PWSTR = @import("../../../windows/win32/foundation.zig").PWSTR;
const VIRTUAL_DISK_ACCESS_MASK = @import("../../../windows/win32/storage/vhd.zig").VIRTUAL_DISK_ACCESS_MASK;
const VIRTUAL_STORAGE_TYPE = @import("../../../windows/win32/storage/vhd.zig").VIRTUAL_STORAGE_TYPE;
