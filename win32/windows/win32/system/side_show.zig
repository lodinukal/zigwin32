...
pub const SIDESHOW_CAPABILITY_DEVICE_ID = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 1 };
pub const SIDESHOW_CAPABILITY_SCREEN_TYPE = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 2 };
pub const SIDESHOW_CAPABILITY_SCREEN_WIDTH = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 3 };
pub const SIDESHOW_CAPABILITY_SCREEN_HEIGHT = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 4 };
pub const SIDESHOW_CAPABILITY_COLOR_DEPTH = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 5 };
pub const SIDESHOW_CAPABILITY_COLOR_TYPE = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 6 };
pub const SIDESHOW_CAPABILITY_DATA_CACHE = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 7 };
pub const SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 8 };
pub const SIDESHOW_CAPABILITY_CURRENT_LANGUAGE = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 9 };
pub const SIDESHOW_CAPABILITY_SUPPORTED_THEMES = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 10 };
pub const SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 14 };
pub const SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 15 };
pub const SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT = PROPERTYKEY { .fmtid = Guid.initIntString("2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153"), .pid = 16 };
