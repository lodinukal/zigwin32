...
pub const CPD_RFC3161v21 = @as(u32, 2097152);
...
pub const SPC_SP_AGENCY_INFO_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2000));
pub const SPC_MINIMAL_CRITERIA_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2001));
pub const SPC_FINANCIAL_CRITERIA_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2002));
pub const SPC_INDIRECT_DATA_CONTENT_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2003));
pub const SPC_PE_IMAGE_DATA_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2004));
pub const SPC_LINK_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2005));
pub const SPC_STATEMENT_TYPE_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2006));
pub const SPC_SP_OPUS_INFO_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2007));
pub const SPC_CAB_DATA_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2008));
pub const SPC_JAVA_CLASS_DATA_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2009));
pub const INTENT_TO_SEAL_ATTRIBUTE_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2010));
pub const SEALING_SIGNATURE_ATTRIBUTE_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2011));
pub const SEALING_TIMESTAMP_ATTRIBUTE_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2012));
pub const SPC_SIGINFO_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2130));
pub const CAT_NAMEVALUE_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2221));
pub const CAT_MEMBERINFO_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2222));
pub const CAT_MEMBERINFO2_STRUCT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2223));
...
pub const WIN_TRUST_SUBJTYPE_RAW_FILE = Guid.initString("959dc450-8d9e-11cf-8736-00aa00a485eb");
pub const WIN_TRUST_SUBJTYPE_PE_IMAGE = Guid.initString("43c9a1e0-8da0-11cf-8736-00aa00a485eb");
pub const WIN_TRUST_SUBJTYPE_JAVA_CLASS = Guid.initString("08ad3990-8da1-11cf-8736-00aa00a485eb");
pub const WIN_TRUST_SUBJTYPE_CABINET = Guid.initString("d17c5374-a392-11cf-9df5-00aa00c184e0");
pub const WIN_TRUST_SUBJTYPE_RAW_FILEEX = Guid.initString("6f458110-c2f1-11cf-8a69-00aa006c3706");
pub const WIN_TRUST_SUBJTYPE_PE_IMAGEEX = Guid.initString("6f458111-c2f1-11cf-8a69-00aa006c3706");
pub const WIN_TRUST_SUBJTYPE_JAVA_CLASSEX = Guid.initString("6f458113-c2f1-11cf-8a69-00aa006c3706");
pub const WIN_TRUST_SUBJTYPE_CABINETEX = Guid.initString("6f458114-c2f1-11cf-8a69-00aa006c3706");
pub const WIN_TRUST_SUBJTYPE_OLE_STORAGE = Guid.initString("c257e740-8da0-11cf-8736-00aa00a485eb");
pub const WIN_SPUB_ACTION_TRUSTED_PUBLISHER = Guid.initString("66426730-8da1-11cf-8736-00aa00a485eb");
pub const WIN_SPUB_ACTION_NT_ACTIVATE_IMAGE = Guid.initString("8bc96b00-8da1-11cf-8736-00aa00a485eb");
pub const WIN_SPUB_ACTION_PUBLISHED_SOFTWARE = Guid.initString("64b9d180-8da2-11cf-8736-00aa00a485eb");
...
pub const WINTRUST_ACTION_GENERIC_VERIFY_V2 = Guid.initString("00aac56b-cd44-11d0-8cc2-00c04fc295ee");
...
pub const WINTRUST_ACTION_TRUSTPROVIDER_TEST = Guid.initString("573e31f8-ddba-11d0-8ccb-00c04fc295ee");
pub const SP_TESTDUMPPOLICY_FUNCTION_TEST = "SoftpubDumpStructure";
pub const WINTRUST_ACTION_GENERIC_CERT_VERIFY = Guid.initString("189a3842-3041-11d1-85e1-00c04fc295ee");
pub const SP_GENERIC_CERT_INIT_FUNCTION = "SoftpubDefCertInit";
pub const WINTRUST_ACTION_GENERIC_CHAIN_VERIFY = Guid.initString("fc451c16-ac75-11d1-b4b8-00c04fb66ea0");
...
pub const HTTPSPROV_ACTION = Guid.initString("573e31f8-aaba-11d0-8ccb-00c04fc295ee");
...
pub const OFFICESIGN_ACTION_VERIFY = Guid.initString("5555c2cd-17fb-11d1-85c4-00c04fc295ee");
...
pub const DRIVER_ACTION_VERIFY = Guid.initString("f750e6c3-38ee-11d1-85e5-00c04fc295ee");
...
pub const CONFIG_CI_ACTION_VERIFY = Guid.initString("6078065b-8f22-4b13-bd9b-5b762776f386");
...
pub const WINTRUST_CATALOG_INFO = extern struct {
    ...
    pcwszCatalogFilePath: ?[*:0]align(1) const u16,
    pcwszMemberTag: ?[*:0]align(1) const u16,
    pcwszMemberFilePath: ?[*:0]align(1) const u16,
    hMemberFile: ?HANDLE,
...
pub const WINTRUST_BLOB_INFO = extern struct {
    cbStruct: u32,
    gSubject: Guid,
    pcwszDisplayName: ?[*:0]align(1) const u16,
    cbMemObject: u32,
    pbMemObject: ?*u8,
    cbMemSignedMsg: u32,
    pbMemSignedMsg: ?*u8,
...
pub const PFN_ALLOCANDFILLDEFUSAGE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszUsageOID: ?[*:0]align(1) const u8,
...
pub const SPC_SP_OPUS_INFO = extern struct {
    pwszProgramName: ?[*:0]align(1) const u16,
    pMoreInfo: ?*SPC_LINK,
...
pub const WIN_TRUST_SUBJECT_FILE_AND_DISPLAY = extern struct {
    hFile: ?HANDLE,
    lpPath: ?[*:0]align(1) const u16,
    lpDisplayName: ?[*:0]align(1) const u16,
};
...
const CERT_CHAIN_ELEMENT = @import("../../../windows/win32/security/cryptography.zig").CERT_CHAIN_ELEMENT;
const CERT_CHAIN_PARA = @import("../../../windows/win32/security/cryptography.zig").CERT_CHAIN_PARA;
const CERT_CONTEXT = @import("../../../windows/win32/security/cryptography.zig").CERT_CONTEXT;
const CERT_INFO = @import("../../../windows/win32/security/cryptography.zig").CERT_INFO;
const CERT_STRONG_SIGN_PARA = @import("../../../windows/win32/security/cryptography.zig").CERT_STRONG_SIGN_PARA;
const CERT_USAGE_MATCH = @import("../../../windows/win32/security/cryptography.zig").CERT_USAGE_MATCH;
const CMSG_SIGNER_INFO = @import("../../../windows/win32/security/cryptography.zig").CMSG_SIGNER_INFO;
const CRYPT_ALGORITHM_IDENTIFIER = @import("../../../windows/win32/security/cryptography.zig").CRYPT_ALGORITHM_IDENTIFIER;
const CRYPT_ATTRIBUTE_TYPE_VALUE = @import("../../../windows/win32/security/cryptography.zig").CRYPT_ATTRIBUTE_TYPE_VALUE;
const CRYPT_BIT_BLOB = @import("../../../windows/win32/security/cryptography.zig").CRYPT_BIT_BLOB;
...
const HCERTCHAINENGINE = @import("../../../windows/win32/security/cryptography.zig").HCERTCHAINENGINE;
...
const SIP_DISPATCH_INFO = @import("../../../windows/win32/security/cryptography/sip.zig").SIP_DISPATCH_INFO;
const SIP_INDIRECT_DATA = @import("../../../windows/win32/security/cryptography/sip.zig").SIP_INDIRECT_DATA;
const SIP_SUBJECTINFO = @import("../../../windows/win32/security/cryptography/sip.zig").SIP_SUBJECTINFO;
