...
pub const IBackgroundCopyJob = extern struct {
    pub const VTable = extern struct {
        ...
        SetProxySettings: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                ProxyList: ?[*:0]align(1) const u16,
                ProxyBypassList: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBackgroundCopyJob,
                ProxyUsage: BG_JOB_PROXY_USAGE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob_AddFile(self: *const T, RemoteUrl: ?[*:0]align(1) const u16, LocalName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob_SetDisplayName(self: *const T, Val: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob_SetDescription(self: *const T, Val: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob_SetProxySettings(self: *const T, ProxyUsage: BG_JOB_PROXY_USAGE, ProxyList: ?[*:0]align(1) const u16, ProxyBypassList: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyManager_CreateJob(self: *const T, DisplayName: ?[*:0]align(1) const u16, Type: BG_JOB_TYPE, pJobId: ?*Guid, ppJob: ?*?*IBackgroundCopyJob) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyJob2 = extern struct {
    pub const VTable = extern struct {
        ...
        SetNotifyCmdLine: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                Program: ?[*:0]align(1) const u16,
                Parameters: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBackgroundCopyJob2,
                Program: ?[*:0]align(1) const u16,
        ...
        SetReplyFileName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IBackgroundCopyJob2,
                ReplyFileName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBackgroundCopyJob2,
                ReplyFileName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob2_SetNotifyCmdLine(self: *const T, Program: ?[*:0]align(1) const u16, Parameters: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob2_SetReplyFileName(self: *const T, ReplyFileName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyJob3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob3_ReplaceRemotePrefix(self: *const T, OldPrefix: ?[*:0]align(1) const u16, NewPrefix: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJob3_AddFileWithRanges(self: *const T, RemoteUrl: ?[*:0]align(1) const u16, LocalName: ?[*:0]align(1) const u16, RangeCount: u32, Ranges: [*]BG_FILE_RANGE) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyFile2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyFile2_SetRemoteName(self: *const T, Val: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyJobHttpOptions = extern struct {
    pub const VTable = extern struct {
        ...
        SetClientCertificateByName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                StoreLocation: BG_CERT_STORE_LOCATION,
                StoreName: ?[*:0]align(1) const u16,
                SubjectName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBackgroundCopyJobHttpOptions,
                StoreLocation: BG_CERT_STORE_LOCATION,
        ...
        SetCustomHeaders: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IBackgroundCopyJobHttpOptions,
                RequestHeaders: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBackgroundCopyJobHttpOptions,
                RequestHeaders: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJobHttpOptions_SetClientCertificateByID(self: *const T, StoreLocation: BG_CERT_STORE_LOCATION, StoreName: ?[*:0]align(1) const u16, pCertHashBlob: *[20]u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJobHttpOptions_SetClientCertificateByName(self: *const T, StoreLocation: BG_CERT_STORE_LOCATION, StoreName: ?[*:0]align(1) const u16, SubjectName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJobHttpOptions_GetClientCertificate(self: *const T, pStoreLocation: ?*BG_CERT_STORE_LOCATION, pStoreName: ?*?PWSTR, ppCertHashBlob: ?*?*u8, pSubjectName: ?*?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJobHttpOptions_SetCustomHeaders(self: *const T, RequestHeaders: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBitsPeerCacheAdministration = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBitsPeerCacheAdministration_DeleteUrl(self: *const T, url: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBackgroundCopyJobHttpOptions2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBackgroundCopyJobHttpOptions2_SetHttpMethod(self: *const T, method: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
