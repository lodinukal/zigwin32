...
//--------------------------------------------------------------------------------
// Section: Constants (100)
//--------------------------------------------------------------------------------
pub const OFN_SHAREFALLTHROUGH = @as(u32, 2);
pub const OFN_SHARENOWARN = @as(u32, 1);
pub const OFN_SHAREWARN = @as(u32, 0);
pub const CDN_INITDONE = @as(u32, 4294966695);
pub const CDN_SELCHANGE = @as(u32, 4294966694);
pub const CDN_FOLDERCHANGE = @as(u32, 4294966693);
pub const CDN_SHAREVIOLATION = @as(u32, 4294966692);
pub const CDN_HELP = @as(u32, 4294966691);
pub const CDN_FILEOK = @as(u32, 4294966690);
pub const CDN_TYPECHANGE = @as(u32, 4294966689);
pub const CDN_INCLUDEITEM = @as(u32, 4294966688);
...
pub const CHOOSECOLOR_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CHOOSECOLOR_FLAGS, @enumFromInt(
              (if (o.RGBINIT == 1) @intFromEnum(CHOOSECOLOR_FLAGS.RGBINIT) else 0)
            | (if (o.FULLOPEN == 1) @intFromEnum(CHOOSECOLOR_FLAGS.FULLOPEN) else 0)
            | (if (o.PREVENTFULLOPEN == 1) @intFromEnum(CHOOSECOLOR_FLAGS.PREVENTFULLOPEN) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(CHOOSECOLOR_FLAGS.SHOWHELP) else 0)
            | (if (o.ENABLEHOOK == 1) @intFromEnum(CHOOSECOLOR_FLAGS.ENABLEHOOK) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(CHOOSECOLOR_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.ENABLETEMPLATEHANDLE == 1) @intFromEnum(CHOOSECOLOR_FLAGS.ENABLETEMPLATEHANDLE) else 0)
            | (if (o.SOLIDCOLOR == 1) @intFromEnum(CHOOSECOLOR_FLAGS.SOLIDCOLOR) else 0)
            | (if (o.ANYCOLOR == 1) @intFromEnum(CHOOSECOLOR_FLAGS.ANYCOLOR) else 0)
        ));
    }
};
...
pub const OPEN_FILENAME_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(OPEN_FILENAME_FLAGS, @enumFromInt(
              (if (o.READONLY == 1) @intFromEnum(OPEN_FILENAME_FLAGS.READONLY) else 0)
            | (if (o.OVERWRITEPROMPT == 1) @intFromEnum(OPEN_FILENAME_FLAGS.OVERWRITEPROMPT) else 0)
            | (if (o.HIDEREADONLY == 1) @intFromEnum(OPEN_FILENAME_FLAGS.HIDEREADONLY) else 0)
            | (if (o.NOCHANGEDIR == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NOCHANGEDIR) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(OPEN_FILENAME_FLAGS.SHOWHELP) else 0)
            | (if (o.ENABLEHOOK == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ENABLEHOOK) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.ENABLETEMPLATEHANDLE == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ENABLETEMPLATEHANDLE) else 0)
            | (if (o.NOVALIDATE == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NOVALIDATE) else 0)
            | (if (o.ALLOWMULTISELECT == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ALLOWMULTISELECT) else 0)
            | (if (o.EXTENSIONDIFFERENT == 1) @intFromEnum(OPEN_FILENAME_FLAGS.EXTENSIONDIFFERENT) else 0)
            | (if (o.PATHMUSTEXIST == 1) @intFromEnum(OPEN_FILENAME_FLAGS.PATHMUSTEXIST) else 0)
            | (if (o.FILEMUSTEXIST == 1) @intFromEnum(OPEN_FILENAME_FLAGS.FILEMUSTEXIST) else 0)
            | (if (o.CREATEPROMPT == 1) @intFromEnum(OPEN_FILENAME_FLAGS.CREATEPROMPT) else 0)
            | (if (o.SHAREAWARE == 1) @intFromEnum(OPEN_FILENAME_FLAGS.SHAREAWARE) else 0)
            | (if (o.NOREADONLYRETURN == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NOREADONLYRETURN) else 0)
            | (if (o.NOTESTFILECREATE == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NOTESTFILECREATE) else 0)
            | (if (o.NONETWORKBUTTON == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NONETWORKBUTTON) else 0)
            | (if (o.NOLONGNAMES == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NOLONGNAMES) else 0)
            | (if (o.EXPLORER == 1) @intFromEnum(OPEN_FILENAME_FLAGS.EXPLORER) else 0)
            | (if (o.NODEREFERENCELINKS == 1) @intFromEnum(OPEN_FILENAME_FLAGS.NODEREFERENCELINKS) else 0)
            | (if (o.LONGNAMES == 1) @intFromEnum(OPEN_FILENAME_FLAGS.LONGNAMES) else 0)
            | (if (o.ENABLEINCLUDENOTIFY == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ENABLEINCLUDENOTIFY) else 0)
            | (if (o.ENABLESIZING == 1) @intFromEnum(OPEN_FILENAME_FLAGS.ENABLESIZING) else 0)
            | (if (o.DONTADDTORECENT == 1) @intFromEnum(OPEN_FILENAME_FLAGS.DONTADDTORECENT) else 0)
            | (if (o.FORCESHOWHIDDEN == 1) @intFromEnum(OPEN_FILENAME_FLAGS.FORCESHOWHIDDEN) else 0)
        ));
    }
};
...
pub const OPEN_FILENAME_FLAGS_EX = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(OPEN_FILENAME_FLAGS_EX, @enumFromInt(
              (if (o.NE == 1) @intFromEnum(OPEN_FILENAME_FLAGS_EX.NE) else 0)
            | (if (o.PLACESBAR == 1) @intFromEnum(OPEN_FILENAME_FLAGS_EX.PLACESBAR) else 0)
        ));
    }
};
...
pub const PAGESETUPDLG_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PAGESETUPDLG_FLAGS, @enumFromInt(
              (if (o.DEFAULTMINMARGINS == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DEFAULTMINMARGINS) else 0)
            | (if (o.DISABLEMARGINS == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DISABLEMARGINS) else 0)
            | (if (o.DISABLEORIENTATION == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DISABLEORIENTATION) else 0)
            | (if (o.DISABLEPAGEPAINTING == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DISABLEPAGEPAINTING) else 0)
            | (if (o.DISABLEPAPER == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DISABLEPAPER) else 0)
            | (if (o.DISABLEPRINTER == 1) @intFromEnum(PAGESETUPDLG_FLAGS.DISABLEPRINTER) else 0)
            | (if (o.ENABLEPAGEPAINTHOOK == 1) @intFromEnum(PAGESETUPDLG_FLAGS.ENABLEPAGEPAINTHOOK) else 0)
            | (if (o.ENABLEPAGESETUPHOOK == 1) @intFromEnum(PAGESETUPDLG_FLAGS.ENABLEPAGESETUPHOOK) else 0)
            | (if (o.ENABLEPAGESETUPTEMPLATE == 1) @intFromEnum(PAGESETUPDLG_FLAGS.ENABLEPAGESETUPTEMPLATE) else 0)
            | (if (o.ENABLEPAGESETUPTEMPLATEHANDLE == 1) @intFromEnum(PAGESETUPDLG_FLAGS.ENABLEPAGESETUPTEMPLATEHANDLE) else 0)
            | (if (o.INHUNDREDTHSOFMILLIMETERS == 1) @intFromEnum(PAGESETUPDLG_FLAGS.INHUNDREDTHSOFMILLIMETERS) else 0)
            | (if (o.INTHOUSANDTHSOFINCHES == 1) @intFromEnum(PAGESETUPDLG_FLAGS.INTHOUSANDTHSOFINCHES) else 0)
            | (if (o.MARGINS == 1) @intFromEnum(PAGESETUPDLG_FLAGS.MARGINS) else 0)
            | (if (o.MINMARGINS == 1) @intFromEnum(PAGESETUPDLG_FLAGS.MINMARGINS) else 0)
            | (if (o.NONETWORKBUTTON == 1) @intFromEnum(PAGESETUPDLG_FLAGS.NONETWORKBUTTON) else 0)
            | (if (o.NOWARNING == 1) @intFromEnum(PAGESETUPDLG_FLAGS.NOWARNING) else 0)
            | (if (o.RETURNDEFAULT == 1) @intFromEnum(PAGESETUPDLG_FLAGS.RETURNDEFAULT) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(PAGESETUPDLG_FLAGS.SHOWHELP) else 0)
        ));
    }
};
...
pub const CHOOSEFONT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CHOOSEFONT_FLAGS, @enumFromInt(
              (if (o.APPLY == 1) @intFromEnum(CHOOSEFONT_FLAGS.APPLY) else 0)
            | (if (o.ANSIONLY == 1) @intFromEnum(CHOOSEFONT_FLAGS.ANSIONLY) else 0)
            | (if (o.BOTH == 1) @intFromEnum(CHOOSEFONT_FLAGS.BOTH) else 0)
            | (if (o.EFFECTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.EFFECTS) else 0)
            | (if (o.ENABLEHOOK == 1) @intFromEnum(CHOOSEFONT_FLAGS.ENABLEHOOK) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(CHOOSEFONT_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.ENABLETEMPLATEHANDLE == 1) @intFromEnum(CHOOSEFONT_FLAGS.ENABLETEMPLATEHANDLE) else 0)
            | (if (o.FIXEDPITCHONLY == 1) @intFromEnum(CHOOSEFONT_FLAGS.FIXEDPITCHONLY) else 0)
            | (if (o.FORCEFONTEXIST == 1) @intFromEnum(CHOOSEFONT_FLAGS.FORCEFONTEXIST) else 0)
            | (if (o.INACTIVEFONTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.INACTIVEFONTS) else 0)
            | (if (o.INITTOLOGFONTSTRUCT == 1) @intFromEnum(CHOOSEFONT_FLAGS.INITTOLOGFONTSTRUCT) else 0)
            | (if (o.LIMITSIZE == 1) @intFromEnum(CHOOSEFONT_FLAGS.LIMITSIZE) else 0)
            | (if (o.NOOEMFONTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOOEMFONTS) else 0)
            | (if (o.NOFACESEL == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOFACESEL) else 0)
            | (if (o.NOSCRIPTSEL == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOSCRIPTSEL) else 0)
            | (if (o.NOSIMULATIONS == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOSIMULATIONS) else 0)
            | (if (o.NOSIZESEL == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOSIZESEL) else 0)
            | (if (o.NOSTYLESEL == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOSTYLESEL) else 0)
            | (if (o.NOVERTFONTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.NOVERTFONTS) else 0)
            | (if (o.PRINTERFONTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.PRINTERFONTS) else 0)
            | (if (o.SCALABLEONLY == 1) @intFromEnum(CHOOSEFONT_FLAGS.SCALABLEONLY) else 0)
            | (if (o.SCREENFONTS == 1) @intFromEnum(CHOOSEFONT_FLAGS.SCREENFONTS) else 0)
            | (if (o.SELECTSCRIPT == 1) @intFromEnum(CHOOSEFONT_FLAGS.SELECTSCRIPT) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(CHOOSEFONT_FLAGS.SHOWHELP) else 0)
            | (if (o.TTONLY == 1) @intFromEnum(CHOOSEFONT_FLAGS.TTONLY) else 0)
            | (if (o.USESTYLE == 1) @intFromEnum(CHOOSEFONT_FLAGS.USESTYLE) else 0)
            | (if (o.WYSIWYG == 1) @intFromEnum(CHOOSEFONT_FLAGS.WYSIWYG) else 0)
        ));
    }
};
...
pub const FINDREPLACE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FINDREPLACE_FLAGS, @enumFromInt(
              (if (o.DOWN == 1) @intFromEnum(FINDREPLACE_FLAGS.DOWN) else 0)
            | (if (o.WHOLEWORD == 1) @intFromEnum(FINDREPLACE_FLAGS.WHOLEWORD) else 0)
            | (if (o.MATCHCASE == 1) @intFromEnum(FINDREPLACE_FLAGS.MATCHCASE) else 0)
            | (if (o.FINDNEXT == 1) @intFromEnum(FINDREPLACE_FLAGS.FINDNEXT) else 0)
            | (if (o.REPLACE == 1) @intFromEnum(FINDREPLACE_FLAGS.REPLACE) else 0)
            | (if (o.REPLACEALL == 1) @intFromEnum(FINDREPLACE_FLAGS.REPLACEALL) else 0)
            | (if (o.DIALOGTERM == 1) @intFromEnum(FINDREPLACE_FLAGS.DIALOGTERM) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(FINDREPLACE_FLAGS.SHOWHELP) else 0)
            | (if (o.ENABLEHOOK == 1) @intFromEnum(FINDREPLACE_FLAGS.ENABLEHOOK) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(FINDREPLACE_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.NOUPDOWN == 1) @intFromEnum(FINDREPLACE_FLAGS.NOUPDOWN) else 0)
            | (if (o.NOMATCHCASE == 1) @intFromEnum(FINDREPLACE_FLAGS.NOMATCHCASE) else 0)
            | (if (o.NOWHOLEWORD == 1) @intFromEnum(FINDREPLACE_FLAGS.NOWHOLEWORD) else 0)
            | (if (o.ENABLETEMPLATEHANDLE == 1) @intFromEnum(FINDREPLACE_FLAGS.ENABLETEMPLATEHANDLE) else 0)
            | (if (o.HIDEUPDOWN == 1) @intFromEnum(FINDREPLACE_FLAGS.HIDEUPDOWN) else 0)
            | (if (o.HIDEMATCHCASE == 1) @intFromEnum(FINDREPLACE_FLAGS.HIDEMATCHCASE) else 0)
            | (if (o.HIDEWHOLEWORD == 1) @intFromEnum(FINDREPLACE_FLAGS.HIDEWHOLEWORD) else 0)
            | (if (o.RAW == 1) @intFromEnum(FINDREPLACE_FLAGS.RAW) else 0)
            | (if (o.SHOWWRAPAROUND == 1) @intFromEnum(FINDREPLACE_FLAGS.SHOWWRAPAROUND) else 0)
            | (if (o.NOWRAPAROUND == 1) @intFromEnum(FINDREPLACE_FLAGS.NOWRAPAROUND) else 0)
            | (if (o.WRAPAROUND == 1) @intFromEnum(FINDREPLACE_FLAGS.WRAPAROUND) else 0)
            | (if (o.MATCHDIAC == 1) @intFromEnum(FINDREPLACE_FLAGS.MATCHDIAC) else 0)
            | (if (o.MATCHKASHIDA == 1) @intFromEnum(FINDREPLACE_FLAGS.MATCHKASHIDA) else 0)
            | (if (o.MATCHALEFHAMZA == 1) @intFromEnum(FINDREPLACE_FLAGS.MATCHALEFHAMZA) else 0)
        ));
    }
};
...
pub const FR_RAW = FINDREPLACE_FLAGS.RAW;
pub const FR_SHOWWRAPAROUND = FINDREPLACE_FLAGS.SHOWWRAPAROUND;
pub const FR_NOWRAPAROUND = FINDREPLACE_FLAGS.NOWRAPAROUND;
pub const FR_WRAPAROUND = FINDREPLACE_FLAGS.WRAPAROUND;
pub const FR_MATCHDIAC = FINDREPLACE_FLAGS.MATCHDIAC;
pub const FR_MATCHKASHIDA = FINDREPLACE_FLAGS.MATCHKASHIDA;
pub const FR_MATCHALEFHAMZA = FINDREPLACE_FLAGS.MATCHALEFHAMZA;
...
pub const PRINTDLGEX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PRINTDLGEX_FLAGS, @enumFromInt(
              (if (o.ALLPAGES == 1) @intFromEnum(PRINTDLGEX_FLAGS.ALLPAGES) else 0)
            | (if (o.COLLATE == 1) @intFromEnum(PRINTDLGEX_FLAGS.COLLATE) else 0)
            | (if (o.CURRENTPAGE == 1) @intFromEnum(PRINTDLGEX_FLAGS.CURRENTPAGE) else 0)
            | (if (o.DISABLEPRINTTOFILE == 1) @intFromEnum(PRINTDLGEX_FLAGS.DISABLEPRINTTOFILE) else 0)
            | (if (o.ENABLEPRINTTEMPLATE == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLEPRINTTEMPLATE) else 0)
            | (if (o.ENABLEPRINTTEMPLATEHANDLE == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLEPRINTTEMPLATEHANDLE) else 0)
            | (if (o.EXCLUSIONFLAGS == 1) @intFromEnum(PRINTDLGEX_FLAGS.EXCLUSIONFLAGS) else 0)
            | (if (o.HIDEPRINTTOFILE == 1) @intFromEnum(PRINTDLGEX_FLAGS.HIDEPRINTTOFILE) else 0)
            | (if (o.NOCURRENTPAGE == 1) @intFromEnum(PRINTDLGEX_FLAGS.NOCURRENTPAGE) else 0)
            | (if (o.NOPAGENUMS == 1) @intFromEnum(PRINTDLGEX_FLAGS.NOPAGENUMS) else 0)
            | (if (o.NOSELECTION == 1) @intFromEnum(PRINTDLGEX_FLAGS.NOSELECTION) else 0)
            | (if (o.NOWARNING == 1) @intFromEnum(PRINTDLGEX_FLAGS.NOWARNING) else 0)
            | (if (o.PAGENUMS == 1) @intFromEnum(PRINTDLGEX_FLAGS.PAGENUMS) else 0)
            | (if (o.PRINTTOFILE == 1) @intFromEnum(PRINTDLGEX_FLAGS.PRINTTOFILE) else 0)
            | (if (o.RETURNDC == 1) @intFromEnum(PRINTDLGEX_FLAGS.RETURNDC) else 0)
            | (if (o.RETURNDEFAULT == 1) @intFromEnum(PRINTDLGEX_FLAGS.RETURNDEFAULT) else 0)
            | (if (o.RETURNIC == 1) @intFromEnum(PRINTDLGEX_FLAGS.RETURNIC) else 0)
            | (if (o.SELECTION == 1) @intFromEnum(PRINTDLGEX_FLAGS.SELECTION) else 0)
            | (if (o.USEDEVMODECOPIES == 1) @intFromEnum(PRINTDLGEX_FLAGS.USEDEVMODECOPIES) else 0)
            | (if (o.USELARGETEMPLATE == 1) @intFromEnum(PRINTDLGEX_FLAGS.USELARGETEMPLATE) else 0)
            | (if (o.ENABLEPRINTHOOK == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLEPRINTHOOK) else 0)
            | (if (o.ENABLESETUPHOOK == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLESETUPHOOK) else 0)
            | (if (o.ENABLESETUPTEMPLATE == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLESETUPTEMPLATE) else 0)
            | (if (o.ENABLESETUPTEMPLATEHANDLE == 1) @intFromEnum(PRINTDLGEX_FLAGS.ENABLESETUPTEMPLATEHANDLE) else 0)
            | (if (o.NONETWORKBUTTON == 1) @intFromEnum(PRINTDLGEX_FLAGS.NONETWORKBUTTON) else 0)
            | (if (o.PRINTSETUP == 1) @intFromEnum(PRINTDLGEX_FLAGS.PRINTSETUP) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(PRINTDLGEX_FLAGS.SHOWHELP) else 0)
        ));
    }
};
...
pub const CHOOSEFONT_FONT_TYPE = enum(u16) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CHOOSEFONT_FONT_TYPE, @enumFromInt(
              (if (o.BOLD_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.BOLD_FONTTYPE) else 0)
            | (if (o.ITALIC_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.ITALIC_FONTTYPE) else 0)
            | (if (o.PRINTER_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.PRINTER_FONTTYPE) else 0)
            | (if (o.REGULAR_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.REGULAR_FONTTYPE) else 0)
            | (if (o.SCREEN_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.SCREEN_FONTTYPE) else 0)
            | (if (o.SIMULATED_FONTTYPE == 1) @intFromEnum(CHOOSEFONT_FONT_TYPE.SIMULATED_FONTTYPE) else 0)
        ));
    }
};
...
pub const OPENFILENAME_NT4A = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        hwndOwner: ?HWND,
        hInstance: ?HINSTANCE,
        lpstrFilter: ?[*:0]align(1) const u8,
        ...
        lpstrFileTitle: ?PSTR,
        nMaxFileTitle: u32,
        lpstrInitialDir: ?[*:0]align(1) const u8,
        lpstrTitle: ?[*:0]align(1) const u8,
        Flags: u32,
        nFileOffset: u16,
        nFileExtension: u16,
        lpstrDefExt: ?[*:0]align(1) const u8,
        lCustData: LPARAM,
    ...
    .X86 => extern struct {
        ...
        lpstrFilter: ?[*:0]align(1) const u8 align(1),
        ...
        lpstrInitialDir: ?[*:0]align(1) const u8 align(1),
        lpstrTitle: ?[*:0]align(1) const u8 align(1),
        Flags: u32 align(1),
        nFileOffset: u16 align(1),
        nFileExtension: u16 align(1),
        lpstrDefExt: ?[*:0]align(1) const u8 align(1),
        lCustData: LPARAM align(1),
        lpfnHook: ?LPOFNHOOKPROC align(1),
        lpTemplateName: ?[*:0]align(1) const u8 align(1),
    },
};
pub const OPENFILENAME_NT4W = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        hwndOwner: ?HWND,
        hInstance: ?HINSTANCE,
        lpstrFilter: ?[*:0]align(1) const u16,
        ...
        nMaxFileTitle: u32,
        lpstrInitialDir: ?[*:0]align(1) const u16,
        lpstrTitle: ?[*:0]align(1) const u16,
        Flags: u32,
        nFileOffset: u16,
        nFileExtension: u16,
        lpstrDefExt: ?[*:0]align(1) const u16,
        lCustData: LPARAM,
        lpfnHook: ?LPOFNHOOKPROC,
    ...
    .X86 => extern struct {
        ...
        hwndOwner: ?HWND align(1),
        hInstance: ?HINSTANCE align(1),
        lpstrFilter: ?[*:0]align(1) const u16 align(1),
        ...
        nMaxFileTitle: u32 align(1),
        lpstrInitialDir: ?[*:0]align(1) const u16 align(1),
        lpstrTitle: ?[*:0]align(1) const u16 align(1),
        Flags: u32 align(1),
        nFileOffset: u16 align(1),
        nFileExtension: u16 align(1),
        lpstrDefExt: ?[*:0]align(1) const u16 align(1),
        lCustData: LPARAM align(1),
        lpfnHook: ?LPOFNHOOKPROC align(1),
        lpTemplateName: ?[*:0]align(1) const u16 align(1),
    },
};
...
pub const PRINTDLGA = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        lpPrintTemplateName: ?[*:0]align(1) const u8,
        lpSetupTemplateName: ?[*:0]align(1) const u8,
    ...
    .X86 => extern struct {
        lStructSize: u32 align(1),
        hwndOwner: ?HWND align(1),
        hDevMode: ?HGLOBAL align(1),
        hDevNames: ?HGLOBAL align(1),
        hDC: ?HDC align(1),
        ...
        lpPrintTemplateName: ?[*:0]align(1) const u8 align(1),
        lpSetupTemplateName: ?[*:0]align(1) const u8 align(1),
        hPrintTemplate: ?HGLOBAL align(1),
        hSetupTemplate: ?HGLOBAL align(1),
    },
};
pub const PRINTDLGW = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        lpfnPrintHook: ?LPPRINTHOOKPROC,
        lpfnSetupHook: ?LPSETUPHOOKPROC,
        lpPrintTemplateName: ?[*:0]align(1) const u16,
        lpSetupTemplateName: ?[*:0]align(1) const u16,
        hPrintTemplate: ?HGLOBAL,
        hSetupTemplate: ?HGLOBAL,
    },
    .X86 => extern struct {
        ...
        lpfnPrintHook: ?LPPRINTHOOKPROC align(1),
        lpfnSetupHook: ?LPSETUPHOOKPROC align(1),
        lpPrintTemplateName: ?[*:0]align(1) const u16 align(1),
        lpSetupTemplateName: ?[*:0]align(1) const u16 align(1),
        hPrintTemplate: ?HGLOBAL align(1),
        hSetupTemplate: ?HGLOBAL align(1),
    },
};
...
pub const PAGESETUPDLGA = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        lpPageSetupTemplateName: ?[*:0]align(1) const u8,
    ...
    .X86 => extern struct {
        ...
        lpPageSetupTemplateName: ?[*:0]align(1) const u8 align(1),
        hPageSetupTemplate: ?HGLOBAL align(1),
    },
};
pub const PAGESETUPDLGW = switch(@import("../../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        lpfnPageSetupHook: ?LPPAGESETUPHOOK,
        lpfnPagePaintHook: ?LPPAGEPAINTHOOK,
        lpPageSetupTemplateName: ?[*:0]align(1) const u16,
        hPageSetupTemplate: ?HGLOBAL,
    },
    .X86 => extern struct {
        lStructSize: u32 align(1),
        ...
        lpfnPageSetupHook: ?LPPAGESETUPHOOK align(1),
        lpfnPagePaintHook: ?LPPAGEPAINTHOOK align(1),
        lpPageSetupTemplateName: ?[*:0]align(1) const u16 align(1),
        hPageSetupTemplate: ?HGLOBAL align(1),
    },
};
...
const NMHDR = @import("../../../../windows/win32/ui/controls.zig").NMHDR;
