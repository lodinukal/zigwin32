...
pub const PKEY_FX_Association = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 0 };
pub const PKEY_FX_PreMixEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 1 };
pub const PKEY_FX_PostMixEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 2 };
pub const PKEY_FX_UserInterfaceClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 3 };
pub const PKEY_FX_FriendlyName = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 4 };
pub const PKEY_FX_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 5 };
pub const PKEY_FX_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 6 };
pub const PKEY_FX_EndpointEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 7 };
pub const PKEY_FX_KeywordDetector_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 8 };
pub const PKEY_FX_KeywordDetector_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 9 };
pub const PKEY_FX_KeywordDetector_EndpointEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 10 };
pub const PKEY_FX_Offload_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 11 };
pub const PKEY_FX_Offload_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 12 };
pub const PKEY_CompositeFX_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 13 };
pub const PKEY_CompositeFX_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 14 };
pub const PKEY_CompositeFX_EndpointEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 15 };
pub const PKEY_CompositeFX_KeywordDetector_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 16 };
pub const PKEY_CompositeFX_KeywordDetector_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 17 };
pub const PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 18 };
pub const PKEY_CompositeFX_Offload_StreamEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 19 };
pub const PKEY_CompositeFX_Offload_ModeEffectClsid = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 20 };
pub const PKEY_FX_SupportAppLauncher = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 21 };
pub const PKEY_FX_SupportedFormats = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 22 };
pub const PKEY_FX_Enumerator = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 23 };
pub const PKEY_FX_VersionMajor = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 24 };
pub const PKEY_FX_VersionMinor = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 25 };
pub const PKEY_FX_Author = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 26 };
pub const PKEY_FX_ObjectId = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 27 };
pub const PKEY_FX_State = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 28 };
pub const PKEY_FX_EffectPackSchema_Version = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 29 };
pub const PKEY_FX_ApplyToBluetooth = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 30 };
pub const PKEY_FX_ApplyToUsb = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 31 };
pub const PKEY_FX_ApplyToRender = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 32 };
pub const PKEY_FX_ApplyToCapture = PROPERTYKEY { .fmtid = Guid.initIntString("3494774182, 22859, 20406, 168, 13, 1, 175, 94, 237, 125, 29"), .pid = 33 };
pub const PKEY_SFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 5 };
pub const PKEY_MFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 6 };
pub const PKEY_EFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 7 };
pub const PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 8 };
pub const PKEY_MFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 9 };
pub const PKEY_EFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 10 };
pub const PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 11 };
pub const PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 12 };
pub const PKEY_APO_SWFallback_ProcessingModes = PROPERTYKEY { .fmtid = Guid.initIntString("3550034495, 39362, 17410, 181, 236, 169, 42, 3, 103, 102, 75"), .pid = 13 };
pub const PKEY_FX_EffectPack_Schema_V1 = Guid.initString("7abf23d9-727e-4d0b-86a3-dd501d260001");
...
pub const IAudioProcessingObjectLoggingService = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioProcessingObjectLoggingService_ApoLog(self: *const T, level: APO_LOG_LEVEL, format: ?[*:0]align(1) const u16) callconv(.Inline) void {
...
pub const APO_NOTIFICATION_TYPE_ENDPOINT_VOLUME2 = APO_NOTIFICATION_TYPE.ENDPOINT_VOLUME2;
pub const APO_NOTIFICATION_TYPE_DEVICE_ORIENTATION = APO_NOTIFICATION_TYPE.DEVICE_ORIENTATION;
pub const APO_NOTIFICATION_TYPE_MICROPHONE_BOOST = APO_NOTIFICATION_TYPE.MICROPHONE_BOOST;
...
pub const AUDIO_ENDPOINT_VOLUME_CHANGE_NOTIFICATION2 = extern struct {
    endpoint: ?*IMMDevice,
    volume: ?*AUDIO_VOLUME_NOTIFICATION_DATA2,
};

pub const DEVICE_ORIENTATION_TYPE = enum(i32) {
    NOT_ROTATED = 0,
    ROTATED_90_DEGREES_CLOCKWISE = 1,
    ROTATED_180_DEGREES_CLOCKWISE = 2,
    ROTATED_270_DEGREES_CLOCKWISE = 3,
};
pub const DEVICE_NOT_ROTATED = DEVICE_ORIENTATION_TYPE.NOT_ROTATED;
pub const DEVICE_ROTATED_90_DEGREES_CLOCKWISE = DEVICE_ORIENTATION_TYPE.ROTATED_90_DEGREES_CLOCKWISE;
pub const DEVICE_ROTATED_180_DEGREES_CLOCKWISE = DEVICE_ORIENTATION_TYPE.ROTATED_180_DEGREES_CLOCKWISE;
pub const DEVICE_ROTATED_270_DEGREES_CLOCKWISE = DEVICE_ORIENTATION_TYPE.ROTATED_270_DEGREES_CLOCKWISE;

pub const AUDIO_MICROPHONE_BOOST_NOTIFICATION = extern struct {
    endpoint: ?*IMMDevice,
    eventContext: Guid,
...
pub const APO_NOTIFICATION = extern struct {
    ...
    Anonymous: extern union {
        ...
        audioEndpointVolumeChange2: AUDIO_ENDPOINT_VOLUME_CHANGE_NOTIFICATION2,
        deviceOrientation: DEVICE_ORIENTATION_TYPE,
        audioMicrophoneBoostChange: AUDIO_MICROPHONE_BOOST_NOTIFICATION,
    },
};
...
pub const AUDIO_MICROPHONE_BOOST_APO_NOTIFICATION_DESCRIPTOR = extern struct {
    device: ?*IMMDevice,
};
...
pub const APO_NOTIFICATION_DESCRIPTOR = extern struct {
    ...
    Anonymous: extern union {
        ...
        audioMicrophoneBoost: AUDIO_MICROPHONE_BOOST_APO_NOTIFICATION_DESCRIPTOR,
    },
};
...
const IID_IAudioProcessingObjectNotifications2_Value = Guid.initString("ca2cfbde-a9d6-4eb0-bc95-c4d026b380f0");
pub const IID_IAudioProcessingObjectNotifications2 = &IID_IAudioProcessingObjectNotifications2_Value;
pub const IAudioProcessingObjectNotifications2 = extern struct {
    pub const VTable = extern struct {
        base: IAudioProcessingObjectNotifications.VTable,
        GetApoNotificationRegistrationInfo2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IAudioProcessingObjectNotifications2,
    ...
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IAudioProcessingObjectNotifications.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAudioProcessingObjectNotifications2_GetApoNotificationRegistrationInfo2(self: *const T, maxApoNotificationTypeSupported: APO_NOTIFICATION_TYPE, apoNotifications: [*]?*APO_NOTIFICATION_DESCRIPTOR, count: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IAudioProcessingObjectNotifications2.VTable, @ptrCast(self.vtable)).GetApoNotificationRegistrationInfo2(@as(*const IAudioProcessingObjectNotifications2, @ptrCast(self)), maxApoNotificationTypeSupported, apoNotifications, count);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
const AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE = @import("../../../../windows/win32/media/audio.zig").AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE;
const AUDIO_VOLUME_NOTIFICATION_DATA = @import("../../../../windows/win32/media/audio.zig").AUDIO_VOLUME_NOTIFICATION_DATA;
...
const IMMDevice = @import("../../../../windows/win32/media/audio.zig").IMMDevice;
const IMMDeviceCollection = @import("../../../../windows/win32/media/audio.zig").IMMDeviceCollection;
