...
pub extern "rstrtmgr" fn RmJoinSession(
    pSessionHandle: ?*u32,
    strSessionKey: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "rstrtmgr" fn RmRegisterResources(
    dwSessionHandle: u32,
    nFiles: u32,
    rgsFileNames: ?[*]const ?[*:0]align(1) const u16,
    nApplications: u32,
    rgApplications: ?[*]RM_UNIQUE_PROCESS,
    nServices: u32,
    rgsServiceNames: ?[*]const ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "rstrtmgr" fn RmAddFilter(
    dwSessionHandle: u32,
    strModuleName: ?[*:0]align(1) const u16,
    pProcess: ?*RM_UNIQUE_PROCESS,
    strServiceShortName: ?[*:0]align(1) const u16,
    FilterAction: RM_FILTER_ACTION,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
