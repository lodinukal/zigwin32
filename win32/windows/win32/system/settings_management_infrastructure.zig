...
pub const ISettingsIdentity = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsIdentity_GetAttribute(self: *const T, Reserved: ?*anyopaque, Name: ?[*:0]align(1) const u16, Value: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsIdentity_SetAttribute(self: *const T, Reserved: ?*anyopaque, Name: ?[*:0]align(1) const u16, Value: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ITargetInfo = extern struct {
    pub const VTable = extern struct {
        ...
        SetTemporaryStoreLocation: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                TemporaryStoreLocation: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ITargetInfo,
                TemporaryStoreLocation: ?[*:0]align(1) const u16,
        ...
        SetTargetProcessorArchitecture: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                ProcessorArchitecture: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ITargetInfo,
                ProcessorArchitecture: ?[*:0]align(1) const u16,
        ...
        SetWow64Context: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                InstallerModule: ?[*:0]align(1) const u16,
                Wow64Context: ?*u8,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ITargetInfo,
        ...
        TranslateWow64: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                ClientArchitecture: ?[*:0]align(1) const u16,
                Value: ?[*:0]align(1) const u16,
        ...
        SetSchemaHiveLocation: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                pwzHiveDir: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ITargetInfo,
                pwzHiveDir: ?[*:0]align(1) const u16,
        ...
        SetSchemaHiveMountName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ITargetInfo,
                pwzMountName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ITargetInfo,
                pwzMountName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetTemporaryStoreLocation(self: *const T, TemporaryStoreLocation: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetTargetProcessorArchitecture(self: *const T, ProcessorArchitecture: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_GetProperty(self: *const T, Offline: BOOL, Property: ?[*:0]align(1) const u16, Value: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetProperty(self: *const T, Offline: BOOL, Property: ?[*:0]align(1) const u16, Value: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_ExpandTarget(self: *const T, Offline: BOOL, Location: ?[*:0]align(1) const u16, ExpandedLocation: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_ExpandTargetPath(self: *const T, Offline: BOOL, Location: ?[*:0]align(1) const u16, ExpandedLocation: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetModulePath(self: *const T, Module: ?[*:0]align(1) const u16, Path: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const ITargetInfo.VTable, @ptrCast(self.vtable)).SetModulePath(@as(*const ITargetInfo, @ptrCast(self)), Module, Path);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_LoadModule(self: *const T, Module: ?[*:0]align(1) const u16, ModuleHandle: ?*HMODULE) callconv(.Inline) HRESULT {
            return @as(*const ITargetInfo.VTable, @ptrCast(self.vtable)).LoadModule(@as(*const ITargetInfo, @ptrCast(self)), Module, ModuleHandle);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetWow64Context(self: *const T, InstallerModule: ?[*:0]align(1) const u16, Wow64Context: ?*u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_TranslateWow64(self: *const T, ClientArchitecture: ?[*:0]align(1) const u16, Value: ?[*:0]align(1) const u16, TranslatedValue: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetSchemaHiveLocation(self: *const T, pwzHiveDir: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITargetInfo_SetSchemaHiveMountName(self: *const T, pwzMountName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISettingsItem = extern struct {
    pub const VTable = extern struct {
        ...
        RemoveListElement: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISettingsItem,
                ElementName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISettingsItem,
                ElementName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_GetChild(self: *const T, Name: ?[*:0]align(1) const u16, Child: ?*?*ISettingsItem) callconv(.Inline) HRESULT {
            return @as(*const ISettingsItem.VTable, @ptrCast(self.vtable)).GetChild(@as(*const ISettingsItem, @ptrCast(self)), Name, Child);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_GetSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16, Setting: ?*?*ISettingsItem) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_CreateSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16, Setting: ?*?*ISettingsItem) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_RemoveSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_RemoveListElement(self: *const T, ElementName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsItem_GetAttribute(self: *const T, Name: ?[*:0]align(1) const u16, Value: ?*VARIANT) callconv(.Inline) HRESULT {
...
pub const ISettingsNamespace = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsNamespace_GetSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16, Setting: ?*?*ISettingsItem) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsNamespace_CreateSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16, Setting: ?*?*ISettingsItem) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsNamespace_RemoveSettingByPath(self: *const T, Path: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsNamespace_GetAttribute(self: *const T, Name: ?[*:0]align(1) const u16, Value: ?*VARIANT) callconv(.Inline) HRESULT {
...
pub const ISettingsContext = extern struct {
    pub const VTable = extern struct {
        ...
        RevertSetting: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISettingsContext,
                pIdentity: ?*ISettingsIdentity,
                pwzSetting: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISettingsContext,
                pIdentity: ?*ISettingsIdentity,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISettingsContext_RevertSetting(self: *const T, pIdentity: ?*ISettingsIdentity, pwzSetting: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
