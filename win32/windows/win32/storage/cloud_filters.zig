...
pub const CF_PLACEHOLDER_CREATE_FLAGS = enum(i32) {
    NONE = 0,
...
pub const CF_PLACEHOLDER_CREATE_INFO = extern struct {
    RelativeFileName: ?[*:0]align(1) const u16,
...
pub const CF_PROCESS_INFO = extern struct {
    ...
    PackageName: ?[*:0]align(1) const u16,
    ApplicationId: ?[*:0]align(1) const u16,
...
pub const CF_REGISTER_FLAGS = enum(i32) {
    NONE = 0,
    UPDATE = 1,
...
pub const CF_HARDLINK_POLICY = enum(i32) {
    NONE = 0,
    ALLOWED = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_SYNC_REGISTRATION = extern struct {
    ...
    ProviderVersion: ?[*:0]align(1) const u16,
...
pub const CF_CALLBACK_INFO = extern struct {
    ...
    VolumeGuidName: ?[*:0]align(1) const u16,
    VolumeDosName: ?[*:0]align(1) const u16,
    ...
    FileIdentity: ?*const anyopaque,
    FileIdentityLength: u32,
    NormalizedPath: ?[*:0]align(1) const u16,
    TransferKey: i64,
    PriorityHint: u8,
...
pub const CF_CALLBACK_CANCEL_FLAGS = enum(i32) {
    NONE = 0,
    IO_TIMEOUT = 1,
    IO_ABORTED = 2,
    _,
...
pub const CF_CALLBACK_FETCH_DATA_FLAGS = enum(i32) {
    NONE = 0,
    RECOVERY = 1,
...
pub const CF_CALLBACK_VALIDATE_DATA_FLAGS = enum(i32) {
    NONE = 0,
    EXPLICIT_HYDRATION = 2,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_CALLBACK_OPEN_COMPLETION_FLAGS = enum(i32) {
    NONE = 0,
...
pub const CF_CALLBACK_CLOSE_COMPLETION_FLAGS = enum(i32) {
    NONE = 0,
    DELETED = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_CALLBACK_DEHYDRATE_FLAGS = enum(i32) {
    NONE = 0,
    BACKGROUND = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS = enum(i32) {
    NONE = 0,
    BACKGROUND = 1,
    DEHYDRATED = 2,
    _,
...
pub const CF_CALLBACK_DELETE_FLAGS = enum(i32) {
    NONE = 0,
    IS_DIRECTORY = 1,
    IS_UNDELETE = 2,
    _,
...
pub const CF_CALLBACK_DELETE_COMPLETION_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_CALLBACK_RENAME_FLAGS = enum(i32) {
    NONE = 0,
    IS_DIRECTORY = 1,
    SOURCE_IN_SCOPE = 2,
    TARGET_IN_SCOPE = 4,
...
pub const CF_CALLBACK_RENAME_COMPLETION_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_CONNECT_FLAGS = enum(i32) {
    NONE = 0,
...
pub const CF_OPERATION_TRANSFER_DATA_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_OPERATION_RETRIEVE_DATA_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_OPERATION_ACK_DATA_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_OPERATION_RESTART_HYDRATION_FLAGS = enum(i32) {
    NONE = 0,
    MARK_IN_SYNC = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS = enum(i32) {
    NONE = 0,
    STOP_ON_ERROR = 1,
...
pub const CF_OPERATION_ACK_DEHYDRATE_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_OPERATION_ACK_RENAME_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_OPERATION_ACK_DELETE_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_CREATE_FLAGS = enum(i32) {
    NONE = 0,
    STOP_ON_ERROR = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_OPEN_FILE_FLAGS = enum(i32) {
    NONE = 0,
    EXCLUSIVE = 1,
    WRITE_ACCESS = 2,
    DELETE_ACCESS = 4,
...
pub const CF_CONVERT_FLAGS = enum(i32) {
    NONE = 0,
    MARK_IN_SYNC = 1,
    DEHYDRATE = 2,
...
pub const CF_UPDATE_FLAGS = enum(i32) {
    NONE = 0,
    VERIFY_IN_SYNC = 1,
    MARK_IN_SYNC = 2,
    DEHYDRATE = 4,
...
pub const CF_REVERT_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_HYDRATE_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub const CF_DEHYDRATE_FLAGS = enum(i32) {
    NONE = 0,
    BACKGROUND = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const CF_SET_PIN_FLAGS = enum(i32) {
    NONE = 0,
    RECURSE = 1,
    RECURSE_ONLY = 2,
...
pub const CF_SET_IN_SYNC_FLAGS = enum(i32) {
    E = 0,
    _,
    pub fn initFlags(o: struct {
        E: u1 = 0,
...
pub extern "cldapi" fn CfRegisterSyncRoot(
    SyncRootPath: ?[*:0]align(1) const u16,
...
pub extern "cldapi" fn CfCreatePlaceholders(
    BaseDirectoryPath: ?[*:0]align(1) const u16,
    PlaceholderArray: [*]CF_PLACEHOLDER_CREATE_INFO,
    PlaceholderCount: u32,
...
pub extern "cldapi" fn CfGetPlaceholderRangeInfoForHydration(
    ConnectionKey: CF_CONNECTION_KEY,
    TransferKey: i64,
    FileId: i64,
    InfoClass: CF_PLACEHOLDER_RANGE_INFO_CLASS,
...
const CORRELATION_VECTOR = @import("../../../windows/win32/system/correlation_vector.zig").CORRELATION_VECTOR;
const FILE_BASIC_INFO = @import("../../../windows/win32/storage/file_system.zig").FILE_BASIC_INFO;
const FILE_INFO_BY_HANDLE_CLASS = @import("../../../windows/win32/storage/file_system.zig").FILE_INFO_BY_HANDLE_CLASS;
