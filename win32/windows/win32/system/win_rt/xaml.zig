...
pub const ITrackerOwner = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITrackerOwner_CreateTrackerHandle(self: *const T, returnValue: ?*TrackerHandle) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITrackerOwner_DeleteTrackerHandle(self: *const T, handle: TrackerHandle) callconv(.Inline) HRESULT {
            return @as(*const ITrackerOwner.VTable, @ptrCast(self.vtable)).DeleteTrackerHandle(@as(*const ITrackerOwner, @ptrCast(self)), handle);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITrackerOwner_SetTrackerValue(self: *const T, handle: TrackerHandle, value: ?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITrackerOwner_TryGetSafeTrackerValue(self: *const T, handle: TrackerHandle, returnValue: ?*?*IUnknown) callconv(.Inline) u8 {
