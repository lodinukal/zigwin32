...
pub const MD_APPPOOL_EMULATION_ON_WINARM64 = @as(u32, 9043);
...
// Section: Types (83)
//--------------------------------------------------------------------------------
pub const PFN_IIS_GETSERVERVARIABLE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HCONN,
        param1: ?PSTR,
        param2: ?*anyopaque,
...
pub const PFN_IIS_WRITECLIENT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HCONN,
        param1: ?*anyopaque,
        param2: ?*u32,
...
pub const PFN_IIS_READCLIENT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HCONN,
        param1: ?*anyopaque,
        param2: ?*u32,
...
pub const PFN_IIS_SERVERSUPPORTFUNCTION = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HCONN,
        param1: u32,
        param2: ?*anyopaque,
...
pub const IFtpAuthenticationProvider = extern struct {
    pub const VTable = extern struct {
        ...
        AuthenticateUser: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszSessionId: ?[*:0]align(1) const u16,
                pszSiteName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFtpAuthenticationProvider_AuthenticateUser(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszPassword: ?[*:0]align(1) const u16, ppszCanonicalUserName: ?*?PWSTR, pfAuthenticated: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const AsyncIFtpAuthenticationProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn AsyncIFtpAuthenticationProvider_Begin_AuthenticateUser(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszPassword: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IFtpRoleProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFtpRoleProvider_IsUserInRole(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszRole: ?[*:0]align(1) const u16, pfIsInRole: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const AsyncIFtpRoleProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn AsyncIFtpRoleProvider_Begin_IsUserInRole(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszRole: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IFtpHomeDirectoryProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFtpHomeDirectoryProvider_GetUserHomeDirectoryData(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, ppszHomeDirectoryData: ?*?PWSTR) callconv(.Inline) HRESULT {
...
pub const AsyncIFtpHomeDirectoryProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn AsyncIFtpHomeDirectoryProvider_Begin_GetUserHomeDirectoryData(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const LOGGING_PARAMETERS = extern struct {
    ...
    pszSiteName: ?[*:0]align(1) const u16,
    pszUserName: ?[*:0]align(1) const u16,
    pszHostName: ?[*:0]align(1) const u16,
    pszRemoteIpAddress: ?[*:0]align(1) const u16,
    dwRemoteIpPort: u32,
    pszLocalIpAddress: ?[*:0]align(1) const u16,
    dwLocalIpPort: u32,
    BytesSent: u64,
    BytesReceived: u64,
    pszCommand: ?[*:0]align(1) const u16,
    pszCommandParameters: ?[*:0]align(1) const u16,
    pszFullPath: ?[*:0]align(1) const u16,
    dwElapsedMilliseconds: u32,
    FtpStatus: u32,
    FtpSubStatus: u32,
    hrStatus: HRESULT,
    pszInformation: ?[*:0]align(1) const u16,
};
...
pub const IFtpAuthorizationProvider = extern struct {
    pub const VTable = extern struct {
        ...
        GetUserAccessPermission: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszSessionId: ?[*:0]align(1) const u16,
                pszSiteName: ?[*:0]align(1) const u16,
                pszVirtualPath: ?[*:0]align(1) const u16,
                pszUserName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFtpAuthorizationProvider_GetUserAccessPermission(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszVirtualPath: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pFtpAccess: ?*FTP_ACCESS) callconv(.Inline) HRESULT {
...
pub const AsyncIFtpAuthorizationProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn AsyncIFtpAuthorizationProvider_Begin_GetUserAccessPermission(self: *const T, pszSessionId: ?[*:0]align(1) const u16, pszSiteName: ?[*:0]align(1) const u16, pszVirtualPath: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const POST_PROCESS_PARAMETERS = extern struct {
    ...
    pszCommandParameters: ?[*:0]align(1) const u16,
    pszFullPath: ?[*:0]align(1) const u16,
    pszPhysicalPath: ?[*:0]align(1) const u16,
    FtpStatus: u32,
    FtpSubStatus: u32,
    hrStatus: HRESULT,
    SessionStartTime: FILETIME,
...
pub const IMSAdminBaseW = extern struct {
    pub const VTable = extern struct {
        ...
        CopyKey: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMSAdminBaseW,
                hMDSourceHandle: u32,
                pszMDSourcePath: ?[*:0]align(1) const u16,
                hMDDestHandle: u32,
                pszMDDestPath: ?[*:0]align(1) const u16,
        ...
        RenameKey: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                hMDHandle: u32,
                pszMDPath: ?[*:0]align(1) const u16,
                pszMDNewName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMSAdminBaseW,
                hMDHandle: u32,
        ...
        Backup: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMSAdminBaseW,
                pszMDBackupLocation: ?[*:0]align(1) const u16,
                dwMDVersion: u32,
                dwMDFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_AddKey(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).AddKey(@as(*const IMSAdminBaseW, @ptrCast(self)), hMDHandle, pszMDPath);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_DeleteKey(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_DeleteChildKeys(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_EnumKeys(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pszMDName: *[256]u16, dwMDEnumObjectIndex: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_CopyKey(self: *const T, hMDSourceHandle: u32, pszMDSourcePath: ?[*:0]align(1) const u16, hMDDestHandle: u32, pszMDDestPath: ?[*:0]align(1) const u16, bMDOverwriteFlag: BOOL, bMDCopyFlag: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_RenameKey(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pszMDNewName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_SetData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pmdrMDData: ?*METADATA_RECORD) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_GetData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pmdrMDData: ?*METADATA_RECORD, pdwMDRequiredDataLen: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_DeleteData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, dwMDIdentifier: u32, dwMDDataType: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_EnumData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pmdrMDData: ?*METADATA_RECORD, dwMDEnumDataIndex: u32, pdwMDRequiredDataLen: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_GetAllData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, dwMDAttributes: u32, dwMDUserType: u32, dwMDDataType: u32, pdwMDNumDataEntries: ?*u32, pdwMDDataSetNumber: ?*u32, dwMDBufferSize: u32, pbMDBuffer: ?*u8, pdwMDRequiredBufferSize: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_DeleteAllData(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, dwMDUserType: u32, dwMDDataType: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_CopyData(self: *const T, hMDSourceHandle: u32, pszMDSourcePath: ?[*:0]align(1) const u16, hMDDestHandle: u32, pszMDDestPath: ?[*:0]align(1) const u16, dwMDAttributes: u32, dwMDUserType: u32, dwMDDataType: u32, bMDCopyFlag: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_GetDataPaths(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, dwMDIdentifier: u32, dwMDDataType: u32, dwMDBufferSize: u32, pszBuffer: [*:0]u16, pdwMDRequiredBufferSize: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_OpenKey(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, dwMDAccessRequested: u32, dwMDTimeOut: u32, phMDNewHandle: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_GetDataSetNumber(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pdwMDDataSetNumber: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_SetLastChangeTime(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pftMDLastChangeTime: ?*FILETIME, bLocalTime: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_GetLastChangeTime(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, pftMDLastChangeTime: ?*FILETIME, bLocalTime: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_Backup(self: *const T, pszMDBackupLocation: ?[*:0]align(1) const u16, dwMDVersion: u32, dwMDFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_Restore(self: *const T, pszMDBackupLocation: ?[*:0]align(1) const u16, dwMDVersion: u32, dwMDFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBaseW_DeleteBackup(self: *const T, pszMDBackupLocation: ?[*:0]align(1) const u16, dwMDVersion: u32) callconv(.Inline) HRESULT {
...
pub const IMSAdminBase2W = extern struct {
    pub const VTable = extern struct {
        ...
        Export: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszSourcePath: ?[*:0]align(1) const u16,
                dwMDFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMSAdminBase2W,
        ...
        Import: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszFileName: ?[*:0]align(1) const u16,
                pszSourcePath: ?[*:0]align(1) const u16,
                pszDestPath: ?[*:0]align(1) const u16,
                dwMDFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMSAdminBase2W,
        ...
        RestoreHistory: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMSAdminBase2W,
                pszMDHistoryLocation: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase2W_BackupWithPasswd(self: *const T, pszMDBackupLocation: ?[*:0]align(1) const u16, dwMDVersion: u32, dwMDFlags: u32, pszPasswd: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase2W_RestoreWithPasswd(self: *const T, pszMDBackupLocation: ?[*:0]align(1) const u16, dwMDVersion: u32, dwMDFlags: u32, pszPasswd: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase2W_Export(self: *const T, pszPasswd: ?[*:0]align(1) const u16, pszFileName: ?[*:0]align(1) const u16, pszSourcePath: ?[*:0]align(1) const u16, dwMDFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase2W_Import(self: *const T, pszPasswd: ?[*:0]align(1) const u16, pszFileName: ?[*:0]align(1) const u16, pszSourcePath: ?[*:0]align(1) const u16, pszDestPath: ?[*:0]align(1) const u16, dwMDFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase2W_RestoreHistory(self: *const T, pszMDHistoryLocation: ?[*:0]align(1) const u16, dwMDMajorVersion: u32, dwMDMinorVersion: u32, dwMDFlags: u32) callconv(.Inline) HRESULT {
...
pub const IMSAdminBase3W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSAdminBase3W_GetChildPaths(self: *const T, hMDHandle: u32, pszMDPath: ?[*:0]align(1) const u16, cchMDBufferSize: u32, pszBuffer: ?[*:0]u16, pcchMDRequiredBufferSize: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMSImpExpHelpW = extern struct {
    pub const VTable = extern struct {
        ...
        EnumeratePathsInFile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszFileName: ?[*:0]align(1) const u16,
                pszKeyType: ?[*:0]align(1) const u16,
                dwMDBufferSize: u32,
                pszBuffer: ?[*:0]u16,
                pdwMDRequiredBufferSize: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSImpExpHelpW_EnumeratePathsInFile(self: *const T, pszFileName: ?[*:0]align(1) const u16, pszKeyType: ?[*:0]align(1) const u16, dwMDBufferSize: u32, pszBuffer: ?[*:0]u16, pdwMDRequiredBufferSize: ?*u32) callconv(.Inline) HRESULT {
...
pub const HSE_TF_INFO = extern struct {
    ...
    pContext: ?*anyopaque,
    hFile: ?HANDLE,
    pszStatusCode: ?[*:0]align(1) const u8,
    BytesToWrite: u32,
    Offset: u32,
    pHead: ?*anyopaque,
    HeadLength: u32,
...
pub const HSE_SEND_HEADER_EX_INFO = extern struct {
    pszStatus: ?[*:0]align(1) const u8,
    pszHeader: ?[*:0]align(1) const u8,
    cchStatus: u32,
    cchHeader: u32,
    fKeepConn: BOOL,
};
...
pub const PFN_HSE_GET_PROTOCOL_MANAGER_CUSTOM_INTERFACE_CALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszProtocolManagerDll: ?[*:0]align(1) const u16,
        pszProtocolManagerDllInitFunction: ?[*:0]align(1) const u16,
...
pub const HTTP_FILTER_URL_MAP_EX = extern struct {
    ...
    cchMatchingPath: u32,
    cchMatchingURL: u32,
    pszScriptMapEntry: ?[*:0]align(1) const u8,
};

pub const HTTP_FILTER_ACCESS_DENIED = extern struct {
    pszURL: ?[*:0]align(1) const u8,
    pszPhysicalPath: ?[*:0]align(1) const u8,
    dwReason: u32,
};

pub const HTTP_FILTER_LOG = extern struct {
    pszClientHostName: ?[*:0]align(1) const u8,
    pszClientUserName: ?[*:0]align(1) const u8,
    pszServerName: ?[*:0]align(1) const u8,
    pszOperation: ?[*:0]align(1) const u8,
    pszTarget: ?[*:0]align(1) const u8,
    pszParameters: ?[*:0]align(1) const u8,
    dwHttpStatus: u32,
    dwWin32Status: u32,
    dwBytesSent: u32,
    dwBytesRecvd: u32,
...
pub const HTTP_TRACE_EVENT_ITEM = extern struct {
    ...
    pbData: ?*u8,
    cbData: u32,
    pszDataDescription: ?[*:0]align(1) const u16,
};
...
pub const PFN_WEB_CORE_SET_METADATA_DLL_ENTRY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszMetadataType: ?[*:0]align(1) const u16,
...
pub const PFN_WEB_CORE_ACTIVATE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszAppHostConfigFile: ?[*:0]align(1) const u16,
        pszRootWebConfigFile: ?[*:0]align(1) const u16,
        pszInstanceName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    else => *const fn(
        pszAppHostConfigFile: ?[*:0]align(1) const u16,
        pszRootWebConfigFile: ?[*:0]align(1) const u16,
...
test {
    ...
    if (@hasDecl(@This(), "PFN_IIS_GETSERVERVARIABLE")) { _ = PFN_IIS_GETSERVERVARIABLE; }
    if (@hasDecl(@This(), "PFN_IIS_WRITECLIENT")) { _ = PFN_IIS_WRITECLIENT; }
    if (@hasDecl(@This(), "PFN_IIS_READCLIENT")) { _ = PFN_IIS_READCLIENT; }
    if (@hasDecl(@This(), "PFN_IIS_SERVERSUPPORTFUNCTION")) { _ = PFN_IIS_SERVERSUPPORTFUNCTION; }
