...
pub const MQ_QTYPE_REPORT = Guid.initString("55ee8f32-cce9-11cf-b108-0020afd61ce9");
pub const MQ_QTYPE_TEST = Guid.initString("55ee8f33-cce9-11cf-b108-0020afd61ce9");
...
// Section: Types (103)
//--------------------------------------------------------------------------------
pub const MQQUEUEACCESSMASK = enum(u32) {
    DELETE_QUEUE = 65536,
    GET_QUEUE_PERMISSIONS = 131072,
    CHANGE_QUEUE_PERMISSIONS = 262144,
    TAKE_QUEUE_OWNERSHIP = 524288,
    RECEIVE_MESSAGE = 3,
    RECEIVE_JOURNAL_MESSAGE = 10,
    QUEUE_GENERIC_READ = 131115,
    QUEUE_GENERIC_WRITE = 131108,
    QUEUE_GENERIC_ALL = 983103,
    DELETE_MESSAGE = 1,
    PEEK_MESSAGE = 2,
    WRITE_MESSAGE = 4,
    DELETE_JOURNAL_MESSAGE = 8,
    SET_QUEUE_PROPERTIES = 16,
    GET_QUEUE_PROPERTIES = 32,
    QUEUE_GENERIC_EXECUTE = 0,
    _,
    pub fn initFlags(o: struct {
        DELETE_QUEUE: u1 = 0,
        GET_QUEUE_PERMISSIONS: u1 = 0,
        CHANGE_QUEUE_PERMISSIONS: u1 = 0,
        TAKE_QUEUE_OWNERSHIP: u1 = 0,
        RECEIVE_MESSAGE: u1 = 0,
        RECEIVE_JOURNAL_MESSAGE: u1 = 0,
        QUEUE_GENERIC_READ: u1 = 0,
        QUEUE_GENERIC_WRITE: u1 = 0,
        QUEUE_GENERIC_ALL: u1 = 0,
        DELETE_MESSAGE: u1 = 0,
        PEEK_MESSAGE: u1 = 0,
        WRITE_MESSAGE: u1 = 0,
        DELETE_JOURNAL_MESSAGE: u1 = 0,
        SET_QUEUE_PROPERTIES: u1 = 0,
        GET_QUEUE_PROPERTIES: u1 = 0,
        QUEUE_GENERIC_EXECUTE: u1 = 0,
    }) MQQUEUEACCESSMASK {
        return @as(MQQUEUEACCESSMASK, @enumFromInt(
              (if (o.DELETE_QUEUE == 1) @intFromEnum(MQQUEUEACCESSMASK.DELETE_QUEUE) else 0)
            | (if (o.GET_QUEUE_PERMISSIONS == 1) @intFromEnum(MQQUEUEACCESSMASK.GET_QUEUE_PERMISSIONS) else 0)
            | (if (o.CHANGE_QUEUE_PERMISSIONS == 1) @intFromEnum(MQQUEUEACCESSMASK.CHANGE_QUEUE_PERMISSIONS) else 0)
            | (if (o.TAKE_QUEUE_OWNERSHIP == 1) @intFromEnum(MQQUEUEACCESSMASK.TAKE_QUEUE_OWNERSHIP) else 0)
            | (if (o.RECEIVE_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.RECEIVE_MESSAGE) else 0)
            | (if (o.RECEIVE_JOURNAL_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.RECEIVE_JOURNAL_MESSAGE) else 0)
            | (if (o.QUEUE_GENERIC_READ == 1) @intFromEnum(MQQUEUEACCESSMASK.QUEUE_GENERIC_READ) else 0)
            | (if (o.QUEUE_GENERIC_WRITE == 1) @intFromEnum(MQQUEUEACCESSMASK.QUEUE_GENERIC_WRITE) else 0)
            | (if (o.QUEUE_GENERIC_ALL == 1) @intFromEnum(MQQUEUEACCESSMASK.QUEUE_GENERIC_ALL) else 0)
            | (if (o.DELETE_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.DELETE_MESSAGE) else 0)
            | (if (o.PEEK_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.PEEK_MESSAGE) else 0)
            | (if (o.WRITE_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.WRITE_MESSAGE) else 0)
            | (if (o.DELETE_JOURNAL_MESSAGE == 1) @intFromEnum(MQQUEUEACCESSMASK.DELETE_JOURNAL_MESSAGE) else 0)
            | (if (o.SET_QUEUE_PROPERTIES == 1) @intFromEnum(MQQUEUEACCESSMASK.SET_QUEUE_PROPERTIES) else 0)
            | (if (o.GET_QUEUE_PROPERTIES == 1) @intFromEnum(MQQUEUEACCESSMASK.GET_QUEUE_PROPERTIES) else 0)
            | (if (o.QUEUE_GENERIC_EXECUTE == 1) @intFromEnum(MQQUEUEACCESSMASK.QUEUE_GENERIC_EXECUTE) else 0)
        ));
    }
};
pub const MQSEC_DELETE_QUEUE = MQQUEUEACCESSMASK.DELETE_QUEUE;
pub const MQSEC_GET_QUEUE_PERMISSIONS = MQQUEUEACCESSMASK.GET_QUEUE_PERMISSIONS;
pub const MQSEC_CHANGE_QUEUE_PERMISSIONS = MQQUEUEACCESSMASK.CHANGE_QUEUE_PERMISSIONS;
pub const MQSEC_TAKE_QUEUE_OWNERSHIP = MQQUEUEACCESSMASK.TAKE_QUEUE_OWNERSHIP;
pub const MQSEC_RECEIVE_MESSAGE = MQQUEUEACCESSMASK.RECEIVE_MESSAGE;
pub const MQSEC_RECEIVE_JOURNAL_MESSAGE = MQQUEUEACCESSMASK.RECEIVE_JOURNAL_MESSAGE;
pub const MQSEC_QUEUE_GENERIC_READ = MQQUEUEACCESSMASK.QUEUE_GENERIC_READ;
pub const MQSEC_QUEUE_GENERIC_WRITE = MQQUEUEACCESSMASK.QUEUE_GENERIC_WRITE;
pub const MQSEC_QUEUE_GENERIC_ALL = MQQUEUEACCESSMASK.QUEUE_GENERIC_ALL;
pub const MQSEC_DELETE_MESSAGE = MQQUEUEACCESSMASK.DELETE_MESSAGE;
pub const MQSEC_PEEK_MESSAGE = MQQUEUEACCESSMASK.PEEK_MESSAGE;
pub const MQSEC_WRITE_MESSAGE = MQQUEUEACCESSMASK.WRITE_MESSAGE;
pub const MQSEC_DELETE_JOURNAL_MESSAGE = MQQUEUEACCESSMASK.DELETE_JOURNAL_MESSAGE;
pub const MQSEC_SET_QUEUE_PROPERTIES = MQQUEUEACCESSMASK.SET_QUEUE_PROPERTIES;
pub const MQSEC_GET_QUEUE_PROPERTIES = MQQUEUEACCESSMASK.GET_QUEUE_PROPERTIES;
pub const MQSEC_QUEUE_GENERIC_EXECUTE = MQQUEUEACCESSMASK.QUEUE_GENERIC_EXECUTE;
...
pub const IMSMQQueueInfo3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueueInfo3_get_IsTransactional2(self: *const T, pisTransactional: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueueInfo3_get_IsWorldReadable2(self: *const T, pisWorldReadable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQQueueInfo4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueueInfo4_get_IsTransactional2(self: *const T, pisTransactional: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueueInfo4_get_IsWorldReadable2(self: *const T, pisWorldReadable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQQueue3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueue3_get_IsOpen2(self: *const T, pisOpen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQQueue4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQQueue4_get_IsOpen2(self: *const T, pisOpen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQMessage3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage3_get_IsAuthenticated2(self: *const T, pisAuthenticated: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage3_get_IsFirstInTransaction2(self: *const T, pisFirstInXact: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage3_get_IsLastInTransaction2(self: *const T, pisLastInXact: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQMessage4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage4_get_IsAuthenticated2(self: *const T, pisAuthenticated: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage4_get_IsFirstInTransaction2(self: *const T, pisFirstInXact: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQMessage4_get_IsLastInTransaction2(self: *const T, pisLastInXact: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQApplication2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQApplication2_get_IsDsEnabled(self: *const T, pfIsDsEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQApplication3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQApplication3_get_IsConnected(self: *const T, pfIsConnected: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQDestination = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQDestination_get_IsOpen(self: *const T, pfIsOpen: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSMQManagement = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSMQManagement_get_IsLocal(self: *const T, pfIsLocal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const MQPROPERTYRESTRICTION = extern struct {
    rel: u32,
    prop: u32,
    prval: PROPVARIANT,
};

pub const MQRESTRICTION = extern struct {
    cRes: u32,
...
pub const MQMSGPROPS = extern struct {
    cProp: u32,
    aPropID: ?*u32,
...
pub const MQQUEUEPROPS = extern struct {
    cProp: u32,
    aPropID: ?*u32,
    aPropVar: ?*PROPVARIANT,
    aStatus: ?*HRESULT,
...
pub const MQQMPROPS = extern struct {
    cProp: u32,
    aPropID: ?*u32,
    aPropVar: ?*PROPVARIANT,
    aStatus: ?*HRESULT,
...
pub const MQPRIVATEPROPS = extern struct {
    cProp: u32,
    aPropID: ?*u32,
    aPropVar: ?*PROPVARIANT,
    aStatus: ?*HRESULT,
...
pub const MQMGMTPROPS = extern struct {
    cProp: u32,
    aPropID: ?*u32,
    aPropVar: ?*PROPVARIANT,
    aStatus: ?*HRESULT,
...
pub const MQConnectionState = enum(i32) {
    NOFAILURE = 0,
    ESTABLISH_PACKET_RECEIVED = 1,
    READY = 2,
    UNKNOWN_FAILURE = -2147483648,
    PING_FAILURE = -2147483647,
    CREATE_SOCKET_FAILURE = -2147483646,
    BIND_SOCKET_FAILURE = -2147483645,
    CONNECT_SOCKET_FAILURE = -2147483644,
    TCP_NOT_ENABLED = -2147483643,
    SEND_FAILURE = -2147483642,
    NOT_READY = -2147483641,
    NAME_RESOLUTION_FAILURE = -2147483640,
    INVALID_SERVER_CERT = -2147483639,
    LIMIT_REACHED = -2147483638,
    REFUSED_BY_OTHER_SIDE = -2147483637,
    ROUTING_FAILURE = -2147483636,
    OUT_OF_MEMORY = -2147483635,
};
pub const MQCONN_NOFAILURE = MQConnectionState.NOFAILURE;
pub const MQCONN_ESTABLISH_PACKET_RECEIVED = MQConnectionState.ESTABLISH_PACKET_RECEIVED;
pub const MQCONN_READY = MQConnectionState.READY;
pub const MQCONN_UNKNOWN_FAILURE = MQConnectionState.UNKNOWN_FAILURE;
pub const MQCONN_PING_FAILURE = MQConnectionState.PING_FAILURE;
pub const MQCONN_CREATE_SOCKET_FAILURE = MQConnectionState.CREATE_SOCKET_FAILURE;
pub const MQCONN_BIND_SOCKET_FAILURE = MQConnectionState.BIND_SOCKET_FAILURE;
pub const MQCONN_CONNECT_SOCKET_FAILURE = MQConnectionState.CONNECT_SOCKET_FAILURE;
pub const MQCONN_TCP_NOT_ENABLED = MQConnectionState.TCP_NOT_ENABLED;
pub const MQCONN_SEND_FAILURE = MQConnectionState.SEND_FAILURE;
pub const MQCONN_NOT_READY = MQConnectionState.NOT_READY;
pub const MQCONN_NAME_RESOLUTION_FAILURE = MQConnectionState.NAME_RESOLUTION_FAILURE;
pub const MQCONN_INVALID_SERVER_CERT = MQConnectionState.INVALID_SERVER_CERT;
pub const MQCONN_LIMIT_REACHED = MQConnectionState.LIMIT_REACHED;
pub const MQCONN_REFUSED_BY_OTHER_SIDE = MQConnectionState.REFUSED_BY_OTHER_SIDE;
pub const MQCONN_ROUTING_FAILURE = MQConnectionState.ROUTING_FAILURE;
pub const MQCONN_OUT_OF_MEMORY = MQConnectionState.OUT_OF_MEMORY;

pub const PMQRECEIVECALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hrStatus: HRESULT,
        hSource: isize,
        dwTimeout: u32,
...
//--------------------------------------------------------------------------------
pub extern "mqrt" fn MQCreateQueue(
    pSecurityDescriptor: ?PSECURITY_DESCRIPTOR,
    pQueueProps: ?*MQQUEUEPROPS,
    lpwcsFormatName: ?[*:0]u16,
    lpdwFormatNameLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQDeleteQueue(
    lpwcsFormatName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQLocateBegin(
    lpwcsContext: ?[*:0]align(1) const u16,
...
pub extern "mqrt" fn MQLocateNext(
    hEnum: ?HANDLE,
    pcProps: ?*u32,
    aPropVar: ?*PROPVARIANT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQLocateEnd(
    hEnum: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQOpenQueue(
    lpwcsFormatName: ?[*:0]align(1) const u16,
    dwAccess: u32,
    dwShareMode: u32,
    phQueue: ?*isize,
...
pub extern "mqrt" fn MQSendMessage(
    hDestinationQueue: isize,
    pMessageProps: ?*MQMSGPROPS,
    pTransaction: ?*ITransaction,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQReceiveMessage(
    hSource: isize,
    dwTimeout: u32,
    dwAction: u32,
    pMessageProps: ?*MQMSGPROPS,
...
pub extern "mqrt" fn MQReceiveMessageByLookupId(
    hSource: isize,
    ullLookupId: u64,
    dwLookupAction: u32,
    pMessageProps: ?*MQMSGPROPS,
...
pub extern "mqrt" fn MQCreateCursor(
    hQueue: isize,
    phCursor: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQCloseCursor(
    hCursor: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQCloseQueue(
    hQueue: isize,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQSetQueueProperties(
    lpwcsFormatName: ?[*:0]align(1) const u16,
    pQueueProps: ?*MQQUEUEPROPS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetQueueProperties(
    lpwcsFormatName: ?[*:0]align(1) const u16,
    pQueueProps: ?*MQQUEUEPROPS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetQueueSecurity(
    lpwcsFormatName: ?[*:0]align(1) const u16,
...
pub extern "mqrt" fn MQSetQueueSecurity(
    lpwcsFormatName: ?[*:0]align(1) const u16,
    SecurityInformation: OBJECT_SECURITY_INFORMATION,
    pSecurityDescriptor: ?PSECURITY_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQPathNameToFormatName(
    lpwcsPathName: ?[*:0]align(1) const u16,
    lpwcsFormatName: [*:0]u16,
    lpdwFormatNameLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQHandleToFormatName(
    hQueue: isize,
    lpwcsFormatName: [*:0]u16,
    lpdwFormatNameLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQInstanceToFormatName(
    pGuid: ?*Guid,
    lpwcsFormatName: [*:0]u16,
    lpdwFormatNameLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQADsPathToFormatName(
    lpwcsADsPath: ?[*:0]align(1) const u16,
    lpwcsFormatName: [*:0]u16,
    lpdwFormatNameLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQFreeMemory(
    pvMemory: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "mqrt" fn MQGetMachineProperties(
    lpwcsMachineName: ?[*:0]align(1) const u16,
    pguidMachineId: ?*const Guid,
    pQMProps: ?*MQQMPROPS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetSecurityContext(
    // TODO: what to do with BytesParamIndex 1?
    lpCertBuffer: ?*anyopaque,
    dwCertBufferLength: u32,
    phSecurityContext: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetSecurityContextEx(
    // TODO: what to do with BytesParamIndex 1?
    lpCertBuffer: ?*anyopaque,
    dwCertBufferLength: u32,
    phSecurityContext: ?*?HANDLE,
...
pub extern "mqrt" fn MQFreeSecurityContext(
    hSecurityContext: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "mqrt" fn MQRegisterCertificate(
    dwFlags: u32,
    lpCertBuffer: ?*anyopaque,
    dwCertBufferLength: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQBeginTransaction(
    ppTransaction: ?*?*ITransaction,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetOverlappedResult(
    lpOverlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQGetPrivateComputerInformation(
    lpwcsComputerName: ?[*:0]align(1) const u16,
    pPrivateProps: ?*MQPRIVATEPROPS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQPurgeQueue(
    hQueue: isize,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQMgmtGetInfo(
    pComputerName: ?[*:0]align(1) const u16,
    pObjectName: ?[*:0]align(1) const u16,
    pMgmtProps: ?*MQMGMTPROPS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQMgmtAction(
    pComputerName: ?[*:0]align(1) const u16,
    pObjectName: ?[*:0]align(1) const u16,
    pAction: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQMarkMessageRejected(
    hQueue: ?HANDLE,
    ullLookupId: u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mqrt" fn MQMoveMessage(
    hSourceQueue: isize,
    hDestinationQueue: isize,
    ullLookupId: u64,
    pTransaction: ?*ITransaction,
...
const ITransaction = @import("../../../windows/win32/system/distributed_transaction_coordinator.zig").ITransaction;
...
test {
    ...
    if (@hasDecl(@This(), "PMQRECEIVECALLBACK")) { _ = PMQRECEIVECALLBACK; }
