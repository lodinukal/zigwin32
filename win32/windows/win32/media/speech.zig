...
pub const SPSTATEHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPWORDHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPRULEHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPGRAMMARHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPRECOCONTEXTHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPPHRASERULEHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPPHRASEPROPERTYHANDLE = isize;

// TODO: this type has an InvalidHandleValue of '0', what can Zig do with this information?
pub const SPTRANSITIONID = isize;
...
pub const ISpDataKey = extern struct {
    pub const VTable = extern struct {
        ...
        OpenKey: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpDataKey,
                pszSubKeyName: ?[*:0]align(1) const u16,
                ppSubKey: ?*?*ISpDataKey,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpDataKey,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_SetData(self: *const T, pszValueName: ?[*:0]align(1) const u16, cbData: u32, pData: ?*const u8) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).SetData(@as(*const ISpDataKey, @ptrCast(self)), pszValueName, cbData, pData);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_GetData(self: *const T, pszValueName: ?[*:0]align(1) const u16, pcbData: ?*u32, pData: ?*u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_SetStringValue(self: *const T, pszValueName: ?[*:0]align(1) const u16, pszValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_GetStringValue(self: *const T, pszValueName: ?[*:0]align(1) const u16, ppszValue: ?*?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_SetDWORD(self: *const T, pszValueName: ?[*:0]align(1) const u16, dwValue: u32) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).SetDWORD(@as(*const ISpDataKey, @ptrCast(self)), pszValueName, dwValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_GetDWORD(self: *const T, pszValueName: ?[*:0]align(1) const u16, pdwValue: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).GetDWORD(@as(*const ISpDataKey, @ptrCast(self)), pszValueName, pdwValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_OpenKey(self: *const T, pszSubKeyName: ?[*:0]align(1) const u16, ppSubKey: ?*?*ISpDataKey) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).OpenKey(@as(*const ISpDataKey, @ptrCast(self)), pszSubKeyName, ppSubKey);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_CreateKey(self: *const T, pszSubKey: ?[*:0]align(1) const u16, ppSubKey: ?*?*ISpDataKey) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).CreateKey(@as(*const ISpDataKey, @ptrCast(self)), pszSubKey, ppSubKey);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_DeleteKey(self: *const T, pszSubKey: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const ISpDataKey.VTable, @ptrCast(self.vtable)).DeleteKey(@as(*const ISpDataKey, @ptrCast(self)), pszSubKey);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpDataKey_DeleteValue(self: *const T, pszValueName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISpObjectTokenCategory = extern struct {
    pub const VTable = extern struct {
        ...
        SetId: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszCategoryId: ?[*:0]align(1) const u16,
        ...
        EnumTokens: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpObjectTokenCategory,
                pzsReqAttribs: ?[*:0]align(1) const u16,
                pszOptAttribs: ?[*:0]align(1) const u16,
        ...
        SetDefaultTokenId: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpObjectTokenCategory,
                pszTokenId: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpObjectTokenCategory,
                pszTokenId: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace ISpDataKey.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectTokenCategory_SetId(self: *const T, pszCategoryId: ?[*:0]align(1) const u16, fCreateIfNotExist: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectTokenCategory_EnumTokens(self: *const T, pzsReqAttribs: ?[*:0]align(1) const u16, pszOptAttribs: ?[*:0]align(1) const u16, ppEnum: ?*?*IEnumSpObjectTokens) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectTokenCategory_SetDefaultTokenId(self: *const T, pszTokenId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISpObjectToken = extern struct {
    pub const VTable = extern struct {
        ...
        GetStorageFileName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszValueName: ?[*:0]align(1) const u16,
                pszFileNameSpecifier: ?[*:0]align(1) const u16,
                nFolder: u32,
                ppszFilePath: ?*?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        IsUISupported: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpObjectToken,
                pszTypeOfUI: ?[*:0]align(1) const u16,
        ...
        MatchesAttributes: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpObjectToken,
                pszAttributes: ?[*:0]align(1) const u16,
                pfMatches: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpObjectToken,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace ISpDataKey.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_SetId(self: *const T, pszCategoryId: ?[*:0]align(1) const u16, pszTokenId: ?[*:0]align(1) const u16, fCreateIfNotExist: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_GetStorageFileName(self: *const T, clsidCaller: ?*const Guid, pszValueName: ?[*:0]align(1) const u16, pszFileNameSpecifier: ?[*:0]align(1) const u16, nFolder: u32, ppszFilePath: ?*?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_RemoveStorageFileName(self: *const T, clsidCaller: ?*const Guid, pszKeyName: ?[*:0]align(1) const u16, fDeleteFile: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_IsUISupported(self: *const T, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, punkObject: ?*IUnknown, pfSupported: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_DisplayUI(self: *const T, hwndParent: ?HWND, pszTitle: ?[*:0]align(1) const u16, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, punkObject: ?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectToken_MatchesAttributes(self: *const T, pszAttributes: ?[*:0]align(1) const u16, pfMatches: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const ISpObjectTokenInit = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpObjectTokenInit_InitFromDataKey(self: *const T, pszCategoryId: ?[*:0]align(1) const u16, pszTokenId: ?[*:0]align(1) const u16, pDataKey: ?*ISpDataKey) callconv(.Inline) HRESULT {
...
pub const ISpStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpStream_BindToFile(self: *const T, pszFileName: ?[*:0]align(1) const u16, eMode: SPFILEMODE, pFormatId: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX, ullEventInterest: u64) callconv(.Inline) HRESULT {
...
pub const ISpTranscript = extern struct {
    pub const VTable = extern struct {
        ...
        AppendTranscript: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpTranscript,
                pszTranscript: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpTranscript,
                pszTranscript: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpTranscript_AppendTranscript(self: *const T, pszTranscript: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const SPPHRASEELEMENT = extern struct {
    ...
    pszDisplayText: ?[*:0]align(1) const u16,
    pszLexicalForm: ?[*:0]align(1) const u16,
...
pub const SPPHRASEREPLACEMENT = extern struct {
    bDisplayAttributes: u8,
    pszReplacementText: ?[*:0]align(1) const u16,
    ulFirstElement: u32,
    ulCountOfElements: u32,
};
...
pub const SPRULE = extern struct {
    pszRuleName: ?[*:0]align(1) const u16,
    ulRuleId: u32,
    dwAttributes: u32,
};
...
pub const ISpLexicon = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpLexicon_GetPronunciations(self: *const T, pszWord: ?[*:0]align(1) const u16, LangID: u16, dwFlags: u32, pWordPronunciationList: ?*SPWORDPRONUNCIATIONLIST) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpLexicon_AddPronunciation(self: *const T, pszWord: ?[*:0]align(1) const u16, LangID: u16, ePartOfSpeech: SPPARTOFSPEECH, pszPronunciation: ?*u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpLexicon_RemovePronunciation(self: *const T, pszWord: ?[*:0]align(1) const u16, LangID: u16, ePartOfSpeech: SPPARTOFSPEECH, pszPronunciation: ?*u16) callconv(.Inline) HRESULT {
...
pub const ISpShortcut = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpShortcut_AddShortcut(self: *const T, pszDisplay: ?[*:0]align(1) const u16, LangID: u16, pszSpoken: ?[*:0]align(1) const u16, shType: SPSHORTCUTTYPE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpShortcut_RemoveShortcut(self: *const T, pszDisplay: ?[*:0]align(1) const u16, LangID: u16, pszSpoken: ?[*:0]align(1) const u16, shType: SPSHORTCUTTYPE) callconv(.Inline) HRESULT {
...
pub const ISpPhoneConverter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpPhoneConverter_PhoneToId(self: *const T, pszPhone: ?[*:0]align(1) const u16, pId: ?*u16) callconv(.Inline) HRESULT {
...
pub const SPVCONTEXT = extern struct {
    pCategory: ?[*:0]align(1) const u16,
    pBefore: ?[*:0]align(1) const u16,
    pAfter: ?[*:0]align(1) const u16,
};
...
pub const ISpVoice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpVoice_Speak(self: *const T, pwcs: ?[*:0]align(1) const u16, dwFlags: u32, pulStreamNumber: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpVoice_Skip(self: *const T, pItemType: ?[*:0]align(1) const u16, lNumItems: i32, pulNumSkipped: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpVoice_IsUISupported(self: *const T, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, pfSupported: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpVoice_DisplayUI(self: *const T, hwndParent: ?HWND, pszTitle: ?[*:0]align(1) const u16, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32) callconv(.Inline) HRESULT {
...
pub const ISpRecoResult2 = extern struct {
    pub const VTable = extern struct {
        ...
        CommitText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                ulStartElement: u32,
                cElements: u32,
                pszCorrectedData: ?[*:0]align(1) const u16,
                eCommitFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoResult2,
        ...
        SetTextFeedback: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpRecoResult2,
                pszFeedback: ?[*:0]align(1) const u16,
                fSuccessful: BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoResult2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoResult2_CommitText(self: *const T, ulStartElement: u32, cElements: u32, pszCorrectedData: ?[*:0]align(1) const u16, eCommitFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoResult2_SetTextFeedback(self: *const T, pszFeedback: ?[*:0]align(1) const u16, fSuccessful: BOOL) callconv(.Inline) HRESULT {
...
pub const ISpGrammarBuilder = extern struct {
    pub const VTable = extern struct {
        ...
        AddWordTransition: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszSeparators: ?[*:0]align(1) const u16,
        ...
        AddResource: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszResourceName: ?[*:0]align(1) const u16,
                pszResourceValue: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpGrammarBuilder,
                hRuleState: SPSTATEHANDLE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_GetRule(self: *const T, pszRuleName: ?[*:0]align(1) const u16, dwRuleId: u32, dwAttributes: u32, fCreateIfNotExist: BOOL, phInitialState: ?*SPSTATEHANDLE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_ClearRule(self: *const T, hState: SPSTATEHANDLE) callconv(.Inline) HRESULT {
            return @as(*const ISpGrammarBuilder.VTable, @ptrCast(self.vtable)).ClearRule(@as(*const ISpGrammarBuilder, @ptrCast(self)), hState);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_CreateNewState(self: *const T, hState: SPSTATEHANDLE, phState: ?*SPSTATEHANDLE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_AddWordTransition(self: *const T, hFromState: SPSTATEHANDLE, hToState: SPSTATEHANDLE, psz: ?[*:0]align(1) const u16, pszSeparators: ?[*:0]align(1) const u16, eWordType: SPGRAMMARWORDTYPE, Weight: f32, pPropInfo: ?*const SPPROPERTYINFO) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_AddRuleTransition(self: *const T, hFromState: SPSTATEHANDLE, hToState: SPSTATEHANDLE, hRule: SPSTATEHANDLE, Weight: f32, pPropInfo: ?*const SPPROPERTYINFO) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder_AddResource(self: *const T, hRuleState: SPSTATEHANDLE, pszResourceName: ?[*:0]align(1) const u16, pszResourceValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISpRecoGrammar = extern struct {
    pub const VTable = extern struct {
        ...
        LoadCmdFromObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpRecoGrammar,
                rcid: ?*const Guid,
                pszGrammarName: ?[*:0]align(1) const u16,
                Options: SPLOADOPTIONS,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoGrammar,
        ...
        LoadCmdFromResource: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                hModule: HMODULE,
                pszResourceName: ?[*:0]align(1) const u16,
                pszResourceType: ?[*:0]align(1) const u16,
                wLanguage: u16,
                Options: SPLOADOPTIONS,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        LoadCmdFromProprietaryGrammar: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszStringParam: ?[*:0]align(1) const u16,
        ...
        LoadDictation: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpRecoGrammar,
                pszTopicName: ?[*:0]align(1) const u16,
                Options: SPLOADOPTIONS,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoGrammar,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadCmdFromFile(self: *const T, pszFileName: ?[*:0]align(1) const u16, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadCmdFromObject(self: *const T, rcid: ?*const Guid, pszGrammarName: ?[*:0]align(1) const u16, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadCmdFromResource(self: *const T, hModule: HMODULE, pszResourceName: ?[*:0]align(1) const u16, pszResourceType: ?[*:0]align(1) const u16, wLanguage: u16, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadCmdFromProprietaryGrammar(self: *const T, rguidParam: ?*const Guid, pszStringParam: ?[*:0]align(1) const u16, pvDataPrarm: ?*const anyopaque, cbDataSize: u32, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_SetRuleState(self: *const T, pszName: ?[*:0]align(1) const u16, pReserved: ?*anyopaque, NewState: SPRULESTATE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadDictation(self: *const T, pszTopicName: ?[*:0]align(1) const u16, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_IsPronounceable(self: *const T, pszWord: ?[*:0]align(1) const u16, pWordPronounceable: ?*SPWORDPRONOUNCEABLE) callconv(.Inline) HRESULT {
...
pub const ISpGrammarBuilder2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpGrammarBuilder2_AddTextSubset(self: *const T, hFromState: SPSTATEHANDLE, hToState: SPSTATEHANDLE, psz: ?[*:0]align(1) const u16, eMatchMode: SPMATCHINGMODE) callconv(.Inline) HRESULT {
...
pub const ISpRecoGrammar2 = extern struct {
    pub const VTable = extern struct {
        ...
        LoadCmdFromFile2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszFileName: ?[*:0]align(1) const u16,
                Options: SPLOADOPTIONS,
                pszSharingUri: ?[*:0]align(1) const u16,
                pszBaseUri: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoGrammar2,
                pszFileName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar2_LoadCmdFromFile2(self: *const T, pszFileName: ?[*:0]align(1) const u16, Options: SPLOADOPTIONS, pszSharingUri: ?[*:0]align(1) const u16, pszBaseUri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar2_LoadCmdFromMemory2(self: *const T, pGrammar: ?*const SPBINARYGRAMMAR, Options: SPLOADOPTIONS, pszSharingUri: ?[*:0]align(1) const u16, pszBaseUri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar2_SetRulePriority(self: *const T, pszRuleName: ?[*:0]align(1) const u16, ulRuleId: u32, nRulePriority: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar2_SetRuleWeight(self: *const T, pszRuleName: ?[*:0]align(1) const u16, ulRuleId: u32, flWeight: f32) callconv(.Inline) HRESULT {
...
pub const ISpeechResourceLoader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechResourceLoader_LoadResource(self: *const T, bstrResourceUri: ?BSTR, fAlwaysReload: VARIANT_BOOL, pStream: ?*?*IUnknown, pbstrMIMEType: ?*?BSTR, pfModified: ?*VARIANT_BOOL, pbstrRedirectUrl: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const ISpRecoContext = extern struct {
    pub const VTable = extern struct {
        ...
        SetAdaptationData: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpRecoContext,
                pAdaptationData: ?[*:0]align(1) const u16,
                cch: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpRecoContext,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoContext_SetAdaptationData(self: *const T, pAdaptationData: ?[*:0]align(1) const u16, cch: u32) callconv(.Inline) HRESULT {
...
pub const ISpRecoContext2 = extern struct {
    pub const VTable = extern struct {
        ...
        SetAdaptationData2: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pAdaptationData: ?[*:0]align(1) const u16,
                cch: u32,
                pTopicName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoContext2_SetAdaptationData2(self: *const T, pAdaptationData: ?[*:0]align(1) const u16, cch: u32, pTopicName: ?[*:0]align(1) const u16, eAdaptationSettings: u32, eRelevance: SPADAPTATIONRELEVANCE) callconv(.Inline) HRESULT {
...
pub const ISpProperties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpProperties_SetPropertyNum(self: *const T, pName: ?[*:0]align(1) const u16, lValue: i32) callconv(.Inline) HRESULT {
            return @as(*const ISpProperties.VTable, @ptrCast(self.vtable)).SetPropertyNum(@as(*const ISpProperties, @ptrCast(self)), pName, lValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpProperties_GetPropertyNum(self: *const T, pName: ?[*:0]align(1) const u16, plValue: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpProperties_SetPropertyString(self: *const T, pName: ?[*:0]align(1) const u16, pValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpProperties_GetPropertyString(self: *const T, pName: ?[*:0]align(1) const u16, ppCoMemValue: ?*?PWSTR) callconv(.Inline) HRESULT {
...
pub const ISpRecognizer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecognizer_GetFormat(self: *const T, WaveFormatType: SPSTREAMFORMATTYPE, pFormatId: ?*Guid, ppCoMemWFEX: ?*?*WAVEFORMATEX) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecognizer_IsUISupported(self: *const T, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, pfSupported: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecognizer_DisplayUI(self: *const T, hwndParent: ?HWND, pszTitle: ?[*:0]align(1) const u16, pszTypeOfUI: ?[*:0]align(1) const u16, pvExtraData: ?*anyopaque, cbExtraData: u32) callconv(.Inline) HRESULT {
...
pub const ISpEnginePronunciation = extern struct {
    pub const VTable = extern struct {
        ...
        Normalize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszWord: ?[*:0]align(1) const u16,
                pszLeftContext: ?[*:0]align(1) const u16,
                pszRightContext: ?[*:0]align(1) const u16,
                LangID: u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpEnginePronunciation_Normalize(self: *const T, pszWord: ?[*:0]align(1) const u16, pszLeftContext: ?[*:0]align(1) const u16, pszRightContext: ?[*:0]align(1) const u16, LangID: u16, pNormalizationList: ?*SPNORMALIZATIONLIST) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpEnginePronunciation_GetPronunciations(self: *const T, pszWord: ?[*:0]align(1) const u16, pszLeftContext: ?[*:0]align(1) const u16, pszRightContext: ?[*:0]align(1) const u16, LangID: u16, pEnginePronunciationList: ?*SPWORDPRONUNCIATIONLIST) callconv(.Inline) HRESULT {
...
pub const SPDISPLAYTOKEN = extern struct {
    pszLexical: ?[*:0]align(1) const u16,
    pszDisplay: ?[*:0]align(1) const u16,
    bDisplayAttributes: u8,
};
...
pub const ISpeechObjectToken = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechObjectToken_SetId(self: *const T, Id: ?BSTR, CategoryID: ?BSTR, CreateIfNotExist: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechObjectToken_RemoveStorageFileName(self: *const T, ObjectStorageCLSID: ?BSTR, KeyName: ?BSTR, DeleteFile: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const ISpeechObjectToken.VTable, @ptrCast(self.vtable)).RemoveStorageFileName(@as(*const ISpeechObjectToken, @ptrCast(self)), ObjectStorageCLSID, KeyName, DeleteFile);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechObjectToken_IsUISupported(self: *const T, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Object: ?*IUnknown, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechObjectToken_MatchesAttributes(self: *const T, Attributes: ?BSTR, Matches: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechObjectTokenCategory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechObjectTokenCategory_SetId(self: *const T, Id: ?BSTR, CreateIfNotExist: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechFileStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechFileStream_Open(self: *const T, FileName: ?BSTR, FileMode: SpeechStreamFileMode, DoEvents: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechVoice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechVoice_put_AllowAudioOutputFormatChangesOnNextSet(self: *const T, Allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechVoice_get_AllowAudioOutputFormatChangesOnNextSet(self: *const T, Allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechVoice_WaitUntilDone(self: *const T, msTimeout: i32, Done: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechVoice_IsUISupported(self: *const T, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechRecognizer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_put_AllowAudioInputFormatChangesOnNextSet(self: *const T, Allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_get_AllowAudioInputFormatChangesOnNextSet(self: *const T, Allow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_get_IsShared(self: *const T, Shared: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_SetPropertyNumber(self: *const T, Name: ?BSTR, Value: i32, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_GetPropertyNumber(self: *const T, Name: ?BSTR, Value: ?*i32, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_SetPropertyString(self: *const T, Name: ?BSTR, Value: ?BSTR, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_GetPropertyString(self: *const T, Name: ?BSTR, Value: ?*?BSTR, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecognizer_IsUISupported(self: *const T, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Supported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechRecoContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecoContext_put_AllowVoiceFormatMatchingOnNextSet(self: *const T, Allow: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecoContext_get_AllowVoiceFormatMatchingOnNextSet(self: *const T, pAllow: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechGrammarRules = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechGrammarRules_get_Dynamic(self: *const T, Dynamic: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechRecoResult2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecoResult2_SetTextFeedback(self: *const T, Feedback: ?BSTR, WasSuccessful: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechPhraseInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechPhraseInfo_GetText(self: *const T, StartElement: i32, Elements: i32, UseReplacements: VARIANT_BOOL, Text: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechPhraseInfo_GetDisplayAttributes(self: *const T, StartElement: i32, Elements: i32, UseReplacements: VARIANT_BOOL, DisplayAttributes: ?*SpeechDisplayAttributes) callconv(.Inline) HRESULT {
...
pub const ISpeechXMLRecoResult = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechXMLRecoResult_GetXMLErrorInfo(self: *const T, LineNumber: ?*i32, ScriptLine: ?*?BSTR, Source: ?*?BSTR, Description: ?*?BSTR, ResultCode: ?*i32, IsError: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISpeechRecoResultDispatch = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecoResultDispatch_GetXMLErrorInfo(self: *const T, LineNumber: ?*i32, ScriptLine: ?*?BSTR, Source: ?*?BSTR, Description: ?*?BSTR, ResultCode: ?*HRESULT, IsError: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpeechRecoResultDispatch_SetTextFeedback(self: *const T, Feedback: ?BSTR, WasSuccessful: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IInternetSecurityManager = @import("../../../windows/win32/system/com/urlmon.zig").IInternetSecurityManager;
