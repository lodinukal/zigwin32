...
pub const MCI_OPEN_PARMSA = extern struct {
    ...
    lpstrDeviceType: ?[*:0]align(1) const u8 align(1),
    lpstrElementName: ?[*:0]align(1) const u8 align(1),
    lpstrAlias: ?[*:0]align(1) const u8 align(1),
};

pub const MCI_OPEN_PARMSW = extern struct {
    dwCallback: usize align(1),
    wDeviceID: u32 align(1),
    lpstrDeviceType: ?[*:0]align(1) const u16 align(1),
    lpstrElementName: ?[*:0]align(1) const u16 align(1),
    lpstrAlias: ?[*:0]align(1) const u16 align(1),
};
...
pub const MCI_SAVE_PARMSA = extern struct {
    dwCallback: usize align(1),
    lpfilename: ?[*:0]align(1) const u8 align(1),
};

pub const MCI_SAVE_PARMSW = extern struct {
    dwCallback: usize align(1),
    lpfilename: ?[*:0]align(1) const u16 align(1),
};
...
pub const MCI_VD_ESCAPE_PARMSA = extern struct {
    dwCallback: usize align(1),
    lpstrCommand: ?[*:0]align(1) const u8 align(1),
};

pub const MCI_VD_ESCAPE_PARMSW = extern struct {
    dwCallback: usize align(1),
    lpstrCommand: ?[*:0]align(1) const u16 align(1),
};
...
pub const MCI_ANIM_WINDOW_PARMSA = extern struct {
    ...
    lpstrText: ?[*:0]align(1) const u8 align(1),
};
...
pub const MCI_ANIM_WINDOW_PARMSW = extern struct {
    ...
    hWnd: ?HWND align(1),
    nCmdShow: u32 align(1),
    lpstrText: ?[*:0]align(1) const u16 align(1),
};
...
pub const DRVCONFIGINFOEX = extern struct {
    ...
    lpszDCISectionName: ?[*:0]align(1) const u16 align(1),
    lpszDCIAliasName: ?[*:0]align(1) const u16 align(1),
...
pub const MCI_OPEN_DRIVER_PARMS = extern struct {
    wDeviceID: u32 align(1),
    lpstrParams: ?[*:0]align(1) const u16 align(1),
...
pub extern "winmm" fn mciSendStringA(
    lpstrCommand: ?[*:0]align(1) const u8,
...
pub extern "winmm" fn mciSendStringW(
    lpstrCommand: ?[*:0]align(1) const u16,
...
pub extern "winmm" fn mciGetDeviceIDFromElementIDA(
    dwElementID: u32,
    lpstrType: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winmm" fn mciGetDeviceIDFromElementIDW(
    dwElementID: u32,
    lpstrType: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winmm" fn OpenDriver(
    szDriverName: ?[*:0]align(1) const u16,
    szSectionName: ?[*:0]align(1) const u16,
    lParam2: LPARAM,
...
pub extern "winmm" fn DrvGetModuleHandle(
    hDriver: ?HDRVR,
) callconv(@import("std").os.windows.WINAPI) HMODULE;
...
pub extern "winmm" fn mmDrvInstall(
    hDriver: ?HDRVR,
    wszDrvEntry: ?[*:0]align(1) const u16,
...
pub extern "winmm" fn mmioStringToFOURCCA(
    sz: ?[*:0]align(1) const u8,
    uFlags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "winmm" fn mmioStringToFOURCCW(
    sz: ?[*:0]align(1) const u16,
    uFlags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winmm" fn mmioRenameA(
    ...
    pszNewFileName: ?[*:0]align(1) const u8,
    pmmioinfo: ?*MMIOINFO,
    fdwRename: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winmm" fn mmioRenameW(
    ...
    pszNewFileName: ?[*:0]align(1) const u16,
    pmmioinfo: ?*MMIOINFO,
    fdwRename: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "avicap32" fn capCreateCaptureWindowA(
    lpszWindowName: ?[*:0]align(1) const u8,
    dwStyle: u32,
    x: i32,
    y: i32,
    nWidth: i32,
...
pub extern "avicap32" fn capCreateCaptureWindowW(
    lpszWindowName: ?[*:0]align(1) const u16,
    dwStyle: u32,
    x: i32,
    y: i32,
    nWidth: i32,
...
const HMIXER = @import("../../../windows/win32/media/audio.zig").HMIXER;
...
const HWAVE = @import("../../../windows/win32/media/audio.zig").HWAVE;
const HWND = @import("../../../windows/win32/foundation.zig").HWND;
const IPersistFile = @import("../../../windows/win32/system/com.zig").IPersistFile;
...
const LPTIMECALLBACK = @import("../../../windows/win32/media.zig").LPTIMECALLBACK;
...
const WAVEFORMAT = @import("../../../windows/win32/media/audio.zig").WAVEFORMAT;
const WAVEFORMATEX = @import("../../../windows/win32/media/audio.zig").WAVEFORMATEX;
const WAVEHDR = @import("../../../windows/win32/media/audio.zig").WAVEHDR;
