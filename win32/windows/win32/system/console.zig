...
pub const CONSOLE_CHARACTER_ATTRIBUTES = enum(u16) {
    FOREGROUND_BLUE = 1,
    FOREGROUND_GREEN = 2,
    FOREGROUND_RED = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        COMMON_LVB_SBCSDBCS: u1 = 0,
    }) CONSOLE_CHARACTER_ATTRIBUTES {
        return @as(CONSOLE_CHARACTER_ATTRIBUTES, @enumFromInt(
              (if (o.FOREGROUND_BLUE == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_BLUE) else 0)
            | (if (o.FOREGROUND_GREEN == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_GREEN) else 0)
            | (if (o.FOREGROUND_RED == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_RED) else 0)
            | (if (o.FOREGROUND_INTENSITY == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_INTENSITY) else 0)
            | (if (o.BACKGROUND_BLUE == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_BLUE) else 0)
            | (if (o.BACKGROUND_GREEN == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_GREEN) else 0)
            | (if (o.BACKGROUND_RED == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_RED) else 0)
            | (if (o.BACKGROUND_INTENSITY == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_INTENSITY) else 0)
            | (if (o.COMMON_LVB_LEADING_BYTE == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_LEADING_BYTE) else 0)
            | (if (o.COMMON_LVB_TRAILING_BYTE == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_TRAILING_BYTE) else 0)
            | (if (o.COMMON_LVB_GRID_HORIZONTAL == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_HORIZONTAL) else 0)
            | (if (o.COMMON_LVB_GRID_LVERTICAL == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_LVERTICAL) else 0)
            | (if (o.COMMON_LVB_GRID_RVERTICAL == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_RVERTICAL) else 0)
            | (if (o.COMMON_LVB_REVERSE_VIDEO == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_REVERSE_VIDEO) else 0)
            | (if (o.COMMON_LVB_UNDERSCORE == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_UNDERSCORE) else 0)
            | (if (o.COMMON_LVB_SBCSDBCS == 1) @intFromEnum(CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_SBCSDBCS) else 0)
        ));
    }
};
pub const FOREGROUND_BLUE = CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_BLUE;
pub const FOREGROUND_GREEN = CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_GREEN;
pub const FOREGROUND_RED = CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_RED;
pub const FOREGROUND_INTENSITY = CONSOLE_CHARACTER_ATTRIBUTES.FOREGROUND_INTENSITY;
pub const BACKGROUND_BLUE = CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_BLUE;
pub const BACKGROUND_GREEN = CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_GREEN;
pub const BACKGROUND_RED = CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_RED;
pub const BACKGROUND_INTENSITY = CONSOLE_CHARACTER_ATTRIBUTES.BACKGROUND_INTENSITY;
pub const COMMON_LVB_LEADING_BYTE = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_LEADING_BYTE;
pub const COMMON_LVB_TRAILING_BYTE = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_TRAILING_BYTE;
pub const COMMON_LVB_GRID_HORIZONTAL = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_HORIZONTAL;
pub const COMMON_LVB_GRID_LVERTICAL = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_LVERTICAL;
pub const COMMON_LVB_GRID_RVERTICAL = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_GRID_RVERTICAL;
pub const COMMON_LVB_REVERSE_VIDEO = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_REVERSE_VIDEO;
pub const COMMON_LVB_UNDERSCORE = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_UNDERSCORE;
pub const COMMON_LVB_SBCSDBCS = CONSOLE_CHARACTER_ATTRIBUTES.COMMON_LVB_SBCSDBCS;
...
pub extern "kernel32" fn SetConsoleTitleA(
    lpConsoleTitle: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn SetConsoleTitleW(
    lpConsoleTitle: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
