...
// Section: Constants (4)
//--------------------------------------------------------------------------------
pub const DEVPKEY_AudioEndpointPlugin_FactoryCLSID = PROPERTYKEY { .fmtid = Guid.initIntString("316160983, 53010, 18110, 133, 64, 129, 39, 16, 211, 2, 28"), .pid = 1 };
pub const DEVPKEY_AudioEndpointPlugin_DataFlow = PROPERTYKEY { .fmtid = Guid.initIntString("316160983, 53010, 18110, 133, 64, 129, 39, 16, 211, 2, 28"), .pid = 2 };
pub const DEVPKEY_AudioEndpointPlugin_PnPInterface = PROPERTYKEY { .fmtid = Guid.initIntString("316160983, 53010, 18110, 133, 64, 129, 39, 16, 211, 2, 28"), .pid = 3 };
pub const DEVPKEY_AudioEndpointPlugin2_FactoryCLSID = PROPERTYKEY { .fmtid = Guid.initIntString("316160983, 53010, 18110, 133, 64, 129, 39, 16, 211, 2, 28"), .pid = 4 };
...
const AUDIO_CURVE_TYPE = @import("../../../../windows/win32/media/kernel_streaming.zig").AUDIO_CURVE_TYPE;
