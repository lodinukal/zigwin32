...
pub const D2D1_OPACITY_MASK_CONTENT = enum(i32) {
    GRAPHICS = 0,
    TEXT_NATURAL = 1,
...
pub const D2D1_EXTEND_MODE = enum(i32) {
    CLAMP = 0,
    WRAP = 1,
    MIRROR = 2,
};
...
pub const D2D1_ANTIALIAS_MODE = enum(i32) {
    PER_PRIMITIVE = 0,
    ALIASED = 1,
};
...
pub const D2D1_TEXT_ANTIALIAS_MODE = enum(i32) {
    DEFAULT = 0,
    CLEARTYPE = 1,
    GRAYSCALE = 2,
    ALIASED = 3,
...
pub const D2D1_BITMAP_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
};
...
pub const D2D1_DRAW_TEXT_OPTIONS = enum(i32) {
    NO_SNAP = 1,
    CLIP = 2,
    ENABLE_COLOR_FONT = 4,
...
pub const D2D1_ARC_SIZE = enum(i32) {
    SMALL = 0,
    LARGE = 1,
};
...
pub const D2D1_CAP_STYLE = enum(i32) {
    FLAT = 0,
    SQUARE = 1,
    ROUND = 2,
    TRIANGLE = 3,
...
pub const D2D1_DASH_STYLE = enum(i32) {
    SOLID = 0,
    DASH = 1,
    DOT = 2,
    DASH_DOT = 3,
...
pub const D2D1_LINE_JOIN = enum(i32) {
    MITER = 0,
    BEVEL = 1,
    ROUND = 2,
    MITER_OR_BEVEL = 3,
...
pub const D2D1_COMBINE_MODE = enum(i32) {
    UNION = 0,
    INTERSECT = 1,
    XOR = 2,
    EXCLUDE = 3,
...
pub const D2D1_GEOMETRY_RELATION = enum(i32) {
    UNKNOWN = 0,
    DISJOINT = 1,
    IS_CONTAINED = 2,
    CONTAINS = 3,
...
pub const D2D1_GEOMETRY_SIMPLIFICATION_OPTION = enum(i32) {
    CUBICS_AND_LINES = 0,
    LINES = 1,
};
...
pub const D2D1_SWEEP_DIRECTION = enum(i32) {
    OUNTER_CLOCKWISE = 0,
    LOCKWISE = 1,
};
pub const D2D1_SWEEP_DIRECTION_COUNTER_CLOCKWISE = D2D1_SWEEP_DIRECTION.OUNTER_CLOCKWISE;
pub const D2D1_SWEEP_DIRECTION_CLOCKWISE = D2D1_SWEEP_DIRECTION.LOCKWISE;
...
pub const D2D1_LAYER_OPTIONS = enum(i32) {
    NONE = 0,
...
pub const D2D1_WINDOW_STATE = enum(i32) {
    NONE = 0,
    OCCLUDED = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const D2D1_RENDER_TARGET_TYPE = enum(i32) {
    DEFAULT = 0,
    SOFTWARE = 1,
    HARDWARE = 2,
};
...
pub const D2D1_FEATURE_LEVEL = enum(i32) {
    DEFAULT = 0,
    @"9" = 37120,
    @"10" = 40960,
};
...
pub const D2D1_RENDER_TARGET_USAGE = enum(i32) {
    NONE = 0,
...
pub const D2D1_PRESENT_OPTIONS = enum(i32) {
    NONE = 0,
    RETAIN_CONTENTS = 1,
    IMMEDIATELY = 2,
    _,
...
pub const D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS = enum(i32) {
    NONE = 0,
    GDI_COMPATIBLE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const D2D1_DC_INITIALIZE_MODE = enum(i32) {
    OPY = 0,
    LEAR = 1,
};
pub const D2D1_DC_INITIALIZE_MODE_COPY = D2D1_DC_INITIALIZE_MODE.OPY;
pub const D2D1_DC_INITIALIZE_MODE_CLEAR = D2D1_DC_INITIALIZE_MODE.LEAR;

pub const D2D1_DEBUG_LEVEL = enum(i32) {
    NONE = 0,
    ERROR = 1,
    WARNING = 2,
    INFORMATION = 3,
...
pub const D2D1_FACTORY_TYPE = enum(i32) {
    SINGLE_THREADED = 0,
    MULTI_THREADED = 1,
};
...
pub const D2D1_CHANNEL_SELECTOR = enum(i32) {
    R = 0,
    G = 1,
    B = 2,
    A = 3,
...
pub const D2D1_BITMAPSOURCE_ORIENTATION = enum(i32) {
    DEFAULT = 1,
    FLIP_HORIZONTAL = 2,
...
pub const D2D1_GAUSSIANBLUR_PROP = enum(i32) {
...
pub const D2D1_GAUSSIANBLUR_OPTIMIZATION = enum(i32) {
    SPEED = 0,
    BALANCED = 1,
    QUALITY = 2,
};
...
pub const D2D1_DIRECTIONALBLUR_PROP = enum(i32) {
    STANDARD_DEVIATION = 0,
    ANGLE = 1,
    OPTIMIZATION = 2,
    BORDER_MODE = 3,
...
pub const D2D1_DIRECTIONALBLUR_OPTIMIZATION = enum(i32) {
    SPEED = 0,
    BALANCED = 1,
    QUALITY = 2,
};
...
pub const D2D1_SHADOW_PROP = enum(i32) {
...
pub const D2D1_SHADOW_OPTIMIZATION = enum(i32) {
    SPEED = 0,
    BALANCED = 1,
    QUALITY = 2,
};
...
pub const D2D1_BLEND_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_BLEND_PROP_MODE = D2D1_BLEND_PROP.E;

pub const D2D1_SATURATION_PROP = enum(i32) {
    N = 0,
};
pub const D2D1_SATURATION_PROP_SATURATION = D2D1_SATURATION_PROP.N;

pub const D2D1_HUEROTATION_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_HUEROTATION_PROP_ANGLE = D2D1_HUEROTATION_PROP.E;

pub const D2D1_COLORMATRIX_PROP = enum(i32) {
    COLOR_MATRIX = 0,
    ALPHA_MODE = 1,
    CLAMP_OUTPUT = 2,
};
...
pub const D2D1_BITMAPSOURCE_PROP = enum(i32) {
    WIC_BITMAP_SOURCE = 0,
    SCALE = 1,
...
pub const D2D1_BITMAPSOURCE_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    FANT = 6,
...
pub const D2D1_BITMAPSOURCE_ALPHA_MODE = enum(i32) {
    PREMULTIPLIED = 1,
    STRAIGHT = 2,
};
...
pub const D2D1_COMPOSITE_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_COMPOSITE_PROP_MODE = D2D1_COMPOSITE_PROP.E;

pub const D2D1_3DTRANSFORM_PROP = enum(i32) {
...
pub const D2D1_3DTRANSFORM_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_3DPERSPECTIVETRANSFORM_PROP = enum(i32) {
    INTERPOLATION_MODE = 0,
    BORDER_MODE = 1,
    DEPTH = 2,
...
pub const D2D1_3DPERSPECTIVETRANSFORM_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_2DAFFINETRANSFORM_PROP = enum(i32) {
    INTERPOLATION_MODE = 0,
    BORDER_MODE = 1,
    TRANSFORM_MATRIX = 2,
    SHARPNESS = 3,
...
pub const D2D1_DPICOMPENSATION_PROP = enum(i32) {
    INTERPOLATION_MODE = 0,
    BORDER_MODE = 1,
    INPUT_DPI = 2,
};
...
pub const D2D1_DPICOMPENSATION_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_SCALE_PROP = enum(i32) {
    SCALE = 0,
    CENTER_POINT = 1,
    INTERPOLATION_MODE = 2,
    BORDER_MODE = 3,
...
pub const D2D1_SCALE_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_TURBULENCE_PROP = enum(i32) {
    OFFSET = 0,
    SIZE = 1,
    BASE_FREQUENCY = 2,
    NUM_OCTAVES = 3,
...
pub const D2D1_DISPLACEMENTMAP_PROP = enum(i32) {
    SCALE = 0,
    X_CHANNEL_SELECT = 1,
    Y_CHANNEL_SELECT = 2,
};
...
pub const D2D1_COLORMANAGEMENT_PROP = enum(i32) {
...
pub const D2D1_COLORMANAGEMENT_ALPHA_MODE = enum(i32) {
    PREMULTIPLIED = 1,
    STRAIGHT = 2,
};
...
pub const D2D1_COLORMANAGEMENT_QUALITY = enum(i32) {
    PROOF = 0,
    NORMAL = 1,
    BEST = 2,
};
...
pub const D2D1_COLORMANAGEMENT_RENDERING_INTENT = enum(i32) {
    PERCEPTUAL = 0,
...
pub const D2D1_HISTOGRAM_PROP = enum(i32) {
    NUM_BINS = 0,
    CHANNEL_SELECT = 1,
    HISTOGRAM_OUTPUT = 2,
};
...
pub const D2D1_POINTSPECULAR_PROP = enum(i32) {
    LIGHT_POSITION = 0,
    SPECULAR_EXPONENT = 1,
    SPECULAR_CONSTANT = 2,
    SURFACE_SCALE = 3,
...
pub const D2D1_POINTSPECULAR_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_SPOTSPECULAR_PROP = enum(i32) {
    LIGHT_POSITION = 0,
    POINTS_AT = 1,
    FOCUS = 2,
...
pub const D2D1_SPOTSPECULAR_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_DISTANTSPECULAR_PROP = enum(i32) {
    AZIMUTH = 0,
    ELEVATION = 1,
    SPECULAR_EXPONENT = 2,
    SPECULAR_CONSTANT = 3,
...
pub const D2D1_DISTANTSPECULAR_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_POINTDIFFUSE_PROP = enum(i32) {
    LIGHT_POSITION = 0,
    DIFFUSE_CONSTANT = 1,
    SURFACE_SCALE = 2,
    COLOR = 3,
...
pub const D2D1_POINTDIFFUSE_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_SPOTDIFFUSE_PROP = enum(i32) {
    LIGHT_POSITION = 0,
    POINTS_AT = 1,
    FOCUS = 2,
    LIMITING_CONE_ANGLE = 3,
...
pub const D2D1_SPOTDIFFUSE_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_DISTANTDIFFUSE_PROP = enum(i32) {
    AZIMUTH = 0,
    ELEVATION = 1,
    DIFFUSE_CONSTANT = 2,
    SURFACE_SCALE = 3,
...
pub const D2D1_DISTANTDIFFUSE_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_FLOOD_PROP = enum(i32) {
    R = 0,
};
pub const D2D1_FLOOD_PROP_COLOR = D2D1_FLOOD_PROP.R;

pub const D2D1_LINEARTRANSFER_PROP = enum(i32) {
    RED_Y_INTERCEPT = 0,
    RED_SLOPE = 1,
    RED_DISABLE = 2,
    GREEN_Y_INTERCEPT = 3,
...
pub const D2D1_GAMMATRANSFER_PROP = enum(i32) {
    RED_AMPLITUDE = 0,
    RED_EXPONENT = 1,
    RED_OFFSET = 2,
    RED_DISABLE = 3,
...
pub const D2D1_TABLETRANSFER_PROP = enum(i32) {
    RED_TABLE = 0,
    RED_DISABLE = 1,
    GREEN_TABLE = 2,
    GREEN_DISABLE = 3,
...
pub const D2D1_DISCRETETRANSFER_PROP = enum(i32) {
    RED_TABLE = 0,
    RED_DISABLE = 1,
    GREEN_TABLE = 2,
    GREEN_DISABLE = 3,
...
pub const D2D1_CONVOLVEMATRIX_PROP = enum(i32) {
...
pub const D2D1_CONVOLVEMATRIX_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_BRIGHTNESS_PROP = enum(i32) {
    WHITE_POINT = 0,
    BLACK_POINT = 1,
};
...
pub const D2D1_ARITHMETICCOMPOSITE_PROP = enum(i32) {
    OEFFICIENTS = 0,
    LAMP_OUTPUT = 1,
};
pub const D2D1_ARITHMETICCOMPOSITE_PROP_COEFFICIENTS = D2D1_ARITHMETICCOMPOSITE_PROP.OEFFICIENTS;
pub const D2D1_ARITHMETICCOMPOSITE_PROP_CLAMP_OUTPUT = D2D1_ARITHMETICCOMPOSITE_PROP.LAMP_OUTPUT;

pub const D2D1_CROP_PROP = enum(i32) {
    RECT = 0,
    BORDER_MODE = 1,
};
...
pub const D2D1_BORDER_PROP = enum(i32) {
    X = 0,
    Y = 1,
};
pub const D2D1_BORDER_PROP_EDGE_MODE_X = D2D1_BORDER_PROP.X;
pub const D2D1_BORDER_PROP_EDGE_MODE_Y = D2D1_BORDER_PROP.Y;

pub const D2D1_BORDER_EDGE_MODE = enum(i32) {
    CLAMP = 0,
    WRAP = 1,
    MIRROR = 2,
};
...
pub const D2D1_MORPHOLOGY_PROP = enum(i32) {
    MODE = 0,
    WIDTH = 1,
    HEIGHT = 2,
};
...
pub const D2D1_MORPHOLOGY_MODE = enum(i32) {
    ERODE = 0,
    DILATE = 1,
};
...
pub const D2D1_TILE_PROP = enum(i32) {
    T = 0,
};
pub const D2D1_TILE_PROP_RECT = D2D1_TILE_PROP.T;

pub const D2D1_ATLAS_PROP = enum(i32) {
    RECT = 0,
    PADDING_RECT = 1,
};
pub const D2D1_ATLAS_PROP_INPUT_RECT = D2D1_ATLAS_PROP.RECT;
pub const D2D1_ATLAS_PROP_INPUT_PADDING_RECT = D2D1_ATLAS_PROP.PADDING_RECT;

pub const D2D1_OPACITYMETADATA_PROP = enum(i32) {
    T = 0,
};
pub const D2D1_OPACITYMETADATA_PROP_INPUT_OPAQUE_RECT = D2D1_OPACITYMETADATA_PROP.T;
...
pub const D2D1_PROPERTY_TYPE = enum(i32) {
    UNKNOWN = 0,
    STRING = 1,
    BOOL = 2,
    UINT32 = 3,
...
pub const D2D1_PROPERTY = enum(i32) {
    CLSID = -2147483648,
...
pub const D2D1_SUBPROPERTY = enum(i32) {
...
pub const D2D1_BITMAP_OPTIONS = enum(i32) {
    NONE = 0,
    TARGET = 1,
    CANNOT_DRAW = 2,
    CPU_READ = 4,
...
pub const D2D1_BUFFER_PRECISION = enum(i32) {
    UNKNOWN = 0,
    @"8BPC_UNORM" = 1,
    @"8BPC_UNORM_SRGB" = 2,
    @"16BPC_UNORM" = 3,
...
pub const D2D1_MAP_OPTIONS = enum(i32) {
    NONE = 0,
    READ = 1,
    WRITE = 2,
    DISCARD = 4,
...
pub const D2D1_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_UNIT_MODE = enum(i32) {
    DIPS = 0,
    PIXELS = 1,
};
...
pub const D2D1_COLOR_SPACE = enum(i32) {
    CUSTOM = 0,
    SRGB = 1,
    SCRGB = 2,
};
...
pub const D2D1_DEVICE_CONTEXT_OPTIONS = enum(i32) {
    NONE = 0,
...
pub const D2D1_STROKE_TRANSFORM_TYPE = enum(i32) {
    NORMAL = 0,
    FIXED = 1,
    HAIRLINE = 2,
};
...
pub const D2D1_PRIMITIVE_BLEND = enum(i32) {
    SOURCE_OVER = 0,
    COPY = 1,
    MIN = 2,
    ADD = 3,
...
pub const D2D1_THREADING_MODE = enum(i32) {
    SINGLE_THREADED = 0,
    MULTI_THREADED = 1,
};
...
pub const D2D1_COLOR_INTERPOLATION_MODE = enum(i32) {
    STRAIGHT = 0,
    PREMULTIPLIED = 1,
};
...
pub const D2D1_LAYER_OPTIONS1 = enum(i32) {
    NONE = 0,
...
pub const D2D1_PRINT_FONT_SUBSET_MODE = enum(i32) {
    DEFAULT = 0,
    EACHPAGE = 1,
    NONE = 2,
};
...
pub const ID2D1Properties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1Properties_GetPropertyIndex(self: *const T, name: ?[*:0]align(1) const u16) callconv(.Inline) u32 {
            return @as(*const ID2D1Properties.VTable, @ptrCast(self.vtable)).GetPropertyIndex(@as(*const ID2D1Properties, @ptrCast(self)), name);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1Properties_SetValueByName(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_PROPERTY_TYPE, data: [*:0]const u8, dataSize: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1Properties_GetValueByName(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_PROPERTY_TYPE, data: [*:0]u8, dataSize: u32) callconv(.Inline) HRESULT {
...
pub const ID2D1DeviceContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1DeviceContext_CreateColorContextFromFilename(self: *const T, filename: ?[*:0]align(1) const u16, colorContext: ?*?*ID2D1ColorContext) callconv(.Inline) HRESULT {
...
pub const ID2D1Factory1 = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterEffectFromString: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ID2D1Factory1,
                classId: ?*const Guid,
                propertyXml: ?[*:0]align(1) const u16,
                bindings: ?[*]const D2D1_PROPERTY_BINDING,
                bindingsCount: u32,
                effectFactory: ?PD2D1_EFFECT_FACTORY,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1Factory1_RegisterEffectFromString(self: *const T, classId: ?*const Guid, propertyXml: ?[*:0]align(1) const u16, bindings: ?[*]const D2D1_PROPERTY_BINDING, bindingsCount: u32, effectFactory: ?PD2D1_EFFECT_FACTORY) callconv(.Inline) HRESULT {
...
pub const D2D1_CHANGE_TYPE = enum(i32) {
    NONE = 0,
    PROPERTIES = 1,
    CONTEXT = 2,
    GRAPH = 3,
...
pub const D2D1_PIXEL_OPTIONS = enum(i32) {
    NONE = 0,
    TRIVIAL_SAMPLING = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const D2D1_VERTEX_OPTIONS = enum(i32) {
    NONE = 0,
    DO_NOT_CLEAR = 1,
    USE_DEPTH_BUFFER = 2,
    ASSUME_NO_OVERLAP = 4,
...
pub const D2D1_VERTEX_USAGE = enum(i32) {
    STATIC = 0,
    DYNAMIC = 1,
};
...
pub const D2D1_BLEND_OPERATION = enum(i32) {
    ADD = 1,
    SUBTRACT = 2,
    REV_SUBTRACT = 3,
    MIN = 4,
...
pub const D2D1_CHANNEL_DEPTH = enum(i32) {
    DEFAULT = 0,
    @"1" = 1,
    @"4" = 4,
};
...
pub const D2D1_FILTER = enum(i32) {
    MIN_MAG_MIP_POINT = 0,
...
pub const D2D1_FEATURE = enum(i32) {
    OUBLES = 0,
    @"3D10_X_HARDWARE_OPTIONS" = 1,
};
pub const D2D1_FEATURE_DOUBLES = D2D1_FEATURE.OUBLES;
pub const D2D1_FEATURE_D3D10_X_HARDWARE_OPTIONS = D2D1_FEATURE.@"3D10_X_HARDWARE_OPTIONS";

pub const D2D1_PROPERTY_BINDING = extern struct {
    propertyName: ?[*:0]align(1) const u16,
...
pub const ID2D1EffectContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1EffectContext_CreateColorContextFromFilename(self: *const T, filename: ?[*:0]align(1) const u16, colorContext: ?*?*ID2D1ColorContext) callconv(.Inline) HRESULT {
...
pub const D2D1_YCBCR_PROP = enum(i32) {
...
pub const D2D1_YCBCR_CHROMA_SUBSAMPLING = enum(i32) {
    AUTO = 0,
    @"420" = 1,
    @"422" = 2,
    @"444" = 3,
...
pub const D2D1_YCBCR_INTERPOLATION_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_CONTRAST_PROP = enum(i32) {
    ONTRAST = 0,
    LAMP_INPUT = 1,
};
pub const D2D1_CONTRAST_PROP_CONTRAST = D2D1_CONTRAST_PROP.ONTRAST;
pub const D2D1_CONTRAST_PROP_CLAMP_INPUT = D2D1_CONTRAST_PROP.LAMP_INPUT;

pub const D2D1_RGBTOHUE_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_RGBTOHUE_PROP_OUTPUT_COLOR_SPACE = D2D1_RGBTOHUE_PROP.E;

pub const D2D1_RGBTOHUE_OUTPUT_COLOR_SPACE = enum(i32) {
    VALUE = 0,
    LIGHTNESS = 1,
};
pub const D2D1_RGBTOHUE_OUTPUT_COLOR_SPACE_HUE_SATURATION_VALUE = D2D1_RGBTOHUE_OUTPUT_COLOR_SPACE.VALUE;
pub const D2D1_RGBTOHUE_OUTPUT_COLOR_SPACE_HUE_SATURATION_LIGHTNESS = D2D1_RGBTOHUE_OUTPUT_COLOR_SPACE.LIGHTNESS;

pub const D2D1_HUETORGB_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_HUETORGB_PROP_INPUT_COLOR_SPACE = D2D1_HUETORGB_PROP.E;

pub const D2D1_HUETORGB_INPUT_COLOR_SPACE = enum(i32) {
    VALUE = 0,
    LIGHTNESS = 1,
};
pub const D2D1_HUETORGB_INPUT_COLOR_SPACE_HUE_SATURATION_VALUE = D2D1_HUETORGB_INPUT_COLOR_SPACE.VALUE;
pub const D2D1_HUETORGB_INPUT_COLOR_SPACE_HUE_SATURATION_LIGHTNESS = D2D1_HUETORGB_INPUT_COLOR_SPACE.LIGHTNESS;

pub const D2D1_CHROMAKEY_PROP = enum(i32) {
    COLOR = 0,
    TOLERANCE = 1,
    INVERT_ALPHA = 2,
    FEATHER = 3,
...
pub const D2D1_EMBOSS_PROP = enum(i32) {
    HEIGHT = 0,
    DIRECTION = 1,
};
...
pub const D2D1_EXPOSURE_PROP = enum(i32) {
    E = 0,
};
pub const D2D1_EXPOSURE_PROP_EXPOSURE_VALUE = D2D1_EXPOSURE_PROP.E;

pub const D2D1_POSTERIZE_PROP = enum(i32) {
    RED_VALUE_COUNT = 0,
    GREEN_VALUE_COUNT = 1,
    BLUE_VALUE_COUNT = 2,
};
...
pub const D2D1_SEPIA_PROP = enum(i32) {
    INTENSITY = 0,
    ALPHA_MODE = 1,
};
...
pub const D2D1_SHARPEN_PROP = enum(i32) {
    SHARPNESS = 0,
    THRESHOLD = 1,
};
...
pub const D2D1_STRAIGHTEN_PROP = enum(i32) {
    ANGLE = 0,
    MAINTAIN_SIZE = 1,
    SCALE_MODE = 2,
};
...
pub const D2D1_STRAIGHTEN_SCALE_MODE = enum(i32) {
    NEAREST_NEIGHBOR = 0,
    LINEAR = 1,
    CUBIC = 2,
    MULTI_SAMPLE_LINEAR = 3,
...
pub const D2D1_TEMPERATUREANDTINT_PROP = enum(i32) {
    EMPERATURE = 0,
    INT = 1,
};
pub const D2D1_TEMPERATUREANDTINT_PROP_TEMPERATURE = D2D1_TEMPERATUREANDTINT_PROP.EMPERATURE;
pub const D2D1_TEMPERATUREANDTINT_PROP_TINT = D2D1_TEMPERATUREANDTINT_PROP.INT;

pub const D2D1_VIGNETTE_PROP = enum(i32) {
    COLOR = 0,
    TRANSITION_SIZE = 1,
    STRENGTH = 2,
};
...
pub const D2D1_EDGEDETECTION_PROP = enum(i32) {
    STRENGTH = 0,
    BLUR_RADIUS = 1,
    MODE = 2,
    OVERLAY_EDGES = 3,
...
pub const D2D1_EDGEDETECTION_MODE = enum(i32) {
    SOBEL = 0,
    PREWITT = 1,
};
...
pub const D2D1_HIGHLIGHTSANDSHADOWS_PROP = enum(i32) {
    HIGHLIGHTS = 0,
    SHADOWS = 1,
    CLARITY = 2,
    INPUT_GAMMA = 3,
...
pub const D2D1_HIGHLIGHTSANDSHADOWS_INPUT_GAMMA = enum(i32) {
    LINEAR = 0,
    SRGB = 1,
};
...
pub const D2D1_LOOKUPTABLE3D_PROP = enum(i32) {
    LUT = 0,
    ALPHA_MODE = 1,
};
...
pub const D2D1_OPACITY_PROP = enum(i32) {
    Y = 0,
};
pub const D2D1_OPACITY_PROP_OPACITY = D2D1_OPACITY_PROP.Y;

pub const D2D1_CROSSFADE_PROP = enum(i32) {
    T = 0,
};
pub const D2D1_CROSSFADE_PROP_WEIGHT = D2D1_CROSSFADE_PROP.T;

pub const D2D1_TINT_PROP = enum(i32) {
    OLOR = 0,
    LAMP_OUTPUT = 1,
};
pub const D2D1_TINT_PROP_COLOR = D2D1_TINT_PROP.OLOR;
pub const D2D1_TINT_PROP_CLAMP_OUTPUT = D2D1_TINT_PROP.LAMP_OUTPUT;

pub const D2D1_WHITELEVELADJUSTMENT_PROP = enum(i32) {
    INPUT_WHITE_LEVEL = 0,
...
pub const D2D1_HDRTONEMAP_PROP = enum(i32) {
...
pub const D2D1_HDRTONEMAP_DISPLAY_MODE = enum(i32) {
    SDR = 0,
    HDR = 1,
};
...
pub const D2D1_RENDERING_PRIORITY = enum(i32) {
    NORMAL = 0,
    LOW = 1,
};
...
pub const D2D1_SVG_PAINT_TYPE = enum(i32) {
    NONE = 0,
    COLOR = 1,
    CURRENT_COLOR = 2,
    URI = 3,
...
pub const D2D1_SVG_LENGTH_UNITS = enum(i32) {
    NUMBER = 0,
    PERCENTAGE = 1,
};
...
pub const D2D1_SVG_DISPLAY = enum(i32) {
    INLINE = 0,
    NONE = 1,
};
...
pub const D2D1_SVG_VISIBILITY = enum(i32) {
    VISIBLE = 0,
    HIDDEN = 1,
};
...
pub const D2D1_SVG_OVERFLOW = enum(i32) {
    VISIBLE = 0,
    HIDDEN = 1,
};
...
pub const D2D1_SVG_LINE_CAP = enum(i32) {
    BUTT = 0,
    SQUARE = 1,
    ROUND = 2,
};
...
pub const D2D1_SVG_LINE_JOIN = enum(i32) {
    BEVEL = 1,
    MITER = 3,
    ROUND = 2,
};
...
pub const D2D1_SVG_ASPECT_ALIGN = enum(i32) {
    NONE = 0,
    X_MIN_Y_MIN = 1,
    X_MID_Y_MIN = 2,
    X_MAX_Y_MIN = 3,
...
pub const D2D1_SVG_ASPECT_SCALING = enum(i32) {
    MEET = 0,
    SLICE = 1,
};
...
pub const D2D1_SVG_PATH_COMMAND = enum(i32) {
    CLOSE_PATH = 0,
    MOVE_ABSOLUTE = 1,
    MOVE_RELATIVE = 2,
    LINE_ABSOLUTE = 3,
...
pub const D2D1_SVG_UNIT_TYPE = enum(i32) {
    USER_SPACE_ON_USE = 0,
...
pub const D2D1_SVG_ATTRIBUTE_STRING_TYPE = enum(i32) {
    SVG = 0,
    ID = 1,
};
...
pub const D2D1_SVG_ATTRIBUTE_POD_TYPE = enum(i32) {
    FLOAT = 0,
    COLOR = 1,
    FILL_MODE = 2,
    DISPLAY = 3,
...
pub const ID2D1SvgPaint = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgPaint_SetId(self: *const T, id: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ID2D1SvgElement = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_CreateChild(self: *const T, tagName: ?[*:0]align(1) const u16, newChild: ?*?*ID2D1SvgElement) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_IsAttributeSpecified(self: *const T, name: ?[*:0]align(1) const u16, inherited: ?*BOOL) callconv(.Inline) BOOL {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_RemoveAttribute(self: *const T, name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_SetAttributeValue(self: *const T, name: ?[*:0]align(1) const u16, value: ?*ID2D1SvgAttribute) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_SetAttributeValue1(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_SVG_ATTRIBUTE_POD_TYPE, value: ?*const anyopaque, valueSizeInBytes: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_SetAttributeValue2(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_SVG_ATTRIBUTE_STRING_TYPE, value: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_GetAttributeValue(self: *const T, name: ?[*:0]align(1) const u16, riid: ?*const Guid, value: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_GetAttributeValue1(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_SVG_ATTRIBUTE_POD_TYPE, value: ?*anyopaque, valueSizeInBytes: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_GetAttributeValue2(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_SVG_ATTRIBUTE_STRING_TYPE, value: [*:0]u16, valueCount: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgElement_GetAttributeValueLength(self: *const T, name: ?[*:0]align(1) const u16, type_: D2D1_SVG_ATTRIBUTE_STRING_TYPE, valueLength: ?*u32) callconv(.Inline) HRESULT {
...
pub const ID2D1SvgDocument = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgDocument_FindElementById(self: *const T, id: ?[*:0]align(1) const u16, svgElement: ?*?*ID2D1SvgElement) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ID2D1SvgDocument_CreatePaint(self: *const T, paintType: D2D1_SVG_PAINT_TYPE, color: ?*const D2D1_COLOR_F, id: ?[*:0]align(1) const u16, paint: ?*?*ID2D1SvgPaint) callconv(.Inline) HRESULT {
...
pub const D2D1_INK_NIB_SHAPE = enum(i32) {
    ROUND = 0,
    SQUARE = 1,
};
...
pub const D2D1_ORIENTATION = enum(i32) {
    DEFAULT = 1,
    FLIP_HORIZONTAL = 2,
    ROTATE_CLOCKWISE180 = 3,
    ROTATE_CLOCKWISE180_FLIP_HORIZONTAL = 4,
...
pub const D2D1_IMAGE_SOURCE_LOADING_OPTIONS = enum(i32) {
    NONE = 0,
    RELEASE_SOURCE = 1,
    CACHE_ON_DEMAND = 2,
    _,
...
pub const D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS = enum(i32) {
    NONE = 0,
...
pub const D2D1_TRANSFORMED_IMAGE_SOURCE_OPTIONS = enum(i32) {
    NONE = 0,
    DISABLE_DPI_SCALE = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const D2D1_PATCH_EDGE_MODE = enum(i32) {
    LIASED = 0,
    NTIALIASED = 1,
    LIASED_INFLATED = 2,
};
pub const D2D1_PATCH_EDGE_MODE_ALIASED = D2D1_PATCH_EDGE_MODE.LIASED;
pub const D2D1_PATCH_EDGE_MODE_ANTIALIASED = D2D1_PATCH_EDGE_MODE.NTIALIASED;
pub const D2D1_PATCH_EDGE_MODE_ALIASED_INFLATED = D2D1_PATCH_EDGE_MODE.LIASED_INFLATED;
...
pub const D2D1_SPRITE_OPTIONS = enum(i32) {
    NONE = 0,
...
pub const D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION = enum(i32) {
    EFAULT = 0,
    ISABLE = 1,
};
pub const D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION_DEFAULT = D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION.EFAULT;
pub const D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION_DISABLE = D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION.ISABLE;

pub const D2D1_GAMMA1 = enum(i32) {
    @"22" = 0,
    @"10" = 1,
    @"2084" = 2,
};
pub const D2D1_GAMMA1_G22 = D2D1_GAMMA1.@"22";
pub const D2D1_GAMMA1_G10 = D2D1_GAMMA1.@"10";
pub const D2D1_GAMMA1_G2084 = D2D1_GAMMA1.@"2084";
...
pub const D2D1_COLOR_CONTEXT_TYPE = enum(i32) {
    ICC = 0,
    SIMPLE = 1,
    DXGI = 2,
};
...
const D2D1_ALPHA_MODE = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_ALPHA_MODE;
const D2D1_BEZIER_SEGMENT = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_BEZIER_SEGMENT;
const D2D1_BLEND_MODE = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_BLEND_MODE;
const D2D1_COLOR_F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_COLOR_F;
const D2D1_COMPOSITE_MODE = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_COMPOSITE_MODE;
const D2D1_FILL_MODE = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_FILL_MODE;
const D2D1_PIXEL_FORMAT = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D1_PIXEL_FORMAT;
const D2D_MATRIX_3X2_F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_MATRIX_3X2_F;
const D2D_MATRIX_4X4_F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_MATRIX_4X4_F;
const D2D_POINT_2F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_POINT_2F;
const D2D_POINT_2U = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_POINT_2U;
const D2D_RECT_F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_RECT_F;
const D2D_RECT_U = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_RECT_U;
const D2D_SIZE_F = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_SIZE_F;
const D2D_SIZE_U = @import("../../../windows/win32/graphics/direct2d/common.zig").D2D_SIZE_U;
const D3D_FEATURE_LEVEL = @import("../../../windows/win32/graphics/direct3d.zig").D3D_FEATURE_LEVEL;
const DWRITE_GLYPH_IMAGE_FORMATS = @import("../../../windows/win32/graphics/direct_write.zig").DWRITE_GLYPH_IMAGE_FORMATS;
const DWRITE_GLYPH_RUN = @import("../../../windows/win32/graphics/direct_write.zig").DWRITE_GLYPH_RUN;
const DWRITE_GLYPH_RUN_DESCRIPTION = @import("../../../windows/win32/graphics/direct_write.zig").DWRITE_GLYPH_RUN_DESCRIPTION;
const DWRITE_MEASURING_MODE = @import("../../../windows/win32/graphics/direct_write.zig").DWRITE_MEASURING_MODE;
const DXGI_COLOR_SPACE_TYPE = @import("../../../windows/win32/graphics/dxgi/common.zig").DXGI_COLOR_SPACE_TYPE;
...
const ID2D1SimplifiedGeometrySink = @import("../../../windows/win32/graphics/direct2d/common.zig").ID2D1SimplifiedGeometrySink;
const IDWriteFontFace = @import("../../../windows/win32/graphics/direct_write.zig").IDWriteFontFace;
const IDWriteRenderingParams = @import("../../../windows/win32/graphics/direct_write.zig").IDWriteRenderingParams;
const IDWriteTextFormat = @import("../../../windows/win32/graphics/direct_write.zig").IDWriteTextFormat;
const IDWriteTextLayout = @import("../../../windows/win32/graphics/direct_write.zig").IDWriteTextLayout;
...
const IPrintDocumentPackageTarget = @import("../../../windows/win32/storage/xps/printing.zig").IPrintDocumentPackageTarget;
const IStream = @import("../../../windows/win32/system/com.zig").IStream;
const IUnknown = @import("../../../windows/win32/system/com.zig").IUnknown;
const IWICBitmap = @import("../../../windows/win32/graphics/imaging.zig").IWICBitmap;
const IWICBitmapSource = @import("../../../windows/win32/graphics/imaging.zig").IWICBitmapSource;
const IWICColorContext = @import("../../../windows/win32/graphics/imaging.zig").IWICColorContext;
const IWICImagingFactory = @import("../../../windows/win32/graphics/imaging.zig").IWICImagingFactory;
