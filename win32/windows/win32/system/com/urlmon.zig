...
pub const IMonikerProp = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMonikerProp_PutProperty(self: *const T, mkp: MONIKERPROPERTY, val: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBindProtocol = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBindProtocol_CreateBinding(self: *const T, szUrl: ?[*:0]align(1) const u16, pbc: ?*IBindCtx, ppb: ?*?*IBinding) callconv(.Inline) HRESULT {
...
pub const IHttpNegotiate = extern struct {
    pub const VTable = extern struct {
        ...
        OnResponse: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IHttpNegotiate,
                dwResponseCode: u32,
                szResponseHeaders: ?[*:0]align(1) const u16,
                szRequestHeaders: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IHttpNegotiate_BeginningTransaction(self: *const T, szURL: ?[*:0]align(1) const u16, szHeaders: ?[*:0]align(1) const u16, dwReserved: u32, pszAdditionalHeaders: ?*?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IHttpNegotiate_OnResponse(self: *const T, dwResponseCode: u32, szResponseHeaders: ?[*:0]align(1) const u16, szRequestHeaders: ?[*:0]align(1) const u16, pszAdditionalRequestHeaders: ?*?PWSTR) callconv(.Inline) HRESULT {
...
pub const ICodeInstall = extern struct {
    pub const VTable = extern struct {
        ...
        OnCodeInstallProblem: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                ulStatusCode: u32,
                szDestination: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICodeInstall_OnCodeInstallProblem(self: *const T, ulStatusCode: u32, szDestination: ?[*:0]align(1) const u16, szSource: ?[*:0]align(1) const u16, dwReserved: u32) callconv(.Inline) HRESULT {
...
pub const IWinInetCacheHints = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinInetCacheHints_SetCacheExtension(self: *const T, pwzExt: ?[*:0]align(1) const u16, pszCacheFile: [*]u8, pcbCacheFile: ?*u32, pdwWinInetError: ?*u32, pdwReserved: ?*u32) callconv(.Inline) HRESULT {
...
pub const IWinInetCacheHints2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWinInetCacheHints2_SetCacheExtension2(self: *const T, pwzExt: ?[*:0]align(1) const u16, pwzCacheFile: [*:0]u16, pcchCacheFile: ?*u32, pdwWinInetError: ?*u32, pdwReserved: ?*u32) callconv(.Inline) HRESULT {
...
pub const IInternetProtocolRoot = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolRoot_Start(self: *const T, szUrl: ?[*:0]align(1) const u16, pOIProtSink: ?*IInternetProtocolSink, pOIBindInfo: ?*IInternetBindInfo, grfPI: u32, dwReserved: HANDLE_PTR) callconv(.Inline) HRESULT {
...
pub const IInternetProtocol = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocol_Seek(self: *const T, dlibMove: i64, dwOrigin: u32, plibNewPosition: ?*u64) callconv(.Inline) HRESULT {
...
pub const IInternetProtocolSink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolSink_ReportProgress(self: *const T, ulStatusCode: u32, szStatusText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolSink_ReportResult(self: *const T, hrResult: HRESULT, dwError: u32, szResult: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IInternetSession = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterNameSpace: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pCF: ?*IClassFactory,
                rclsid: ?*const Guid,
                pwzProtocol: ?[*:0]align(1) const u16,
                cPatterns: u32,
        ...
        UnregisterNameSpace: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IInternetSession,
                pCF: ?*IClassFactory,
                pszProtocol: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IInternetSession,
                pCF: ?*IClassFactory,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSession_RegisterNameSpace(self: *const T, pCF: ?*IClassFactory, rclsid: ?*const Guid, pwzProtocol: ?[*:0]align(1) const u16, cPatterns: u32, ppwzPatterns: ?*const ?PWSTR, dwReserved: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSession_UnregisterNameSpace(self: *const T, pCF: ?*IClassFactory, pszProtocol: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSession_RegisterMimeFilter(self: *const T, pCF: ?*IClassFactory, rclsid: ?*const Guid, pwzType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSession_UnregisterMimeFilter(self: *const T, pCF: ?*IClassFactory, pwzType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSession_CreateBinding(self: *const T, pBC: ?*IBindCtx, szUrl: ?[*:0]align(1) const u16, pUnkOuter: ?*IUnknown, ppUnk: ?*?*IUnknown, ppOInetProt: ?*?*IInternetProtocol, dwOption: u32) callconv(.Inline) HRESULT {
...
pub const IInternetProtocolInfo = extern struct {
    pub const VTable = extern struct {
        ...
        CombineUrl: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IInternetProtocolInfo,
                pwzBaseUrl: ?[*:0]align(1) const u16,
                pwzRelativeUrl: ?[*:0]align(1) const u16,
                dwCombineFlags: u32,
                pwzResult: ?PWSTR,
                cchResult: u32,
                pcchResult: ?*u32,
        ...
        CompareUrl: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IInternetProtocolInfo,
                pwzUrl1: ?[*:0]align(1) const u16,
                pwzUrl2: ?[*:0]align(1) const u16,
                dwCompareFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IInternetProtocolInfo,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolInfo_ParseUrl(self: *const T, pwzUrl: ?[*:0]align(1) const u16, ParseAction: PARSEACTION, dwParseFlags: u32, pwzResult: ?PWSTR, cchResult: u32, pcchResult: ?*u32, dwReserved: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolInfo_CombineUrl(self: *const T, pwzBaseUrl: ?[*:0]align(1) const u16, pwzRelativeUrl: ?[*:0]align(1) const u16, dwCombineFlags: u32, pwzResult: ?PWSTR, cchResult: u32, pcchResult: ?*u32, dwReserved: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolInfo_CompareUrl(self: *const T, pwzUrl1: ?[*:0]align(1) const u16, pwzUrl2: ?[*:0]align(1) const u16, dwCompareFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolInfo_QueryInfo(self: *const T, pwzUrl: ?[*:0]align(1) const u16, OueryOption: QUERYOPTION, dwQueryFlags: u32, pBuffer: [*]u8, cbBuffer: u32, pcbBuf: ?*u32, dwReserved: u32) callconv(.Inline) HRESULT {
...
pub const IInternetSecurityManager = extern struct {
    pub const VTable = extern struct {
        ...
        SetZoneMapping: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IInternetSecurityManager,
                dwZone: u32,
                lpszPattern: ?[*:0]align(1) const u16,
                dwFlags: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IInternetSecurityManager,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManager_MapUrlToZone(self: *const T, pwszUrl: ?[*:0]align(1) const u16, pdwZone: ?*u32, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManager_GetSecurityId(self: *const T, pwszUrl: ?[*:0]align(1) const u16, pbSecurityId: *[512]u8, pcbSecurityId: ?*u32, dwReserved: usize) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManager_ProcessUrlAction(self: *const T, pwszUrl: ?[*:0]align(1) const u16, dwAction: u32, pPolicy: [*:0]u8, cbPolicy: u32, pContext: ?*u8, cbContext: u32, dwFlags: u32, dwReserved: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManager_QueryCustomPolicy(self: *const T, pwszUrl: ?[*:0]align(1) const u16, guidKey: ?*const Guid, ppPolicy: [*]?*u8, pcbPolicy: ?*u32, pContext: ?*u8, cbContext: u32, dwReserved: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManager_SetZoneMapping(self: *const T, dwZone: u32, lpszPattern: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
...
pub const IInternetSecurityManagerEx = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetSecurityManagerEx_ProcessUrlActionEx(self: *const T, pwszUrl: ?[*:0]align(1) const u16, dwAction: u32, pPolicy: [*:0]u8, cbPolicy: u32, pContext: ?*u8, cbContext: u32, dwFlags: u32, dwReserved: u32, pdwOutFlags: ?*u32) callconv(.Inline) HRESULT {
...
pub const IZoneIdentifier2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IZoneIdentifier2_SetLastWriterPackageFamilyName(self: *const T, packageFamilyName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IInternetZoneManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetZoneManager_PromptAction(self: *const T, dwAction: u32, hwndParent: ?HWND, pwszUrl: ?[*:0]align(1) const u16, pwszText: ?[*:0]align(1) const u16, dwPromptFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetZoneManager_LogAction(self: *const T, dwAction: u32, pwszUrl: ?[*:0]align(1) const u16, pwszText: ?[*:0]align(1) const u16, dwLogFlags: u32) callconv(.Inline) HRESULT {
...
pub const ISoftDistExt = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISoftDistExt_ProcessSoftDist(self: *const T, szCDFURL: ?[*:0]align(1) const u16, pSoftDistElement: ?*IXMLElement, lpsdi: ?*SOFTDISTINFO) callconv(.Inline) HRESULT {
...
pub const IEncodingFilterFactory = extern struct {
    pub const VTable = extern struct {
        ...
        FindBestFilter: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwzCodeIn: ?[*:0]align(1) const u16,
                pwzCodeOut: ?[*:0]align(1) const u16,
                info: DATAINFO,
                ppDF: ?*?*IDataFilter,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEncodingFilterFactory_FindBestFilter(self: *const T, pwzCodeIn: ?[*:0]align(1) const u16, pwzCodeOut: ?[*:0]align(1) const u16, info: DATAINFO, ppDF: ?*?*IDataFilter) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEncodingFilterFactory_GetDefaultFilter(self: *const T, pwzCodeIn: ?[*:0]align(1) const u16, pwzCodeOut: ?[*:0]align(1) const u16, ppDF: ?*?*IDataFilter) callconv(.Inline) HRESULT {
...
pub const PROTOCOL_ARGUMENT = extern struct {
    szMethod: ?[*:0]align(1) const u16,
    szTargetUrl: ?[*:0]align(1) const u16,
};
...
pub const IBindCallbackRedirect = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBindCallbackRedirect_Redirect(self: *const T, lpcUrl: ?[*:0]align(1) const u16, vbCancel: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "urlmon" fn MkParseDisplayNameEx(
    pbc: ?*IBindCtx,
    szDisplayName: ?[*:0]align(1) const u16,
    pchEaten: ?*u32,
    ppmk: ?*?*IMoniker,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn CoGetClassObjectFromURL(
    rCLASSID: ?*const Guid,
    szCODE: ?[*:0]align(1) const u16,
    dwFileVersionMS: u32,
    dwFileVersionLS: u32,
    szTYPE: ?[*:0]align(1) const u16,
    pBindCtx: ?*IBindCtx,
    dwClsContext: CLSCTX,
    pvReserved: ?*anyopaque,
    riid: ?*const Guid,
...
pub extern "urlmon" fn RegisterMediaTypes(
    ctypes: u32,
    rgszTypes: [*]const ?[*:0]align(1) const u8,
    rgcfTypes: [*:0]u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "urlmon" fn FindMediaType(
    rgszTypes: ?[*:0]align(1) const u8,
    rgcfTypes: ?*u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn FindMimeFromData(
    ...
    pBuffer: ?*anyopaque,
    cbSize: u32,
    pwzMimeProposed: ?[*:0]align(1) const u16,
    dwMimeFlags: u32,
    ppwzMimeOut: ?*?PWSTR,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn HlinkSimpleNavigateToString(
    szTarget: ?[*:0]align(1) const u16,
    szLocation: ?[*:0]align(1) const u16,
    szTargetFrameName: ?[*:0]align(1) const u16,
    pUnk: ?*IUnknown,
    pbc: ?*IBindCtx,
...
pub extern "urlmon" fn CoInternetIsFeatureZoneElevationEnabled(
    szFromURL: ?[*:0]align(1) const u16,
    szToURL: ?[*:0]align(1) const u16,
    pSecMgr: ?*IInternetSecurityManager,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "urlmon" fn GetSoftwareUpdateInfo(
    szDistUnit: ?[*:0]align(1) const u16,
    psdi: ?*SOFTDISTINFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const IBinding = @import("../../../../windows/win32/system/com.zig").IBinding;
...
const IUriBuilder = @import("../../../../windows/win32/system/com.zig").IUriBuilder;
const IXMLElement = @import("../../../../windows/win32/data/xml/ms_xml.zig").IXMLElement;
const PSTR = @import("../../../../windows/win32/foundation.zig").PSTR;
const PWSTR = @import("../../../../windows/win32/foundation.zig").PWSTR;
const QUERYCONTEXT = @import("../../../../windows/win32/system/com.zig").QUERYCONTEXT;
...
const uCLSSPEC = @import("../../../../windows/win32/system/com.zig").uCLSSPEC;
