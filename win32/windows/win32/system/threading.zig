...
//--------------------------------------------------------------------------------
pub const ALL_PROCESSOR_GROUPS = @as(u16, 65535);
pub const FLS_OUT_OF_INDEXES = @as(u32, 4294967295);
pub const PRIVATE_NAMESPACE_FLAG_DESTROY = @as(u32, 1);
pub const TLS_OUT_OF_INDEXES = @as(u32, 4294967295);
...
pub const PF_PPC_MOVEMEM_64BIT_OK = PROCESSOR_FEATURE_ID.PPC_MOVEMEM_64BIT_OK;
pub const PF_ALPHA_BYTE_INSTRUCTIONS = PROCESSOR_FEATURE_ID.ALPHA_BYTE_INSTRUCTIONS;
...
pub const PF_SSE_DAZ_MODE_AVAILABLE = PROCESSOR_FEATURE_ID.SSE_DAZ_MODE_AVAILABLE;
...
pub const PF_ARM_NEON_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.ARM_NEON_INSTRUCTIONS_AVAILABLE;
...
pub const PF_RDRAND_INSTRUCTION_AVAILABLE = PROCESSOR_FEATURE_ID.RDRAND_INSTRUCTION_AVAILABLE;
...
pub const PF_RDTSCP_INSTRUCTION_AVAILABLE = PROCESSOR_FEATURE_ID.RDTSCP_INSTRUCTION_AVAILABLE;
pub const PF_RDPID_INSTRUCTION_AVAILABLE = PROCESSOR_FEATURE_ID.RDPID_INSTRUCTION_AVAILABLE;
pub const PF_ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE;
pub const PF_MONITORX_INSTRUCTION_AVAILABLE = PROCESSOR_FEATURE_ID.MONITORX_INSTRUCTION_AVAILABLE;
pub const PF_SSSE3_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.SSSE3_INSTRUCTIONS_AVAILABLE;
pub const PF_SSE4_1_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.SSE4_1_INSTRUCTIONS_AVAILABLE;
pub const PF_SSE4_2_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.SSE4_2_INSTRUCTIONS_AVAILABLE;
pub const PF_AVX_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.AVX_INSTRUCTIONS_AVAILABLE;
pub const PF_AVX2_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.AVX2_INSTRUCTIONS_AVAILABLE;
pub const PF_AVX512F_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.AVX512F_INSTRUCTIONS_AVAILABLE;
pub const PF_ERMS_AVAILABLE = PROCESSOR_FEATURE_ID.ERMS_AVAILABLE;
pub const PF_ARM_V82_DP_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.ARM_V82_DP_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE = PROCESSOR_FEATURE_ID.ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE;
...
pub const SYNCHRONIZATION_ACCESS_RIGHTS = enum(u32) {
    EVENT_ALL_ACCESS = 2031619,
    EVENT_MODIFY_STATE = 2,
    MUTEX_ALL_ACCESS = 2031617,
    MUTEX_MODIFY_STATE = 1,
    // SEMAPHORE_ALL_ACCESS = 2031619, this enum value conflicts with EVENT_ALL_ACCESS
    // SEMAPHORE_MODIFY_STATE = 2, this enum value conflicts with EVENT_MODIFY_STATE
    // TIMER_ALL_ACCESS = 2031619, this enum value conflicts with EVENT_ALL_ACCESS
    // TIMER_MODIFY_STATE = 2, this enum value conflicts with EVENT_MODIFY_STATE
    // TIMER_QUERY_STATE = 1, this enum value conflicts with MUTEX_MODIFY_STATE
    ...
    _,
    pub fn initFlags(o: struct {
        EVENT_ALL_ACCESS: u1 = 0,
        EVENT_MODIFY_STATE: u1 = 0,
        MUTEX_ALL_ACCESS: u1 = 0,
        ...
        return @as(SYNCHRONIZATION_ACCESS_RIGHTS, @enumFromInt(
              (if (o.EVENT_ALL_ACCESS == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_ALL_ACCESS) else 0)
            | (if (o.EVENT_MODIFY_STATE == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_MODIFY_STATE) else 0)
            | (if (o.MUTEX_ALL_ACCESS == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.MUTEX_ALL_ACCESS) else 0)
            | (if (o.MUTEX_MODIFY_STATE == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.MUTEX_MODIFY_STATE) else 0)
            | (if (o.SYNCHRONIZATION_DELETE == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_DELETE) else 0)
            | (if (o.SYNCHRONIZATION_READ_CONTROL == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_READ_CONTROL) else 0)
            | (if (o.SYNCHRONIZATION_WRITE_DAC == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_WRITE_DAC) else 0)
            | (if (o.SYNCHRONIZATION_WRITE_OWNER == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_WRITE_OWNER) else 0)
            | (if (o.SYNCHRONIZATION_SYNCHRONIZE == 1) @intFromEnum(SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_SYNCHRONIZE) else 0)
        ));
    }
};
pub const EVENT_ALL_ACCESS = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_ALL_ACCESS;
pub const EVENT_MODIFY_STATE = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_MODIFY_STATE;
pub const MUTEX_ALL_ACCESS = SYNCHRONIZATION_ACCESS_RIGHTS.MUTEX_ALL_ACCESS;
pub const MUTEX_MODIFY_STATE = SYNCHRONIZATION_ACCESS_RIGHTS.MUTEX_MODIFY_STATE;
pub const SEMAPHORE_ALL_ACCESS = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_ALL_ACCESS;
pub const SEMAPHORE_MODIFY_STATE = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_MODIFY_STATE;
pub const TIMER_ALL_ACCESS = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_ALL_ACCESS;
pub const TIMER_MODIFY_STATE = SYNCHRONIZATION_ACCESS_RIGHTS.EVENT_MODIFY_STATE;
pub const TIMER_QUERY_STATE = SYNCHRONIZATION_ACCESS_RIGHTS.MUTEX_MODIFY_STATE;
pub const SYNCHRONIZATION_DELETE = SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_DELETE;
pub const SYNCHRONIZATION_READ_CONTROL = SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_READ_CONTROL;
pub const SYNCHRONIZATION_WRITE_DAC = SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_WRITE_DAC;
pub const SYNCHRONIZATION_WRITE_OWNER = SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_WRITE_OWNER;
pub const SYNCHRONIZATION_SYNCHRONIZE = SYNCHRONIZATION_ACCESS_RIGHTS.SYNCHRONIZATION_SYNCHRONIZE;
...
// TODO: this type has a FreeFunc 'CloseThreadpoolCleanupGroup', what can Zig do with this information?
...
pub const QUEUE_USER_APC_FLAGS_NONE = QUEUE_USER_APC_FLAGS.FLAGS_NONE;
pub const QUEUE_USER_APC_FLAGS_SPECIAL_USER_APC = QUEUE_USER_APC_FLAGS.FLAGS_SPECIAL_USER_APC;
pub const QUEUE_USER_APC_CALLBACK_DATA_CONTEXT = QUEUE_USER_APC_FLAGS.CALLBACK_DATA_CONTEXT;
...
pub const MACHINE_ATTRIBUTES = enum(i32) {
    UserEnabled = 1,
    KernelEnabled = 2,
    Wow64Container = 4,
    _,
...
pub const RTWQPERIODICCALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        context: ?*IUnknown,
    ) callconv(@import("std").os.windows.WINAPI) void,
    else => *const fn(
...
pub const RTWQ_WORKQUEUE_TYPE = enum(i32) {
    STANDARD_WORKQUEUE = 0,
    WINDOW_WORKQUEUE = 1,
    MULTITHREADED_WORKQUEUE = 2,
};
pub const RTWQ_STANDARD_WORKQUEUE = RTWQ_WORKQUEUE_TYPE.STANDARD_WORKQUEUE;
pub const RTWQ_WINDOW_WORKQUEUE = RTWQ_WORKQUEUE_TYPE.WINDOW_WORKQUEUE;
pub const RTWQ_MULTITHREADED_WORKQUEUE = RTWQ_WORKQUEUE_TYPE.MULTITHREADED_WORKQUEUE;

// TODO: this type is limited to platform 'windows8.1'
const IID_IRtwqAsyncResult_Value = Guid.initString("ac6b7889-0740-4d51-8619-905994a55cc6");
pub const IID_IRtwqAsyncResult = &IID_IRtwqAsyncResult_Value;
pub const IRtwqAsyncResult = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetState: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRtwqAsyncResult,
                ppunkState: ?*?*IUnknown,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IRtwqAsyncResult_GetState(self: *const T, ppunkState: ?*?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncResult.VTable, @ptrCast(self.vtable)).GetState(@as(*const IRtwqAsyncResult, @ptrCast(self)), ppunkState);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncResult_GetStatus(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncResult.VTable, @ptrCast(self.vtable)).GetStatus(@as(*const IRtwqAsyncResult, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncResult_SetStatus(self: *const T, hrStatus: HRESULT) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncResult.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IRtwqAsyncResult, @ptrCast(self)), hrStatus);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncResult_GetObject(self: *const T, ppObject: ?*?*IUnknown) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncResult.VTable, @ptrCast(self.vtable)).GetObject(@as(*const IRtwqAsyncResult, @ptrCast(self)), ppObject);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncResult_GetStateNoAddRef(self: *const T) callconv(.Inline) ?*IUnknown {
            return @as(*const IRtwqAsyncResult.VTable, @ptrCast(self.vtable)).GetStateNoAddRef(@as(*const IRtwqAsyncResult, @ptrCast(self)));
        }
    };}
...
// TODO: this type is limited to platform 'windows8.1'
const IID_IRtwqAsyncCallback_Value = Guid.initString("a27003cf-2354-4f2a-8d6a-ab7cff15437e");
pub const IID_IRtwqAsyncCallback = &IID_IRtwqAsyncCallback_Value;
pub const IRtwqAsyncCallback = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetParameters: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRtwqAsyncCallback,
                pdwFlags: ?*u32,
                pdwQueue: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncCallback_GetParameters(self: *const T, pdwFlags: ?*u32, pdwQueue: ?*u32) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncCallback.VTable, @ptrCast(self.vtable)).GetParameters(@as(*const IRtwqAsyncCallback, @ptrCast(self)), pdwFlags, pdwQueue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqAsyncCallback_Invoke(self: *const T, pAsyncResult: ?*IRtwqAsyncResult) callconv(.Inline) HRESULT {
            return @as(*const IRtwqAsyncCallback.VTable, @ptrCast(self.vtable)).Invoke(@as(*const IRtwqAsyncCallback, @ptrCast(self)), pAsyncResult);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};

pub const RTWQASYNCRESULT = extern struct {
    pub const VTable = extern struct {
        base: IRtwqAsyncResult.VTable,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IRtwqAsyncResult.MethodMixin(T);
    };}
    pub usingnamespace MethodMixin(@This());
};

// TODO: this type is limited to platform 'windows8.1'
const IID_IRtwqPlatformEvents_Value = Guid.initString("63d9255a-7ff1-4b61-8faf-ed6460dacf2b");
pub const IID_IRtwqPlatformEvents = &IID_IRtwqPlatformEvents_Value;
pub const IRtwqPlatformEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        InitializationComplete: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRtwqPlatformEvents,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IRtwqPlatformEvents,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        },
        ShutdownStart: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRtwqPlatformEvents,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        ShutdownComplete: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRtwqPlatformEvents,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqPlatformEvents_InitializationComplete(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IRtwqPlatformEvents.VTable, @ptrCast(self.vtable)).InitializationComplete(@as(*const IRtwqPlatformEvents, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqPlatformEvents_ShutdownStart(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IRtwqPlatformEvents.VTable, @ptrCast(self.vtable)).ShutdownStart(@as(*const IRtwqPlatformEvents, @ptrCast(self)));
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRtwqPlatformEvents_ShutdownComplete(self: *const T) callconv(.Inline) HRESULT {
            return @as(*const IRtwqPlatformEvents.VTable, @ptrCast(self.vtable)).ShutdownComplete(@as(*const IRtwqPlatformEvents, @ptrCast(self)));
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const ProcessUserPointerAuthPolicy = PROCESS_MITIGATION_POLICY.ProcessUserPointerAuthPolicy;
pub const ProcessSEHOPPolicy = PROCESS_MITIGATION_POLICY.ProcessSEHOPPolicy;
...
pub const UMS_THREAD_INFO_CLASS = enum(i32) {
    InvalidInfoClass = 0,
    UserContext = 1,
    Priority = 2,
    Affinity = 3,
...
pub const UmsThreadInvalidInfoClass = UMS_THREAD_INFO_CLASS.InvalidInfoClass;
pub const UmsThreadUserContext = UMS_THREAD_INFO_CLASS.UserContext;
pub const UmsThreadPriority = UMS_THREAD_INFO_CLASS.Priority;
pub const UmsThreadAffinity = UMS_THREAD_INFO_CLASS.Affinity;
pub const UmsThreadTeb = UMS_THREAD_INFO_CLASS.Teb;
pub const UmsThreadIsSuspended = UMS_THREAD_INFO_CLASS.IsSuspended;
pub const UmsThreadIsTerminated = UMS_THREAD_INFO_CLASS.IsTerminated;
pub const UmsThreadMaxInfoClass = UMS_THREAD_INFO_CLASS.MaxInfoClass;
...
pub const ProcThreadAttributeTrustedApp = PROC_THREAD_ATTRIBUTE_NUM.TrustedApp;
...
//--------------------------------------------------------------------------------
// Section: Functions (336)
//--------------------------------------------------------------------------------
pub extern "forceinline" fn GetCurrentProcessToken(
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

pub extern "forceinline" fn GetCurrentThreadToken(
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

pub extern "forceinline" fn GetCurrentThreadEffectiveToken(
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "kernel32" fn OpenWaitableTimerW(
    dwDesiredAccess: SYNCHRONIZATION_ACCESS_RIGHTS,
    bInheritHandle: BOOL,
    lpTimerName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "kernel32" fn CreateProcessA(
    ...
    lpCurrentDirectory: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn CreateProcessW(
    ...
    dwCreationFlags: PROCESS_CREATION_FLAGS,
    lpEnvironment: ?*anyopaque,
    lpCurrentDirectory: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn SetThreadDescription(
    hThread: ?HANDLE,
    lpThreadDescription: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
) callconv(@import("std").os.windows.WINAPI) PTP_CLEANUP_GROUP;
...
pub extern "kernel32" fn CreateThreadpoolWork(
    ...
    pv: ?*anyopaque,
    pcbe: ?*TP_CALLBACK_ENVIRON_V3,
) callconv(@import("std").os.windows.WINAPI) PTP_WORK;
...
pub extern "kernel32" fn CreateThreadpoolTimer(
    ...
    pv: ?*anyopaque,
    pcbe: ?*TP_CALLBACK_ENVIRON_V3,
) callconv(@import("std").os.windows.WINAPI) PTP_TIMER;
...
pub extern "kernel32" fn CreateThreadpoolWait(
    ...
    pv: ?*anyopaque,
    pcbe: ?*TP_CALLBACK_ENVIRON_V3,
) callconv(@import("std").os.windows.WINAPI) PTP_WAIT;
...
pub extern "kernel32" fn CreateThreadpoolIo(
    ...
    pv: ?*anyopaque,
    pcbe: ?*TP_CALLBACK_ENVIRON_V3,
) callconv(@import("std").os.windows.WINAPI) PTP_IO;
...
pub extern "kernel32" fn CreatePrivateNamespaceW(
    ...
    lpAliasPrefix: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "avrt" fn AvSetMmThreadCharacteristicsA(
    TaskName: ?[*:0]align(1) const u8,
    TaskIndex: ?*u32,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "avrt" fn AvSetMmThreadCharacteristicsW(
    TaskName: ?[*:0]align(1) const u16,
    TaskIndex: ?*u32,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "avrt" fn AvSetMmMaxThreadCharacteristicsA(
    FirstTask: ?[*:0]align(1) const u8,
    SecondTask: ?[*:0]align(1) const u8,
    TaskIndex: ?*u32,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "avrt" fn AvSetMmMaxThreadCharacteristicsW(
    FirstTask: ?[*:0]align(1) const u16,
    SecondTask: ?[*:0]align(1) const u16,
    TaskIndex: ?*u32,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqStartup(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqShutdown(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqLockWorkQueue(
    workQueueId: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqUnlockWorkQueue(
    workQueueId: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqLockSharedWorkQueue(
    usageClass: ?[*:0]align(1) const u16,
    basePriority: i32,
    taskId: ?*u32,
    id: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqJoinWorkQueue(
    workQueueId: u32,
    hFile: ?HANDLE,
    out: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqUnjoinWorkQueue(
    workQueueId: u32,
    hFile: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqCreateAsyncResult(
    appObject: ?*IUnknown,
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqInvokeCallback(
    result: ?*IRtwqAsyncResult,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqLockPlatform(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqUnlockPlatform(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqRegisterPlatformWithMMCSS(
    usageClass: ?[*:0]align(1) const u16,
    taskId: ?*u32,
    lPriority: i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqUnregisterPlatformFromMMCSS(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqPutWorkItem(
    dwQueue: u32,
    lPriority: i32,
    result: ?*IRtwqAsyncResult,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqPutWaitingWorkItem(
    hEvent: ?HANDLE,
    lPriority: i32,
    result: ?*IRtwqAsyncResult,
    key: ?*u64,
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqAllocateSerialWorkQueue(
    workQueueIdIn: u32,
    workQueueIdOut: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqScheduleWorkItem(
    result: ?*IRtwqAsyncResult,
    Timeout: i64,
    key: ?*u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqAddPeriodicCallback(
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqRemovePeriodicCallback(
    dwKey: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqCancelWorkItem(
    Key: u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqAllocateWorkQueue(
    WorkQueueType: RTWQ_WORKQUEUE_TYPE,
    workQueueId: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqBeginRegisterWorkQueueWithMMCSS(
    workQueueId: u32,
    usageClass: ?[*:0]align(1) const u16,
    dwTaskId: u32,
    lPriority: i32,
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqBeginUnregisterWorkQueueWithMMCSS(
    workQueueId: u32,
    doneCallback: ?*IRtwqAsyncCallback,
    doneState: ?*IUnknown,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqEndRegisterWorkQueueWithMMCSS(
    result: ?*IRtwqAsyncResult,
    taskId: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqGetWorkQueueMMCSSClass(
    workQueueId: u32,
    usageClass: ?[*:0]u16,
    usageClassLength: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqGetWorkQueueMMCSSTaskId(
    workQueueId: u32,
    taskId: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqGetWorkQueueMMCSSPriority(
    workQueueId: u32,
    priority: ?*i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqRegisterPlatformEvents(
    platformEvents: ?*IRtwqPlatformEvents,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqUnregisterPlatformEvents(
    platformEvents: ?*IRtwqPlatformEvents,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "rtworkq" fn RtwqSetLongRunning(
    workQueueId: u32,
    enable: BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "rtworkq" fn RtwqSetDeadline(
    workQueueId: u32,
    deadlineInHNS: i64,
    pRequest: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "rtworkq" fn RtwqSetDeadline2(
    workQueueId: u32,
    deadlineInHNS: i64,
...
pub extern "rtworkq" fn RtwqCancelDeadline(
    pRequest: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "kernel32" fn CreateWaitableTimerA(
    lpTimerAttributes: ?*SECURITY_ATTRIBUTES,
    bManualReset: BOOL,
    lpTimerName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "advapi32" fn CreateProcessWithLogonW(
    lpUsername: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn CreatePrivateNamespaceA(
    lpPrivateNamespaceAttributes: ?*SECURITY_ATTRIBUTES,
    lpBoundaryDescriptor: ?*anyopaque,
    lpAliasPrefix: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const OpenWaitableTimer = thismodule.OpenWaitableTimerA;
        ...
        pub const CreateWaitableTimerEx = thismodule.CreateWaitableTimerExA;
        pub const CreateSemaphore = thismodule.CreateSemaphoreA;
        pub const CreateWaitableTimer = thismodule.CreateWaitableTimerA;
    ...
    .wide => struct {
        ...
        pub const OpenWaitableTimer = thismodule.OpenWaitableTimerW;
        ...
        pub const CreateWaitableTimerEx = thismodule.CreateWaitableTimerExW;
        pub const CreateSemaphore = thismodule.CreateSemaphoreW;
        pub const CreateWaitableTimer = thismodule.CreateWaitableTimerW;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const OpenWaitableTimer = @compileError("'OpenWaitableTimer' requires that UNICODE be set to true or false in the root module");
        ...
        pub const CreateWaitableTimerEx = @compileError("'CreateWaitableTimerEx' requires that UNICODE be set to true or false in the root module");
        pub const CreateSemaphore = @compileError("'CreateSemaphore' requires that UNICODE be set to true or false in the root module");
        pub const CreateWaitableTimer = @compileError("'CreateWaitableTimer' requires that UNICODE be set to true or false in the root module");
...
const GROUP_AFFINITY = @import("../../../windows/win32/system/system_information.zig").GROUP_AFFINITY;
...
const PROCESSOR_NUMBER = @import("../../../windows/win32/system/kernel.zig").PROCESSOR_NUMBER;
...
const RTL_UMS_SCHEDULER_REASON = @import("../../../windows/win32/system/system_services.zig").RTL_UMS_SCHEDULER_REASON;
const SECURITY_ATTRIBUTES = @import("../../../windows/win32/security.zig").SECURITY_ATTRIBUTES;
const SLIST_ENTRY = @import("../../../windows/win32/system/kernel.zig").SLIST_ENTRY;
const SLIST_HEADER = @import("../../../windows/win32/system/kernel.zig").SLIST_HEADER;
const TOKEN_ACCESS_MASK = @import("../../../windows/win32/security.zig").TOKEN_ACCESS_MASK;
const UNICODE_STRING = @import("../../../windows/win32/foundation.zig").UNICODE_STRING;
...
test {
    ...
    if (@hasDecl(@This(), "RTWQPERIODICCALLBACK")) { _ = RTWQPERIODICCALLBACK; }
