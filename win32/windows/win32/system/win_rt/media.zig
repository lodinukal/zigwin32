...
const IMFDXGIDeviceManager = @import("../../../../windows/win32/media/media_foundation.zig").IMFDXGIDeviceManager;
const IMFSample = @import("../../../../windows/win32/media/media_foundation.zig").IMFSample;
const MFVideoArea = @import("../../../../windows/win32/media/media_foundation.zig").MFVideoArea;
