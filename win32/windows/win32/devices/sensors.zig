...
pub const SENSOR_EVENT_PARAMETER_EVENT_ID = PROPERTYKEY { .fmtid = Guid.initIntString("1681157680, 34600, 19252, 189, 246, 79, 82, 68, 44, 92, 40"), .pid = 2 };
pub const SENSOR_EVENT_PARAMETER_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("1681157680, 34600, 19252, 189, 246, 79, 82, 68, 44, 92, 40"), .pid = 3 };
...
pub const SENSOR_PROPERTY_TYPE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 2 };
pub const SENSOR_PROPERTY_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 3 };
pub const SENSOR_PROPERTY_PERSISTENT_UNIQUE_ID = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 5 };
pub const SENSOR_PROPERTY_MANUFACTURER = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 6 };
pub const SENSOR_PROPERTY_MODEL = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 7 };
pub const SENSOR_PROPERTY_SERIAL_NUMBER = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 8 };
pub const SENSOR_PROPERTY_FRIENDLY_NAME = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 9 };
pub const SENSOR_PROPERTY_DESCRIPTION = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 10 };
pub const SENSOR_PROPERTY_CONNECTION_TYPE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 11 };
pub const SENSOR_PROPERTY_MIN_REPORT_INTERVAL = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 12 };
pub const SENSOR_PROPERTY_CURRENT_REPORT_INTERVAL = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 13 };
pub const SENSOR_PROPERTY_CHANGE_SENSITIVITY = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 14 };
pub const SENSOR_PROPERTY_DEVICE_PATH = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 15 };
pub const SENSOR_PROPERTY_LIGHT_RESPONSE_CURVE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 16 };
pub const SENSOR_PROPERTY_ACCURACY = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 17 };
pub const SENSOR_PROPERTY_RESOLUTION = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 18 };
pub const SENSOR_PROPERTY_LOCATION_DESIRED_ACCURACY = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 19 };
pub const SENSOR_PROPERTY_RANGE_MINIMUM = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 20 };
pub const SENSOR_PROPERTY_RANGE_MAXIMUM = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 21 };
pub const SENSOR_PROPERTY_HID_USAGE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 22 };
pub const SENSOR_PROPERTY_RADIO_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 23 };
pub const SENSOR_PROPERTY_RADIO_STATE_PREVIOUS = PROPERTYKEY { .fmtid = Guid.initIntString("2139325420, 54252, 18780, 168, 207, 184, 187, 232, 92, 41, 32"), .pid = 24 };
...
pub const SENSOR_DATA_TYPE_TIMESTAMP = PROPERTYKEY { .fmtid = Guid.initIntString("3680374002, 53023, 19480, 180, 108, 216, 96, 17, 214, 33, 80"), .pid = 2 };
pub const SENSOR_DATA_TYPE_LOCATION_GUID = Guid.initString("055c74d8-ca6f-47d6-95c6-1ed3637a0ff4");
pub const SENSOR_DATA_TYPE_LATITUDE_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 2 };
pub const SENSOR_DATA_TYPE_LONGITUDE_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 3 };
pub const SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 4 };
pub const SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 5 };
pub const SENSOR_DATA_TYPE_SPEED_KNOTS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 6 };
pub const SENSOR_DATA_TYPE_TRUE_HEADING_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 7 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 8 };
pub const SENSOR_DATA_TYPE_MAGNETIC_VARIATION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 9 };
pub const SENSOR_DATA_TYPE_FIX_QUALITY = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 10 };
pub const SENSOR_DATA_TYPE_FIX_TYPE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 11 };
pub const SENSOR_DATA_TYPE_POSITION_DILUTION_OF_PRECISION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 12 };
pub const SENSOR_DATA_TYPE_HORIZONAL_DILUTION_OF_PRECISION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 13 };
pub const SENSOR_DATA_TYPE_VERTICAL_DILUTION_OF_PRECISION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 14 };
pub const SENSOR_DATA_TYPE_SATELLITES_USED_COUNT = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 15 };
pub const SENSOR_DATA_TYPE_SATELLITES_USED_PRNS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 16 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 17 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_PRNS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 18 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ELEVATION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 19 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_AZIMUTH = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 20 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_STN_RATIO = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 21 };
pub const SENSOR_DATA_TYPE_ERROR_RADIUS_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 22 };
pub const SENSOR_DATA_TYPE_ADDRESS1 = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 23 };
pub const SENSOR_DATA_TYPE_ADDRESS2 = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 24 };
pub const SENSOR_DATA_TYPE_CITY = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 25 };
pub const SENSOR_DATA_TYPE_STATE_PROVINCE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 26 };
pub const SENSOR_DATA_TYPE_POSTALCODE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 27 };
pub const SENSOR_DATA_TYPE_COUNTRY_REGION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 28 };
pub const SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_ERROR_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 29 };
pub const SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_ERROR_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 30 };
pub const SENSOR_DATA_TYPE_GPS_SELECTION_MODE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 31 };
pub const SENSOR_DATA_TYPE_GPS_OPERATION_MODE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 32 };
pub const SENSOR_DATA_TYPE_GPS_STATUS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 33 };
pub const SENSOR_DATA_TYPE_GEOIDAL_SEPARATION = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 34 };
pub const SENSOR_DATA_TYPE_DGPS_DATA_AGE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 35 };
pub const SENSOR_DATA_TYPE_ALTITUDE_ANTENNA_SEALEVEL_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 36 };
pub const SENSOR_DATA_TYPE_DIFFERENTIAL_REFERENCE_STATION_ID = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 37 };
pub const SENSOR_DATA_TYPE_NMEA_SENTENCE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 38 };
pub const SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ID = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 39 };
pub const SENSOR_DATA_TYPE_LOCATION_SOURCE = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 40 };
pub const SENSOR_DATA_TYPE_SATELLITES_USED_PRNS_AND_CONSTELLATIONS = PROPERTYKEY { .fmtid = Guid.initIntString("89945304, 51823, 18390, 149, 198, 30, 211, 99, 122, 15, 244"), .pid = 41 };
pub const SENSOR_DATA_TYPE_ENVIRONMENTAL_GUID = Guid.initString("8b0aa2f1-2d57-42ee-8cc0-4d27622b46c4");
pub const SENSOR_DATA_TYPE_TEMPERATURE_CELSIUS = PROPERTYKEY { .fmtid = Guid.initIntString("2332730097, 11607, 17134, 140, 192, 77, 39, 98, 43, 70, 196"), .pid = 2 };
pub const SENSOR_DATA_TYPE_RELATIVE_HUMIDITY_PERCENT = PROPERTYKEY { .fmtid = Guid.initIntString("2332730097, 11607, 17134, 140, 192, 77, 39, 98, 43, 70, 196"), .pid = 3 };
pub const SENSOR_DATA_TYPE_ATMOSPHERIC_PRESSURE_BAR = PROPERTYKEY { .fmtid = Guid.initIntString("2332730097, 11607, 17134, 140, 192, 77, 39, 98, 43, 70, 196"), .pid = 4 };
pub const SENSOR_DATA_TYPE_WIND_DIRECTION_DEGREES_ANTICLOCKWISE = PROPERTYKEY { .fmtid = Guid.initIntString("2332730097, 11607, 17134, 140, 192, 77, 39, 98, 43, 70, 196"), .pid = 5 };
pub const SENSOR_DATA_TYPE_WIND_SPEED_METERS_PER_SECOND = PROPERTYKEY { .fmtid = Guid.initIntString("2332730097, 11607, 17134, 140, 192, 77, 39, 98, 43, 70, 196"), .pid = 6 };
pub const SENSOR_DATA_TYPE_MOTION_GUID = Guid.initString("3f8a69a2-07c5-4e48-a965-cd797aab56d5");
pub const SENSOR_DATA_TYPE_ACCELERATION_X_G = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 2 };
pub const SENSOR_DATA_TYPE_ACCELERATION_Y_G = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 3 };
pub const SENSOR_DATA_TYPE_ACCELERATION_Z_G = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 4 };
pub const SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_X_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 5 };
pub const SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Y_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 6 };
pub const SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Z_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 7 };
pub const SENSOR_DATA_TYPE_SPEED_METERS_PER_SECOND = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 8 };
pub const SENSOR_DATA_TYPE_MOTION_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 9 };
pub const SENSOR_DATA_TYPE_ANGULAR_VELOCITY_X_DEGREES_PER_SECOND = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 10 };
pub const SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 11 };
pub const SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND = PROPERTYKEY { .fmtid = Guid.initIntString("1066035618, 1989, 20040, 169, 101, 205, 121, 122, 171, 86, 213"), .pid = 12 };
pub const SENSOR_DATA_TYPE_ORIENTATION_GUID = Guid.initString("1637d8a2-4248-4275-865d-558de84aedfd");
pub const SENSOR_DATA_TYPE_TILT_X_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 2 };
pub const SENSOR_DATA_TYPE_TILT_Y_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 3 };
pub const SENSOR_DATA_TYPE_TILT_Z_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 4 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_X_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 5 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_Y_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 6 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_Z_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 7 };
pub const SENSOR_DATA_TYPE_DISTANCE_X_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 8 };
pub const SENSOR_DATA_TYPE_DISTANCE_Y_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 9 };
pub const SENSOR_DATA_TYPE_DISTANCE_Z_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 10 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 11 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 12 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 13 };
pub const SENSOR_DATA_TYPE_MAGNETIC_HEADING_TRUE_NORTH_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 14 };
pub const SENSOR_DATA_TYPE_QUADRANT_ANGLE_DEGREES = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 15 };
pub const SENSOR_DATA_TYPE_ROTATION_MATRIX = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 16 };
pub const SENSOR_DATA_TYPE_QUATERNION = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 17 };
pub const SENSOR_DATA_TYPE_SIMPLE_DEVICE_ORIENTATION = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 18 };
pub const SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 19 };
pub const SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 20 };
pub const SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 21 };
pub const SENSOR_DATA_TYPE_MAGNETOMETER_ACCURACY = PROPERTYKEY { .fmtid = Guid.initIntString("372758690, 16968, 17013, 134, 93, 85, 141, 232, 74, 237, 253"), .pid = 22 };
pub const SENSOR_DATA_TYPE_GUID_MECHANICAL_GUID = Guid.initString("38564a7c-f2f2-49bb-9b2b-ba60f66a58df");
pub const SENSOR_DATA_TYPE_BOOLEAN_SWITCH_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 2 };
pub const SENSOR_DATA_TYPE_MULTIVALUE_SWITCH_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 3 };
pub const SENSOR_DATA_TYPE_FORCE_NEWTONS = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 4 };
pub const SENSOR_DATA_TYPE_ABSOLUTE_PRESSURE_PASCAL = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 5 };
pub const SENSOR_DATA_TYPE_GAUGE_PRESSURE_PASCAL = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 6 };
pub const SENSOR_DATA_TYPE_STRAIN = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 7 };
pub const SENSOR_DATA_TYPE_WEIGHT_KILOGRAMS = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 8 };
pub const SENSOR_DATA_TYPE_BOOLEAN_SWITCH_ARRAY_STATES = PROPERTYKEY { .fmtid = Guid.initIntString("945179260, 62194, 18875, 155, 43, 186, 96, 246, 106, 88, 223"), .pid = 10 };
pub const SENSOR_DATA_TYPE_BIOMETRIC_GUID = Guid.initString("2299288a-6d9e-4b0b-b7ec-3528f89e40af");
pub const SENSOR_DATA_TYPE_HUMAN_PRESENCE = PROPERTYKEY { .fmtid = Guid.initIntString("580462730, 28062, 19211, 183, 236, 53, 40, 248, 158, 64, 175"), .pid = 2 };
pub const SENSOR_DATA_TYPE_HUMAN_PROXIMITY_METERS = PROPERTYKEY { .fmtid = Guid.initIntString("580462730, 28062, 19211, 183, 236, 53, 40, 248, 158, 64, 175"), .pid = 3 };
pub const SENSOR_DATA_TYPE_TOUCH_STATE = PROPERTYKEY { .fmtid = Guid.initIntString("580462730, 28062, 19211, 183, 236, 53, 40, 248, 158, 64, 175"), .pid = 4 };
pub const SENSOR_DATA_TYPE_LIGHT_GUID = Guid.initString("e4c77ce2-dcb7-46e9-8439-4fec548833a6");
pub const SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX = PROPERTYKEY { .fmtid = Guid.initIntString("3838278882, 56503, 18153, 132, 57, 79, 236, 84, 136, 51, 166"), .pid = 2 };
pub const SENSOR_DATA_TYPE_LIGHT_TEMPERATURE_KELVIN = PROPERTYKEY { .fmtid = Guid.initIntString("3838278882, 56503, 18153, 132, 57, 79, 236, 84, 136, 51, 166"), .pid = 3 };
pub const SENSOR_DATA_TYPE_LIGHT_CHROMACITY = PROPERTYKEY { .fmtid = Guid.initIntString("3838278882, 56503, 18153, 132, 57, 79, 236, 84, 136, 51, 166"), .pid = 4 };
pub const SENSOR_DATA_TYPE_SCANNER_GUID = Guid.initString("d7a59a3c-3421-44ab-8d3a-9de8ab6c4cae");
pub const SENSOR_DATA_TYPE_RFID_TAG_40_BIT = PROPERTYKEY { .fmtid = Guid.initIntString("3617954364, 13345, 17579, 141, 58, 157, 232, 171, 108, 76, 174"), .pid = 2 };
pub const SENSOR_DATA_TYPE_ELECTRICAL_GUID = Guid.initString("bbb246d1-e242-4780-a2d3-cded84f35842");
pub const SENSOR_DATA_TYPE_VOLTAGE_VOLTS = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 2 };
pub const SENSOR_DATA_TYPE_CURRENT_AMPS = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 3 };
pub const SENSOR_DATA_TYPE_CAPACITANCE_FARAD = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 4 };
pub const SENSOR_DATA_TYPE_RESISTANCE_OHMS = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 5 };
pub const SENSOR_DATA_TYPE_INDUCTANCE_HENRY = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 6 };
pub const SENSOR_DATA_TYPE_ELECTRICAL_POWER_WATTS = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 7 };
pub const SENSOR_DATA_TYPE_ELECTRICAL_PERCENT_OF_RANGE = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 8 };
pub const SENSOR_DATA_TYPE_ELECTRICAL_FREQUENCY_HERTZ = PROPERTYKEY { .fmtid = Guid.initIntString("3149022929, 57922, 18304, 162, 211, 205, 237, 132, 243, 88, 66"), .pid = 9 };
pub const SENSOR_DATA_TYPE_CUSTOM_GUID = Guid.initString("b14c764f-07cf-41e8-9d82-ebe3d0776a6f");
pub const SENSOR_DATA_TYPE_CUSTOM_USAGE = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 5 };
pub const SENSOR_DATA_TYPE_CUSTOM_BOOLEAN_ARRAY = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 6 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE1 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 7 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE2 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 8 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE3 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 9 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE4 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 10 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE5 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 11 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE6 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 12 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE7 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 13 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE8 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 14 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE9 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 15 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE10 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 16 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE11 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 17 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE12 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 18 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE13 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 19 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE14 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 20 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE15 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 21 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE16 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 22 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE17 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 23 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE18 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 24 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE19 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 25 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE20 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 26 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE21 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 27 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE22 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 28 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE23 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 29 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE24 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 30 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE25 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 31 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE26 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 32 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE27 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 33 };
pub const SENSOR_DATA_TYPE_CUSTOM_VALUE28 = PROPERTYKEY { .fmtid = Guid.initIntString("2974578255, 1999, 16872, 157, 130, 235, 227, 208, 119, 106, 111"), .pid = 34 };
pub const SENSOR_PROPERTY_TEST_GUID = Guid.initString("e1e962f4-6e65-45f7-9c36-d487b7b1bd34");
pub const SENSOR_PROPERTY_CLEAR_ASSISTANCE_DATA = PROPERTYKEY { .fmtid = Guid.initIntString("3790168820, 28261, 17911, 156, 54, 212, 135, 183, 177, 189, 52"), .pid = 2 };
pub const SENSOR_PROPERTY_TURN_ON_OFF_NMEA = PROPERTYKEY { .fmtid = Guid.initIntString("3790168820, 28261, 17911, 156, 54, 212, 135, 183, 177, 189, 52"), .pid = 3 };
...
pub const ISensor = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISensor_SupportsDataField(self: *const T, key: ?*const PROPERTYKEY, pIsSupported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISensor_SupportsEvent(self: *const T, eventGuid: ?*const Guid, pIsSupported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const PROXIMITY_SENSOR_CAPABILITIES = enum(i32) {
    Human_Presence_Capable = 1,
    Human_Engagement_Capable = 2,
    Supported_Capabilities = 3,
};
pub const Proximity_Sensor_Human_Presence_Capable = PROXIMITY_SENSOR_CAPABILITIES.Human_Presence_Capable;
pub const Proximity_Sensor_Human_Engagement_Capable = PROXIMITY_SENSOR_CAPABILITIES.Human_Engagement_Capable;
pub const Proximity_Sensor_Supported_Capabilities = PROXIMITY_SENSOR_CAPABILITIES.Supported_Capabilities;
...
const IPortableDeviceKeyCollection = @import("../../../windows/win32/devices/portable_devices.zig").IPortableDeviceKeyCollection;
const IPortableDeviceValues = @import("../../../windows/win32/devices/portable_devices.zig").IPortableDeviceValues;
