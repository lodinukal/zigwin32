...
pub const ICOMAdminCatalog = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICOMAdminCatalog_QueryApplicationFile(self: *const T, bstrApplicationFile: ?BSTR, pbstrApplicationName: ?*?BSTR, pbstrApplicationDescription: ?*?BSTR, pbHasUsers: ?*VARIANT_BOOL, pbIsProxy: ?*VARIANT_BOOL, ppsaVarFileNames: ?*?*SAFEARRAY) callconv(.Inline) HRESULT {
...
pub const ICOMAdminCatalog2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICOMAdminCatalog2_AreApplicationInstancesPaused(self: *const T, pVarApplicationInstanceID: ?*VARIANT, pVarBoolPaused: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICOMAdminCatalog2_get_IsApplicationInstanceDumpSupported(self: *const T, pVarBoolDumpSupported: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICOMAdminCatalog2_CreateServiceForApplication(self: *const T, bstrApplicationIDOrName: ?BSTR, bstrServiceName: ?BSTR, bstrStartType: ?BSTR, bstrErrorControl: ?BSTR, bstrDependencies: ?BSTR, bstrRunAs: ?BSTR, bstrPassword: ?BSTR, bDesktopOk: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICOMAdminCatalog2_get_Is64BitCatalogServer(self: *const T, pbIs64Bit: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ICatalogObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICatalogObject_IsPropertyReadOnly(self: *const T, bstrPropName: ?BSTR, pbRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICatalogObject_get_Valid(self: *const T, pbRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const ICatalogObject.VTable, @ptrCast(self.vtable)).get_Valid(@as(*const ICatalogObject, @ptrCast(self)), pbRetVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICatalogObject_IsPropertyWriteOnly(self: *const T, bstrPropName: ?BSTR, pbRetVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ICatalogCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICatalogCollection_get_AddEnabled(self: *const T, pVarBool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICatalogCollection_get_RemoveEnabled(self: *const T, pVarBool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISecurityCallContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISecurityCallContext_IsCallerInRole(self: *const T, bstrRole: ?BSTR, pfInRole: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISecurityCallContext_IsSecurityEnabled(self: *const T, pfIsEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISecurityCallContext_IsUserInRole(self: *const T, pUser: ?*VARIANT, bstrRole: ?BSTR, pfInRole: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ContextInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ContextInfo_IsInTransaction(self: *const T, pbIsInTx: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ObjectContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ObjectContext_IsInTransaction(self: *const T, pbIsInTx: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const ObjectContext.VTable, @ptrCast(self.vtable)).IsInTransaction(@as(*const ObjectContext, @ptrCast(self)), pbIsInTx);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ObjectContext_IsSecurityEnabled(self: *const T, pbIsEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ObjectContext_IsCallerInRole(self: *const T, bstrRole: ?BSTR, pbInRole: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IComResourceEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComResourceEvents_OnResourceCreate(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjectID: u64, pszType: ?[*:0]align(1) const u16, resId: u64, enlisted: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComResourceEvents_OnResourceAllocate(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjectID: u64, pszType: ?[*:0]align(1) const u16, resId: u64, enlisted: BOOL, NumRated: u32, Rating: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComResourceEvents_OnResourceRecycle(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjectID: u64, pszType: ?[*:0]align(1) const u16, resId: u64) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComResourceEvents_OnResourceDestroy(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjectID: u64, hr: HRESULT, pszType: ?[*:0]align(1) const u16, resId: u64) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComResourceEvents_OnResourceTrack(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjectID: u64, pszType: ?[*:0]align(1) const u16, resId: u64, enlisted: BOOL) callconv(.Inline) HRESULT {
...
pub const IComObjectConstructionEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnObjectConstruct: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pInfo: ?*COMSVCSEVENTINFO,
                guidObject: ?*const Guid,
                sConstructString: ?[*:0]align(1) const u16,
                oid: u64,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IComObjectConstructionEvents,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComObjectConstructionEvents_OnObjectConstruct(self: *const T, pInfo: ?*COMSVCSEVENTINFO, guidObject: ?*const Guid, sConstructString: ?[*:0]align(1) const u16, oid: u64) callconv(.Inline) HRESULT {
...
pub const IComIdentityEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnIISRequestInfo: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pInfo: ?*COMSVCSEVENTINFO,
                ObjId: u64,
                pszClientIP: ?[*:0]align(1) const u16,
                pszServerIP: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComIdentityEvents_OnIISRequestInfo(self: *const T, pInfo: ?*COMSVCSEVENTINFO, ObjId: u64, pszClientIP: ?[*:0]align(1) const u16, pszServerIP: ?[*:0]align(1) const u16, pszURL: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IComExceptionEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnExceptionUser: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                code: u32,
                address: u64,
                pszStackTrace: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IComExceptionEvents,
                pInfo: ?*COMSVCSEVENTINFO,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComExceptionEvents_OnExceptionUser(self: *const T, pInfo: ?*COMSVCSEVENTINFO, code: u32, address: u64, pszStackTrace: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IComObjectConstruction2Events = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComObjectConstruction2Events_OnObjectConstruct2(self: *const T, pInfo: ?*COMSVCSEVENTINFO, guidObject: ?*const Guid, sConstructString: ?[*:0]align(1) const u16, oid: u64, guidPartition: ?*const Guid) callconv(.Inline) HRESULT {
...
pub const IMtsEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMtsEvents_get_FireEvents(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IDispenserManager = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterDispenser: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                szDispenserName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDispenserManager_RegisterDispenser(self: *const T, __MIDL__IDispenserManager0000: ?*IDispenserDriver, szDispenserName: ?[*:0]align(1) const u16, __MIDL__IDispenserManager0001: ?*?*IHolder) callconv(.Inline) HRESULT {
...
pub const ObjectControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ObjectControl_CanBePooled(self: *const T, pbPoolable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISharedPropertyGroup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISharedPropertyGroup_CreatePropertyByPosition(self: *const T, Index: i32, fExists: ?*VARIANT_BOOL, ppProp: ?*?*ISharedProperty) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISharedPropertyGroup_CreateProperty(self: *const T, Name: ?BSTR, fExists: ?*VARIANT_BOOL, ppProp: ?*?*ISharedProperty) callconv(.Inline) HRESULT {
...
pub const ISharedPropertyGroupManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISharedPropertyGroupManager_CreatePropertyGroup(self: *const T, Name: ?BSTR, dwIsoMode: ?*i32, dwRelMode: ?*i32, fExists: ?*VARIANT_BOOL, ppGroup: ?*?*ISharedPropertyGroup) callconv(.Inline) HRESULT {
...
pub const IContextState = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContextState_SetDeactivateOnReturn(self: *const T, bDeactivate: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContextState_GetDeactivateOnReturn(self: *const T, pbDeactivate: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ICrmLogControl = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterCompensator: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ICrmLogControl,
                lpcwstrProgIdCompensator: ?[*:0]align(1) const u16,
                lpcwstrDescription: ?[*:0]align(1) const u16,
                lCrmRegFlags: i32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ICrmLogControl,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmLogControl_RegisterCompensator(self: *const T, lpcwstrProgIdCompensator: ?[*:0]align(1) const u16, lpcwstrDescription: ?[*:0]align(1) const u16, lCrmRegFlags: i32) callconv(.Inline) HRESULT {
...
pub const ICrmCompensatorVariants = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_PrepareRecordVariants(self: *const T, pLogRecord: ?*VARIANT, pbForget: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_EndPrepareVariants(self: *const T, pbOkToPrepare: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_BeginCommitVariants(self: *const T, bRecovery: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_CommitRecordVariants(self: *const T, pLogRecord: ?*VARIANT, pbForget: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_BeginAbortVariants(self: *const T, bRecovery: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmCompensatorVariants_AbortRecordVariants(self: *const T, pLogRecord: ?*VARIANT, pbForget: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ICrmMonitorLogRecords = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICrmMonitorLogRecords_get_StructuredRecords(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IServiceSxsConfig = extern struct {
    pub const VTable = extern struct {
        ...
        SxsDirectory: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IServiceSxsConfig,
                szSxsDirectory: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IServiceSxsConfig,
                szSxsDirectory: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IServiceSxsConfig_SxsName(self: *const T, szSxsName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IServiceSxsConfig.VTable, @ptrCast(self.vtable)).SxsName(@as(*const IServiceSxsConfig, @ptrCast(self)), szSxsName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IServiceSxsConfig_SxsDirectory(self: *const T, szSxsDirectory: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ICheckSxsConfig = extern struct {
    pub const VTable = extern struct {
        ...
        IsSameSxsConfig: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszSxsName: ?[*:0]align(1) const u16,
                wszSxsDirectory: ?[*:0]align(1) const u16,
                wszSxsAppName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ICheckSxsConfig,
                wszSxsName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICheckSxsConfig_IsSameSxsConfig(self: *const T, wszSxsName: ?[*:0]align(1) const u16, wszSxsDirectory: ?[*:0]align(1) const u16, wszSxsAppName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IServiceTransactionConfigBase = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IServiceTransactionConfigBase_BringYourOwnTransaction(self: *const T, szTipURL: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IServiceTransactionConfigBase_NewTransactionDescription(self: *const T, szTxDesc: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IServiceTrackerConfig = extern struct {
    pub const VTable = extern struct {
        ...
        TrackerConfig: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                szTrackerAppName: ?[*:0]align(1) const u16,
                szTrackerCtxName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IServiceTrackerConfig,
                trackerConfig: CSC_TrackerConfig,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IServiceTrackerConfig_TrackerConfig(self: *const T, trackerConfig: CSC_TrackerConfig, szTrackerAppName: ?[*:0]align(1) const u16, szTrackerCtxName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const APTTYPE = @import("../../../windows/win32/system/com.zig").APTTYPE;
...
const ITransactionVoterBallotAsync2 = @import("../../../windows/win32/system/distributed_transaction_coordinator.zig").ITransactionVoterBallotAsync2;
const ITransactionVoterNotifyAsync2 = @import("../../../windows/win32/system/distributed_transaction_coordinator.zig").ITransactionVoterNotifyAsync2;
