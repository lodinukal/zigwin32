...
pub const WINBIO_DATA_FLAG_PRIVACY = @as(u16, 2);
pub const WINBIO_DATA_FLAG_INTEGRITY = @as(u16, 1);
pub const WINBIO_DATA_FLAG_SIGNED = @as(u16, 4);
pub const WINBIO_DATA_FLAG_RAW = @as(u16, 32);
pub const WINBIO_DATA_FLAG_INTERMEDIATE = @as(u16, 64);
pub const WINBIO_DATA_FLAG_PROCESSED = @as(u16, 128);
pub const WINBIO_DATA_FLAG_OPTION_MASK_PRESENT = @as(u16, 8);
pub const WINBIO_ANSI_381_PIXELS_PER_INCH = @as(u16, 1);
pub const WINBIO_ANSI_381_PIXELS_PER_CM = @as(u16, 2);
pub const WINBIO_ANSI_381_IMG_UNCOMPRESSED = @as(u16, 0);
pub const WINBIO_ANSI_381_IMG_BIT_PACKED = @as(u16, 1);
pub const WINBIO_ANSI_381_IMG_COMPRESSED_WSQ = @as(u16, 2);
pub const WINBIO_ANSI_381_IMG_COMPRESSED_JPEG = @as(u16, 3);
pub const WINBIO_ANSI_381_IMG_COMPRESSED_JPEG2000 = @as(u16, 4);
pub const WINBIO_ANSI_381_IMG_COMPRESSED_PNG = @as(u16, 5);
pub const WINBIO_ANSI_381_IMP_TYPE_LIVE_SCAN_PLAIN = @as(u16, 0);
pub const WINBIO_ANSI_381_IMP_TYPE_LIVE_SCAN_ROLLED = @as(u16, 1);
pub const WINBIO_ANSI_381_IMP_TYPE_NONLIVE_SCAN_PLAIN = @as(u16, 2);
pub const WINBIO_ANSI_381_IMP_TYPE_NONLIVE_SCAN_ROLLED = @as(u16, 3);
pub const WINBIO_ANSI_381_IMP_TYPE_LATENT = @as(u16, 7);
pub const WINBIO_ANSI_381_IMP_TYPE_SWIPE = @as(u16, 8);
pub const WINBIO_ANSI_381_IMP_TYPE_LIVE_SCAN_CONTACTLESS = @as(u16, 9);
