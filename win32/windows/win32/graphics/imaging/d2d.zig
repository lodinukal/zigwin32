...
const ID2D1Device = @import("../../../../windows/win32/graphics/direct2d.zig").ID2D1Device;
const ID2D1Image = @import("../../../../windows/win32/graphics/direct2d.zig").ID2D1Image;
const IUnknown = @import("../../../../windows/win32/system/com.zig").IUnknown;
const IWICBitmapEncoder = @import("../../../../windows/win32/graphics/imaging.zig").IWICBitmapEncoder;
const IWICBitmapFrameEncode = @import("../../../../windows/win32/graphics/imaging.zig").IWICBitmapFrameEncode;
const IWICImagingFactory = @import("../../../../windows/win32/graphics/imaging.zig").IWICImagingFactory;
const WICImageParameters = @import("../../../../windows/win32/graphics/imaging.zig").WICImageParameters;
