...
// Section: Constants (6)
//--------------------------------------------------------------------------------
pub const DML_TARGET_VERSION = @as(u32, 20480);
...
pub const DML_TENSOR_FLAGS = enum(i32) {
    NONE = 0,
    OWNED_BY_DML = 1,
    _,
...
pub const DML_FEATURE_LEVEL_4_1 = DML_FEATURE_LEVEL.@"4_1";
pub const DML_FEATURE_LEVEL_5_0 = DML_FEATURE_LEVEL.@"5_0";
...
pub const DML_EXECUTION_FLAGS = enum(i32) {
    NONE = 0,
...
pub const DML_CREATE_DEVICE_FLAGS = enum(i32) {
    NONE = 0,
    DEBUG = 1,
    _,
    pub fn initFlags(o: struct {
...
pub const IDMLObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDMLObject_SetName(self: *const T, name: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
const D3D12_CPU_DESCRIPTOR_HANDLE = @import("../../../../windows/win32/graphics/direct3d12.zig").D3D12_CPU_DESCRIPTOR_HANDLE;
const D3D12_GPU_DESCRIPTOR_HANDLE = @import("../../../../windows/win32/graphics/direct3d12.zig").D3D12_GPU_DESCRIPTOR_HANDLE;
const HRESULT = @import("../../../../windows/win32/foundation.zig").HRESULT;
const ID3D12CommandList = @import("../../../../windows/win32/graphics/direct3d12.zig").ID3D12CommandList;
