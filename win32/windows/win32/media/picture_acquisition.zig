...
//--------------------------------------------------------------------------------
pub const PKEY_PhotoAcquire_RelativePathname = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 2 };
pub const PKEY_PhotoAcquire_FinalFilename = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 3 };
pub const PKEY_PhotoAcquire_GroupTag = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 4 };
pub const PKEY_PhotoAcquire_TransferResult = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 5 };
pub const PKEY_PhotoAcquire_OriginalFilename = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 6 };
pub const PKEY_PhotoAcquire_CameraSequenceNumber = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 7 };
pub const PKEY_PhotoAcquire_IntermediateFile = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 8 };
pub const PKEY_PhotoAcquire_SkipImport = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 9 };
pub const PKEY_PhotoAcquire_DuplicateDetectionID = PROPERTYKEY { .fmtid = Guid.initIntString("15872887, 31430, 19322, 132, 67, 52, 94, 115, 31, 165, 122"), .pid = 10 };
...
pub const IPhotoAcquireProgressCB = extern struct {
    pub const VTable = extern struct {
        ...
        ErrorAdvise: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoAcquireProgressCB,
                hr: HRESULT,
                pszErrorMessage: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireProgressCB_DirectoryCreated(self: *const T, pszDirectory: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireProgressCB_ErrorAdvise(self: *const T, hr: HRESULT, pszErrorMessage: ?[*:0]align(1) const u16, nMessageType: ERROR_ADVISE_MESSAGE_TYPE, pnErrorAdviseResult: ?*ERROR_ADVISE_RESULT) callconv(.Inline) HRESULT {
...
pub const IPhotoProgressDialog = extern struct {
    pub const VTable = extern struct {
        ...
        SetCheckboxText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoProgressDialog,
                nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID,
                pszCheckboxText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoProgressDialog,
                nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID,
        ...
        SetCheckboxTooltip: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoProgressDialog,
                nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID,
                pszCheckboxTooltipText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoProgressDialog,
                nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID,
        ...
        SetProgressText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoProgressDialog,
                pszProgressText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoProgressDialog,
                pszProgressText: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetTitle(self: *const T, pszTitle: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetCheckboxText(self: *const T, nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID, pszCheckboxText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetCheckboxTooltip(self: *const T, nCheckboxId: PROGRESS_DIALOG_CHECKBOX_ID, pszCheckboxTooltipText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetCaption(self: *const T, pszTitle: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetProgressText(self: *const T, pszProgressText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoProgressDialog_SetActionLinkText(self: *const T, pszCaption: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPhotoAcquire = extern struct {
    pub const VTable = extern struct {
        ...
        Acquire: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                fShowProgress: BOOL,
                hWndParent: ?HWND,
                pszApplicationName: ?[*:0]align(1) const u16,
                pPhotoAcquireProgressCB: ?*IPhotoAcquireProgressCB,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoAcquire,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquire_CreatePhotoSource(self: *const T, pszDevice: ?[*:0]align(1) const u16, ppPhotoAcquireSource: ?*?*IPhotoAcquireSource) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquire_Acquire(self: *const T, pPhotoAcquireSource: ?*IPhotoAcquireSource, fShowProgress: BOOL, hWndParent: ?HWND, pszApplicationName: ?[*:0]align(1) const u16, pPhotoAcquireProgressCB: ?*IPhotoAcquireProgressCB) callconv(.Inline) HRESULT {
...
pub const IPhotoAcquireSettings = extern struct {
    pub const VTable = extern struct {
        ...
        InitializeFromRegistry: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszRegistryKey: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoAcquireSettings,
                pszRegistryKey: ?[*:0]align(1) const u16,
        ...
        SetGroupTag: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoAcquireSettings,
                pszGroupTag: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoAcquireSettings,
                pszGroupTag: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireSettings_InitializeFromRegistry(self: *const T, pszRegistryKey: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireSettings_SetOutputFilenameTemplate(self: *const T, pszTemplate: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireSettings_SetGroupTag(self: *const T, pszGroupTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPhotoAcquireOptionsDialog = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszRegistryRoot: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoAcquireOptionsDialog,
                pszRegistryRoot: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireOptionsDialog_Initialize(self: *const T, pszRegistryRoot: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPhotoAcquireDeviceSelectionDialog = extern struct {
    pub const VTable = extern struct {
        ...
        SetSubmitButtonText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPhotoAcquireDeviceSelectionDialog,
                pszSubmitButtonText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPhotoAcquireDeviceSelectionDialog,
                pszSubmitButtonText: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireDeviceSelectionDialog_SetTitle(self: *const T, pszTitle: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquireDeviceSelectionDialog_SetSubmitButtonText(self: *const T, pszSubmitButtonText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPhotoAcquirePlugin = extern struct {
    pub const VTable = extern struct {
        ...
        ProcessItem: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszFinalFilename: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhotoAcquirePlugin_ProcessItem(self: *const T, dwAcquireStage: u32, pPhotoAcquireItem: ?*IPhotoAcquireItem, pOriginalItemStream: ?*IStream, pszFinalFilename: ?[*:0]align(1) const u16, pPropertyStore: ?*IPropertyStore) callconv(.Inline) HRESULT {
