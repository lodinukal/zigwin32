...
pub const HcsEventGroupVmLifecycle = HCS_EVENT_TYPE.GroupVmLifecycle;
pub const HcsEventGroupOperationInfo = HCS_EVENT_TYPE.GroupOperationInfo;

pub const HCS_EVENT = extern struct {
    Type: HCS_EVENT_TYPE,
    EventData: ?[*:0]align(1) const u16,
    Operation: HCS_OPERATION,
};

pub const HCS_EVENT_OPTIONS = enum(i32) {
    None = 0,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(HCS_EVENT_OPTIONS, @enumFromInt(
            ...
            | (if (o.EnableVmLifecycle == 1) @intFromEnum(HCS_EVENT_OPTIONS.EnableVmLifecycle) else 0)
        ));
    }
};
...
pub const HcsEventOptionEnableVmLifecycle = HCS_EVENT_OPTIONS.EnableVmLifecycle;

pub const HCS_OPERATION_OPTIONS = enum(i32) {
    None = 0,
    ProgressUpdate = 1,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(HCS_OPERATION_OPTIONS, @enumFromInt(
              (if (o.None == 1) @intFromEnum(HCS_OPERATION_OPTIONS.None) else 0)
            | (if (o.ProgressUpdate == 1) @intFromEnum(HCS_OPERATION_OPTIONS.ProgressUpdate) else 0)
        ));
    }
};
pub const HcsOperationOptionNone = HCS_OPERATION_OPTIONS.None;
pub const HcsOperationOptionProgressUpdate = HCS_OPERATION_OPTIONS.ProgressUpdate;
...
pub const HCS_RESOURCE_TYPE = enum(i32) {
    None = 0,
    File = 1,
    Job = 2,
};
pub const HcsResourceTypeNone = HCS_RESOURCE_TYPE.None;
pub const HcsResourceTypeFile = HCS_RESOURCE_TYPE.File;
pub const HcsResourceTypeJob = HCS_RESOURCE_TYPE.Job;
...
pub const HcsNotificationOperationProgressUpdate = HCS_NOTIFICATIONS.OperationProgressUpdate;
...
pub const HCS_NOTIFICATION_CALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        notificationData: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) void,
    else => *const fn(
        notificationType: u32,
        context: ?*anyopaque,
...
pub extern "computecore" fn HcsEnumerateComputeSystemsInNamespace(
    idNamespace: ?[*:0]align(1) const u16,
    query: ?[*:0]align(1) const u16,
    operation: HCS_OPERATION,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computecore" fn HcsCreateOperationWithNotifications(
...
pub extern "computecore" fn HcsAddResourceToOperation(
    operation: HCS_OPERATION,
...
pub extern "computecore" fn HcsGetProcessorCompatibilityFromSavedState(
    RuntimeFileName: ?[*:0]align(1) const u16,
    ProcessorFeaturesString: ?*const ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computecore" fn HcsCreateComputeSystem(
    ...
    configuration: ?[*:0]align(1) const u16,
    operation: HCS_OPERATION,
...
pub extern "computecore" fn HcsGetComputeSystemProperties(
    computeSystem: HCS_SYSTEM,
    operation: HCS_OPERATION,
    propertyQuery: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computecore" fn HcsCreateProcess(
    computeSystem: HCS_SYSTEM,
    processParameters: ?[*:0]align(1) const u16,
    operation: HCS_OPERATION,
    securityDescriptor: ?*const SECURITY_DESCRIPTOR,
    process: ?*HCS_PROCESS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computecore" fn HcsCreateEmptyGuestStateFile(
    guestStateFilePath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "computecore" fn HcsCreateEmptyRuntimeStateFile(
    runtimeStateFilePath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "computecore" fn HcsGrantVmAccess(
    vmId: ?[*:0]align(1) const u16,
...
pub extern "computestorage" fn HcsImportLayer(
    layerPath: ?[*:0]align(1) const u16,
    sourceFolderPath: ?[*:0]align(1) const u16,
    layerData: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "computestorage" fn HcsExportLayer(
    layerPath: ?[*:0]align(1) const u16,
    exportFolderPath: ?[*:0]align(1) const u16,
    layerData: ?[*:0]align(1) const u16,
    options: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "computestorage" fn HcsExportLegacyWritableLayer(
    writableLayerMountPath: ?[*:0]align(1) const u16,
    writableLayerFolderPath: ?[*:0]align(1) const u16,
    exportFolderPath: ?[*:0]align(1) const u16,
    layerData: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computestorage" fn HcsInitializeWritableLayer(
    writableLayerPath: ?[*:0]align(1) const u16,
    layerData: ?[*:0]align(1) const u16,
    options: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "computestorage" fn HcsSetupBaseOSVolume(
    layerPath: ?[*:0]align(1) const u16,
    volumePath: ?[*:0]align(1) const u16,
    options: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const SECURITY_DESCRIPTOR = @import("../../../windows/win32/security.zig").SECURITY_DESCRIPTOR;
