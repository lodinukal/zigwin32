...
pub const LDAPAPIInfoW = extern struct {
    ...
    ldapai_vendor_name: ?[*]align(1) u16,
    ldapai_vendor_version: i32,
};
...
pub const LDAPSortKeyW = extern struct {
    sk_attrtype: ?[*]align(1) u16,
    sk_matchruleoid: ?[*]align(1) u16,
    sk_reverseorder: BOOLEAN,
};

pub const LDAPSortKeyA = extern struct {
    sk_attrtype: ?[*]align(1) u8,
    sk_matchruleoid: ?[*]align(1) u8,
    sk_reverseorder: BOOLEAN,
};
...
pub extern "wldap32" fn ldap_sasl_bindW(
    ExternalHandle: ?*LDAP,
    DistName: ?[*:0]align(1) const u16,
    AuthMechanism: ?[*:0]align(1) const u16,
    cred: ?*const LDAP_BERVAL,
...
pub extern "wldap32" fn ldap_simple_bind(
    ld: ?*LDAP,
    dn: ?[*:0]align(1) const u8,
    passwd: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_searchW(
    ld: ?*LDAP,
    base: ?[*:0]align(1) const u16,
    scope: u32,
    filter: ?[*:0]align(1) const u16,
    attrs: ?*?*u16,
    attrsonly: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_searchA(
    ld: ?*LDAP,
    base: ?[*:0]align(1) const u8,
    scope: u32,
    filter: ?[*:0]align(1) const u8,
    attrs: ?*?*i8,
    attrsonly: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_modrdn2W(
    ExternalHandle: ?*LDAP,
    DistinguishedName: ?[*:0]align(1) const u16,
    NewDistinguishedName: ?[*:0]align(1) const u16,
    DeleteOldRdn: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_modrdn2A(
    ExternalHandle: ?*LDAP,
    DistinguishedName: ?[*:0]align(1) const u8,
    NewDistinguishedName: ?[*:0]align(1) const u8,
    DeleteOldRdn: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_rename_extW(
    ld: ?*LDAP,
    dn: ?[*:0]align(1) const u16,
    NewRDN: ?[*:0]align(1) const u16,
    NewParent: ?[*:0]align(1) const u16,
    DeleteOldRdn: i32,
    ServerControls: ?*?*LDAPControlW,
    ClientControls: ?*?*LDAPControlW,
    MessageNumber: ?*u32,
...
pub extern "wldap32" fn ldap_rename_extA(
    ld: ?*LDAP,
    dn: ?[*:0]align(1) const u8,
    NewRDN: ?[*:0]align(1) const u8,
    NewParent: ?[*:0]align(1) const u8,
    DeleteOldRdn: i32,
    ServerControls: ?*?*LDAPControlA,
    ClientControls: ?*?*LDAPControlA,
    MessageNumber: ?*u32,
...
pub extern "wldap32" fn ldap_ufn2dnW(
    ufn: ?[*:0]align(1) const u16,
    pDn: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wldap32" fn ldap_ufn2dnA(
    ufn: ?[*:0]align(1) const u8,
    pDn: ?*?PSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_escape_filter_elementW(
    ...
    sourceFilterElement: ?[*]align(1) u8,
    sourceLength: u32,
    // TODO: what to do with BytesParamIndex 3?
    destFilterElement: ?[*]align(1) u16,
    destLength: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_search_init_pageW(
    ...
    DistinguishedName: ?[*:0]align(1) const u16,
    ScopeOfSearch: u32,
    SearchFilter: ?[*:0]align(1) const u16,
    AttributeList: ?*?*u16,
    AttributesOnly: u32,
    ServerControls: ?*?*LDAPControlW,
    ClientControls: ?*?*LDAPControlW,
    ...
    TotalSizeLimit: u32,
    SortKeys: ?*?*LDAPSortKeyW,
) callconv(@import("std").os.windows.WINAPI) PLDAPSearch;
...
pub extern "wldap32" fn ldap_search_init_pageA(
    ...
    DistinguishedName: ?[*:0]align(1) const u8,
    ScopeOfSearch: u32,
    SearchFilter: ?[*:0]align(1) const u8,
    AttributeList: ?*?*i8,
    AttributesOnly: u32,
    ServerControls: ?*?*LDAPControlA,
    ClientControls: ?*?*LDAPControlA,
