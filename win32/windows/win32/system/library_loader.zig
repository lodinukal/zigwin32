...
pub const PGET_MODULE_HANDLE_EXA = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        dwFlags: u32,
        lpModuleName: ?[*:0]align(1) const u8,
        phModule: ?*HMODULE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
        dwFlags: u32,
...
pub extern "kernel32" fn LoadLibraryExW(
    lpLibFileName: ?[*:0]align(1) const u16,
    hFile: ?HANDLE,
    dwFlags: LOAD_LIBRARY_FLAGS,
) callconv(@import("std").os.windows.WINAPI) HMODULE;
...
pub extern "kernel32" fn AddDllDirectory(
    NewDirectory: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "kernel32" fn LoadPackagedLibrary(
    lpwLibFileName: ?[*:0]align(1) const u16,
    Reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HMODULE;
