...
//--------------------------------------------------------------------------------
// Section: Constants (614)
//--------------------------------------------------------------------------------
pub const WLDP_DLL = "WLDP.DLL";
pub const WLDP_GETLOCKDOWNPOLICY_FN = "WldpGetLockdownPolicy";
pub const WLDP_ISCLASSINAPPROVEDLIST_FN = "WldpIsClassInApprovedList";
pub const WLDP_SETDYNAMICCODETRUST_FN = "WldpSetDynamicCodeTrust";
pub const WLDP_ISDYNAMICCODEPOLICYENABLED_FN = "WldpIsDynamicCodePolicyEnabled";
pub const WLDP_QUERYDANAMICCODETRUST_FN = "WldpQueryDynamicCodeTrust";
pub const WLDP_QUERYDYNAMICCODETRUST_FN = "WldpQueryDynamicCodeTrust";
pub const WLDP_QUERYWINDOWSLOCKDOWNMODE_FN = "WldpQueryWindowsLockdownMode";
pub const WLDP_SETWINDOWSLOCKDOWNRESTRICTION_FN = "WldpSetWindowsLockdownRestriction";
pub const WLDP_QUERYDEVICESECURITYINFORMATION_FN = "WldpQueryDeviceSecurityInformation";
pub const WLDP_QUERYWINDOWSLOCKDOWNRESTRICTION_FN = "WldpQueryWindowsLockdownRestriction";
pub const WLDP_ISAPPAPPROVEDBYPOLICY_FN = "WldpIsAppApprovedByPolicy";
pub const WLDP_QUERYPOLICYSETTINGENABLED_FN = "WldpQueryPolicySettingEnabled";
pub const WLDP_QUERYPOLICYSETTINGENABLED2_FN = "WldpQueryPolicySettingEnabled2";
pub const WLDP_ISWCOSPRODUCTIONCONFIGURATION_FN = "WldpIsWcosProductionConfiguration";
pub const WLDP_RESETWCOSPRODUCTIONCONFIGURATION_FN = "WldpResetWcosProductionConfiguration";
pub const WLDP_ISPRODUCTIONCONFIGURATION_FN = "WldpIsProductionConfiguration";
pub const WLDP_RESETPRODUCTIONCONFIGURATION_FN = "WldpResetProductionConfiguration";
pub const WLDP_CANEXECUTEBUFFER_FN = "WldpCanExecuteBuffer";
pub const WLDP_CANEXECUTEFILE_FN = "WldpCanExecuteFile";
...
pub const COPY_FILE_ENABLE_SPARSE_COPY = @as(u32, 536870912);
pub const FAIL_FAST_GENERATE_EXCEPTION_ADDRESS = @as(u32, 1);
pub const FAIL_FAST_NO_HARD_ERROR_DLG = @as(u32, 2);
pub const SP_SERIALCOMM = @as(u32, 1);
pub const PST_UNSPECIFIED = @as(u32, 0);
pub const PST_RS232 = @as(u32, 1);
pub const PST_PARALLELPORT = @as(u32, 2);
pub const PST_RS422 = @as(u32, 3);
pub const PST_RS423 = @as(u32, 4);
pub const PST_RS449 = @as(u32, 5);
pub const PST_MODEM = @as(u32, 6);
pub const PST_FAX = @as(u32, 33);
pub const PST_SCANNER = @as(u32, 34);
pub const PST_NETWORK_BRIDGE = @as(u32, 256);
pub const PST_LAT = @as(u32, 257);
pub const PST_TCPIP_TELNET = @as(u32, 258);
pub const PST_X25 = @as(u32, 259);
pub const PCF_DTRDSR = @as(u32, 1);
pub const PCF_RTSCTS = @as(u32, 2);
pub const PCF_RLSD = @as(u32, 4);
pub const PCF_PARITY_CHECK = @as(u32, 8);
pub const PCF_XONXOFF = @as(u32, 16);
pub const PCF_SETXCHAR = @as(u32, 32);
pub const PCF_TOTALTIMEOUTS = @as(u32, 64);
pub const PCF_INTTIMEOUTS = @as(u32, 128);
pub const PCF_SPECIALCHARS = @as(u32, 256);
pub const PCF_16BITMODE = @as(u32, 512);
pub const SP_PARITY = @as(u32, 1);
pub const SP_BAUD = @as(u32, 2);
pub const SP_DATABITS = @as(u32, 4);
pub const SP_STOPBITS = @as(u32, 8);
pub const SP_HANDSHAKING = @as(u32, 16);
pub const SP_PARITY_CHECK = @as(u32, 32);
pub const SP_RLSD = @as(u32, 64);
pub const BAUD_075 = @as(u32, 1);
pub const BAUD_110 = @as(u32, 2);
pub const BAUD_134_5 = @as(u32, 4);
pub const BAUD_150 = @as(u32, 8);
pub const BAUD_300 = @as(u32, 16);
pub const BAUD_600 = @as(u32, 32);
pub const BAUD_1200 = @as(u32, 64);
pub const BAUD_1800 = @as(u32, 128);
pub const BAUD_2400 = @as(u32, 256);
pub const BAUD_4800 = @as(u32, 512);
pub const BAUD_7200 = @as(u32, 1024);
pub const BAUD_9600 = @as(u32, 2048);
pub const BAUD_14400 = @as(u32, 4096);
pub const BAUD_19200 = @as(u32, 8192);
pub const BAUD_38400 = @as(u32, 16384);
pub const BAUD_56K = @as(u32, 32768);
pub const BAUD_128K = @as(u32, 65536);
pub const BAUD_115200 = @as(u32, 131072);
pub const BAUD_57600 = @as(u32, 262144);
pub const BAUD_USER = @as(u32, 268435456);
pub const COMMPROP_INITIALIZED = @as(u32, 3879531822);
...
pub const SCS_THIS_PLATFORM_BINARY = @as(u32, 6);
...
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_A_W = "GetSystemWow64DirectoryA";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_A_T = "GetSystemWow64DirectoryA";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_A = "GetSystemWow64DirectoryW";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_W = "GetSystemWow64DirectoryW";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_T = "GetSystemWow64DirectoryW";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_A = "GetSystemWow64DirectoryW";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_W = "GetSystemWow64DirectoryW";
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_T = "GetSystemWow64DirectoryW";
...
pub const COPY_FILE2_V2_DONT_COPY_JUNCTIONS = @as(u32, 1);
pub const COPY_FILE2_V2_VALID_FLAGS = @as(u32, 1);
...
pub const RPI_SMB2_SHAREFLAG_ENCRYPT_DATA = @as(u32, 1);
pub const RPI_SMB2_SHAREFLAG_COMPRESS_DATA = @as(u32, 2);
...
pub const REG_SAVE_LOG_KEY = "RegSaveLogFile";
pub const REG_RESTORE_LOG_KEY = "RegRestoreLogFile";
...
pub const WLDP_HOST_CMD = Guid.initString("5baea1d6-6f1c-488e-8490-347fa5c5067f");
pub const WLDP_HOST_POWERSHELL = Guid.initString("8e9aaa7c-198b-4879-ae41-a50d47ad6458");
pub const WLDP_HOST_PYTHON = Guid.initString("bfd557ef-2448-42ec-810b-0d9f09352d4a");
pub const WLDP_HOST_WINDOWS_SCRIPT_HOST = Guid.initString("d30b84c5-29ce-4ff3-86ec-a30007a82e49");
pub const WLDP_HOST_JAVASCRIPT = Guid.initString("5629f0d5-1cca-4fed-a1a3-36a8c18d74c0");
pub const WLDP_HOST_HTML = Guid.initString("b35a71b6-fe56-48d6-9543-2dff0ecded66");
pub const WLDP_HOST_XML = Guid.initString("5594be58-c6bf-4295-82f4-d494d20e3a36");
pub const WLDP_HOST_MSI = Guid.initString("624eb611-6e7e-4eec-9bfe-f0ecdbfcf390");
pub const WLDP_HOST_OTHER = Guid.initString("626cbec3-e1fa-4227-9800-ed210274cf7c");
...
pub const ICameraUIControlEventCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICameraUIControlEventCallback_OnItemCaptured(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) void {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICameraUIControlEventCallback_OnItemDeleted(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) void {
...
pub const ICameraUIControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICameraUIControl_RemoveCapturedItem(self: *const T, pszPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IEditionUpgradeHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEditionUpgradeHelper_UpdateOperatingSystem(self: *const T, contentId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IEditionUpgradeBroker = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEditionUpgradeBroker_InitializeParentWindow(self: *const T, parentHandle: OLE_HANDLE) callconv(.Inline) HRESULT {
...
pub const IContainerActivationHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContainerActivationHelper_CanActivateClientVM(self: *const T, isAllowed: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IID_IFClipNotificationHelper_Value = Guid.initString("3d5e3d21-bd41-4c2a-a669-b17ce87fb50b");
pub const IID_IFClipNotificationHelper = &IID_IFClipNotificationHelper_Value;
pub const IFClipNotificationHelper = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        ShowSystemDialog: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IFClipNotificationHelper,
                titleText: ?BSTR,
                bodyText: ?BSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFClipNotificationHelper_ShowSystemDialog(self: *const T, titleText: ?BSTR, bodyText: ?BSTR) callconv(.Inline) HRESULT {
            return @as(*const IFClipNotificationHelper.VTable, @ptrCast(self.vtable)).ShowSystemDialog(@as(*const IFClipNotificationHelper, @ptrCast(self)), titleText, bodyText);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const FEATURE_ERROR = extern struct {
    ...
    process: ?[*:0]align(1) const u8,
    module: ?[*:0]align(1) const u8,
    callerReturnAddressOffset: u32,
    callerModule: ?[*:0]align(1) const u8,
    message: ?[*:0]align(1) const u8,
    originLineNumber: u16,
    originFile: ?[*:0]align(1) const u8,
    originModule: ?[*:0]align(1) const u8,
    originCallerReturnAddressOffset: u32,
    originCallerModule: ?[*:0]align(1) const u8,
    originName: ?[*:0]align(1) const u8,
};
...
pub const WLDP_EXECUTION_POLICY = enum(i32) {
    BLOCKED = 0,
    ALLOWED = 1,
    REQUIRE_SANDBOX = 2,
};
pub const WLDP_EXECUTION_POLICY_BLOCKED = WLDP_EXECUTION_POLICY.BLOCKED;
pub const WLDP_EXECUTION_POLICY_ALLOWED = WLDP_EXECUTION_POLICY.ALLOWED;
pub const WLDP_EXECUTION_POLICY_REQUIRE_SANDBOX = WLDP_EXECUTION_POLICY.REQUIRE_SANDBOX;

pub const WLDP_EXECUTION_EVALUATION_OPTIONS = enum(i32) {
    NONE = 0,
    EXECUTE_IN_INTERACTIVE_SESSION = 1,
    _,
    pub fn initFlags(o: struct {
        NONE: u1 = 0,
        EXECUTE_IN_INTERACTIVE_SESSION: u1 = 0,
    }) WLDP_EXECUTION_EVALUATION_OPTIONS {
        return @as(WLDP_EXECUTION_EVALUATION_OPTIONS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(WLDP_EXECUTION_EVALUATION_OPTIONS.NONE) else 0)
            | (if (o.EXECUTE_IN_INTERACTIVE_SESSION == 1) @intFromEnum(WLDP_EXECUTION_EVALUATION_OPTIONS.EXECUTE_IN_INTERACTIVE_SESSION) else 0)
        ));
    }
};
pub const WLDP_EXECUTION_EVALUATION_OPTION_NONE = WLDP_EXECUTION_EVALUATION_OPTIONS.NONE;
pub const WLDP_EXECUTION_EVALUATION_OPTION_EXECUTE_IN_INTERACTIVE_SESSION = WLDP_EXECUTION_EVALUATION_OPTIONS.EXECUTE_IN_INTERACTIVE_SESSION;
...
pub const PWLDP_CANEXECUTEFILE_API = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        host: ?*const Guid,
        options: WLDP_EXECUTION_EVALUATION_OPTIONS,
        fileHandle: ?HANDLE,
        auditInfo: ?[*:0]align(1) const u16,
...
pub const PWLDP_CANEXECUTEBUFFER_API = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        host: ?*const Guid,
        options: WLDP_EXECUTION_EVALUATION_OPTIONS,
        buffer: [*:0]const u8,
...
pub const PWLDP_CANEXECUTESTREAM_API = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        host: ?*const Guid,
        options: WLDP_EXECUTION_EVALUATION_OPTIONS,
        stream: ?*IStream,
...
pub const DELAYLOAD_INFO = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => extern struct {
        ...
        TargetDllName: ?[*:0]align(1) const u8,
...
pub extern "kernel32" fn GetProfileIntA(
    lpAppName: ?[*:0]align(1) const u8,
    lpKeyName: ?[*:0]align(1) const u8,
    nDefault: i32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn GetProfileIntW(
    lpAppName: ?[*:0]align(1) const u16,
    lpKeyName: ?[*:0]align(1) const u16,
    nDefault: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetPrivateProfileStructA(
    lpszSection: ?[*:0]align(1) const u8,
    lpszKey: ?[*:0]align(1) const u8,
    // TODO: what to do with BytesParamIndex 3?
    lpStruct: ?*anyopaque,
    uSizeStruct: u32,
    szFile: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn GetPrivateProfileStructW(
    lpszSection: ?[*:0]align(1) const u16,
    lpszKey: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 3?
    lpStruct: ?*anyopaque,
    uSizeStruct: u32,
...
pub extern "ntdll" fn RtlInitUnicodeString(
    ...
    SourceString: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "advpack" fn RunSetupCommandA(
    hWnd: ?HWND,
    szCmdName: ?[*:0]align(1) const u8,
    szInfSection: ?[*:0]align(1) const u8,
    szDir: ?[*:0]align(1) const u8,
    lpszTitle: ?[*:0]align(1) const u8,
    phEXE: ?*?HANDLE,
    dwFlags: u32,
...
pub extern "advpack" fn RunSetupCommandW(
    hWnd: ?HWND,
    szCmdName: ?[*:0]align(1) const u16,
    szInfSection: ?[*:0]align(1) const u16,
    szDir: ?[*:0]align(1) const u16,
    lpszTitle: ?[*:0]align(1) const u16,
    phEXE: ?*?HANDLE,
    dwFlags: u32,
    pvReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn RebootCheckOnInstallA(
    hwnd: ?HWND,
    pszINF: ?[*:0]align(1) const u8,
    pszSec: ?[*:0]align(1) const u8,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn RebootCheckOnInstallW(
    hwnd: ?HWND,
    pszINF: ?[*:0]align(1) const u16,
    pszSec: ?[*:0]align(1) const u16,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn TranslateInfStringA(
    pszInfFilename: ?[*:0]align(1) const u8,
    pszInstallSection: ?[*:0]align(1) const u8,
    pszTranslateSection: ?[*:0]align(1) const u8,
    pszTranslateKey: ?[*:0]align(1) const u8,
    pszBuffer: ?[*:0]u8,
    cchBuffer: u32,
    pdwRequiredSize: ?*u32,
    pvReserved: ?*anyopaque,
...
pub extern "advpack" fn TranslateInfStringW(
    pszInfFilename: ?[*:0]align(1) const u16,
    pszInstallSection: ?[*:0]align(1) const u16,
    pszTranslateSection: ?[*:0]align(1) const u16,
    pszTranslateKey: ?[*:0]align(1) const u16,
    pszBuffer: ?[*:0]u16,
    cchBuffer: u32,
    pdwRequiredSize: ?*u32,
    pvReserved: ?*anyopaque,
...
pub extern "advpack" fn RegInstallW(
    hmod: HMODULE,
    pszSection: ?[*:0]align(1) const u16,
...
pub extern "advpack" fn AdvInstallFileA(
    hwnd: ?HWND,
    lpszSourceDir: ?[*:0]align(1) const u8,
    lpszSourceFile: ?[*:0]align(1) const u8,
    lpszDestDir: ?[*:0]align(1) const u8,
    lpszDestFile: ?[*:0]align(1) const u8,
    dwFlags: u32,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn AdvInstallFileW(
    hwnd: ?HWND,
    lpszSourceDir: ?[*:0]align(1) const u16,
    lpszSourceFile: ?[*:0]align(1) const u16,
    lpszDestDir: ?[*:0]align(1) const u16,
    lpszDestFile: ?[*:0]align(1) const u16,
    dwFlags: u32,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn RegSaveRestoreA(
    hWnd: ?HWND,
    pszTitleString: ?[*:0]align(1) const u8,
    hkBckupKey: ?HKEY,
    pcszRootKey: ?[*:0]align(1) const u8,
    pcszSubKey: ?[*:0]align(1) const u8,
    pcszValueName: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn RegSaveRestoreW(
    hWnd: ?HWND,
    pszTitleString: ?[*:0]align(1) const u16,
    hkBckupKey: ?HKEY,
    pcszRootKey: ?[*:0]align(1) const u16,
    pcszSubKey: ?[*:0]align(1) const u16,
    pcszValueName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn FileSaveRestoreW(
    hDlg: ?HWND,
    lpFileList: ?PWSTR,
    lpDir: ?[*:0]align(1) const u16,
    lpBaseName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn FileSaveRestoreOnINFA(
    ...
    pszINF: ?[*:0]align(1) const u8,
    pszSection: ?[*:0]align(1) const u8,
    pszBackupDir: ?[*:0]align(1) const u8,
    pszBaseBackupFile: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn FileSaveRestoreOnINFW(
    ...
    pszINF: ?[*:0]align(1) const u16,
    pszSection: ?[*:0]align(1) const u16,
    pszBackupDir: ?[*:0]align(1) const u16,
    pszBaseBackupFile: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn AddDelBackupEntryA(
    lpcszFileList: ?[*:0]align(1) const u8,
    lpcszBackupDir: ?[*:0]align(1) const u8,
    lpcszBaseName: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn AddDelBackupEntryW(
    lpcszFileList: ?[*:0]align(1) const u16,
    lpcszBackupDir: ?[*:0]align(1) const u16,
    lpcszBaseName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn FileSaveMarkNotExistA(
    lpFileList: ?[*:0]align(1) const u8,
    lpDir: ?[*:0]align(1) const u8,
    lpBaseName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn FileSaveMarkNotExistW(
    lpFileList: ?[*:0]align(1) const u16,
    lpDir: ?[*:0]align(1) const u16,
    lpBaseName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn DelNodeA(
    pszFileOrDirName: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn DelNodeW(
    pszFileOrDirName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn ExtractFilesA(
    pszCabName: ?[*:0]align(1) const u8,
    pszExpandDir: ?[*:0]align(1) const u8,
    dwFlags: u32,
    pszFileList: ?[*:0]align(1) const u8,
    lpReserved: ?*anyopaque,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn ExtractFilesW(
    pszCabName: ?[*:0]align(1) const u16,
    pszExpandDir: ?[*:0]align(1) const u16,
    dwFlags: u32,
    pszFileList: ?[*:0]align(1) const u16,
    lpReserved: ?*anyopaque,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "wldp" fn WldpCanExecuteFile(
    host: ?*const Guid,
    options: WLDP_EXECUTION_EVALUATION_OPTIONS,
    fileHandle: ?HANDLE,
    auditInfo: ?[*:0]align(1) const u16,
...
pub extern "wldp" fn WldpCanExecuteBuffer(
    host: ?*const Guid,
    options: WLDP_EXECUTION_EVALUATION_OPTIONS,
    buffer: [*:0]const u8,
    bufferSize: u32,
...
pub extern "wldp" fn WldpCanExecuteStream(
    host: ?*const Guid,
    options: WLDP_EXECUTION_EVALUATION_OPTIONS,
    stream: ?*IStream,
    auditInfo: ?[*:0]align(1) const u16,
...
const HLOCAL = @import("../../../windows/win32/foundation.zig").HLOCAL;
...
const OLE_HANDLE = @import("../../../windows/win32/system/ole.zig").OLE_HANDLE;
...
const STRING = @import("../../../windows/win32/system/kernel.zig").STRING;
...
test {
    ...
    if (@hasDecl(@This(), "PWLDP_CANEXECUTEFILE_API")) { _ = PWLDP_CANEXECUTEFILE_API; }
    if (@hasDecl(@This(), "PWLDP_CANEXECUTEBUFFER_API")) { _ = PWLDP_CANEXECUTEBUFFER_API; }
    if (@hasDecl(@This(), "PWLDP_CANEXECUTESTREAM_API")) { _ = PWLDP_CANEXECUTESTREAM_API; }
