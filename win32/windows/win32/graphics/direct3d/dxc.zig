...
pub const IDxcIncludeHandler = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcIncludeHandler_LoadSource(self: *const T, pFilename: ?[*:0]align(1) const u16, ppIncludeSource: ?*?*IDxcBlob) callconv(.Inline) HRESULT {
...
pub const IDxcCompilerArgs = extern struct {
    pub const VTable = extern struct {
        ...
        AddArguments: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDxcCompilerArgs,
                pArguments: ?[*]const ?[*:0]align(1) const u16,
                argCount: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDxcCompilerArgs,
        ...
        AddArgumentsUTF8: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDxcCompilerArgs,
                pArguments: ?[*]const ?[*:0]align(1) const u8,
                argCount: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDxcCompilerArgs,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcCompilerArgs_AddArguments(self: *const T, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcCompilerArgs_AddArgumentsUTF8(self: *const T, pArguments: ?[*]const ?[*:0]align(1) const u8, argCount: u32) callconv(.Inline) HRESULT {
...
pub const IDxcLibrary = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcLibrary_CreateBlobFromFile(self: *const T, pFileName: ?[*:0]align(1) const u16, codePage: ?*DXC_CP, pBlobEncoding: ?*?*IDxcBlobEncoding) callconv(.Inline) HRESULT {
...
pub const IDxcCompiler = extern struct {
    pub const VTable = extern struct {
        ...
        Compile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pSource: ?*IDxcBlob,
                pSourceName: ?[*:0]align(1) const u16,
                pEntryPoint: ?[*:0]align(1) const u16,
                pTargetProfile: ?[*:0]align(1) const u16,
                pArguments: ?[*]const ?[*:0]align(1) const u16,
                argCount: u32,
                pDefines: [*]const DxcDefine,
                defineCount: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcCompiler_Compile(self: *const T, pSource: ?*IDxcBlob, pSourceName: ?[*:0]align(1) const u16, pEntryPoint: ?[*:0]align(1) const u16, pTargetProfile: ?[*:0]align(1) const u16, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32, pDefines: [*]const DxcDefine, defineCount: u32, pIncludeHandler: ?*IDxcIncludeHandler, ppResult: ?*?*IDxcOperationResult) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcCompiler_Preprocess(self: *const T, pSource: ?*IDxcBlob, pSourceName: ?[*:0]align(1) const u16, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32, pDefines: [*]const DxcDefine, defineCount: u32, pIncludeHandler: ?*IDxcIncludeHandler, ppResult: ?*?*IDxcOperationResult) callconv(.Inline) HRESULT {
...
pub const IDxcLinker = extern struct {
    pub const VTable = extern struct {
        ...
        Link: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDxcLinker,
                pEntryName: ?[*:0]align(1) const u16,
                pTargetProfile: ?[*:0]align(1) const u16,
                pLibNames: [*]const ?[*:0]align(1) const u16,
                libCount: u32,
                pArguments: ?[*]const ?[*:0]align(1) const u16,
                argCount: u32,
                ppResult: ?*?*IDxcOperationResult,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcLinker_RegisterLibrary(self: *const T, pLibName: ?[*:0]align(1) const u16, pLib: ?*IDxcBlob) callconv(.Inline) HRESULT {
            return @as(*const IDxcLinker.VTable, @ptrCast(self.vtable)).RegisterLibrary(@as(*const IDxcLinker, @ptrCast(self)), pLibName, pLib);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcLinker_Link(self: *const T, pEntryName: ?[*:0]align(1) const u16, pTargetProfile: ?[*:0]align(1) const u16, pLibNames: [*]const ?[*:0]align(1) const u16, libCount: u32, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32, ppResult: ?*?*IDxcOperationResult) callconv(.Inline) HRESULT {
...
pub const IDxcUtils = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcUtils_LoadFile(self: *const T, pFileName: ?[*:0]align(1) const u16, pCodePage: ?*DXC_CP, pBlobEncoding: ?*?*IDxcBlobEncoding) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcUtils_BuildArguments(self: *const T, pSourceName: ?[*:0]align(1) const u16, pEntryPoint: ?[*:0]align(1) const u16, pTargetProfile: ?[*:0]align(1) const u16, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32, pDefines: [*]const DxcDefine, defineCount: u32, ppArgs: ?*?*IDxcCompilerArgs) callconv(.Inline) HRESULT {
...
pub const IDxcCompiler3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcCompiler3_Compile(self: *const T, pSource: ?*const DxcBuffer, pArguments: ?[*]const ?[*:0]align(1) const u16, argCount: u32, pIncludeHandler: ?*IDxcIncludeHandler, riid: ?*const Guid, ppResult: ?*?*anyopaque) callconv(.Inline) HRESULT {
...
pub const IDxcOptimizer = extern struct {
    pub const VTable = extern struct {
        ...
        RunOptimizer: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDxcOptimizer,
                pBlob: ?*IDxcBlob,
                ppOptions: [*]const ?[*:0]align(1) const u16,
                optionCount: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcOptimizer_RunOptimizer(self: *const T, pBlob: ?*IDxcBlob, ppOptions: [*]const ?[*:0]align(1) const u16, optionCount: u32, pOutputModule: ?*?*IDxcBlob, ppOutputText: ?*?*IDxcBlobEncoding) callconv(.Inline) HRESULT {
...
pub const IDxcPdbUtils = extern struct {
    pub const VTable = extern struct {
        ...
        OverrideRootSignature: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDxcPdbUtils,
                pRootSignature: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IDxcPdbUtils,
                pRootSignature: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDxcPdbUtils_OverrideRootSignature(self: *const T, pRootSignature: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
