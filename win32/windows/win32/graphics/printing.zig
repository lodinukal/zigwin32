...
pub const DOC_INFO_INTERNAL_LEVEL = @as(u32, 100);
...
pub const JOB_CONTROL_SEND_TOAST = @as(u32, 10);
...
pub const PFN_PRINTING_ENUMPORTS = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: u32,
        param2: ?*u8,
...
pub const PFN_PRINTING_OPENPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: ?*?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
...
pub const PFN_PRINTING_OPENPORTEX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_STARTDOCPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: u32,
...
pub const PFN_PRINTING_WRITEPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*u8,
        param2: u32,
...
pub const PFN_PRINTING_READPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*u8,
        param2: u32,
...
pub const PFN_PRINTING_ENDDOCPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_CLOSEPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_ADDPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: ?HWND,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_ADDPORTEX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: u32,
        param2: ?*u8,
...
pub const PFN_PRINTING_CONFIGUREPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: ?HWND,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_DELETEPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?PWSTR,
        param1: ?HWND,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_GETPRINTERDATAFROMPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_SETPORTTIMEOUTS = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*COMMTIMEOUTS,
        param2: u32,
...
pub const PFN_PRINTING_XCVOPENPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
...
pub const PFN_PRINTING_XCVDATAPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
...
pub const PFN_PRINTING_XCVCLOSEPORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_ENUMPORTS2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: u32,
...
pub const PFN_PRINTING_OPENPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: ?*?HANDLE,
...
pub const PFN_PRINTING_OPENPORTEX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?HANDLE,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_STARTDOCPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: u32,
...
pub const PFN_PRINTING_WRITEPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*u8,
        param2: u32,
...
pub const PFN_PRINTING_READPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*u8,
        param2: u32,
...
pub const PFN_PRINTING_ENDDOCPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_CLOSEPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_ADDPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: ?HWND,
...
pub const PFN_PRINTING_ADDPORTEX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: u32,
...
pub const PFN_PRINTING_CONFIGUREPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: ?HWND,
...
pub const PFN_PRINTING_DELETEPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?PWSTR,
        param2: ?HWND,
...
pub const PFN_PRINTING_GETPRINTERDATAFROMPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?PWSTR,
...
pub const PFN_PRINTING_SETPORTTIMEOUTS2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?*COMMTIMEOUTS,
        param2: u32,
...
pub const PFN_PRINTING_XCVOPENPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?[*:0]align(1) const u16,
        param2: u32,
...
pub const PFN_PRINTING_XCVDATAPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: ?[*:0]align(1) const u16,
        param2: ?*u8,
...
pub const PFN_PRINTING_XCVCLOSEPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
...
pub const PFN_PRINTING_SHUTDOWN2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
...
pub const PFN_PRINTING_SENDRECVBIDIDATAFROMPORT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?[*:0]align(1) const u16,
        param3: ?*BIDI_REQUEST_CONTAINER,
        param4: ?*?*BIDI_RESPONSE_CONTAINER,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        param0: ?HANDLE,
        param1: u32,
...
pub const PFN_PRINTING_NOTIFYUSEDPORTS2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?[*:0]align(1) const u16,
...
pub const PFN_PRINTING_NOTIFYUNUSEDPORTS2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?[*:0]align(1) const u16,
...
pub const PFN_PRINTING_POWEREVENT2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HANDLE,
        param1: u32,
        param2: ?*POWERBROADCAST_SETTING,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        param0: ?HANDLE,
        param1: u32,
...
pub const IBidiRequest = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IBidiRequest_SetSchema(self: *const T, pszSchema: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IBidiSpl = extern struct {
    pub const VTable = extern struct {
        ...
        BindDevice: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IBidiSpl,
                pszDeviceName: ?[*:0]align(1) const u16,
                dwAccess: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IBidiSpl,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBidiSpl_BindDevice(self: *const T, pszDeviceName: ?[*:0]align(1) const u16, dwAccess: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBidiSpl_SendRecv(self: *const T, pszAction: ?[*:0]align(1) const u16, pRequest: ?*IBidiRequest) callconv(.Inline) HRESULT {
            return @as(*const IBidiSpl.VTable, @ptrCast(self.vtable)).SendRecv(@as(*const IBidiSpl, @ptrCast(self)), pszAction, pRequest);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBidiSpl_MultiSendRecv(self: *const T, pszAction: ?[*:0]align(1) const u16, pRequestContainer: ?*IBidiRequestContainer) callconv(.Inline) HRESULT {
...
pub const IBidiSpl2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IBidiSpl2_BindDevice(self: *const T, pszDeviceName: ?[*:0]align(1) const u16, dwAccess: u32) callconv(.Inline) HRESULT {
...
pub const IPrintPipelinePropertyBag = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintPipelinePropertyBag_AddProperty(self: *const T, pszName: ?[*:0]align(1) const u16, pVar: ?*const VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintPipelinePropertyBag_GetProperty(self: *const T, pszName: ?[*:0]align(1) const u16, pVar: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintPipelinePropertyBag_DeleteProperty(self: *const T, pszName: ?[*:0]align(1) const u16) callconv(.Inline) BOOL {
...
pub const IPrintClassObjectFactory = extern struct {
    pub const VTable = extern struct {
        ...
        GetPrintClassObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszPrinterName: ?[*:0]align(1) const u16,
                riid: ?*const Guid,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintClassObjectFactory_GetPrintClassObject(self: *const T, pszPrinterName: ?[*:0]align(1) const u16, riid: ?*const Guid, ppNewObject: ?*?*anyopaque) callconv(.Inline) HRESULT {
...
pub const IXpsDocumentConsumer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXpsDocumentConsumer_GetNewEmptyPart(self: *const T, uri: ?[*:0]align(1) const u16, riid: ?*const Guid, ppNewObject: ?*?*anyopaque, ppWriteStream: ?*?*IPrintWriteStream) callconv(.Inline) HRESULT {
...
pub const IFixedPage = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFixedPage_GetPagePart(self: *const T, uri: ?[*:0]align(1) const u16, ppUnk: ?*?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFixedPage_DeleteResource(self: *const T, uri: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPartImage = extern struct {
    pub const VTable = extern struct {
        ...
        SetImageContent: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPartImage,
                pContentType: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPartImage,
                pContentType: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPartImage_SetImageContent(self: *const T, pContentType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPartFont = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPartFont_SetFontContent(self: *const T, pContentType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPartThumbnail = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPartThumbnail_SetThumbnailContent(self: *const T, pContentType: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const FORM_INFO_2A = extern struct {
    Flags: u32,
    pName: ?[*:0]align(1) const u8,
    Size: SIZE,
    ImageableArea: RECTL,
    pKeyword: ?[*:0]align(1) const u8,
    StringType: u32,
    pMuiDll: ?[*:0]align(1) const u8,
    dwResourceId: u32,
    pDisplayName: ?[*:0]align(1) const u8,
    wLangId: u16,
};
...
pub const FORM_INFO_2W = extern struct {
    ...
    pKeyword: ?[*:0]align(1) const u8,
    StringType: u32,
    pMuiDll: ?[*:0]align(1) const u16,
    dwResourceId: u32,
    pDisplayName: ?[*:0]align(1) const u16,
    wLangId: u16,
};
...
pub const PFN_DrvUpgradeRegistrySetting = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hPrinter: ?HANDLE,
        pFeature: ?[*:0]align(1) const u8,
        pOption: ?[*:0]align(1) const u8,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
        hPrinter: ?HANDLE,
        pFeature: ?[*:0]align(1) const u8,
...
pub const PRINT_FEATURE_OPTION = extern struct {
    pszFeature: ?[*:0]align(1) const u8,
    pszOption: ?[*:0]align(1) const u8,
};
...
pub const IPrintCoreHelper = extern struct {
    pub const VTable = extern struct {
        ...
        GetOption: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                cbSize: u32,
                pszFeatureRequested: ?[*:0]align(1) const u8,
                ppszOption: ?*const ?PSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintCoreHelper,
                // TODO: what to do with BytesParamIndex 1?
        ...
        EnumConstrainedOptions: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pDevmode: ?*const DEVMODEA,
                cbSize: u32,
                pszFeatureKeyword: ?[*:0]align(1) const u8,
                pConstrainedOptionList: ?*const ?*?*?PSTR,
                pdwNumOptions: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintCoreHelper,
        ...
        WhyConstrained: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                cbSize: u32,
                pszFeatureKeyword: ?[*:0]align(1) const u8,
                pszOptionKeyword: ?[*:0]align(1) const u8,
        ...
        GetFontSubstitution: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintCoreHelper,
                pszTrueTypeFontName: ?[*:0]align(1) const u16,
                ppszDevFontName: ?*const ?PWSTR,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintCoreHelper,
                pszTrueTypeFontName: ?[*:0]align(1) const u16,
        ...
        SetFontSubstitution: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintCoreHelper,
                pszTrueTypeFontName: ?[*:0]align(1) const u16,
                pszDevFontName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintCoreHelper,
                pszTrueTypeFontName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_GetOption(self: *const T, pDevmode: ?*const DEVMODEA, cbSize: u32, pszFeatureRequested: ?[*:0]align(1) const u8, ppszOption: ?*const ?PSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_EnumConstrainedOptions(self: *const T, pDevmode: ?*const DEVMODEA, cbSize: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pConstrainedOptionList: ?*const ?*?*?PSTR, pdwNumOptions: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_WhyConstrained(self: *const T, pDevmode: ?*const DEVMODEA, cbSize: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pszOptionKeyword: ?[*:0]align(1) const u8, ppFOConstraints: ?*const ?*PRINT_FEATURE_OPTION, pdwNumOptions: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_EnumFeatures(self: *const T, pFeatureList: ?*const ?*?*?PSTR, pdwNumFeatures: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_EnumOptions(self: *const T, pszFeatureKeyword: ?[*:0]align(1) const u8, pOptionList: ?*const ?*?*?PSTR, pdwNumOptions: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_GetFontSubstitution(self: *const T, pszTrueTypeFontName: ?[*:0]align(1) const u16, ppszDevFontName: ?*const ?PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelper_SetFontSubstitution(self: *const T, pszTrueTypeFontName: ?[*:0]align(1) const u16, pszDevFontName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPrintCoreHelperUni2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetNamedCommand: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pDevmode: ?*DEVMODEA,
                cbSize: u32,
                pszCommandName: ?[*:0]align(1) const u16,
                ppCommandBytes: ?*?*u8,
                pcbCommandSize: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelperUni2_GetNamedCommand(self: *const T, pDevmode: ?*DEVMODEA, cbSize: u32, pszCommandName: ?[*:0]align(1) const u16, ppCommandBytes: ?*?*u8, pcbCommandSize: ?*u32) callconv(.Inline) HRESULT {
...
pub const IPrintCoreHelperPS = extern struct {
    pub const VTable = extern struct {
        ...
        GetGlobalAttribute: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszAttribute: ?[*:0]align(1) const u8,
                pdwDataType: ?*u32,
                ppbData: ?*?*u8,
                pcbSize: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IPrintCoreHelper.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelperPS_GetGlobalAttribute(self: *const T, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, ppbData: ?*?*u8, pcbSize: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelperPS_GetFeatureAttribute(self: *const T, pszFeatureKeyword: ?[*:0]align(1) const u8, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, ppbData: ?*?*u8, pcbSize: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreHelperPS_GetOptionAttribute(self: *const T, pszFeatureKeyword: ?[*:0]align(1) const u8, pszOptionKeyword: ?[*:0]align(1) const u8, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, ppbData: ?*?*u8, pcbSize: ?*u32) callconv(.Inline) HRESULT {
...
pub const IPrintOemDriverUI = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintOemDriverUI_DrvGetDriverSetting(self: *const T, pci: ?*anyopaque, Feature: ?[*:0]align(1) const u8, pOutput: ?*anyopaque, cbSize: u32, pcbNeeded: ?*u32, pdwOptionsReturned: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintOemDriverUI_DrvUpgradeRegistrySetting(self: *const T, hPrinter: ?HANDLE, pFeature: ?[*:0]align(1) const u8, pOption: ?[*:0]align(1) const u8) callconv(.Inline) HRESULT {
...
pub const IPrintCoreUI2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetOptions: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pmszFeatureOptionBuf: ?[*]align(1) u8,
                cbSize: u32,
                pcbNeeded: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        EnumConstrainedOptions: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pmszConstrainedOptionList: ?[*]align(1) u8,
                cbSize: u32,
                pcbNeeded: ?*u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_GetOptions(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pmszFeaturesRequested: ?*i8, cbIn: u32, pmszFeatureOptionBuf: ?[*]align(1) u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_EnumConstrainedOptions(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pmszConstrainedOptionList: ?[*]align(1) u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_WhyConstrained(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pszOptionKeyword: ?[*:0]align(1) const u8, pmszReasonList: ?[*]align(1) u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_GetGlobalAttribute(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, pbData: ?*u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_GetFeatureAttribute(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, pbData: ?*u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_GetOptionAttribute(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pszOptionKeyword: ?[*:0]align(1) const u8, pszAttribute: ?[*:0]align(1) const u8, pdwDataType: ?*u32, pbData: ?*u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_EnumFeatures(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pmszFeatureList: ?[*]align(1) u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintCoreUI2_EnumOptions(self: *const T, poemuiobj: ?*OEMUIOBJ, dwFlags: u32, pszFeatureKeyword: ?[*:0]align(1) const u8, pmszOptionList: ?[*]align(1) u8, cbSize: u32, pcbNeeded: ?*u32) callconv(.Inline) HRESULT {
...
pub const IPrintTicketProvider2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetPrintDeviceResources: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintTicketProvider2,
                pszLocaleName: ?[*:0]align(1) const u16,
                pPrintTicket: ?*IXMLDOMDocument2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintTicketProvider2_GetPrintDeviceResources(self: *const T, pszLocaleName: ?[*:0]align(1) const u16, pPrintTicket: ?*IXMLDOMDocument2, ppDeviceResources: ?*?*IXMLDOMDocument2) callconv(.Inline) HRESULT {
...
pub const IAsyncGetSrvReferralCookie = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAsyncGetSrvReferralCookie_FinishAsyncCallWithData(self: *const T, param0: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPrintAsyncNotifyServerReferral = extern struct {
    pub const VTable = extern struct {
        ...
        SetServerReferral: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPrintAsyncNotifyServerReferral,
                pRmtServerReferral: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPrintAsyncNotifyServerReferral,
                pRmtServerReferral: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPrintAsyncNotifyServerReferral_SetServerReferral(self: *const T, pRmtServerReferral: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const MONITORINIT = extern struct {
    ...
    bLocal: BOOL,
    pszServerName: ?[*:0]align(1) const u16,
};
...
pub extern "winspool" fn GetPrinterDataExA(
    hPrinter: ?HANDLE,
    pKeyName: ?[*:0]align(1) const u8,
    pValueName: ?[*:0]align(1) const u8,
    pType: ?*u32,
    // TODO: what to do with BytesParamIndex 5?
    pData: ?*u8,
    nSize: u32,
...
pub extern "winspool" fn GetPrinterDataExW(
    hPrinter: ?HANDLE,
    pKeyName: ?[*:0]align(1) const u16,
    pValueName: ?[*:0]align(1) const u16,
    pType: ?*u32,
    // TODO: what to do with BytesParamIndex 5?
    pData: ?*u8,
    nSize: u32,
...
pub extern "winspool" fn XcvDataW(
    hXcv: ?HANDLE,
    pszDataName: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 3?
    pInputData: ?*u8,
    cbInputData: u32,
    // TODO: what to do with BytesParamIndex 5?
...
pub extern "winspool" fn SetDefaultPrinterA(
    pszPrinter: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "winspool" fn SetDefaultPrinterW(
    pszPrinter: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winspool" fn OpenPrinter2A(
    pPrinterName: ?[*:0]align(1) const u8,
    phPrinter: ?*?HANDLE,
    pDefault: ?*PRINTER_DEFAULTSA,
...
pub extern "winspool" fn OpenPrinter2W(
    pPrinterName: ?[*:0]align(1) const u16,
    phPrinter: ?*?HANDLE,
    pDefault: ?*PRINTER_DEFAULTSW,
...
pub extern "winspool" fn InstallPrinterDriverFromPackageA(
    pszServer: ?[*:0]align(1) const u8,
    pszInfPath: ?[*:0]align(1) const u8,
    pszDriverName: ?[*:0]align(1) const u8,
    pszEnvironment: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "winspool" fn InstallPrinterDriverFromPackageW(
    pszServer: ?[*:0]align(1) const u16,
    pszInfPath: ?[*:0]align(1) const u16,
    pszDriverName: ?[*:0]align(1) const u16,
    pszEnvironment: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winspool" fn GetCorePrinterDriversA(
    pszServer: ?[*:0]align(1) const u8,
    pszEnvironment: ?[*:0]align(1) const u8,
    pszzCoreDriverDependencies: ?[*:0]align(1) const u8,
...
pub extern "winspool" fn GetCorePrinterDriversW(
    pszServer: ?[*:0]align(1) const u16,
    pszEnvironment: ?[*:0]align(1) const u16,
    pszzCoreDriverDependencies: ?[*:0]align(1) const u16,
    cCorePrinterDrivers: u32,
...
pub extern "winspool" fn GetPrinterDriverPackagePathA(
    pszServer: ?[*:0]align(1) const u8,
    pszEnvironment: ?[*:0]align(1) const u8,
    pszLanguage: ?[*:0]align(1) const u8,
    pszPackageID: ?[*:0]align(1) const u8,
...
pub extern "winspool" fn GetPrinterDriverPackagePathW(
    pszServer: ?[*:0]align(1) const u16,
    pszEnvironment: ?[*:0]align(1) const u16,
    pszLanguage: ?[*:0]align(1) const u16,
    pszPackageID: ?[*:0]align(1) const u16,
...
pub extern "mscms" fn GenerateCopyFilePaths(
    pszPrinterName: ?[*:0]align(1) const u16,
    pszDirectory: ?[*:0]align(1) const u16,
    pSplClientInfo: ?*u8,
    dwLevel: u32,
    pszSourceDir: [*:0]u16,
...
const COMMTIMEOUTS = @import("../../../windows/win32/devices/communication.zig").COMMTIMEOUTS;
const DEVMODEA = @import("../../../windows/win32/graphics/gdi.zig").DEVMODEA;
const DEVMODEW = @import("../../../windows/win32/graphics/gdi.zig").DEVMODEW;
const DLGPROC = @import("../../../windows/win32/ui/windows_and_messaging.zig").DLGPROC;
const DOCINFOW = @import("../../../windows/win32/storage/xps.zig").DOCINFOW;
const FARPROC = @import("../../../windows/win32/foundation.zig").FARPROC;
const FD_KERNINGPAIR = @import("../../../windows/win32/devices/display.zig").FD_KERNINGPAIR;
...
const ICreateErrorInfo = @import("../../../windows/win32/system/ole.zig").ICreateErrorInfo;
...
const IErrorInfo = @import("../../../windows/win32/system/com.zig").IErrorInfo;
...
const IXMLDOMDocument2 = @import("../../../windows/win32/data/xml/ms_xml.zig").IXMLDOMDocument2;
const IXpsOMPage = @import("../../../windows/win32/storage/xps.zig").IXpsOMPage;
const LPARAM = @import("../../../windows/win32/foundation.zig").LPARAM;
const LRESULT = @import("../../../windows/win32/foundation.zig").LRESULT;
const PANOSE = @import("../../../windows/win32/graphics/gdi.zig").PANOSE;
const POINTL = @import("../../../windows/win32/foundation.zig").POINTL;
const POWERBROADCAST_SETTING = @import("../../../windows/win32/system/power.zig").POWERBROADCAST_SETTING;
...
const STREAM_SEEK = @import("../../../windows/win32/system/com.zig").STREAM_SEEK;
...
test {
    ...
    if (@hasDecl(@This(), "PFN_PRINTING_ENUMPORTS")) { _ = PFN_PRINTING_ENUMPORTS; }
    if (@hasDecl(@This(), "PFN_PRINTING_OPENPORT")) { _ = PFN_PRINTING_OPENPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_OPENPORTEX")) { _ = PFN_PRINTING_OPENPORTEX; }
    if (@hasDecl(@This(), "PFN_PRINTING_STARTDOCPORT")) { _ = PFN_PRINTING_STARTDOCPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_WRITEPORT")) { _ = PFN_PRINTING_WRITEPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_READPORT")) { _ = PFN_PRINTING_READPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_ENDDOCPORT")) { _ = PFN_PRINTING_ENDDOCPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_CLOSEPORT")) { _ = PFN_PRINTING_CLOSEPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_ADDPORT")) { _ = PFN_PRINTING_ADDPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_ADDPORTEX")) { _ = PFN_PRINTING_ADDPORTEX; }
    if (@hasDecl(@This(), "PFN_PRINTING_CONFIGUREPORT")) { _ = PFN_PRINTING_CONFIGUREPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_DELETEPORT")) { _ = PFN_PRINTING_DELETEPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_GETPRINTERDATAFROMPORT")) { _ = PFN_PRINTING_GETPRINTERDATAFROMPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_SETPORTTIMEOUTS")) { _ = PFN_PRINTING_SETPORTTIMEOUTS; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVOPENPORT")) { _ = PFN_PRINTING_XCVOPENPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVDATAPORT")) { _ = PFN_PRINTING_XCVDATAPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVCLOSEPORT")) { _ = PFN_PRINTING_XCVCLOSEPORT; }
    if (@hasDecl(@This(), "PFN_PRINTING_ENUMPORTS2")) { _ = PFN_PRINTING_ENUMPORTS2; }
    if (@hasDecl(@This(), "PFN_PRINTING_OPENPORT2")) { _ = PFN_PRINTING_OPENPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_OPENPORTEX2")) { _ = PFN_PRINTING_OPENPORTEX2; }
    if (@hasDecl(@This(), "PFN_PRINTING_STARTDOCPORT2")) { _ = PFN_PRINTING_STARTDOCPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_WRITEPORT2")) { _ = PFN_PRINTING_WRITEPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_READPORT2")) { _ = PFN_PRINTING_READPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_ENDDOCPORT2")) { _ = PFN_PRINTING_ENDDOCPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_CLOSEPORT2")) { _ = PFN_PRINTING_CLOSEPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_ADDPORT2")) { _ = PFN_PRINTING_ADDPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_ADDPORTEX2")) { _ = PFN_PRINTING_ADDPORTEX2; }
    if (@hasDecl(@This(), "PFN_PRINTING_CONFIGUREPORT2")) { _ = PFN_PRINTING_CONFIGUREPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_DELETEPORT2")) { _ = PFN_PRINTING_DELETEPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_GETPRINTERDATAFROMPORT2")) { _ = PFN_PRINTING_GETPRINTERDATAFROMPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_SETPORTTIMEOUTS2")) { _ = PFN_PRINTING_SETPORTTIMEOUTS2; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVOPENPORT2")) { _ = PFN_PRINTING_XCVOPENPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVDATAPORT2")) { _ = PFN_PRINTING_XCVDATAPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_XCVCLOSEPORT2")) { _ = PFN_PRINTING_XCVCLOSEPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_SHUTDOWN2")) { _ = PFN_PRINTING_SHUTDOWN2; }
    if (@hasDecl(@This(), "PFN_PRINTING_SENDRECVBIDIDATAFROMPORT2")) { _ = PFN_PRINTING_SENDRECVBIDIDATAFROMPORT2; }
    if (@hasDecl(@This(), "PFN_PRINTING_NOTIFYUSEDPORTS2")) { _ = PFN_PRINTING_NOTIFYUSEDPORTS2; }
    if (@hasDecl(@This(), "PFN_PRINTING_NOTIFYUNUSEDPORTS2")) { _ = PFN_PRINTING_NOTIFYUNUSEDPORTS2; }
    if (@hasDecl(@This(), "PFN_PRINTING_POWEREVENT2")) { _ = PFN_PRINTING_POWEREVENT2; }
