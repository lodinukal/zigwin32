...
pub const IPSEC_POLICY_FLAG_BANDWIDTH1 = @as(u32, 268435456);
pub const IPSEC_POLICY_FLAG_BANDWIDTH2 = @as(u32, 536870912);
pub const IPSEC_POLICY_FLAG_BANDWIDTH3 = @as(u32, 1073741824);
pub const IPSEC_POLICY_FLAG_BANDWIDTH4 = @as(u32, 2147483648);
...
pub const IPSEC_SA_BUNDLE_FLAG_TUNNEL_BANDWIDTH1 = @as(u32, 268435456);
pub const IPSEC_SA_BUNDLE_FLAG_TUNNEL_BANDWIDTH2 = @as(u32, 536870912);
pub const IPSEC_SA_BUNDLE_FLAG_TUNNEL_BANDWIDTH3 = @as(u32, 1073741824);
pub const IPSEC_SA_BUNDLE_FLAG_TUNNEL_BANDWIDTH4 = @as(u32, 2147483648);
...
pub const FWPM_LAYER_OUTBOUND_NETWORK_CONNECTION_POLICY_V4 = Guid.initString("037f317a-d696-494a-bba5-bffc265e6052");
pub const FWPM_LAYER_OUTBOUND_NETWORK_CONNECTION_POLICY_V6 = Guid.initString("22a4fdb1-6d7e-48ae-ae77-3742525c3119");
...
pub const FWPM_SUBLAYER_MPSSVC_APP_ISOLATION = Guid.initString("ffe221c3-92a8-4564-a59f-dafb70756020");
...
pub const FWPM_PROVIDER_MPSSVC_APP_ISOLATION = Guid.initString("3cc2631f-2d5d-43a0-b174-614837d863a1");
...
pub const FWPM_CALLOUT_OUTBOUND_NETWORK_CONNECTION_POLICY_LAYER_V4 = Guid.initString("103090d4-8e28-4fd6-9894-d1d67d6b10c9");
pub const FWPM_CALLOUT_OUTBOUND_NETWORK_CONNECTION_POLICY_LAYER_V6 = Guid.initString("4ed3446d-8dc7-459b-b09f-c1cb7a8f8689");
...
pub const IPSEC_SA_BUNDLE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IPSEC_SA_BUNDLE_FLAGS, @enumFromInt(
              (if (o.ND_SECURE == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ND_SECURE) else 0)
            | (if (o.ND_BOUNDARY == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ND_BOUNDARY) else 0)
            | (if (o.ND_PEER_NAT_BOUNDARY == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ND_PEER_NAT_BOUNDARY) else 0)
            | (if (o.GUARANTEE_ENCRYPTION == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.GUARANTEE_ENCRYPTION) else 0)
            | (if (o.ALLOW_NULL_TARGET_NAME_MATCH == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ALLOW_NULL_TARGET_NAME_MATCH) else 0)
            | (if (o.CLEAR_DF_ON_TUNNEL == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.CLEAR_DF_ON_TUNNEL) else 0)
            | (if (o.ASSUME_UDP_CONTEXT_OUTBOUND == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ASSUME_UDP_CONTEXT_OUTBOUND) else 0)
            | (if (o.ND_PEER_BOUNDARY == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.ND_PEER_BOUNDARY) else 0)
            | (if (o.SUPPRESS_DUPLICATE_DELETION == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.SUPPRESS_DUPLICATE_DELETION) else 0)
            | (if (o.PEER_SUPPORTS_GUARANTEE_ENCRYPTION == 1) @intFromEnum(IPSEC_SA_BUNDLE_FLAGS.PEER_SUPPORTS_GUARANTEE_ENCRYPTION) else 0)
        ));
    }
};
...
pub const IPSEC_POLICY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IPSEC_POLICY_FLAG, @enumFromInt(
              (if (o.ND_SECURE == 1) @intFromEnum(IPSEC_POLICY_FLAG.ND_SECURE) else 0)
            | (if (o.ND_BOUNDARY == 1) @intFromEnum(IPSEC_POLICY_FLAG.ND_BOUNDARY) else 0)
            | (if (o.NAT_ENCAP_ALLOW_PEER_BEHIND_NAT == 1) @intFromEnum(IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_PEER_BEHIND_NAT) else 0)
            | (if (o.NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL == 1) @intFromEnum(IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL) else 0)
            | (if (o.DONT_NEGOTIATE_SECOND_LIFETIME == 1) @intFromEnum(IPSEC_POLICY_FLAG.DONT_NEGOTIATE_SECOND_LIFETIME) else 0)
            | (if (o.DONT_NEGOTIATE_BYTE_LIFETIME == 1) @intFromEnum(IPSEC_POLICY_FLAG.DONT_NEGOTIATE_BYTE_LIFETIME) else 0)
            | (if (o.CLEAR_DF_ON_TUNNEL == 1) @intFromEnum(IPSEC_POLICY_FLAG.CLEAR_DF_ON_TUNNEL) else 0)
            | (if (o.ENABLE_V6_IN_V4_TUNNELING == 1) @intFromEnum(IPSEC_POLICY_FLAG.ENABLE_V6_IN_V4_TUNNELING) else 0)
            | (if (o.ENABLE_SERVER_ADDR_ASSIGNMENT == 1) @intFromEnum(IPSEC_POLICY_FLAG.ENABLE_SERVER_ADDR_ASSIGNMENT) else 0)
            | (if (o.TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION == 1) @intFromEnum(IPSEC_POLICY_FLAG.TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION) else 0)
            | (if (o.TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION == 1) @intFromEnum(IPSEC_POLICY_FLAG.TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION) else 0)
            | (if (o.TUNNEL_BYPASS_ICMPV6 == 1) @intFromEnum(IPSEC_POLICY_FLAG.TUNNEL_BYPASS_ICMPV6) else 0)
            | (if (o.KEY_MANAGER_ALLOW_DICTATE_KEY == 1) @intFromEnum(IPSEC_POLICY_FLAG.KEY_MANAGER_ALLOW_DICTATE_KEY) else 0)
        ));
    }
};
...
pub const IKEEXT_CERT_AUTH = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_CERT_AUTH, @enumFromInt(
              (if (o.FLAG_SSL_ONE_WAY == 1) @intFromEnum(IKEEXT_CERT_AUTH.FLAG_SSL_ONE_WAY) else 0)
            | (if (o.ENABLE_CRL_CHECK_STRONG == 1) @intFromEnum(IKEEXT_CERT_AUTH.ENABLE_CRL_CHECK_STRONG) else 0)
            | (if (o.DISABLE_SSL_CERT_VALIDATION == 1) @intFromEnum(IKEEXT_CERT_AUTH.DISABLE_SSL_CERT_VALIDATION) else 0)
            | (if (o.ALLOW_HTTP_CERT_LOOKUP == 1) @intFromEnum(IKEEXT_CERT_AUTH.ALLOW_HTTP_CERT_LOOKUP) else 0)
            | (if (o.URL_CONTAINS_BUNDLE == 1) @intFromEnum(IKEEXT_CERT_AUTH.URL_CONTAINS_BUNDLE) else 0)
        ));
    }
};
...
pub const IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS, @enumFromInt(
              (if (o.LOCAL_AUTH_ONLY == 1) @intFromEnum(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0)
            | (if (o.REMOTE_AUTH_ONLY == 1) @intFromEnum(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0)
        ));
    }
};
...
pub const IKEEXT_POLICY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_POLICY_FLAG, @enumFromInt(
              (if (o.DISABLE_DIAGNOSTICS == 1) @intFromEnum(IKEEXT_POLICY_FLAG.DISABLE_DIAGNOSTICS) else 0)
            | (if (o.NO_MACHINE_LUID_VERIFY == 1) @intFromEnum(IKEEXT_POLICY_FLAG.NO_MACHINE_LUID_VERIFY) else 0)
            | (if (o.NO_IMPERSONATION_LUID_VERIFY == 1) @intFromEnum(IKEEXT_POLICY_FLAG.NO_IMPERSONATION_LUID_VERIFY) else 0)
            | (if (o.ENABLE_OPTIONAL_DH == 1) @intFromEnum(IKEEXT_POLICY_FLAG.ENABLE_OPTIONAL_DH) else 0)
        ));
    }
};
...
pub const IKEEXT_CERT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_CERT_FLAGS, @enumFromInt(
              (if (o.ENABLE_ACCOUNT_MAPPING == 1) @intFromEnum(IKEEXT_CERT_FLAGS.ENABLE_ACCOUNT_MAPPING) else 0)
            | (if (o.DISABLE_REQUEST_PAYLOAD == 1) @intFromEnum(IKEEXT_CERT_FLAGS.DISABLE_REQUEST_PAYLOAD) else 0)
            | (if (o.USE_NAP_CERTIFICATE == 1) @intFromEnum(IKEEXT_CERT_FLAGS.USE_NAP_CERTIFICATE) else 0)
            | (if (o.INTERMEDIATE_CA == 1) @intFromEnum(IKEEXT_CERT_FLAGS.INTERMEDIATE_CA) else 0)
            | (if (o.IGNORE_INIT_CERT_MAP_FAILURE == 1) @intFromEnum(IKEEXT_CERT_FLAGS.IGNORE_INIT_CERT_MAP_FAILURE) else 0)
            | (if (o.PREFER_NAP_CERTIFICATE_OUTBOUND == 1) @intFromEnum(IKEEXT_CERT_FLAGS.PREFER_NAP_CERTIFICATE_OUTBOUND) else 0)
            | (if (o.SELECT_NAP_CERTIFICATE == 1) @intFromEnum(IKEEXT_CERT_FLAGS.SELECT_NAP_CERTIFICATE) else 0)
            | (if (o.VERIFY_NAP_CERTIFICATE == 1) @intFromEnum(IKEEXT_CERT_FLAGS.VERIFY_NAP_CERTIFICATE) else 0)
            | (if (o.FOLLOW_RENEWAL_CERTIFICATE == 1) @intFromEnum(IKEEXT_CERT_FLAGS.FOLLOW_RENEWAL_CERTIFICATE) else 0)
        ));
    }
};
...
pub const IPSEC_DOSP_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IPSEC_DOSP_FLAGS, @enumFromInt(
              (if (o.ENABLE_IKEV1 == 1) @intFromEnum(IPSEC_DOSP_FLAGS.ENABLE_IKEV1) else 0)
            | (if (o.ENABLE_IKEV2 == 1) @intFromEnum(IPSEC_DOSP_FLAGS.ENABLE_IKEV2) else 0)
            | (if (o.DISABLE_AUTHIP == 1) @intFromEnum(IPSEC_DOSP_FLAGS.DISABLE_AUTHIP) else 0)
            | (if (o.DISABLE_DEFAULT_BLOCK == 1) @intFromEnum(IPSEC_DOSP_FLAGS.DISABLE_DEFAULT_BLOCK) else 0)
            | (if (o.FILTER_BLOCK == 1) @intFromEnum(IPSEC_DOSP_FLAGS.FILTER_BLOCK) else 0)
            | (if (o.FILTER_EXEMPT == 1) @intFromEnum(IPSEC_DOSP_FLAGS.FILTER_EXEMPT) else 0)
        ));
    }
};
...
pub const IKEEXT_KERBEROS_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_KERBEROS_AUTHENTICATION_FLAGS, @enumFromInt(
              (if (o.ISABLE_INITIATOR_TOKEN_GENERATION == 1) @intFromEnum(IKEEXT_KERBEROS_AUTHENTICATION_FLAGS.ISABLE_INITIATOR_TOKEN_GENERATION) else 0)
            | (if (o.ONT_ACCEPT_EXPLICIT_CREDENTIALS == 1) @intFromEnum(IKEEXT_KERBEROS_AUTHENTICATION_FLAGS.ONT_ACCEPT_EXPLICIT_CREDENTIALS) else 0)
        ));
    }
};
...
pub const IKEEXT_RESERVED_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_RESERVED_AUTHENTICATION_FLAGS, @enumFromInt(
              (if (o.N == 1) @intFromEnum(IKEEXT_RESERVED_AUTHENTICATION_FLAGS.N) else 0)
        ));
    }
};
...
pub const IKEEXT_EAP_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_EAP_AUTHENTICATION_FLAGS, @enumFromInt(
              (if (o.LOCAL_AUTH_ONLY == 1) @intFromEnum(IKEEXT_EAP_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0)
            | (if (o.REMOTE_AUTH_ONLY == 1) @intFromEnum(IKEEXT_EAP_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0)
        ));
    }
};
...
pub const FWPM_FILTER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FWPM_FILTER_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(FWPM_FILTER_FLAGS.NONE) else 0)
            | (if (o.PERSISTENT == 1) @intFromEnum(FWPM_FILTER_FLAGS.PERSISTENT) else 0)
            | (if (o.BOOTTIME == 1) @intFromEnum(FWPM_FILTER_FLAGS.BOOTTIME) else 0)
            | (if (o.HAS_PROVIDER_CONTEXT == 1) @intFromEnum(FWPM_FILTER_FLAGS.HAS_PROVIDER_CONTEXT) else 0)
            | (if (o.CLEAR_ACTION_RIGHT == 1) @intFromEnum(FWPM_FILTER_FLAGS.CLEAR_ACTION_RIGHT) else 0)
            | (if (o.PERMIT_IF_CALLOUT_UNREGISTERED == 1) @intFromEnum(FWPM_FILTER_FLAGS.PERMIT_IF_CALLOUT_UNREGISTERED) else 0)
            | (if (o.DISABLED == 1) @intFromEnum(FWPM_FILTER_FLAGS.DISABLED) else 0)
            | (if (o.INDEXED == 1) @intFromEnum(FWPM_FILTER_FLAGS.INDEXED) else 0)
        ));
    }
};
...
pub const FWP_ACTION_TYPE = enum(u32) {
    BLOCK = 4097,
    PERMIT = 4098,
    CALLOUT_TERMINATING = 20483,
    CALLOUT_INSPECTION = 24580,
    CALLOUT_UNKNOWN = 16389,
    CONTINUE = 8198,
    NONE = 7,
    NONE_NO_MATCH = 8,
};
pub const FWP_ACTION_BLOCK = FWP_ACTION_TYPE.BLOCK;
pub const FWP_ACTION_PERMIT = FWP_ACTION_TYPE.PERMIT;
pub const FWP_ACTION_CALLOUT_TERMINATING = FWP_ACTION_TYPE.CALLOUT_TERMINATING;
pub const FWP_ACTION_CALLOUT_INSPECTION = FWP_ACTION_TYPE.CALLOUT_INSPECTION;
pub const FWP_ACTION_CALLOUT_UNKNOWN = FWP_ACTION_TYPE.CALLOUT_UNKNOWN;
pub const FWP_ACTION_CONTINUE = FWP_ACTION_TYPE.CONTINUE;
pub const FWP_ACTION_NONE = FWP_ACTION_TYPE.NONE;
pub const FWP_ACTION_NONE_NO_MATCH = FWP_ACTION_TYPE.NONE_NO_MATCH;
...
pub const FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE = enum(i32) {
    SOURCE_ADDRESS = 0,
    NEXT_HOP_INTERFACE = 1,
    NEXT_HOP = 2,
    MAX = 3,
};
pub const FWP_NETWORK_CONNECTION_POLICY_SOURCE_ADDRESS = FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE.SOURCE_ADDRESS;
pub const FWP_NETWORK_CONNECTION_POLICY_NEXT_HOP_INTERFACE = FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE.NEXT_HOP_INTERFACE;
pub const FWP_NETWORK_CONNECTION_POLICY_NEXT_HOP = FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE.NEXT_HOP;
pub const FWP_NETWORK_CONNECTION_POLICY_MAX = FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE.MAX;
...
pub const FWPM_PROVIDER_CONTEXT_TYPE = enum(i32) {
    ...
    NETWORK_CONNECTION_POLICY_CONTEXT = 13,
    PROVIDER_CONTEXT_TYPE_MAX = 14,
};
...
pub const FWPM_NETWORK_CONNECTION_POLICY_CONTEXT = FWPM_PROVIDER_CONTEXT_TYPE.NETWORK_CONNECTION_POLICY_CONTEXT;
