...
pub const RasCustomScriptExecuteFn = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hPort: ?HANDLE,
        lpszPhonebook: ?[*:0]align(1) const u16,
        lpszEntryName: ?[*:0]align(1) const u16,
...
pub extern "rasapi32" fn RasGetEapUserDataA(
    hToken: ?HANDLE,
    pszPhonebook: ?[*:0]align(1) const u8,
    pszEntry: ?[*:0]align(1) const u8,
    pbEapData: ?*u8,
...
pub extern "rasapi32" fn RasGetEapUserDataW(
    hToken: ?HANDLE,
    pszPhonebook: ?[*:0]align(1) const u16,
    pszEntry: ?[*:0]align(1) const u16,
    pbEapData: ?*u8,
    pdwSizeofEapData: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "mprapi" fn MprAdminUserGetInfo(
    lpszServer: ?[*:0]align(1) const u16,
    lpszUser: ?[*:0]align(1) const u16,
    dwLevel: u32,
    lpbBuffer: ?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
const MIB_IPMCAST_MFE = @import("../../../windows/win32/network_management/ip_helper.zig").MIB_IPMCAST_MFE;
