...
pub const SCC_DEFAULT = @as(u32, 0);
pub const SCC_CAN_CREATE_WITHOUT_UI = @as(u32, 1);
pub const SCC_CAN_MODIFY_WITHOUT_UI = @as(u32, 2);
pub const SCC_CREATE_NOT_SUPPORTED = @as(u32, 4);
pub const SCC_MODIFY_NOT_SUPPORTED = @as(u32, 8);
pub const SPC_DEFAULT = @as(u32, 0);
pub const SYNC_PROVIDER_STATE_ENABLED = @as(u32, 1);
pub const SYNC_PROVIDER_STATE_DIRTY = @as(u32, 2);
pub const SYNC_PROVIDER_CONFIGURATION_VERSION = @as(u32, 1);
pub const SYNC_PROVIDER_CONFIGUI_CONFIGURATION_VERSION = @as(u32, 1);
pub const SYNC_32_BIT_SUPPORTED = @as(u32, 1);
pub const SYNC_64_BIT_SUPPORTED = @as(u32, 2);
pub const PKEY_PROVIDER_INSTANCEID = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 2 };
pub const PKEY_PROVIDER_CLSID = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 3 };
pub const PKEY_PROVIDER_CONFIGUI = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 4 };
pub const PKEY_PROVIDER_CONTENTTYPE = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 5 };
pub const PKEY_PROVIDER_CAPABILITIES = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 6 };
pub const PKEY_PROVIDER_SUPPORTED_ARCHITECTURE = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 7 };
pub const PKEY_PROVIDER_NAME = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 8 };
pub const PKEY_PROVIDER_DESCRIPTION = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 9 };
pub const PKEY_PROVIDER_TOOLTIPS = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 10 };
pub const PKEY_PROVIDER_ICON = PROPERTYKEY { .fmtid = Guid.initIntString("2216140385, 24822, 19484, 136, 237, 241, 197, 49, 179, 43, 218"), .pid = 11 };
pub const PKEY_CONFIGUI_INSTANCEID = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 2 };
pub const PKEY_CONFIGUI_CLSID = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 3 };
pub const PKEY_CONFIGUI_CONTENTTYPE = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 4 };
pub const PKEY_CONFIGUI_CAPABILITIES = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 5 };
pub const PKEY_CONFIGUI_SUPPORTED_ARCHITECTURE = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 6 };
pub const PKEY_CONFIGUI_IS_GLOBAL = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 7 };
pub const PKEY_CONFIGUI_NAME = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 8 };
pub const PKEY_CONFIGUI_DESCRIPTION = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 9 };
pub const PKEY_CONFIGUI_TOOLTIPS = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 10 };
pub const PKEY_CONFIGUI_ICON = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 11 };
pub const PKEY_CONFIGUI_MENUITEM_NOUI = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 12 };
pub const PKEY_CONFIGUI_MENUITEM = PROPERTYKEY { .fmtid = Guid.initIntString("1430988010, 59619, 17850, 147, 82, 223, 181, 97, 225, 113, 228"), .pid = 13 };
...
pub const IRecoverableErrorData = extern struct {
    pub const VTable = extern struct {
        ...
        Initialize: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pcszItemDisplayName: ?[*:0]align(1) const u16,
                pcszErrorDescription: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IRecoverableErrorData,
                pcszItemDisplayName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRecoverableErrorData_Initialize(self: *const T, pcszItemDisplayName: ?[*:0]align(1) const u16, pcszErrorDescription: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
