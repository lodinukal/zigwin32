...
pub const WDS_TRANSPORTCLIENT_REQUEST = extern struct {
    ...
    pwszServer: ?[*:0]align(1) const u16,
    pwszNamespace: ?[*:0]align(1) const u16,
...
pub const IWdsTransportCacheable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IWdsTransportCacheable_get_Dirty(self: *const T, pbDirty: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWdsTransportConfigurationManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportConfigurationManager_get_WdsTransportServicesRunning(self: *const T, bRealtimeStatus: VARIANT_BOOL, pbServicesRunning: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWdsTransportNamespaceManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportNamespaceManager_RetrieveNamespaces(self: *const T, bszContentProvider: ?BSTR, bszNamespaceName: ?BSTR, bIncludeTombstones: VARIANT_BOOL, ppWdsTransportNamespaces: ?*?*IWdsTransportCollection) callconv(.Inline) HRESULT {
...
pub const IWdsTransportServicePolicy2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportServicePolicy2_get_EnableTftpVariableWindowExtension(self: *const T, pbEnableTftpVariableWindowExtension: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportServicePolicy2_put_EnableTftpVariableWindowExtension(self: *const T, bEnableTftpVariableWindowExtension: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWdsTransportDiagnosticsPolicy = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IWdsTransportCacheable.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportDiagnosticsPolicy_get_Enabled(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportDiagnosticsPolicy_put_Enabled(self: *const T, bEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWdsTransportMulticastSessionPolicy = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportMulticastSessionPolicy_get_SlowClientFallback(self: *const T, pbClientFallback: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportMulticastSessionPolicy_put_SlowClientFallback(self: *const T, bClientFallback: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWdsTransportNamespace = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportNamespace_get_Registered(self: *const T, pbRegistered: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportNamespace_get_Tombstoned(self: *const T, pbTombstoned: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportNamespace_get_TransmissionStarted(self: *const T, pbTransmissionStarted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWdsTransportNamespace_Deregister(self: *const T, bTerminateSessions: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "wdsclientapi" fn WdsCliTransferFile(
    pwszServer: ?[*:0]align(1) const u16,
    pwszNamespace: ?[*:0]align(1) const u16,
    pwszRemoteFilePath: ?[*:0]align(1) const u16,
    pwszLocalFilePath: ?[*:0]align(1) const u16,
    dwFlags: u32,
    dwReserved: u32,
    pfnWdsCliCallback: ?PFN_WdsCliCallback,
    pvUserData: ?*anyopaque,
...
pub extern "wdspxe" fn PxeProviderRegister(
    ...
    pszModulePath: ?[*:0]align(1) const u16,
    Index: u32,
    bIsCritical: BOOL,
    phProviderKey: ?*?HKEY,
