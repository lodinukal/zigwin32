...
pub const ICastingEventHandler = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICastingEventHandler_OnError(self: *const T, errorStatus: CASTING_CONNECTION_ERROR_STATUS, errorMessage: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const PFNGETACTIVATIONFACTORY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: ?HSTRING,
        param1: ?*?*IActivationFactory,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    else => *const fn(
        param0: ?HSTRING,
        param1: ?*?*IActivationFactory,
...
pub const RO_ERROR_REPORTING_FLAGS = enum(i32) {
    NONE = 0,
...
pub extern "api-ms-win-core-winrt-l1-1-0" fn RoRegisterActivationFactories(
    ...
    activationFactoryCallbacks: [*]?PFNGETACTIVATIONFACTORY,
    count: u32,
...
const IMarshal = @import("../../../windows/win32/system/com/marshal.zig").IMarshal;
const INamedPropertyStore = @import("../../../windows/win32/ui/shell/properties_system.zig").INamedPropertyStore;
...
test {
    ...
    if (@hasDecl(@This(), "PFNGETACTIVATIONFACTORY")) { _ = PFNGETACTIVATIONFACTORY; }
...
pub const metadata = @import("win_rt/metadata.zig");
