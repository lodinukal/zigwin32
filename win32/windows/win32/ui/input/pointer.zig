...
pub const POINTER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(POINTER_FLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(POINTER_FLAGS.NONE) else 0)
            | (if (o.NEW == 1) @intFromEnum(POINTER_FLAGS.NEW) else 0)
            | (if (o.INRANGE == 1) @intFromEnum(POINTER_FLAGS.INRANGE) else 0)
            | (if (o.INCONTACT == 1) @intFromEnum(POINTER_FLAGS.INCONTACT) else 0)
            | (if (o.FIRSTBUTTON == 1) @intFromEnum(POINTER_FLAGS.FIRSTBUTTON) else 0)
            | (if (o.SECONDBUTTON == 1) @intFromEnum(POINTER_FLAGS.SECONDBUTTON) else 0)
            | (if (o.THIRDBUTTON == 1) @intFromEnum(POINTER_FLAGS.THIRDBUTTON) else 0)
            | (if (o.FOURTHBUTTON == 1) @intFromEnum(POINTER_FLAGS.FOURTHBUTTON) else 0)
            | (if (o.FIFTHBUTTON == 1) @intFromEnum(POINTER_FLAGS.FIFTHBUTTON) else 0)
            | (if (o.PRIMARY == 1) @intFromEnum(POINTER_FLAGS.PRIMARY) else 0)
            | (if (o.CONFIDENCE == 1) @intFromEnum(POINTER_FLAGS.CONFIDENCE) else 0)
            | (if (o.CANCELED == 1) @intFromEnum(POINTER_FLAGS.CANCELED) else 0)
            | (if (o.DOWN == 1) @intFromEnum(POINTER_FLAGS.DOWN) else 0)
            | (if (o.UPDATE == 1) @intFromEnum(POINTER_FLAGS.UPDATE) else 0)
            | (if (o.UP == 1) @intFromEnum(POINTER_FLAGS.UP) else 0)
            | (if (o.WHEEL == 1) @intFromEnum(POINTER_FLAGS.WHEEL) else 0)
            | (if (o.HWHEEL == 1) @intFromEnum(POINTER_FLAGS.HWHEEL) else 0)
            | (if (o.CAPTURECHANGED == 1) @intFromEnum(POINTER_FLAGS.CAPTURECHANGED) else 0)
            | (if (o.HASTRANSFORM == 1) @intFromEnum(POINTER_FLAGS.HASTRANSFORM) else 0)
        ));
    }
};
...
const HSYNTHETICPOINTERDEVICE = @import("../../../../windows/win32/ui/controls.zig").HSYNTHETICPOINTERDEVICE;
const HWND = @import("../../../../windows/win32/foundation.zig").HWND;
const POINT = @import("../../../../windows/win32/foundation.zig").POINT;
const POINTER_DEVICE_CURSOR_INFO = @import("../../../../windows/win32/ui/controls.zig").POINTER_DEVICE_CURSOR_INFO;
const POINTER_DEVICE_INFO = @import("../../../../windows/win32/ui/controls.zig").POINTER_DEVICE_INFO;
const POINTER_DEVICE_PROPERTY = @import("../../../../windows/win32/ui/controls.zig").POINTER_DEVICE_PROPERTY;
const POINTER_INPUT_TYPE = @import("../../../../windows/win32/ui/windows_and_messaging.zig").POINTER_INPUT_TYPE;
const POINTER_TYPE_INFO = @import("../../../../windows/win32/ui/controls.zig").POINTER_TYPE_INFO;
