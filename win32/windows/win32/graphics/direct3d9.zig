...
//--------------------------------------------------------------------------------
// Section: Constants (694)
//--------------------------------------------------------------------------------
pub const D3DRTYPECOUNT = @as(u32, 8);
pub const DIRECT3D_VERSION = @as(u32, 2304);
...
pub const D3DFVF_POSITION_MASK = @as(u32, 16398);
...
pub const D3DFVF_RESERVED2 = @as(u32, 24576);
...
pub const D3DSTENCILOP = enum(i32) {
    KEEP = 1,
    ZERO = 2,
    REPLACE = 3,
    INCRSAT = 4,
...
pub const D3DSWAPEFFECT = enum(i32) {
    DISCARD = 1,
    FLIP = 2,
    COPY = 3,
    OVERLAY = 4,
...
pub const D3DBACKBUFFER_TYPE = enum(i32) {
    MONO = 0,
    LEFT = 1,
    RIGHT = 2,
};
...
pub const LPD3DVALIDATECALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpUserArg: ?*anyopaque,
        dwOffset: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
...
pub const LPD3DENUMTEXTUREFORMATSCALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
...
pub const LPD3DENUMPIXELFORMATSCALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
...
pub const LPD3DENUMDEVICESCALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpGuid: ?*Guid,
        lpDeviceDescription: ?PSTR,
        lpDeviceName: ?PSTR,
        param3: ?*D3DDEVICEDESC,
        param4: ?*D3DDEVICEDESC,
        param5: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    else => *const fn(
        lpGuid: ?*Guid,
...
pub const LPD3DENUMDEVICESCALLBACK7 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpDeviceDescription: ?PSTR,
        lpDeviceName: ?PSTR,
        param2: ?*D3DDEVICEDESC7,
        param3: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    else => *const fn(
        lpDeviceDescription: ?PSTR,
...
pub const D3DPRESENTSTATS = switch(@import("../../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        ...
        SyncQPCTime: i64 align(4),
        SyncGPUTime: i64 align(4),
    },
};
...
const D3DVECTOR = @import("../../../windows/win32/graphics/direct3d.zig").D3DVECTOR;
