...
pub const NI_UPGRADE_VERSION = @as(u32, 2);
...
pub const CLUSAPI_VERSION_NI = @as(u32, 2572);
pub const CLUSAPI_VERSION = @as(u32, 2572);
...
pub const CLUSAPI_NODE_RESUME_FAILBACK_STORAGE = @as(u32, 1);
pub const CLUSAPI_NODE_RESUME_FAILBACK_VMS = @as(u32, 2);
pub const CLUSAPI_NODE_RESUME_FAILBACK_PINNED_VMS_ONLY = @as(u32, 4);
...
pub const CLUSREG_NAME_NODE_UNIQUEID = "UniqueID";
...
pub const CLUSREG_NAME_FILESHR_QOS_FLOWSCOPE = "QosFlowScope";
pub const CLUSREG_NAME_FILESHR_QOS_POLICYID = "QosPolicyId";
...
pub const CLUSRES_DISABLE_WPR_WATCHDOG_FOR_ONLINE_CALLS = @as(u32, 1);
pub const CLUSRES_DISABLE_WPR_WATCHDOG_FOR_OFFLINE_CALLS = @as(u32, 2);
...
pub const CLUSTER_READ_BATCH_COMMAND = extern struct {
    Command: CLUSTER_REG_COMMAND,
    dwOptions: u32,
    wzSubkeyName: ?[*:0]align(1) const u16,
    wzValueName: ?[*:0]align(1) const u16,
    lpData: ?*const u8,
    cbData: u32,
};
...
pub const CLUSTER_IP_ENTRY = extern struct {
    lpszIpAddress: ?[*:0]align(1) const u16,
    dwPrefixLength: u32,
};

pub const CREATE_CLUSTER_CONFIG = extern struct {
    dwVersion: u32,
    lpszClusterName: ?[*:0]align(1) const u16,
    cNodes: u32,
    ppszNodeNames: ?*const ?PWSTR,
    cIpEntries: u32,
...
pub const CREATE_CLUSTER_NAME_ACCOUNT = extern struct {
    ...
    pszPassword: ?[*:0]align(1) const u16,
    pszDomain: ?[*:0]align(1) const u16,
    managementPointType: CLUSTER_MGMT_POINT_TYPE,
    managementPointResType: CLUSTER_MGMT_POINT_RESTYPE,
    bUpgradeVCOs: BOOLEAN,
};

pub const PCLUSAPI_PFN_REASON_HANDLER = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
...
pub const PCLUSAPI_SET_REASON_HANDLER = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpHandler: ?*CLUSAPI_REASON_HANDLER,
    ) callconv(@import("std").os.windows.WINAPI) ?*CLUSAPI_REASON_HANDLER,
    else => *const fn(
        lpHandler: ?*CLUSAPI_REASON_HANDLER,
    ) callconv(@import("std").os.windows.WINAPI) ?*CLUSAPI_REASON_HANDLER,
} ;
...
pub const PCLUSAPI_GET_NODE_CLUSTER_STATE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszNodeName: ?[*:0]align(1) const u16,
        pdwClusterState: ?*u32,
...
pub const PCLUSAPI_OPEN_CLUSTER = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszClusterName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSTER,
    else => *const fn(
        lpszClusterName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSTER,
} ;
...
pub const PCLUSAPI_SetClusterName = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszNewClusterName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszNewClusterName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_CLUSTER_NAME_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszNewClusterName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszNewClusterName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        lpszDeviceName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_BACKUP_CLUSTER_DATABASE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszPathName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszPathName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_RESTORE_CLUSTER_DATABASE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszPathName: ?[*:0]align(1) const u16,
        bForce: BOOL,
        lpszQuorumDriveLetter: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        lpszPathName: ?[*:0]align(1) const u16,
        bForce: BOOL,
...
pub const PCLUSAPI_SET_CLUSTER_SERVICE_ACCOUNT_PASSWORD = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszClusterName: ?[*:0]align(1) const u16,
        lpszNewPassword: ?[*:0]align(1) const u16,
        dwFlags: u32,
...
pub const PCLUSAPI_CLUSTER_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const CLUSTER_OBJECT_TYPE_FAULTDOMAIN = CLUSTER_OBJECT_TYPE.FAULTDOMAIN;
...
pub const PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT_V2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        dwFilterCount: u32,
        dwNotifyKey: usize,
    ) callconv(@import("std").os.windows.WINAPI) HCHANGE,
    else => *const fn(
        hChange: HCHANGE,
        hCluster: HCLUSTER,
        Filters: ?*NOTIFY_FILTER_AND_TYPE,
...
pub const PCLUSAPI_CLUSTER_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSENUM,
    else => *const fn(
        hCluster: HCLUSTER,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSENUM,
...
pub const PCLUSAPI_CLUSTER_OPEN_ENUM_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        dwType: u32,
        pOptions: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSENUMEX,
    else => *const fn(
        hCluster: HCLUSTER,
        dwType: u32,
        pOptions: ?*anyopaque,
...
pub const PCLUSAPI_CREATE_CLUSTER_GROUP_GROUPSET = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszGroupSetName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HGROUPSET,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszGroupSetName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HGROUPSET,
...
pub const PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUPSET_WITH_DOMAINS_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        hGroup: HGROUP,
        faultDomain: u32,
...
pub const PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
...
pub const PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hDependentGroup: HGROUP,
        hProviderGroup: HGROUP,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUP,
        lpszDependencyExpression: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hGroupSet: HGROUP,
        lpszDependencyExpression: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszDependencyExpression: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        hDependsOn: HGROUP,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hDependentGroupSet: HGROUPSET,
        hProviderGroupSet: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        lpszDependencyExpression: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroupSet: HGROUPSET,
        hDependsOn: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hDependentGroup: HGROUP,
        hProviderGroupSet: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        hDependsOn: HGROUPSET,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_ADD_CROSS_CLUSTER_GROUPSET_DEPENDENCY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hDependentGroupSet: HGROUPSET,
        lpRemoteClusterName: ?[*:0]align(1) const u16,
        lpRemoteGroupSetName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hDependentGroupSet: HGROUPSET,
        lpRemoteClusterName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CREATE_CLUSTER_AVAILABILITY_SET = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpAvailabilitySetName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_AFFINITY_RULE_CONTROL = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        affinityRuleName: ?[*:0]align(1) const u16,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_OPEN_CLUSTER_NODE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszNodeName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNODE,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszNodeName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNODE,
...
pub const PCLUSAPI_CLUSTER_NODE_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNode: HNODE,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HNODEENUM,
    else => *const fn(
        hNode: HNODE,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HNODEENUM,
...
pub const PCLUSAPI_CLUSTER_NODE_OPEN_ENUM_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        dwType: u32,
        pOptions: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) HNODEENUMEX,
    else => *const fn(
        hNode: HNODE,
        dwType: u32,
        pOptions: ?*anyopaque,
...
pub const PCLUSAPI_EVICT_CLUSTER_NODE_EX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNode: HNODE,
        dwTimeout: u32,
        phrCleanupStatus: ?*HRESULT,
...
pub const PCLUSAPI_GET_CLUSTER_RESOURCE_TYPE_KEY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszTypeName: ?[*:0]align(1) const u16,
        samDesired: u32,
...
pub const PCLUSAPI_CREATE_CLUSTER_GROUP = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszGroupName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HGROUP,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszGroupName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HGROUP,
...
pub const PCLUSAPI_PAUSE_CLUSTER_NODE_EX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNode: HNODE,
        bDrainNode: BOOL,
        dwPauseFlags: u32,
...
pub const PCLUSAPI_RESUME_CLUSTER_NODE_EX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNode: HNODE,
        eResumeFailbackType: CLUSTER_NODE_RESUME_FAILBACK_TYPE,
        dwResumeFlagsReserved: u32,
...
pub const PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        lpszProperties: ?[*:0]align(1) const u16,
        cbProperties: u32,
        // TODO: what to do with BytesParamIndex 4?
        lpszRoProperties: ?[*:0]align(1) const u16,
        cbRoProperties: u32,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HGROUPENUMEX,
    else => *const fn(
        hCluster: HCLUSTER,
        // TODO: what to do with BytesParamIndex 2?
        lpszProperties: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_OPEN_ENUM_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        cbRoProperties: u32,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESENUMEX,
    else => *const fn(
        hCluster: HCLUSTER,
        // TODO: what to do with BytesParamIndex 2?
        lpszProperties: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_RESTART_CLUSTER_RESOURCE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszGroupName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        NodeCount: u32,
        NodeList: ?[*]HNODE,
...
pub const PCLUSAPI_DELETE_CLUSTER_GROUP_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_DESTROY_CLUSTER_GROUP_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HGROUPENUM,
    else => *const fn(
        hGroup: HGROUP,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HGROUPENUM,
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszResourceName: ?[*:0]align(1) const u16,
        lpszResourceType: ?[*:0]align(1) const u16,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESOURCE,
    else => *const fn(
        hGroup: HGROUP,
        lpszResourceName: ?[*:0]align(1) const u16,
        lpszResourceType: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        lpszResourceName: ?[*:0]align(1) const u16,
        lpszResourceType: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_DELETE_CLUSTER_RESOURCE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        lpszResourceName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        lpszReason: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hGroup: HGROUP,
        Flags: u64,
...
pub const PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hNode: HNODE,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hNode: HNODE,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hDependsOn: HRESOURCE,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hDependsOn: HRESOURCE,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        hHostNode: HNODE,
        dwControlCode: u32,
        // TODO: what to do with BytesParamIndex 5?
        lpInBuffer: ?*anyopaque,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_CONTROL_AS_USER_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        hHostNode: HNODE,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        hHostNode: HNODE,
...
pub const PCLUSAPI_CLUSTER_GROUP_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hGroup: HGROUP,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_CLUSTER_NODE_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNode: HNODE,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const CLCTL_CODES = enum(i32) {
    ...
    LCTL_CHECK_VOTER_EVICT_WITNESS = 109,
    LCTL_CHECK_VOTER_DOWN_WITNESS = 113,
...
pub const CLCTL_CHECK_VOTER_EVICT_WITNESS = CLCTL_CODES.LCTL_CHECK_VOTER_EVICT_WITNESS;
pub const CLCTL_CHECK_VOTER_DOWN_WITNESS = CLCTL_CODES.LCTL_CHECK_VOTER_DOWN_WITNESS;
...
pub const CLUSCTL_CLUSTER_CODES = enum(i32) {
    ...
    CHECK_VOTER_EVICT_WITNESS = 117440621,
    CHECK_VOTER_DOWN_WITNESS = 117440625,
};
...
pub const CLUSCTL_CLUSTER_CHECK_VOTER_EVICT_WITNESS = CLUSCTL_CLUSTER_CODES.CHECK_VOTER_EVICT_WITNESS;
pub const CLUSCTL_CLUSTER_CHECK_VOTER_DOWN_WITNESS = CLUSCTL_CLUSTER_CODES.CHECK_VOTER_DOWN_WITNESS;
...
pub const PCLUSAPI_CLUSTER_RESOURCE_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hResource: HRESOURCE,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESENUM,
    else => *const fn(
        hResource: HRESOURCE,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESENUM,
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        lpszDisplayName: ?[*:0]align(1) const u16,
        lpszResourceTypeDll: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        lpszDisplayName: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszTypeName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_TYPE_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESTYPEENUM,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszResourceTypeName: ?[*:0]align(1) const u16,
        dwType: u32,
...
pub const PCLUSAPI_OPEN_CLUSTER_NETWORK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszNetworkName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNETWORK,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszNetworkName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNETWORK,
...
pub const PCLUSAPI_CLUSTER_NETWORK_OPEN_ENUM = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNetwork: HNETWORK,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HNETWORKENUM,
    else => *const fn(
        hNetwork: HNETWORK,
        dwType: u32,
    ) callconv(@import("std").os.windows.WINAPI) HNETWORKENUM,
...
pub const PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNetwork: HNETWORK,
        lpszName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_NETWORK_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNetwork: HNETWORK,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_OPEN_CLUSTER_NET_INTERFACE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszInterfaceName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNETINTERFACE,
    else => *const fn(
        hCluster: HCLUSTER,
        lpszInterfaceName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) HNETINTERFACE,
...
pub const PCLUSAPI_OPEN_CLUSTER_NETINTERFACE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        lpszNetInterfaceName: ?[*:0]align(1) const u16,
        dwDesiredAccess: u32,
        lpdwGrantedAccess: ?*u32,
    ) callconv(@import("std").os.windows.WINAPI) HNETINTERFACE,
    else => *const fn(
...
pub const PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hNetInterface: HNETINTERFACE,
        hHostNode: HNODE,
        dwControlCode: u32,
...
pub const PCLUSAPI_CLUSTER_REG_CREATE_KEY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        lpszSubKey: ?[*:0]align(1) const u16,
        dwOptions: u32,
        samDesired: u32,
...
pub const PCLUSAPI_CLUSTER_REG_CREATE_KEY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        lpszSubKey: ?[*:0]align(1) const u16,
        dwOptions: u32,
...
pub const PCLUSAPI_CLUSTER_REG_DELETE_KEY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
...
pub const PCLUSAPI_CLUSTER_REG_SET_VALUE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        lpszValueName: ?[*:0]align(1) const u16,
        dwType: u32,
        lpData: ?*const u8,
        cbData: u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PCLUSAPI_CLUSTER_REG_SET_VALUE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        lpszValueName: ?[*:0]align(1) const u16,
        dwType: u32,
...
pub const PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        lpszValueName: ?[*:0]align(1) const u16,
        lpszReason: ?[*:0]align(1) const u16,
...
pub const PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        SecurityInformation: u32,
        pSecurityDescriptor: ?PSECURITY_DESCRIPTOR,
...
pub const PCLUSTER_REG_CREATE_BATCH_NOTIFY_PORT = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hKey: ?HKEY,
        phBatchNotifyPort: ?*HREGBATCHPORT,
    ) callconv(@import("std").os.windows.WINAPI) i32,
    else => *const fn(
        hKey: ?HKEY,
        phBatchNotifyPort: ?*HREGBATCHPORT,
...
pub const PCLUSTER_REG_CLOSE_READ_BATCH = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hRegReadBatch: HREGREADBATCH,
        phRegReadBatchReply: ?*HREGREADBATCHREPLY,
    ) callconv(@import("std").os.windows.WINAPI) i32,
    else => *const fn(
        hRegReadBatch: HREGREADBATCH,
        phRegReadBatchReply: ?*HREGREADBATCHREPLY,
...
pub const PCLUSTER_SET_ACCOUNT_ACCESS = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        szAccountSID: ?[*:0]align(1) const u16,
        dwAccess: u32,
        dwControlType: u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
...
pub const PCLUSTER_SETUP_PROGRESS_CALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        lpszObjectName: ?[*:0]align(1) const u16,
        dwStatus: u32,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
    else => *const fn(
        pvCallbackArg: ?*anyopaque,
...
pub const PLOG_EVENT_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceHandle: isize,
        LogLevel: LOG_LEVEL,
        FormatString: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) void,
    else => *const fn(
        ResourceHandle: isize,
        LogLevel: LOG_LEVEL,
...
pub const POPEN_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceName: ?[*:0]align(1) const u16,
        ResourceKey: ?HKEY,
        ResourceHandle: isize,
...
pub const PRESOURCE_TYPE_CONTROL_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceTypeName: ?[*:0]align(1) const u16,
        ControlCode: u32,
        InBuffer: ?*anyopaque,
        InBufferSize: u32,
        OutBuffer: ?*anyopaque,
...
pub const POFFLINE_V2_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        Resource: ?*anyopaque,
        DestinationNodeName: ?[*:0]align(1) const u16,
        OfflineFlags: u32,
        // TODO: what to do with BytesParamIndex 4?
        InBuffer: ?*u8,
        InBufferSize: u32,
...
pub const PSTARTUP_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceType: ?[*:0]align(1) const u16,
...
pub const PCHANGE_RESOURCE_PROCESS_FOR_DUMPS = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        resource: isize,
        processName: ?[*:0]align(1) const u16,
        processId: u32,
        isAdd: BOOL,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
...
pub const PSET_RESOURCE_WPR_POLICY_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceHandle: isize,
        WprPolicyFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PARM_WPR_WATCHDOG_FOR_CURRENT_RESOURCE_CALL_ROUTINE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ResourceHandle: isize,
        TimeoutInMs: u64,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PRESUTIL_START_RESOURCE_SERVICE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszServiceName: ?[*:0]align(1) const u16,
        phServiceHandle: ?*SC_HANDLE,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        pszServiceName: ?[*:0]align(1) const u16,
        phServiceHandle: ?*SC_HANDLE,
...
pub const PRESUTIL_DUP_STRING = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszInString: ?[*:0]align(1) const u16,
...
pub const PRESUTIL_SET_SZ_VALUE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hkeyClusterKey: ?HKEY,
        pszValueName: ?[*:0]align(1) const u16,
        pszNewValue: ?[*:0]align(1) const u16,
        ppszOutString: ?*?PWSTR,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hkeyClusterKey: ?HKEY,
...
pub const PRESUTIL_GET_SZ_PROPERTY = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        pszOldValue: ?[*:0]align(1) const u16,
        // TODO: what to do with BytesParamIndex 4?
        ppPropertyList: ?*?*u8,
        pcbPropertyListSize: ?*u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PRESUTIL_ENUM_RESOURCES = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hSelf: HRESOURCE,
        lpszResTypeName: ?[*:0]align(1) const u16,
...
pub const PRESUTIL_GET_CORE_CLUSTER_RESOURCES = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hCluster: HCLUSTER,
        phClusterNameResource: ?*HRESOURCE,
        phClusterIPAddressResource: ?*HRESOURCE,
        phClusterQuorumResource: ?*HRESOURCE,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hCluster: HCLUSTER,
        phClusterNameResource: ?*HRESOURCE,
...
pub const PCLUSTER_CLEAR_BACKUP_STATE_FOR_SHARED_VOLUME = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszVolumePathName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        lpszVolumePathName: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) u32,
...
pub const PRESUTIL_GET_CORE_CLUSTER_RESOURCES_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        hClusterIn: HCLUSTER,
        phClusterNameResourceOut: ?*HRESOURCE,
        phClusterIPAddressResourceOut: ?*HRESOURCE,
        phClusterQuorumResourceOut: ?*HRESOURCE,
        dwDesiredAccess: u32,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        hClusterIn: HCLUSTER,
...
pub const POPEN_CLUSTER_CRYPT_PROVIDER = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszResource: ?[*:0]align(1) const u16,
        lpszProvider: ?*i8,
        dwType: u32,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSCRYPTPROVIDER,
    else => *const fn(
        lpszResource: ?[*:0]align(1) const u16,
        lpszProvider: ?*i8,
        dwType: u32,
...
pub const POPEN_CLUSTER_CRYPT_PROVIDEREX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszResource: ?[*:0]align(1) const u16,
        lpszKeyname: ?[*:0]align(1) const u16,
        lpszProvider: ?*i8,
        dwType: u32,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HCLUSCRYPTPROVIDER,
...
pub const IGetClusterDataInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterDataInfo_GetClusterHandle(self: *const T) callconv(.Inline) HCLUSTER {
...
pub const IGetClusterNodeInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterNodeInfo_GetNodeHandle(self: *const T, lObjIndex: i32) callconv(.Inline) HNODE {
...
pub const IGetClusterGroupInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterGroupInfo_GetGroupHandle(self: *const T, lObjIndex: i32) callconv(.Inline) HGROUP {
...
pub const IGetClusterResourceInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterResourceInfo_GetResourceHandle(self: *const T, lObjIndex: i32) callconv(.Inline) HRESOURCE {
...
pub const IGetClusterNetworkInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterNetworkInfo_GetNetworkHandle(self: *const T, lObjIndex: i32) callconv(.Inline) HNETWORK {
...
pub const IGetClusterNetInterfaceInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGetClusterNetInterfaceInfo_GetNetInterfaceHandle(self: *const T, lObjIndex: i32) callconv(.Inline) HNETINTERFACE {
...
//--------------------------------------------------------------------------------
pub extern "clusapi" fn ClusapiSetReasonHandler(
    lpHandler: ?*CLUSAPI_REASON_HANDLER,
) callconv(@import("std").os.windows.WINAPI) ?*CLUSAPI_REASON_HANDLER;
...
pub extern "clusapi" fn SetClusterNameEx(
    hCluster: HCLUSTER,
    lpszNewClusterName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetClusterQuorumResourceEx(
    hResource: HRESOURCE,
    lpszDeviceName: ?[*:0]align(1) const u16,
    dwMaxQuorumLogSize: u32,
    lpszReason: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn ClusterControlEx(
    hCluster: HCLUSTER,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn CreateClusterGroupSet(
    hCluster: HCLUSTER,
    groupSetName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HGROUPSET;
...
pub extern "clusapi" fn DeleteClusterGroupSetEx(
    hGroupSet: HGROUPSET,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterAddGroupToGroupSetWithDomainsEx(
    hGroupSet: HGROUPSET,
    hGroup: HGROUP,
    faultDomain: u32,
    updateDomain: u32,
...
pub extern "clusapi" fn ClusterRemoveGroupFromGroupSetEx(
    hGroup: HGROUP,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterGroupSetControlEx(
    hGroupSet: HGROUPSET,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn AddClusterGroupDependencyEx(
    hDependentGroup: HGROUP,
    hProviderGroup: HGROUP,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetGroupDependencyExpressionEx(
    hGroup: HGROUP,
    lpszDependencyExpression: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RemoveClusterGroupDependencyEx(
    hGroup: HGROUP,
    hDependsOn: HGROUP,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn AddClusterGroupSetDependencyEx(
    hDependentGroupSet: HGROUPSET,
    hProviderGroupSet: HGROUPSET,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetClusterGroupSetDependencyExpression(
    hGroupSet: HGROUPSET,
    lpszDependencyExprssion: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn SetClusterGroupSetDependencyExpressionEx(
    hGroupSet: HGROUPSET,
    lpszDependencyExpression: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RemoveClusterGroupSetDependencyEx(
    hGroupSet: HGROUPSET,
    hDependsOn: HGROUPSET,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn AddClusterGroupToGroupSetDependencyEx(
    hDependentGroup: HGROUP,
    hProviderGroupSet: HGROUPSET,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RemoveClusterGroupToGroupSetDependencyEx(
    hGroup: HGROUP,
    hDependsOn: HGROUPSET,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterGroupSetOpenEnum(
    hCluster: HCLUSTER,
) callconv(@import("std").os.windows.WINAPI) HGROUPSETENUM;
...
pub extern "clusapi" fn ClusterNodeReplacement(
    hCluster: HCLUSTER,
    lpszNodeNameCurrent: ?[*:0]align(1) const u16,
    lpszNodeNameNew: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterNetInterfaceOpenEnum(
    ...
    lpszNodeName: ?[*:0]align(1) const u16,
    lpszNetworkName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HNETINTERFACEENUM;
...
pub extern "clusapi" fn EvictClusterNodeEx2(
    hNode: HNODE,
    dwTimeout: u32,
    phrCleanupStatus: ?*HRESULT,
    lpszReason: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn PauseClusterNodeEx2(
    hNode: HNODE,
    bDrainNode: BOOL,
    dwPauseFlags: u32,
    hNodeDrainTarget: HNODE,
...
pub extern "clusapi" fn ResumeClusterNodeEx2(
    hNode: HNODE,
    eResumeFailbackType: CLUSTER_NODE_RESUME_FAILBACK_TYPE,
    dwResumeFlagsReserved: u32,
    lpszReason: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn OnlineClusterGroupEx2(
    hGroup: HGROUP,
    hDestinationNode: HNODE,
    dwOnlineFlags: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn OfflineClusterGroupEx2(
    hGroup: HGROUP,
    dwOfflineFlags: u32,
    lpInBuffer: ?*u8,
    cbInBufferSize: u32,
...
pub extern "clusapi" fn OnlineClusterResourceEx2(
    hResource: HRESOURCE,
    dwOnlineFlags: u32,
    // TODO: what to do with BytesParamIndex 3?
    lpInBuffer: ?*u8,
...
pub extern "clusapi" fn OfflineClusterResourceEx2(
    hResource: HRESOURCE,
    dwOfflineFlags: u32,
    // TODO: what to do with BytesParamIndex 3?
    lpInBuffer: ?*u8,
...
pub extern "clusapi" fn MoveClusterGroupEx2(
    hGroup: HGROUP,
    hDestinationNode: HNODE,
    dwMoveFlags: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn RestartClusterResourceEx(
    hResource: HRESOURCE,
    dwFlags: u32,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetClusterGroupNameEx(
    hGroup: HGROUP,
    lpszGroupName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn SetClusterGroupNodeListEx(
    hGroup: HGROUP,
    NodeCount: u32,
    NodeList: [*]HNODE,
    lpszReason: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn DeleteClusterGroupEx(
    hGroup: HGROUP,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn DestroyClusterGroupEx(
    hGroup: HGROUP,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn CreateClusterResourceEx(
    hGroup: HGROUP,
    lpszResourceName: ?[*:0]align(1) const u16,
    lpszResourceType: ?[*:0]align(1) const u16,
    dwFlags: u32,
...
pub extern "clusapi" fn DeleteClusterResourceEx(
    hResource: HRESOURCE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetClusterResourceNameEx(
    hResource: HRESOURCE,
    lpszResourceName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn FailClusterResourceEx(
    hResource: HRESOURCE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ChangeClusterResourceGroupEx2(
    hResource: HRESOURCE,
    hGroup: HGROUP,
    Flags: u64,
    lpszReason: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn AddClusterResourceNodeEx(
    hResource: HRESOURCE,
    hNode: HNODE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn RemoveClusterResourceNodeEx(
    hResource: HRESOURCE,
    hNode: HNODE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn AddClusterResourceDependencyEx(
    hResource: HRESOURCE,
    hDependsOn: HRESOURCE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn RemoveClusterResourceDependencyEx(
    hResource: HRESOURCE,
    hDependsOn: HRESOURCE,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterResourceControlEx(
    hResource: HRESOURCE,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn ClusterResourceControlAsUserEx(
    hResource: HRESOURCE,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn ClusterResourceTypeControlEx(
    hCluster: HCLUSTER,
    lpszResourceTypeName: ?[*:0]align(1) const u16,
    hHostNode: HNODE,
    dwControlCode: u32,
...
pub extern "clusapi" fn ClusterResourceTypeControlAsUserEx(
    hCluster: HCLUSTER,
    lpszResourceTypeName: ?[*:0]align(1) const u16,
    hHostNode: HNODE,
    dwControlCode: u32,
...
pub extern "clusapi" fn ClusterGroupControlEx(
    hGroup: HGROUP,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn ClusterNodeControlEx(
    hNode: HNODE,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn CreateClusterResourceTypeEx(
    hCluster: HCLUSTER,
    lpszResourceTypeName: ?[*:0]align(1) const u16,
    lpszDisplayName: ?[*:0]align(1) const u16,
    lpszResourceTypeDll: ?[*:0]align(1) const u16,
...
pub extern "clusapi" fn DeleteClusterResourceTypeEx(
    hCluster: HCLUSTER,
    lpszTypeName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn SetClusterNetworkNameEx(
    hNetwork: HNETWORK,
    lpszName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterNetworkControlEx(
    hNetwork: HNETWORK,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn ClusterNetInterfaceControlEx(
    hNetInterface: HNETINTERFACE,
    hHostNode: HNODE,
    dwControlCode: u32,
    // TODO: what to do with BytesParamIndex 4?
...
pub extern "clusapi" fn ClusterRegCreateKeyEx(
    hKey: ?HKEY,
    lpSubKey: ?[*:0]align(1) const u16,
    dwOptions: u32,
    samDesired: u32,
...
pub extern "clusapi" fn ClusterRegDeleteKeyEx(
    hKey: ?HKEY,
    lpSubKey: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "clusapi" fn ClusterRegSetValueEx(
    hKey: ?HKEY,
    lpszValueName: ?[*:0]align(1) const u16,
    dwType: u32,
    lpData: ?*const u8,
...
pub extern "clusapi" fn ClusterRegDeleteValueEx(
    hKey: ?HKEY,
    lpszValueName: ?[*:0]align(1) const u16,
    lpszReason: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterRegSetKeySecurityEx(
    hKey: ?HKEY,
...
pub extern "clusapi" fn GetNodeCloudTypeDW(
    ppszNodeName: ?[*:0]align(1) const u16,
    NodeCloudType: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RegisterClusterResourceTypeNotifyV2(
    ...
    hCluster: HCLUSTER,
    Flags: i64,
    resTypeName: ?[*:0]align(1) const u16,
    dwNotifyKey: usize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn AddClusterStorageNode(
    ...
    pfnProgressCallback: ?PCLUSTER_SETUP_PROGRESS_CALLBACK,
    pvCallbackArg: ?*anyopaque,
    lpszClusterStorageNodeDescription: ?[*:0]align(1) const u16,
    lpszClusterStorageNodeLocation: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RemoveClusterStorageNode(
    hCluster: HCLUSTER,
    lpszClusterStorageEnclosureName: ?[*:0]align(1) const u16,
    dwTimeout: u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
const SC_HANDLE = @import("../../../windows/win32/security.zig").SC_HANDLE;
const SECURITY_ATTRIBUTES = @import("../../../windows/win32/security.zig").SECURITY_ATTRIBUTES;
const SECURITY_DESCRIPTOR_RELATIVE = @import("../../../windows/win32/security.zig").SECURITY_DESCRIPTOR_RELATIVE;
...
test {
    ...
    if (@hasDecl(@This(), "PCLUSAPI_PFN_REASON_HANDLER")) { _ = PCLUSAPI_PFN_REASON_HANDLER; }
    if (@hasDecl(@This(), "PCLUSAPI_SET_REASON_HANDLER")) { _ = PCLUSAPI_SET_REASON_HANDLER; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_NAME_EX")) { _ = PCLUSAPI_SET_CLUSTER_NAME_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE_EX")) { _ = PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_CONTROL_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET_EX")) { _ = PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUP_GROUPSET")) { _ = PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUP_GROUPSET; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUPSET_WITH_DOMAINS_EX")) { _ = PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUPSET_WITH_DOMAINS_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET")) { _ = PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET_EX")) { _ = PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL")) { _ = PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY")) { _ = PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY; }
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY_EX")) { _ = PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION")) { _ = PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION; }
    if (@hasDecl(@This(), "PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX")) { _ = PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY")) { _ = PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY_EX")) { _ = PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY")) { _ = PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY; }
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX")) { _ = PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION_EX")) { _ = PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY")) { _ = PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX")) { _ = PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX")) { _ = PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX")) { _ = PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_EVICT_CLUSTER_NODE_EX2")) { _ = PCLUSAPI_EVICT_CLUSTER_NODE_EX2; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_PAUSE_CLUSTER_NODE_EX2")) { _ = PCLUSAPI_PAUSE_CLUSTER_NODE_EX2; }
    if (@hasDecl(@This(), "PCLUSAPI_RESUME_CLUSTER_NODE_EX")) { _ = PCLUSAPI_RESUME_CLUSTER_NODE_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_RESUME_CLUSTER_NODE_EX2")) { _ = PCLUSAPI_RESUME_CLUSTER_NODE_EX2; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_RESTART_CLUSTER_RESOURCE_EX")) { _ = PCLUSAPI_RESTART_CLUSTER_RESOURCE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX")) { _ = PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX")) { _ = PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_DELETE_CLUSTER_GROUP_EX")) { _ = PCLUSAPI_DELETE_CLUSTER_GROUP_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_DESTROY_CLUSTER_GROUP_EX")) { _ = PCLUSAPI_DESTROY_CLUSTER_GROUP_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CREATE_CLUSTER_RESOURCE_EX")) { _ = PCLUSAPI_CREATE_CLUSTER_RESOURCE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_DELETE_CLUSTER_RESOURCE_EX")) { _ = PCLUSAPI_DELETE_CLUSTER_RESOURCE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX")) { _ = PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_FAIL_CLUSTER_RESOURCE")) { _ = PCLUSAPI_FAIL_CLUSTER_RESOURCE; }
    if (@hasDecl(@This(), "PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX")) { _ = PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2")) { _ = PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE_EX")) { _ = PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX")) { _ = PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY_EX")) { _ = PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY_EX")) { _ = PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_RESOURCE_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_RESOURCE_CONTROL_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_RESOURCE_CONTROL_AS_USER_EX")) { _ = PCLUSAPI_CLUSTER_RESOURCE_CONTROL_AS_USER_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX")) { _ = PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_GROUP_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_GROUP_CONTROL_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_NODE_CONTROL")) { _ = PCLUSAPI_CLUSTER_NODE_CONTROL; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_NODE_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_NODE_CONTROL_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE_EX")) { _ = PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX")) { _ = PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX")) { _ = PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_NETWORK_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_NETWORK_CONTROL_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL_EX")) { _ = PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REG_CREATE_KEY_EX")) { _ = PCLUSAPI_CLUSTER_REG_CREATE_KEY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REG_DELETE_KEY_EX")) { _ = PCLUSAPI_CLUSTER_REG_DELETE_KEY_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REG_SET_VALUE_EX")) { _ = PCLUSAPI_CLUSTER_REG_SET_VALUE_EX; }
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX")) { _ = PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX; }
    ...
    if (@hasDecl(@This(), "PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX")) { _ = PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX; }
    ...
    if (@hasDecl(@This(), "PSET_RESOURCE_WPR_POLICY_ROUTINE")) { _ = PSET_RESOURCE_WPR_POLICY_ROUTINE; }
    if (@hasDecl(@This(), "PARM_WPR_WATCHDOG_FOR_CURRENT_RESOURCE_CALL_ROUTINE")) { _ = PARM_WPR_WATCHDOG_FOR_CURRENT_RESOURCE_CALL_ROUTINE; }
