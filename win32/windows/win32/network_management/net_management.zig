...
pub const NERR_CannotUpdateAadHostName = @as(u32, 2728);
pub const NERR_DuplicateHostName = @as(u32, 2729);
pub const NERR_HostNameTooLong = @as(u32, 2730);
pub const NERR_TooManyHostNames = @as(u32, 2731);
pub const NERR_AccountReuseBlockedByPolicy = @as(u32, 2732);
...
pub const NETLOG_PassThruFilterError_Summary_AdminOverride = @as(u32, 5832);
pub const NETLOG_PassThruFilterError_Summary_Blocked = @as(u32, 5833);
pub const NETLOG_PassThruFilterError_Request_AdminOverride = @as(u32, 5834);
pub const NETLOG_PassThruFilterError_Request_Blocked = @as(u32, 5835);
pub const NETLOG_NetlogonRpcBacklogLimitSet = @as(u32, 5836);
pub const NETLOG_NetlogonRpcBacklogLimitFailure = @as(u32, 5837);
...
pub const ALIGN_SHIFT = @as(u32, 7);
...
pub const NET_REQUEST_PROVISION_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NET_REQUEST_PROVISION_OPTIONS, @enumFromInt(
              (if (o.R == 1) @intFromEnum(NET_REQUEST_PROVISION_OPTIONS.R) else 0)
        ));
    }
};
...
pub const NET_JOIN_DOMAIN_JOIN_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NET_JOIN_DOMAIN_JOIN_OPTIONS, @enumFromInt(
              (if (o.JOIN_DOMAIN == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.JOIN_DOMAIN) else 0)
            | (if (o.ACCT_CREATE == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.ACCT_CREATE) else 0)
            | (if (o.WIN9X_UPGRADE == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.WIN9X_UPGRADE) else 0)
            | (if (o.DOMAIN_JOIN_IF_JOINED == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.DOMAIN_JOIN_IF_JOINED) else 0)
            | (if (o.JOIN_UNSECURE == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.JOIN_UNSECURE) else 0)
            | (if (o.MACHINE_PWD_PASSED == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.MACHINE_PWD_PASSED) else 0)
            | (if (o.DEFER_SPN_SET == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.DEFER_SPN_SET) else 0)
            | (if (o.JOIN_DC_ACCOUNT == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.JOIN_DC_ACCOUNT) else 0)
            | (if (o.JOIN_WITH_NEW_NAME == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.JOIN_WITH_NEW_NAME) else 0)
            | (if (o.JOIN_READONLY == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.JOIN_READONLY) else 0)
            | (if (o.AMBIGUOUS_DC == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.AMBIGUOUS_DC) else 0)
            | (if (o.NO_NETLOGON_CACHE == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.NO_NETLOGON_CACHE) else 0)
            | (if (o.DONT_CONTROL_SERVICES == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.DONT_CONTROL_SERVICES) else 0)
            | (if (o.SET_MACHINE_NAME == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.SET_MACHINE_NAME) else 0)
            | (if (o.FORCE_SPN_SET == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.FORCE_SPN_SET) else 0)
            | (if (o.NO_ACCT_REUSE == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.NO_ACCT_REUSE) else 0)
            | (if (o.IGNORE_UNSUPPORTED_FLAGS == 1) @intFromEnum(NET_JOIN_DOMAIN_JOIN_OPTIONS.IGNORE_UNSUPPORTED_FLAGS) else 0)
        ));
    }
};
...
pub const NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = enum(u32) {
...
pub const NET_SERVER_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NET_SERVER_TYPE, @enumFromInt(
              (if (o.WORKSTATION == 1) @intFromEnum(NET_SERVER_TYPE.WORKSTATION) else 0)
            | (if (o.SERVER == 1) @intFromEnum(NET_SERVER_TYPE.SERVER) else 0)
            | (if (o.SQLSERVER == 1) @intFromEnum(NET_SERVER_TYPE.SQLSERVER) else 0)
            | (if (o.DOMAIN_CTRL == 1) @intFromEnum(NET_SERVER_TYPE.DOMAIN_CTRL) else 0)
            | (if (o.DOMAIN_BAKCTRL == 1) @intFromEnum(NET_SERVER_TYPE.DOMAIN_BAKCTRL) else 0)
            | (if (o.TIME_SOURCE == 1) @intFromEnum(NET_SERVER_TYPE.TIME_SOURCE) else 0)
            | (if (o.AFP == 1) @intFromEnum(NET_SERVER_TYPE.AFP) else 0)
            | (if (o.NOVELL == 1) @intFromEnum(NET_SERVER_TYPE.NOVELL) else 0)
            | (if (o.DOMAIN_MEMBER == 1) @intFromEnum(NET_SERVER_TYPE.DOMAIN_MEMBER) else 0)
            | (if (o.PRINTQ_SERVER == 1) @intFromEnum(NET_SERVER_TYPE.PRINTQ_SERVER) else 0)
            | (if (o.DIALIN_SERVER == 1) @intFromEnum(NET_SERVER_TYPE.DIALIN_SERVER) else 0)
            | (if (o.XENIX_SERVER == 1) @intFromEnum(NET_SERVER_TYPE.XENIX_SERVER) else 0)
            | (if (o.NT == 1) @intFromEnum(NET_SERVER_TYPE.NT) else 0)
            | (if (o.WFW == 1) @intFromEnum(NET_SERVER_TYPE.WFW) else 0)
            | (if (o.SERVER_MFPN == 1) @intFromEnum(NET_SERVER_TYPE.SERVER_MFPN) else 0)
            | (if (o.SERVER_NT == 1) @intFromEnum(NET_SERVER_TYPE.SERVER_NT) else 0)
            | (if (o.POTENTIAL_BROWSER == 1) @intFromEnum(NET_SERVER_TYPE.POTENTIAL_BROWSER) else 0)
            | (if (o.BACKUP_BROWSER == 1) @intFromEnum(NET_SERVER_TYPE.BACKUP_BROWSER) else 0)
            | (if (o.MASTER_BROWSER == 1) @intFromEnum(NET_SERVER_TYPE.MASTER_BROWSER) else 0)
            | (if (o.DOMAIN_MASTER == 1) @intFromEnum(NET_SERVER_TYPE.DOMAIN_MASTER) else 0)
            | (if (o.SERVER_OSF == 1) @intFromEnum(NET_SERVER_TYPE.SERVER_OSF) else 0)
            | (if (o.SERVER_VMS == 1) @intFromEnum(NET_SERVER_TYPE.SERVER_VMS) else 0)
            | (if (o.WINDOWS == 1) @intFromEnum(NET_SERVER_TYPE.WINDOWS) else 0)
            | (if (o.DFS == 1) @intFromEnum(NET_SERVER_TYPE.DFS) else 0)
            | (if (o.CLUSTER_NT == 1) @intFromEnum(NET_SERVER_TYPE.CLUSTER_NT) else 0)
            | (if (o.TERMINALSERVER == 1) @intFromEnum(NET_SERVER_TYPE.TERMINALSERVER) else 0)
            | (if (o.CLUSTER_VS_NT == 1) @intFromEnum(NET_SERVER_TYPE.CLUSTER_VS_NT) else 0)
            | (if (o.DCE == 1) @intFromEnum(NET_SERVER_TYPE.DCE) else 0)
            | (if (o.ALTERNATE_XPORT == 1) @intFromEnum(NET_SERVER_TYPE.ALTERNATE_XPORT) else 0)
            | (if (o.LOCAL_LIST_ONLY == 1) @intFromEnum(NET_SERVER_TYPE.LOCAL_LIST_ONLY) else 0)
            | (if (o.DOMAIN_ENUM == 1) @intFromEnum(NET_SERVER_TYPE.DOMAIN_ENUM) else 0)
            | (if (o.ALL == 1) @intFromEnum(NET_SERVER_TYPE.ALL) else 0)
        ));
    }
};
...
pub const NET_USER_ENUM_FILTER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NET_USER_ENUM_FILTER_FLAGS, @enumFromInt(
              (if (o.TEMP_DUPLICATE_ACCOUNT == 1) @intFromEnum(NET_USER_ENUM_FILTER_FLAGS.TEMP_DUPLICATE_ACCOUNT) else 0)
            | (if (o.NORMAL_ACCOUNT == 1) @intFromEnum(NET_USER_ENUM_FILTER_FLAGS.NORMAL_ACCOUNT) else 0)
            | (if (o.INTERDOMAIN_TRUST_ACCOUNT == 1) @intFromEnum(NET_USER_ENUM_FILTER_FLAGS.INTERDOMAIN_TRUST_ACCOUNT) else 0)
            | (if (o.WORKSTATION_TRUST_ACCOUNT == 1) @intFromEnum(NET_USER_ENUM_FILTER_FLAGS.WORKSTATION_TRUST_ACCOUNT) else 0)
            | (if (o.SERVER_TRUST_ACCOUNT == 1) @intFromEnum(NET_USER_ENUM_FILTER_FLAGS.SERVER_TRUST_ACCOUNT) else 0)
        ));
    }
};
...
pub const NETSETUP_PROVISION = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NETSETUP_PROVISION, @enumFromInt(
              (if (o.DOWNLEVEL_PRIV_SUPPORT == 1) @intFromEnum(NETSETUP_PROVISION.DOWNLEVEL_PRIV_SUPPORT) else 0)
            | (if (o.REUSE_ACCOUNT == 1) @intFromEnum(NETSETUP_PROVISION.REUSE_ACCOUNT) else 0)
            | (if (o.USE_DEFAULT_PASSWORD == 1) @intFromEnum(NETSETUP_PROVISION.USE_DEFAULT_PASSWORD) else 0)
            | (if (o.SKIP_ACCOUNT_SEARCH == 1) @intFromEnum(NETSETUP_PROVISION.SKIP_ACCOUNT_SEARCH) else 0)
            | (if (o.ROOT_CA_CERTS == 1) @intFromEnum(NETSETUP_PROVISION.ROOT_CA_CERTS) else 0)
        ));
    }
};
...
pub const USER_ACCOUNT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(USER_ACCOUNT_FLAGS, @enumFromInt(
              (if (o.SCRIPT == 1) @intFromEnum(USER_ACCOUNT_FLAGS.SCRIPT) else 0)
            | (if (o.ACCOUNTDISABLE == 1) @intFromEnum(USER_ACCOUNT_FLAGS.ACCOUNTDISABLE) else 0)
            | (if (o.HOMEDIR_REQUIRED == 1) @intFromEnum(USER_ACCOUNT_FLAGS.HOMEDIR_REQUIRED) else 0)
            | (if (o.PASSWD_NOTREQD == 1) @intFromEnum(USER_ACCOUNT_FLAGS.PASSWD_NOTREQD) else 0)
            | (if (o.PASSWD_CANT_CHANGE == 1) @intFromEnum(USER_ACCOUNT_FLAGS.PASSWD_CANT_CHANGE) else 0)
            | (if (o.LOCKOUT == 1) @intFromEnum(USER_ACCOUNT_FLAGS.LOCKOUT) else 0)
            | (if (o.DONT_EXPIRE_PASSWD == 1) @intFromEnum(USER_ACCOUNT_FLAGS.DONT_EXPIRE_PASSWD) else 0)
            | (if (o.ENCRYPTED_TEXT_PASSWORD_ALLOWED == 1) @intFromEnum(USER_ACCOUNT_FLAGS.ENCRYPTED_TEXT_PASSWORD_ALLOWED) else 0)
            | (if (o.NOT_DELEGATED == 1) @intFromEnum(USER_ACCOUNT_FLAGS.NOT_DELEGATED) else 0)
            | (if (o.SMARTCARD_REQUIRED == 1) @intFromEnum(USER_ACCOUNT_FLAGS.SMARTCARD_REQUIRED) else 0)
            | (if (o.USE_DES_KEY_ONLY == 1) @intFromEnum(USER_ACCOUNT_FLAGS.USE_DES_KEY_ONLY) else 0)
            | (if (o.DONT_REQUIRE_PREAUTH == 1) @intFromEnum(USER_ACCOUNT_FLAGS.DONT_REQUIRE_PREAUTH) else 0)
            | (if (o.TRUSTED_FOR_DELEGATION == 1) @intFromEnum(USER_ACCOUNT_FLAGS.TRUSTED_FOR_DELEGATION) else 0)
            | (if (o.PASSWORD_EXPIRED == 1) @intFromEnum(USER_ACCOUNT_FLAGS.PASSWORD_EXPIRED) else 0)
            | (if (o.TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION == 1) @intFromEnum(USER_ACCOUNT_FLAGS.TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION) else 0)
        ));
    }
};
...
pub const AF_OP = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(AF_OP, @enumFromInt(
              (if (o.PRINT == 1) @intFromEnum(AF_OP.PRINT) else 0)
            | (if (o.COMM == 1) @intFromEnum(AF_OP.COMM) else 0)
            | (if (o.SERVER == 1) @intFromEnum(AF_OP.SERVER) else 0)
            | (if (o.ACCOUNTS == 1) @intFromEnum(AF_OP.ACCOUNTS) else 0)
        ));
    }
};
...
pub const SERVER_INFO_HIDDEN = enum(i32) {
    VISIBLE = 0,
    HIDDEN = 1,
};
...
pub const NETSETUP_PROVISIONING_PARAMS = extern struct {
    dwVersion: u32,
    lpDomain: ?[*:0]align(1) const u16,
    lpHostName: ?[*:0]align(1) const u16,
    lpMachineAccountOU: ?[*:0]align(1) const u16,
    lpDcName: ?[*:0]align(1) const u16,
    dwProvisionOptions: NETSETUP_PROVISION,
    aCertTemplateNames: ?*const ?PWSTR,
    cCertTemplateNames: u32,
    aMachinePolicyNames: ?*const ?PWSTR,
    cMachinePolicyNames: u32,
    aMachinePolicyPaths: ?*const ?PWSTR,
...
pub const INetCfg = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfg_FindComponent(self: *const T, pszwInfId: ?[*:0]align(1) const u16, pComponent: ?*?*INetCfgComponent) callconv(.Inline) HRESULT {
...
pub const INetCfgLock = extern struct {
    pub const VTable = extern struct {
        ...
        AcquireWriteLock: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                cmsTimeout: u32,
                pszwClientDescription: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgLock_AcquireWriteLock(self: *const T, cmsTimeout: u32, pszwClientDescription: ?[*:0]align(1) const u16, ppszwClientDescription: ?*?PWSTR) callconv(.Inline) HRESULT {
...
pub const INetCfgClass = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgClass_FindComponent(self: *const T, pszwInfId: ?[*:0]align(1) const u16, ppnccItem: ?*?*INetCfgComponent) callconv(.Inline) HRESULT {
...
pub const OBO_TOKEN = extern struct {
    ...
    pszwManufacturer: ?[*:0]align(1) const u16,
    pszwProduct: ?[*:0]align(1) const u16,
    pszwDisplayName: ?[*:0]align(1) const u16,
    fRegistered: BOOL,
};
...
pub const INetCfgClassSetup = extern struct {
    pub const VTable = extern struct {
        ...
        Install: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszwAnswerFile: ?[*:0]align(1) const u16,
                pszwAnswerSections: ?[*:0]align(1) const u16,
                ppnccItem: ?*?*INetCfgComponent,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const INetCfgClassSetup,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgClassSetup_Install(self: *const T, pszwInfId: ?[*:0]align(1) const u16, pOboToken: ?*OBO_TOKEN, dwSetupFlags: u32, dwUpgradeFromBuildNo: u32, pszwAnswerFile: ?[*:0]align(1) const u16, pszwAnswerSections: ?[*:0]align(1) const u16, ppnccItem: ?*?*INetCfgComponent) callconv(.Inline) HRESULT {
...
pub const INetCfgComponent = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponent_SetDisplayName(self: *const T, pszwDisplayName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INetCfgComponentBindings = extern struct {
    pub const VTable = extern struct {
        ...
        SupportsBindingInterface: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetCfgComponentBindings,
                dwFlags: u32,
                pszwInterfaceName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const INetCfgComponentBindings,
                dwFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentBindings_SupportsBindingInterface(self: *const T, dwFlags: u32, pszwInterfaceName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INetCfgSysPrep = extern struct {
    pub const VTable = extern struct {
        ...
        HrSetupSetFirstDword: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwszSection: ?[*:0]align(1) const u16,
                pwszKey: ?[*:0]align(1) const u16,
                dwValue: u32,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const INetCfgSysPrep,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgSysPrep_HrSetupSetFirstDword(self: *const T, pwszSection: ?[*:0]align(1) const u16, pwszKey: ?[*:0]align(1) const u16, dwValue: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgSysPrep_HrSetupSetFirstString(self: *const T, pwszSection: ?[*:0]align(1) const u16, pwszKey: ?[*:0]align(1) const u16, pwszValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgSysPrep_HrSetupSetFirstStringAsBool(self: *const T, pwszSection: ?[*:0]align(1) const u16, pwszKey: ?[*:0]align(1) const u16, fValue: BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgSysPrep_HrSetupSetFirstMultiSzField(self: *const T, pwszSection: ?[*:0]align(1) const u16, pwszKey: ?[*:0]align(1) const u16, pmszValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INetCfgPnpReconfigCallback = extern struct {
    pub const VTable = extern struct {
        ...
        SendPnpReconfig: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszwUpper: ?[*:0]align(1) const u16,
                pszwLower: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgPnpReconfigCallback_SendPnpReconfig(self: *const T, Layer: NCPNP_RECONFIG_LAYER, pszwUpper: ?[*:0]align(1) const u16, pszwLower: ?[*:0]align(1) const u16, pvData: ?*anyopaque, dwSizeOfData: u32) callconv(.Inline) HRESULT {
...
pub const INetCfgComponentSetup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentSetup_ReadAnswerFile(self: *const T, pszwAnswerFile: ?[*:0]align(1) const u16, pszwAnswerSections: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const INetCfgComponentPropertyUi = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentPropertyUi_MergePropPages(self: *const T, pdwDefPages: ?*u32, pahpspPrivate: ?*?*u8, pcPages: ?*u32, hwndParent: ?HWND, pszStartPage: ?*const ?PWSTR) callconv(.Inline) HRESULT {
...
pub const INetCfgComponentUpperEdge = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentUpperEdge_AddInterfacesToAdapter(self: *const T, pAdapter: ?*INetCfgComponent, dwNumInterfaces: u32) callconv(.Inline) HRESULT {
...
pub const RASCON_UIINFO_FLAGS = enum(i32) {
    VPN = 1,
    DEMAND_DIAL = 2,
    NOT_ADMIN = 4,
...
pub const RCUIF_VPN = RASCON_UIINFO_FLAGS.VPN;
pub const RCUIF_DEMAND_DIAL = RASCON_UIINFO_FLAGS.DEMAND_DIAL;
pub const RCUIF_NOT_ADMIN = RASCON_UIINFO_FLAGS.NOT_ADMIN;
pub const RCUIF_USE_IPv4_STATICADDRESS = RASCON_UIINFO_FLAGS.USE_IPv4_STATICADDRESS;
pub const RCUIF_USE_IPv4_NAME_SERVERS = RASCON_UIINFO_FLAGS.USE_IPv4_NAME_SERVERS;
pub const RCUIF_USE_IPv4_REMOTE_GATEWAY = RASCON_UIINFO_FLAGS.USE_IPv4_REMOTE_GATEWAY;
pub const RCUIF_USE_IPv4_EXPLICIT_METRIC = RASCON_UIINFO_FLAGS.USE_IPv4_EXPLICIT_METRIC;
pub const RCUIF_USE_HEADER_COMPRESSION = RASCON_UIINFO_FLAGS.USE_HEADER_COMPRESSION;
pub const RCUIF_USE_DISABLE_REGISTER_DNS = RASCON_UIINFO_FLAGS.USE_DISABLE_REGISTER_DNS;
pub const RCUIF_USE_PRIVATE_DNS_SUFFIX = RASCON_UIINFO_FLAGS.USE_PRIVATE_DNS_SUFFIX;
pub const RCUIF_ENABLE_NBT = RASCON_UIINFO_FLAGS.ENABLE_NBT;
pub const RCUIF_USE_IPv6_STATICADDRESS = RASCON_UIINFO_FLAGS.USE_IPv6_STATICADDRESS;
pub const RCUIF_USE_IPv6_NAME_SERVERS = RASCON_UIINFO_FLAGS.USE_IPv6_NAME_SERVERS;
pub const RCUIF_USE_IPv6_REMOTE_GATEWAY = RASCON_UIINFO_FLAGS.USE_IPv6_REMOTE_GATEWAY;
pub const RCUIF_USE_IPv6_EXPLICIT_METRIC = RASCON_UIINFO_FLAGS.USE_IPv6_EXPLICIT_METRIC;
...
pub const INetCfgComponentSysPrep = extern struct {
    pub const VTable = extern struct {
        ...
        RestoreAdapterParameters: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetCfgComponentSysPrep,
                pszwAnswerFile: ?[*:0]align(1) const u16,
                pszwAnswerSection: ?[*:0]align(1) const u16,
                pAdapterInstanceGuid: ?*Guid,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const INetCfgComponentSysPrep,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentSysPrep_SaveAdapterParameters(self: *const T, pncsp: ?*INetCfgSysPrep, pszwAnswerSections: ?[*:0]align(1) const u16, pAdapterInstanceGuid: ?*Guid) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetCfgComponentSysPrep_RestoreAdapterParameters(self: *const T, pszwAnswerFile: ?[*:0]align(1) const u16, pszwAnswerSection: ?[*:0]align(1) const u16, pAdapterInstanceGuid: ?*Guid) callconv(.Inline) HRESULT {
...
pub const IProvisioningDomain = extern struct {
    pub const VTable = extern struct {
        ...
        Add: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszwPathToFolder: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IProvisioningDomain,
                pszwPathToFolder: ?[*:0]align(1) const u16,
        ...
        Query: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IProvisioningDomain,
                pszwDomain: ?[*:0]align(1) const u16,
                pszwLanguage: ?[*:0]align(1) const u16,
                pszwXPathQuery: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProvisioningDomain_Add(self: *const T, pszwPathToFolder: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProvisioningDomain_Query(self: *const T, pszwDomain: ?[*:0]align(1) const u16, pszwLanguage: ?[*:0]align(1) const u16, pszwXPathQuery: ?[*:0]align(1) const u16, Nodes: ?*?*IXMLDOMNodeList) callconv(.Inline) HRESULT {
...
pub extern "netapi32" fn NetUserAdd(
    servername: ?[*:0]align(1) const u16,
    level: u32,
    buf: ?*u8,
    parm_err: ?*u32,
...
pub extern "netapi32" fn NetUserChangePassword(
    domainname: ?[*:0]align(1) const u16,
    username: ?[*:0]align(1) const u16,
    oldpassword: ?[*:0]align(1) const u16,
    newpassword: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetLocalGroupGetMembers(
    servername: ?[*:0]align(1) const u16,
    localgroupname: ?[*:0]align(1) const u16,
    level: u32,
    bufptr: ?*?*u8,
    prefmaxlen: u32,
    entriesread: ?*u32,
...
pub extern "netapi32" fn NetAlertRaiseEx(
    ...
    ServiceName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "netapi32" fn NetMessageNameAdd(
    servername: ?[*:0]align(1) const u16,
    msgname: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetServiceInstall(
    ...
    service: ?[*:0]align(1) const u16,
    argc: u32,
    argv: [*]const ?[*:0]align(1) const u16,
    bufptr: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetErrorLogClear(
    UncServerName: ?[*:0]align(1) const u16,
    BackupFile: ?[*:0]align(1) const u16,
    Reserved: ?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetConfigGet(
    server: ?[*:0]align(1) const u16,
    component: ?[*:0]align(1) const u16,
    parameter: ?[*:0]align(1) const u16,
    bufptr: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetJoinDomain(
    lpServer: ?[*:0]align(1) const u16,
    lpDomain: ?[*:0]align(1) const u16,
    lpMachineAccountOU: ?[*:0]align(1) const u16,
    lpAccount: ?[*:0]align(1) const u16,
    lpPassword: ?[*:0]align(1) const u16,
...
pub extern "netapi32" fn NetRenameMachineInDomain(
    lpServer: ?[*:0]align(1) const u16,
    lpNewMachineName: ?[*:0]align(1) const u16,
    lpAccount: ?[*:0]align(1) const u16,
    lpPassword: ?[*:0]align(1) const u16,
    fRenameOptions: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetAddAlternateComputerName(
    Server: ?[*:0]align(1) const u16,
    AlternateName: ?[*:0]align(1) const u16,
    DomainAccount: ?[*:0]align(1) const u16,
    DomainAccountPassword: ?[*:0]align(1) const u16,
    Reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetSetPrimaryComputerName(
    Server: ?[*:0]align(1) const u16,
    PrimaryName: ?[*:0]align(1) const u16,
    DomainAccount: ?[*:0]align(1) const u16,
    DomainAccountPassword: ?[*:0]align(1) const u16,
    Reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetProvisionComputerAccount(
    lpDomain: ?[*:0]align(1) const u16,
    lpMachineName: ?[*:0]align(1) const u16,
    lpMachineAccountOU: ?[*:0]align(1) const u16,
    lpDcName: ?[*:0]align(1) const u16,
...
pub extern "netapi32" fn NetRequestOfflineDomainJoin(
    ...
    lpWindowsPath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetGetAadJoinInformation(
    pcszTenantId: ?[*:0]align(1) const u16,
...
pub extern "mstask" fn SetNetScheduleAccountInformation(
    pwszServerName: ?[*:0]align(1) const u16,
    pwszAccount: ?[*:0]align(1) const u16,
...
pub extern "rtutils" fn TraceRegisterExA(
    lpszCallerName: ?[*:0]align(1) const u8,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TraceDumpExA(
    ...
    dwGroupSize: u32,
    bAddressPrefix: BOOL,
    lpszPrefix: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rtutils" fn TraceRegisterExW(
    lpszCallerName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TracePrintfW(
    dwTraceID: u32,
    lpszFormat: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TracePutsExW(
    dwTraceID: u32,
    dwFlags: u32,
    lpszString: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TraceDumpExW(
    ...
    dwGroupSize: u32,
    bAddressPrefix: BOOL,
    lpszPrefix: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn RouterLogRegisterW(
    lpszSource: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "rtutils" fn RouterLogEventExW(
    ...
    dwErrorCode: u32,
    dwMessageId: u32,
    ptszFormat: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) void;
...
const IXMLDOMNodeList = @import("../../../windows/win32/data/xml/ms_xml.zig").IXMLDOMNodeList;
