...
pub const CRYPTPROTECT_DEFAULT_PROVIDER = Guid.initString("df9d8cd0-1501-11d1-8c7a-00c04fc297eb");
...
pub const NCRYPT_EXTENDED_ERRORS_FLAG = @as(u32, 268435456);
...
pub const PP_IS_PFX_EPHEMERAL = @as(u32, 50);
...
pub const szOID_RFC3161v21_counterSign = "1.3.6.1.4.1.311.3.3.2";
pub const szOID_RFC3161v21_thumbprints = "1.3.6.1.4.1.311.3.3.3";
...
pub const X509_CERT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const X509_CERT_TO_BE_SIGNED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const X509_CERT_CRL_TO_BE_SIGNED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const X509_CERT_REQUEST_TO_BE_SIGNED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const X509_EXTENSIONS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const X509_NAME_VALUE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 6));
pub const X509_NAME = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 7));
pub const X509_PUBLIC_KEY_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 8));
pub const X509_AUTHORITY_KEY_ID = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 9));
pub const X509_KEY_ATTRIBUTES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 10));
pub const X509_KEY_USAGE_RESTRICTION = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 11));
pub const X509_ALTERNATE_NAME = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 12));
pub const X509_BASIC_CONSTRAINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 13));
pub const X509_KEY_USAGE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 14));
pub const X509_BASIC_CONSTRAINTS2 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 15));
pub const X509_CERT_POLICIES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 16));
pub const PKCS_UTC_TIME = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 17));
pub const PKCS_TIME_REQUEST = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 18));
pub const RSA_CSP_PUBLICKEYBLOB = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 19));
pub const X509_UNICODE_NAME = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 20));
pub const X509_KEYGEN_REQUEST_TO_BE_SIGNED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 21));
pub const PKCS_ATTRIBUTE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 22));
pub const PKCS_CONTENT_INFO_SEQUENCE_OF_ANY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 23));
pub const X509_UNICODE_NAME_VALUE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 24));
pub const X509_ANY_STRING = @as(i32, 6);
pub const X509_UNICODE_ANY_STRING = @as(i32, 24);
pub const X509_OCTET_STRING = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 25));
pub const X509_BITS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 26));
pub const X509_INTEGER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 27));
pub const X509_MULTI_BYTE_INTEGER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 28));
pub const X509_ENUMERATED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 29));
pub const X509_CHOICE_OF_TIME = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 30));
pub const X509_AUTHORITY_KEY_ID2 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 31));
pub const X509_AUTHORITY_INFO_ACCESS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 32));
pub const X509_SUBJECT_INFO_ACCESS = @as(i32, 32);
pub const X509_CRL_REASON_CODE = @as(i32, 29);
pub const PKCS_CONTENT_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 33));
pub const X509_SEQUENCE_OF_ANY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 34));
pub const X509_CRL_DIST_POINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 35));
pub const X509_ENHANCED_KEY_USAGE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 36));
pub const PKCS_CTL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 37));
pub const X509_MULTI_BYTE_UINT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 38));
pub const X509_DSS_PUBLICKEY = @as(i32, 38);
pub const X509_DSS_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 39));
pub const X509_DSS_SIGNATURE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 40));
pub const PKCS_RC2_CBC_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 41));
pub const PKCS_SMIME_CAPABILITIES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 42));
pub const X509_QC_STATEMENTS_EXT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 42));
pub const PKCS_RSA_PRIVATE_KEY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 43));
pub const PKCS_PRIVATE_KEY_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 44));
pub const PKCS_ENCRYPTED_PRIVATE_KEY_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 45));
pub const X509_PKIX_POLICY_QUALIFIER_USERNOTICE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 46));
pub const X509_DH_PUBLICKEY = @as(i32, 38);
pub const X509_DH_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 47));
pub const PKCS_ATTRIBUTES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 48));
pub const PKCS_SORTED_CTL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 49));
pub const X509_ECC_SIGNATURE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 47));
pub const X942_DH_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 50));
pub const X509_BITS_WITHOUT_TRAILING_ZEROES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 51));
pub const X942_OTHER_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 52));
pub const X509_CERT_PAIR = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 53));
pub const X509_ISSUING_DIST_POINT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 54));
pub const X509_NAME_CONSTRAINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 55));
pub const X509_POLICY_MAPPINGS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 56));
pub const X509_POLICY_CONSTRAINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 57));
pub const X509_CROSS_CERT_DIST_POINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 58));
pub const CMC_DATA = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 59));
pub const CMC_RESPONSE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 60));
pub const CMC_STATUS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 61));
pub const CMC_ADD_EXTENSIONS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 62));
pub const CMC_ADD_ATTRIBUTES = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 63));
pub const X509_CERTIFICATE_TEMPLATE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 64));
pub const OCSP_SIGNED_REQUEST = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 65));
pub const OCSP_REQUEST = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 66));
pub const OCSP_RESPONSE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 67));
pub const OCSP_BASIC_SIGNED_RESPONSE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 68));
pub const OCSP_BASIC_RESPONSE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 69));
pub const X509_LOGOTYPE_EXT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 70));
pub const X509_BIOMETRIC_EXT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 71));
pub const CNG_RSA_PUBLIC_KEY_BLOB = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 72));
pub const X509_OBJECT_IDENTIFIER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 73));
pub const X509_ALGORITHM_IDENTIFIER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 74));
pub const PKCS_RSA_SSA_PSS_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 75));
pub const PKCS_RSAES_OAEP_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 76));
pub const ECC_CMS_SHARED_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 77));
pub const TIMESTAMP_REQUEST = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 78));
pub const TIMESTAMP_RESPONSE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 79));
pub const TIMESTAMP_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 80));
pub const X509_CERT_BUNDLE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 81));
pub const X509_ECC_PRIVATE_KEY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 82));
pub const CNG_RSA_PRIVATE_KEY_BLOB = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 83));
pub const X509_SUBJECT_DIR_ATTRS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 84));
pub const X509_ECC_PARAMETERS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 85));
pub const PKCS7_SIGNER_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 500));
pub const CMS_SIGNER_INFO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 501));
...
pub const szOID_NTDS_CA_SECURITY_EXT = "1.3.6.1.4.1.311.25.2";
pub const szOID_NTDS_OBJECTSID = "1.3.6.1.4.1.311.25.2.1";
...
pub const CMSG_DEFAULT_INSTALLABLE_FUNC_OID = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
...
pub const CERT_DISALLOWED_CA_FILETIME_PROP_ID = @as(u32, 128);
pub const CERT_FIRST_RESERVED_PROP_ID = @as(u32, 129);
...
pub const szOID_CERT_DISALLOWED_CA_FILETIME_PROP_ID = "1.3.6.1.4.1.311.10.11.128";
...
pub const CERT_STORE_PROV_MSG = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CERT_STORE_PROV_MEMORY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const CERT_STORE_PROV_FILE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const CERT_STORE_PROV_REG = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const CERT_STORE_PROV_PKCS7 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const CERT_STORE_PROV_SERIALIZED = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 6));
pub const CERT_STORE_PROV_FILENAME_A = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 7));
pub const CERT_STORE_PROV_FILENAME_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 8));
pub const CERT_STORE_PROV_FILENAME = @as(i32, 8);
pub const CERT_STORE_PROV_SYSTEM_A = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 9));
pub const CERT_STORE_PROV_SYSTEM_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 10));
pub const CERT_STORE_PROV_SYSTEM = @as(i32, 10);
pub const CERT_STORE_PROV_COLLECTION = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 11));
pub const CERT_STORE_PROV_SYSTEM_REGISTRY_A = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 12));
pub const CERT_STORE_PROV_SYSTEM_REGISTRY_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 13));
pub const CERT_STORE_PROV_SYSTEM_REGISTRY = @as(i32, 13);
pub const CERT_STORE_PROV_PHYSICAL_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 14));
pub const CERT_STORE_PROV_PHYSICAL = @as(i32, 14);
pub const CERT_STORE_PROV_SMART_CARD_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 15));
pub const CERT_STORE_PROV_SMART_CARD = @as(i32, 15);
pub const CERT_STORE_PROV_LDAP_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 16));
pub const CERT_STORE_PROV_LDAP = @as(i32, 16);
pub const CERT_STORE_PROV_PKCS12 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 17));
...
pub const CREDENTIAL_OID_PASSWORD_CREDENTIALS_A = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CREDENTIAL_OID_PASSWORD_CREDENTIALS_W = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
...
pub const CONTEXT_OID_CERTIFICATE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CONTEXT_OID_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const CONTEXT_OID_CTL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const CONTEXT_OID_PKCS7 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const CONTEXT_OID_CAPI2_ANY = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const CONTEXT_OID_OCSP_RESP = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 6));
...
pub const CRYPT_PARAM_ASYNC_RETRIEVAL_COMPLETION = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CRYPT_PARAM_CANCEL_ASYNC_RETRIEVAL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const URL_OID_GET_OBJECT_URL_FUNC = "UrlDllGetObjectUrl";
pub const URL_OID_CERTIFICATE_ISSUER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const URL_OID_CERTIFICATE_CRL_DIST_POINT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const URL_OID_CTL_ISSUER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const URL_OID_CTL_NEXT_UPDATE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const URL_OID_CRL_ISSUER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const URL_OID_CERTIFICATE_FRESHEST_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 6));
pub const URL_OID_CRL_FRESHEST_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 7));
pub const URL_OID_CROSS_CERT_DIST_POINT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 8));
pub const URL_OID_CERTIFICATE_OCSP = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 9));
pub const URL_OID_CERTIFICATE_OCSP_AND_CRL_DIST_POINT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 10));
pub const URL_OID_CERTIFICATE_CRL_DIST_POINT_AND_OCSP = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 11));
pub const URL_OID_CROSS_CERT_SUBJECT_INFO_ACCESS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 12));
pub const URL_OID_CERTIFICATE_ONLY_OCSP = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 13));
pub const TIME_VALID_OID_GET_OBJECT_FUNC = "TimeValidDllGetObject";
pub const TIME_VALID_OID_GET_CTL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const TIME_VALID_OID_GET_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const TIME_VALID_OID_GET_CRL_FROM_CERT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const TIME_VALID_OID_GET_FRESHEST_CRL_FROM_CERT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const TIME_VALID_OID_GET_FRESHEST_CRL_FROM_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const TIME_VALID_OID_FLUSH_OBJECT_FUNC = "TimeValidDllFlushObject";
pub const TIME_VALID_OID_FLUSH_CTL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const TIME_VALID_OID_FLUSH_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const TIME_VALID_OID_FLUSH_CRL_FROM_CERT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const TIME_VALID_OID_FLUSH_FRESHEST_CRL_FROM_CERT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const TIME_VALID_OID_FLUSH_FRESHEST_CRL_FROM_CRL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
...
pub const CERT_TRUST_BEFORE_DISALLOWED_CA_FILETIME = @as(u32, 2097152);
...
pub const CERT_CHAIN_ENABLE_DISALLOWED_CA = @as(u32, 131072);
pub const REVOCATION_OID_CRL_REVOCATION = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
...
pub const CERT_CHAIN_POLICY_BASE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CERT_CHAIN_POLICY_AUTHENTICODE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const CERT_CHAIN_POLICY_AUTHENTICODE_TS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const CERT_CHAIN_POLICY_SSL = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 4));
pub const CERT_CHAIN_POLICY_BASIC_CONSTRAINTS = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 5));
pub const CERT_CHAIN_POLICY_NT_AUTH = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 6));
pub const CERT_CHAIN_POLICY_MICROSOFT_ROOT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 7));
pub const CERT_CHAIN_POLICY_EV = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 8));
pub const CERT_CHAIN_POLICY_SSL_F12 = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 9));
pub const CERT_CHAIN_POLICY_SSL_HPKP_HEADER = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 10));
pub const CERT_CHAIN_POLICY_THIRD_PARTY_ROOT = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 11));
pub const CERT_CHAIN_POLICY_SSL_KEY_PIN = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 12));
...
pub const CERT_RETRIEVE_ISSUER_LOGO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1));
pub const CERT_RETRIEVE_SUBJECT_LOGO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 2));
pub const CERT_RETRIEVE_COMMUNITY_LOGO = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 3));
pub const CERT_RETRIEVE_BIOMETRIC_PREDEFINED_BASE_TYPE = @import("../../../zig.zig").typedConst([*:0]align(1) const u8, @as(i32, 1000));
...
pub const BCRYPT_OPERATION = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(BCRYPT_OPERATION, @enumFromInt(
              (if (o.CIPHER_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.CIPHER_OPERATION) else 0)
            | (if (o.HASH_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.HASH_OPERATION) else 0)
            | (if (o.ASYMMETRIC_ENCRYPTION_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.ASYMMETRIC_ENCRYPTION_OPERATION) else 0)
            | (if (o.SECRET_AGREEMENT_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.SECRET_AGREEMENT_OPERATION) else 0)
            | (if (o.SIGNATURE_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.SIGNATURE_OPERATION) else 0)
            | (if (o.RNG_OPERATION == 1) @intFromEnum(BCRYPT_OPERATION.RNG_OPERATION) else 0)
        ));
    }
};
...
pub const NCRYPT_OPERATION = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NCRYPT_OPERATION, @enumFromInt(
              (if (o.CIPHER_OPERATION == 1) @intFromEnum(NCRYPT_OPERATION.CIPHER_OPERATION) else 0)
            | (if (o.HASH_OPERATION == 1) @intFromEnum(NCRYPT_OPERATION.HASH_OPERATION) else 0)
            | (if (o.ASYMMETRIC_ENCRYPTION_OPERATION == 1) @intFromEnum(NCRYPT_OPERATION.ASYMMETRIC_ENCRYPTION_OPERATION) else 0)
            | (if (o.SECRET_AGREEMENT_OPERATION == 1) @intFromEnum(NCRYPT_OPERATION.SECRET_AGREEMENT_OPERATION) else 0)
            | (if (o.SIGNATURE_OPERATION == 1) @intFromEnum(NCRYPT_OPERATION.SIGNATURE_OPERATION) else 0)
        ));
    }
};
...
pub const CERT_FIND_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_FIND_FLAGS, @enumFromInt(
              (if (o.ANY == 1) @intFromEnum(CERT_FIND_FLAGS.ANY) else 0)
            | (if (o.CERT_ID == 1) @intFromEnum(CERT_FIND_FLAGS.CERT_ID) else 0)
            | (if (o.CTL_USAGE == 1) @intFromEnum(CERT_FIND_FLAGS.CTL_USAGE) else 0)
            | (if (o.EXISTING == 1) @intFromEnum(CERT_FIND_FLAGS.EXISTING) else 0)
            | (if (o.HASH == 1) @intFromEnum(CERT_FIND_FLAGS.HASH) else 0)
            | (if (o.HAS_PRIVATE_KEY == 1) @intFromEnum(CERT_FIND_FLAGS.HAS_PRIVATE_KEY) else 0)
            | (if (o.ISSUER_ATTR == 1) @intFromEnum(CERT_FIND_FLAGS.ISSUER_ATTR) else 0)
            | (if (o.ISSUER_NAME == 1) @intFromEnum(CERT_FIND_FLAGS.ISSUER_NAME) else 0)
            | (if (o.ISSUER_OF == 1) @intFromEnum(CERT_FIND_FLAGS.ISSUER_OF) else 0)
            | (if (o.ISSUER_STR == 1) @intFromEnum(CERT_FIND_FLAGS.ISSUER_STR) else 0)
            | (if (o.KEY_IDENTIFIER == 1) @intFromEnum(CERT_FIND_FLAGS.KEY_IDENTIFIER) else 0)
            | (if (o.KEY_SPEC == 1) @intFromEnum(CERT_FIND_FLAGS.KEY_SPEC) else 0)
            | (if (o.MD5_HASH == 1) @intFromEnum(CERT_FIND_FLAGS.MD5_HASH) else 0)
            | (if (o.PROPERTY == 1) @intFromEnum(CERT_FIND_FLAGS.PROPERTY) else 0)
            | (if (o.PUBLIC_KEY == 1) @intFromEnum(CERT_FIND_FLAGS.PUBLIC_KEY) else 0)
            | (if (o.SIGNATURE_HASH == 1) @intFromEnum(CERT_FIND_FLAGS.SIGNATURE_HASH) else 0)
            | (if (o.SUBJECT_ATTR == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_ATTR) else 0)
            | (if (o.SUBJECT_CERT == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_CERT) else 0)
            | (if (o.SUBJECT_NAME == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_NAME) else 0)
            | (if (o.SUBJECT_STR == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_STR) else 0)
            | (if (o.CROSS_CERT_DIST_POINTS == 1) @intFromEnum(CERT_FIND_FLAGS.CROSS_CERT_DIST_POINTS) else 0)
            | (if (o.PUBKEY_MD5_HASH == 1) @intFromEnum(CERT_FIND_FLAGS.PUBKEY_MD5_HASH) else 0)
            | (if (o.SUBJECT_STR_A == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_STR_A) else 0)
            | (if (o.ISSUER_STR_A == 1) @intFromEnum(CERT_FIND_FLAGS.ISSUER_STR_A) else 0)
            | (if (o.SUBJECT_INFO_ACCESS == 1) @intFromEnum(CERT_FIND_FLAGS.SUBJECT_INFO_ACCESS) else 0)
            | (if (o.HASH_STR == 1) @intFromEnum(CERT_FIND_FLAGS.HASH_STR) else 0)
            | (if (o.OPTIONAL_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.OPTIONAL_ENHKEY_USAGE_FLAG) else 0)
            | (if (o.EXT_ONLY_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.EXT_ONLY_ENHKEY_USAGE_FLAG) else 0)
            | (if (o.PROP_ONLY_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.PROP_ONLY_ENHKEY_USAGE_FLAG) else 0)
            | (if (o.NO_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.NO_ENHKEY_USAGE_FLAG) else 0)
            | (if (o.OR_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.OR_ENHKEY_USAGE_FLAG) else 0)
            | (if (o.VALID_ENHKEY_USAGE_FLAG == 1) @intFromEnum(CERT_FIND_FLAGS.VALID_ENHKEY_USAGE_FLAG) else 0)
        ));
    }
};
...
pub const CERT_QUERY_ENCODING_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_QUERY_ENCODING_TYPE, @enumFromInt(
              (if (o.X509_ASN_ENCODING == 1) @intFromEnum(CERT_QUERY_ENCODING_TYPE.X509_ASN_ENCODING) else 0)
            | (if (o.PKCS_7_ASN_ENCODING == 1) @intFromEnum(CERT_QUERY_ENCODING_TYPE.PKCS_7_ASN_ENCODING) else 0)
        ));
    }
};
...
pub const CERT_RDN_ATTR_VALUE_TYPE = enum(i32) {
    ANY_TYPE = 0,
    NUMERIC_STRING = 3,
    PRINTABLE_STRING = 4,
    T61_STRING = 5,
...
pub const BCRYPT_FLAGS = enum(u32) {
    BLOCK_PADDING = 1,
    // PAD_NONE = 1, this enum value conflicts with BLOCK_PADDING
    PAD_OAEP = 4,
    PAD_PKCS1 = 2,
    PAD_PSS = 8,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(BCRYPT_FLAGS, @enumFromInt(
              (if (o.BLOCK_PADDING == 1) @intFromEnum(BCRYPT_FLAGS.BLOCK_PADDING) else 0)
            | (if (o.PAD_OAEP == 1) @intFromEnum(BCRYPT_FLAGS.PAD_OAEP) else 0)
            | (if (o.PAD_PKCS1 == 1) @intFromEnum(BCRYPT_FLAGS.PAD_PKCS1) else 0)
            | (if (o.PAD_PSS == 1) @intFromEnum(BCRYPT_FLAGS.PAD_PSS) else 0)
        ));
    }
};
pub const BCRYPT_BLOCK_PADDING = BCRYPT_FLAGS.BLOCK_PADDING;
pub const BCRYPT_PAD_NONE = BCRYPT_FLAGS.BLOCK_PADDING;
pub const BCRYPT_PAD_OAEP = BCRYPT_FLAGS.PAD_OAEP;
pub const BCRYPT_PAD_PKCS1 = BCRYPT_FLAGS.PAD_PKCS1;
pub const BCRYPT_PAD_PSS = BCRYPT_FLAGS.PAD_PSS;
...
pub const NCRYPT_FLAGS = enum(u32) {
    ...
    PAD_OAEP_FLAG = 4,
    PAD_PKCS1_FLAG = 2,
    // REGISTER_NOTIFY_FLAG = 1, this enum value conflicts with NO_PADDING_FLAG
    // UNREGISTER_NOTIFY_FLAG = 2, this enum value conflicts with PAD_PKCS1_FLAG
    MACHINE_KEY_FLAG = 32,
    // UNPROTECT_NO_DECRYPT = 1, this enum value conflicts with NO_PADDING_FLAG
    OVERWRITE_KEY_FLAG = 128,
    NO_KEY_VALIDATION = 8,
    WRITE_KEY_TO_LEGACY_STORE_FLAG = 512,
    // PAD_PSS_FLAG = 8, this enum value conflicts with NO_KEY_VALIDATION
    PERSIST_FLAG = 2147483648,
    PERSIST_ONLY_FLAG = 1073741824,
    _,
    pub fn initFlags(o: struct {
        SILENT_FLAG: u1 = 0,
        NO_PADDING_FLAG: u1 = 0,
        PAD_OAEP_FLAG: u1 = 0,
        PAD_PKCS1_FLAG: u1 = 0,
        MACHINE_KEY_FLAG: u1 = 0,
        OVERWRITE_KEY_FLAG: u1 = 0,
        NO_KEY_VALIDATION: u1 = 0,
        WRITE_KEY_TO_LEGACY_STORE_FLAG: u1 = 0,
        PERSIST_FLAG: u1 = 0,
        PERSIST_ONLY_FLAG: u1 = 0,
    }) NCRYPT_FLAGS {
        return @as(NCRYPT_FLAGS, @enumFromInt(
              (if (o.SILENT_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.SILENT_FLAG) else 0)
            | (if (o.NO_PADDING_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NO_PADDING_FLAG) else 0)
            | (if (o.PAD_OAEP_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.PAD_OAEP_FLAG) else 0)
            | (if (o.PAD_PKCS1_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.PAD_PKCS1_FLAG) else 0)
            | (if (o.MACHINE_KEY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.MACHINE_KEY_FLAG) else 0)
            | (if (o.OVERWRITE_KEY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.OVERWRITE_KEY_FLAG) else 0)
            | (if (o.NO_KEY_VALIDATION == 1) @intFromEnum(NCRYPT_FLAGS.NO_KEY_VALIDATION) else 0)
            | (if (o.WRITE_KEY_TO_LEGACY_STORE_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.WRITE_KEY_TO_LEGACY_STORE_FLAG) else 0)
            | (if (o.PERSIST_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.PERSIST_FLAG) else 0)
            | (if (o.PERSIST_ONLY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.PERSIST_ONLY_FLAG) else 0)
        ));
    }
};
pub const NCRYPT_SILENT_FLAG = NCRYPT_FLAGS.SILENT_FLAG;
pub const NCRYPT_NO_PADDING_FLAG = NCRYPT_FLAGS.NO_PADDING_FLAG;
pub const NCRYPT_PAD_OAEP_FLAG = NCRYPT_FLAGS.PAD_OAEP_FLAG;
pub const NCRYPT_PAD_PKCS1_FLAG = NCRYPT_FLAGS.PAD_PKCS1_FLAG;
pub const NCRYPT_REGISTER_NOTIFY_FLAG = NCRYPT_FLAGS.NO_PADDING_FLAG;
pub const NCRYPT_UNREGISTER_NOTIFY_FLAG = NCRYPT_FLAGS.PAD_PKCS1_FLAG;
pub const NCRYPT_MACHINE_KEY_FLAG = NCRYPT_FLAGS.MACHINE_KEY_FLAG;
pub const NCRYPT_UNPROTECT_NO_DECRYPT = NCRYPT_FLAGS.NO_PADDING_FLAG;
pub const NCRYPT_OVERWRITE_KEY_FLAG = NCRYPT_FLAGS.OVERWRITE_KEY_FLAG;
pub const NCRYPT_NO_KEY_VALIDATION = NCRYPT_FLAGS.NO_KEY_VALIDATION;
pub const NCRYPT_WRITE_KEY_TO_LEGACY_STORE_FLAG = NCRYPT_FLAGS.WRITE_KEY_TO_LEGACY_STORE_FLAG;
pub const NCRYPT_PAD_PSS_FLAG = NCRYPT_FLAGS.NO_KEY_VALIDATION;
pub const NCRYPT_PERSIST_FLAG = NCRYPT_FLAGS.PERSIST_FLAG;
pub const NCRYPT_PERSIST_ONLY_FLAG = NCRYPT_FLAGS.PERSIST_ONLY_FLAG;
...
pub const CRYPT_IMPORT_PUBLIC_KEY_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_IMPORT_PUBLIC_KEY_FLAGS, @enumFromInt(
              (if (o.SIGN_KEY_FLAG == 1) @intFromEnum(CRYPT_IMPORT_PUBLIC_KEY_FLAGS.SIGN_KEY_FLAG) else 0)
            | (if (o.ENCRYPT_KEY_FLAG == 1) @intFromEnum(CRYPT_IMPORT_PUBLIC_KEY_FLAGS.ENCRYPT_KEY_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_ENCODE_OBJECT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_ENCODE_OBJECT_FLAGS, @enumFromInt(
              (if (o.ENCODE_ALLOC_FLAG == 1) @intFromEnum(CRYPT_ENCODE_OBJECT_FLAGS.ENCODE_ALLOC_FLAG) else 0)
            | (if (o.ENCODE_ENABLE_PUNYCODE_FLAG == 1) @intFromEnum(CRYPT_ENCODE_OBJECT_FLAGS.ENCODE_ENABLE_PUNYCODE_FLAG) else 0)
            | (if (o.UNICODE_NAME_ENCODE_DISABLE_CHECK_TYPE_FLAG == 1) @intFromEnum(CRYPT_ENCODE_OBJECT_FLAGS.UNICODE_NAME_ENCODE_DISABLE_CHECK_TYPE_FLAG) else 0)
            | (if (o.UNICODE_NAME_ENCODE_ENABLE_T61_UNICODE_FLAG == 1) @intFromEnum(CRYPT_ENCODE_OBJECT_FLAGS.UNICODE_NAME_ENCODE_ENABLE_T61_UNICODE_FLAG) else 0)
            | (if (o.UNICODE_NAME_ENCODE_ENABLE_UTF8_UNICODE_FLAG == 1) @intFromEnum(CRYPT_ENCODE_OBJECT_FLAGS.UNICODE_NAME_ENCODE_ENABLE_UTF8_UNICODE_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_ACQUIRE_FLAGS = enum(u32) {
    ...
    NO_HEALING = 8,
    SILENT_FLAG = 64,
    WINDOW_HANDLE_FLAG = 128,
    NCRYPT_KEY_FLAGS_MASK = 458752,
    ALLOW_NCRYPT_KEY_FLAG = 65536,
    PREFER_NCRYPT_KEY_FLAG = 131072,
    ONLY_NCRYPT_KEY_FLAG = 262144,
    _,
    pub fn initFlags(o: struct {
        CACHE_FLAG: u1 = 0,
        ...
        NO_HEALING: u1 = 0,
        SILENT_FLAG: u1 = 0,
        WINDOW_HANDLE_FLAG: u1 = 0,
        NCRYPT_KEY_FLAGS_MASK: u1 = 0,
        ALLOW_NCRYPT_KEY_FLAG: u1 = 0,
        PREFER_NCRYPT_KEY_FLAG: u1 = 0,
        ONLY_NCRYPT_KEY_FLAG: u1 = 0,
    }) CRYPT_ACQUIRE_FLAGS {
        return @as(CRYPT_ACQUIRE_FLAGS, @enumFromInt(
              (if (o.CACHE_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.CACHE_FLAG) else 0)
            | (if (o.USE_PROV_INFO_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.USE_PROV_INFO_FLAG) else 0)
            | (if (o.COMPARE_KEY_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.COMPARE_KEY_FLAG) else 0)
            | (if (o.NO_HEALING == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.NO_HEALING) else 0)
            | (if (o.SILENT_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.SILENT_FLAG) else 0)
            | (if (o.WINDOW_HANDLE_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.WINDOW_HANDLE_FLAG) else 0)
            | (if (o.NCRYPT_KEY_FLAGS_MASK == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.NCRYPT_KEY_FLAGS_MASK) else 0)
            | (if (o.ALLOW_NCRYPT_KEY_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.ALLOW_NCRYPT_KEY_FLAG) else 0)
            | (if (o.PREFER_NCRYPT_KEY_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.PREFER_NCRYPT_KEY_FLAG) else 0)
            | (if (o.ONLY_NCRYPT_KEY_FLAG == 1) @intFromEnum(CRYPT_ACQUIRE_FLAGS.ONLY_NCRYPT_KEY_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_ACQUIRE_WINDOW_HANDLE_FLAG = CRYPT_ACQUIRE_FLAGS.WINDOW_HANDLE_FLAG;
pub const CRYPT_ACQUIRE_NCRYPT_KEY_FLAGS_MASK = CRYPT_ACQUIRE_FLAGS.NCRYPT_KEY_FLAGS_MASK;
pub const CRYPT_ACQUIRE_ALLOW_NCRYPT_KEY_FLAG = CRYPT_ACQUIRE_FLAGS.ALLOW_NCRYPT_KEY_FLAG;
pub const CRYPT_ACQUIRE_PREFER_NCRYPT_KEY_FLAG = CRYPT_ACQUIRE_FLAGS.PREFER_NCRYPT_KEY_FLAG;
pub const CRYPT_ACQUIRE_ONLY_NCRYPT_KEY_FLAG = CRYPT_ACQUIRE_FLAGS.ONLY_NCRYPT_KEY_FLAG;
...
pub const CRYPT_GET_URL_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_GET_URL_FLAGS, @enumFromInt(
              (if (o.PROPERTY == 1) @intFromEnum(CRYPT_GET_URL_FLAGS.PROPERTY) else 0)
            | (if (o.EXTENSION == 1) @intFromEnum(CRYPT_GET_URL_FLAGS.EXTENSION) else 0)
            | (if (o.UNAUTH_ATTRIBUTE == 1) @intFromEnum(CRYPT_GET_URL_FLAGS.UNAUTH_ATTRIBUTE) else 0)
            | (if (o.AUTH_ATTRIBUTE == 1) @intFromEnum(CRYPT_GET_URL_FLAGS.AUTH_ATTRIBUTE) else 0)
        ));
    }
};
...
pub const CERT_FIND_CHAIN_IN_STORE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_FIND_CHAIN_IN_STORE_FLAGS, @enumFromInt(
              (if (o.COMPARE_KEY_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.COMPARE_KEY_FLAG) else 0)
            | (if (o.COMPLEX_CHAIN_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.COMPLEX_CHAIN_FLAG) else 0)
            | (if (o.CACHE_ONLY_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.CACHE_ONLY_FLAG) else 0)
            | (if (o.CACHE_ONLY_URL_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.CACHE_ONLY_URL_FLAG) else 0)
            | (if (o.LOCAL_MACHINE_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.LOCAL_MACHINE_FLAG) else 0)
            | (if (o.NO_KEY_FLAG == 1) @intFromEnum(CERT_FIND_CHAIN_IN_STORE_FLAGS.NO_KEY_FLAG) else 0)
        ));
    }
};
...
pub const BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS, @enumFromInt(
              (if (o.ALG_HANDLE_HMAC_FLAG == 1) @intFromEnum(BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS.ALG_HANDLE_HMAC_FLAG) else 0)
            | (if (o.PROV_DISPATCH == 1) @intFromEnum(BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS.PROV_DISPATCH) else 0)
            | (if (o.HASH_REUSABLE_FLAG == 1) @intFromEnum(BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS.HASH_REUSABLE_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_KEY_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_KEY_FLAGS, @enumFromInt(
              (if (o.CRYPT_EXPORTABLE == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_EXPORTABLE) else 0)
            | (if (o.CRYPT_USER_PROTECTED == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_USER_PROTECTED) else 0)
            | (if (o.CRYPT_ARCHIVABLE == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_ARCHIVABLE) else 0)
            | (if (o.CRYPT_CREATE_IV == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_CREATE_IV) else 0)
            | (if (o.CRYPT_CREATE_SALT == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_CREATE_SALT) else 0)
            | (if (o.CRYPT_DATA_KEY == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_DATA_KEY) else 0)
            | (if (o.CRYPT_FORCE_KEY_PROTECTION_HIGH == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_FORCE_KEY_PROTECTION_HIGH) else 0)
            | (if (o.CRYPT_KEK == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_KEK) else 0)
            | (if (o.CRYPT_INITIATOR == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_INITIATOR) else 0)
            | (if (o.CRYPT_NO_SALT == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_NO_SALT) else 0)
            | (if (o.CRYPT_ONLINE == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_ONLINE) else 0)
            | (if (o.CRYPT_SF == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_SF) else 0)
            | (if (o.CRYPT_SGCKEY == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_SGCKEY) else 0)
            | (if (o.CRYPT_VOLATILE == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_VOLATILE) else 0)
            | (if (o.CRYPT_MACHINE_KEYSET == 1) @intFromEnum(CRYPT_KEY_FLAGS.CRYPT_MACHINE_KEYSET) else 0)
        ));
    }
};
...
pub const CERT_OPEN_STORE_FLAGS = enum(u32) {
    ...
    _,
    pub fn initFlags(o: struct {
        BACKUP_RESTORE_FLAG: u1 = 0,
        CREATE_NEW_FLAG: u1 = 0,
        DEFER_CLOSE_UNTIL_LAST_FREE_FLAG: u1 = 0,
        DELETE_FLAG: u1 = 0,
        ENUM_ARCHIVED_FLAG: u1 = 0,
        MAXIMUM_ALLOWED_FLAG: u1 = 0,
        NO_CRYPT_RELEASE_FLAG: u1 = 0,
        OPEN_EXISTING_FLAG: u1 = 0,
        READONLY_FLAG: u1 = 0,
        SET_LOCALIZED_NAME_FLAG: u1 = 0,
        SHARE_CONTEXT_FLAG: u1 = 0,
        UPDATE_KEYID_FLAG: u1 = 0,
    }) CERT_OPEN_STORE_FLAGS {
        return @as(CERT_OPEN_STORE_FLAGS, @enumFromInt(
              (if (o.BACKUP_RESTORE_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.BACKUP_RESTORE_FLAG) else 0)
            | (if (o.CREATE_NEW_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.CREATE_NEW_FLAG) else 0)
            | (if (o.DEFER_CLOSE_UNTIL_LAST_FREE_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.DEFER_CLOSE_UNTIL_LAST_FREE_FLAG) else 0)
            | (if (o.DELETE_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.DELETE_FLAG) else 0)
            | (if (o.ENUM_ARCHIVED_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.ENUM_ARCHIVED_FLAG) else 0)
            | (if (o.MAXIMUM_ALLOWED_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.MAXIMUM_ALLOWED_FLAG) else 0)
            | (if (o.NO_CRYPT_RELEASE_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.NO_CRYPT_RELEASE_FLAG) else 0)
            | (if (o.OPEN_EXISTING_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.OPEN_EXISTING_FLAG) else 0)
            | (if (o.READONLY_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.READONLY_FLAG) else 0)
            | (if (o.SET_LOCALIZED_NAME_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.SET_LOCALIZED_NAME_FLAG) else 0)
            | (if (o.SHARE_CONTEXT_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.SHARE_CONTEXT_FLAG) else 0)
            | (if (o.UPDATE_KEYID_FLAG == 1) @intFromEnum(CERT_OPEN_STORE_FLAGS.UPDATE_KEYID_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_DEFAULT_CONTEXT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_DEFAULT_CONTEXT_FLAGS, @enumFromInt(
              (if (o.AUTO_RELEASE_FLAG == 1) @intFromEnum(CRYPT_DEFAULT_CONTEXT_FLAGS.AUTO_RELEASE_FLAG) else 0)
            | (if (o.PROCESS_FLAG == 1) @intFromEnum(CRYPT_DEFAULT_CONTEXT_FLAGS.PROCESS_FLAG) else 0)
        ));
    }
};
...
pub const CERT_CREATE_SELFSIGN_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_CREATE_SELFSIGN_FLAGS, @enumFromInt(
              (if (o.KEY_INFO == 1) @intFromEnum(CERT_CREATE_SELFSIGN_FLAGS.KEY_INFO) else 0)
            | (if (o.SIGN == 1) @intFromEnum(CERT_CREATE_SELFSIGN_FLAGS.SIGN) else 0)
        ));
    }
};
...
pub const BCRYPT_RESOLVE_PROVIDERS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(BCRYPT_RESOLVE_PROVIDERS_FLAGS, @enumFromInt(
              (if (o.FUNCTIONS == 1) @intFromEnum(BCRYPT_RESOLVE_PROVIDERS_FLAGS.FUNCTIONS) else 0)
            | (if (o.PROVIDERS == 1) @intFromEnum(BCRYPT_RESOLVE_PROVIDERS_FLAGS.PROVIDERS) else 0)
        ));
    }
};
...
pub const CRYPT_IMAGE_REF_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_IMAGE_REF_FLAGS, @enumFromInt(
              (if (o.MIN_DEPENDENCIES == 1) @intFromEnum(CRYPT_IMAGE_REF_FLAGS.MIN_DEPENDENCIES) else 0)
            | (if (o.PROCESS_ISOLATE == 1) @intFromEnum(CRYPT_IMAGE_REF_FLAGS.PROCESS_ISOLATE) else 0)
        ));
    }
};
...
pub const CERT_ROOT_PROGRAM_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_ROOT_PROGRAM_FLAGS, @enumFromInt(
              (if (o.LSC == 1) @intFromEnum(CERT_ROOT_PROGRAM_FLAGS.LSC) else 0)
            | (if (o.ORG == 1) @intFromEnum(CERT_ROOT_PROGRAM_FLAGS.ORG) else 0)
            | (if (o.SUBJECT_LOGO == 1) @intFromEnum(CERT_ROOT_PROGRAM_FLAGS.SUBJECT_LOGO) else 0)
        ));
    }
};
...
pub const CERT_STORE_PROV_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_STORE_PROV_FLAGS, @enumFromInt(
              (if (o.EXTERNAL_FLAG == 1) @intFromEnum(CERT_STORE_PROV_FLAGS.EXTERNAL_FLAG) else 0)
            | (if (o.DELETED_FLAG == 1) @intFromEnum(CERT_STORE_PROV_FLAGS.DELETED_FLAG) else 0)
            | (if (o.NO_PERSIST_FLAG == 1) @intFromEnum(CERT_STORE_PROV_FLAGS.NO_PERSIST_FLAG) else 0)
            | (if (o.SYSTEM_STORE_FLAG == 1) @intFromEnum(CERT_STORE_PROV_FLAGS.SYSTEM_STORE_FLAG) else 0)
            | (if (o.LM_SYSTEM_STORE_FLAG == 1) @intFromEnum(CERT_STORE_PROV_FLAGS.LM_SYSTEM_STORE_FLAG) else 0)
        ));
    }
};
...
pub const CRYPT_CONTEXT_CONFIG_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_CONTEXT_CONFIG_FLAGS, @enumFromInt(
              (if (o.EXCLUSIVE == 1) @intFromEnum(CRYPT_CONTEXT_CONFIG_FLAGS.EXCLUSIVE) else 0)
            | (if (o.OVERRIDE == 1) @intFromEnum(CRYPT_CONTEXT_CONFIG_FLAGS.OVERRIDE) else 0)
        ));
    }
};
...
pub const CERT_STRONG_SIGN_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_STRONG_SIGN_FLAGS, @enumFromInt(
              (if (o.CRL_CHECK == 1) @intFromEnum(CERT_STRONG_SIGN_FLAGS.CRL_CHECK) else 0)
            | (if (o.OCSP_CHECK == 1) @intFromEnum(CERT_STRONG_SIGN_FLAGS.OCSP_CHECK) else 0)
        ));
    }
};
...
pub const CRYPT_XML_TRANSFORM_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPT_XML_TRANSFORM_FLAGS, @enumFromInt(
              (if (o.ON_STREAM == 1) @intFromEnum(CRYPT_XML_TRANSFORM_FLAGS.ON_STREAM) else 0)
            | (if (o.ON_NODESET == 1) @intFromEnum(CRYPT_XML_TRANSFORM_FLAGS.ON_NODESET) else 0)
            | (if (o.URI_QUERY_STRING == 1) @intFromEnum(CRYPT_XML_TRANSFORM_FLAGS.URI_QUERY_STRING) else 0)
        ));
    }
};
...
pub const BCRYPTGENRANDOM_FLAGS = enum(u32) {
    RNG_USE_ENTROPY_IN_BUFFER = 1,
    USE_SYSTEM_PREFERRED_RNG = 2,
};
pub const BCRYPT_RNG_USE_ENTROPY_IN_BUFFER = BCRYPTGENRANDOM_FLAGS.RNG_USE_ENTROPY_IN_BUFFER;
pub const BCRYPT_USE_SYSTEM_PREFERRED_RNG = BCRYPTGENRANDOM_FLAGS.USE_SYSTEM_PREFERRED_RNG;

pub const SIGNER_SIGN_FLAGS = enum(u32) {
    IG_APPEND = 4096,
    PC_INC_PE_RESOURCES_FLAG = 128,
    PC_INC_PE_DEBUG_INFO_FLAG = 64,
    PC_INC_PE_IMPORT_ADDR_TABLE_FLAG = 32,
    PC_EXC_PE_PAGE_HASHES_FLAG = 16,
    PC_INC_PE_PAGE_HASHES_FLAG = 256,
    PC_DIGEST_GENERATE_FLAG = 512,
    PC_DIGEST_SIGN_FLAG = 1024,
    PC_DIGEST_SIGN_EX_FLAG = 16384,
    _,
    pub fn initFlags(o: struct {
        IG_APPEND: u1 = 0,
        PC_INC_PE_RESOURCES_FLAG: u1 = 0,
        PC_INC_PE_DEBUG_INFO_FLAG: u1 = 0,
        PC_INC_PE_IMPORT_ADDR_TABLE_FLAG: u1 = 0,
        PC_EXC_PE_PAGE_HASHES_FLAG: u1 = 0,
        PC_INC_PE_PAGE_HASHES_FLAG: u1 = 0,
        PC_DIGEST_GENERATE_FLAG: u1 = 0,
        PC_DIGEST_SIGN_FLAG: u1 = 0,
        PC_DIGEST_SIGN_EX_FLAG: u1 = 0,
    }) SIGNER_SIGN_FLAGS {
        return @as(SIGNER_SIGN_FLAGS, @enumFromInt(
              (if (o.IG_APPEND == 1) @intFromEnum(SIGNER_SIGN_FLAGS.IG_APPEND) else 0)
            | (if (o.PC_INC_PE_RESOURCES_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_INC_PE_RESOURCES_FLAG) else 0)
            | (if (o.PC_INC_PE_DEBUG_INFO_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_INC_PE_DEBUG_INFO_FLAG) else 0)
            | (if (o.PC_INC_PE_IMPORT_ADDR_TABLE_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_INC_PE_IMPORT_ADDR_TABLE_FLAG) else 0)
            | (if (o.PC_EXC_PE_PAGE_HASHES_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_EXC_PE_PAGE_HASHES_FLAG) else 0)
            | (if (o.PC_INC_PE_PAGE_HASHES_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_INC_PE_PAGE_HASHES_FLAG) else 0)
            | (if (o.PC_DIGEST_GENERATE_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_DIGEST_GENERATE_FLAG) else 0)
            | (if (o.PC_DIGEST_SIGN_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_DIGEST_SIGN_FLAG) else 0)
            | (if (o.PC_DIGEST_SIGN_EX_FLAG == 1) @intFromEnum(SIGNER_SIGN_FLAGS.PC_DIGEST_SIGN_EX_FLAG) else 0)
        ));
    }
};
pub const SIG_APPEND = SIGNER_SIGN_FLAGS.IG_APPEND;
pub const SPC_INC_PE_RESOURCES_FLAG = SIGNER_SIGN_FLAGS.PC_INC_PE_RESOURCES_FLAG;
pub const SPC_INC_PE_DEBUG_INFO_FLAG = SIGNER_SIGN_FLAGS.PC_INC_PE_DEBUG_INFO_FLAG;
pub const SPC_INC_PE_IMPORT_ADDR_TABLE_FLAG = SIGNER_SIGN_FLAGS.PC_INC_PE_IMPORT_ADDR_TABLE_FLAG;
pub const SPC_EXC_PE_PAGE_HASHES_FLAG = SIGNER_SIGN_FLAGS.PC_EXC_PE_PAGE_HASHES_FLAG;
pub const SPC_INC_PE_PAGE_HASHES_FLAG = SIGNER_SIGN_FLAGS.PC_INC_PE_PAGE_HASHES_FLAG;
pub const SPC_DIGEST_GENERATE_FLAG = SIGNER_SIGN_FLAGS.PC_DIGEST_GENERATE_FLAG;
pub const SPC_DIGEST_SIGN_FLAG = SIGNER_SIGN_FLAGS.PC_DIGEST_SIGN_FLAG;
pub const SPC_DIGEST_SIGN_EX_FLAG = SIGNER_SIGN_FLAGS.PC_DIGEST_SIGN_EX_FLAG;

pub const SIGNER_TIMESTAMP_FLAGS = enum(u32) {
    AUTHENTICODE = 1,
    RFC3161 = 2,
};
pub const SIGNER_TIMESTAMP_AUTHENTICODE = SIGNER_TIMESTAMP_FLAGS.AUTHENTICODE;
pub const SIGNER_TIMESTAMP_RFC3161 = SIGNER_TIMESTAMP_FLAGS.RFC3161;

pub const SIGNER_SUBJECT_CHOICE = enum(u32) {
    FILE = 1,
    BLOB = 2,
};
pub const SIGNER_SUBJECT_FILE = SIGNER_SUBJECT_CHOICE.FILE;
pub const SIGNER_SUBJECT_BLOB = SIGNER_SUBJECT_CHOICE.BLOB;

pub const SIGNER_SIGNATURE_ATTRIBUTE_CHOICE = enum(u32) {
    NO_ATTR = 0,
    AUTHCODE_ATTR = 1,
};
pub const SIGNER_NO_ATTR = SIGNER_SIGNATURE_ATTRIBUTE_CHOICE.NO_ATTR;
pub const SIGNER_AUTHCODE_ATTR = SIGNER_SIGNATURE_ATTRIBUTE_CHOICE.AUTHCODE_ATTR;

pub const SIGNER_PRIVATE_KEY_CHOICE = enum(u32) {
    FILE_NAME = 1,
    KEYCONTAINER = 2,
};
pub const PVK_TYPE_FILE_NAME = SIGNER_PRIVATE_KEY_CHOICE.FILE_NAME;
pub const PVK_TYPE_KEYCONTAINER = SIGNER_PRIVATE_KEY_CHOICE.KEYCONTAINER;

pub const SIGNER_CERT_POLICY = enum(u32) {
    STORE = 1,
    CHAIN = 2,
    SPC = 4,
    CHAIN_NO_ROOT = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SIGNER_CERT_POLICY, @enumFromInt(
              (if (o.STORE == 1) @intFromEnum(SIGNER_CERT_POLICY.STORE) else 0)
            | (if (o.CHAIN == 1) @intFromEnum(SIGNER_CERT_POLICY.CHAIN) else 0)
            | (if (o.SPC == 1) @intFromEnum(SIGNER_CERT_POLICY.SPC) else 0)
            | (if (o.CHAIN_NO_ROOT == 1) @intFromEnum(SIGNER_CERT_POLICY.CHAIN_NO_ROOT) else 0)
        ));
    }
};
pub const SIGNER_CERT_POLICY_STORE = SIGNER_CERT_POLICY.STORE;
pub const SIGNER_CERT_POLICY_CHAIN = SIGNER_CERT_POLICY.CHAIN;
pub const SIGNER_CERT_POLICY_SPC = SIGNER_CERT_POLICY.SPC;
pub const SIGNER_CERT_POLICY_CHAIN_NO_ROOT = SIGNER_CERT_POLICY.CHAIN_NO_ROOT;

pub const SIGNER_CERT_CHOICE = enum(u32) {
    PC_FILE = 1,
    TORE = 2,
    PC_CHAIN = 3,
};
pub const SIGNER_CERT_SPC_FILE = SIGNER_CERT_CHOICE.PC_FILE;
pub const SIGNER_CERT_STORE = SIGNER_CERT_CHOICE.TORE;
pub const SIGNER_CERT_SPC_CHAIN = SIGNER_CERT_CHOICE.PC_CHAIN;

pub const ALG_ID = enum(u32) {
    MD2 = 32769,
    MD4 = 32770,
    MD5 = 32771,
    SHA = 32772,
    ...
    ECDSA = 8707,
    NULLCIPHER = 24576,
    THIRDPARTY_KEY_EXCHANGE = 45056,
    THIRDPARTY_SIGNATURE = 12288,
    THIRDPARTY_CIPHER = 28672,
    THIRDPARTY_HASH = 36864,
};
pub const CALG_MD2 = ALG_ID.MD2;
pub const CALG_MD4 = ALG_ID.MD4;
pub const CALG_MD5 = ALG_ID.MD5;
pub const CALG_SHA = ALG_ID.SHA;
pub const CALG_SHA1 = ALG_ID.SHA;
pub const CALG_MAC = ALG_ID.MAC;
pub const CALG_RSA_SIGN = ALG_ID.RSA_SIGN;
pub const CALG_DSS_SIGN = ALG_ID.DSS_SIGN;
pub const CALG_NO_SIGN = ALG_ID.NO_SIGN;
pub const CALG_RSA_KEYX = ALG_ID.RSA_KEYX;
pub const CALG_DES = ALG_ID.DES;
pub const CALG_3DES_112 = ALG_ID.@"3DES_112";
pub const CALG_3DES = ALG_ID.@"3DES";
pub const CALG_DESX = ALG_ID.DESX;
pub const CALG_RC2 = ALG_ID.RC2;
pub const CALG_RC4 = ALG_ID.RC4;
pub const CALG_SEAL = ALG_ID.SEAL;
pub const CALG_DH_SF = ALG_ID.DH_SF;
pub const CALG_DH_EPHEM = ALG_ID.DH_EPHEM;
pub const CALG_AGREEDKEY_ANY = ALG_ID.AGREEDKEY_ANY;
pub const CALG_KEA_KEYX = ALG_ID.KEA_KEYX;
pub const CALG_HUGHES_MD5 = ALG_ID.HUGHES_MD5;
pub const CALG_SKIPJACK = ALG_ID.SKIPJACK;
pub const CALG_TEK = ALG_ID.TEK;
pub const CALG_CYLINK_MEK = ALG_ID.CYLINK_MEK;
pub const CALG_SSL3_SHAMD5 = ALG_ID.SSL3_SHAMD5;
pub const CALG_SSL3_MASTER = ALG_ID.SSL3_MASTER;
pub const CALG_SCHANNEL_MASTER_HASH = ALG_ID.SCHANNEL_MASTER_HASH;
pub const CALG_SCHANNEL_MAC_KEY = ALG_ID.SCHANNEL_MAC_KEY;
pub const CALG_SCHANNEL_ENC_KEY = ALG_ID.SCHANNEL_ENC_KEY;
pub const CALG_PCT1_MASTER = ALG_ID.PCT1_MASTER;
pub const CALG_SSL2_MASTER = ALG_ID.SSL2_MASTER;
pub const CALG_TLS1_MASTER = ALG_ID.TLS1_MASTER;
pub const CALG_RC5 = ALG_ID.RC5;
pub const CALG_HMAC = ALG_ID.HMAC;
pub const CALG_TLS1PRF = ALG_ID.TLS1PRF;
pub const CALG_HASH_REPLACE_OWF = ALG_ID.HASH_REPLACE_OWF;
pub const CALG_AES_128 = ALG_ID.AES_128;
pub const CALG_AES_192 = ALG_ID.AES_192;
pub const CALG_AES_256 = ALG_ID.AES_256;
pub const CALG_AES = ALG_ID.AES;
pub const CALG_SHA_256 = ALG_ID.SHA_256;
pub const CALG_SHA_384 = ALG_ID.SHA_384;
pub const CALG_SHA_512 = ALG_ID.SHA_512;
pub const CALG_ECDH = ALG_ID.ECDH;
pub const CALG_ECDH_EPHEM = ALG_ID.ECDH_EPHEM;
pub const CALG_ECMQV = ALG_ID.ECMQV;
pub const CALG_ECDSA = ALG_ID.ECDSA;
pub const CALG_NULLCIPHER = ALG_ID.NULLCIPHER;
pub const CALG_THIRDPARTY_KEY_EXCHANGE = ALG_ID.THIRDPARTY_KEY_EXCHANGE;
pub const CALG_THIRDPARTY_SIGNATURE = ALG_ID.THIRDPARTY_SIGNATURE;
pub const CALG_THIRDPARTY_CIPHER = ALG_ID.THIRDPARTY_CIPHER;
pub const CALG_THIRDPARTY_HASH = ALG_ID.THIRDPARTY_HASH;
...
pub const NCRYPT_UI_POLICY = extern struct {
    dwVersion: u32,
    dwFlags: u32,
    pszCreationTitle: ?[*:0]align(1) const u16,
    pszFriendlyName: ?[*:0]align(1) const u16,
    pszDescription: ?[*:0]align(1) const u16,
};
...
pub const PFN_CRYPT_ENUM_OID_FUNC = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        dwEncodingType: u32,
        pszFuncName: ?[*:0]align(1) const u8,
        pszOID: ?[*:0]align(1) const u8,
        cValue: u32,
        rgdwValueType: [*]const u32,
        rgpwszValueName: [*]const ?[*:0]align(1) const u16,
...
pub const CERT_SYSTEM_STORE_RELOCATE_PARA = extern struct {
    ...
    Anonymous2: extern union {
        ...
        pszSystemStore: ?[*:0]align(1) const u8,
        pwszSystemStore: ?[*:0]align(1) const u16,
    },
};
...
pub const CERT_LDAP_STORE_OPENED_PARA = extern struct {
    ...
    pwszLdapUrl: ?[*:0]align(1) const u16,
};
...
pub const PFN_CERT_DLL_OPEN_STORE_PROV_FUNC = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpszStoreProvider: ?[*:0]align(1) const u8,
...
pub const PFN_CERT_ENUM_SYSTEM_STORE_LOCATION = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pwszStoreLocation: ?[*:0]align(1) const u16,
        dwFlags: u32,
        pvReserved: ?*anyopaque,
        pvArg: ?*anyopaque,
    ) callconv(@import("std").os.windows.WINAPI) BOOL,
...
pub const PFN_CERT_ENUM_PHYSICAL_STORE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pvSystemStore: ?*const anyopaque,
        dwFlags: u32,
        pwszStoreName: ?[*:0]align(1) const u16,
...
pub const CRYPT_VERIFY_CERT_SIGN_WEAK_HASH_INFO = extern struct {
    cCNGHashAlgid: u32,
    rgpwszCNGHashAlgid: ?*const ?PWSTR,
    dwWeakIndex: u32,
};
...
pub const PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        pwszCNGPubKeyAlgid: ?[*:0]align(1) const u16,
        pwszCNGHashAlgid: ?[*:0]align(1) const u16,
...
pub const CRYPT_CREDENTIALS = extern struct {
    cbSize: u32,
    pszCredentialsOid: ?[*:0]align(1) const u8,
...
pub const PFN_FREE_ENCODED_OBJECT_FUNC = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pszObjectOid: ?[*:0]align(1) const u8,
...
pub const CERT_REVOCATION_INFO = extern struct {
    ...
    pszRevocationOid: ?[*:0]align(1) const u8,
...
pub const CERT_CHAIN_ELEMENT = extern struct {
    ...
    pwszExtendedErrorInfo: ?[*:0]align(1) const u16,
};
...
pub const CERT_CHAIN_FIND_BY_ISSUER_PARA = extern struct {
    cbSize: u32,
    pszUsageIdentifier: ?[*:0]align(1) const u8,
    dwKeySpec: u32,
...
pub const SSL_KEY_PIN_EXTRA_CERT_CHAIN_POLICY_PARA = extern struct {
    cbSize: u32,
    dwReserved: u32,
    pwszServerName: ?[*:0]align(1) const u16,
};
...
pub const CRYPT_TIMESTAMP_PARA = extern struct {
    pszTSAPolicyId: ?[*:0]align(1) const u8,
    fRequestCerts: BOOL,
    Nonce: CRYPT_INTEGER_BLOB,
    cExtension: u32,
    rgExtension: ?*CERT_EXTENSION,
...
pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pPluginContext: ?*anyopaque,
        pwszPassword: ?[*:0]align(1) const u16,
    ) callconv(@import("std").os.windows.WINAPI) void,
    else => *const fn(
        pPluginContext: ?*anyopaque,
        pwszPassword: ?[*:0]align(1) const u16,
...
pub const PFN_AUTHENTICODE_DIGEST_SIGN = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pSigningCert: ?*const CERT_CONTEXT,
        pMetadataBlob: ?*CRYPT_INTEGER_BLOB,
        digestAlgId: ALG_ID,
        pbToBeSignedDigest: ?*u8,
...
pub const PFN_AUTHENTICODE_DIGEST_SIGN_EX = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pMetadataBlob: ?*CRYPT_INTEGER_BLOB,
        digestAlgId: ALG_ID,
        pbToBeSignedDigest: ?*u8,
...
pub const PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pMetadataBlob: ?*CRYPT_INTEGER_BLOB,
        digestAlgId: ALG_ID,
        pbToBeSignedDigest: ?*u8,
...
pub const PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        pSigningCert: ?*const CERT_CONTEXT,
        pMetadataBlob: ?*CRYPT_INTEGER_BLOB,
        digestAlgId: ALG_ID,
...
pub const SIGNER_BLOB_INFO = extern struct {
    ...
    cbBlob: u32,
    pbBlob: ?*u8,
    pwszDisplayName: ?[*:0]align(1) const u16,
};
...
pub const SIGNER_SPC_CHAIN_INFO = extern struct {
    cbSize: u32,
    pwszSpcFile: ?[*:0]align(1) const u16,
    dwCertPolicy: u32,
    hCertStore: ?HCERTSTORE,
};
...
pub const SIGNER_DIGEST_SIGN_INFO = extern struct {
    ...
    Anonymous: extern union {
        ...
        pfnAuthenticodeDigestSignWithFileHandle: ?PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE,
        pfnAuthenticodeDigestSignEx: ?PFN_AUTHENTICODE_DIGEST_SIGN_EX,
        pfnAuthenticodeDigestSignExWithFileHandle: ?PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE,
    },
    pMetadataBlob: ?*CRYPT_INTEGER_BLOB,
    dwReserved: u32,
    dwReserved2: u32,
...
pub const SIGNER_PROVIDER_INFO = extern struct {
    cbSize: u32,
    pwszProviderName: ?[*:0]align(1) const u16,
    dwProviderType: u32,
    dwKeySpec: u32,
    dwPvkChoice: SIGNER_PRIVATE_KEY_CHOICE,
    Anonymous: extern union {
        pwszPvkFileName: ?PWSTR,
        pwszKeyContainer: ?PWSTR,
    },
};
...
pub const CRYPT_XML_ALGORITHM = extern struct {
    cbSize: u32,
    wszAlgorithm: ?[*:0]align(1) const u16,
...
pub const CRYPT_XML_KEY_ECDSA_KEY_VALUE = extern struct {
    wszNamedCurve: ?[*:0]align(1) const u16,
...
pub const CRYPT_XML_ISSUER_SERIAL = extern struct {
    wszIssuer: ?[*:0]align(1) const u16,
    wszSerial: ?[*:0]align(1) const u16,
};
...
pub const CRYPT_XML_X509DATA_ITEM = extern struct {
    ...
    Anonymous: extern union {
        ...
        wszSubjectName: ?[*:0]align(1) const u16,
...
pub const CRYPT_XML_KEY_INFO_ITEM = extern struct {
    ...
    Anonymous: extern union {
        wszKeyName: ?[*:0]align(1) const u16,
...
pub const CRYPT_XML_REFERENCE = extern struct {
    ...
    wszId: ?[*:0]align(1) const u16,
    wszUri: ?[*:0]align(1) const u16,
    wszType: ?[*:0]align(1) const u16,
...
pub const CRYPT_XML_OBJECT = extern struct {
    ...
    hObject: ?*anyopaque,
    wszId: ?[*:0]align(1) const u16,
    wszMimeType: ?[*:0]align(1) const u16,
    wszEncoding: ?[*:0]align(1) const u16,
...
pub const POLICY_ELEMENT = extern struct {
    targetEndpointAddress: ?[*:0]align(1) const u16,
    issuerEndpointAddress: ?[*:0]align(1) const u16,
    issuedTokenParameters: ?[*:0]align(1) const u16,
    privacyNoticeLink: ?[*:0]align(1) const u16,
    privacyNoticeVersion: u32,
    useManagedPresentation: BOOL,
};

pub const ENDPOINTADDRESS = extern struct {
    serviceUrl: ?[*:0]align(1) const u16,
    policyUrl: ?[*:0]align(1) const u16,
...
pub const RECIPIENTPOLICY = extern struct {
    ...
    tokenType: ?[*:0]align(1) const u16,
    requiredClaims: CLAIMLIST,
    optionalClaims: CLAIMLIST,
    privacyUrl: ?[*:0]align(1) const u16,
    privacyVersion: u32,
};
...
pub const ICertSrvSetupKeyInformation = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetupKeyInformation_get_Existing(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetupKeyInformation_put_Existing(self: *const T, bVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ICertSrvSetup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_InitializeDefaults(self: *const T, bServer: VARIANT_BOOL, bClient: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_IsPropertyEditable(self: *const T, propertyId: CASetupProperty, pbEditable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_CAImportPFX(self: *const T, bstrFileName: ?BSTR, bstrPasswd: ?BSTR, bOverwriteExistingKey: VARIANT_BOOL, ppVal: ?*?*ICertSrvSetupKeyInformation) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_SetCADistinguishedName(self: *const T, bstrCADN: ?BSTR, bIgnoreUnicode: VARIANT_BOOL, bOverwriteExistingKey: VARIANT_BOOL, bOverwriteExistingCAInDS: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_SetDatabaseInformation(self: *const T, bstrDBDirectory: ?BSTR, bstrLogDirectory: ?BSTR, bstrSharedFolder: ?BSTR, bForceOverwrite: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICertSrvSetup_PreUnInstall(self: *const T, bClientOnly: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IMSCEPSetup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSCEPSetup_IsMSCEPStoreEmpty(self: *const T, pbEmpty: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IMSCEPSetup.VTable, @ptrCast(self.vtable)).IsMSCEPStoreEmpty(@as(*const IMSCEPSetup, @ptrCast(self)), pbEmpty);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSCEPSetup_GetProviderNameList(self: *const T, bExchange: VARIANT_BOOL, pVal: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMSCEPSetup_GetKeyLengthList(self: *const T, bExchange: VARIANT_BOOL, bstrProviderName: ?BSTR, pVal: ?*VARIANT) callconv(.Inline) HRESULT {
...
//--------------------------------------------------------------------------------
// Section: Functions (409)
//--------------------------------------------------------------------------------
pub extern "bcryptprimitives" fn SystemPrng(
    // TODO: what to do with BytesParamIndex 1?
    pbRandomData: ?*u8,
    cbRandomData: usize,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "bcryptprimitives" fn ProcessPrng(
    // TODO: what to do with BytesParamIndex 1?
    pbData: ?*u8,
    cbData: usize,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CryptAcquireContextA(
    phProv: ?*usize,
    szContainer: ?[*:0]align(1) const u8,
    szProvider: ?[*:0]align(1) const u8,
    dwProvType: u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CryptAcquireContextW(
    phProv: ?*usize,
    szContainer: ?[*:0]align(1) const u16,
    szProvider: ?[*:0]align(1) const u16,
    dwProvType: u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CryptSignHashA(
    hHash: usize,
    dwKeySpec: u32,
    szDescription: ?[*:0]align(1) const u8,
    dwFlags: u32,
    // TODO: what to do with BytesParamIndex 5?
    pbSignature: ?*u8,
    pdwSigLen: ?*u32,
...
pub extern "advapi32" fn CryptSignHashW(
    hHash: usize,
    dwKeySpec: u32,
    szDescription: ?[*:0]align(1) const u16,
    dwFlags: u32,
    // TODO: what to do with BytesParamIndex 5?
    pbSignature: ?*u8,
    pdwSigLen: ?*u32,
...
pub extern "advapi32" fn CryptSetProviderA(
    pszProvName: ?[*:0]align(1) const u8,
    dwProvType: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn CryptSetProviderW(
    pszProvName: ?[*:0]align(1) const u16,
    dwProvType: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "bcrypt" fn BCryptOpenAlgorithmProvider(
    ...
    pszAlgId: ?[*:0]align(1) const u16,
    pszImplementation: ?[*:0]align(1) const u16,
...
pub extern "bcrypt" fn BCryptGetProperty(
    ...
    pszProperty: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 3?
    pbOutput: ?*u8,
    cbOutput: u32,
    pcbResult: ?*u32,
...
pub extern "bcrypt" fn BCryptExportKey(
    ...
    pszBlobType: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 4?
    pbOutput: ?*u8,
    cbOutput: u32,
    pcbResult: ?*u32,
...
pub extern "bcrypt" fn BCryptQueryProviderRegistration(
    pszProvider: ?[*:0]align(1) const u16,
...
pub extern "bcrypt" fn BCryptCreateContext(
    ...
    pszContext: ?[*:0]align(1) const u16,
...
pub extern "bcrypt" fn BCryptAddContextFunction(
    ...
    pszContext: ?[*:0]align(1) const u16,
    dwInterface: BCRYPT_INTERFACE,
    pszFunction: ?[*:0]align(1) const u16,
    dwPosition: u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "ncrypt" fn NCryptOpenStorageProvider(
    ...
    pszProviderName: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "ncrypt" fn NCryptCreatePersistedKey(
    ...
    pszAlgId: ?[*:0]align(1) const u16,
    pszKeyName: ?[*:0]align(1) const u16,
    dwLegacyKeySpec: CERT_KEY_SPEC,
    dwFlags: NCRYPT_FLAGS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "crypt32" fn CryptFormatObject(
    ...
    lpszStructType: ?[*:0]align(1) const u8,
    // TODO: what to do with BytesParamIndex 6?
    pbEncoded: ?*const u8,
    cbEncoded: u32,
...
pub extern "crypt32" fn CryptRegisterOIDFunction(
    ...
    pszOID: ?[*:0]align(1) const u8,
    pwszDll: ?[*:0]align(1) const u16,
    pszOverrideFuncName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "crypt32" fn CryptSetOIDFunctionValue(
    ...
    pszFuncName: ?[*:0]align(1) const u8,
    pszOID: ?[*:0]align(1) const u8,
    pwszValueName: ?[*:0]align(1) const u16,
...
pub extern "crypt32" fn CryptFindLocalizedName(
    pwszCryptName: ?[*:0]align(1) const u16,
...
pub extern "crypt32" fn CertStrToNameA(
    dwCertEncodingType: CERT_QUERY_ENCODING_TYPE,
    pszX500: ?[*:0]align(1) const u8,
    dwStrType: CERT_STRING_TYPE,
    pvReserved: ?*anyopaque,
    // TODO: what to do with BytesParamIndex 5?
    pbEncoded: ?*u8,
    pcbEncoded: ?*u32,
    ppszError: ?*const ?PSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "crypt32" fn CertStrToNameW(
    dwCertEncodingType: CERT_QUERY_ENCODING_TYPE,
    pszX500: ?[*:0]align(1) const u16,
    dwStrType: CERT_STRING_TYPE,
    pvReserved: ?*anyopaque,
    // TODO: what to do with BytesParamIndex 5?
    pbEncoded: ?*u8,
    pcbEncoded: ?*u32,
    ppszError: ?*const ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "crypt32" fn CertOpenSystemStoreA(
    ...
    szSubsystemProtocol: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) ?HCERTSTORE;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "crypt32" fn CertOpenSystemStoreW(
    hProv: HCRYPTPROV_LEGACY,
    szSubsystemProtocol: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) ?HCERTSTORE;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "crypt32" fn CertAddEncodedCertificateToSystemStoreA(
    szCertStoreName: ?[*:0]align(1) const u8,
    // TODO: what to do with BytesParamIndex 2?
    pbCertEncoded: ?*const u8,
    cbCertEncoded: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "crypt32" fn CertAddEncodedCertificateToSystemStoreW(
    szCertStoreName: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 2?
    pbCertEncoded: ?*const u8,
    cbCertEncoded: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wintrust" fn FindCertsByIssuer(
    ...
    pwszPurpose: ?[*:0]align(1) const u16,
    dwKeySpec: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "crypt32" fn CryptGetKeyIdentifierProperty(
    ...
    dwPropId: u32,
    dwFlags: u32,
    pwszComputerName: ?[*:0]align(1) const u16,
    pvReserved: ?*anyopaque,
    // TODO: what to do with BytesParamIndex 6?
    pvData: ?*anyopaque,
    pcbData: ?*u32,
...
pub extern "crypt32" fn CryptCreateKeyIdentifierFromCSP(
    dwCertEncodingType: CERT_QUERY_ENCODING_TYPE,
    pszPubKeyOID: ?[*:0]align(1) const u8,
    // TODO: what to do with BytesParamIndex 3?
...
pub extern "crypt32" fn CertVerifyCertificateChainPolicy(
    pszPolicyOID: ?[*:0]align(1) const u8,
    pChainContext: ?*CERT_CHAIN_CONTEXT,
...
pub extern "crypt32" fn PFXImportCertStore(
    ...
    szPassword: ?[*:0]align(1) const u16,
    dwFlags: CRYPT_KEY_FLAGS,
) callconv(@import("std").os.windows.WINAPI) ?HCERTSTORE;
...
pub extern "crypt32" fn CertRetrieveLogoOrBiometricInfo(
    pCertContext: ?*const CERT_CONTEXT,
    lpszLogoOrBiometricType: ?[*:0]align(1) const u8,
    dwRetrievalFlags: u32,
    dwTimeout: u32,
    dwFlags: u32,
    pvReserved: ?*anyopaque,
...
pub extern "crypt32" fn CryptRetrieveTimeStamp(
    wszUrl: ?[*:0]align(1) const u16,
    dwRetrievalFlags: u32,
    dwTimeout: u32,
    pszHashId: ?[*:0]align(1) const u8,
...
pub extern "crypt32" fn CryptProtectData(
    ...
    szDataDescr: ?[*:0]align(1) const u16,
...
pub extern "crypt32" fn CryptUpdateProtectedState(
    pOldSid: ?PSID,
    pwszOldPassword: ?[*:0]align(1) const u16,
    dwFlags: u32,
    pdwSuccessCount: ?*u32,
    pdwFailureCount: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "ncrypt" fn NCryptRegisterProtectionDescriptorName(
    pwszName: ?[*:0]align(1) const u16,
    pwszDescriptorString: ?[*:0]align(1) const u16,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mssign32" fn SignError(
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mssign32" fn SignerFreeSignerContext(
    pSignerContext: ?*SIGNER_CONTEXT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mssign32" fn SignerSign(
    ...
    pwszHttpTimeStamp: ?[*:0]align(1) const u16,
    psRequest: ?*CRYPT_ATTRIBUTES,
    pSipData: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mssign32" fn SignerSignEx(
...
pub extern "mssign32" fn SignerSignEx2(
    dwFlags: SIGNER_SIGN_FLAGS,
    pSubjectInfo: ?*SIGNER_SUBJECT_INFO,
    pSignerCert: ?*SIGNER_CERT,
    pSignatureInfo: ?*SIGNER_SIGNATURE_INFO,
    ...
    pszTimestampAlgorithmOid: ?[*:0]align(1) const u8,
    pwszHttpTimeStamp: ?[*:0]align(1) const u16,
    psRequest: ?*CRYPT_ATTRIBUTES,
    pSipData: ?*anyopaque,
    ppSignerContext: ?*?*SIGNER_CONTEXT,
...
pub extern "mssign32" fn SignerSignEx3(
    dwFlags: SIGNER_SIGN_FLAGS,
    pSubjectInfo: ?*SIGNER_SUBJECT_INFO,
    pSignerCert: ?*SIGNER_CERT,
    pSignatureInfo: ?*SIGNER_SIGNATURE_INFO,
    ...
    ppSignerContext: ?*?*SIGNER_CONTEXT,
    pCryptoPolicy: ?*CERT_STRONG_SIGN_PARA,
    pDigestSignInfo: ?*SIGNER_DIGEST_SIGN_INFO,
    pReserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mssign32" fn SignerTimeStamp(
    pSubjectInfo: ?*SIGNER_SUBJECT_INFO,
    pwszHttpTimeStamp: ?[*:0]align(1) const u16,
    psRequest: ?*CRYPT_ATTRIBUTES,
    pSipData: ?*anyopaque,
...
pub extern "mssign32" fn SignerTimeStampEx(
    dwFlags: u32,
    pSubjectInfo: ?*SIGNER_SUBJECT_INFO,
    pwszHttpTimeStamp: ?[*:0]align(1) const u16,
    psRequest: ?*CRYPT_ATTRIBUTES,
...
pub extern "mssign32" fn SignerTimeStampEx2(
...
pub extern "mssign32" fn SignerTimeStampEx3(
    dwFlags: SIGNER_TIMESTAMP_FLAGS,
    dwIndex: u32,
    pSubjectInfo: ?*SIGNER_SUBJECT_INFO,
    pwszHttpTimeStamp: ?[*:0]align(1) const u16,
    pszAlgorithmOid: ?[*:0]align(1) const u16,
    psRequest: ?*CRYPT_ATTRIBUTES,
    pSipData: ?*anyopaque,
    ppSignerContext: ?*?*SIGNER_CONTEXT,
    pCryptoPolicy: ?*CERT_STRONG_SIGN_PARA,
...
pub extern "infocardapi" fn SignHash(
    ...
    // TODO: what to do with BytesParamIndex 1?
    pHash: ?*u8,
    hashAlgOid: ?[*:0]align(1) const u16,
    pcbSig: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    ppSig: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const NCRYPT_DESCRIPTOR_HANDLE = @import("../../../windows/win32/security.zig").NCRYPT_DESCRIPTOR_HANDLE;
const NCRYPT_STREAM_HANDLE = @import("../../../windows/win32/security.zig").NCRYPT_STREAM_HANDLE;
const NTSTATUS = @import("../../../windows/win32/foundation.zig").NTSTATUS;
const OBJECT_SECURITY_INFORMATION = @import("../../../windows/win32/security.zig").OBJECT_SECURITY_INFORMATION;
...
const REG_VALUE_TYPE = @import("../../../windows/win32/system/registry.zig").REG_VALUE_TYPE;
...
test {
    ...
    if (@hasDecl(@This(), "PFN_AUTHENTICODE_DIGEST_SIGN")) { _ = PFN_AUTHENTICODE_DIGEST_SIGN; }
    if (@hasDecl(@This(), "PFN_AUTHENTICODE_DIGEST_SIGN_EX")) { _ = PFN_AUTHENTICODE_DIGEST_SIGN_EX; }
    if (@hasDecl(@This(), "PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE")) { _ = PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE; }
    if (@hasDecl(@This(), "PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE")) { _ = PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE; }
