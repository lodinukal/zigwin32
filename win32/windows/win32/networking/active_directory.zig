...
pub const IPersistQuery = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_WriteString(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, pValue: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_ReadString(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, pBuffer: ?PWSTR, cchBuffer: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_WriteInt(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, value: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_ReadInt(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, pValue: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_WriteStruct(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, pStruct: ?*anyopaque, cbStruct: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPersistQuery_ReadStruct(self: *const T, pSection: ?[*:0]align(1) const u16, pValueName: ?[*:0]align(1) const u16, pStruct: ?*anyopaque, cbStruct: u32) callconv(.Inline) HRESULT {
...
pub const IADsClass = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_get_Abstract(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsClass.VTable, @ptrCast(self.vtable)).get_Abstract(@as(*const IADsClass, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_put_Abstract(self: *const T, fAbstract: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsClass.VTable, @ptrCast(self.vtable)).put_Abstract(@as(*const IADsClass, @ptrCast(self)), fAbstract);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_get_Auxiliary(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsClass.VTable, @ptrCast(self.vtable)).get_Auxiliary(@as(*const IADsClass, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_put_Auxiliary(self: *const T, fAuxiliary: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_get_Container(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsClass.VTable, @ptrCast(self.vtable)).get_Container(@as(*const IADsClass, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsClass_put_Container(self: *const T, fContainer: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsProperty = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsProperty_get_MultiValued(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsProperty.VTable, @ptrCast(self.vtable)).get_MultiValued(@as(*const IADsProperty, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsProperty_put_MultiValued(self: *const T, fMultiValued: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsDomain = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IADs.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsDomain_get_IsWorkgroup(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsComputerOperations = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsComputerOperations_Shutdown(self: *const T, bReboot: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsGroup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsGroup_IsMember(self: *const T, bstrMember: ?BSTR, bMember: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsUser = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_get_AccountDisabled(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsUser.VTable, @ptrCast(self.vtable)).get_AccountDisabled(@as(*const IADsUser, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_put_AccountDisabled(self: *const T, fAccountDisabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_get_IsAccountLocked(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsUser.VTable, @ptrCast(self.vtable)).get_IsAccountLocked(@as(*const IADsUser, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_put_IsAccountLocked(self: *const T, fIsAccountLocked: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_get_PasswordRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsUser.VTable, @ptrCast(self.vtable)).get_PasswordRequired(@as(*const IADsUser, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_put_PasswordRequired(self: *const T, fPasswordRequired: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_get_RequireUniquePassword(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IADsUser.VTable, @ptrCast(self.vtable)).get_RequireUniquePassword(@as(*const IADsUser, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsUser_put_RequireUniquePassword(self: *const T, fRequireUniquePassword: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsSecurityDescriptor = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_get_OwnerDefaulted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_put_OwnerDefaulted(self: *const T, fOwnerDefaulted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_get_GroupDefaulted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_put_GroupDefaulted(self: *const T, fGroupDefaulted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_get_DaclDefaulted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_put_DaclDefaulted(self: *const T, fDaclDefaulted: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_get_SaclDefaulted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsSecurityDescriptor_put_SaclDefaulted(self: *const T, fSaclDefaulted: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IADsADSystemInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IADsADSystemInfo_get_IsNativeMode(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IDsBrowseDomainTree = extern struct {
    pub const VTable = extern struct {
        ...
        SetComputer: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDsBrowseDomainTree,
                pszComputerName: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsBrowseDomainTree_SetComputer(self: *const T, pszComputerName: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszPassword: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const LPDSENUMATTRIBUTES = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        pszDisplayName: ?[*:0]align(1) const u16,
        dwFlags: u32,
    ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    else => *const fn(
        lParam: LPARAM,
...
pub const IDsDisplaySpecifier = extern struct {
    pub const VTable = extern struct {
        ...
        GetDisplaySpecifier: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDsDisplaySpecifier,
                pszObjectClass: ?[*:0]align(1) const u16,
                riid: ?*const Guid,
                ppv: ?*?*anyopaque,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
        ...
        IsClassContainer: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDsDisplaySpecifier,
                pszObjectClass: ?[*:0]align(1) const u16,
                pszADsPath: ?[*:0]align(1) const u16,
                dwFlags: u32,
        ...
        GetAttributeADsType: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IDsDisplaySpecifier,
                pszAttributeName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) ADSTYPE,
            else => *const fn(
                self: *const IDsDisplaySpecifier,
                pszAttributeName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) ADSTYPE,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_SetServer(self: *const T, pszServer: ?[*:0]align(1) const u16, pszUserName: ?[*:0]align(1) const u16, pszPassword: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetDisplaySpecifier(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, riid: ?*const Guid, ppv: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetIconLocation(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, dwFlags: u32, pszBuffer: [*:0]u16, cchBuffer: i32, presid: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetIcon(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, dwFlags: u32, cxIcon: i32, cyIcon: i32) callconv(.Inline) ?HICON {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetFriendlyClassName(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, pszBuffer: [*:0]u16, cchBuffer: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetFriendlyAttributeName(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, pszAttributeName: ?[*:0]align(1) const u16, pszBuffer: [*:0]u16, cchBuffer: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_IsClassContainer(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, pszADsPath: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) BOOL {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetClassCreationInfo(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, ppdscci: ?*?*DSCLASSCREATIONINFO) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_EnumClassAttributes(self: *const T, pszObjectClass: ?[*:0]align(1) const u16, pcbEnum: ?LPDSENUMATTRIBUTES, lParam: LPARAM) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsDisplaySpecifier_GetAttributeADsType(self: *const T, pszAttributeName: ?[*:0]align(1) const u16) callconv(.Inline) ADSTYPE {
...
pub const DSBROWSEINFOW = extern struct {
    ...
    lParam: LPARAM,
    dwReturnFormat: u32,
    pUserName: ?[*:0]align(1) const u16,
    pPassword: ?[*:0]align(1) const u16,
    pszObjectClass: ?PWSTR,
    cchObjectClass: u32,
};
...
pub const DSOP_SCOPE_INIT_INFO = extern struct {
    ...
    pwzDcName: ?[*:0]align(1) const u16,
    pwzADsPath: ?[*:0]align(1) const u16,
    hr: HRESULT,
};

pub const DSOP_INIT_INFO = extern struct {
    cbSize: u32,
    pwzTargetComputer: ?[*:0]align(1) const u16,
    cDsScopeInfos: u32,
    aDsScopeInfos: ?*DSOP_SCOPE_INIT_INFO,
    flOptions: u32,
    cAttributesToFetch: u32,
    apwzAttributeNames: ?*const ?PWSTR,
};
...
pub const IDsObjectPickerCredentials = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsObjectPickerCredentials_SetCredentials(self: *const T, szUserName: ?[*:0]align(1) const u16, szPassword: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDsAdminCreateObj = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsAdminCreateObj_Initialize(self: *const T, pADsContainerObj: ?*IADsContainer, pADsCopySource: ?*IADs, lpszClassName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDsAdminNewObjPrimarySite = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsAdminNewObjPrimarySite_CreateNew(self: *const T, pszName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IDsAdminNewObjExt = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDsAdminNewObjExt_Initialize(self: *const T, pADsContainerObj: ?*IADsContainer, pADsCopySource: ?*IADs, lpszClassName: ?[*:0]align(1) const u16, pDsAdminNewObj: ?*IDsAdminNewObj, pDispInfo: ?*DSA_NEWOBJ_DISPINFO) callconv(.Inline) HRESULT {
...
pub extern "activeds" fn ADsOpenObject(
    lpszPathName: ?[*:0]align(1) const u16,
    lpszUserName: ?[*:0]align(1) const u16,
    lpszPassword: ?[*:0]align(1) const u16,
...
pub extern "dsparse" fn DsMakeSpnW(
    ServiceClass: ?[*:0]align(1) const u16,
    ServiceName: ?[*:0]align(1) const u16,
    InstanceName: ?[*:0]align(1) const u16,
    InstancePort: u16,
    Referrer: ?[*:0]align(1) const u16,
    pcSpnLength: ?*u32,
    pszSpn: ?[*:0]u16,
...
pub extern "dsparse" fn DsMakeSpnA(
    ServiceClass: ?[*:0]align(1) const u8,
    ServiceName: ?[*:0]align(1) const u8,
    InstanceName: ?[*:0]align(1) const u8,
    InstancePort: u16,
    Referrer: ?[*:0]align(1) const u8,
    pcSpnLength: ?*u32,
    pszSpn: ?[*:0]u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsBindW(
    DomainControllerName: ?[*:0]align(1) const u16,
    DnsDomainName: ?[*:0]align(1) const u16,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "ntdsapi" fn DsBindA(
    DomainControllerName: ?[*:0]align(1) const u8,
    DnsDomainName: ?[*:0]align(1) const u8,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsBindWithSpnW(
    ...
    DnsDomainName: ?[*:0]align(1) const u16,
    AuthIdentity: ?*anyopaque,
    ServicePrincipalName: ?[*:0]align(1) const u16,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsBindWithSpnA(
    ...
    DnsDomainName: ?[*:0]align(1) const u8,
    AuthIdentity: ?*anyopaque,
    ServicePrincipalName: ?[*:0]align(1) const u8,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsBindByInstanceW(
    ...
    Annotation: ?[*:0]align(1) const u16,
    InstanceGuid: ?*Guid,
    DnsDomainName: ?[*:0]align(1) const u16,
    AuthIdentity: ?*anyopaque,
    ServicePrincipalName: ?[*:0]align(1) const u16,
...
pub extern "ntdsapi" fn DsBindByInstanceA(
    ServerName: ?[*:0]align(1) const u8,
    Annotation: ?[*:0]align(1) const u8,
    InstanceGuid: ?*Guid,
    DnsDomainName: ?[*:0]align(1) const u8,
    AuthIdentity: ?*anyopaque,
    ServicePrincipalName: ?[*:0]align(1) const u8,
...
pub extern "ntdsapi" fn DsBindToISTGW(
    SiteName: ?[*:0]align(1) const u16,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "ntdsapi" fn DsBindToISTGA(
    SiteName: ?[*:0]align(1) const u8,
    phDS: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsMakePasswordCredentialsA(
    User: ?[*:0]align(1) const u8,
    Domain: ?[*:0]align(1) const u8,
    Password: ?[*:0]align(1) const u8,
    pAuthIdentity: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsCrackNamesW(
    ...
    cNames: u32,
    rpNames: [*]const ?[*:0]align(1) const u16,
...
pub extern "ntdsapi" fn DsCrackNamesA(
    ...
    formatDesired: DS_NAME_FORMAT,
    cNames: u32,
    rpNames: [*]const ?[*:0]align(1) const u8,
...
pub extern "ntdsapi" fn DsGetSpnA(
    ...
    InstancePort: u16,
    cInstanceNames: u16,
    pInstanceNames: ?[*]const ?[*:0]align(1) const u8,
...
pub extern "ntdsapi" fn DsGetSpnW(
    ...
    InstancePort: u16,
    cInstanceNames: u16,
    pInstanceNames: ?[*]const ?[*:0]align(1) const u16,
    pInstancePorts: ?[*:0]const u16,
    pcSpn: ?*u32,
    prpszSpn: ?*?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsWriteAccountSpnA(
    ...
    pszAccount: ?[*:0]align(1) const u8,
    cSpn: u32,
    rpszSpn: [*]const ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsWriteAccountSpnW(
    hDS: ?HANDLE,
    Operation: DS_SPN_WRITE_OP,
    pszAccount: ?[*:0]align(1) const u16,
    cSpn: u32,
    rpszSpn: [*]const ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsServerRegisterSpnA(
    Operation: DS_SPN_WRITE_OP,
    ServiceClass: ?[*:0]align(1) const u8,
    UserObjectDN: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsServerRegisterSpnW(
    Operation: DS_SPN_WRITE_OP,
    ServiceClass: ?[*:0]align(1) const u16,
    UserObjectDN: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "ntdsapi" fn DsReplicaSyncA(
    hDS: ?HANDLE,
    NameContext: ?[*:0]align(1) const u8,
...
pub extern "ntdsapi" fn DsReplicaSyncW(
    hDS: ?HANDLE,
    NameContext: ?[*:0]align(1) const u16,
    pUuidDsaSrc: ?*const Guid,
    Options: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsReplicaAddA(
    hDS: ?HANDLE,
    NameContext: ?[*:0]align(1) const u8,
    SourceDsaDn: ?[*:0]align(1) const u8,
    TransportDn: ?[*:0]align(1) const u8,
    SourceDsaAddress: ?[*:0]align(1) const u8,
...
pub extern "ntdsapi" fn DsReplicaAddW(
    hDS: ?HANDLE,
    NameContext: ?[*:0]align(1) const u16,
    SourceDsaDn: ?[*:0]align(1) const u16,
    TransportDn: ?[*:0]align(1) const u16,
    SourceDsaAddress: ?[*:0]align(1) const u16,
    pSchedule: ?*const SCHEDULE,
    Options: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsReplicaSyncAllA(
    hDS: ?HANDLE,
    pszNameContext: ?[*:0]align(1) const u8,
    ulFlags: u32,
    pFnCallBack: isize,
...
pub extern "ntdsapi" fn DsReplicaSyncAllW(
    hDS: ?HANDLE,
    pszNameContext: ?[*:0]align(1) const u16,
    ulFlags: u32,
    pFnCallBack: isize,
    pCallbackData: ?*anyopaque,
...
pub extern "ntdsapi" fn DsAddSidHistoryW(
    hDS: ?HANDLE,
    Flags: u32,
    SrcDomain: ?[*:0]align(1) const u16,
    SrcPrincipal: ?[*:0]align(1) const u16,
    SrcDomainController: ?[*:0]align(1) const u16,
    SrcDomainCreds: ?*anyopaque,
    DstDomain: ?[*:0]align(1) const u16,
    DstPrincipal: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdsapi" fn DsAddSidHistoryA(
    hDS: ?HANDLE,
    Flags: u32,
    SrcDomain: ?[*:0]align(1) const u8,
    SrcPrincipal: ?[*:0]align(1) const u8,
    SrcDomainController: ?[*:0]align(1) const u8,
    SrcDomainCreds: ?*anyopaque,
    DstDomain: ?[*:0]align(1) const u8,
    DstPrincipal: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn DsGetDcNameA(
    ComputerName: ?[*:0]align(1) const u8,
    DomainName: ?[*:0]align(1) const u8,
    DomainGuid: ?*Guid,
    SiteName: ?[*:0]align(1) const u8,
    Flags: u32,
...
pub extern "netapi32" fn DsValidateSubnetNameW(
    SubnetName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "netapi32" fn DsValidateSubnetNameA(
    SubnetName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn DsGetForestTrustInformationW(
    ServerName: ?[*:0]align(1) const u16,
    TrustedDomainName: ?[*:0]align(1) const u16,
    Flags: u32,
...
pub extern "netapi32" fn DsGetDcOpenW(
    DnsName: ?[*:0]align(1) const u16,
    OptionFlags: u32,
    SiteName: ?[*:0]align(1) const u16,
    DomainGuid: ?*Guid,
    DnsForestName: ?[*:0]align(1) const u16,
    DcFlags: u32,
...
pub extern "netapi32" fn DsGetDcOpenA(
    DnsName: ?[*:0]align(1) const u8,
    OptionFlags: u32,
    SiteName: ?[*:0]align(1) const u8,
    DomainGuid: ?*Guid,
    DnsForestName: ?[*:0]align(1) const u8,
    DcFlags: u32,
    RetGetDcContext: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
const BFFCALLBACK = @import("../../../windows/win32/ui/shell.zig").BFFCALLBACK;
...
const LPFNSVADDPROPSHEETPAGE = @import("../../../windows/win32/ui/controls.zig").LPFNSVADDPROPSHEETPAGE;
const LSA_FOREST_TRUST_INFORMATION = @import("../../../windows/win32/security/authentication/identity.zig").LSA_FOREST_TRUST_INFORMATION;
...
const SOCKET_ADDRESS = @import("../../../windows/win32/networking/win_sock.zig").SOCKET_ADDRESS;
