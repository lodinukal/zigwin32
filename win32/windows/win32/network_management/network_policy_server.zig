...
pub const MS_ATTRIBUTE_AZURE_POLICY_ID = ATTRIBUTEID.MS_ATTRIBUTE_AZURE_POLICY_ID;
...
pub const ISdoMachine = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISdoMachine_IsDirectoryAvailable(self: *const T, boolDirectoryAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISdoMachine2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISdoMachine2_SyncConfigAgainstTemplates(self: *const T, bstrServiceName: ?BSTR, ppConfigRoot: ?*?*IUnknown, ppTemplatesRoot: ?*?*IUnknown, bForcedSync: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISdoCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISdoCollection_IsNameUnique(self: *const T, bstrName: ?BSTR, pBool: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
