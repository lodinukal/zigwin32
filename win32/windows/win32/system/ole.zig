...
pub const VAR_TIMEVALUEONLY = @as(u32, 1);
pub const VAR_DATEVALUEONLY = @as(u32, 2);
pub const VAR_VALIDDATE = @as(u32, 4);
pub const VAR_CALENDAR_HIJRI = @as(u32, 8);
pub const VAR_LOCALBOOL = @as(u32, 16);
pub const VAR_FORMAT_NOSUBSTITUTE = @as(u32, 32);
pub const VAR_FOURDIGITYEARS = @as(u32, 64);
pub const LOCALE_USE_NLS = @as(u32, 268435456);
pub const VAR_CALENDAR_THAI = @as(u32, 128);
pub const VAR_CALENDAR_GREGORIAN = @as(u32, 256);
...
pub const OLEIVERB_PRIMARY = OLEIVERB.PRIMARY;
pub const OLEIVERB_SHOW = OLEIVERB.SHOW;
pub const OLEIVERB_OPEN = OLEIVERB.OPEN;
pub const OLEIVERB_HIDE = OLEIVERB.HIDE;
pub const OLEIVERB_UIACTIVATE = OLEIVERB.UIACTIVATE;
pub const OLEIVERB_INPLACEACTIVATE = OLEIVERB.INPLACEACTIVATE;
pub const OLEIVERB_DISCARDUNDOSTATE = OLEIVERB.DISCARDUNDOSTATE;
...
pub const DROPEFFECT = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DROPEFFECT, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DROPEFFECT.NONE) else 0)
            | (if (o.COPY == 1) @intFromEnum(DROPEFFECT.COPY) else 0)
            | (if (o.MOVE == 1) @intFromEnum(DROPEFFECT.MOVE) else 0)
            | (if (o.LINK == 1) @intFromEnum(DROPEFFECT.LINK) else 0)
            | (if (o.SCROLL == 1) @intFromEnum(DROPEFFECT.SCROLL) else 0)
        ));
    }
};
pub const DROPEFFECT_NONE = DROPEFFECT.NONE;
pub const DROPEFFECT_COPY = DROPEFFECT.COPY;
pub const DROPEFFECT_MOVE = DROPEFFECT.MOVE;
pub const DROPEFFECT_LINK = DROPEFFECT.LINK;
pub const DROPEFFECT_SCROLL = DROPEFFECT.SCROLL;

pub const KEYMODIFIERS = enum(u32) {
    SHIFT = 1,
    CONTROL = 2,
    ALT = 4,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(KEYMODIFIERS, @enumFromInt(
              (if (o.SHIFT == 1) @intFromEnum(KEYMODIFIERS.SHIFT) else 0)
            | (if (o.CONTROL == 1) @intFromEnum(KEYMODIFIERS.CONTROL) else 0)
            | (if (o.ALT == 1) @intFromEnum(KEYMODIFIERS.ALT) else 0)
        ));
    }
};
pub const KEYMOD_SHIFT = KEYMODIFIERS.SHIFT;
pub const KEYMOD_CONTROL = KEYMODIFIERS.CONTROL;
pub const KEYMOD_ALT = KEYMODIFIERS.ALT;

pub const ACTIVEOBJECT_FLAGS = enum(u32) {
    STRONG = 0,
    WEAK = 1,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(ACTIVEOBJECT_FLAGS, @enumFromInt(
              (if (o.STRONG == 1) @intFromEnum(ACTIVEOBJECT_FLAGS.STRONG) else 0)
            | (if (o.WEAK == 1) @intFromEnum(ACTIVEOBJECT_FLAGS.WEAK) else 0)
        ));
    }
};
pub const ACTIVEOBJECT_STRONG = ACTIVEOBJECT_FLAGS.STRONG;
pub const ACTIVEOBJECT_WEAK = ACTIVEOBJECT_FLAGS.WEAK;

pub const BUSY_DIALOG_FLAGS = enum(u32) {
    ...
    _,
    pub fn initFlags(o: struct {
        DISABLECANCELBUTTON: u1 = 0,
        DISABLESWITCHTOBUTTON: u1 = 0,
        DISABLERETRYBUTTON: u1 = 0,
        NOTRESPONDINGDIALOG: u1 = 0,
    }) BUSY_DIALOG_FLAGS {
        return @as(BUSY_DIALOG_FLAGS, @enumFromInt(
              (if (o.DISABLECANCELBUTTON == 1) @intFromEnum(BUSY_DIALOG_FLAGS.DISABLECANCELBUTTON) else 0)
            | (if (o.DISABLESWITCHTOBUTTON == 1) @intFromEnum(BUSY_DIALOG_FLAGS.DISABLESWITCHTOBUTTON) else 0)
            | (if (o.DISABLERETRYBUTTON == 1) @intFromEnum(BUSY_DIALOG_FLAGS.DISABLERETRYBUTTON) else 0)
            | (if (o.NOTRESPONDINGDIALOG == 1) @intFromEnum(BUSY_DIALOG_FLAGS.NOTRESPONDINGDIALOG) else 0)
        ));
    }
};
pub const BZ_DISABLECANCELBUTTON = BUSY_DIALOG_FLAGS.DISABLECANCELBUTTON;
pub const BZ_DISABLESWITCHTOBUTTON = BUSY_DIALOG_FLAGS.DISABLESWITCHTOBUTTON;
pub const BZ_DISABLERETRYBUTTON = BUSY_DIALOG_FLAGS.DISABLERETRYBUTTON;
pub const BZ_NOTRESPONDINGDIALOG = BUSY_DIALOG_FLAGS.NOTRESPONDINGDIALOG;

pub const UI_CONVERT_FLAGS = enum(u32) {
    SHOWHELPBUTTON = 1,
    SETCONVERTDEFAULT = 2,
    SETACTIVATEDEFAULT = 4,
    SELECTCONVERTTO = 8,
    SELECTACTIVATEAS = 16,
    DISABLEDISPLAYASICON = 32,
    DISABLEACTIVATEAS = 64,
    HIDECHANGEICON = 128,
    CONVERTONLY = 256,
    _,
    pub fn initFlags(o: struct {
        SHOWHELPBUTTON: u1 = 0,
        SETCONVERTDEFAULT: u1 = 0,
        SETACTIVATEDEFAULT: u1 = 0,
        SELECTCONVERTTO: u1 = 0,
        SELECTACTIVATEAS: u1 = 0,
        DISABLEDISPLAYASICON: u1 = 0,
        DISABLEACTIVATEAS: u1 = 0,
        HIDECHANGEICON: u1 = 0,
        CONVERTONLY: u1 = 0,
    }) UI_CONVERT_FLAGS {
        return @as(UI_CONVERT_FLAGS, @enumFromInt(
              (if (o.SHOWHELPBUTTON == 1) @intFromEnum(UI_CONVERT_FLAGS.SHOWHELPBUTTON) else 0)
            | (if (o.SETCONVERTDEFAULT == 1) @intFromEnum(UI_CONVERT_FLAGS.SETCONVERTDEFAULT) else 0)
            | (if (o.SETACTIVATEDEFAULT == 1) @intFromEnum(UI_CONVERT_FLAGS.SETACTIVATEDEFAULT) else 0)
            | (if (o.SELECTCONVERTTO == 1) @intFromEnum(UI_CONVERT_FLAGS.SELECTCONVERTTO) else 0)
            | (if (o.SELECTACTIVATEAS == 1) @intFromEnum(UI_CONVERT_FLAGS.SELECTACTIVATEAS) else 0)
            | (if (o.DISABLEDISPLAYASICON == 1) @intFromEnum(UI_CONVERT_FLAGS.DISABLEDISPLAYASICON) else 0)
            | (if (o.DISABLEACTIVATEAS == 1) @intFromEnum(UI_CONVERT_FLAGS.DISABLEACTIVATEAS) else 0)
            | (if (o.HIDECHANGEICON == 1) @intFromEnum(UI_CONVERT_FLAGS.HIDECHANGEICON) else 0)
            | (if (o.CONVERTONLY == 1) @intFromEnum(UI_CONVERT_FLAGS.CONVERTONLY) else 0)
        ));
    }
};
pub const CF_SHOWHELPBUTTON = UI_CONVERT_FLAGS.SHOWHELPBUTTON;
pub const CF_SETCONVERTDEFAULT = UI_CONVERT_FLAGS.SETCONVERTDEFAULT;
pub const CF_SETACTIVATEDEFAULT = UI_CONVERT_FLAGS.SETACTIVATEDEFAULT;
pub const CF_SELECTCONVERTTO = UI_CONVERT_FLAGS.SELECTCONVERTTO;
pub const CF_SELECTACTIVATEAS = UI_CONVERT_FLAGS.SELECTACTIVATEAS;
pub const CF_DISABLEDISPLAYASICON = UI_CONVERT_FLAGS.DISABLEDISPLAYASICON;
pub const CF_DISABLEACTIVATEAS = UI_CONVERT_FLAGS.DISABLEACTIVATEAS;
pub const CF_HIDECHANGEICON = UI_CONVERT_FLAGS.HIDECHANGEICON;
pub const CF_CONVERTONLY = UI_CONVERT_FLAGS.CONVERTONLY;

pub const CHANGE_ICON_FLAGS = enum(u32) {
    SHOWHELP = 1,
    SELECTCURRENT = 2,
    SELECTDEFAULT = 4,
    SELECTFROMFILE = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CHANGE_ICON_FLAGS, @enumFromInt(
              (if (o.SHOWHELP == 1) @intFromEnum(CHANGE_ICON_FLAGS.SHOWHELP) else 0)
            | (if (o.SELECTCURRENT == 1) @intFromEnum(CHANGE_ICON_FLAGS.SELECTCURRENT) else 0)
            | (if (o.SELECTDEFAULT == 1) @intFromEnum(CHANGE_ICON_FLAGS.SELECTDEFAULT) else 0)
            | (if (o.SELECTFROMFILE == 1) @intFromEnum(CHANGE_ICON_FLAGS.SELECTFROMFILE) else 0)
            | (if (o.USEICONEXE == 1) @intFromEnum(CHANGE_ICON_FLAGS.USEICONEXE) else 0)
        ));
    }
};
pub const CIF_SHOWHELP = CHANGE_ICON_FLAGS.SHOWHELP;
pub const CIF_SELECTCURRENT = CHANGE_ICON_FLAGS.SELECTCURRENT;
pub const CIF_SELECTDEFAULT = CHANGE_ICON_FLAGS.SELECTDEFAULT;
pub const CIF_SELECTFROMFILE = CHANGE_ICON_FLAGS.SELECTFROMFILE;
pub const CIF_USEICONEXE = CHANGE_ICON_FLAGS.USEICONEXE;

pub const CHANGE_SOURCE_FLAGS = enum(u32) {
    SHOWHELP = 1,
    VALIDSOURCE = 2,
    ONLYGETSOURCE = 4,
    EXPLORER = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CHANGE_SOURCE_FLAGS, @enumFromInt(
              (if (o.SHOWHELP == 1) @intFromEnum(CHANGE_SOURCE_FLAGS.SHOWHELP) else 0)
            | (if (o.VALIDSOURCE == 1) @intFromEnum(CHANGE_SOURCE_FLAGS.VALIDSOURCE) else 0)
            | (if (o.ONLYGETSOURCE == 1) @intFromEnum(CHANGE_SOURCE_FLAGS.ONLYGETSOURCE) else 0)
            | (if (o.EXPLORER == 1) @intFromEnum(CHANGE_SOURCE_FLAGS.EXPLORER) else 0)
        ));
    }
};
pub const CSF_SHOWHELP = CHANGE_SOURCE_FLAGS.SHOWHELP;
pub const CSF_VALIDSOURCE = CHANGE_SOURCE_FLAGS.VALIDSOURCE;
pub const CSF_ONLYGETSOURCE = CHANGE_SOURCE_FLAGS.ONLYGETSOURCE;
pub const CSF_EXPLORER = CHANGE_SOURCE_FLAGS.EXPLORER;

pub const EDIT_LINKS_FLAGS = enum(u32) {
    SHOWHELP = 1,
    DISABLEUPDATENOW = 2,
    DISABLEOPENSOURCE = 4,
    DISABLECHANGESOURCE = 8,
    DISABLECANCELLINK = 16,
    _,
    pub fn initFlags(o: struct {
        SHOWHELP: u1 = 0,
        DISABLEUPDATENOW: u1 = 0,
        DISABLEOPENSOURCE: u1 = 0,
        DISABLECHANGESOURCE: u1 = 0,
        DISABLECANCELLINK: u1 = 0,
    }) EDIT_LINKS_FLAGS {
        return @as(EDIT_LINKS_FLAGS, @enumFromInt(
              (if (o.SHOWHELP == 1) @intFromEnum(EDIT_LINKS_FLAGS.SHOWHELP) else 0)
            | (if (o.DISABLEUPDATENOW == 1) @intFromEnum(EDIT_LINKS_FLAGS.DISABLEUPDATENOW) else 0)
            | (if (o.DISABLEOPENSOURCE == 1) @intFromEnum(EDIT_LINKS_FLAGS.DISABLEOPENSOURCE) else 0)
            | (if (o.DISABLECHANGESOURCE == 1) @intFromEnum(EDIT_LINKS_FLAGS.DISABLECHANGESOURCE) else 0)
            | (if (o.DISABLECANCELLINK == 1) @intFromEnum(EDIT_LINKS_FLAGS.DISABLECANCELLINK) else 0)
        ));
    }
};
pub const ELF_SHOWHELP = EDIT_LINKS_FLAGS.SHOWHELP;
pub const ELF_DISABLEUPDATENOW = EDIT_LINKS_FLAGS.DISABLEUPDATENOW;
pub const ELF_DISABLEOPENSOURCE = EDIT_LINKS_FLAGS.DISABLEOPENSOURCE;
pub const ELF_DISABLECHANGESOURCE = EDIT_LINKS_FLAGS.DISABLECHANGESOURCE;
pub const ELF_DISABLECANCELLINK = EDIT_LINKS_FLAGS.DISABLECANCELLINK;

pub const INSERT_OBJECT_FLAGS = enum(u32) {
    SHOWHELP = 1,
    SELECTCREATENEW = 2,
    SELECTCREATEFROMFILE = 4,
    CHECKLINK = 8,
    CHECKDISPLAYASICON = 16,
    CREATENEWOBJECT = 32,
    CREATEFILEOBJECT = 64,
    CREATELINKOBJECT = 128,
    DISABLELINK = 256,
    VERIFYSERVERSEXIST = 512,
    DISABLEDISPLAYASICON = 1024,
    HIDECHANGEICON = 2048,
    SHOWINSERTCONTROL = 4096,
    SELECTCREATECONTROL = 8192,
    _,
    pub fn initFlags(o: struct {
        SHOWHELP: u1 = 0,
        SELECTCREATENEW: u1 = 0,
        SELECTCREATEFROMFILE: u1 = 0,
        CHECKLINK: u1 = 0,
        CHECKDISPLAYASICON: u1 = 0,
        CREATENEWOBJECT: u1 = 0,
        CREATEFILEOBJECT: u1 = 0,
        CREATELINKOBJECT: u1 = 0,
        DISABLELINK: u1 = 0,
        VERIFYSERVERSEXIST: u1 = 0,
        DISABLEDISPLAYASICON: u1 = 0,
        HIDECHANGEICON: u1 = 0,
        SHOWINSERTCONTROL: u1 = 0,
        SELECTCREATECONTROL: u1 = 0,
    }) INSERT_OBJECT_FLAGS {
        return @as(INSERT_OBJECT_FLAGS, @enumFromInt(
              (if (o.SHOWHELP == 1) @intFromEnum(INSERT_OBJECT_FLAGS.SHOWHELP) else 0)
            | (if (o.SELECTCREATENEW == 1) @intFromEnum(INSERT_OBJECT_FLAGS.SELECTCREATENEW) else 0)
            | (if (o.SELECTCREATEFROMFILE == 1) @intFromEnum(INSERT_OBJECT_FLAGS.SELECTCREATEFROMFILE) else 0)
            | (if (o.CHECKLINK == 1) @intFromEnum(INSERT_OBJECT_FLAGS.CHECKLINK) else 0)
            | (if (o.CHECKDISPLAYASICON == 1) @intFromEnum(INSERT_OBJECT_FLAGS.CHECKDISPLAYASICON) else 0)
            | (if (o.CREATENEWOBJECT == 1) @intFromEnum(INSERT_OBJECT_FLAGS.CREATENEWOBJECT) else 0)
            | (if (o.CREATEFILEOBJECT == 1) @intFromEnum(INSERT_OBJECT_FLAGS.CREATEFILEOBJECT) else 0)
            | (if (o.CREATELINKOBJECT == 1) @intFromEnum(INSERT_OBJECT_FLAGS.CREATELINKOBJECT) else 0)
            | (if (o.DISABLELINK == 1) @intFromEnum(INSERT_OBJECT_FLAGS.DISABLELINK) else 0)
            | (if (o.VERIFYSERVERSEXIST == 1) @intFromEnum(INSERT_OBJECT_FLAGS.VERIFYSERVERSEXIST) else 0)
            | (if (o.DISABLEDISPLAYASICON == 1) @intFromEnum(INSERT_OBJECT_FLAGS.DISABLEDISPLAYASICON) else 0)
            | (if (o.HIDECHANGEICON == 1) @intFromEnum(INSERT_OBJECT_FLAGS.HIDECHANGEICON) else 0)
            | (if (o.SHOWINSERTCONTROL == 1) @intFromEnum(INSERT_OBJECT_FLAGS.SHOWINSERTCONTROL) else 0)
            | (if (o.SELECTCREATECONTROL == 1) @intFromEnum(INSERT_OBJECT_FLAGS.SELECTCREATECONTROL) else 0)
        ));
    }
};
pub const IOF_SHOWHELP = INSERT_OBJECT_FLAGS.SHOWHELP;
pub const IOF_SELECTCREATENEW = INSERT_OBJECT_FLAGS.SELECTCREATENEW;
pub const IOF_SELECTCREATEFROMFILE = INSERT_OBJECT_FLAGS.SELECTCREATEFROMFILE;
pub const IOF_CHECKLINK = INSERT_OBJECT_FLAGS.CHECKLINK;
pub const IOF_CHECKDISPLAYASICON = INSERT_OBJECT_FLAGS.CHECKDISPLAYASICON;
pub const IOF_CREATENEWOBJECT = INSERT_OBJECT_FLAGS.CREATENEWOBJECT;
pub const IOF_CREATEFILEOBJECT = INSERT_OBJECT_FLAGS.CREATEFILEOBJECT;
pub const IOF_CREATELINKOBJECT = INSERT_OBJECT_FLAGS.CREATELINKOBJECT;
pub const IOF_DISABLELINK = INSERT_OBJECT_FLAGS.DISABLELINK;
pub const IOF_VERIFYSERVERSEXIST = INSERT_OBJECT_FLAGS.VERIFYSERVERSEXIST;
pub const IOF_DISABLEDISPLAYASICON = INSERT_OBJECT_FLAGS.DISABLEDISPLAYASICON;
pub const IOF_HIDECHANGEICON = INSERT_OBJECT_FLAGS.HIDECHANGEICON;
pub const IOF_SHOWINSERTCONTROL = INSERT_OBJECT_FLAGS.SHOWINSERTCONTROL;
pub const IOF_SELECTCREATECONTROL = INSERT_OBJECT_FLAGS.SELECTCREATECONTROL;

pub const OBJECT_PROPERTIES_FLAGS = enum(u32) {
    OBJECTISLINK = 1,
    NOFILLDEFAULT = 2,
    SHOWHELP = 4,
    DISABLECONVERT = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(OBJECT_PROPERTIES_FLAGS, @enumFromInt(
              (if (o.OBJECTISLINK == 1) @intFromEnum(OBJECT_PROPERTIES_FLAGS.OBJECTISLINK) else 0)
            | (if (o.NOFILLDEFAULT == 1) @intFromEnum(OBJECT_PROPERTIES_FLAGS.NOFILLDEFAULT) else 0)
            | (if (o.SHOWHELP == 1) @intFromEnum(OBJECT_PROPERTIES_FLAGS.SHOWHELP) else 0)
            | (if (o.DISABLECONVERT == 1) @intFromEnum(OBJECT_PROPERTIES_FLAGS.DISABLECONVERT) else 0)
        ));
    }
};
pub const OPF_OBJECTISLINK = OBJECT_PROPERTIES_FLAGS.OBJECTISLINK;
pub const OPF_NOFILLDEFAULT = OBJECT_PROPERTIES_FLAGS.NOFILLDEFAULT;
pub const OPF_SHOWHELP = OBJECT_PROPERTIES_FLAGS.SHOWHELP;
pub const OPF_DISABLECONVERT = OBJECT_PROPERTIES_FLAGS.DISABLECONVERT;

pub const VIEW_OBJECT_PROPERTIES_FLAGS = enum(u32) {
    SELECTRELATIVE = 1,
    DISABLERELATIVE = 2,
    DISABLESCALE = 4,
    _,
    pub fn initFlags(o: struct {
        SELECTRELATIVE: u1 = 0,
        DISABLERELATIVE: u1 = 0,
        DISABLESCALE: u1 = 0,
    }) VIEW_OBJECT_PROPERTIES_FLAGS {
        return @as(VIEW_OBJECT_PROPERTIES_FLAGS, @enumFromInt(
              (if (o.SELECTRELATIVE == 1) @intFromEnum(VIEW_OBJECT_PROPERTIES_FLAGS.SELECTRELATIVE) else 0)
            | (if (o.DISABLERELATIVE == 1) @intFromEnum(VIEW_OBJECT_PROPERTIES_FLAGS.DISABLERELATIVE) else 0)
            | (if (o.DISABLESCALE == 1) @intFromEnum(VIEW_OBJECT_PROPERTIES_FLAGS.DISABLESCALE) else 0)
        ));
    }
};
pub const VPF_SELECTRELATIVE = VIEW_OBJECT_PROPERTIES_FLAGS.SELECTRELATIVE;
pub const VPF_DISABLERELATIVE = VIEW_OBJECT_PROPERTIES_FLAGS.DISABLERELATIVE;
pub const VPF_DISABLESCALE = VIEW_OBJECT_PROPERTIES_FLAGS.DISABLESCALE;

pub const PARAMFLAGS = enum(u16) {
    NONE = 0,
    FIN = 1,
    FOUT = 2,
    FLCID = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(PARAMFLAGS, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(PARAMFLAGS.NONE) else 0)
            | (if (o.FIN == 1) @intFromEnum(PARAMFLAGS.FIN) else 0)
            | (if (o.FOUT == 1) @intFromEnum(PARAMFLAGS.FOUT) else 0)
            | (if (o.FLCID == 1) @intFromEnum(PARAMFLAGS.FLCID) else 0)
            | (if (o.FRETVAL == 1) @intFromEnum(PARAMFLAGS.FRETVAL) else 0)
            | (if (o.FOPT == 1) @intFromEnum(PARAMFLAGS.FOPT) else 0)
            | (if (o.FHASDEFAULT == 1) @intFromEnum(PARAMFLAGS.FHASDEFAULT) else 0)
            | (if (o.FHASCUSTDATA == 1) @intFromEnum(PARAMFLAGS.FHASCUSTDATA) else 0)
        ));
    }
};
pub const PARAMFLAG_NONE = PARAMFLAGS.NONE;
pub const PARAMFLAG_FIN = PARAMFLAGS.FIN;
pub const PARAMFLAG_FOUT = PARAMFLAGS.FOUT;
pub const PARAMFLAG_FLCID = PARAMFLAGS.FLCID;
pub const PARAMFLAG_FRETVAL = PARAMFLAGS.FRETVAL;
pub const PARAMFLAG_FOPT = PARAMFLAGS.FOPT;
pub const PARAMFLAG_FHASDEFAULT = PARAMFLAGS.FHASDEFAULT;
pub const PARAMFLAG_FHASCUSTDATA = PARAMFLAGS.FHASCUSTDATA;

pub const NUMPARSE_FLAGS = enum(u32) {
    LEADING_WHITE = 1,
    TRAILING_WHITE = 2,
    LEADING_PLUS = 4,
    TRAILING_PLUS = 8,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NUMPARSE_FLAGS, @enumFromInt(
              (if (o.LEADING_WHITE == 1) @intFromEnum(NUMPARSE_FLAGS.LEADING_WHITE) else 0)
            | (if (o.TRAILING_WHITE == 1) @intFromEnum(NUMPARSE_FLAGS.TRAILING_WHITE) else 0)
            | (if (o.LEADING_PLUS == 1) @intFromEnum(NUMPARSE_FLAGS.LEADING_PLUS) else 0)
            | (if (o.TRAILING_PLUS == 1) @intFromEnum(NUMPARSE_FLAGS.TRAILING_PLUS) else 0)
            | (if (o.LEADING_MINUS == 1) @intFromEnum(NUMPARSE_FLAGS.LEADING_MINUS) else 0)
            | (if (o.TRAILING_MINUS == 1) @intFromEnum(NUMPARSE_FLAGS.TRAILING_MINUS) else 0)
            | (if (o.HEX_OCT == 1) @intFromEnum(NUMPARSE_FLAGS.HEX_OCT) else 0)
            | (if (o.PARENS == 1) @intFromEnum(NUMPARSE_FLAGS.PARENS) else 0)
            | (if (o.DECIMAL == 1) @intFromEnum(NUMPARSE_FLAGS.DECIMAL) else 0)
            | (if (o.THOUSANDS == 1) @intFromEnum(NUMPARSE_FLAGS.THOUSANDS) else 0)
            | (if (o.CURRENCY == 1) @intFromEnum(NUMPARSE_FLAGS.CURRENCY) else 0)
            | (if (o.EXPONENT == 1) @intFromEnum(NUMPARSE_FLAGS.EXPONENT) else 0)
            | (if (o.USE_ALL == 1) @intFromEnum(NUMPARSE_FLAGS.USE_ALL) else 0)
            | (if (o.STD == 1) @intFromEnum(NUMPARSE_FLAGS.STD) else 0)
            | (if (o.NEG == 1) @intFromEnum(NUMPARSE_FLAGS.NEG) else 0)
            | (if (o.INEXACT == 1) @intFromEnum(NUMPARSE_FLAGS.INEXACT) else 0)
        ));
    }
};
pub const NUMPRS_LEADING_WHITE = NUMPARSE_FLAGS.LEADING_WHITE;
pub const NUMPRS_TRAILING_WHITE = NUMPARSE_FLAGS.TRAILING_WHITE;
pub const NUMPRS_LEADING_PLUS = NUMPARSE_FLAGS.LEADING_PLUS;
pub const NUMPRS_TRAILING_PLUS = NUMPARSE_FLAGS.TRAILING_PLUS;
pub const NUMPRS_LEADING_MINUS = NUMPARSE_FLAGS.LEADING_MINUS;
pub const NUMPRS_TRAILING_MINUS = NUMPARSE_FLAGS.TRAILING_MINUS;
pub const NUMPRS_HEX_OCT = NUMPARSE_FLAGS.HEX_OCT;
pub const NUMPRS_PARENS = NUMPARSE_FLAGS.PARENS;
pub const NUMPRS_DECIMAL = NUMPARSE_FLAGS.DECIMAL;
pub const NUMPRS_THOUSANDS = NUMPARSE_FLAGS.THOUSANDS;
pub const NUMPRS_CURRENCY = NUMPARSE_FLAGS.CURRENCY;
pub const NUMPRS_EXPONENT = NUMPARSE_FLAGS.EXPONENT;
pub const NUMPRS_USE_ALL = NUMPARSE_FLAGS.USE_ALL;
pub const NUMPRS_STD = NUMPARSE_FLAGS.STD;
pub const NUMPRS_NEG = NUMPARSE_FLAGS.NEG;
pub const NUMPRS_INEXACT = NUMPARSE_FLAGS.INEXACT;

pub const PICTYPE = enum(i16) {
    UNINITIALIZED = -1,
    NONE = 0,
    BITMAP = 1,
    METAFILE = 2,
...
pub const PICTYPE_UNINITIALIZED = PICTYPE.UNINITIALIZED;
pub const PICTYPE_NONE = PICTYPE.NONE;
pub const PICTYPE_BITMAP = PICTYPE.BITMAP;
pub const PICTYPE_METAFILE = PICTYPE.METAFILE;
pub const PICTYPE_ICON = PICTYPE.ICON;
pub const PICTYPE_ENHMETAFILE = PICTYPE.ENHMETAFILE;

pub const VARCMP = enum(u32) {
    LT = 0,
    EQ = 1,
    GT = 2,
    NULL = 3,
};
pub const VARCMP_LT = VARCMP.LT;
pub const VARCMP_EQ = VARCMP.EQ;
pub const VARCMP_GT = VARCMP.GT;
pub const VARCMP_NULL = VARCMP.NULL;

pub const PASTE_SPECIAL_FLAGS = enum(u32) {
    SHOWHELP = 1,
    SELECTPASTE = 2,
    SELECTPASTELINK = 4,
    CHECKDISPLAYASICON = 8,
    DISABLEDISPLAYASICON = 16,
    HIDECHANGEICON = 32,
    STAYONCLIPBOARDCHANGE = 64,
    NOREFRESHDATAOBJECT = 128,
    _,
    pub fn initFlags(o: struct {
        SHOWHELP: u1 = 0,
        SELECTPASTE: u1 = 0,
        SELECTPASTELINK: u1 = 0,
        CHECKDISPLAYASICON: u1 = 0,
        DISABLEDISPLAYASICON: u1 = 0,
        HIDECHANGEICON: u1 = 0,
        STAYONCLIPBOARDCHANGE: u1 = 0,
        NOREFRESHDATAOBJECT: u1 = 0,
    }) PASTE_SPECIAL_FLAGS {
        return @as(PASTE_SPECIAL_FLAGS, @enumFromInt(
              (if (o.SHOWHELP == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.SHOWHELP) else 0)
            | (if (o.SELECTPASTE == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.SELECTPASTE) else 0)
            | (if (o.SELECTPASTELINK == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.SELECTPASTELINK) else 0)
            | (if (o.CHECKDISPLAYASICON == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.CHECKDISPLAYASICON) else 0)
            | (if (o.DISABLEDISPLAYASICON == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.DISABLEDISPLAYASICON) else 0)
            | (if (o.HIDECHANGEICON == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.HIDECHANGEICON) else 0)
            | (if (o.STAYONCLIPBOARDCHANGE == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.STAYONCLIPBOARDCHANGE) else 0)
            | (if (o.NOREFRESHDATAOBJECT == 1) @intFromEnum(PASTE_SPECIAL_FLAGS.NOREFRESHDATAOBJECT) else 0)
        ));
    }
};
pub const PSF_SHOWHELP = PASTE_SPECIAL_FLAGS.SHOWHELP;
pub const PSF_SELECTPASTE = PASTE_SPECIAL_FLAGS.SELECTPASTE;
pub const PSF_SELECTPASTELINK = PASTE_SPECIAL_FLAGS.SELECTPASTELINK;
pub const PSF_CHECKDISPLAYASICON = PASTE_SPECIAL_FLAGS.CHECKDISPLAYASICON;
pub const PSF_DISABLEDISPLAYASICON = PASTE_SPECIAL_FLAGS.DISABLEDISPLAYASICON;
pub const PSF_HIDECHANGEICON = PASTE_SPECIAL_FLAGS.HIDECHANGEICON;
pub const PSF_STAYONCLIPBOARDCHANGE = PASTE_SPECIAL_FLAGS.STAYONCLIPBOARDCHANGE;
pub const PSF_NOREFRESHDATAOBJECT = PASTE_SPECIAL_FLAGS.NOREFRESHDATAOBJECT;

pub const EMBDHLP_FLAGS = enum(u32) {
    INPROC_HANDLER = 0,
    INPROC_SERVER = 1,
    // CREATENOW = 0, this enum value conflicts with INPROC_HANDLER
    DELAYCREATE = 65536,
    _,
    pub fn initFlags(o: struct {
        INPROC_HANDLER: u1 = 0,
        ...
        return @as(EMBDHLP_FLAGS, @enumFromInt(
              (if (o.INPROC_HANDLER == 1) @intFromEnum(EMBDHLP_FLAGS.INPROC_HANDLER) else 0)
            | (if (o.INPROC_SERVER == 1) @intFromEnum(EMBDHLP_FLAGS.INPROC_SERVER) else 0)
            | (if (o.DELAYCREATE == 1) @intFromEnum(EMBDHLP_FLAGS.DELAYCREATE) else 0)
        ));
    }
};
pub const EMBDHLP_INPROC_HANDLER = EMBDHLP_FLAGS.INPROC_HANDLER;
pub const EMBDHLP_INPROC_SERVER = EMBDHLP_FLAGS.INPROC_SERVER;
pub const EMBDHLP_CREATENOW = EMBDHLP_FLAGS.INPROC_HANDLER;
pub const EMBDHLP_DELAYCREATE = EMBDHLP_FLAGS.DELAYCREATE;

pub const FDEX_PROP_FLAGS = enum(u32) {
    CanGet = 1,
    CannotGet = 2,
    CanPut = 4,
    CannotPut = 8,
    ...
    CannotCall = 512,
    CanConstruct = 1024,
    CannotConstruct = 2048,
    CanSourceEvents = 4096,
    CannotSourceEvents = 8192,
    _,
    pub fn initFlags(o: struct {
        CanGet: u1 = 0,
        CannotGet: u1 = 0,
        ...
        CannotCall: u1 = 0,
        CanConstruct: u1 = 0,
        CannotConstruct: u1 = 0,
        CanSourceEvents: u1 = 0,
        CannotSourceEvents: u1 = 0,
    }) FDEX_PROP_FLAGS {
        return @as(FDEX_PROP_FLAGS, @enumFromInt(
              (if (o.CanGet == 1) @intFromEnum(FDEX_PROP_FLAGS.CanGet) else 0)
            | (if (o.CannotGet == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotGet) else 0)
            | (if (o.CanPut == 1) @intFromEnum(FDEX_PROP_FLAGS.CanPut) else 0)
            | (if (o.CannotPut == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotPut) else 0)
            | (if (o.CanPutRef == 1) @intFromEnum(FDEX_PROP_FLAGS.CanPutRef) else 0)
            | (if (o.CannotPutRef == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotPutRef) else 0)
            | (if (o.NoSideEffects == 1) @intFromEnum(FDEX_PROP_FLAGS.NoSideEffects) else 0)
            | (if (o.DynamicType == 1) @intFromEnum(FDEX_PROP_FLAGS.DynamicType) else 0)
            | (if (o.CanCall == 1) @intFromEnum(FDEX_PROP_FLAGS.CanCall) else 0)
            | (if (o.CannotCall == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotCall) else 0)
            | (if (o.CanConstruct == 1) @intFromEnum(FDEX_PROP_FLAGS.CanConstruct) else 0)
            | (if (o.CannotConstruct == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotConstruct) else 0)
            | (if (o.CanSourceEvents == 1) @intFromEnum(FDEX_PROP_FLAGS.CanSourceEvents) else 0)
            | (if (o.CannotSourceEvents == 1) @intFromEnum(FDEX_PROP_FLAGS.CannotSourceEvents) else 0)
        ));
    }
};
pub const fdexPropCanGet = FDEX_PROP_FLAGS.CanGet;
pub const fdexPropCannotGet = FDEX_PROP_FLAGS.CannotGet;
pub const fdexPropCanPut = FDEX_PROP_FLAGS.CanPut;
pub const fdexPropCannotPut = FDEX_PROP_FLAGS.CannotPut;
pub const fdexPropCanPutRef = FDEX_PROP_FLAGS.CanPutRef;
pub const fdexPropCannotPutRef = FDEX_PROP_FLAGS.CannotPutRef;
pub const fdexPropNoSideEffects = FDEX_PROP_FLAGS.NoSideEffects;
pub const fdexPropDynamicType = FDEX_PROP_FLAGS.DynamicType;
pub const fdexPropCanCall = FDEX_PROP_FLAGS.CanCall;
pub const fdexPropCannotCall = FDEX_PROP_FLAGS.CannotCall;
pub const fdexPropCanConstruct = FDEX_PROP_FLAGS.CanConstruct;
pub const fdexPropCannotConstruct = FDEX_PROP_FLAGS.CannotConstruct;
pub const fdexPropCanSourceEvents = FDEX_PROP_FLAGS.CanSourceEvents;
pub const fdexPropCannotSourceEvents = FDEX_PROP_FLAGS.CannotSourceEvents;

pub const LOAD_PICTURE_FLAGS = enum(u32) {
    DEFAULT = 0,
    MONOCHROME = 1,
    VGACOLOR = 2,
    COLOR = 4,
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(LOAD_PICTURE_FLAGS, @enumFromInt(
              (if (o.DEFAULT == 1) @intFromEnum(LOAD_PICTURE_FLAGS.DEFAULT) else 0)
            | (if (o.MONOCHROME == 1) @intFromEnum(LOAD_PICTURE_FLAGS.MONOCHROME) else 0)
            | (if (o.VGACOLOR == 1) @intFromEnum(LOAD_PICTURE_FLAGS.VGACOLOR) else 0)
            | (if (o.COLOR == 1) @intFromEnum(LOAD_PICTURE_FLAGS.COLOR) else 0)
        ));
    }
};
pub const LP_DEFAULT = LOAD_PICTURE_FLAGS.DEFAULT;
pub const LP_MONOCHROME = LOAD_PICTURE_FLAGS.MONOCHROME;
pub const LP_VGACOLOR = LOAD_PICTURE_FLAGS.VGACOLOR;
pub const LP_COLOR = LOAD_PICTURE_FLAGS.COLOR;

pub const OLECREATE = enum(u32) {
    ZERO = 0,
    LEAVERUNNING = 1,
};
pub const OLECREATE_ZERO = OLECREATE.ZERO;
pub const OLECREATE_LEAVERUNNING = OLECREATE.LEAVERUNNING;

pub const VARFORMAT_FIRST_DAY = enum(i32) {
    SYSTEMDEFAULT = 0,
    MONDAY = 1,
    TUESDAY = 2,
    WEDNESDAY = 3,
...
pub const VARFORMAT_FIRST_DAY_SYSTEMDEFAULT = VARFORMAT_FIRST_DAY.SYSTEMDEFAULT;
pub const VARFORMAT_FIRST_DAY_MONDAY = VARFORMAT_FIRST_DAY.MONDAY;
pub const VARFORMAT_FIRST_DAY_TUESDAY = VARFORMAT_FIRST_DAY.TUESDAY;
pub const VARFORMAT_FIRST_DAY_WEDNESDAY = VARFORMAT_FIRST_DAY.WEDNESDAY;
pub const VARFORMAT_FIRST_DAY_THURSDAY = VARFORMAT_FIRST_DAY.THURSDAY;
pub const VARFORMAT_FIRST_DAY_FRIDAY = VARFORMAT_FIRST_DAY.FRIDAY;
pub const VARFORMAT_FIRST_DAY_SATURDAY = VARFORMAT_FIRST_DAY.SATURDAY;
pub const VARFORMAT_FIRST_DAY_SUNDAY = VARFORMAT_FIRST_DAY.SUNDAY;

pub const VARFORMAT_FIRST_WEEK = enum(i32) {
    SYSTEMDEFAULT = 0,
    CONTAINS_JANUARY_FIRST = 1,
    LARGER_HALF_IN_CURRENT_YEAR = 2,
    HAS_SEVEN_DAYS = 3,
};
pub const VARFORMAT_FIRST_WEEK_SYSTEMDEFAULT = VARFORMAT_FIRST_WEEK.SYSTEMDEFAULT;
pub const VARFORMAT_FIRST_WEEK_CONTAINS_JANUARY_FIRST = VARFORMAT_FIRST_WEEK.CONTAINS_JANUARY_FIRST;
pub const VARFORMAT_FIRST_WEEK_LARGER_HALF_IN_CURRENT_YEAR = VARFORMAT_FIRST_WEEK.LARGER_HALF_IN_CURRENT_YEAR;
pub const VARFORMAT_FIRST_WEEK_HAS_SEVEN_DAYS = VARFORMAT_FIRST_WEEK.HAS_SEVEN_DAYS;

pub const VARFORMAT_NAMED_FORMAT = enum(i32) {
    GENERALDATE = 0,
    LONGDATE = 1,
    SHORTDATE = 2,
    LONGTIME = 3,
...
pub const VARFORMAT_NAMED_FORMAT_GENERALDATE = VARFORMAT_NAMED_FORMAT.GENERALDATE;
pub const VARFORMAT_NAMED_FORMAT_LONGDATE = VARFORMAT_NAMED_FORMAT.LONGDATE;
pub const VARFORMAT_NAMED_FORMAT_SHORTDATE = VARFORMAT_NAMED_FORMAT.SHORTDATE;
pub const VARFORMAT_NAMED_FORMAT_LONGTIME = VARFORMAT_NAMED_FORMAT.LONGTIME;
pub const VARFORMAT_NAMED_FORMAT_SHORTTIME = VARFORMAT_NAMED_FORMAT.SHORTTIME;

pub const VARFORMAT_LEADING_DIGIT = enum(i32) {
    SYSTEMDEFAULT = -2,
    INCLUDED = -1,
    NOTINCLUDED = 0,
};
pub const VARFORMAT_LEADING_DIGIT_SYSTEMDEFAULT = VARFORMAT_LEADING_DIGIT.SYSTEMDEFAULT;
pub const VARFORMAT_LEADING_DIGIT_INCLUDED = VARFORMAT_LEADING_DIGIT.INCLUDED;
pub const VARFORMAT_LEADING_DIGIT_NOTINCLUDED = VARFORMAT_LEADING_DIGIT.NOTINCLUDED;

pub const VARFORMAT_PARENTHESES = enum(i32) {
    SYSTEMDEFAULT = -2,
    USED = -1,
    NOTUSED = 0,
};
pub const VARFORMAT_PARENTHESES_SYSTEMDEFAULT = VARFORMAT_PARENTHESES.SYSTEMDEFAULT;
pub const VARFORMAT_PARENTHESES_USED = VARFORMAT_PARENTHESES.USED;
pub const VARFORMAT_PARENTHESES_NOTUSED = VARFORMAT_PARENTHESES.NOTUSED;

pub const VARFORMAT_GROUP = enum(i32) {
    SYSTEMDEFAULT = -2,
    THOUSANDS = -1,
    NOTTHOUSANDS = 0,
};
pub const VARFORMAT_GROUP_SYSTEMDEFAULT = VARFORMAT_GROUP.SYSTEMDEFAULT;
pub const VARFORMAT_GROUP_THOUSANDS = VARFORMAT_GROUP.THOUSANDS;
pub const VARFORMAT_GROUP_NOTTHOUSANDS = VARFORMAT_GROUP.NOTTHOUSANDS;
...
pub const SAFEARR_UNKNOWN = extern struct {
    Size: u32,
    apUnknown: ?*?*IUnknown,
};

pub const SAFEARR_DISPATCH = extern struct {
    Size: u32,
    apDispatch: ?*?*IDispatch,
};

pub const SAFEARR_VARIANT = extern struct {
    Size: u32,
    aVariant: ?*?*_wireVARIANT,
};

pub const SAFEARR_BRECORD = extern struct {
    Size: u32,
    aRecord: ?*?*_wireBRECORD,
};

pub const SAFEARR_HAVEIID = extern struct {
    Size: u32,
    apUnknown: ?*?*IUnknown,
    iid: Guid,
};
...
pub const SAFEARRAYUNION = extern struct {
    sfType: u32,
    u: extern struct {
...
pub const ICreateTypeInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ICreateTypeInfo_SetImplTypeFlags(self: *const T, index: u32, implTypeFlags: IMPLTYPEFLAGS) callconv(.Inline) HRESULT {
...
pub const IRecordInfo = extern struct {
    pub const VTable = extern struct {
        ...
        GetField: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IRecordInfo,
                pvData: ?*anyopaque,
                szFieldName: ?[*:0]align(1) const u16,
                pvarField: ?*VARIANT,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IRecordInfo,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRecordInfo_GetField(self: *const T, pvData: ?*anyopaque, szFieldName: ?[*:0]align(1) const u16, pvarField: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRecordInfo_GetFieldNoCopy(self: *const T, pvData: ?*anyopaque, szFieldName: ?[*:0]align(1) const u16, pvarField: ?*VARIANT, ppvDataCArray: ?*?*anyopaque) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRecordInfo_PutField(self: *const T, wFlags: u32, pvData: ?*anyopaque, szFieldName: ?[*:0]align(1) const u16, pvarField: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRecordInfo_PutFieldNoCopy(self: *const T, wFlags: u32, pvData: ?*anyopaque, szFieldName: ?[*:0]align(1) const u16, pvarField: ?*VARIANT) callconv(.Inline) HRESULT {
...
pub const IOleObject = extern struct {
    pub const VTable = extern struct {
        ...
        SetHostNames: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IOleObject,
                szContainerApp: ?[*:0]align(1) const u16,
                szContainerObj: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IOleObject,
                szContainerApp: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleObject_SetHostNames(self: *const T, szContainerApp: ?[*:0]align(1) const u16, szContainerObj: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleObject_SetExtent(self: *const T, dwDrawAspect: DVASPECT, psizel: ?*SIZE) callconv(.Inline) HRESULT {
            return @as(*const IOleObject.VTable, @ptrCast(self.vtable)).SetExtent(@as(*const IOleObject, @ptrCast(self)), dwDrawAspect, psizel);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleObject_GetExtent(self: *const T, dwDrawAspect: DVASPECT, psizel: ?*SIZE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleObject_GetMiscStatus(self: *const T, dwAspect: DVASPECT, pdwStatus: ?*OLEMISC) callconv(.Inline) HRESULT {
...
pub const IOleLink = extern struct {
    pub const VTable = extern struct {
        ...
        SetSourceDisplayName: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IOleLink,
                pszStatusText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IOleLink,
                pszStatusText: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleLink_SetSourceDisplayName(self: *const T, pszStatusText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOleInPlaceUIWindow = extern struct {
    pub const VTable = extern struct {
        ...
        SetActiveObject: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszObjName: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IOleInPlaceUIWindow,
                pActiveObject: ?*IOleInPlaceActiveObject,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleInPlaceUIWindow_SetActiveObject(self: *const T, pActiveObject: ?*IOleInPlaceActiveObject, pszObjName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOleInPlaceFrame = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleInPlaceFrame_SetStatusText(self: *const T, pszStatusText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOleInPlaceSite = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleInPlaceSite_GetWindowContext(self: *const T, ppFrame: ?*?*IOleInPlaceFrame, ppDoc: ?*?*IOleInPlaceUIWindow, lprcPosRect: ?*RECT, lprcClipRect: ?*RECT, lpFrameInfo: ?*OLEINPLACEFRAMEINFO) callconv(.Inline) HRESULT {
...
pub const IViewObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObject_Draw(self: *const T, dwDrawAspect: DVASPECT, lindex: i32, pvAspect: ?*anyopaque, ptd: ?*DVTARGETDEVICE, hdcTargetDev: ?HDC, hdcDraw: ?HDC, lprcBounds: ?*RECTL, lprcWBounds: ?*RECTL, pfnContinue: isize, dwContinue: usize) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObject_GetColorSet(self: *const T, dwDrawAspect: DVASPECT, lindex: i32, pvAspect: ?*anyopaque, ptd: ?*DVTARGETDEVICE, hicTargetDev: ?HDC, ppColorSet: ?*?*LOGPALETTE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObject_Freeze(self: *const T, dwDrawAspect: DVASPECT, lindex: i32, pvAspect: ?*anyopaque, pdwFreeze: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObject_SetAdvise(self: *const T, aspects: DVASPECT, advf: u32, pAdvSink: ?*IAdviseSink) callconv(.Inline) HRESULT {
...
pub const IViewObject2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObject2_GetExtent(self: *const T, dwDrawAspect: DVASPECT, lindex: i32, ptd: ?*DVTARGETDEVICE, lpsizel: ?*SIZE) callconv(.Inline) HRESULT {
...
pub const IDropSource = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDropSource_QueryContinueDrag(self: *const T, fEscapePressed: BOOL, grfKeyState: MODIFIERKEYS_FLAGS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDropSource_GiveFeedback(self: *const T, dwEffect: DROPEFFECT) callconv(.Inline) HRESULT {
...
pub const IDropTarget = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDropTarget_DragEnter(self: *const T, pDataObj: ?*IDataObject, grfKeyState: MODIFIERKEYS_FLAGS, pt: POINTL, pdwEffect: ?*DROPEFFECT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDropTarget_DragOver(self: *const T, grfKeyState: MODIFIERKEYS_FLAGS, pt: POINTL, pdwEffect: ?*DROPEFFECT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDropTarget_Drop(self: *const T, pDataObj: ?*IDataObject, grfKeyState: MODIFIERKEYS_FLAGS, pt: POINTL, pdwEffect: ?*DROPEFFECT) callconv(.Inline) HRESULT {
...
pub const IEnterpriseDropTarget = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IEnterpriseDropTarget_SetDropSourceEnterpriseId(self: *const T, identity: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IOleControlSite = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleControlSite_TranslateAccelerator(self: *const T, pMsg: ?*MSG, grfModifiers: KEYMODIFIERS) callconv(.Inline) HRESULT {
...
pub const IPropertyPage = extern struct {
    pub const VTable = extern struct {
        ...
        Help: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IPropertyPage,
                pszHelpDir: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IPropertyPage,
                pszHelpDir: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertyPage_Help(self: *const T, pszHelpDir: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IPicture = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPicture_get_Handle(self: *const T, pHandle: ?*OLE_HANDLE) callconv(.Inline) HRESULT {
            return @as(*const IPicture.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const IPicture, @ptrCast(self)), pHandle);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPicture_get_hPal(self: *const T, phPal: ?*OLE_HANDLE) callconv(.Inline) HRESULT {
            return @as(*const IPicture.VTable, @ptrCast(self.vtable)).get_hPal(@as(*const IPicture, @ptrCast(self)), phPal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPicture_get_Type(self: *const T, pType: ?*PICTYPE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPicture_set_hPal(self: *const T, hPal: OLE_HANDLE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPicture_SelectPicture(self: *const T, hDCIn: ?HDC, phDCOut: ?*?HDC, phBmpOut: ?*OLE_HANDLE) callconv(.Inline) HRESULT {
...
pub const DVEXTENTMODE = enum(i32) {
    CONTENT = 0,
    INTEGRAL = 1,
};
pub const DVEXTENT_CONTENT = DVEXTENTMODE.CONTENT;
pub const DVEXTENT_INTEGRAL = DVEXTENTMODE.INTEGRAL;

pub const DVASPECTINFOFLAG = enum(i32) {
    E = 1,
};
pub const DVASPECTINFOFLAG_CANOPTIMIZE = DVASPECTINFOFLAG.E;
...
pub const IViewObjectEx = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IViewObjectEx_GetNaturalExtent(self: *const T, dwAspect: DVASPECT, lindex: i32, ptd: ?*DVTARGETDEVICE, hicTargetDev: ?HDC, pExtentInfo: ?*DVEXTENTINFO, pSizel: ?*SIZE) callconv(.Inline) HRESULT {
...
pub const IPointerInactive = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPointerInactive_GetActivationPolicy(self: *const T, pdwPolicy: ?*POINTERINACTIVE) callconv(.Inline) HRESULT {
...
pub const IVBGetControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVBGetControl_EnumControls(self: *const T, dwOleContF: u32, dwWhich: ENUM_CONTROLS_WHICH_FLAGS, ppenumUnk: ?*?*IEnumUnknown) callconv(.Inline) HRESULT {
...
pub const IProtectedModeMenuServices = extern struct {
    pub const VTable = extern struct {
        ...
        LoadMenu: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IProtectedModeMenuServices,
                pszModuleName: ?[*:0]align(1) const u16,
                pszMenuName: ?[*:0]align(1) const u16,
                phMenu: ?*?HMENU,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IProtectedModeMenuServices,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProtectedModeMenuServices_LoadMenu(self: *const T, pszModuleName: ?[*:0]align(1) const u16, pszMenuName: ?[*:0]align(1) const u16, phMenu: ?*?HMENU) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProtectedModeMenuServices_LoadMenuID(self: *const T, pszModuleName: ?[*:0]align(1) const u16, wResourceID: u16, phMenu: ?*?HMENU) callconv(.Inline) HRESULT {
...
pub const OLEUIINSERTOBJECTW = extern struct {
    ...
    lCustData: LPARAM,
    hInstance: ?HINSTANCE,
    lpszTemplate: ?[*:0]align(1) const u16,
    hResource: ?HRSRC,
    clsid: Guid,
    lpszFile: ?PWSTR,
    cchFile: u32,
...
pub const OLEUIINSERTOBJECTA = extern struct {
    ...
    lCustData: LPARAM,
    hInstance: ?HINSTANCE,
    lpszTemplate: ?[*:0]align(1) const u8,
    hResource: ?HRSRC,
    clsid: Guid,
    lpszFile: ?PSTR,
    cchFile: u32,
...
pub const OLEUIPASTEENTRYW = extern struct {
    fmtetc: FORMATETC,
    lpstrFormatName: ?[*:0]align(1) const u16,
    lpstrResultText: ?[*:0]align(1) const u16,
    dwFlags: u32,
    dwScratchSpace: u32,
};
...
pub const OLEUIPASTEENTRYA = extern struct {
    fmtetc: FORMATETC,
    lpstrFormatName: ?[*:0]align(1) const u8,
    lpstrResultText: ?[*:0]align(1) const u8,
    dwFlags: u32,
    dwScratchSpace: u32,
};
...
pub const IOleUIObjInfoW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleUIObjInfoW_GetViewInfo(self: *const T, dwObject: u32, phMetaPict: ?*?HGLOBAL, pdvAspect: ?*u32, pnCurrentScale: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleUIObjInfoW_SetViewInfo(self: *const T, dwObject: u32, hMetaPict: ?HGLOBAL, dvAspect: u32, nCurrentScale: i32, bRelativeToOrig: BOOL) callconv(.Inline) HRESULT {
...
pub const IOleUIObjInfoA = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleUIObjInfoA_GetViewInfo(self: *const T, dwObject: u32, phMetaPict: ?*?HGLOBAL, pdvAspect: ?*u32, pnCurrentScale: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOleUIObjInfoA_SetViewInfo(self: *const T, dwObject: u32, hMetaPict: ?HGLOBAL, dvAspect: u32, nCurrentScale: i32, bRelativeToOrig: BOOL) callconv(.Inline) HRESULT {
...
pub const IDispatchEx = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDispatchEx_GetMemberProperties(self: *const T, id: i32, grfdexFetch: u32, pgrfdex: ?*FDEX_PROP_FLAGS) callconv(.Inline) HRESULT {
...
pub const IVariantChangeType = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IVariantChangeType_ChangeType(self: *const T, pvarDst: ?*VARIANT, pvarSrc: ?*VARIANT, lcid: u32, vtNew: VARENUM) callconv(.Inline) HRESULT {
...
pub const IProvideRuntimeContext = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProvideRuntimeContext_GetCurrentSourceContext(self: *const T, pdwContext: ?*usize, pfExecutingGlobalCode: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "oleaut32" fn VarCmp(
    ...
    lcid: u32,
    dwFlags: u32,
) callconv(@import("std").os.windows.WINAPI) VARCMP;
...
pub extern "oleaut32" fn RegisterTypeLib(
    ptlib: ?*ITypeLib,
    szFullPath: ?[*:0]align(1) const u16,
    szHelpDir: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "ole32" fn OleCreateLinkToFile(
    lpszFileName: ?[*:0]align(1) const u16,
    riid: ?*const Guid,
    renderopt: u32,
    lpFormatEtc: ?*FORMATETC,
    pClientSite: ?*IOleClientSite,
...
) callconv(@import("std").os.windows.WINAPI) ?HGLOBAL;
...
pub extern "oledlg" fn OleUIAddVerbMenuW(
    lpOleObj: ?*IOleObject,
    lpszShortType: ?[*:0]align(1) const u16,
    hMenu: ?HMENU,
    uPos: u32,
    uIDVerbMin: u32,
    uIDVerbMax: u32,
...
pub extern "oledlg" fn OleUIAddVerbMenuA(
    lpOleObj: ?*IOleObject,
    lpszShortType: ?[*:0]align(1) const u8,
    hMenu: ?HMENU,
    uPos: u32,
    uIDVerbMin: u32,
    uIDVerbMax: u32,
...
const BYTE_SIZEDARR = @import("../../../windows/win32/system/com.zig").BYTE_SIZEDARR;
const CALLCONV = @import("../../../windows/win32/system/com.zig").CALLCONV;
const CHAR = @import("../../../windows/win32/foundation.zig").CHAR;
const COLORREF = @import("../../../windows/win32/foundation.zig").COLORREF;
const CUSTDATA = @import("../../../windows/win32/system/com.zig").CUSTDATA;
...
const DVASPECT = @import("../../../windows/win32/system/com.zig").DVASPECT;
const DVTARGETDEVICE = @import("../../../windows/win32/system/com.zig").DVTARGETDEVICE;
const DWORD_SIZEDARR = @import("../../../windows/win32/system/com.zig").DWORD_SIZEDARR;
const EXCEPINFO = @import("../../../windows/win32/system/com.zig").EXCEPINFO;
const FILETIME = @import("../../../windows/win32/foundation.zig").FILETIME;
const FLAGGED_WORD_BLOB = @import("../../../windows/win32/system/com.zig").FLAGGED_WORD_BLOB;
const FORMATETC = @import("../../../windows/win32/system/com.zig").FORMATETC;
const FUNCDESC = @import("../../../windows/win32/system/com.zig").FUNCDESC;
const GLOBAL_ALLOC_FLAGS = @import("../../../windows/win32/system/memory.zig").GLOBAL_ALLOC_FLAGS;
...
const HCURSOR = @import("../../../windows/win32/ui/windows_and_messaging.zig").HCURSOR;
...
const HRSRC = @import("../../../windows/win32/foundation.zig").HRSRC;
const HTASK = @import("../../../windows/win32/media.zig").HTASK;
const HWND = @import("../../../windows/win32/foundation.zig").HWND;
const HYPER_SIZEDARR = @import("../../../windows/win32/system/com.zig").HYPER_SIZEDARR;
const IAdviseSink = @import("../../../windows/win32/system/com.zig").IAdviseSink;
const IBindCtx = @import("../../../windows/win32/system/com.zig").IBindCtx;
const IBindHost = @import("../../../windows/win32/system/com.zig").IBindHost;
const IClassFactory = @import("../../../windows/win32/system/com.zig").IClassFactory;
const IDataObject = @import("../../../windows/win32/system/com.zig").IDataObject;
const IDispatch = @import("../../../windows/win32/system/com.zig").IDispatch;
const IDLDESC = @import("../../../windows/win32/system/com.zig").IDLDESC;
const IEnumFORMATETC = @import("../../../windows/win32/system/com.zig").IEnumFORMATETC;
const IEnumSTATDATA = @import("../../../windows/win32/system/com.zig").IEnumSTATDATA;
...
const IMPLTYPEFLAGS = @import("../../../windows/win32/system/com.zig").IMPLTYPEFLAGS;
const INVOKEKIND = @import("../../../windows/win32/system/com.zig").INVOKEKIND;
const IPersist = @import("../../../windows/win32/system/com.zig").IPersist;
const IPersistStorage = @import("../../../windows/win32/system/com/structured_storage.zig").IPersistStorage;
const IPersistStream = @import("../../../windows/win32/system/com.zig").IPersistStream;
const IPropertyBag = @import("../../../windows/win32/system/com/structured_storage.zig").IPropertyBag;
const IPropertyBag2 = @import("../../../windows/win32/system/com/structured_storage.zig").IPropertyBag2;
...
const ITypeLib = @import("../../../windows/win32/system/com.zig").ITypeLib;
...
const MENU_ITEM_FLAGS = @import("../../../windows/win32/ui/windows_and_messaging.zig").MENU_ITEM_FLAGS;
const MODIFIERKEYS_FLAGS = @import("../../../windows/win32/system/system_services.zig").MODIFIERKEYS_FLAGS;
const MSG = @import("../../../windows/win32/ui/windows_and_messaging.zig").MSG;
const OPENFILENAMEA = @import("../../../windows/win32/ui/controls/dialogs.zig").OPENFILENAMEA;
const OPENFILENAMEW = @import("../../../windows/win32/ui/controls/dialogs.zig").OPENFILENAMEW;
const POINT = @import("../../../windows/win32/foundation.zig").POINT;
const POINTL = @import("../../../windows/win32/foundation.zig").POINTL;
...
const SAFEARRAYBOUND = @import("../../../windows/win32/system/com.zig").SAFEARRAYBOUND;
const SIZE = @import("../../../windows/win32/foundation.zig").SIZE;
const STGMEDIUM = @import("../../../windows/win32/system/com.zig").STGMEDIUM;
const SYSKIND = @import("../../../windows/win32/system/com.zig").SYSKIND;
...
const TYPEKIND = @import("../../../windows/win32/system/com.zig").TYPEKIND;
const VARDESC = @import("../../../windows/win32/system/com.zig").VARDESC;
...
const WORD_SIZEDARR = @import("../../../windows/win32/system/com.zig").WORD_SIZEDARR;
