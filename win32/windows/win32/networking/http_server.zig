...
pub const HTTP_LOG_FIELD_FAULT_CODE = @as(u32, 2147483648);
...
pub const HTTP_SERVICE_CONFIG_SSL_FLAG_DISABLE_SESSION_ID = @as(u32, 16384);
...
pub const HTTP_LOGGING_INFO = extern struct {
    Flags: HTTP_PROPERTY_FLAGS,
    LoggingFlags: u32,
    SoftwareName: ?[*:0]align(1) const u16,
    SoftwareNameLength: u16,
    DirectoryNameLength: u16,
    DirectoryName: ?[*:0]align(1) const u16,
...
pub const HTTP_LOG_FIELDS_DATA = extern struct {
    ...
    CookieLength: u16,
    ReferrerLength: u16,
    UserName: ?[*]align(1) u16,
    UriStem: ?[*]align(1) u16,
    ClientIp: ?[*]align(1) u8,
    ServerName: ?[*]align(1) u8,
    ServiceName: ?[*]align(1) u8,
    ServerIp: ?[*]align(1) u8,
    Method: ?[*]align(1) u8,
    UriQuery: ?[*]align(1) u8,
    Host: ?[*]align(1) u8,
    UserAgent: ?[*]align(1) u8,
    Cookie: ?[*]align(1) u8,
    Referrer: ?[*]align(1) u8,
    ServerPort: u16,
    ProtocolStatus: u16,
...
pub const HTTP_DATA_CHUNK = extern struct {
    ...
    Anonymous: extern union {
        ...
        FromFragmentCache: extern struct {
            ...
            pFragmentName: ?[*:0]align(1) const u16,
        },
...
pub const HTTP_COOKED_URL = extern struct {
    ...
    pFullUrl: ?[*:0]align(1) const u16,
    pHost: ?[*:0]align(1) const u16,
    pAbsPath: ?[*:0]align(1) const u16,
    pQueryString: ?[*:0]align(1) const u16,
};
...
pub const HTTP_SSL_INFO = extern struct {
    ...
    pServerCertIssuer: ?[*:0]align(1) const u8,
    pServerCertSubject: ?[*:0]align(1) const u8,
...
pub const HTTP_REQUEST_V1 = extern struct {
    ...
    RawUrlLength: u16,
    pUnknownVerb: ?[*:0]align(1) const u8,
    pRawUrl: ?[*:0]align(1) const u8,
...
pub const HttpFeatureLast = HTTP_FEATURE_ID.Last;
...
pub extern "httpapi" fn HttpAddUrl(
    RequestQueueHandle: ?HANDLE,
    FullyQualifiedUrl: ?[*:0]align(1) const u16,
    Reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpAddUrlToUrlGroup(
    UrlGroupId: u64,
    pFullyQualifiedUrl: ?[*:0]align(1) const u16,
    UrlContext: u64,
    Reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
