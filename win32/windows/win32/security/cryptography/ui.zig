...
pub const CRYPTUI_WIZ_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPTUI_WIZ_FLAGS, @enumFromInt(
              (if (o.NO_UI == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.NO_UI) else 0)
            | (if (o.IGNORE_NO_UI_FLAG_FOR_CSPS == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IGNORE_NO_UI_FLAG_FOR_CSPS) else 0)
            | (if (o.NO_UI_EXCEPT_CSP == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.NO_UI_EXCEPT_CSP) else 0)
            | (if (o.IMPORT_ALLOW_CERT == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_ALLOW_CERT) else 0)
            | (if (o.IMPORT_ALLOW_CRL == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_ALLOW_CRL) else 0)
            | (if (o.IMPORT_ALLOW_CTL == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_ALLOW_CTL) else 0)
            | (if (o.IMPORT_NO_CHANGE_DEST_STORE == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_NO_CHANGE_DEST_STORE) else 0)
            | (if (o.IMPORT_TO_LOCALMACHINE == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_TO_LOCALMACHINE) else 0)
            | (if (o.IMPORT_TO_CURRENTUSER == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_TO_CURRENTUSER) else 0)
            | (if (o.IMPORT_REMOTE_DEST_STORE == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.IMPORT_REMOTE_DEST_STORE) else 0)
            | (if (o.EXPORT_PRIVATE_KEY == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.EXPORT_PRIVATE_KEY) else 0)
            | (if (o.EXPORT_NO_DELETE_PRIVATE_KEY == 1) @intFromEnum(CRYPTUI_WIZ_FLAGS.EXPORT_NO_DELETE_PRIVATE_KEY) else 0)
        ));
    }
};
...
pub const CRYPTUI_VIEWCERTIFICATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CRYPTUI_VIEWCERTIFICATE_FLAGS, @enumFromInt(
              (if (o.HIDE_HIERARCHYPAGE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.HIDE_HIERARCHYPAGE) else 0)
            | (if (o.HIDE_DETAILPAGE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.HIDE_DETAILPAGE) else 0)
            | (if (o.DISABLE_EDITPROPERTIES == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DISABLE_EDITPROPERTIES) else 0)
            | (if (o.ENABLE_EDITPROPERTIES == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ENABLE_EDITPROPERTIES) else 0)
            | (if (o.DISABLE_ADDTOSTORE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DISABLE_ADDTOSTORE) else 0)
            | (if (o.ENABLE_ADDTOSTORE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ENABLE_ADDTOSTORE) else 0)
            | (if (o.ACCEPT_DECLINE_STYLE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ACCEPT_DECLINE_STYLE) else 0)
            | (if (o.IGNORE_UNTRUSTED_ROOT == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.IGNORE_UNTRUSTED_ROOT) else 0)
            | (if (o.DONT_OPEN_STORES == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DONT_OPEN_STORES) else 0)
            | (if (o.ONLY_OPEN_ROOT_STORE == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ONLY_OPEN_ROOT_STORE) else 0)
            | (if (o.WARN_UNTRUSTED_ROOT == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.WARN_UNTRUSTED_ROOT) else 0)
            | (if (o.ENABLE_REVOCATION_CHECKING == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ENABLE_REVOCATION_CHECKING) else 0)
            | (if (o.WARN_REMOTE_TRUST == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.WARN_REMOTE_TRUST) else 0)
            | (if (o.DISABLE_EXPORT == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DISABLE_EXPORT) else 0)
            | (if (o.ENABLE_REVOCATION_CHECK_END_CERT == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ENABLE_REVOCATION_CHECK_END_CERT) else 0)
            | (if (o.ENABLE_REVOCATION_CHECK_CHAIN == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.ENABLE_REVOCATION_CHECK_CHAIN) else 0)
            | (if (o.DISABLE_HTMLLINK == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DISABLE_HTMLLINK) else 0)
            | (if (o.DISABLE_ISSUERSTATEMENT == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.DISABLE_ISSUERSTATEMENT) else 0)
            | (if (o.CACHE_ONLY_URL_RETRIEVAL == 1) @intFromEnum(CRYPTUI_VIEWCERTIFICATE_FLAGS.CACHE_ONLY_URL_RETRIEVAL) else 0)
        ));
    }
};
...
pub const CERT_SELECT_STRUCT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_SELECT_STRUCT_FLAGS, @enumFromInt(
              (if (o.HIDE_PROPERTIES == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.HIDE_PROPERTIES) else 0)
            | (if (o.ENABLEHOOK == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.ENABLEHOOK) else 0)
            | (if (o.ALLOWMULTISELECT == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.ALLOWMULTISELECT) else 0)
            | (if (o.SHOW_HELP == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.SHOW_HELP) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.ENABLETEMPLATEHANDLE == 1) @intFromEnum(CERT_SELECT_STRUCT_FLAGS.ENABLETEMPLATEHANDLE) else 0)
        ));
    }
};
...
pub const CERT_VIEWPROPERTIES_STRUCT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(CERT_VIEWPROPERTIES_STRUCT_FLAGS, @enumFromInt(
              (if (o.ENABLEHOOK == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.ENABLEHOOK) else 0)
            | (if (o.SHOW_HELP == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.SHOW_HELP) else 0)
            | (if (o.SHOW_HELPICON == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.SHOW_HELPICON) else 0)
            | (if (o.ENABLETEMPLATE == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.ENABLETEMPLATE) else 0)
            | (if (o.HIDE_ADVANCEPAGE == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.HIDE_ADVANCEPAGE) else 0)
            | (if (o.HIDE_TRUSTPAGE == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.HIDE_TRUSTPAGE) else 0)
            | (if (o.NO_NAMECHANGE == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.NO_NAMECHANGE) else 0)
            | (if (o.NO_EDITTRUST == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.NO_EDITTRUST) else 0)
            | (if (o.HIDE_DETAILPAGE == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.HIDE_DETAILPAGE) else 0)
            | (if (o.ADD_CERT_STORES == 1) @intFromEnum(CERT_VIEWPROPERTIES_STRUCT_FLAGS.ADD_CERT_STORES) else 0)
        ));
    }
};
...
pub const CERT_SELECT_STRUCT_W = extern struct {
    ...
    hwndParent: ?HWND,
    hInstance: ?HINSTANCE,
    pTemplateName: ?[*:0]align(1) const u16,
    dwFlags: CERT_SELECT_STRUCT_FLAGS,
    ...
    pfnHook: ?PFNCMHOOKPROC,
    pfnFilter: ?PFNCMFILTERPROC,
    szHelpFileName: ?[*:0]align(1) const u16,
    dwHelpId: u32,
    hprov: usize,
};
...
pub const CERT_FILTER_EXTENSION_MATCH = extern struct {
    szExtensionOID: ?[*:0]align(1) const u8,
    dwTestOperation: u32,
    pbTestData: ?*u8,
    cbTestData: u32,
};
...
pub const CRYPTUI_CERT_MGR_STRUCT = extern struct {
    ...
    hwndParent: ?HWND,
    dwFlags: u32,
    pwszTitle: ?[*:0]align(1) const u16,
    pszInitUsageOID: ?[*:0]align(1) const u8,
};
...
pub const CRYPTUI_WIZ_DIGITAL_SIGN_EXTENDED_INFO = extern struct {
    ...
    pwszMoreInfoLocation: ?[*:0]align(1) const u16,
    pszHashAlg: ?[*:0]align(1) const u8,
    pwszSigningCertDisplayString: ?[*:0]align(1) const u16,
...
pub const CRYPTUI_WIZ_DIGITAL_SIGN_INFO = extern struct {
    ...
    pwszTimestampURL: ?[*:0]align(1) const u16,
...
pub const CRYPTUI_WIZ_EXPORT_INFO = extern struct {
    dwSize: u32,
    pwszExportFileName: ?[*:0]align(1) const u16,
...
pub extern "cryptui" fn CryptUIDlgSelectCertificateFromStore(
    ...
    hwnd: ?HWND,
    pwszTitle: ?[*:0]align(1) const u16,
    pwszDisplayString: ?[*:0]align(1) const u16,
    dwDontUseColumn: u32,
    dwFlags: u32,
    pvReserved: ?*anyopaque,
...
pub extern "cryptui" fn CryptUIWizDigitalSign(
    dwFlags: u32,
    hwndParent: ?HWND,
    pwszWizardTitle: ?[*:0]align(1) const u16,
...
const CRL_CONTEXT = @import("../../../../windows/win32/security/cryptography.zig").CRL_CONTEXT;
const CRYPT_ATTRIBUTES = @import("../../../../windows/win32/security/cryptography.zig").CRYPT_ATTRIBUTES;
const CRYPT_INTEGER_BLOB = @import("../../../../windows/win32/security/cryptography.zig").CRYPT_INTEGER_BLOB;
const CRYPT_KEY_FLAGS = @import("../../../../windows/win32/security/cryptography.zig").CRYPT_KEY_FLAGS;
const CRYPT_KEY_PROV_INFO = @import("../../../../windows/win32/security/cryptography.zig").CRYPT_KEY_PROV_INFO;
const CRYPT_PROVIDER_DATA = @import("../../../../windows/win32/security/win_trust.zig").CRYPT_PROVIDER_DATA;
const CTL_CONTEXT = @import("../../../../windows/win32/security/cryptography.zig").CTL_CONTEXT;
...
const PROPSHEETPAGEA = @import("../../../../windows/win32/ui/controls.zig").PROPSHEETPAGEA;
const PROPSHEETPAGEW = @import("../../../../windows/win32/ui/controls.zig").PROPSHEETPAGEW;
