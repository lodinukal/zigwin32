...
pub const WER_RUNTIME_EXCEPTION_INFORMATION = extern struct {
    ...
    context: CONTEXT,
    pwszReportId: ?[*:0]align(1) const u16,
    bIsFatal: BOOL,
    dwReserved: u32,
};
...
pub extern "wer" fn WerReportCreate(
    pwzEventType: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn WerRegisterAppLocalDump(
    localAppDataRelativePath: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "wer" fn WerAddExcludedApplication(
    pwzExeName: ?[*:0]align(1) const u16,
    bAllUsers: BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "kernel32" fn WerRegisterRuntimeExceptionModule(
    pwszOutOfProcessCallbackDll: ?[*:0]align(1) const u16,
    pContext: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "wer" fn WerStoreQueryReportMetadataV2(
    hReportStore: HREPORTSTORE,
    pszReportKey: ?[*:0]align(1) const u16,
...
pub extern "faultrep" fn AddERExcludedApplicationA(
    szApplication: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "faultrep" fn AddERExcludedApplicationW(
    wszApplication: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "faultrep" fn WerReportHang(
    hwndHungApp: ?HWND,
    pwzHungApplicationName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const EXCEPTION_RECORD = @import("../../../windows/win32/system/diagnostics/debug.zig").EXCEPTION_RECORD;
