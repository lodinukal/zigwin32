...
pub const DWMWA_SYSTEMBACKDROP_TYPE = DWMWINDOWATTRIBUTE.SYSTEMBACKDROP_TYPE;
...
pub const DWM_SYSTEMBACKDROP_TYPE = enum(i32) {
    AUTO = 0,
    NONE = 1,
    MAINWINDOW = 2,
    TRANSIENTWINDOW = 3,
...
pub const DWMSBT_AUTO = DWM_SYSTEMBACKDROP_TYPE.AUTO;
pub const DWMSBT_NONE = DWM_SYSTEMBACKDROP_TYPE.NONE;
pub const DWMSBT_MAINWINDOW = DWM_SYSTEMBACKDROP_TYPE.MAINWINDOW;
pub const DWMSBT_TRANSIENTWINDOW = DWM_SYSTEMBACKDROP_TYPE.TRANSIENTWINDOW;
pub const DWMSBT_TABBEDWINDOW = DWM_SYSTEMBACKDROP_TYPE.TABBEDWINDOW;
...
pub const DWM_TAB_WINDOW_REQUIREMENTS = enum(i32) {
    NONE = 0,
...
const MARGINS = @import("../../../windows/win32/ui/controls.zig").MARGINS;
