...
pub const WEBAUTHN_API_VERSION_4 = @as(u32, 4);
pub const WEBAUTHN_API_CURRENT_VERSION = @as(u32, 4);
...
pub const WEBAUTHN_CREDENTIAL_DETAILS_VERSION_1 = @as(u32, 1);
pub const WEBAUTHN_CREDENTIAL_DETAILS_CURRENT_VERSION = @as(u32, 1);
pub const WEBAUTHN_GET_CREDENTIALS_OPTIONS_VERSION_1 = @as(u32, 1);
pub const WEBAUTHN_GET_CREDENTIALS_OPTIONS_CURRENT_VERSION = @as(u32, 1);
pub const WEBAUTHN_CTAP_ONE_HMAC_SECRET_LENGTH = @as(u32, 32);
...
pub const WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_VERSION_5 = @as(u32, 5);
pub const WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_CURRENT_VERSION = @as(u32, 5);
...
pub const WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS_VERSION_6 = @as(u32, 6);
pub const WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS_CURRENT_VERSION = @as(u32, 6);
pub const WEBAUTHN_AUTHENTICATOR_HMAC_SECRET_VALUES_FLAG = @as(u32, 1048576);
...
pub const WEBAUTHN_ASSERTION_VERSION_3 = @as(u32, 3);
pub const WEBAUTHN_ASSERTION_CURRENT_VERSION = @as(u32, 3);
...
pub const IContentPrefetcherTaskTrigger = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IContentPrefetcherTaskTrigger_TriggerContentPrefetcherTask(self: *const T, packageFullName: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IContentPrefetcherTaskTrigger_IsRegisteredForContentPrefetch(self: *const T, packageFullName: ?[*:0]align(1) const u16, isRegistered: ?*u8) callconv(.Inline) HRESULT {
...
pub const WEBAUTHN_RP_ENTITY_INFORMATION = extern struct {
    dwVersion: u32,
    pwszId: ?[*:0]align(1) const u16,
    pwszName: ?[*:0]align(1) const u16,
    pwszIcon: ?[*:0]align(1) const u16,
};
...
pub const WEBAUTHN_CLIENT_DATA = extern struct {
    ...
    pbClientDataJSON: ?*u8,
    pwszHashAlgId: ?[*:0]align(1) const u16,
};

pub const WEBAUTHN_COSE_CREDENTIAL_PARAMETER = extern struct {
    dwVersion: u32,
    pwszCredentialType: ?[*:0]align(1) const u16,
    lAlg: i32,
};
...
pub const WEBAUTHN_EXTENSION = extern struct {
    pwszExtensionIdentifier: ?[*:0]align(1) const u16,
    cbExtension: u32,
...
pub const WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS = extern struct {
    ...
    dwUserVerificationRequirement: u32,
    dwFlags: u32,
    pwszU2fAppId: ?[*:0]align(1) const u16,
    pbU2fAppId: ?*BOOL,
    pCancellationId: ?*Guid,
...
pub const WEBAUTHN_COMMON_ATTESTATION = extern struct {
    dwVersion: u32,
    pwszAlg: ?[*:0]align(1) const u16,
    lAlg: i32,
    cbSignature: u32,
    pbSignature: ?*u8,
    cX5c: u32,
    pX5c: ?*WEBAUTHN_X5C,
    pwszVer: ?[*:0]align(1) const u16,
    cbCertInfo: u32,
    pbCertInfo: ?*u8,
    cbPubArea: u32,
    pbPubArea: ?*u8,
...
pub const WEBAUTHN_CREDENTIAL_ATTESTATION = extern struct {
    dwVersion: u32,
    pwszFormatType: ?[*:0]align(1) const u16,
...
pub extern "webauthn" fn WebAuthNGetPlatformCredentialList(
    pGetCredentialsOptions: ?*WEBAUTHN_GET_CREDENTIALS_OPTIONS,
    ppCredentialDetailsList: ?*?*WEBAUTHN_CREDENTIAL_DETAILS_LIST,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "webauthn" fn WebAuthNFreePlatformCredentialList(
    pCredentialDetailsList: ?*WEBAUTHN_CREDENTIAL_DETAILS_LIST,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "webauthn" fn WebAuthNDeletePlatformCredential(
    cbCredentialId: u32,
...
const NCRYPT_KEY_HANDLE = @import("../../../windows/win32/security/cryptography.zig").NCRYPT_KEY_HANDLE;
const PWSTR = @import("../../../windows/win32/foundation.zig").PWSTR;
const SecPkgContext_IssuerListInfoEx = @import("../../../windows/win32/security/authentication/identity.zig").SecPkgContext_IssuerListInfoEx;
