...
const DEBUG_EVENT = @import("../../../windows/win32/system/diagnostics/debug.zig").DEBUG_EVENT;
const FLOATING_SAVE_AREA = @import("../../../windows/win32/system/kernel.zig").FLOATING_SAVE_AREA;
...
const CONTEXT = switch(@import("../../../zig.zig").arch) {
    .X86 => @import("../../../windows/win32/system/diagnostics/debug.zig").CONTEXT,
    else => usize, // NOTE: this should be a @compileError but can't because of https://github.com/ziglang/zig/issues/9682
};
const LDT_ENTRY = switch(@import("../../../zig.zig").arch) {
    .X86 => @import("../../../windows/win32/system/diagnostics/debug.zig").LDT_ENTRY,
    else => usize, // NOTE: this should be a @compileError but can't because of https://github.com/ziglang/zig/issues/9682
};
