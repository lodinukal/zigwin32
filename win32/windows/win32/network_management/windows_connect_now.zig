...
pub const PKEY_WCN_DeviceType_Category = PROPERTYKEY { .fmtid = Guid.initIntString("2283342731, 18052, 4570, 162, 106, 0, 2, 179, 152, 142, 129"), .pid = 16 };
pub const PKEY_WCN_DeviceType_SubCategoryOUI = PROPERTYKEY { .fmtid = Guid.initIntString("2283342731, 18052, 4570, 162, 106, 0, 2, 179, 152, 142, 129"), .pid = 17 };
pub const PKEY_WCN_DeviceType_SubCategory = PROPERTYKEY { .fmtid = Guid.initIntString("2283342731, 18052, 4570, 162, 106, 0, 2, 179, 152, 142, 129"), .pid = 18 };
pub const PKEY_WCN_SSID = PROPERTYKEY { .fmtid = Guid.initIntString("2283342731, 18052, 4570, 162, 106, 0, 2, 179, 152, 142, 129"), .pid = 32 };
...
pub const IWCNDevice = extern struct {
    pub const VTable = extern struct {
        ...
        SetNetworkProfile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWCNDevice,
                pszProfileXml: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWCNDevice,
                pszProfileXml: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWCNDevice_SetNetworkProfile(self: *const T, pszProfileXml: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
