...
const D3D12_RESOURCE_STATES = @import("../../../windows/win32/graphics/direct3d12.zig").D3D12_RESOURCE_STATES;
...
const ID3D11Device = @import("../../../windows/win32/graphics/direct3d11.zig").ID3D11Device;
const ID3D11DeviceContext = @import("../../../windows/win32/graphics/direct3d11.zig").ID3D11DeviceContext;
const ID3D11Resource = @import("../../../windows/win32/graphics/direct3d11.zig").ID3D11Resource;
const ID3D12CommandQueue = @import("../../../windows/win32/graphics/direct3d12.zig").ID3D12CommandQueue;
const ID3D12Fence = @import("../../../windows/win32/graphics/direct3d12.zig").ID3D12Fence;
