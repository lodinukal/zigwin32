...
pub const IGameStatistics = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameStatistics_SetCategoryTitle(self: *const T, categoryIndex: u16, title: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameStatistics_SetStatistic(self: *const T, categoryIndex: u16, statIndex: u16, name: ?[*:0]align(1) const u16, value: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IGameStatisticsMgr = extern struct {
    pub const VTable = extern struct {
        ...
        GetGameStatistics: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                GDFBinaryPath: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameStatisticsMgr_GetGameStatistics(self: *const T, GDFBinaryPath: ?[*:0]align(1) const u16, openType: GAMESTATS_OPEN_TYPE, pOpenResult: ?*GAMESTATS_OPEN_RESULT, ppiStats: ?*?*IGameStatistics) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameStatisticsMgr_RemoveGameStatistics(self: *const T, GDFBinaryPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IGameExplorer2 = extern struct {
    pub const VTable = extern struct {
        ...
        InstallGame: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                binaryGDFPath: ?[*:0]align(1) const u16,
                installDirectory: ?[*:0]align(1) const u16,
                installScope: GAME_INSTALL_SCOPE,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IGameExplorer2,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameExplorer2_InstallGame(self: *const T, binaryGDFPath: ?[*:0]align(1) const u16, installDirectory: ?[*:0]align(1) const u16, installScope: GAME_INSTALL_SCOPE) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameExplorer2_UninstallGame(self: *const T, binaryGDFPath: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGameExplorer2_CheckAccess(self: *const T, binaryGDFPath: ?[*:0]align(1) const u16, pHasAccess: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const GAMING_DEVICE_DEVICE_ID = enum(i32) {
    ...
    XBOX_SERIES_S = 489159355,
    XBOX_SERIES_X = 796540415,
    XBOX_SERIES_X_DEVKIT = -561359263,
};
...
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_S = GAMING_DEVICE_DEVICE_ID.XBOX_SERIES_S;
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_X = GAMING_DEVICE_DEVICE_ID.XBOX_SERIES_X;
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_X_DEVKIT = GAMING_DEVICE_DEVICE_ID.XBOX_SERIES_X_DEVKIT;
...
pub const IXblIdpAuthManager = extern struct {
    pub const VTable = extern struct {
        ...
        SetGamerAccount: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                msaAccountId: ?[*:0]align(1) const u16,
                xuid: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXblIdpAuthManager,
                msaAccountId: ?[*:0]align(1) const u16,
        ...
        GetTokenAndSignatureWithTokenResult: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                msaAccountId: ?[*:0]align(1) const u16,
                appSid: ?[*:0]align(1) const u16,
                msaTarget: ?[*:0]align(1) const u16,
                msaPolicy: ?[*:0]align(1) const u16,
                httpMethod: ?[*:0]align(1) const u16,
                uri: ?[*:0]align(1) const u16,
                headers: ?[*:0]align(1) const u16,
                body: [*:0]u8,
                bodySize: u32,
                forceRefresh: BOOL,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXblIdpAuthManager_SetGamerAccount(self: *const T, msaAccountId: ?[*:0]align(1) const u16, xuid: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXblIdpAuthManager_SetAppViewInitialized(self: *const T, appSid: ?[*:0]align(1) const u16, msaAccountId: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXblIdpAuthManager_GetTokenAndSignatureWithTokenResult(self: *const T, msaAccountId: ?[*:0]align(1) const u16, appSid: ?[*:0]align(1) const u16, msaTarget: ?[*:0]align(1) const u16, msaPolicy: ?[*:0]align(1) const u16, httpMethod: ?[*:0]align(1) const u16, uri: ?[*:0]align(1) const u16, headers: ?[*:0]align(1) const u16, body: [*:0]u8, bodySize: u32, forceRefresh: BOOL, result: ?*?*IXblIdpAuthTokenResult) callconv(.Inline) HRESULT {
...
const IID_IXblIdpAuthManager2_Value = Guid.initString("bf8c0950-8389-43dd-9a76-a19728ec5dc5");
pub const IID_IXblIdpAuthManager2 = &IID_IXblIdpAuthManager2_Value;
pub const IXblIdpAuthManager2 = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        GetUserlessTokenAndSignatureWithTokenResult: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IXblIdpAuthManager2,
                appSid: ?[*:0]align(1) const u16,
                msaTarget: ?[*:0]align(1) const u16,
                msaPolicy: ?[*:0]align(1) const u16,
                httpMethod: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXblIdpAuthManager2_GetUserlessTokenAndSignatureWithTokenResult(self: *const T, appSid: ?[*:0]align(1) const u16, msaTarget: ?[*:0]align(1) const u16, msaPolicy: ?[*:0]align(1) const u16, httpMethod: ?[*:0]align(1) const u16, uri: ?[*:0]align(1) const u16, headers: ?[*:0]align(1) const u16, body: [*:0]u8, bodySize: u32, forceRefresh: BOOL, result: ?*?*IXblIdpAuthTokenResult) callconv(.Inline) HRESULT {
            return @as(*const IXblIdpAuthManager2.VTable, @ptrCast(self.vtable)).GetUserlessTokenAndSignatureWithTokenResult(@as(*const IXblIdpAuthManager2, @ptrCast(self)), appSid, msaTarget, msaPolicy, httpMethod, uri, headers, body, bodySize, forceRefresh, result);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
