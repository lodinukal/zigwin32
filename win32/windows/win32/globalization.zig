...
pub const COMPARESTRING_RESULT = enum(i32) {
    LESS_THAN = 1,
    EQUAL = 2,
    GREATER_THAN = 3,
};
pub const CSTR_LESS_THAN = COMPARESTRING_RESULT.LESS_THAN;
pub const CSTR_EQUAL = COMPARESTRING_RESULT.EQUAL;
pub const CSTR_GREATER_THAN = COMPARESTRING_RESULT.GREATER_THAN;
...
pub const ISpellChecker = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_Check(self: *const T, text: ?[*:0]align(1) const u16, value: ?*?*IEnumSpellingError) callconv(.Inline) HRESULT {
            return @as(*const ISpellChecker.VTable, @ptrCast(self.vtable)).Check(@as(*const ISpellChecker, @ptrCast(self)), text, value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_Suggest(self: *const T, word: ?[*:0]align(1) const u16, value: ?*?*IEnumString) callconv(.Inline) HRESULT {
            return @as(*const ISpellChecker.VTable, @ptrCast(self.vtable)).Suggest(@as(*const ISpellChecker, @ptrCast(self)), word, value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_Add(self: *const T, word: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const ISpellChecker.VTable, @ptrCast(self.vtable)).Add(@as(*const ISpellChecker, @ptrCast(self)), word);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_Ignore(self: *const T, word: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const ISpellChecker.VTable, @ptrCast(self.vtable)).Ignore(@as(*const ISpellChecker, @ptrCast(self)), word);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_AutoCorrect(self: *const T, from: ?[*:0]align(1) const u16, to: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const ISpellChecker.VTable, @ptrCast(self.vtable)).AutoCorrect(@as(*const ISpellChecker, @ptrCast(self)), from, to);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_GetOptionValue(self: *const T, optionId: ?[*:0]align(1) const u16, value: ?*u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_GetOptionDescription(self: *const T, optionId: ?[*:0]align(1) const u16, value: ?*?*IOptionDescription) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker_ComprehensiveCheck(self: *const T, text: ?[*:0]align(1) const u16, value: ?*?*IEnumSpellingError) callconv(.Inline) HRESULT {
...
pub const ISpellChecker2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellChecker2_Remove(self: *const T, word: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISpellCheckerFactory = extern struct {
    pub const VTable = extern struct {
        ...
        IsSupported: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const ISpellCheckerFactory,
                languageTag: ?[*:0]align(1) const u16,
                value: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const ISpellCheckerFactory,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckerFactory_IsSupported(self: *const T, languageTag: ?[*:0]align(1) const u16, value: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckerFactory_CreateSpellChecker(self: *const T, languageTag: ?[*:0]align(1) const u16, value: ?*?*ISpellChecker) callconv(.Inline) HRESULT {
...
pub const IUserDictionariesRegistrar = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterUserDictionary: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                dictionaryPath: ?[*:0]align(1) const u16,
                languageTag: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IUserDictionariesRegistrar,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUserDictionariesRegistrar_RegisterUserDictionary(self: *const T, dictionaryPath: ?[*:0]align(1) const u16, languageTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUserDictionariesRegistrar_UnregisterUserDictionary(self: *const T, dictionaryPath: ?[*:0]align(1) const u16, languageTag: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const ISpellCheckProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProvider_Check(self: *const T, text: ?[*:0]align(1) const u16, value: ?*?*IEnumSpellingError) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProvider_Suggest(self: *const T, word: ?[*:0]align(1) const u16, value: ?*?*IEnumString) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProvider_GetOptionValue(self: *const T, optionId: ?[*:0]align(1) const u16, value: ?*u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProvider_SetOptionValue(self: *const T, optionId: ?[*:0]align(1) const u16, value: u8) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProvider_GetOptionDescription(self: *const T, optionId: ?[*:0]align(1) const u16, value: ?*?*IOptionDescription) callconv(.Inline) HRESULT {
...
pub const IComprehensiveSpellCheckProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComprehensiveSpellCheckProvider_ComprehensiveCheck(self: *const T, text: ?[*:0]align(1) const u16, value: ?*?*IEnumSpellingError) callconv(.Inline) HRESULT {
...
pub const ISpellCheckProviderFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProviderFactory_IsSupported(self: *const T, languageTag: ?[*:0]align(1) const u16, value: ?*BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpellCheckProviderFactory_CreateSpellCheckProvider(self: *const T, languageTag: ?[*:0]align(1) const u16, value: ?*?*ISpellCheckProvider) callconv(.Inline) HRESULT {
...
pub const UConverterFromUnicodeArgs = extern struct {
    ...
    target: ?PSTR,
    targetLimit: ?[*:0]align(1) const u8,
    offsets: ?*i32,
};
...
pub const UConverterToUnicodeArgs = extern struct {
    ...
    sourceLimit: ?[*:0]align(1) const u8,
    target: ?*u16,
...
pub const IMLangStringBufW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLangStringBufW_UnlockBuf(self: *const T, pszBuf: ?[*:0]align(1) const u16, cchOffset: i32, cchWrite: i32) callconv(.Inline) HRESULT {
...
pub const IMLangStringBufA = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLangStringBufA_UnlockBuf(self: *const T, pszBuf: ?[*:0]align(1) const u8, cchOffset: i32, cchWrite: i32) callconv(.Inline) HRESULT {
...
pub const IMLangFontLink2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMLangFontLink2_GetScriptFontInfo(self: *const T, sid: u8, dwFlags: u32, puiFonts: ?*u32, pScriptFont: ?*SCRIPTFONTINFO) callconv(.Inline) HRESULT {
...
pub const IMultiLanguage3 = extern struct {
    pub const VTable = extern struct {
        ...
        DetectOutboundCodePage: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                lpSpecialChar: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMultiLanguage3,
                dwFlags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMultiLanguage3_DetectOutboundCodePage(self: *const T, dwFlags: u32, lpWideCharStr: [*:0]const u16, cchWideChar: u32, puiPreferredCodePages: ?[*]const u32, nPreferredCodePages: u32, puiDetectedCodePages: [*]u32, pnDetectedCodePages: ?*u32, lpSpecialChar: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMultiLanguage3_DetectOutboundCodePageInIStream(self: *const T, dwFlags: u32, pStrIn: ?*IStream, puiPreferredCodePages: ?[*]const u32, nPreferredCodePages: u32, puiDetectedCodePages: [*]u32, pnDetectedCodePages: ?*u32, lpSpecialChar: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub extern "kernel32" fn GetTimeFormatEx(
    lpLocaleName: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn GetDateFormatEx(
    ...
    lpDateStr: ?[*:0]u16,
    cchDate: i32,
    lpCalendar: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "kernel32" fn CompareStringEx(
    ...
    lParam: LPARAM,
) callconv(@import("std").os.windows.WINAPI) COMPARESTRING_RESULT;
...
pub extern "kernel32" fn WideCharToMultiByte(
    ...
    lpMultiByteStr: ?PSTR,
    cbMultiByte: i32,
    lpDefaultChar: ?[*]align(1) const u8,
...
pub extern "kernel32" fn SetProcessPreferredUILanguages(
    dwFlags: u32,
    pwszLanguagesBuffer: ?[*]align(1) const u16,
    pulNumLanguages: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetFileMUIInfo(
    dwFlags: u32,
    pcwszFilePath: ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 3?
...
pub extern "kernel32" fn GetUILanguageInfo(
    dwFlags: u32,
    pwmszLanguage: ?[*]align(1) const u16,
...
pub extern "kernel32" fn NotifyUILanguageChange(
    dwFlags: u32,
    pcwstrNewLanguage: ?[*:0]align(1) const u16,
    pcwstrPreviousLanguage: ?[*:0]align(1) const u16,
    dwReserved: u32,
    pdwStatusRtrn: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn VerifyScripts(
    dwFlags: u32,
    lpLocaleScripts: ?[*:0]align(1) const u16,
    cchLocaleScripts: i32,
    lpTestScripts: ?[*:0]align(1) const u16,
    cchTestScripts: i32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetCalendarInfoEx(
    lpLocaleName: ?[*:0]align(1) const u16,
    Calendar: u32,
    lpReserved: ?[*:0]align(1) const u16,
    CalType: u32,
    lpCalData: ?[*:0]u16,
    cchData: i32,
    lpValue: ?*u32,
...
pub extern "kernel32" fn ResolveLocaleName(
    lpNameToResolve: ?[*:0]align(1) const u16,
    lpLocaleName: ?[*:0]u16,
    cchLocaleName: i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "elscore" fn MappingDoAction(
    pBag: ?*MAPPING_PROPERTY_BAG,
    dwRangeIndex: u32,
    pszActionId: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "usp10" fn ScriptTextOut(
    ...
    pwcReserved: ?[*:0]align(1) const u16,
    iReserved: i32,
    pwGlyphs: [*:0]const u16,
    cGlyphs: i32,
    piAdvance: [*]const i32,
...
pub extern "icu" fn u_versionFromString(
    versionArray: ?*u8,
    versionString: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "icu" fn uscript_getCode(
    nameOrAbbrOrLocale: ?[*:0]align(1) const u8,
    fillIn: ?*UScriptCode,
    capacity: i32,
    err: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "icu" fn uloc_getDisplayLanguage(
    locale: ?[*:0]align(1) const u8,
    displayLocale: ?[*:0]align(1) const u8,
    language: ?*u16,
    languageCapacity: i32,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "icu" fn uloc_getKeywordValue(
    localeID: ?[*:0]align(1) const u8,
    keywordName: ?[*:0]align(1) const u8,
    buffer: ?PSTR,
    bufferCapacity: i32,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "icu" fn uloc_setKeywordValue(
    keywordName: ?[*:0]align(1) const u8,
    keywordValue: ?[*:0]align(1) const u8,
    buffer: ?PSTR,
    bufferCapacity: i32,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "icu" fn uloc_acceptLanguageFromHTTP(
    ...
    httpAcceptLanguage: ?[*:0]align(1) const u8,
...
pub extern "icu" fn ures_open(
    packageName: ?[*:0]align(1) const u8,
    locale: ?[*:0]align(1) const u8,
    status: ?*UErrorCode,
...
pub extern "icu" fn ucurr_getPluralName(
    ...
    locale: ?[*:0]align(1) const u8,
    isChoiceFormat: ?*i8,
    pluralCount: ?[*:0]align(1) const u8,
    len: ?*i32,
    ec: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) ?*u16;
...
pub extern "icu" fn ucnv_compareNames(
    name1: ?[*:0]align(1) const u8,
    name2: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

pub extern "icu" fn ucnv_open(
    converterName: ?[*:0]align(1) const u8,
    err: ?*UErrorCode,
...
pub extern "icu" fn ucnv_convert(
    toConverterName: ?[*:0]align(1) const u8,
    fromConverterName: ?[*:0]align(1) const u8,
    target: ?PSTR,
    targetCapacity: i32,
    source: ?[*:0]align(1) const u8,
    sourceLength: i32,
...
pub extern "icu" fn ucnv_openStandardNames(
    convName: ?[*:0]align(1) const u8,
    standard: ?[*:0]align(1) const u8,
    pErrorCode: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) ?*UEnumeration;
...
pub extern "icu" fn ucol_getDisplayName(
    objLoc: ?[*:0]align(1) const u8,
    dispLoc: ?[*:0]align(1) const u8,
    result: ?*u16,
    resultLength: i32,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "icu" fn uspoof_openFromSource(
    confusables: ?[*:0]align(1) const u8,
    confusablesLen: i32,
    confusablesWholeScript: ?[*:0]align(1) const u8,
...
pub extern "icu" fn uspoof_setAllowedLocales(
    sc: ?*USpoofChecker,
    localesList: ?[*:0]align(1) const u8,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "icu" fn uspoof_areConfusableUTF8(
    sc: ?*const USpoofChecker,
    id1: ?[*:0]align(1) const u8,
    length1: i32,
    id2: ?[*:0]align(1) const u8,
    length2: i32,
    status: ?*UErrorCode,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "bcp47mrm" fn GetDistanceOfClosestLanguageInList(
    ...
    pszLanguagesList: ?[*:0]align(1) const u16,
...
pub extern "kernel32" fn lstrcmpA(
    lpString1: ?[*:0]align(1) const u8,
    lpString2: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn lstrcmpW(
    lpString1: ?[*:0]align(1) const u16,
    lpString2: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
const ABC = @import("../../windows/win32/graphics/gdi.zig").ABC;
const AXESLISTA = @import("../../windows/win32/graphics/gdi.zig").AXESLISTA;
const AXESLISTW = @import("../../windows/win32/graphics/gdi.zig").AXESLISTW;
...
const ETO_OPTIONS = @import("../../windows/win32/graphics/gdi.zig").ETO_OPTIONS;
...
const NEWTEXTMETRICA = @import("../../windows/win32/graphics/gdi.zig").NEWTEXTMETRICA;
const NEWTEXTMETRICW = @import("../../windows/win32/graphics/gdi.zig").NEWTEXTMETRICW;
