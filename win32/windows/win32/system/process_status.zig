...
pub extern "psapi" fn EnumProcessModulesEx(
    hProcess: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    lphModule: ?*HMODULE,
    cb: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetModuleBaseNameW(
    hProcess: ?HANDLE,
    hModule: HMODULE,
    lpBaseName: [*:0]u16,
    nSize: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetModuleFileNameExA(
    hProcess: ?HANDLE,
    hModule: HMODULE,
    lpFilename: [*:0]u8,
    nSize: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetModuleFileNameExW(
    hProcess: ?HANDLE,
    hModule: HMODULE,
    lpFilename: [*:0]u16,
    nSize: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn EmptyWorkingSet(
    hProcess: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn InitializeProcessForWsWatch(
    hProcess: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetWsChanges(
    hProcess: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "psapi" fn GetWsChangesEx(
    hProcess: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetMappedFileNameW(
    hProcess: ?HANDLE,
    lpv: ?*anyopaque,
    lpFilename: [*:0]u16,
    nSize: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetMappedFileNameA(
    hProcess: ?HANDLE,
    lpv: ?*anyopaque,
    lpFilename: [*:0]u8,
    nSize: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn EnumDeviceDrivers(
    // TODO: what to do with BytesParamIndex 1?
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetDeviceDriverBaseNameA(
    ImageBase: ?*anyopaque,
    lpFilename: [*:0]u8,
    nSize: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetDeviceDriverBaseNameW(
    ImageBase: ?*anyopaque,
    lpBaseName: [*:0]u16,
    nSize: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetDeviceDriverFileNameA(
    ImageBase: ?*anyopaque,
    lpFilename: [*:0]u8,
    nSize: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetDeviceDriverFileNameW(
    ImageBase: ?*anyopaque,
    lpFilename: [*:0]u16,
    nSize: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn QueryWorkingSet(
    hProcess: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    pv: ?*anyopaque,
    cb: u32,
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "psapi" fn QueryWorkingSetEx(
    hProcess: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    pv: ?*anyopaque,
    cb: u32,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetPerformanceInfo(
    pPerformanceInformation: ?*PERFORMANCE_INFORMATION,
    cb: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn EnumPageFilesW(
    pCallBackRoutine: ?PENUM_PAGE_FILE_CALLBACKW,
    pContext: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn EnumPageFilesA(
    pCallBackRoutine: ?PENUM_PAGE_FILE_CALLBACKA,
    pContext: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetProcessImageFileNameA(
    hProcess: ?HANDLE,
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "psapi" fn GetProcessImageFileNameW(
    hProcess: ?HANDLE,
...
//--------------------------------------------------------------------------------
// Section: Unicode Aliases (15)
//--------------------------------------------------------------------------------
const thismodule = @This();
pub usingnamespace switch (@import("../../../zig.zig").unicode_mode) {
    .ansi => struct {
        pub const PENUM_PAGE_FILE_CALLBACK = thismodule.PENUM_PAGE_FILE_CALLBACKA;
        pub const GetModuleBaseName = thismodule.GetModuleBaseNameA;
        pub const GetModuleFileNameEx = thismodule.GetModuleFileNameExA;
        pub const GetMappedFileName = thismodule.GetMappedFileNameA;
        pub const GetDeviceDriverBaseName = thismodule.GetDeviceDriverBaseNameA;
        pub const GetDeviceDriverFileName = thismodule.GetDeviceDriverFileNameA;
        pub const EnumPageFiles = thismodule.EnumPageFilesA;
        pub const GetProcessImageFileName = thismodule.GetProcessImageFileNameA;
    ...
    .wide => struct {
        ...
        pub const GetModuleBaseName = thismodule.GetModuleBaseNameW;
        pub const GetModuleFileNameEx = thismodule.GetModuleFileNameExW;
        pub const GetMappedFileName = thismodule.GetMappedFileNameW;
        pub const GetDeviceDriverBaseName = thismodule.GetDeviceDriverBaseNameW;
        pub const GetDeviceDriverFileName = thismodule.GetDeviceDriverFileNameW;
        pub const EnumPageFiles = thismodule.EnumPageFilesW;
        pub const GetProcessImageFileName = thismodule.GetProcessImageFileNameW;
    ...
    .unspecified => if (@import("builtin").is_test) struct {
        ...
        pub const GetModuleBaseName = *opaque{};
        pub const GetModuleFileNameEx = *opaque{};
        pub const GetMappedFileName = *opaque{};
        pub const GetDeviceDriverBaseName = *opaque{};
        pub const GetDeviceDriverFileName = *opaque{};
        pub const EnumPageFiles = *opaque{};
        pub const GetProcessImageFileName = *opaque{};
        ...
        pub const GetModuleBaseName = @compileError("'GetModuleBaseName' requires that UNICODE be set to true or false in the root module");
        pub const GetModuleFileNameEx = @compileError("'GetModuleFileNameEx' requires that UNICODE be set to true or false in the root module");
        pub const GetMappedFileName = @compileError("'GetMappedFileName' requires that UNICODE be set to true or false in the root module");
        pub const GetDeviceDriverBaseName = @compileError("'GetDeviceDriverBaseName' requires that UNICODE be set to true or false in the root module");
        pub const GetDeviceDriverFileName = @compileError("'GetDeviceDriverFileName' requires that UNICODE be set to true or false in the root module");
        pub const EnumPageFiles = @compileError("'EnumPageFiles' requires that UNICODE be set to true or false in the root module");
        pub const GetProcessImageFileName = @compileError("'GetProcessImageFileName' requires that UNICODE be set to true or false in the root module");
