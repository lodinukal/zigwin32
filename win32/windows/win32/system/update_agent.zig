...
pub const IStringCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStringCollection_get_ReadOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWebProxy = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebProxy_get_BypassProxyOnLocal(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWebProxy.VTable, @ptrCast(self.vtable)).get_BypassProxyOnLocal(@as(*const IWebProxy, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebProxy_put_BypassProxyOnLocal(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWebProxy.VTable, @ptrCast(self.vtable)).put_BypassProxyOnLocal(@as(*const IWebProxy, @ptrCast(self)), value);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebProxy_get_ReadOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebProxy_get_AutoDetect(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IWebProxy.VTable, @ptrCast(self.vtable)).get_AutoDetect(@as(*const IWebProxy, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWebProxy_put_AutoDetect(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISystemInformation = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISystemInformation_get_RebootRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAutomaticUpdatesSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings_get_ReadOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings_get_Required(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAutomaticUpdatesSettings2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings2_get_IncludeRecommendedUpdates(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings2_put_IncludeRecommendedUpdates(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings2_CheckPermission(self: *const T, userType: AutomaticUpdatesUserType, permissionType: AutomaticUpdatesPermissionType, userHasPermission: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAutomaticUpdatesSettings3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings3_get_NonAdministratorsElevated(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings3_put_NonAdministratorsElevated(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings3_get_FeaturedUpdatesEnabled(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdatesSettings3_put_FeaturedUpdatesEnabled(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IAutomaticUpdates = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAutomaticUpdates_get_ServiceEnabled(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInstallationBehavior = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInstallationBehavior_get_CanRequestUserInput(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInstallationBehavior_get_RequiresNetworkConnectivity(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateDownloadContent2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateDownloadContent2_get_IsDeltaCompressedContent(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdate = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_get_AutoSelectOnWebSites(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_get_CanRequireSource(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_get_DeltaCompressedContentAvailable(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_get_DeltaCompressedContentPreferred(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_get_EulaAccepted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate_CopyFromCache(self: *const T, path: ?BSTR, toExtractCabFiles: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdate2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUpdate.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate2_get_RebootRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IUpdate2.VTable, @ptrCast(self.vtable)).get_RebootRequired(@as(*const IUpdate2, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate2_get_IsPresent(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdate3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate3_get_BrowseOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdate4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdate4_get_PerUser(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWindowsDriverUpdate2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsDriverUpdate2_get_RebootRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsDriverUpdate2_get_IsPresent(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWindowsDriverUpdate3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsDriverUpdate3_get_BrowseOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IWindowsDriverUpdate4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsDriverUpdate4_get_PerUser(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateCollection_get_ReadOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const ISearchJob = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISearchJob_get_IsCompleted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateSearcher = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_get_CanAutomaticallyUpgradeService(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_put_CanAutomaticallyUpgradeService(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_get_IncludePotentiallySupersededUpdates(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_put_IncludePotentiallySupersededUpdates(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_get_Online(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IUpdateSearcher.VTable, @ptrCast(self.vtable)).get_Online(@as(*const IUpdateSearcher, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher_put_Online(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateSearcher2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher2_get_IgnoreDownloadPriority(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSearcher2_put_IgnoreDownloadPriority(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IDownloadJob = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDownloadJob_get_IsCompleted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateDownloader = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateDownloader_get_IsForced(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IUpdateDownloader.VTable, @ptrCast(self.vtable)).get_IsForced(@as(*const IUpdateDownloader, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateDownloader_put_IsForced(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateInstallationResult = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstallationResult_get_RebootRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInstallationResult = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInstallationResult_get_RebootRequired(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IInstallationJob = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInstallationJob_get_IsCompleted(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateInstaller = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_get_IsForced(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IUpdateInstaller.VTable, @ptrCast(self.vtable)).get_IsForced(@as(*const IUpdateInstaller, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_put_IsForced(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_get_IsBusy(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_get_AllowSourcePrompts(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_put_AllowSourcePrompts(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller_get_RebootRequiredBeforeInstallation(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateInstaller2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller2_get_ForceQuiet(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller2_put_ForceQuiet(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateInstaller3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller3_get_AttemptCloseAppsIfNecessary(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateInstaller3_put_AttemptCloseAppsIfNecessary(self: *const T, value: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateSession = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateSession_get_ReadOnly(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateService = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService_get_IsManaged(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IUpdateService.VTable, @ptrCast(self.vtable)).get_IsManaged(@as(*const IUpdateService, @ptrCast(self)), retval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService_get_IsRegisteredWithAU(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService_get_OffersWindowsUpdates(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService_get_IsScanPackageService(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService_get_CanRegisterWithAU(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateService2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateService2_get_IsDefaultAUService(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IUpdateServiceRegistration = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUpdateServiceRegistration_get_IsPendingRegistrationWithAU(self: *const T, retval: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
