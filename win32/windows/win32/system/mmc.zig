...
pub const ISnapinPropertiesCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISnapinPropertiesCallback_AddPropertyName(self: *const T, pszPropName: ?[*:0]align(1) const u16, dwFlags: u32) callconv(.Inline) HRESULT {
...
pub const Node = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Node_get_Name(self: *const T, Name: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const Node.VTable, @ptrCast(self.vtable)).get_Name(@as(*const Node, @ptrCast(self)), Name);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Node_get_Property(self: *const T, PropertyName: ?BSTR, PropertyValue: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const Node.VTable, @ptrCast(self.vtable)).get_Property(@as(*const Node, @ptrCast(self)), PropertyName, PropertyValue);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Node_get_Bookmark(self: *const T, Bookmark: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Node_get_Nodetype(self: *const T, Nodetype: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const Document = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_Name(self: *const T, Name: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_Location(self: *const T, Location: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const SnapIn = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_Name(self: *const T, Name: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const SnapIn.VTable, @ptrCast(self.vtable)).get_Name(@as(*const SnapIn, @ptrCast(self)), Name);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_Vendor(self: *const T, Vendor: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const SnapIn.VTable, @ptrCast(self.vtable)).get_Vendor(@as(*const SnapIn, @ptrCast(self)), Vendor);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_Version(self: *const T, Version: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_SnapinCLSID(self: *const T, SnapinCLSID: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const Extension = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extension_get_Name(self: *const T, Name: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const Extension.VTable, @ptrCast(self.vtable)).get_Name(@as(*const Extension, @ptrCast(self)), Name);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extension_get_Vendor(self: *const T, Vendor: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const Extension.VTable, @ptrCast(self.vtable)).get_Vendor(@as(*const Extension, @ptrCast(self)), Vendor);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extension_get_Version(self: *const T, Version: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extension_get_SnapinCLSID(self: *const T, SnapinCLSID: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const View = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_Is(self: *const T, _param_View: ?*View, TheSame: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_Memento(self: *const T, Memento: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_CellContents(self: *const T, _param_Node: ?*Node, _param_Column: i32, CellContents: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const MenuItem = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn MenuItem_get_DisplayName(self: *const T, DisplayName: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const MenuItem.VTable, @ptrCast(self.vtable)).get_DisplayName(@as(*const MenuItem, @ptrCast(self)), DisplayName);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn MenuItem_get_LanguageIndependentName(self: *const T, LanguageIndependentName: ?*?BSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn MenuItem_get_Path(self: *const T, Path: ?*?BSTR) callconv(.Inline) HRESULT {
            return @as(*const MenuItem.VTable, @ptrCast(self.vtable)).get_Path(@as(*const MenuItem, @ptrCast(self)), Path);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn MenuItem_get_LanguageIndependentPath(self: *const T, LanguageIndependentPath: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const Property = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Property_get_Name(self: *const T, Name: ?*?BSTR) callconv(.Inline) HRESULT {
...
pub const IConsole = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole_MessageBox(self: *const T, lpszText: ?[*:0]align(1) const u16, lpszTitle: ?[*:0]align(1) const u16, fuStyle: u32, piRetval: ?*i32) callconv(.Inline) HRESULT {
...
pub const IHeaderCtrl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IHeaderCtrl_InsertColumn(self: *const T, nCol: i32, title: ?[*:0]align(1) const u16, nFormat: i32, nWidth: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IHeaderCtrl_SetColumnText(self: *const T, nCol: i32, title: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const IImageList = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IImageList_ImageListSetStrip(self: *const T, pBMapSm: ?*isize, pBMapLg: ?*isize, nStartLoc: i32, cMask: COLORREF) callconv(.Inline) HRESULT {
...
pub const IPropertySheetProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySheetProvider_CreatePropertySheet(self: *const T, title: ?[*:0]align(1) const u16, type_: u8, cookie: isize, pIDataObjectm: ?*IDataObject, dwOptions: u32) callconv(.Inline) HRESULT {
...
pub const IToolbar = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IToolbar_AddBitmap(self: *const T, nImages: i32, hbmp: ?HBITMAP, cxSize: i32, cySize: i32, crMask: COLORREF) callconv(.Inline) HRESULT {
...
pub const ISnapinAbout = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISnapinAbout_GetStaticFolderImage(self: *const T, hSmallImage: ?*?HBITMAP, hSmallImageOpen: ?*?HBITMAP, hLargeImage: ?*?HBITMAP, cMask: ?*COLORREF) callconv(.Inline) HRESULT {
...
pub const IStringTable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStringTable_AddString(self: *const T, pszAdd: ?[*:0]align(1) const u16, pStringID: ?*u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IStringTable_FindString(self: *const T, pszFind: ?[*:0]align(1) const u16, pStringID: ?*u32) callconv(.Inline) HRESULT {
...
pub const IMessageView = extern struct {
    pub const VTable = extern struct {
        ...
        SetTitleText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pszTitleText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMessageView,
                pszTitleText: ?[*:0]align(1) const u16,
        ...
        SetBodyText: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IMessageView,
                pszBodyText: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IMessageView,
                pszBodyText: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMessageView_SetTitleText(self: *const T, pszTitleText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
            return @as(*const IMessageView.VTable, @ptrCast(self.vtable)).SetTitleText(@as(*const IMessageView, @ptrCast(self)), pszTitleText);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IMessageView_SetBodyText(self: *const T, pszBodyText: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
...
pub const MMC_EXT_VIEW_DATA = extern struct {
    ...
    pszViewTitle: ?[*:0]align(1) const u16,
    pszTooltipText: ?[*:0]align(1) const u16,
...
pub const INodeProperties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INodeProperties_GetProperty(self: *const T, pDataObject: ?*IDataObject, szPropertyName: ?BSTR, pbstrProperty: ?*?BSTR) callconv(.Inline) HRESULT {
