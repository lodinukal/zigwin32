...
pub const CLSID_INDEX_SERVER_DSO = Guid.initString("f9ae8980-7e52-11d0-8964-00c04fd611d7");
pub const PSGUID_FILENAME = Guid.initString("41cf5ae0-f75a-4806-bd87-59c7d9248eb9");
pub const PID_FILENAME = @as(u32, 100);
pub const DBPROPSET_FSCIFRMWRK_EXT = Guid.initString("a9bd1526-6a80-11d0-8c9d-0020af1d740e");
...
pub const DBPROPSET_SESS_QUERYEXT = Guid.initString("63623309-2d8b-4d17-b152-6e2956c26a70");
pub const DBPROP_DEFAULT_EQUALS_BEHAVIOR = @as(u32, 2);
pub const DBPROPSET_QUERYEXT = Guid.initString("a7ac77ed-f8d7-11ce-a798-0020f8008025");
...
pub const DBPROPSET_CIFRMWRKCORE_EXT = Guid.initString("afafaca5-b5d1-11d0-8c62-00c04fc2db8d");
pub const DBPROP_MACHINE = @as(u32, 2);
pub const DBPROP_CLIENT_CLSID = @as(u32, 3);
pub const DBPROPSET_MSIDXS_ROWSETEXT = Guid.initString("aa6ee6b0-e828-11d0-b23e-00aa0047fc01");
...
pub const IPhraseSink = extern struct {
    pub const VTable = extern struct {
        ...
        PutSmallPhrase: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pwcNoun: ?[*:0]align(1) const u16,
                cwcNoun: u32,
                pwcModifier: ?[*:0]align(1) const u16,
                cwcModifier: u32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhraseSink_PutSmallPhrase(self: *const T, pwcNoun: ?[*:0]align(1) const u16, cwcNoun: u32, pwcModifier: ?[*:0]align(1) const u16, cwcModifier: u32, ulAttachmentType: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPhraseSink_PutPhrase(self: *const T, pwcPhrase: ?[*:0]align(1) const u16, cwcPhrase: u32) callconv(.Inline) HRESULT {
