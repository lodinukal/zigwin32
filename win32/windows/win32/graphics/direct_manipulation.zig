...
pub const DIRECTMANIPULATION_HITTEST_TYPE = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ASYNCHRONOUS: u1 = 0,
        SYNCHRONOUS: u1 = 0,
        AUTO_SYNCHRONOUS: u1 = 0,
    }) DIRECTMANIPULATION_HITTEST_TYPE {
        return @as(DIRECTMANIPULATION_HITTEST_TYPE, @enumFromInt(
              (if (o.ASYNCHRONOUS == 1) @intFromEnum(DIRECTMANIPULATION_HITTEST_TYPE.ASYNCHRONOUS) else 0)
            | (if (o.SYNCHRONOUS == 1) @intFromEnum(DIRECTMANIPULATION_HITTEST_TYPE.SYNCHRONOUS) else 0)
            | (if (o.AUTO_SYNCHRONOUS == 1) @intFromEnum(DIRECTMANIPULATION_HITTEST_TYPE.AUTO_SYNCHRONOUS) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_CONFIGURATION = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        TRANSLATION_Y: u1 = 0,
        SCALING: u1 = 0,
        TRANSLATION_INERTIA: u1 = 0,
        SCALING_INERTIA: u1 = 0,
        RAILS_X: u1 = 0,
        RAILS_Y: u1 = 0,
    }) DIRECTMANIPULATION_CONFIGURATION {
        return @as(DIRECTMANIPULATION_CONFIGURATION, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.NONE) else 0)
            | (if (o.INTERACTION == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.INTERACTION) else 0)
            | (if (o.TRANSLATION_X == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.TRANSLATION_X) else 0)
            | (if (o.TRANSLATION_Y == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.TRANSLATION_Y) else 0)
            | (if (o.SCALING == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.SCALING) else 0)
            | (if (o.TRANSLATION_INERTIA == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.TRANSLATION_INERTIA) else 0)
            | (if (o.SCALING_INERTIA == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.SCALING_INERTIA) else 0)
            | (if (o.RAILS_X == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.RAILS_X) else 0)
            | (if (o.RAILS_Y == 1) @intFromEnum(DIRECTMANIPULATION_CONFIGURATION.RAILS_Y) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_GESTURE_CONFIGURATION = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        NONE: u1 = 0,
        CROSS_SLIDE_VERTICAL: u1 = 0,
        CROSS_SLIDE_HORIZONTAL: u1 = 0,
        PINCH_ZOOM: u1 = 0,
    }) DIRECTMANIPULATION_GESTURE_CONFIGURATION {
        return @as(DIRECTMANIPULATION_GESTURE_CONFIGURATION, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DIRECTMANIPULATION_GESTURE_CONFIGURATION.NONE) else 0)
            | (if (o.CROSS_SLIDE_VERTICAL == 1) @intFromEnum(DIRECTMANIPULATION_GESTURE_CONFIGURATION.CROSS_SLIDE_VERTICAL) else 0)
            | (if (o.CROSS_SLIDE_HORIZONTAL == 1) @intFromEnum(DIRECTMANIPULATION_GESTURE_CONFIGURATION.CROSS_SLIDE_HORIZONTAL) else 0)
            | (if (o.PINCH_ZOOM == 1) @intFromEnum(DIRECTMANIPULATION_GESTURE_CONFIGURATION.PINCH_ZOOM) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_MOTION_TYPES = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DIRECTMANIPULATION_MOTION_TYPES, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.NONE) else 0)
            | (if (o.TRANSLATEX == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.TRANSLATEX) else 0)
            | (if (o.TRANSLATEY == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.TRANSLATEY) else 0)
            | (if (o.ZOOM == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.ZOOM) else 0)
            | (if (o.CENTERX == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.CENTERX) else 0)
            | (if (o.CENTERY == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.CENTERY) else 0)
            | (if (o.ALL == 1) @intFromEnum(DIRECTMANIPULATION_MOTION_TYPES.ALL) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        MANUALUPDATE: u1 = 0,
        INPUT: u1 = 0,
        EXPLICITHITTEST: u1 = 0,
        DISABLEPIXELSNAPPING: u1 = 0,
    }) DIRECTMANIPULATION_VIEWPORT_OPTIONS {
        return @as(DIRECTMANIPULATION_VIEWPORT_OPTIONS, @enumFromInt(
              (if (o.DEFAULT == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.DEFAULT) else 0)
            | (if (o.AUTODISABLE == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.AUTODISABLE) else 0)
            | (if (o.MANUALUPDATE == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.MANUALUPDATE) else 0)
            | (if (o.INPUT == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.INPUT) else 0)
            | (if (o.EXPLICITHITTEST == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.EXPLICITHITTEST) else 0)
            | (if (o.DISABLEPIXELSNAPPING == 1) @intFromEnum(DIRECTMANIPULATION_VIEWPORT_OPTIONS.DISABLEPIXELSNAPPING) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_SNAPPOINT_COORDINATE = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DIRECTMANIPULATION_SNAPPOINT_COORDINATE, @enumFromInt(
              (if (o.BOUNDARY == 1) @intFromEnum(DIRECTMANIPULATION_SNAPPOINT_COORDINATE.BOUNDARY) else 0)
            | (if (o.ORIGIN == 1) @intFromEnum(DIRECTMANIPULATION_SNAPPOINT_COORDINATE.ORIGIN) else 0)
            | (if (o.MIRRORED == 1) @intFromEnum(DIRECTMANIPULATION_SNAPPOINT_COORDINATE.MIRRORED) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_HORIZONTALALIGNMENT = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DIRECTMANIPULATION_HORIZONTALALIGNMENT, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DIRECTMANIPULATION_HORIZONTALALIGNMENT.NONE) else 0)
            | (if (o.LEFT == 1) @intFromEnum(DIRECTMANIPULATION_HORIZONTALALIGNMENT.LEFT) else 0)
            | (if (o.CENTER == 1) @intFromEnum(DIRECTMANIPULATION_HORIZONTALALIGNMENT.CENTER) else 0)
            | (if (o.RIGHT == 1) @intFromEnum(DIRECTMANIPULATION_HORIZONTALALIGNMENT.RIGHT) else 0)
            | (if (o.UNLOCKCENTER == 1) @intFromEnum(DIRECTMANIPULATION_HORIZONTALALIGNMENT.UNLOCKCENTER) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_VERTICALALIGNMENT = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DIRECTMANIPULATION_VERTICALALIGNMENT, @enumFromInt(
              (if (o.NONE == 1) @intFromEnum(DIRECTMANIPULATION_VERTICALALIGNMENT.NONE) else 0)
            | (if (o.TOP == 1) @intFromEnum(DIRECTMANIPULATION_VERTICALALIGNMENT.TOP) else 0)
            | (if (o.CENTER == 1) @intFromEnum(DIRECTMANIPULATION_VERTICALALIGNMENT.CENTER) else 0)
            | (if (o.BOTTOM == 1) @intFromEnum(DIRECTMANIPULATION_VERTICALALIGNMENT.BOTTOM) else 0)
            | (if (o.UNLOCKCENTER == 1) @intFromEnum(DIRECTMANIPULATION_VERTICALALIGNMENT.UNLOCKCENTER) else 0)
        ));
    }
};
...
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = enum(i32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION, @enumFromInt(
              (if (o.VERTICAL == 1) @intFromEnum(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION.VERTICAL) else 0)
            | (if (o.HORIZONTAL == 1) @intFromEnum(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION.HORIZONTAL) else 0)
            | (if (o.SELECT_ONLY == 1) @intFromEnum(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION.SELECT_ONLY) else 0)
            | (if (o.SELECT_DRAG == 1) @intFromEnum(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION.SELECT_DRAG) else 0)
            | (if (o.HOLD_DRAG == 1) @intFromEnum(DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION.HOLD_DRAG) else 0)
        ));
    }
};
