...
pub const IXMLGraphBuilder = extern struct {
    pub const VTable = extern struct {
        ...
        BuildFromXMLFile: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                wszBaseURL: ?[*:0]align(1) const u16,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IXMLGraphBuilder,
                pGraph: ?*IGraphBuilder,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IXMLGraphBuilder_BuildFromXMLFile(self: *const T, pGraph: ?*IGraphBuilder, wszFileName: ?[*:0]align(1) const u16, wszBaseURL: ?[*:0]align(1) const u16) callconv(.Inline) HRESULT {
