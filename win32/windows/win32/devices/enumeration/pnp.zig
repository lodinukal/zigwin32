...
pub const SW_DEVICE_CREATE_INFO = extern struct {
    ...
    pszzHardwareIds: ?[*]align(1) const u16,
    pszzCompatibleIds: ?[*]align(1) const u16,
    pContainerId: ?*const Guid,
    CapabilityFlags: u32,
    pszDeviceDescription: ?[*:0]align(1) const u16,
    pszDeviceLocation: ?[*:0]align(1) const u16,
...
pub const SW_DEVICE_CREATE_CALLBACK = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        ...
        pContext: ?*anyopaque,
        pszDeviceInstanceId: ?[*:0]align(1) const u16,
...
pub const IUPnPServiceCallback = extern struct {
    pub const VTable = extern struct {
        ...
        StateVariableChanged: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                ...
                pus: ?*IUPnPService,
                pcwszStateVarName: ?[*:0]align(1) const u16,
                vaValue: VARIANT,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IUPnPServiceCallback,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUPnPServiceCallback_StateVariableChanged(self: *const T, pus: ?*IUPnPService, pcwszStateVarName: ?[*:0]align(1) const u16, vaValue: VARIANT) callconv(.Inline) HRESULT {
...
pub const IUPnPDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUPnPDevice_get_IsRootDevice(self: *const T, pvarb: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IUPnPDevice_get_HasChildren(self: *const T, pvarb: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "cfgmgr32" fn SwDeviceCreate(
    pszEnumeratorName: ?[*:0]align(1) const u16,
    pszParentDeviceInstance: ?[*:0]align(1) const u16,
...
pub extern "cfgmgr32" fn SwDeviceInterfaceRegister(
    ...
    pszReferenceString: ?[*:0]align(1) const u16,
    cPropertyCount: u32,
    pProperties: ?[*]const DEVPROPERTY,
    fEnabled: BOOL,
...
pub extern "cfgmgr32" fn SwDeviceInterfaceSetState(
    hSwDevice: ?HSWDEVICE,
    pszDeviceInterfaceId: ?[*:0]align(1) const u16,
    fEnabled: BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
const DEVPROPERTY = @import("../../../../windows/win32/devices/properties.zig").DEVPROPERTY;
