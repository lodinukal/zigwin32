...
pub const PF_NPGetConnection3 = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpLocalName: ?[*:0]align(1) const u16,
        dwLevel: u32,
        // TODO: what to do with BytesParamIndex 3?
        lpBuffer: ?*anyopaque,
        lpBufferSize: ?*u32,
...
pub const PF_NPGetUniversalName = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpLocalPath: ?[*:0]align(1) const u16,
        dwInfoLevel: u32,
        // TODO: what to do with BytesParamIndex 3?
        lpBuffer: ?*anyopaque,
        lpnBufferSize: ?*u32,
...
pub const PF_NPGetConnectionPerformance = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpRemoteName: ?[*:0]align(1) const u16,
...
pub const PF_NPLogonNotify = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        lpLogonId: ?*LUID,
        lpAuthentInfoType: ?[*:0]align(1) const u16,
        lpAuthentInfo: ?*anyopaque,
        lpPreviousAuthentInfoType: ?[*:0]align(1) const u16,
...
pub extern "mpr" fn WNetAddConnectionA(
    lpRemoteName: ?[*:0]align(1) const u8,
    lpPassword: ?[*:0]align(1) const u8,
    lpLocalName: ?[*:0]align(1) const u8,
...
pub extern "mpr" fn WNetGetUniversalNameA(
    lpLocalPath: ?[*:0]align(1) const u8,
