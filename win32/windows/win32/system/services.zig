...
pub const ENUM_SERVICE_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(ENUM_SERVICE_TYPE, @enumFromInt(
            ...
            | (if (o.FILE_SYSTEM_DRIVER == 1) @intFromEnum(ENUM_SERVICE_TYPE.FILE_SYSTEM_DRIVER) else 0)
            | (if (o.RECOGNIZER_DRIVER == 1) @intFromEnum(ENUM_SERVICE_TYPE.RECOGNIZER_DRIVER) else 0)
            | (if (o.WIN32_OWN_PROCESS == 1) @intFromEnum(ENUM_SERVICE_TYPE.WIN32_OWN_PROCESS) else 0)
...
pub extern "advapi32" fn ChangeServiceConfigA(
    ...
    dwStartType: SERVICE_START_TYPE,
    dwErrorControl: SERVICE_ERROR,
    lpBinaryPathName: ?[*:0]align(1) const u8,
    lpLoadOrderGroup: ?[*:0]align(1) const u8,
    lpdwTagId: ?*u32,
    lpDependencies: ?[*:0]align(1) const u8,
    lpServiceStartName: ?[*:0]align(1) const u8,
    lpPassword: ?[*:0]align(1) const u8,
    lpDisplayName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn ChangeServiceConfigW(
    ...
    dwStartType: SERVICE_START_TYPE,
    dwErrorControl: SERVICE_ERROR,
    lpBinaryPathName: ?[*:0]align(1) const u16,
    lpLoadOrderGroup: ?[*:0]align(1) const u16,
    lpdwTagId: ?*u32,
    lpDependencies: ?[*:0]align(1) const u16,
    lpServiceStartName: ?[*:0]align(1) const u16,
...
pub extern "advapi32" fn CreateServiceA(
    ...
    lpServiceName: ?[*:0]align(1) const u8,
    lpDisplayName: ?[*:0]align(1) const u8,
    dwDesiredAccess: u32,
    dwServiceType: ENUM_SERVICE_TYPE,
    dwStartType: SERVICE_START_TYPE,
...
pub extern "advapi32" fn CreateServiceW(
    hSCManager: SC_HANDLE,
    lpServiceName: ?[*:0]align(1) const u16,
    lpDisplayName: ?[*:0]align(1) const u16,
    dwDesiredAccess: u32,
    dwServiceType: ENUM_SERVICE_TYPE,
    dwStartType: SERVICE_START_TYPE,
...
pub extern "advapi32" fn EnumServicesStatusExA(
    ...
    lpServicesReturned: ?*u32,
    lpResumeHandle: ?*u32,
    pszGroupName: ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn EnumServicesStatusExW(
    ...
    lpServicesReturned: ?*u32,
    lpResumeHandle: ?*u32,
    pszGroupName: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn OpenSCManagerA(
    ...
    lpDatabaseName: ?[*:0]align(1) const u8,
    dwDesiredAccess: u32,
) callconv(@import("std").os.windows.WINAPI) SC_HANDLE;
...
pub extern "advapi32" fn OpenSCManagerW(
    ...
    lpDatabaseName: ?[*:0]align(1) const u16,
    dwDesiredAccess: u32,
) callconv(@import("std").os.windows.WINAPI) SC_HANDLE;
...
pub extern "advapi32" fn StartServiceA(
    ...
    lpServiceArgVectors: ?[*]const ?[*:0]align(1) const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn StartServiceW(
    hService: SC_HANDLE,
    dwNumServiceArgs: u32,
    lpServiceArgVectors: ?[*]const ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "sechost" fn SubscribeServiceChangeNotifications(
    hService: SC_HANDLE,
...
pub extern "sechost" fn UnsubscribeServiceChangeNotifications(
    pSubscription: PSC_NOTIFICATION_REGISTRATION,
) callconv(@import("std").os.windows.WINAPI) void;
