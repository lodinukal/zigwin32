...
pub extern "mdmregistration" fn RegisterDeviceWithManagementUsingAADDeviceCredentials2(
    MDMApplicationID: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mdmregistration" fn RegisterDeviceDualEnrollMmpcUsingAADDeviceCredentials(
    cchEnrollmentId: u32,
    pszEnrollmentId: [*:0]u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "mdmregistration" fn RegisterDeviceWithManagement(
    pszUPN: ?[*:0]align(1) const u16,
    ppszMDMServiceUri: ?[*:0]align(1) const u16,
    ppzsAccessToken: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.1'
pub extern "mdmregistration" fn UnregisterDeviceWithManagement(
    enrollmentID: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mdmregistration" fn SetDeviceManagementConfigInfo(
    providerID: ?[*:0]align(1) const u16,
    configString: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mdmregistration" fn DiscoverManagementServiceEx(
    pszUPN: ?[*:0]align(1) const u16,
    pszDiscoveryServiceCandidate: ?[*:0]align(1) const u16,
    ppMgmtInfo: ?*?*MANAGEMENT_SERVICE_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mdmlocalmanagement" fn ApplyLocalManagementSyncML(
    syncMLRequest: ?[*:0]align(1) const u16,
    syncMLResult: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
