...
pub const INetDiagHelper = extern struct {
    pub const VTable = extern struct {
        ...
        LowHealth: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const INetDiagHelper,
                pwszInstanceDescription: ?[*:0]align(1) const u16,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetDiagHelper_LowHealth(self: *const T, pwszInstanceDescription: ?[*:0]align(1) const u16, ppwszDescription: ?*?PWSTR, pDeferredTime: ?*i32, pStatus: ?*DIAGNOSIS_STATUS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn INetDiagHelper_HighUtilization(self: *const T, pwszInstanceDescription: ?[*:0]align(1) const u16, ppwszDescription: ?*?PWSTR, pDeferredTime: ?*i32, pStatus: ?*DIAGNOSIS_STATUS) callconv(.Inline) HRESULT {
...
pub extern "ndfapi" fn NdfCreateIncident(
    helperClassName: ?[*:0]align(1) const u16,
    celt: u32,
...
pub extern "ndfapi" fn NdfCreateWinSockIncident(
    sock: ?SOCKET,
    host: ?[*:0]align(1) const u16,
    port: u16,
    appId: ?[*:0]align(1) const u16,
    userId: ?*SID,
    handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "ndfapi" fn NdfCreatePnrpIncident(
    cloudname: ?[*:0]align(1) const u16,
    peername: ?[*:0]align(1) const u16,
...
pub extern "ndfapi" fn NdfCreateGroupingIncident(
    ...
    Invitation: ?[*:0]align(1) const u16,
...
const SOCKET = @import("../../../windows/win32/networking/win_sock.zig").SOCKET;
