...
pub extern "websocket" fn WebSocketBeginClientHandshake(
    ...
    pszSubprotocols: ?[*]const ?[*:0]align(1) const u8,
    ulSubprotocolCount: u32,
    pszExtensions: ?[*]const ?[*:0]align(1) const u8,
...
pub extern "websocket" fn WebSocketBeginServerHandshake(
    hWebSocket: WEB_SOCKET_HANDLE,
    pszSubprotocolSelected: ?[*:0]align(1) const u8,
    pszExtensionSelected: ?[*]const ?[*:0]align(1) const u8,
