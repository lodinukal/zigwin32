...
pub const EVT_VARIANT = extern struct {
    Anonymous: extern union {
        ...
        GuidVal: ?*Guid,
        StringVal: ?[*:0]align(1) const u16,
        AnsiStringVal: ?[*:0]align(1) const u8,
        BinaryVal: ?*u8,
        SidVal: ?PSID,
        SizeTVal: usize,
        BooleanArr: ?*BOOL,
        ...
        XmlVal: ?[*:0]align(1) const u16,
        XmlValArr: ?*const ?PWSTR,
    },
    Count: u32,
    Type: u32,
};
...
pub extern "wevtapi" fn EvtOpenSession(
    ...
    Timeout: u32,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) EVT_HANDLE;
...
pub extern "wevtapi" fn EvtSubscribe(
    Session: EVT_HANDLE,
    SignalEvent: ?HANDLE,
    ChannelPath: ?[*:0]align(1) const u16,
    Query: ?[*:0]align(1) const u16,
    Bookmark: EVT_HANDLE,
    Context: ?*anyopaque,
...
pub extern "wevtapi" fn EvtCreateRenderContext(
    ValuePathsCount: u32,
    ValuePaths: ?[*]const ?[*:0]align(1) const u16,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) EVT_HANDLE;
...
pub extern "wevtapi" fn EvtClearLog(
    Session: EVT_HANDLE,
    ChannelPath: ?[*:0]align(1) const u16,
    TargetFilePath: ?[*:0]align(1) const u16,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wevtapi" fn EvtArchiveExportedLog(
    Session: EVT_HANDLE,
    LogFilePath: ?[*:0]align(1) const u16,
    Locale: u32,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wevtapi" fn EvtOpenPublisherMetadata(
    Session: EVT_HANDLE,
    PublisherId: ?[*:0]align(1) const u16,
    LogFilePath: ?[*:0]align(1) const u16,
    Locale: u32,
    Flags: u32,
) callconv(@import("std").os.windows.WINAPI) EVT_HANDLE;
...
pub extern "wevtapi" fn EvtCreateBookmark(
    BookmarkXml: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) EVT_HANDLE;
...
pub extern "advapi32" fn ReportEventA(
    ...
    wNumStrings: u16,
    dwDataSize: u32,
    lpStrings: ?[*]const ?[*:0]align(1) const u8,
...
pub extern "advapi32" fn ReportEventW(
    ...
    wNumStrings: u16,
    dwDataSize: u32,
    lpStrings: ?[*]const ?[*:0]align(1) const u16,
    // TODO: what to do with BytesParamIndex 6?
    lpRawData: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
