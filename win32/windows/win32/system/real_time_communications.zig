...
pub const IRTCClient = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_SetPreferredMediaTypes(self: *const T, lMediaTypes: i32, fPersistent: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_get_NetworkAddresses(self: *const T, fTCP: VARIANT_BOOL, fExternal: VARIANT_BOOL, pvAddresses: ?*VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_put_AudioMuted(self: *const T, enDevice: RTC_AUDIO_DEVICE, fMuted: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IRTCClient.VTable, @ptrCast(self.vtable)).put_AudioMuted(@as(*const IRTCClient, @ptrCast(self)), enDevice, fMuted);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_get_AudioMuted(self: *const T, enDevice: RTC_AUDIO_DEVICE, pfMuted: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_put_PreferredAEC(self: *const T, bEnable: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IRTCClient.VTable, @ptrCast(self.vtable)).put_PreferredAEC(@as(*const IRTCClient, @ptrCast(self)), bEnable);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_get_PreferredAEC(self: *const T, pbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_get_IsT120AppletRunning(self: *const T, enApplet: RTC_T120_APPLET, pfRunning: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_PlayRing(self: *const T, enType: RTC_RING_TYPE, bPlay: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient_get_IsTuned(self: *const T, pfTuned: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCClient2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClient2_InvokeTuningWizardEx(self: *const T, hwndParent: isize, fAllowAudio: VARIANT_BOOL, fAllowVideo: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCClientPresence = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence_EnablePresence(self: *const T, fUseStorage: VARIANT_BOOL, varStorage: VARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence_Import(self: *const T, varStorage: VARIANT, fReplaceAll: VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence_AddBuddy(self: *const T, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fPersistent: VARIANT_BOOL, pProfile: ?*IRTCProfile, lFlags: i32, ppBuddy: ?*?*IRTCBuddy) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence_AddWatcher(self: *const T, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fBlocked: VARIANT_BOOL, fPersistent: VARIANT_BOOL, ppWatcher: ?*?*IRTCWatcher) callconv(.Inline) HRESULT {
...
pub const IRTCClientPresence2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence2_AddWatcherEx(self: *const T, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, enState: RTC_WATCHER_STATE, fPersistent: VARIANT_BOOL, enScope: RTC_ACE_SCOPE, pProfile: ?*IRTCProfile, lFlags: i32, ppWatcher: ?*?*IRTCWatcher2) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCClientPresence2_AddBuddyEx(self: *const T, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fPersistent: VARIANT_BOOL, enSubscriptionType: RTC_BUDDY_SUBSCRIPTION_TYPE, pProfile: ?*IRTCProfile, lFlags: i32, ppBuddy: ?*?*IRTCBuddy2) callconv(.Inline) HRESULT {
...
pub const IRTCProfile = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCProfile_get_ClientBanner(self: *const T, pfBanner: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCSession = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCSession_get_CanAddParticipants(self: *const T, pfCanAdd: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCSession2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCSession2_IsSecurityEnabled(self: *const T, enSecurityType: RTC_SECURITY_TYPE, pfSecurityEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCSessionCallControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCSessionCallControl_get_IsReferred(self: *const T, pfIsReferred: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCParticipant = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCParticipant_get_Removable(self: *const T, pfRemovable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCSessionStateChangeEvent2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCSessionStateChangeEvent2_get_IsForked(self: *const T, pfIsForked: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCPresenceContact = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCPresenceContact_get_Persistent(self: *const T, pfPersistent: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCPresenceContact_put_Persistent(self: *const T, fPersistent: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCUserSearchResultsEvent = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCUserSearchResultsEvent_get_MoreAvailable(self: *const T, pfMoreAvailable: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IRTCSessionDescriptionManager = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRTCSessionDescriptionManager_EvaluateSessionDescription(self: *const T, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR, pfApplicationSession: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
const IVideoWindow = @import("../../../windows/win32/media/direct_show.zig").IVideoWindow;
const TRANSPORT_SETTING_ID = @import("../../../windows/win32/networking/win_sock.zig").TRANSPORT_SETTING_ID;
