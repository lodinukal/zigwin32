...
pub const IDirectDraw = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectDraw_GetVerticalBlankStatus(self: *const T, param0: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDirectDraw2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectDraw2_GetVerticalBlankStatus(self: *const T, param0: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDirectDraw4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectDraw4_GetVerticalBlankStatus(self: *const T, param0: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDirectDraw7 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectDraw7_GetVerticalBlankStatus(self: *const T, param0: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IDirectDrawVideoPort = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDirectDrawVideoPort_GetFieldPolarity(self: *const T, param0: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const PDD_VPORTCB_GETAUTOFLIPSURF = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        param0: PDD_GETVPORTAUTOFLIPSURFACEDATA,
    ) callconv(@import("std").os.windows.WINAPI) u32,
    else => *const fn(
        param0: PDD_GETVPORTAUTOFLIPSURFACEDATA,
    ) callconv(@import("std").os.windows.WINAPI) u32,
