...
pub extern "chakra" fn JsParseScript(
    script: ?[*:0]align(1) const u16,
    sourceContext: usize,
    sourceUrl: ?[*:0]align(1) const u16,
    result: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) JsErrorCode;
...
const IActiveScriptProfilerCallback = @import("../../../windows/win32/system/diagnostics/debug/active_script.zig").IActiveScriptProfilerCallback;
const IActiveScriptProfilerHeapEnum = @import("../../../windows/win32/system/diagnostics/debug/active_script.zig").IActiveScriptProfilerHeapEnum;
const PROFILER_EVENT_MASK = @import("../../../windows/win32/system/diagnostics/debug/active_script.zig").PROFILER_EVENT_MASK;
...
const IDebugApplication32 = switch(@import("../../../zig.zig").arch) {
    .X86 => @import("../../../windows/win32/system/diagnostics/debug/active_script.zig").IDebugApplication32,
    else => usize, // NOTE: this should be a @compileError but can't because of https://github.com/ziglang/zig/issues/9682
};
const IDebugApplication64 = switch(@import("../../../zig.zig").arch) {
    .X64, .Arm64 => @import("../../../windows/win32/system/diagnostics/debug/active_script.zig").IDebugApplication64,
    else => usize, // NOTE: this should be a @compileError but can't because of https://github.com/ziglang/zig/issues/9682
};
