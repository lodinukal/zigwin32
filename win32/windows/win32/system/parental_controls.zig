...
pub const IWPCProviderConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWPCProviderConfig_RequestOverride(self: *const T, hWnd: ?HWND, bstrPath: ?BSTR, dwFlags: u32) callconv(.Inline) HRESULT {
...
pub const IWPCWebSettings = extern struct {
    pub const VTable = extern struct {
        ...
        RequestURLOverride: switch (@import("builtin").zig_backend) {
            .stage1 => fn(
                self: *const IWPCWebSettings,
                hWnd: ?HWND,
                pcszURL: ?[*:0]align(1) const u16,
                cURLs: u32,
                ppcszSubURLs: ?[*]const ?[*:0]align(1) const u16,
                pfChanged: ?*BOOL,
            ) callconv(@import("std").os.windows.WINAPI) HRESULT,
            else => *const fn(
                self: *const IWPCWebSettings,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWPCWebSettings_RequestURLOverride(self: *const T, hWnd: ?HWND, pcszURL: ?[*:0]align(1) const u16, cURLs: u32, ppcszSubURLs: ?[*]const ?[*:0]align(1) const u16, pfChanged: ?*BOOL) callconv(.Inline) HRESULT {
...
pub const IWindowsParentalControlsCore = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsParentalControlsCore_GetUserSettings(self: *const T, pcszSID: ?[*:0]align(1) const u16, ppSettings: ?*?*IWPCSettings) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsParentalControlsCore_GetWebSettings(self: *const T, pcszSID: ?[*:0]align(1) const u16, ppSettings: ?*?*IWPCWebSettings) callconv(.Inline) HRESULT {
...
pub const IWindowsParentalControls = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWindowsParentalControls_GetGamesSettings(self: *const T, pcszSID: ?[*:0]align(1) const u16, ppSettings: ?*?*IWPCGamesSettings) callconv(.Inline) HRESULT {
