...
pub const REGISTRY_EXTENSION_GUID = Guid.initString("35378eac-683f-11d2-a89a-00c04fbbcfa2");
pub const GROUP_POLICY_TRIGGER_EVENT_PROVIDER_GUID = Guid.initString("bd2f4252-5e1e-49fc-9a30-f3978ad89ee2");
pub const MACHINE_POLICY_PRESENT_TRIGGER_GUID = Guid.initString("659fcae6-5bdb-4da9-b1ff-ca2a178d46e0");
pub const USER_POLICY_PRESENT_TRIGGER_GUID = Guid.initString("54fb46c8-f089-464c-b1fd-59d1b62c3b50");
...
pub const ADMXCOMMENTS_EXTENSION_GUID = Guid.initString("6c5a2a86-9eb3-42b9-aa83-a7371ba011b9");
...
// Section: Types (111)
//--------------------------------------------------------------------------------
pub const GPO_OPEN_FLAGS = enum(u32) {
    LOAD_REGISTRY = 1,
    READ_ONLY = 2,
};
pub const GPO_OPEN_LOAD_REGISTRY = GPO_OPEN_FLAGS.LOAD_REGISTRY;
pub const GPO_OPEN_READ_ONLY = GPO_OPEN_FLAGS.READ_ONLY;

pub const GPO_OPTIONS = enum(u32) {
    USER = 1,
    MACHINE = 2,
    _,
    pub fn initFlags(o: struct {
        ...
        return @as(GPO_OPTIONS, @enumFromInt(
              (if (o.USER == 1) @intFromEnum(GPO_OPTIONS.USER) else 0)
            | (if (o.MACHINE == 1) @intFromEnum(GPO_OPTIONS.MACHINE) else 0)
        ));
    }
};
pub const GPO_OPTION_DISABLE_USER = GPO_OPTIONS.USER;
pub const GPO_OPTION_DISABLE_MACHINE = GPO_OPTIONS.MACHINE;

pub const GPO_SECTION = enum(u32) {
    ROOT = 0,
    USER = 1,
    MACHINE = 2,
};
pub const GPO_SECTION_ROOT = GPO_SECTION.ROOT;
pub const GPO_SECTION_USER = GPO_SECTION.USER;
pub const GPO_SECTION_MACHINE = GPO_SECTION.MACHINE;
...
pub const IGPM = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPM_CreatePermission(self: *const T, bstrTrustee: ?BSTR, perm: GPMPermissionType, bInheritable: VARIANT_BOOL, ppPerm: ?*?*IGPMPermission) callconv(.Inline) HRESULT {
...
pub const IGPMPermission = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMPermission_get_Inherited(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMPermission.VTable, @ptrCast(self.vtable)).get_Inherited(@as(*const IGPMPermission, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMPermission_get_Inheritable(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMPermission.VTable, @ptrCast(self.vtable)).get_Inheritable(@as(*const IGPMPermission, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMPermission_get_Denied(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IGPMSOM = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMSOM_get_GPOInheritanceBlocked(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMSOM.VTable, @ptrCast(self.vtable)).get_GPOInheritanceBlocked(@as(*const IGPMSOM, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMSOM_put_GPOInheritanceBlocked(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IGPMGPO = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPO_SetUserEnabled(self: *const T, vbEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPO.VTable, @ptrCast(self.vtable)).SetUserEnabled(@as(*const IGPMGPO, @ptrCast(self)), vbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPO_SetComputerEnabled(self: *const T, vbEnabled: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPO.VTable, @ptrCast(self.vtable)).SetComputerEnabled(@as(*const IGPMGPO, @ptrCast(self)), vbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPO_IsUserEnabled(self: *const T, pvbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPO.VTable, @ptrCast(self.vtable)).IsUserEnabled(@as(*const IGPMGPO, @ptrCast(self)), pvbEnabled);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPO_IsComputerEnabled(self: *const T, pvbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPO_IsACLConsistent(self: *const T, pvbConsistent: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IGPMGPOLink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPOLink_get_Enabled(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPOLink.VTable, @ptrCast(self.vtable)).get_Enabled(@as(*const IGPMGPOLink, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPOLink_put_Enabled(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPOLink.VTable, @ptrCast(self.vtable)).put_Enabled(@as(*const IGPMGPOLink, @ptrCast(self)), newVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPOLink_get_Enforced(self: *const T, pVal: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
            return @as(*const IGPMGPOLink.VTable, @ptrCast(self.vtable)).get_Enforced(@as(*const IGPMGPOLink, @ptrCast(self)), pVal);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMGPOLink_put_Enforced(self: *const T, newVal: VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IGPMClientSideExtension = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMClientSideExtension_IsUserEnabled(self: *const T, pvbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMClientSideExtension_IsComputerEnabled(self: *const T, pvbEnabled: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub const IGPMConstants = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMConstants_get_SecurityFlags(self: *const T, vbOwner: VARIANT_BOOL, vbGroup: VARIANT_BOOL, vbDACL: VARIANT_BOOL, vbSACL: VARIANT_BOOL, pVal: ?*i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMConstants_get_RsopPlanningLoopbackOption(self: *const T, vbMerge: VARIANT_BOOL, pVal: ?*i32) callconv(.Inline) HRESULT {
...
pub const IGPMDomain2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGPMDomain2_LoadStarterGPO(self: *const T, bstrLoadFile: ?BSTR, bOverwrite: VARIANT_BOOL, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) callconv(.Inline) HRESULT {
...
pub const IGroupPolicyObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_OpenDSGPO(self: *const T, pszPath: ?PWSTR, dwFlags: GPO_OPEN_FLAGS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_OpenLocalMachineGPO(self: *const T, dwFlags: GPO_OPEN_FLAGS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_OpenRemoteMachineGPO(self: *const T, pszComputerName: ?PWSTR, dwFlags: GPO_OPEN_FLAGS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_GetRegistryKey(self: *const T, dwSection: GPO_SECTION, hKey: ?*?HKEY) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_GetOptions(self: *const T, dwOptions: ?*GPO_OPTIONS) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IGroupPolicyObject_SetOptions(self: *const T, dwOptions: GPO_OPTIONS, dwMask: u32) callconv(.Inline) HRESULT {
...
pub extern "userenv" fn GetGPOListA(
    ...
    lpHostName: ?[*:0]align(1) const u8,
    lpComputerName: ?[*:0]align(1) const u8,
    dwFlags: u32,
    pGPOList: ?*?*GROUP_POLICY_OBJECTA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "userenv" fn GetGPOListW(
    ...
    lpComputerName: ?[*:0]align(1) const u16,
    dwFlags: u32,
...
pub extern "userenv" fn GetAppliedGPOListA(
    dwFlags: u32,
    pMachineName: ?[*:0]align(1) const u8,
    pSidUser: ?PSID,
    pGuidExtension: ?*Guid,
...
pub extern "userenv" fn GetAppliedGPOListW(
    dwFlags: u32,
    pMachineName: ?[*:0]align(1) const u16,
    pSidUser: ?PSID,
    pGuidExtension: ?*Guid,
...
pub extern "userenv" fn GenerateGPNotification(
    bMachine: BOOL,
    lpwszMgmtProduct: ?[*:0]align(1) const u16,
...
const APPCATEGORYINFOLIST = @import("../../../windows/win32/ui/shell.zig").APPCATEGORYINFOLIST;
...
const IWbemClassObject = @import("../../../windows/win32/system/wmi.zig").IWbemClassObject;
const IWbemServices = @import("../../../windows/win32/system/wmi.zig").IWbemServices;
const LPARAM = @import("../../../windows/win32/foundation.zig").LPARAM;
const OBJECT_TYPE_LIST = @import("../../../windows/win32/security.zig").OBJECT_TYPE_LIST;
