...
pub const ERROR_WSMAN_EVENTING_PUSH_SUBSCRIPTION_NOACTIVATE_EVENTSOURCE = @as(u32, 2150859263);
...
pub const WSMAN_ERROR = extern struct {
    code: u32,
    errorDetail: ?[*:0]align(1) const u16,
    language: ?[*:0]align(1) const u16,
    machineName: ?[*:0]align(1) const u16,
    pluginName: ?[*:0]align(1) const u16,
};
...
pub const WSMAN_AUTHENTICATION_CREDENTIALS = extern struct {
    ...
    Anonymous: extern union {
        ...
        certificateThumbprint: ?[*:0]align(1) const u16,
    },
};
...
pub const WSMAN_OPERATION_INFOEX = extern struct {
    ...
    version: u32,
    uiLocale: ?[*:0]align(1) const u16,
    dataLocale: ?[*:0]align(1) const u16,
};
...
pub const WSMAN_RECEIVE_DATA_RESULT = extern struct {
    streamId: ?[*:0]align(1) const u16,
    streamData: WSMAN_DATA,
    commandState: ?[*:0]align(1) const u16,
    exitCode: u32,
};
...
pub const WSMAN_PLUGIN_STARTUP = switch (@import("builtin").zig_backend) {
    .stage1 => fn(
        flags: u32,
        applicationIdentification: ?[*:0]align(1) const u16,
        extraInfo: ?[*:0]align(1) const u16,
...
pub const IWSManEnumerator = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSManEnumerator_get_AtEndOfStream(self: *const T, eos: ?*VARIANT_BOOL) callconv(.Inline) HRESULT {
...
pub extern "wsmsvc" fn WSManGetErrorMessage(
    apiHandle: WSMAN_API_HANDLE,
    flags: u32,
    languageCode: ?[*:0]align(1) const u16,
    errorCode: u32,
    messageLength: u32,
    message: ?[*:0]u16,
...
pub extern "wsmsvc" fn WSManCreateSession(
    apiHandle: WSMAN_API_HANDLE,
    connection: ?[*:0]align(1) const u16,
    flags: u32,
...
pub extern "wsmsvc" fn WSManPluginOperationComplete(
    ...
    flags: u32,
    errorCode: u32,
    extendedInformation: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wsmsvc" fn WSManPluginAuthzUserComplete(
    ...
    errorCode: u32,
    extendedErrorInformation: ?[*:0]align(1) const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
