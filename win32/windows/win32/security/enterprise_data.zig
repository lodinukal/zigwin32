...
pub const ENTERPRISE_DATA_POLICIES = enum(i32) {
    NONE = 0,
    ALLOWED = 1,
    ENLIGHTENED = 2,
    EXEMPT = 4,
...
pub extern "srpapi" fn SrpCreateThreadNetworkContext(
    enterpriseId: ?[*:0]align(1) const u16,
...
pub extern "efswrt" fn ProtectFileToEnterpriseIdentity(
    fileOrFolderPath: ?[*:0]align(1) const u16,
...
const PACKAGE_ID = @import("../../../windows/win32/storage/packaging/appx.zig").PACKAGE_ID;
