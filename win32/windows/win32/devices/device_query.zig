...
pub extern "api-ms-win-devices-query-l1-1-0" fn DevCreateObjectQueryFromIds(
    ObjectType: DEV_OBJECT_TYPE,
    pszzObjectIds: ?[*]align(1) const u16,
    QueryFlags: u32,
    cRequestedProperties: u32,
    pRequestedProperties: ?[*]const DEVPROPCOMPKEY,
    cFilterExpressionCount: u32,
...
// Section: Imports (7)
//--------------------------------------------------------------------------------
const DEVPROPCOMPKEY = @import("../../../windows/win32/devices/properties.zig").DEVPROPCOMPKEY;
...
const DEVPROPSTORE = @import("../../../windows/win32/devices/properties.zig").DEVPROPSTORE;
